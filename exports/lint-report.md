...
## [2026-06-25] lint | health-check | 自动化 wiki 健康检查
...
- wiki/methods/htwk-gym.md（被 5 个页面引用，无 queries/comparisons 落地）
...
📊 Sources 覆盖率：1295/1324 (98%) wiki/entity 页有 ingest 来源
