...
updated: 2026-09-25
arxiv: "2505.04999"
venue: "IEEE/RSJ International Conference on Intelligent Robots and Systems 2026 (arXiv"
summary: "CLAM learns continuous action codes from robot observation transitions, grounds them with limited action-labeled data, then imitates expert videos in that latent space. Deployment uses a policy and action decoder; future"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2505_04999_clam-continuous-latent-action-models-for.md
...
**CLAM: Continuous Latent Action Models for Robot Learning from Unlabeled Demonstrations** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 197/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

CLAM learns continuous action codes from robot observation transitions, grounds them with limited action-labeled data, then imitates expert videos in that latent space. Deployment uses a policy and action decoder; future-observation prediction serves training. Its strongest evidence concerns action-label scarcity wi...
...
| 出处 | IEEE/RSJ International Conference on Intelligent Robots and Systems 2026 (arXiv journal reference) |
| 论文 | <https://arxiv.org/abs/2505.04999> |
| 子类 / 象限 | Latent-action & representation methods · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.04999) 为准。
...
**本条目的站内价值是把「CLAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2505_04999_clam-continuous-latent-action-models-for.md`](../../sources/papers/rcl_awesome_wam_2505_04999_clam-continuous-latent-action-models-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.04999)
