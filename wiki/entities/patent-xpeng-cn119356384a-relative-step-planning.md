...
summary: "小鹏 IRON CN119356384A：以相对位移和转角规划双足迈步动作（2025-01-24 公开/公告）；在机身坐标系表达支撑-摆动脚相对位移与绕竖轴转角，经状态机与落足区间筛选生成轨迹。…"
---

# 小鹏 IRON · 以相对位移和转角规划双足迈步动作（CN119356384A）

专利 **CN119356384A**（*以相对位移和转角规划双足迈步动作*，小鹏机器人 / IRON 相关布局，2025-01-24）公开 **双足步态控制** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**在机身坐标系表达支撑-摆动脚相对位移与绕竖轴转角，经状态机与落足区间筛选生成轨迹。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN119356384A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn119356384a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN119356384A](https://patents.google.com/patent/CN119356384A/zh)
