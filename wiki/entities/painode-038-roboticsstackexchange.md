...
status: complete
updated: 2026-09-20
summary: "Q&A for robotics professionals and enthusiasts."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_038_robotics-stack-exchange.md
...
**Robotics Stack Exchange** 收录于 awesome-physical-ai（natnew）**第 038/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Q&A for robotics professionals and enthusiasts.
...
| 分组 | Community |
| 来源清单 | natnew |
| 主链接 | <https://robotics.stackexchange.com/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://robotics.stackexchange.com/> |
...
- [`sources/repos/pai_awesome_community_038_robotics-stack-exchange.md`](../../sources/repos/pai_awesome_community_038_robotics-stack-exchange.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robotics.stackexchange.com/)
