...
code: https://github.com/leggedrobotics/fdm
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2504_19322_learned-perceptive-forward-dynamics-mode.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Learned Perceptive Forward Dynamics Model for Safe and Platform-aware Robotic...

**Learned Perceptive Forward Dynamics Model for Safe and Platform-aware Robotic Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 406/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 编号 | 406/564 |
| 分组 | WAMs |
| 出处 | Robotics: Science and Systems (RSS) 2025 |
| 论文 | <https://www.roboticsproceedings.org/rss21/p001.html> |
| 代码/项目 | <https://github.com/leggedrobotics/fdm> |
| 子类 / 象限 | 导航 · 三维多视角建模 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.roboticsproceedings.org/rss21/p001.html) 为准。
...
**本条目的站内价值是把「Learned Perceptive Forward Dynamics Model for Safe and Platform-aware Robotic...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2504_19322_learned-perceptive-forward-dynamics-mode.md`](../../sources/papers/rcl_awesome_wam_2504_19322_learned-perceptive-forward-dynamics-mode.md) — 本条目策展摘录
...
- [原文](https://www.roboticsproceedings.org/rss21/p001.html)
