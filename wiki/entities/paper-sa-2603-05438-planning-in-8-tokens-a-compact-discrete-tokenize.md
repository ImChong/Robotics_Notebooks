...
arxiv: "2603.05438"
venue: "arXiv 2026"
summary: "Compresses each observation to only 8 tokens."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2603_05438_planning-in-8-tokens-a-compact-discrete.md
...
**Planning in 8 Tokens: A Compact Discrete Tokenizer for Latent World Model (CompACT)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 015/571** 篇，分组 **103 Efficient & Real-Time Inference**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Compresses each observation to only 8 tokens.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2603.05438> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.05438) 为准。
...
**本条目的站内价值是把「Planning in 8 Tokens」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2603_05438_planning-in-8-tokens-a-compact-discrete.md`](../../sources/papers/sun_awesome_wm_2603_05438_planning-in-8-tokens-a-compact-discrete.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.05438)
