...
- **标题：** Human-Robot Collaboration for the Remote Control of Mobile Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/07_Teleoperation/human-robot-collaboration-for-the-remote-control/human-robot-collaboration-for-the-remote-control.md`
- **分类：** 07_Teleoperation
