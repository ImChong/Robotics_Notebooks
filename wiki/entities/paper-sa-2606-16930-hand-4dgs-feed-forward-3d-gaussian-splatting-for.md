...
arxiv: "2606.16930"
venue: "arXiv 2026"
summary: "Dynamic 3D hand reconstruction from egocentric videos addressing fast head motion, rapid hand dynamics, severe occlusions, and single-view ambiguity"
related:
...
**Hand-4DGS: Feed-Forward 3D Gaussian Splatting for 4D Hand Reconstruction from Egocentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 212/249** 篇，分组 **Human Pose & Mesh Recovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Dynamic 3D hand reconstruction from egocentric videos addressing fast head motion, rapid hand dynamics, severe occlusions, and single-view ambiguity
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.16930> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.16930) 为准。
...
- [原文](https://arxiv.org/abs/2606.16930)
