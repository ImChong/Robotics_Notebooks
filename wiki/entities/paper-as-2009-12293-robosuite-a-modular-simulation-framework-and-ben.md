...
**robosuite: A modular simulation framework and benchmark for robot learning** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 028/139** 篇，分组 **Action / Foundation Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2009.12293) 为准。
...
**本条目的站内价值是把「robosuite」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_2009_12293_robosuite-a-modular-simulation-framework.md`](../../sources/papers/lc_awesome_sim2real_2009_12293_robosuite-a-modular-simulation-framework.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2009.12293)
