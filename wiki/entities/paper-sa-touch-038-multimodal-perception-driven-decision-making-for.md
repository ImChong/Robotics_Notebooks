...
sources:
  - ../../sources/papers/sun_awesome_touch_noarxiv_038_multimodal-perception-driven-decision-ma.md
  - ../../sources/papers/sun_awesome_touch_catalog.md
  - ../../sources/repos/awesome-touch.md
---

# Multimodal Perception-Driven Decision-Making for Human-Robot Interaction

**Multimodal Perception-Driven Decision-Making for Human-Robot Interaction: A Survey** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 038/065** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Comprehensive review of multimodal perception integrating vision, language, and tactile information for decision-making in robotics.
...
| 出处 | Frontiers in Robotics and AI 2025 |
| 论文 | <https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2025.1604472/pdf> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2025.1604472/pdf) 为准。
...
**本条目的站内价值是把「Multimodal Perception-Driven Decision-Making for Human-Robot Interaction」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_noarxiv_038_multimodal-perception-driven-decision-ma.md`](../../sources/papers/sun_awesome_touch_noarxiv_038_multimodal-perception-driven-decision-ma.md) — 本条目策展摘录
...
- [原文](https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2025.1604472/pdf)
