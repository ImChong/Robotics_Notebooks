...
**flexiv_rdk** 是 [非夕科技](https://github.com/flexivrobotics) 公开的 **SDK/驱动** 开源项目：提供非夕机器人C++与Python开发接口，使控制、状态、力控和应用程序接入真实机器人。
...
1. 从官方 GitHub/Gitee 组织检索 `flexiv_rdk` 仓库并核对 README 许可与依赖。
