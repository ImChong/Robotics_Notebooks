...
**Wiki-GRx-Pipeline** 是 [傅利叶智能](https://github.com/FFTAI) 公开的 **部署运行时** 开源项目：以模型准备、Isaac Gym训练、MuJoCo验证和真机部署四步连接Wiki-GRx-URDF、Wiki-GRx-MJCF、Wiki-GRx-Gym、Wiki-GRx-Mujoco与Wiki-GRx-Deploy，使读者能按同一机器人型号检查资产、策略和部署接口。
...
1. 从官方 GitHub/Gitee 组织检索 `Wiki-GRx-Pipeline` 仓库并核对 README 许可与依赖。
