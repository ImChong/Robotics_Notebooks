...
summary: "World models amplify data scaling laws in autonomous driving."
related:
...
**DriveVLA-W0: World Models Amplify Data Scaling Law in Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 422/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

World models amplify data scaling laws in autonomous driving.
...
| 代码/项目 | <https://github.com/BraveGroup/DriveVLA-W0> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.12796) 为准。
...
**本条目的站内价值是把「DriveVLA-W0」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_12796_drivevla-w0-world-models-amplify-data-sc.md`](../../sources/papers/sun_awesome_wm_2510_12796_drivevla-w0-world-models-amplify-data-sc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.12796)
