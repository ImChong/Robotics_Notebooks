...
**Lightwheel-simready-asset** 是 [光轮智能](https://github.com/LightwheelAI) 公开的 **本体模型资产** 开源项目：提供机器人训练和交互仿真所需的开源三维数字资产。
...
1. 从官方 GitHub/Gitee 组织检索 `Lightwheel-simready-asset` 仓库并核对 README 许可与依赖。
