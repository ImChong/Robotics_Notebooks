...
## [2026-08-09] lint | health-check | 自动化 wiki 健康检查
...
- URDF（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/entities/paper-dypes-vla.md（含绝对化措辞「SOTA」，updated=2026-08-08；同主题更新页 wiki/entities/paper-commnav.md updated=2026-08-09）
- wiki/entities/paper-slamformer-infinity.md（含绝对化措辞「SOTA」，updated=2026-08-08；同主题更新页 wiki/entities/paper-commnav.md updated=2026-08-09）
...
📊 Sources 覆盖率：2123/2123 (100%) wiki/entity 页有 ingest 来源
