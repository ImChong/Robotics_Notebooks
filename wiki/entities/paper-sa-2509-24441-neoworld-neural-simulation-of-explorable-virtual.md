...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_24441_neoworld-neural-simulation-of-explorable.md
...
**NeoWorld: Neural Simulation of Explorable Virtual Worlds via Progressive 3D Unfolding** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 037/571** 篇，分组 **113 Interactive World Models & Game Engines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A deep learning framework that supports user‑driven object manipulation and physics‑based dynamic simulation, enabling interactive world generation in continuously expanding 3D environments.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.24441> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.24441) 为准。
...
**本条目的站内价值是把「NeoWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_24441_neoworld-neural-simulation-of-explorable.md`](../../sources/papers/sun_awesome_wm_2509_24441_neoworld-neural-simulation-of-explorable.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.24441)
