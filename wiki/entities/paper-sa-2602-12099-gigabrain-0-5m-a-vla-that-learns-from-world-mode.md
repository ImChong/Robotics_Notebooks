...
summary: "VLA that learns from world model-based RL."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_12099_gigabrain-0-5m-a-vla-that-learns-from-wo.md
...
**GigaBrain-0.5M\*: a VLA That Learns From World Model-Based Reinforcement Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 220/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

VLA that learns from world model-based RL.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.12099> |
| 代码/项目 | <https://github.com/open-gigaai/giga-brain-0> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.12099) 为准。
...
**这一页能给你的是「GigaBrain-0.5M\*」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2602_12099_gigabrain-0-5m-a-vla-that-learns-from-wo.md`](../../sources/papers/sun_awesome_wm_2602_12099_gigabrain-0-5m-a-vla-that-learns-from-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.12099)
