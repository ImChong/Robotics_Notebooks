...
status: complete
updated: 2026-08-12
summary: "Vim 将双向 Mamba 扫描引入视觉骨干，以近线性复杂度做图像分类与密集预测，探索无注意力的通用视觉主干。"
related:
...
Vim 将双向 Mamba 扫描引入视觉骨干，以近线性复杂度做图像分类与密集预测，探索无注意力的通用视觉主干。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| Vim | Vision Mamba | 视觉 Mamba 骨干 |
| SSM | State Space Model | 核心序列算子 |
| BiMamba | Bidirectional Mamba | 双向扫描 |
| ViT | Vision Transformer | 对照注意力骨干 |
| FPS | Frames Per Second | 部署关注点 |
...
- [相关论文](https://arxiv.org/abs/2401.09417)
