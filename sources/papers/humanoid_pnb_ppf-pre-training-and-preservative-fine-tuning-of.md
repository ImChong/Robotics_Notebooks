...
- **标题：** PPF: Pre-training and Preservative Fine-tuning of Humanoid Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/ppf-pre-training-and-preservative-fine-tuning-of/ppf-pre-training-and-preservative-fine-tuning-of.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-ppf-pre-training-and-preservative-fine-tuning-of](../../wiki/entities/paper-notebook-ppf-pre-training-and-preservative-fine-tuning-of.md).

## 对 wiki 的映射

- [paper-notebook-ppf-pre-training-and-preservative-fine-tuning-of](../../wiki/entities/paper-notebook-ppf-pre-training-and-preservative-fine-tuning-of.md)
