...
**Embodylink** 是 [越疆科技](https://github.com/embodied-dobot) 公开的 **数据集/Benchmark** 开源项目：面向越疆机器人提供数据采集、标注、模型训练管理和遥操作工具入口。
...
1. 从官方 GitHub/Gitee 组织检索 `Embodylink` 仓库并核对 README 许可与依赖。
