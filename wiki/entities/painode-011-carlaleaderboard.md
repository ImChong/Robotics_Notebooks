---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, benchmark]
status: complete
updated: 2026-09-20
summary: "Standardized autonomous-driving benchmark emphasizing closed-loop safety and robustness."
related:
...
sources:
  - ../../sources/repos/pai_awesome_benchmark_011_carla-leaderboard.md
...
**CARLA Leaderboard** 收录于 awesome-physical-ai（natnew）**第 011/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Standardized autonomous-driving benchmark emphasizing closed-loop safety and robustness.
...
| 分组 | Benchmarks |
| 来源清单 | natnew |
| 主链接 | <https://leaderboard.carla.org/> |

## 核心原理

Standardized autonomous-driving benchmark emphasizing closed-loop safety and robustness.

该条目在 Physical AI 清单中的角色是 **benchmark**，分组 **Benchmarks**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://leaderboard.carla.org/> |
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 闭环驾驶评测且强调安全与鲁棒性，属该闭环第 ③ 层「策略任务成功率评测」的闭环（非开环回放）口径参照

## 参考来源

- [`sources/repos/pai_awesome_benchmark_011_carla-leaderboard.md`](../../sources/repos/pai_awesome_benchmark_011_carla-leaderboard.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://leaderboard.carla.org/)
