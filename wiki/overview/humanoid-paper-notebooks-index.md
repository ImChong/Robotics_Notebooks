...
summary: "Humanoid Paper Notebooks 137+ 篇深读笔记在本库的分类父节点与 wiki 子节点总索引（共 528 篇）。"
---
...
- [Loco-Manipulation and WBC（运动操作与全身控制）](./paper-notebook-category-04-loco-manipulation-and-wbc.md) — `04_Loco-Manipulation_and_WBC`，158 篇
...
- [Teleoperation（遥操作）](./paper-notebook-category-07-teleoperation.md) — `07_Teleoperation`，20 篇
...
- [Sim-to-Real（仿真到现实）](./paper-notebook-category-10-sim-to-real.md) — `10_Sim-to-Real`，8 篇
- [Simulation Benchmark（仿真与基准）](./paper-notebook-category-11-simulation-benchmark.md) — `11_Simulation_Benchmark`，20 篇
- [Hardware Design（硬件设计）](./paper-notebook-category-12-hardware-design.md) — `12_Hardware_Design`，38 篇
