...
arxiv: "2510.19195"
venue: "arXiv 2025"
summary: "Rethinking driving world models as synthetic data generators."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_19195_dream4drive-rethinking-driving-world-mod.md
...
**Dream4Drive: Rethinking Driving World Model as Synthetic Data Generator for Perception Tasks** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 412/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Rethinking driving world models as synthetic data generators.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.19195> |
| 项目页 | <https://wm-research.github.io/Dream4Drive/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.19195) 为准。
...
**本条目的站内价值是把「Dream4Drive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_19195_dream4drive-rethinking-driving-world-mod.md`](../../sources/papers/sun_awesome_wm_2510_19195_dream4drive-rethinking-driving-world-mod.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.19195)
