...
sources:
  - ../../sources/repos/pai_awesome_resource_006_nerf-gs-for-robotics.md
...
# NeRF + GS for Robotics

**NeRF + GS for Robotics** 收录于 awesome-physical-ai（aichr）**第 006/384** 条，分组 **3D Computer Vision**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://openaccess.thecvf.com/content/ICCV2025/papers/Fang_NeRF_Is_a_Valuable_Assistant_for_3D_Gaussian_Splatting_ICCV_2025_paper.pdf> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://openaccess.thecvf.com/content/ICCV2025/papers/Fang_NeRF_Is_a_Valuable_Assistant_for_3D_Gaussian_Splatting_ICCV_2025_paper.pdf> |
...
- [`sources/repos/pai_awesome_resource_006_nerf-gs-for-robotics.md`](../../sources/repos/pai_awesome_resource_006_nerf-gs-for-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://openaccess.thecvf.com/content/ICCV2025/papers/Fang_NeRF_Is_a_Valuable_Assistant_for_3D_Gaussian_Splatting_ICCV_2025_paper.pdf)
