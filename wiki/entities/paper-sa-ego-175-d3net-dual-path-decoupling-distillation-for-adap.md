...
sources:
  - ../../sources/papers/sun_awesome_ego_noarxiv_175_d3net-dual-path-decoupling-distillation.md
...
**D3Net: Dual-Path Decoupling-Distillation for Adaptive Fusion in Continual Egocentric Learning** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 175/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Proposes a Dual-path Decoupling-Distillation Network for more effective dynamic fusion of modal information and knowledge transfer. Explicitly separates shared and private features of modalities through a dual-path decoupling module with a dynamic gating mechanism. Achieves 83.97% accuracy on UESTC MMEA CL dataset
...
| 出处 | IEEE 2025 |
| 论文 | <https://ieeexplore.ieee.org/document/11324280> |
| 项目页 | <https://ieeexplore.ieee.org/document/11324280> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/11324280) 为准。
...
**本条目的站内价值是把「D3Net」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_175_d3net-dual-path-decoupling-distillation.md`](../../sources/papers/sun_awesome_ego_noarxiv_175_d3net-dual-path-decoupling-distillation.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/11324280)
