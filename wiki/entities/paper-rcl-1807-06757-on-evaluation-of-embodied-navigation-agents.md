...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1807_06757_on-evaluation-of-embodied-navigation-age.md
...
**On Evaluation of Embodied Navigation Agents** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 142/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1807.06757) 为准。
...
**本条目的站内价值是把「On Evaluation of Embodied Navigation Agents」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1807_06757_on-evaluation-of-embodied-navigation-age.md`](../../sources/papers/rcl_awesome_wam_1807_06757_on-evaluation-of-embodied-navigation-age.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/1807.06757)
