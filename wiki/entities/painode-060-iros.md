...
sources:
  - ../../sources/repos/pai_awesome_conference_060_iros.md
...
**IROS** 收录于 awesome-physical-ai（natnew、aichr）**第 060/384** 条，分组 **Conferences / Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew、aichr |
| 主链接 | <https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/iros> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/iros> |
...
- [`sources/repos/pai_awesome_conference_060_iros.md`](../../sources/repos/pai_awesome_conference_060_iros.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/iros)
