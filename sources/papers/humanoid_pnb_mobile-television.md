...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Mobile-TeleVision__Predictive_Motion_Priors_for_Humanoid_Whole-Body_Control/Mobile-TeleVision__Predictive_Motion_Priors_for_Humanoid_Whole-Body_Control.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-mobile-television](../../wiki/entities/paper-notebook-mobile-television.md).

## 对 wiki 的映射

- [paper-notebook-mobile-television](../../wiki/entities/paper-notebook-mobile-television.md)
