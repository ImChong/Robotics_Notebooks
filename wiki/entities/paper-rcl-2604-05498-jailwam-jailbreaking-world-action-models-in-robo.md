...
arxiv: "2604.05498"
venue: "2026"
summary: "JailWAM evaluates instruction-induced robot risk by rendering predicted actions as trajectory charts, screening them with a trained vision-language discriminator, and verifying selected candidates in closed-loop simulati"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_05498_jailwam-jailbreaking-world-action-models.md
...
**JailWAM: Jailbreaking World Action Models in Robot Control** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 029/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

JailWAM evaluates instruction-induced robot risk by rendering predicted actions as trajectory charts, screening them with a trained vision-language discriminator, and verifying selected candidates in closed-loop simulation. It reports 84.20% human-verified attack success on LingBot-VA, but its cheaper screening pipe...
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2604.05498> |
| 子类 / 象限 | 评测协议与诊断 · 鲁棒性与泛化评测 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.05498) 为准。
...
**本条目的站内价值是把「JailWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_05498_jailwam-jailbreaking-world-action-models.md`](../../sources/papers/rcl_awesome_wam_2604_05498_jailwam-jailbreaking-world-action-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.05498)
