...
status: complete
updated: 2026-09-20
summary: "Strong practical RL course with modern policy-gradient and model-based methods."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_067_cs-285-deep-reinforcement-learning-b.md
...
**CS 285 — Deep Reinforcement Learning (Berkeley)** 收录于 awesome-physical-ai（natnew）**第 067/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Strong practical RL course with modern policy-gradient and model-based methods.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://rail.eecs.berkeley.edu/deeprlcourse/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://rail.eecs.berkeley.edu/deeprlcourse/> |
...
- [`sources/repos/pai_awesome_course_067_cs-285-deep-reinforcement-learning-b.md`](../../sources/repos/pai_awesome_course_067_cs-285-deep-reinforcement-learning-b.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://rail.eecs.berkeley.edu/deeprlcourse/)
