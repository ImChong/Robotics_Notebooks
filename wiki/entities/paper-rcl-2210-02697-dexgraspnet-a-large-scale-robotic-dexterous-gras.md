...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2210_02697_dexgraspnet-a-large-scale-robotic-dexter.md
...
**DexGraspNet: A Large-Scale Robotic Dexterous Grasp Dataset for General Objects Based on Simulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 104/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | ICRA 2023 |
| 论文 | <https://ieeexplore.ieee.org/document/10160982/> |
| 项目页 | <https://pku-epic.github.io/DexGraspNet/> |
| 子类 / 象限 | 灵巧手与抓取数据 · 合成数据与数据生成 · 三维物体资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/10160982/) 为准。
...
**本条目的站内价值是把「DexGraspNet」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2210_02697_dexgraspnet-a-large-scale-robotic-dexter.md`](../../sources/papers/rcl_awesome_wam_2210_02697_dexgraspnet-a-large-scale-robotic-dexter.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/10160982/)
