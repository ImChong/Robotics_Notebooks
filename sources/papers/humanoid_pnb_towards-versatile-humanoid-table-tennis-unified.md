...
- **标题：** Towards Versatile Humanoid Table Tennis: Unified Reinforcement Learning with Prediction Augmentation
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/towards-versatile-humanoid-table-tennis-unified/towards-versatile-humanoid-table-tennis-unified.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2509.21690>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-towards-versatile-humanoid-table-tennis](../../wiki/entities/paper-notebook-towards-versatile-humanoid-table-tennis.md).

## 对 wiki 的映射

- [paper-notebook-towards-versatile-humanoid-table-tennis](../../wiki/entities/paper-notebook-towards-versatile-humanoid-table-tennis.md)
...
- 论文：<https://arxiv.org/abs/2509.21690>
