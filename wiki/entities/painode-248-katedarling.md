---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, person]
status: complete
updated: 2026-09-20
summary: "MIT Media Lab, BD AI Institute. Robotics ethics and human-robot interaction."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_248_kate-darling.md
...
**Kate Darling** 收录于 awesome-physical-ai（natnew）**第 248/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

MIT Media Lab, BD AI Institute. Robotics ethics and human-robot interaction.
...
| 分组 | People to Follow |
| 来源清单 | natnew |
| 主链接 | <https://x.com/grok_> |

## 核心原理

MIT Media Lab, BD AI Institute. Robotics ethics and human-robot interaction.

该条目在 Physical AI 清单中的角色是 **person**，分组 **People to Follow**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
- [`sources/repos/pai_awesome_person_248_kate-darling.md`](../../sources/repos/pai_awesome_person_248_kate-darling.md) — 本条目策展摘录
