...
status: complete
updated: 2026-09-20
code: https://github.com/zchoi/awesome-embodied-robotics-and-agent
summary: "Embodied AI with VLMs and LLMs."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_275_awesome-embodied-agent.md
...
**Awesome Embodied Agent** 收录于 awesome-physical-ai（natnew）**第 275/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Embodied AI with VLMs and LLMs.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent> |
| 代码/仓库 | <https://github.com/zchoi/awesome-embodied-robotics-and-agent> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent> |
| 代码/仓库 | <https://github.com/zchoi/awesome-embodied-robotics-and-agent> |
...
- [`sources/repos/pai_awesome_list_275_awesome-embodied-agent.md`](../../sources/repos/pai_awesome_list_275_awesome-embodied-agent.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/zchoi/Awesome-Embodied-Robotics-and-Agent)
