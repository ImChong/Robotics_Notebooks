...
arxiv: "2510.04020"
venue: "arXiv 2025"
summary: "Spatiotemporal forecasting as planning with generative world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_04020_sfp-spatiotemporal-forecasting-as-planni.md
...
**SFP: Spatiotemporal Forecasting as Planning – A Model-Based RL Approach with Generative World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 524/571** 篇，分组 **84 Scientific Discovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Spatiotemporal forecasting as planning with generative world models.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.04020> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.04020) 为准。
...
**本条目的站内价值是把「SFP」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_04020_sfp-spatiotemporal-forecasting-as-planni.md`](../../sources/papers/sun_awesome_wm_2510_04020_sfp-spatiotemporal-forecasting-as-planni.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.04020)
