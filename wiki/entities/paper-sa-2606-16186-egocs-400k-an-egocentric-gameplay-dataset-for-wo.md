...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_16186_egocs-400k-an-egocentric-gameplay-datase.md
...
**EgoCS-400K: An Egocentric Gameplay Dataset for World Models** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 105/249** 篇，分组 **28 Egocentric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A large-scale replay-grounded egocentric Counter-Strike dataset for world models, built from public professional CS match demos preserving human gameplay trajectories
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.16186> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.16186) 为准。
...
**本条目的站内价值是把「EgoCS-400K」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_16186_egocs-400k-an-egocentric-gameplay-datase.md`](../../sources/papers/sun_awesome_ego_2606_16186_egocs-400k-an-egocentric-gameplay-datase.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.16186)
