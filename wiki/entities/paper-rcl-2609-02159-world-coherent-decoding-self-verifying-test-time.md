...
updated: 2026-09-25
arxiv: "2609.02159"
summary: "We propose World-Coherent-Decoding (WCD), a self-verifying test-time planning framework that treats WAM rollouts as falsifiable future--action hypotheses."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_02159_world-coherent-decoding-self-verifying-t.md
...
**World-Coherent Decoding: Self-Verifying Test-Time Planning for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 549/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We propose World-Coherent-Decoding (WCD), a self-verifying test-time planning framework that treats WAM rollouts as falsifiable future--action hypotheses.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2609.02159> |
| 子类 / 象限 | 策略后训练与WM-RL · 高效推理与实时控制 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.02159) 为准。
...
**本条目的站内价值是把「World-Coherent Decoding」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_02159_world-coherent-decoding-self-verifying-t.md`](../../sources/papers/rcl_awesome_wam_2609_02159_world-coherent-decoding-self-verifying-t.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.02159)
