...
sources:
  - ../../sources/papers/sun_awesome_touch_2505_09577_vtla-vision-tactile-language-action-mode.md
...
**VTLA: Vision-Tactile-Language-Action Model with Preference Learning for Insertion Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 015/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Integrates tactile perception into vision-language foundation model for contact-rich manipulation challenges such as peg-in-hole insertion.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.09577> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.09577) 为准。
...
**本条目的站内价值是把「VTLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2505_09577_vtla-vision-tactile-language-action-mode.md`](../../sources/papers/sun_awesome_touch_2505_09577_vtla-vision-tactile-language-action-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.09577)
