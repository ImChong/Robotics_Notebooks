...
- **标题：** A Gait Driven RL Framework for Humanoid Robots
- **类型：** paper
- **深读状态：** 待撰写（见 [papers/PROGRESS.md](https://github.com/ImChong/Robot_Learning_Paper_Notebooks/blob/main/papers/PROGRESS.md)）
- **计划笔记路径：** `papers/05_Locomotion/a-gait-driven-rl-framework-for-humanoid-robots/a-gait-driven-rl-framework-for-humanoid-robots.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-a-gait-driven-rl-framework-for-humanoid-robots](../../wiki/entities/paper-notebook-a-gait-driven-rl-framework-for-humanoid-robots.md).

## 对 wiki 的映射

- [paper-notebook-a-gait-driven-rl-framework-for-humanoid-robots](../../wiki/entities/paper-notebook-a-gait-driven-rl-framework-for-humanoid-robots.md)
