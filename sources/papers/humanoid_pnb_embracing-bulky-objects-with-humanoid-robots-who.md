...
- **标题：** Embracing Bulky Objects with Humanoid Robots: Whole-Body Manipulation with Reinforcement Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/embracing-bulky-objects-with-humanoid-robots-who/embracing-bulky-objects-with-humanoid-robots-who.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2509.13534>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-embracing-bulky-objects-with-humanoid-robots](../../wiki/entities/paper-notebook-embracing-bulky-objects-with-humanoid-robots.md).

## 对 wiki 的映射

- [paper-notebook-embracing-bulky-objects-with-humanoid-robots](../../wiki/entities/paper-notebook-embracing-bulky-objects-with-humanoid-robots.md)
...
- 论文：<https://arxiv.org/abs/2509.13534>
