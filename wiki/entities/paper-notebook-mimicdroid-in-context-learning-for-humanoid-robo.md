...
**MimicDroid: In-Context Learning for Humanoid Robot Manipulation from Human Play Videos** 收录于 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html)（分类：06_Manipulation），深读笔记已完成。本页是 **笔记摘要**：要点编译自深读笔记，细节以笔记原文与论文 PDF 为准。
...
- 适用边界在「看几个例子就会」的快速适应，而非从零学全新技能；本页为笔记摘要，量化细节以深读笔记与论文 PDF 为准。
