...
- **标题：** ManiSkill3: GPU Parallelized Robotics Simulation and Rendering for Generalizable Embodied AI
- **类型：** paper
...
- **计划笔记路径：** `papers/11_Simulation_Benchmark/maniskill3-gpu-parallelized-robotics-simulation/maniskill3-gpu-parallelized-robotics-simulation.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-maniskill3-gpu-parallelized-robotics-simulation](../../wiki/entities/paper-notebook-maniskill3-gpu-parallelized-robotics-simulation.md).

## 对 wiki 的映射

- [paper-notebook-maniskill3-gpu-parallelized-robotics-simulation](../../wiki/entities/paper-notebook-maniskill3-gpu-parallelized-robotics-simulation.md)
