...
- **标题：** Optimizing Bipedal Locomotion for The 100m Dash With Comparison to Human Running
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/optimizing-bipedal-locomotion-for-the-100m-dash/optimizing-bipedal-locomotion-for-the-100m-dash.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-optimizing-bipedal-locomotion-for-the-100m-dash](../../wiki/entities/paper-notebook-optimizing-bipedal-locomotion-for-the-100m-dash.md).

## 对 wiki 的映射

- [paper-notebook-optimizing-bipedal-locomotion-for-the-100m-dash](../../wiki/entities/paper-notebook-optimizing-bipedal-locomotion-for-the-100m-dash.md)
