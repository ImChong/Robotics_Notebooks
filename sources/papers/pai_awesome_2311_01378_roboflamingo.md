...
- **代码：** 未在清单中标注
- **清单摘要：** Open vision-language-action model for low-cost adaptation to robot manipulation tasks. <!-- tags: paper, open-source -->
- **沉淀到 wiki：** [`wiki/entities/paper-pai-2311-01378-roboflamingo.md`](../../wiki/entities/paper-pai-2311-01378-roboflamingo.md)
...
- 实体页：[`wiki/entities/paper-pai-2311-01378-roboflamingo.md`](../../wiki/entities/paper-pai-2311-01378-roboflamingo.md)
