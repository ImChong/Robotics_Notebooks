...
- **标题：** GaussGym: An open-source real-to-sim framework for learning locomotion from pixels
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/gaussgym-an-open-source-real-to-sim-framework-fo/gaussgym-an-open-source-real-to-sim-framework-fo.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-gaussgym-an-open-source-real-to-sim-framework-fo](../../wiki/entities/paper-notebook-gaussgym-an-open-source-real-to-sim-framework-fo.md).

## 对 wiki 的映射

- [paper-notebook-gaussgym-an-open-source-real-to-sim-framework-fo](../../wiki/entities/paper-notebook-gaussgym-an-open-source-real-to-sim-framework-fo.md)
