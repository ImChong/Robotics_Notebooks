...
updated: 2026-09-25
arxiv: "2608.11605"
summary: "To bridge this gap, we propose ForeWAM, a dynamics-conditioned direct-policy WAM that provides predictive context for action generation without decoding future videos. Without embodied robot data pretraining, the standar"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_11605_foresight-without-seeing-latent-futures.md
...
**Foresight Without Seeing: Latent Futures for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 359/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To bridge this gap, we propose ForeWAM, a dynamics-conditioned direct-policy WAM that provides predictive context for action generation without decoding future videos. Without embodied robot data pretraining, the standard and accelerated variants of ForeWAM achieve average success rates of 96.7% and 96.9% on LIBERO,...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.11605> |
| 子类 / 象限 | 潜空间预测与JEPA · 视觉规划与IDM · 高效推理与实时控制 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.11605) 为准。
...
**本条目的站内价值是把「Foresight Without Seeing」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_11605_foresight-without-seeing-latent-futures.md`](../../sources/papers/rcl_awesome_wam_2608_11605_foresight-without-seeing-latent-futures.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.11605)
