...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_06194_activemimic-egocentric-video-pretraining.md
...
**ActiveMimic: Egocentric Video Pretraining with Active Perception** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 069/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A pretraining framework that recovers synchronized camera and wrist trajectories from a single body-worn RGB camera to address the performance gap between egocentric video and robot data pretraining
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.06194> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.06194) 为准。
...
**本条目的站内价值是把「ActiveMimic」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_06194_activemimic-egocentric-video-pretraining.md`](../../sources/papers/sun_awesome_ego_2606_06194_activemimic-egocentric-video-pretraining.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.06194)
