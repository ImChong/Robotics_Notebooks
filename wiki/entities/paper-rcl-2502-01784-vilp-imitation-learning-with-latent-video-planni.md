...
arxiv: "2502.01784"
venue: "2025"
summary: "VILP learns observation-conditioned future videos in a compressed latent space, decodes them, and maps adjacent frames to actions through a separate low-level policy. This makes short-horizon video planning practical on"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2502_01784_vilp-imitation-learning-with-latent-vide.md
...
**VILP: Imitation Learning with Latent Video Planning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 514/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VILP learns observation-conditioned future videos in a compressed latent space, decodes them, and maps adjacent frames to actions through a separate low-level policy. This makes short-horizon video planning practical on the tested tasks and lets task videos supply information beyond scarce action labels. Simulation...
...
| 分组 | WAMs |
| 出处 | 2025 |
| 论文 | <https://arxiv.org/abs/2502.01784> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.01784) 为准。
...
**本条目的站内价值是把「VILP」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2502_01784_vilp-imitation-learning-with-latent-vide.md`](../../sources/papers/rcl_awesome_wam_2502_01784_vilp-imitation-learning-with-latent-vide.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.01784)
