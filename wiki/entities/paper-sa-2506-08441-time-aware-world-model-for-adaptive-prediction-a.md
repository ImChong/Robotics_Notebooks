...
arxiv: "2506.08441"
venue: "arXiv 2025"
code: https://github.com/anh-nn01/Time-Aware-World-Model/tree/main?tab=readme-ov-file
summary: "Time-aware world model for adaptive prediction and control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_08441_time-aware-world-model-for-adaptive-pred.md
...
**Time-Aware World Model for Adaptive Prediction and Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 336/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.08441> |
| 代码/项目 | <https://github.com/anh-nn01/Time-Aware-World-Model/tree/main?tab=readme-ov-file> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.08441) 为准。
...
**这一页能给你的是「Time-Aware World Model for Adaptive Prediction and Control」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2506_08441_time-aware-world-model-for-adaptive-pred.md`](../../sources/papers/sun_awesome_wm_2506_08441_time-aware-world-model-for-adaptive-pred.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.08441)
