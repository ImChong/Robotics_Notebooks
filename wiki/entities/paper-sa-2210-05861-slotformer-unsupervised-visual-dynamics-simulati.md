...
arxiv: "2210.05861"
venue: "arXiv 2022"
summary: "Unsupervised visual dynamics simulation with object-centric models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2210_05861_slotformer-unsupervised-visual-dynamics.md
...
**SlotFormer: Unsupervised Visual Dynamics Simulation with Object-Centric Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 132/571** 篇，分组 **45 Object-Centric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2022 |
| 论文 | <https://arxiv.org/abs/2210.05861> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2210.05861) 为准。
...
**本条目的站内价值是把「SlotFormer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2210_05861_slotformer-unsupervised-visual-dynamics.md`](../../sources/papers/sun_awesome_wm_2210_05861_slotformer-unsupervised-visual-dynamics.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2210.05861)
