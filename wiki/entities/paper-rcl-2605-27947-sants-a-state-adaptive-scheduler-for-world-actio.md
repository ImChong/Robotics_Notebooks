...
arxiv: "2605.27947"
venue: "2026"
summary: "We introduce State-Adaptive Noise Trajectory Scheduler (SANTS), a lightweight scheduler for video-to-action diffusion policies."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_27947_sants-a-state-adaptive-scheduler-for-wor.md
...
**SANTS: A State-Adaptive Scheduler for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 473/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce State-Adaptive Noise Trajectory Scheduler (SANTS), a lightweight scheduler for video-to-action diffusion policies.
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2605.27947> |
| 项目页 | <https://advanced-robotics-lab.github.io/SANTS/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.27947) 为准。
...
**本条目的站内价值是把「SANTS」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_27947_sants-a-state-adaptive-scheduler-for-wor.md`](../../sources/papers/rcl_awesome_wam_2605_27947_sants-a-state-adaptive-scheduler-for-wor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.27947)
