...
> 来源归档（ingest · awesome-bfm-papers 第 04/41）

- **标题：** Fast Imitation via Behavior Foundation Models
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 有行为基座后新动作应少走弯路；降低技能扩展的真机数据与训练成本。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 01 Forward-backward 表征，编号 **04/41**。
- **公众号导读要点：** 有行为基座后新动作应少走弯路；降低技能扩展的真机数据与训练成本。
