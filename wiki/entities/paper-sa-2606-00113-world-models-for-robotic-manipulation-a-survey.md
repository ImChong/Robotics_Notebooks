...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_00113_world-models-for-robotic-manipulation-a.md
...
**World Models for Robotic Manipulation: A Survey** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 544/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Surveys world models for robotic manipulation through three questions: what future representation to predict, how prediction connects to action, and when to use it in robot learning pipelines.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.00113> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.00113) 为准。
...
**本条目的站内价值是把「World Models for Robotic Manipulation」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_00113_world-models-for-robotic-manipulation-a.md`](../../sources/papers/sun_awesome_wm_2606_00113_world-models-for-robotic-manipulation-a.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.00113)
