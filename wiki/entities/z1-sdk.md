...
summary: "Z1 机械臂控制 SDK。"
---

# z1_sdk

**z1_sdk** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **Z1 机械臂** 主线。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/z1_sdk`](https://github.com/unitreerobotics/z1_sdk) |
| 组织分类 | Z1 机械臂 |
| 星标（2026-07-24） | ~45 |
| 最近推送 | 2025-09-22 |
| 主要语言 | C++ |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/z1_sdk.md](../../sources/repos/z1_sdk.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/z1_sdk>
