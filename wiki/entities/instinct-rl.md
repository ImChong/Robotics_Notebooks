...
# project-instinct/instinct_rl

[project-instinct/instinct_rl](https://github.com/project-instinct/instinct_rl) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「工程与实机部署」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

承担Project Instinct的算法侧，实现PPO、AMP、WASABI、MoE、VAE和DAgger等训练组件，并与InstinctLab环境接口分离；便于在不改任务定义的情况下替换策略结构与辅助损失。
...
|------|------|
| 主表分组 | 工程与实机部署 |
| 官方入口 | https://github.com/project-instinct/instinct_rl |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["project-instinct-instinct_rl"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [Project Instinct](./project-instinct.md)
- [InstinctLab](./instinctlab.md)
- [instinct_onboard](./instinct-onboard.md)
- [RL](../methods/reinforcement-learning.md)
- [HMI 覆盖索引](../queries/hmi-opensource-projects-coverage.md)

## 参考来源

- [project-instinct/instinct_rl 来源归档](../../sources/repos/instinct-rl.md)
