...
**TacCap-Gripper** 是 [千觉机器人](https://github.com/XenseRobotics-AI) 公开的 **SDK/驱动** 开源项目：TacCap 多模态触觉数据采集夹爪 SDK（C++17/Python，支持主从与腕部相机）
...
1. 从官方 GitHub/Gitee 组织检索 `TacCap-Gripper` 仓库并核对 README 许可与依赖。
