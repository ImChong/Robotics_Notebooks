...
- **计划笔记路径：** `papers/05_Locomotion/learning-to-get-up-across-morphologies-zero-shot/learning-to-get-up-across-morphologies-zero-shot.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-to-get-up-across-morphologies-zero-shot](../../wiki/entities/paper-notebook-learning-to-get-up-across-morphologies-zero-shot.md).

## 对 wiki 的映射

- [paper-notebook-learning-to-get-up-across-morphologies-zero-shot](../../wiki/entities/paper-notebook-learning-to-get-up-across-morphologies-zero-shot.md)
