...
arxiv: "2411.07690"
venue: "arXiv 2024"
summary: "Survey on safety challenges and risks of world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2411_07690_world-models-the-safety-perspective.md
...
**World Models: The Safety Perspective** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 547/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Survey on safety challenges and risks of world models.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2411.07690> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.07690) 为准。
...
- [`sources/papers/sun_awesome_wm_2411_07690_world-models-the-safety-perspective.md`](../../sources/papers/sun_awesome_wm_2411_07690_world-models-the-safety-perspective.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.07690)
