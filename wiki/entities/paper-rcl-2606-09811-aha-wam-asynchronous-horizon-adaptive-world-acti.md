...
summary: "Therefore, we propose AHA-WAM, an Asynchronous Horizon-Adaptive World-Action Model built on a dual Diffusion Transformer (DiT) architecture that reorganizes world-action modeling around this temporal asymmetry. To suppor"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_09811_aha-wam-asynchronous-horizon-adaptive-wo.md
...
**AHA-WAM:Asynchronous Horizon-Adaptive World-Action Modeling with Observation-Guided Context Routing** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 276/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Therefore, we propose AHA-WAM, an Asynchronous Horizon-Adaptive World-Action Model built on a dual Diffusion Transformer (DiT) architecture that reorganizes world-action modeling around this temporal asymmetry. To support asynchronous execution, we introduce horizon-adaptive offset training and Observation-Guided Vi...
...
| 代码/项目 | <https://github.com/serene-sivy/AHA-WAM> |
| 子类 / 象限 | 记忆与长时序 · 高效推理与实时控制 · 联合视频动作建模 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.09811) 为准。
...
**本条目的站内价值是把「AHA-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_09811_aha-wam-asynchronous-horizon-adaptive-wo.md`](../../sources/papers/rcl_awesome_wam_2606_09811_aha-wam-asynchronous-horizon-adaptive-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.09811)
