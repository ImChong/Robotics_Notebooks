...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2601_18629_exogs-a-4d-real-to-sim-to-real-framework.md
...
**ExoGS: A 4D Real-to-Sim-to-Real Framework for Scalable Manipulation Data Collection** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 036/063** 篇，分组 **41 Gaussian Splatting-based Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A robot-free 4D Real-to-Sim-to-Real framework that captures both static environments and dynamic interactions in the real world and transfers them seamlessly to a simulated environment
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2601.18629> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.18629) 为准。
...
**本条目的站内价值是把「ExoGS」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2601_18629_exogs-a-4d-real-to-sim-to-real-framework.md`](../../sources/papers/sun_awesome_r2s2r_2601_18629_exogs-a-4d-real-to-sim-to-real-framework.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.18629)
