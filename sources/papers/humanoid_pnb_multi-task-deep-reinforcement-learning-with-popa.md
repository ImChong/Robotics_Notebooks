...
- **标题：** Multi-task Deep Reinforcement Learning with PopArt
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/multi-task-deep-reinforcement-learning-with-popa/multi-task-deep-reinforcement-learning-with-popa.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-multi-task-deep-reinforcement-learning-with-popa](../../wiki/entities/paper-notebook-multi-task-deep-reinforcement-learning-with-popa.md).

## 对 wiki 的映射

- [paper-notebook-multi-task-deep-reinforcement-learning-with-popa](../../wiki/entities/paper-notebook-multi-task-deep-reinforcement-learning-with-popa.md)
