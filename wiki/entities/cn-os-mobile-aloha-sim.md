...
**mobile_aloha_sim** 是 [松灵机器人](https://github.com/agilexrobotics) 公开的 **仿真环境** 开源项目：官方仿真环境与模型接入：联调、策略回放与 Sim2Sim 验证
...
1. 从官方 GitHub/Gitee 组织检索 `mobile_aloha_sim` 仓库并核对 README 许可与依赖。
