...
status: complete
updated: 2026-09-20
summary: "Formal safety model for decision-making in autonomous systems."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_316_responsibility-sensitive-safety-rss.md
...
**Responsibility-Sensitive Safety (RSS)** 收录于 awesome-physical-ai（natnew）**第 316/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Formal safety model for decision-making in autonomous systems.
...
| 来源清单 | natnew |
| 主链接 | <https://www.mobileye.com/technology/responsibility-sensitive-safety/> |

## 核心原理

Formal safety model for decision-making in autonomous systems.

该条目在 Physical AI 清单中的角色是 **resource**，分组 **Safety & Robustness**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.mobileye.com/technology/responsibility-sensitive-safety/> |
...
- [`sources/repos/pai_awesome_resource_316_responsibility-sensitive-safety-rss.md`](../../sources/repos/pai_awesome_resource_316_responsibility-sensitive-safety-rss.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.mobileye.com/technology/responsibility-sensitive-safety/)
