...
arxiv: "2406.13945"
venue: "arXiv 2024"
code: https://github.com/tsinghua-fib-lab/CityBench
summary: "Evaluates LLMs as city-level world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2406_13945_citybench-evaluating-the-capabilities-of.md
...
**CityBench: Evaluating the Capabilities of Large Language Model as World Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 059/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Evaluates LLMs as city-level world models.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2406.13945> |
| 代码/项目 | <https://github.com/tsinghua-fib-lab/CityBench> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.13945) 为准。
...
**本条目的站内价值是把「CityBench」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2406_13945_citybench-evaluating-the-capabilities-of.md`](../../sources/papers/sun_awesome_wm_2406_13945_citybench-evaluating-the-capabilities-of.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.13945)
