...
updated: 2026-09-25
arxiv: "2608.08558"
code: https://github.com/qch-FA/Vid2WAM
summary: "In this paper, we propose Vid2WAM, an offline distillation framework that transfers visual diffusion priors from a large video foundation model into a compact WAM student. To robustly integrate synthetic and real supervi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_08558_vid2wam-distilling-video-diffusion-prior.md
...
**Vid2WAM: Distilling Video Diffusion Priors into World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 522/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this paper, we propose Vid2WAM, an offline distillation framework that transfers visual diffusion priors from a large video foundation model into a compact WAM student. To robustly integrate synthetic and real supervision, we introduce source-aware residual action adaptation that learns source-specific correction...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.08558> |
| 代码/项目 | <https://github.com/qch-FA/Vid2WAM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.08558) 为准。
...
**本条目的站内价值是把「Vid2WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_08558_vid2wam-distilling-video-diffusion-prior.md`](../../sources/papers/rcl_awesome_wam_2608_08558_vid2wam-distilling-video-diffusion-prior.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.08558)
