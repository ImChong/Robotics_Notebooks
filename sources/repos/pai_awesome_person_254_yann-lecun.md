...
- **入库日期：** 2026-09-20
- **arXiv：** （无 / 非 arXiv）
- **主链接：** <https://x.com/ylecun>
- **代码：** 未在清单中标注
- **清单摘要：** Chief AI Scientist at Meta. V-JEPA, world models, and self-supervised learning.
- **沉淀到 wiki：** [`wiki/entities/painode-254-yannlecun.md`](../../wiki/entities/painode-254-yannlecun.md)
...
- 实体页：[`wiki/entities/painode-254-yannlecun.md`](../../wiki/entities/painode-254-yannlecun.md)
