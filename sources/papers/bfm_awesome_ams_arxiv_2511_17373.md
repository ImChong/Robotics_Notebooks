...
> 来源归档（ingest · awesome-bfm-papers 第 09/41）
...
- **入库日期：** 2026-05-26
- **一句话说明：** 异构数据下敏捷与稳定权衡；MoCap/仿真/视频等混合是 BFM 数据常态。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **09/41**。
- **公众号导读要点：** 异构数据下敏捷与稳定权衡；MoCap/仿真/视频等混合是 BFM 数据常态。
