...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2401_08553_fmb-a-functional-manipulation-benchmark.md
...
**FMB: A functional manipulation benchmark for generalizable robotic learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 020/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | The International Journal of Robotics Research |
| 论文 | <https://journals.sagepub.com/doi/10.1177/02783649241276017> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://journals.sagepub.com/doi/10.1177/02783649241276017) 为准。
...
**本条目的站内价值是把「FMB」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2401_08553_fmb-a-functional-manipulation-benchmark.md`](../../sources/papers/rcl_awesome_wam_2401_08553_fmb-a-functional-manipulation-benchmark.md) — 本条目策展摘录
...
- [原文](https://journals.sagepub.com/doi/10.1177/02783649241276017)
