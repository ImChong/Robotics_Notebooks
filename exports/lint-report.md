...
- DINOv2（被 7 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
- robot（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/methods/stereo-matching-foundation-models.md（被 9 个页面引用，无 queries/comparisons 落地）
...
- wiki/entities/paper-dpt.md（缺 评测 / 对比）
...
- wiki/entities/eth3d-stereo-benchmark.md
- wiki/entities/kitti-stereo-benchmark.md
- wiki/entities/middlebury-stereo-benchmark.md
...
📊 Sources 覆盖率：3878/3878 (100%) wiki/entity 页有 ingest 来源
