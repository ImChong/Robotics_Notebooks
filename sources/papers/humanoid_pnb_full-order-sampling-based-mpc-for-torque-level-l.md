...
- **标题：** Full-Order Sampling-Based MPC for Torque-Level Locomotion Control via Diffusion-Style Annealing
- **类型：** paper
...
- **计划笔记路径：** `papers/14_Human_Motion/full-order-sampling-based-mpc-for-torque-level-l/full-order-sampling-based-mpc-for-torque-level-l.md`
- **分类：** 14_Human_Motion
...
- 知识归纳见 wiki 实体页：[paper-notebook-full-order-sampling-based-mpc-for-torque-level-l](../../wiki/entities/paper-notebook-full-order-sampling-based-mpc-for-torque-level-l.md).

## 对 wiki 的映射

- [paper-notebook-full-order-sampling-based-mpc-for-torque-level-l](../../wiki/entities/paper-notebook-full-order-sampling-based-mpc-for-torque-level-l.md)
