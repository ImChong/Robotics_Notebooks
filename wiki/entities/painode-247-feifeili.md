...
status: complete
updated: 2026-09-20
summary: "Stanford HAI, World Labs. Computer vision and spatial intelligence pioneer."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_247_fei-fei-li.md
...
**Fei-Fei Li** 收录于 awesome-physical-ai（natnew）**第 247/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Stanford HAI, World Labs. Computer vision and spatial intelligence pioneer.
...
- [`sources/repos/pai_awesome_person_247_fei-fei-li.md`](../../sources/repos/pai_awesome_person_247_fei-fei-li.md) — 本条目策展摘录
