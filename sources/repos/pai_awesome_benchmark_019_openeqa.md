...
- **代码：** 未在清单中标注
- **清单摘要：** Embodied question-answering benchmark over scanned real environments.
- **沉淀到 wiki：** [`wiki/entities/painode-019-openeqa.md`](../../wiki/entities/painode-019-openeqa.md)
...
- 实体页：[`wiki/entities/painode-019-openeqa.md`](../../wiki/entities/painode-019-openeqa.md)
