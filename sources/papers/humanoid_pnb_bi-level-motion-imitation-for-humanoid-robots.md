...
- **标题：** Bi-Level Motion Imitation for Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/bi-level-motion-imitation-for-humanoid-robots/bi-level-motion-imitation-for-humanoid-robots.md`
- **分类：** 05_Locomotion
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-bi-level-motion-imitation-for-humanoid-robots](../../wiki/entities/paper-notebook-bi-level-motion-imitation-for-humanoid-robots.md).

## 对 wiki 的映射

- [paper-notebook-bi-level-motion-imitation-for-humanoid-robots](../../wiki/entities/paper-notebook-bi-level-motion-imitation-for-humanoid-robots.md)
