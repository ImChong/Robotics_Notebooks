...
**RoboCasa365 的贡献不是新算法而是新底座：把 RoboCasa 扩到 365 任务 / 2500 场景 / 600h+ 人类演示 + 1600h 合成演示，并把「跨形态」与「基础模型、终身学习」直接写进评测设定。**

- 真正起作用的是规模与设定的组合：任务与场景数决定覆盖面，1600 小时合成演示决定能否绕开真实数据稀缺，多任务 / 基础模型 / 终身学习三种问题设定决定这批数据能被怎么用。
