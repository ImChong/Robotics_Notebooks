...
status: complete
updated: 2026-09-20
summary: "MIT's central robotics hub."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_288_mit-robotics.md
...
**MIT Robotics** 收录于 awesome-physical-ai（aichr）**第 288/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

MIT's central robotics hub.
...
- [`sources/repos/pai_awesome_lab_288_mit-robotics.md`](../../sources/repos/pai_awesome_lab_288_mit-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robotics.mit.edu/)
