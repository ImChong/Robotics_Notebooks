...
arxiv: "2606.29908"
venue: "ECCV 2026"
summary: "To address these issues, we propose SWAM (Spatial-perceiving World Action Model), a task-centric joint observation-action generation framework. Extensive experiments show that SWAM significantly outperforms state-of-the"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_29908_pondering-the-way-spatial-perceiving-wor.md
...
**Pondering the Way: Spatial-perceiving World Action Model for Embodied Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 452/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To address these issues, we propose SWAM (Spatial-perceiving World Action Model), a task-centric joint observation-action generation framework. Extensive experiments show that SWAM significantly outperforms state-of-the-art two-stage planners in success rate, trajectory accuracy, and inference efficiency, while demo...
...
| 分组 | WAMs |
| 出处 | ECCV 2026 |
| 论文 | <https://arxiv.org/abs/2606.29908> |
| 子类 / 象限 | 导航 · 联合视频动作建模 · 三维多视角建模 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.29908) 为准。
...
**本条目的站内价值是把「Pondering the Way」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_29908_pondering-the-way-spatial-perceiving-wor.md`](../../sources/papers/rcl_awesome_wam_2606_29908_pondering-the-way-spatial-perceiving-wor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.29908)
