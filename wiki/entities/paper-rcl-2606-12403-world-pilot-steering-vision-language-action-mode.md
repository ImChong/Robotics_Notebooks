...
summary: "We present World Pilot, a VLA framework that augments the policy with priors from a World-Action Model (WAM), routed into the decision chain through two complementary pathways. World Pilot attains a state-of-the-art Tota"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_12403_world-pilot-steering-vision-language-act.md
...
**World Pilot: Steering Vision-Language-Action Models with World-Action Priors** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 547/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present World Pilot, a VLA framework that augments the policy with priors from a World-Action Model (WAM), routed into the decision chain through two complementary pathways. World Pilot attains a state-of-the-art Total success rate of 84.7% on the LIBERO-Plus zero-shot OOD benchmark and the highest success rate o...
...
| 代码/项目 | <https://github.com/ZefuLin/WorldPilot> |
| 子类 / 象限 | 视觉规划与IDM · 潜空间预测与JEPA · 泛化与动作对齐 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.12403) 为准。
...
**本条目的站内价值是把「World Pilot」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_12403_world-pilot-steering-vision-language-act.md`](../../sources/papers/rcl_awesome_wam_2606_12403_world-pilot-steering-vision-language-act.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.12403)
