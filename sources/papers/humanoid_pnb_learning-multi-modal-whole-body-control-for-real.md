...
- **标题：** Learning Multi-Modal Whole-Body Control for Real-World Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/learning-multi-modal-whole-body-control-for-real/learning-multi-modal-whole-body-control-for-real.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-multi-modal-whole-body-control-for-real](../../wiki/entities/paper-notebook-learning-multi-modal-whole-body-control-for-real.md).

## 对 wiki 的映射

- [paper-notebook-learning-multi-modal-whole-body-control-for-real](../../wiki/entities/paper-notebook-learning-multi-modal-whole-body-control-for-real.md)
