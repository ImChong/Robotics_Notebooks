...
summary: "星动纪元 开源项目 video-prediction-policy（VLA/操作模型）：VLA/策略接入：模型输出动作块驱动本体执行…"
institutions:
  - roboterax
---
...
**video-prediction-policy** 是 [星动纪元](https://github.com/roboterax) 公开的 **VLA/操作模型** 开源项目：VLA/策略接入：模型输出动作块驱动本体执行
...
1. 从官方 GitHub/Gitee 组织检索 `video-prediction-policy` 仓库并核对 README 许可与依赖。
