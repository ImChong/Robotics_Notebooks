...
updated: 2026-09-20
arxiv: "2209.07753"
summary: "Program-synthesis approach that compiles language instructions into executable robot policies. <!-- tags: paper -->"
related:
...
sources:
  - ../../sources/papers/pai_awesome_2209_07753_code-as-policies.md
...
**Code as Policies** 收录于 awesome-physical-ai（natnew）**第 296/384** 条，分组 **Robotics Foundation Models**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Program-synthesis approach that compiles language instructions into executable robot policies. <!-- tags: paper -->
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2209.07753> |
| arXiv | 2209.07753 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2209.07753) 为准。
...
**本条目的站内价值是把「Code as Policies」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2209_07753_code-as-policies.md`](../../sources/papers/pai_awesome_2209_07753_code-as-policies.md) — 本条目策展摘录
