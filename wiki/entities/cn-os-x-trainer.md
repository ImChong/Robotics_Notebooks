...
**x-trainer** 是 [越疆科技](https://github.com/embodied-dobot) 公开的 **数据集/Benchmark** 开源项目：为X-Trainer协作机械臂提供VR和手柄遥操作适配、数据采集与GPU仿真训练入口。
...
1. 从官方 GitHub/Gitee 组织检索 `x-trainer` 仓库并核对 README 许可与依赖。
