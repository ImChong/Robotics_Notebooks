...
arxiv: "2502.13092"
venue: "arXiv 2025"
summary: "First benchmark for evaluating LLMs' ability to generate symbolic world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_13092_text2world-benchmarking-large-language-m.md
...
**Text2World: Benchmarking Large Language Models for Symbolic World Model Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 067/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First benchmark for evaluating LLMs' ability to generate symbolic world models.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.13092> |
| 项目页 | <https://text-to-world.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.13092) 为准。
...
**本条目的站内价值是把「Text2World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_13092_text2world-benchmarking-large-language-m.md`](../../sources/papers/sun_awesome_wm_2502_13092_text2world-benchmarking-large-language-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.13092)
