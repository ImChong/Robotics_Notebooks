...
- **标题：** VINS-Fusion: An optimization-based multi-sensor state estimator
- **类型：** paper
...
- **计划笔记路径：** `papers/09_State_Estimation/vins-fusion-an-optimization-based-multi-sensor-s/vins-fusion-an-optimization-based-multi-sensor-s.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-vins-fusion-an-optimization-based-multi-sensor-s](../../wiki/entities/paper-notebook-vins-fusion-an-optimization-based-multi-sensor-s.md).

## 对 wiki 的映射

- [paper-notebook-vins-fusion-an-optimization-based-multi-sensor-s](../../wiki/entities/paper-notebook-vins-fusion-an-optimization-based-multi-sensor-s.md)
