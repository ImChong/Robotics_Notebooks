...
**astribot_msgs** 是 [星尘智能](https://github.com/Astribot-Dev) 公开的 **仿真环境** 开源项目：公开星尘智能机器人软件栈使用的自定义消息定义，为仿真与上层模块通信提供接口基础。
...
1. 从官方 GitHub/Gitee 组织检索 `astribot_msgs` 仓库并核对 README 许可与依赖。
