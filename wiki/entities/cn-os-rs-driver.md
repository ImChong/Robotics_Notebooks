...
**rs_driver** 是 [速腾聚创](https://github.com/RoboSense-LiDAR) 公开的 **SDK/驱动** 开源项目：提供跨平台雷达驱动内核，为上层ROS或自定义应用解析速腾聚创雷达数据。
...
1. 从官方 GitHub/Gitee 组织检索 `rs_driver` 仓库并核对 README 许可与依赖。
