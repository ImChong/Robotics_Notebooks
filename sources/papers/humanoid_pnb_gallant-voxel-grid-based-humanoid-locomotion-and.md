...
- **计划笔记路径：** `papers/08_Navigation/gallant-voxel-grid-based-humanoid-locomotion-and/gallant-voxel-grid-based-humanoid-locomotion-and.md`
- **分类：** 08_Navigation
...
- 知识归纳见 wiki 实体页：[paper-notebook-gallant-voxel-grid-based-humanoid-locomotion-and](../../wiki/entities/paper-notebook-gallant-voxel-grid-based-humanoid-locomotion-and.md).

## 对 wiki 的映射

- [paper-notebook-gallant-voxel-grid-based-humanoid-locomotion-and](../../wiki/entities/paper-notebook-gallant-voxel-grid-based-humanoid-locomotion-and.md)
