...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2103_11943_bert-a-review-of-applications-in-natural.md
...
**BERT: A Review of Applications in Natural Language Processing and Understanding** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 190/564** 篇，分组 **Major category not recorded**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2021 |
| 论文 | <https://arxiv.org/abs/2103.11943> |
| 子类 / 象限 | 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2103.11943) 为准。
...
**本条目的站内价值是把「BERT」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2103_11943_bert-a-review-of-applications-in-natural.md`](../../sources/papers/rcl_awesome_wam_2103_11943_bert-a-review-of-applications-in-natural.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2103.11943)
