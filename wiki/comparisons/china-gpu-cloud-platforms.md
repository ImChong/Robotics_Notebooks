...
本地工作站不足以支撑 [Isaac Lab](../entities/isaac-lab.md)、mjlab 或多卡 [PPO](../methods/reinforcement-learning.md) 时，国内研究者常租用 **GPU 容器云/算力市场**。本页并列六类主流平台，按 **计费、存储、文档生态、仿真友好度** 选型——不是「谁绝对更好」，而是 **任务形态与预算** 匹配。
