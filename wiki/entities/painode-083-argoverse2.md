...
sources:
  - ../../sources/repos/pai_awesome_dataset_083_argoverse-2.md
...
**Argoverse 2** 收录于 awesome-physical-ai（natnew）**第 083/384** 条，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

High-quality motion-forecasting and 3D tracking datasets for real-world embodied prediction tasks.
...
| 分组 | Datasets |
| 来源清单 | natnew |
| 主链接 | <https://www.argoverse.org/av2.html> |
...
| 重定向就绪度 | **不适用**：车载运动预测 / 3D 跟踪标注，**无** 机器人关节或手姿字段；可作感知与轨迹预测预训练语料，不能重定向成本体动作（索引级判断，以官方文档 / 数据卡为准） |
...
- [`sources/repos/pai_awesome_dataset_083_argoverse-2.md`](../../sources/repos/pai_awesome_dataset_083_argoverse-2.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.argoverse.org/av2.html)
