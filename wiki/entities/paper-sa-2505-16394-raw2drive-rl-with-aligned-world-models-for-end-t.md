...
arxiv: "2505.16394"
venue: "arXiv 2025"
summary: "RL with aligned world models for end-to-end autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2505_16394_raw2drive-rl-with-aligned-world-models-f.md
...
**Raw2Drive: RL with Aligned World Models for End-to-End Autonomous Driving (in CARLA v2)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 474/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

RL with aligned world models for end-to-end autonomous driving.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.16394> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.16394) 为准。
...
**本条目的站内价值是把「Raw2Drive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2505_16394_raw2drive-rl-with-aligned-world-models-f.md`](../../sources/papers/sun_awesome_wm_2505_16394_raw2drive-rl-with-aligned-world-models-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.16394)
