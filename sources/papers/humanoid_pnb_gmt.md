...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/GMT__General_Motion_Tracking_for_Humanoid_Whole-Body_Control/GMT__General_Motion_Tracking_for_Humanoid_Whole-Body_Control.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-gmt](../../wiki/entities/paper-notebook-gmt.md).

## 对 wiki 的映射

- [paper-notebook-gmt](../../wiki/entities/paper-notebook-gmt.md)
