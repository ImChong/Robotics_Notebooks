...
arxiv: "2405.18418"
venue: "arXiv 2024"
code: https://nicklashansen.com/rlpuppeteer
summary: "Hierarchical world models as visual whole-body humanoid controllers."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2405_18418_puppeteer-hierarchical-world-models-as-v.md
...
**Puppeteer: Hierarchical World Models as Visual Whole-Body Humanoid Controllers** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 370/571** 篇，分组 **814 Locomotion & Loco-Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2405.18418> |
| 代码/项目 | <https://nicklashansen.com/rlpuppeteer> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2405.18418) 为准。
...
**本条目的站内价值是把「Puppeteer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2405_18418_puppeteer-hierarchical-world-models-as-v.md`](../../sources/papers/sun_awesome_wm_2405_18418_puppeteer-hierarchical-world-models-as-v.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2405.18418)
