...
arxiv: "2510.11892"
venue: "arXiv 2025"
summary: "Retrieval-augmented world model for computer-use agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_11892_r-wom-retrieval-augmented-world-model-fo.md
...
**R-WoM: Retrieval-augmented World Model For Computer-use Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 508/571** 篇，分组 **83 GUI / Computer-Use Agents**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Retrieval-augmented world model for computer-use agents.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.11892> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.11892) 为准。
...
**本条目的站内价值是把「R-WoM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_11892_r-wom-retrieval-augmented-world-model-fo.md`](../../sources/papers/sun_awesome_wm_2510_11892_r-wom-retrieval-augmented-world-model-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.11892)
