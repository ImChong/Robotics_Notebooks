...
updated: 2026-08-10
venue: "ECCV 2024"
summary: "Neural volumetric world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_noarxiv_463_nemo-neural-volumetric-world-models-for.md
...
**NeMo: Neural Volumetric World Models for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 463/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Neural volumetric world models.
...
| 出处 | ECCV 2024 |
| 论文 | <https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/02571.pdf> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/02571.pdf) 为准。
...
**本条目的站内价值是把「NeMo」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_noarxiv_463_nemo-neural-volumetric-world-models-for.md`](../../sources/papers/sun_awesome_wm_noarxiv_463_nemo-neural-volumetric-world-models-for.md) — 本条目策展摘录
...
- [原文](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/02571.pdf)
