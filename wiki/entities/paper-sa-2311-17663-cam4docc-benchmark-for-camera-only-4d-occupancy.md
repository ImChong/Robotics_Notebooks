...
summary: "Benchmark for camera-only 4D occupancy forecasting."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2311_17663_cam4docc-benchmark-for-camera-only-4d-oc.md
...
**Cam4DOCC: Benchmark for Camera-Only 4D Occupancy Forecasting in Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 402/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Benchmark for camera-only 4D occupancy forecasting.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2311.17663> |
| 代码/项目 | <https://github.com/haomo-ai/Cam4DOcc> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2311.17663) 为准。
...
**本条目的站内价值是把「Cam4DOCC」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2311_17663_cam4docc-benchmark-for-camera-only-4d-oc.md`](../../sources/papers/sun_awesome_wm_2311_17663_cam4docc-benchmark-for-camera-only-4d-oc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2311.17663)
