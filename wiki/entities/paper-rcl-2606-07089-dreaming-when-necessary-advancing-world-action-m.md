...
updated: 2026-09-25
arxiv: "2606.07089"
summary: "Motivated by this observation, we propose \\textbf{AdaWAM}, a world action model with adaptive multimodal reasoning abilities. Experiments on both simulated and real-world embodied tasks show that AdaWAM substantially imp"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_07089_dreaming-when-necessary-advancing-world.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Dreaming when Necessary

**Dreaming when Necessary: Advancing World Action Models with Adaptive Multi-Modal Reasoning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 317/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Motivated by this observation, we propose \textbf{AdaWAM}, a world action model with adaptive multimodal reasoning abilities. Experiments on both simulated and real-world embodied tasks show that AdaWAM substantially improves inference efficiency while outperforming state-of-the-art embodied policies.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.07089) 为准。
...
**本条目的站内价值是把「Dreaming when Necessary」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_07089_dreaming-when-necessary-advancing-world.md`](../../sources/papers/rcl_awesome_wam_2606_07089_dreaming-when-necessary-advancing-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.07089)
