...
- **标题：** Explosive Output to Enhance Jumping Ability: A Variable Reduction Ratio Design Paradigm for Humanoid Robots Knee Joint
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/explosive-output-to-enhance-jumping-ability-a-va/explosive-output-to-enhance-jumping-ability-a-va.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-explosive-output-to-enhance-jumping-ability-a-va](../../wiki/entities/paper-notebook-explosive-output-to-enhance-jumping-ability-a-va.md).

## 对 wiki 的映射

- [paper-notebook-explosive-output-to-enhance-jumping-ability-a-va](../../wiki/entities/paper-notebook-explosive-output-to-enhance-jumping-ability-a-va.md)
