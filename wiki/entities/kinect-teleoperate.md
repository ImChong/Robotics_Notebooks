...
summary: "Azure Kinect 驱动的 H1/G1 全身遥操作实现。"
---

# kinect_teleoperate

**kinect_teleoperate** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **遥操作与采数** 主线。

## 一句话定义

Azure Kinect 驱动的 H1/G1 全身遥操作实现。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/kinect_teleoperate`](https://github.com/unitreerobotics/kinect_teleoperate) |
| 组织分类 | 遥操作与采数 |
| 星标（2026-07-24） | ~117 |
| 最近推送 | 2024-08-13 |
| 主要语言 | C |
| 项目主页 | https://support.unitree.com/home/zh/Teleoperation/kinect_teleoperate |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/kinect_teleoperate.md](../../sources/repos/kinect_teleoperate.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/kinect_teleoperate>
