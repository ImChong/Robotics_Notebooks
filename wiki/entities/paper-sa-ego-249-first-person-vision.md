...
sources:
  - ../../sources/papers/sun_awesome_ego_noarxiv_249_first-person-vision.md
...
**First-Person Vision** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 249/249** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A foundational survey in the field, formally defining the research scope, core challenges and application directions of first-person vision for the first time
...
| 出处 | Proceedings of the IEEE 2012 |
| 论文 | <https://ieeexplore.ieee.org/document/6232429> |
| 项目页 | <https://ieeexplore.ieee.org/document/6232429> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/6232429) 为准。
...
**本条目的站内价值是把「First-Person Vision」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_249_first-person-vision.md`](../../sources/papers/sun_awesome_ego_noarxiv_249_first-person-vision.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/6232429)
