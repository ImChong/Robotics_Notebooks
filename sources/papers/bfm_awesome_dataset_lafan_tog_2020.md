# LAFAN（BFM 行为数据 · awesome-bfm-papers 数据集表）
...
- **出处：** 2020 · TOG
- **规模：** 77 clips · 4.6 h（列表标注）
- **论文链接：** <https://arxiv.org/abs/2102.04942>
- **代码/入口：** <https://github.com/ubisoft/ubisoft-laforge-animation-dataset>
- **索引来源：** [具身智能研究室 BFM 41 篇编译](../blogs/wechat_embodied_ai_lab_bfm_41_papers_survey.md)
- **入库日期：** 2026-05-26
- **一句话说明：** motion imitation 常用动作源。
...
- 数据集论文/页：<https://arxiv.org/abs/2102.04942>
