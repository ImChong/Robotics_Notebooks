...
arxiv: "2405.03520"
venue: "arXiv 2024"
summary: "Comprehensive survey on general world models and their relation to video generation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2405_03520_is-sora-a-world-simulator-a-comprehensiv.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Is Sora a World Simulator? A Comprehensive Survey on General World Models and...

**Is Sora a World Simulator? A Comprehensive Survey on General World Models and Beyond** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 538/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Comprehensive survey on general world models and their relation to video generation.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2405.03520> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2405.03520) 为准。
...
**本条目的站内价值是把「Is Sora a World Simulator? A Comprehensive Survey on General World Models and...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2405_03520_is-sora-a-world-simulator-a-comprehensiv.md`](../../sources/papers/sun_awesome_wm_2405_03520_is-sora-a-world-simulator-a-comprehensiv.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2405.03520)
