...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_e064f89fc62c8df5da9f_universal-manipulation-interface-in-the.md
...
**Universal Manipulation Interface: In-The-Wild Robot Teaching Without In-The-Wild Robots** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 128/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 论文 | <https://www.roboticsproceedings.org/rss20/p045.html> |
| 子类 / 象限 | 数据采集接口 · 机器人示范与操作数据 · 跨机器人与多任务数据 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.roboticsproceedings.org/rss20/p045.html) 为准。
...
**本条目的站内价值是把「Universal Manipulation Interface」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_e064f89fc62c8df5da9f_universal-manipulation-interface-in-the.md`](../../sources/papers/rcl_awesome_wam_ref_e064f89fc62c8df5da9f_universal-manipulation-interface-in-the.md) — 本条目策展摘录
...
- [原文](https://www.roboticsproceedings.org/rss20/p045.html)
