...
## [2026-08-13] lint | health-check | 自动化 wiki 健康检查
...
- damping（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/methods/cma-es.md（被 4 个页面引用，无 queries/comparisons 落地）
...
📊 Sources 覆盖率：3057/3057 (100%) wiki/entity 页有 ingest 来源
