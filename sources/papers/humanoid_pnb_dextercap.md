...
- **代码：** <https://github.com/PKU-MoCCA/dextercap>
- **数据：** <https://huggingface.co/datasets/pku-mocca/DexterHand>
- **机构：** Peking University / Tencent Robotics X
- **入库日期：** 2026-07-10
...
- 2026-07-28 项目页核查：处理/重建代码与最终 `.npz` 数据已公开；全量数据仍标为 coming soon，公开集不含原始多视角视频和中间 3D marker track，仓库未见许可证声明。
...
- 项目页归档：[dextercap](../sites/dextercap.md)
- 代码归档：[dextercap](../repos/dextercap.md)
