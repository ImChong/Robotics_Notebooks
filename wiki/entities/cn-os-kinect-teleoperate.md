...
**kinect_teleoperate** 是 [宇树科技](https://github.com/unitreerobotics) 公开的 **遥操作与数据采集** 开源项目：遥操作与数据采集：人体/设备输入映射为机器人动作并记录示范数据
...
1. 从官方 GitHub/Gitee 组织检索 `kinect_teleoperate` 仓库并核对 README 许可与依赖。
