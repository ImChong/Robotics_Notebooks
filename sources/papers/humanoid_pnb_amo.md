...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/AMO__Adaptive_Motion_Optimization_for_Hyper-Dexterous_Humanoid_Whole-Body_Contro/AMO__Adaptive_Motion_Optimization_for_Hyper-Dexterous_Humanoid_Whole-Body_Contro.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-amo](../../wiki/entities/paper-notebook-amo.md).

## 对 wiki 的映射

- [paper-notebook-amo](../../wiki/entities/paper-notebook-amo.md)
