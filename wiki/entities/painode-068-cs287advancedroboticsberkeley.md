...
status: complete
updated: 2026-09-20
summary: "Planning, learning, and control for robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_068_cs-287-advanced-robotics-berkeley.md
...
# CS 287 — Advanced Robotics (Berkeley)

**CS 287 — Advanced Robotics (Berkeley)** 收录于 awesome-physical-ai（natnew）**第 068/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Planning, learning, and control for robotics.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://people.eecs.berkeley.edu/~pabbeel/cs287-fa19/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://people.eecs.berkeley.edu/~pabbeel/cs287-fa19/> |
...
- [`sources/repos/pai_awesome_course_068_cs-287-advanced-robotics-berkeley.md`](../../sources/repos/pai_awesome_course_068_cs-287-advanced-robotics-berkeley.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://people.eecs.berkeley.edu/~pabbeel/cs287-fa19/)
