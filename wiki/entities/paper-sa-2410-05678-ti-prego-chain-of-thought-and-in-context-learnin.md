...
sources:
  - ../../sources/papers/sun_awesome_ego_2410_05678_ti-prego-chain-of-thought-and-in-context.md
...
**TI-PREGO: Chain of Thought and In-Context Learning for Online Mistake Detection in PRocedural EGOcentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 124/249** 篇，分组 **291 Procedural Error Detection**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Enhances PREGO with chain-of-thought and in-context learning for improved online error detection
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2410.05678> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.05678) 为准。
...
**本条目的站内价值是把「TI-PREGO」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2410_05678_ti-prego-chain-of-thought-and-in-context.md`](../../sources/papers/sun_awesome_ego_2410_05678_ti-prego-chain-of-thought-and-in-context.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2410.05678)
