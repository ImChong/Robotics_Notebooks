...
- **标题：** UniAct: Unified Motion Generation and Action Streaming for Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/uniact-unified-motion-generation-and-action-stre/uniact-unified-motion-generation-and-action-stre.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2512.24321>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-023-uniact](../../wiki/entities/paper-loco-manip-161-023-uniact.md).

## 对 wiki 的映射

- [paper-loco-manip-161-023-uniact](../../wiki/entities/paper-loco-manip-161-023-uniact.md)
...
- 论文：<https://arxiv.org/abs/2512.24321>
