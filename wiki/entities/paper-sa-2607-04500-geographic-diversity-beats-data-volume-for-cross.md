...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2607_04500_geographic-diversity-beats-data-volume-f.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Geographic Diversity Beats Data Volume for Cross-Domain Generalization in Zer...

**Geographic Diversity Beats Data Volume for Cross-Domain Generalization in Zero-Label JEPA Driving World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 441/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Geographic diversity outperforms data volume for cross-domain generalization; 63K geographically diverse scenes outperform 200K single-geography scenes.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2607.04500> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.04500) 为准。
...
**本条目的站内价值是把「Geographic Diversity Beats Data Volume for Cross-Domain Generalization in Zer...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2607_04500_geographic-diversity-beats-data-volume-f.md`](../../sources/papers/sun_awesome_wm_2607_04500_geographic-diversity-beats-data-volume-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.04500)
