...
arxiv: "2603.05687"
venue: "RSS 2026"
summary: "Dexterous visuotactile policy with generative contact grounding."
related:
...
sources:
  - ../../sources/papers/sun_awesome_touch_2603_05687_contact-grounded-policy-dexterous-visuot.md
...
**Contact-Grounded Policy: Dexterous Visuotactile Policy with Generative Contact Grounding** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 020/065** 篇，分组 **51 Imitation Learning with Tactile Feedback**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | RSS 2026 |
| 论文 | <https://arxiv.org/abs/2603.05687> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.05687) 为准。
...
**本条目的站内价值是把「Contact-Grounded Policy」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2603_05687_contact-grounded-policy-dexterous-visuot.md`](../../sources/papers/sun_awesome_touch_2603_05687_contact-grounded-policy-dexterous-visuot.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.05687)
