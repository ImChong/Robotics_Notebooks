...
status: complete
updated: 2026-09-20
summary: "Gemini Robotics, RT-2, and embodied AI updates."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_229_google-deepmind-blog.md
...
**Google DeepMind Blog** 收录于 awesome-physical-ai（natnew）**第 229/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Gemini Robotics, RT-2, and embodied AI updates.
...
| 来源清单 | natnew |
| 主链接 | <https://deepmind.google/blog/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://deepmind.google/blog/> |
...
- [`sources/repos/pai_awesome_community_229_google-deepmind-blog.md`](../../sources/repos/pai_awesome_community_229_google-deepmind-blog.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://deepmind.google/blog/)
