...
- **代码：** 未在清单中标注
- **清单摘要：** High-quality motion-forecasting and 3D tracking datasets for real-world embodied prediction tasks.
- **沉淀到 wiki：** [`wiki/entities/painode-083-argoverse2.md`](../../wiki/entities/painode-083-argoverse2.md)
...
- 实体页：[`wiki/entities/painode-083-argoverse2.md`](../../wiki/entities/painode-083-argoverse2.md)
