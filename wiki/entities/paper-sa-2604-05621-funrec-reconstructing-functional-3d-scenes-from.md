...
sources:
  - ../../sources/papers/sun_awesome_ego_2604_05621_funrec-reconstructing-functional-3d-scen.md
...
**FunRec: Reconstructing Functional 3D Scenes from Egocentric Interaction Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 211/249** 篇，分组 **Human Pose & Mesh Recovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Reconstructs functional 3D digital twins of indoor scenes directly from egocentric RGB-D interaction videos, discovering articulated parts and estimating kinematic parameters
...
| 出处 | CVPR 2026 |
| 论文 | <https://arxiv.org/abs/2604.05621> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.05621) 为准。
...
**本条目的站内价值是把「FunRec」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2604_05621_funrec-reconstructing-functional-3d-scen.md`](../../sources/papers/sun_awesome_ego_2604_05621_funrec-reconstructing-functional-3d-scen.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.05621)
