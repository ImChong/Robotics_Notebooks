...
- **计划笔记路径：** `papers/03_High_Impact_Selection/learning-a-vision-based-footstep-planner-for-hie/learning-a-vision-based-footstep-planner-for-hie.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-a-vision-based-footstep-planner-for-hie](../../wiki/entities/paper-notebook-learning-a-vision-based-footstep-planner-for-hie.md).

## 对 wiki 的映射

- [paper-notebook-learning-a-vision-based-footstep-planner-for-hie](../../wiki/entities/paper-notebook-learning-a-vision-based-footstep-planner-for-hie.md)
