...
- **代码：** 未在清单中标注
- **清单摘要：** Strong practical RL course with modern policy-gradient and model-based methods.
- **沉淀到 wiki：** [`wiki/entities/painode-067-cs285deepreinforcementlearningb.md`](../../wiki/entities/painode-067-cs285deepreinforcementlearningb.md)
...
- 实体页：[`wiki/entities/painode-067-cs285deepreinforcementlearningb.md`](../../wiki/entities/painode-067-cs285deepreinforcementlearningb.md)
