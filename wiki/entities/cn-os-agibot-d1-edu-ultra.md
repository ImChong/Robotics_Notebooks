...
**agibot_D1_Edu-Ultra** 是 [智元机器人](https://github.com/AgibotTech) 公开的 **SDK/驱动** 开源项目：官方 SDK：真机控制与状态读取的统一接入层
...
1. 从官方 GitHub/Gitee 组织检索 `agibot_D1_Edu-Ultra` 仓库并核对 README 许可与依赖。
