...
### 推荐读什么
- [Sim2Real](../wiki/concepts/sim2real.md) — Real2Sim 资产与迁移总图的概念枢纽
- [Sim2Real 残差适配 vs Real2Sim 真机回放 vs 真机直接微调](../wiki/comparisons/sim2real-vs-real2sim-fine-tuning.md) — 把 Real2Sim 放进"gap 在哪被消化"的三分谱系
- [物理保真度 ↔ sim2real gap](../wiki/concepts/physics-fidelity-sim2real-gap.md) — 几何/刚体/接触/执行器四层因果
- [CRISP（Contact-guided Real2Sim）](../wiki/methods/crisp-real2sim.md) — "可仿真而非好看"的代表性判据来源（跟踪失败率 55.2%→6.9%）
...
### 推荐读什么
- [CRISP vs GS-Playground：Real2Sim 路线选型（接触动力学 vs 光真实感）](../wiki/comparisons/crisp-vs-gs-playground-real2sim.md) — 本阶段的核心选型页
- [CRISP（Contact-guided Real2Sim）](../wiki/methods/crisp-real2sim.md) · [GS-Playground](../wiki/entities/gs-playground.md) — 两条维度的代表实现
- [Flexion × Niantic × NVIDIA RGB Sim2Real 管线](../wiki/entities/flexion-niantic-nvidia-rgb-sim2real-pipeline.md) — 360° 扫描 → 3DGS+碰撞 mesh 的 NuRec 数字孪生 → Isaac Lab RGB 导航零样本真机
...
- [CRISP（Real2Sim 方法页）](../wiki/methods/crisp-real2sim.md) 与 [CRISP（ICLR 2026）论文](https://arxiv.org/abs/2512.14696)
- [SimFoundry](../wiki/entities/paper-simfoundry-real2sim-scene-generation.md) 与 [SimFoundry: Modular and Automated Scene Generation for Policy Learning and Evaluation](https://arxiv.org/abs/2606.28276)
- [Agentic Real2Sim](../wiki/entities/paper-agentic-real2sim.md) 与 [Agentic Real2Sim: Physics-based World Modeling with Vision-Language Agents](https://arxiv.org/abs/2607.19190)
- [CRISP vs GS-Playground（Real2Sim）](../wiki/comparisons/crisp-vs-gs-playground-real2sim.md) 与 [gs_playground.md 仓库](https://github.com/discoverse-dev/gs_playground)
- [Sim2Real 残差适配 vs Real2Sim 真机回放对比](../wiki/comparisons/sim2real-vs-real2sim-fine-tuning.md)
- [Flexion × Niantic × NVIDIA RGB Sim2Real 管线](../wiki/entities/flexion-niantic-nvidia-rgb-sim2real-pipeline.md) 与 [Niantic Spatial, Flexion, and NVIDIA: Closing the Sim2Real Gap for Humanoids](https://flexion.ai/news/niantic-spatial-flexion-and-nvidia-closing-the-sim2real-gap-for-humanoids)
