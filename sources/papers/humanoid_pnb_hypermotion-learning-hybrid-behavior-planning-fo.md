...
- **标题：** HYPERmotion: Learning Hybrid Behavior Planning for Autonomous Loco-manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/hypermotion-learning-hybrid-behavior-planning-fo/hypermotion-learning-hybrid-behavior-planning-fo.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2406.14655v1>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-065-hypermotion](../../wiki/entities/paper-loco-manip-161-065-hypermotion.md).

## 对 wiki 的映射

- [paper-loco-manip-161-065-hypermotion](../../wiki/entities/paper-loco-manip-161-065-hypermotion.md)
...
- 论文：<https://arxiv.org/abs/2406.14655v1>
