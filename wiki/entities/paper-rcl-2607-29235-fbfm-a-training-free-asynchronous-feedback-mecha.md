...
arxiv: "2607.29235"
venue: "2026"
summary: "To address this, we propose Feedback Flow Matching (FBFM), a training-free inference mechanism that pushes re-grounding inside the actively generated chunk."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_29235_fbfm-a-training-free-asynchronous-feedba.md
...
**FBFM: A Training-Free Asynchronous Feedback Mechanism for Flow-Matching in World-Action Models Execution** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 348/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To address this, we propose Feedback Flow Matching (FBFM), a training-free inference mechanism that pushes re-grounding inside the actively generated chunk.
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2607.29235> |
| 子类 / 象限 | 高效推理与实时控制 · 记忆与长时序 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.29235) 为准。
...
**本条目的站内价值是把「FBFM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_29235_fbfm-a-training-free-asynchronous-feedba.md`](../../sources/papers/rcl_awesome_wam_2607_29235_fbfm-a-training-free-asynchronous-feedba.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.29235)
