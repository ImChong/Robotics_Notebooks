...
**Sim-to-Real Reinforcement Learning for Vision-Based Dexterous Manipulation on Humanoids** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 004/063** 篇，分组 **21 Reinforcement Learning-based Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces a practical sim-to-real RL recipe that trains a humanoid robot to perform three challenging dexterous manipulation tasks: grasp-and-reach, box lift and bimanual handover
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.20396) 为准。
...
**本条目的站内价值是把「Sim-to-Real Reinforcement Learning for Vision-Based Dexterous Manipulation on...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2502_20396_sim-to-real-reinforcement-learning-for-v.md`](../../sources/papers/sun_awesome_r2s2r_2502_20396_sim-to-real-reinforcement-learning-for-v.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.20396)
