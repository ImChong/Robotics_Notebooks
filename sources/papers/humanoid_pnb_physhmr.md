...
- **标题：** PhysHMR: Learning Humanoid Control Policies from Vision for Physically Plausible Human Motion Reconstruction
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/13_Physics-Based_Animation/PhysHMR__Learning_Humanoid_Control_Policies_from_Vision_for_Physical_HMR/PhysHMR__Learning_Humanoid_Control_Policies_from_Vision_for_Physical_HMR.html>
...
- 知识归纳见 wiki 实体页：[paper-notebook-physhmr](../../wiki/entities/paper-notebook-physhmr.md).

## 对 wiki 的映射

- [paper-notebook-physhmr](../../wiki/entities/paper-notebook-physhmr.md)
