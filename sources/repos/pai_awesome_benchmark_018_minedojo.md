...
- **代码：** 未在清单中标注
- **清单摘要：** Open-ended embodied-agent benchmark for long-horizon decision making in complex 3D worlds.
- **沉淀到 wiki：** [`wiki/entities/painode-018-minedojo.md`](../../wiki/entities/painode-018-minedojo.md)
...
- 实体页：[`wiki/entities/painode-018-minedojo.md`](../../wiki/entities/painode-018-minedojo.md)
