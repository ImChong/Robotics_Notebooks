...
summary: "小鹏 IRON CN122425667A：响应用户意图的任务队列动态重排（2026-07-21 公开/公告）；解析用户意图后动态调整预设任务序列的数量或顺序，使导览等场景可插入临时请求。…"
---

# 小鹏 IRON · 响应用户意图的任务队列动态重排（CN122425667A）

专利 **CN122425667A**（*响应用户意图的任务队列动态重排*，小鹏机器人 / IRON 相关布局，2026-07-21）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**解析用户意图后动态调整预设任务序列的数量或顺序，使导览等场景可插入临时请求。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN122425667A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn122425667a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN122425667A](https://patents.google.com/patent/CN122425667A/zh)
