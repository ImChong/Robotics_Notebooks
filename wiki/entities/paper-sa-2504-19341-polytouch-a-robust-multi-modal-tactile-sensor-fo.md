...
sources:
  - ../../sources/papers/sun_awesome_touch_2504_19341_polytouch-a-robust-multi-modal-tactile-s.md
...
**PolyTouch: A Robust Multi-Modal Tactile Sensor for Contact-rich Manipulation Using Tactile-Diffusion Policies** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 032/065** 篇，分组 **53 Diffusion Policies for Tactile Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Robot finger integrating camera-based tactile sensing, acoustic sensing, and peripheral visual sensing; at least 20-fold increase in lifespan; tactile-diffusion policy significantly outperforms haptic-oblivious policies.
...
|------|------|
| 编号 | 032/065 |
| 分组 | 53 Diffusion Policies for Tactile Manipulation |
| 出处 | ICRA 2025 (Best Paper Nominee) |
| 论文 | <https://arxiv.org/abs/2504.19341> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2504.19341) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-touch-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-touch-technology-map.md) 的 **53 Diffusion Policies for Tactile Manipulation** 分组逐条展开。
...
**本条目的站内价值是把「PolyTouch」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **53 Diffusion Policies for Tactile Manipulation** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_touch_2504_19341_polytouch-a-robust-multi-modal-tactile-s.md`](../../sources/papers/sun_awesome_touch_2504_19341_polytouch-a-robust-multi-modal-tactile-s.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2504.19341)
