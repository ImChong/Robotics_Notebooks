...
- **清单摘要：** Grasp pose generation directly from partial point clouds.
- **沉淀到 wiki：** [`wiki/entities/painode-214-contactgraspnet.md`](../../wiki/entities/painode-214-contactgraspnet.md)
...
- 实体页：[`wiki/entities/painode-214-contactgraspnet.md`](../../wiki/entities/painode-214-contactgraspnet.md)
