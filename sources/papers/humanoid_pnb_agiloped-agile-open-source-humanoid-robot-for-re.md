...
- **标题：** AGILOped: Agile Open-Source Humanoid Robot for Research
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/agiloped-agile-open-source-humanoid-robot-for-re/agiloped-agile-open-source-humanoid-robot-for-re.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-agiloped-agile-open-source-humanoid-robot-for-re](../../wiki/entities/paper-notebook-agiloped-agile-open-source-humanoid-robot-for-re.md).

## 对 wiki 的映射

- [paper-notebook-agiloped-agile-open-source-humanoid-robot-for-re](../../wiki/entities/paper-notebook-agiloped-agile-open-source-humanoid-robot-for-re.md)
