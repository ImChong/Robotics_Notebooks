...
- **代码：** 未在清单中标注
- **清单摘要：** Robot manipulation dataset with paired human demonstrations for one-shot learning research.
- **沉淀到 wiki：** [`wiki/entities/painode-092-rh20t.md`](../../wiki/entities/painode-092-rh20t.md)
...
- 实体页：[`wiki/entities/painode-092-rh20t.md`](../../wiki/entities/painode-092-rh20t.md)
