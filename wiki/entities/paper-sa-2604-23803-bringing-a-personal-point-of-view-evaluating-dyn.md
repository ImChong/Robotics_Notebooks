...
sources:
  - ../../sources/papers/sun_awesome_ego_2604_23803_bringing-a-personal-point-of-view-evalua.md
...
**Bringing a Personal Point of View: Evaluating Dynamic 3D Gaussian Splatting for Egocentric Scene Reconstruction** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 206/249** 篇，分组 **Human Pose & Mesh Recovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Systematic benchmark of dynamic 3DGS on egocentric vs. exocentric footage, confirming consistent quality degradation from the first-person viewpoint
...
| 出处 | EgoVis@CVPR 2026 |
| 论文 | <https://arxiv.org/abs/2604.23803> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.23803) 为准。
...
**本条目的站内价值是把「Bringing a Personal Point of View」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2604_23803_bringing-a-personal-point-of-view-evalua.md`](../../sources/papers/sun_awesome_ego_2604_23803_bringing-a-personal-point-of-view-evalua.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.23803)
