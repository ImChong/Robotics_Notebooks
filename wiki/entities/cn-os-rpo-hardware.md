---
type: entity
tags: [repo, china-embodied-opensource, open-source, 萝卜派对-roboparty]
status: draft
updated: 2026-09-06
related:
...
sources:
  ...
  - ../../sources/repos/rpo_hardware.md
summary: "萝卜派对（RoboParty） 开源项目 rpo_hardware（硬件开源）：RPO 人形硬件设计文件：机械结构、PCB、BOM 与制造资产…"
institutions:
  - roboparty
---
...
**rpo_hardware** 是 [萝卜派对（RoboParty）](https://github.com/Roboparty) 公开的 **硬件开源** 开源项目：RPO 人形硬件设计文件：机械结构、PCB、BOM 与制造资产
...
| 机构 | 萝卜派对（RoboParty） |
| 类别 | 硬件开源 |
| 官方组织 | https://github.com/Roboparty |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `rpo_hardware` 仓库并核对 README 许可与依赖。
...
- [rpo_hardware 源码归档](../../sources/repos/rpo_hardware.md)（<https://github.com/Roboparty/rpo_hardware>）

- [国内具身智能开源全景（微信公众号）](../../sources/blogs/wechat_embodied_station_domestic_opensource_panorama_2026-09-06.md)

## 推荐继续阅读

- [萝卜派对（RoboParty） 官方组织](https://github.com/Roboparty)
