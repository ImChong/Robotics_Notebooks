...
status: complete
updated: 2026-09-20
summary: "Safety case standard for autonomous products and systems."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_142_ul-4600.md
...
**UL 4600** 收录于 awesome-physical-ai（natnew）**第 142/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Safety case standard for autonomous products and systems.
...
| 来源清单 | natnew |
| 主链接 | <https://standardscatalog.ul.com/standards/en/standard_4600> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://standardscatalog.ul.com/standards/en/standard_4600> |
...
- [`sources/repos/pai_awesome_standard_142_ul-4600.md`](../../sources/repos/pai_awesome_standard_142_ul-4600.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://standardscatalog.ul.com/standards/en/standard_4600)
