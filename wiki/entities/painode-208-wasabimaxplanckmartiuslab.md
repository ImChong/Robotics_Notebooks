...
summary: "Versatile skill learning for quadrupeds via unsupervised motion-prior discovery from unlabeled reference data."
related:
...
sources:
  - ../../sources/repos/pai_awesome_paper_208_wasabi-max-planck-martius-lab.md
...
# WASABI (Max Planck / Martius Lab)

**WASABI (Max Planck / Martius Lab)** 收录于 awesome-physical-ai（natnew）**第 208/384** 条，分组 **Locomotion**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Versatile skill learning for quadrupeds via unsupervised motion-prior discovery from unlabeled reference data.
...
| 分组 | Locomotion |
| 来源清单 | natnew |
| 主链接 | <https://github.com/martius-lab/wasabi> |
| 代码/仓库 | <https://github.com/martius-lab/wasabi> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/martius-lab/wasabi) 为准。
...
**本条目的站内价值是把「WASABI (Max Planck / Martius Lab)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/repos/pai_awesome_paper_208_wasabi-max-planck-martius-lab.md`](../../sources/repos/pai_awesome_paper_208_wasabi-max-planck-martius-lab.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/martius-lab/wasabi)
