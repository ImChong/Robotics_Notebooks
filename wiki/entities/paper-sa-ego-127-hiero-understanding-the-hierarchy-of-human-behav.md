...
sources:
  - ../../sources/papers/sun_awesome_ego_noarxiv_127_hiero-understanding-the-hierarchy-of-hum.md
...
**HiERO: Understanding the Hierarchy of Human Behavior Enhances Reasoning on Egocentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 127/249** 篇，分组 **292 Procedural Learning**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Hierarchical behavior understanding framework that significantly boosts egocentric procedural reasoning performance
...
| 出处 | ICCV 2025 |
| 论文 | <https://github.com/facebookresearch/hiero> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/facebookresearch/hiero) 为准。
...
**本条目的站内价值是把「HiERO」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_127_hiero-understanding-the-hierarchy-of-hum.md`](../../sources/papers/sun_awesome_ego_noarxiv_127_hiero-understanding-the-hierarchy-of-hum.md) — 本条目策展摘录
...
- [原文](https://github.com/facebookresearch/hiero)
