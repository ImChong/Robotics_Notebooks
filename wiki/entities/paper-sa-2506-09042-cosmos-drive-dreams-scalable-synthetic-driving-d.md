...
arxiv: "2506.09042"
venue: "arXiv 2025"
summary: "Scalable synthetic driving data generation with world foundation models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_09042_cosmos-drive-dreams-scalable-synthetic-d.md
...
**Cosmos-Drive-Dreams: Scalable Synthetic Driving Data Generation with World Foundation Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 406/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 项目页 | <https://research.nvidia.com/labs/toronto-ai/cosmos_drive_dreams> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.09042) 为准。
...
**本条目的站内价值是把「Cosmos-Drive-Dreams」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2506_09042_cosmos-drive-dreams-scalable-synthetic-d.md`](../../sources/papers/sun_awesome_wm_2506_09042_cosmos-drive-dreams-scalable-synthetic-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.09042)
