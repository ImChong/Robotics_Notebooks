...
> 来源归档（ingest · 人形 RL 身体系统栈 42 篇 · 第 27/42）
...
- **入库日期：** 2026-05-26
- **一句话说明：** 这篇论文把 diffusion-based motion generation 和 RL-based motion tracking 结合起来，目标是 terrain-aware whole-body locomotion。

## 核心摘录（策展，非全文）

- **在身体系统栈中的位置：** 03 感知式高动态运动，编号 **27/42**。
- **公众号导读要点：** 这篇论文把 diffusion-based motion generation 和 RL-based motion tracking 结合起来，目标是 terrain-aware whole-body locomotion。
