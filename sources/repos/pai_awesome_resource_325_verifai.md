...
- **代码：** <https://github.com/berkeleylearnverify/verifai>
- **清单摘要：** Falsification and formal-analysis toolkit for autonomy and cyber-physical systems.
- **沉淀到 wiki：** [`wiki/entities/painode-325-verifai.md`](../../wiki/entities/painode-325-verifai.md)
...
- 实体页：[`wiki/entities/painode-325-verifai.md`](../../wiki/entities/painode-325-verifai.md)
