...
sources:
  - ../../sources/papers/vlnverse_lightnav_2026.md
  - ../../sources/blogs/lightorigins_lightnav_0_2026-09-01.md
summary: "VLNVerse：INSIGHT-Bench 训练 8.0% 片段来源；丰富视觉外观与空间结构。"
---

# VLNVerse

**VLNVerse**（VLNVerse：VLN 场景数据源（LightNav 数据引擎））在 [Light Origins · LightNav-0：以规模化 Real2Sim2Real 实现零样本通用导航](https://www.lightorigins.com/blog/lightnav-0) 中被引用。

## 一句话定义

**INSIGHT-Bench 训练 8.0% 片段来源；丰富视觉外观与空间结构。**
...
**VLNVerse 是 LightNav / LightParkour 管线中的关键组件——读博客数字前先对齐本页定义与开源边界。**
...
- [vlnverse_lightnav_2026.md](../../sources/papers/vlnverse_lightnav_2026.md)
