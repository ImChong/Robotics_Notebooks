...
**Reactive Diffusion Policy: Slow-Fast Visual-Tactile Policy Learning for Contact-Rich Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 033/065** 篇，分组 **53 Diffusion Policies for Tactile Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

TactAR teleoperation system with real-time tactile feedback through AR; Reactive Diffusion Policy (RDP) with two-level hierarchy for contact-rich manipulation skills.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.02881) 为准。
...
**本条目的站内价值是把「Reactive Diffusion Policy」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2503_02881_reactive-diffusion-policy-slow-fast-visu.md`](../../sources/papers/sun_awesome_touch_2503_02881_reactive-diffusion-policy-slow-fast-visu.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.02881)
