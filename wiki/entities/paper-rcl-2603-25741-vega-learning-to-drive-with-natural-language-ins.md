...
arxiv: "2603.25741"
venue: "2026"
summary: "Vega learns instruction-conditioned driving by training trajectory denoising together with future-image denoising. Modality-specific transformers exchange information through global causal attention. InstructScene suppli"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_25741_vega-learning-to-drive-with-natural-lang.md
...
**Vega: Learning to Drive with Natural Language Instructions** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 520/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Vega learns instruction-conditioned driving by training trajectory denoising together with future-image denoising. Modality-specific transformers exchange information through global causal attention. InstructScene supplies automatically generated instructions describing recorded driving. The strongest reported NAVSI...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2603.25741> |
| 子类 / 象限 | 自动驾驶 · 联合视频动作建模 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.25741) 为准。
...
**本条目的站内价值是把「Vega」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_25741_vega-learning-to-drive-with-natural-lang.md`](../../sources/papers/rcl_awesome_wam_2603_25741_vega-learning-to-drive-with-natural-lang.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.25741)
