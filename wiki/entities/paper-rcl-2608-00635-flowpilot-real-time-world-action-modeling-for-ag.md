...
updated: 2026-09-25
arxiv: "2608.00635"
summary: "We present FlowPilot, a compact world-action model for real-time onboard UAV navigation from depth. In closed-loop simulation, it outperforms learning- and optimization-based baselines under increasing clutter and comman"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_00635_flowpilot-real-time-world-action-modelin.md
...
**FlowPilot: Real-Time World-Action Modeling for Agile UAV Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 356/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 子类 / 象限 | 导航 · 联合视频动作建模 · 高效推理与实时控制 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.00635) 为准。
...
**本条目的站内价值是把「FlowPilot」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_00635_flowpilot-real-time-world-action-modelin.md`](../../sources/papers/rcl_awesome_wam_2608_00635_flowpilot-real-time-world-action-modelin.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.00635)
