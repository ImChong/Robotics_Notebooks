...
sources:
  ...
  - ../../sources/repos/models.md
summary: "星动纪元 开源项目 models（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - roboterax
---
...
**models** 是 [星动纪元](https://github.com/roboterax) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `models` 仓库并核对 README 许可与依赖。
...
- [models 源码归档](../../sources/repos/models.md)（<https://github.com/roboterax/models>）
