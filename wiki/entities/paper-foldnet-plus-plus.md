...
| 维度 | 归档口径（2026-09-14） |
|------|----------------------|
| **规模** | 6 种机器人 × 1K 件 T 恤 × 1K 环境资产，合计 **120K episode**（全合成） |
| **模态** | 仿真渲染的视觉观测 + 本体状态；归档未列出具体通道与分辨率，触觉/力反馈无提及 |
| **许可证** | **未知** — 开源状态为 **待发布**，尚无 LICENSE 可查 |
| **重定向就绪度** | 数据在 **生成阶段** 就按 6 种机器人分别渲染，等于把跨本体重定向前置解决；代价是换到这 6 种以外的本体仍需自行重新生成 |
