...
arxiv: "2604.27895"
venue: "arXiv 2026"
summary: "Taxonomy based on relational inductive biases: spatial, physical, logical."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2604_27895_graph-world-models-concepts-taxonomy-and.md
...
**Graph World Models: Concepts, Taxonomy, and Future Directions** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 135/571** 篇，分组 **46 Symbolic & Neuro-Symbolic World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Taxonomy based on relational inductive biases: spatial, physical, logical.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2604.27895> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.27895) 为准。
...
**本条目的站内价值是把「Graph World Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2604_27895_graph-world-models-concepts-taxonomy-and.md`](../../sources/papers/sun_awesome_wm_2604_27895_graph-world-models-concepts-taxonomy-and.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.27895)
