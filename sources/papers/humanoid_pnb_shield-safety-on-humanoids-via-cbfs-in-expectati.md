...
- **标题：** SHIELD: Safety on Humanoids via CBFs In Expectation on Learned Dynamics
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/shield-safety-on-humanoids-via-cbfs-in-expectati/shield-safety-on-humanoids-via-cbfs-in-expectati.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-shield-safety-on-humanoids-via-cbfs-in-expectati](../../wiki/entities/paper-notebook-shield-safety-on-humanoids-via-cbfs-in-expectati.md).

## 对 wiki 的映射

- [paper-notebook-shield-safety-on-humanoids-via-cbfs-in-expectati](../../wiki/entities/paper-notebook-shield-safety-on-humanoids-via-cbfs-in-expectati.md)
