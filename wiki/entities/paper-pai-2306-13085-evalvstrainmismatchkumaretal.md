...
updated: 2026-09-20
arxiv: "2306.13085"
summary: "Methodology paper on why offline metrics mispredict deployed robot performance."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2306_13085_eval-vs-train-mismatch-kumar-et-al.md
...
# Eval-vs-Train Mismatch (Kumar et al.)

**Eval-vs-Train Mismatch (Kumar et al.)** 收录于 awesome-physical-ai（natnew）**第 109/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Methodology paper on why offline metrics mispredict deployed robot performance.
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2306.13085> |
| arXiv | 2306.13085 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2306.13085) 为准。
...
**本条目的站内价值是把「Eval-vs-Train Mismatch (Kumar et al.)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Evaluation Methodology**，来源 natnew。
...
- [`sources/papers/pai_awesome_2306_13085_eval-vs-train-mismatch-kumar-et-al.md`](../../sources/papers/pai_awesome_2306_13085_eval-vs-train-mismatch-kumar-et-al.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2306.13085)
