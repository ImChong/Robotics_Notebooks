...
- **代码：** 未在清单中标注
- **清单摘要：** Affordable 6/7-DOF robot arms for research and development.
- **沉淀到 wiki：** [`wiki/entities/painode-174-xarm.md`](../../wiki/entities/painode-174-xarm.md)
...
- 实体页：[`wiki/entities/painode-174-xarm.md`](../../wiki/entities/painode-174-xarm.md)
