...
**Contrastive Representation Learning for Robust Sim-to-Real Transfer of Adaptive Humanoid Locomotion** 收录于 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html)（分类：10_Sim-to-Real）。本页为 **清单索引实体**，链向深读笔记与原始论文；详细机制待从笔记消化后补充。
...
- 主要风险：特权信息只在仿真中可得，蒸馏质量直接决定隐状态是否可靠；本页为笔记摘要，消融与完整指标以深读笔记与论文 PDF 为准。
