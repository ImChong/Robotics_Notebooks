...
arxiv: "2606.02372"
venue: "arXiv 2026"
summary: "Co-evolves textual world models and agent policies through closed-loop interaction."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_02372_comap-co-evolving-world-models-and-agent.md
...
**CoMap: Co-Evolving World Models and Agent Policies for LLM Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 252/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Co-evolves textual world models and agent policies through closed-loop interaction.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.02372> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.02372) 为准。
...
**本条目的站内价值是把「CoMap」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_02372_comap-co-evolving-world-models-and-agent.md`](../../sources/papers/sun_awesome_wm_2606_02372_comap-co-evolving-world-models-and-agent.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.02372)
