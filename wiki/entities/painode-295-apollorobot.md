...
sources:
  - ../../sources/repos/pai_awesome_hardware_295_apollo-robot.md
...
**Apollo Robot** 收录于 awesome-physical-ai（aichr）**第 295/384** 条，分组 **Robot Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Robot Platforms |
| 来源清单 | aichr |
| 主链接 | <https://apollo.auto/developer> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://apollo.auto/developer> |
...
- [`sources/repos/pai_awesome_hardware_295_apollo-robot.md`](../../sources/repos/pai_awesome_hardware_295_apollo-robot.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://apollo.auto/developer)
