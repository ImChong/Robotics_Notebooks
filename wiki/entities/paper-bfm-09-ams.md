...
status: complete
updated: 2026-05-26
summary: "异构数据下敏捷与稳定权衡；MoCap/仿真/视频等混合是 BFM 数据常态。"
related:
...
**Agility Meets Stability** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 09/41** 篇，归类为 **02 Goal-conditioned 学习**（2025 · arXiv）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_ams_arxiv_2511_17373.md](../../sources/papers/bfm_awesome_ams_arxiv_2511_17373.md)
