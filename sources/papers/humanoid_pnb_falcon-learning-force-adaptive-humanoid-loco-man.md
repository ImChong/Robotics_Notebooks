...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/falcon-learning-force-adaptive-humanoid-loco-man/falcon-learning-force-adaptive-humanoid-loco-man.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-falcon](../../wiki/entities/paper-notebook-falcon.md).

## 对 wiki 的映射

- [paper-notebook-falcon](../../wiki/entities/paper-notebook-falcon.md)
...
- 论文：<https://arxiv.org/abs/2505.06776>
