...
- lerobot-eval（被 7 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
- alpha（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
- ROS（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
- Task（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
### 💡 动力学/仿真/物理概念页缺回链「仿真物理保真度」知识链枢纽（信息型，不阻塞 CI）（2 个）
- wiki/concepts/hardware-in-the-loop.md
- wiki/concepts/lerobot-envhub.md
...
- wiki/concepts/lerobot-envhub.md
- wiki/entities/isaac-lab-arena.md
- wiki/entities/paper-r2s-eval.md
...
📊 Sources 覆盖率：3794/3794 (100%) wiki/entity 页有 ingest 来源
