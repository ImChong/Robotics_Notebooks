...
arxiv: "2502.13200"
venue: "arXiv 2025"
summary: "Learns to explore with predictive world models via self-supervised learning."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_13200_learning-to-explore-with-predictive-worl.md
...
**Learning To Explore With Predictive World Model Via Self-Supervised Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 260/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns to explore with predictive world models via self-supervised learning.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.13200> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.13200) 为准。
...
**本条目的站内价值是把「Learning To Explore With Predictive World Model Via Self-Supervised Learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_13200_learning-to-explore-with-predictive-worl.md`](../../sources/papers/sun_awesome_wm_2502_13200_learning-to-explore-with-predictive-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.13200)
