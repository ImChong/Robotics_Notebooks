...
- **代码：** 未在清单中标注
- **清单摘要：** Generalist policy architecture spanning embodied control and non-robotic tasks with tokenized actions. <!-- tags: paper -->
- **沉淀到 wiki：** [`wiki/entities/paper-pai-2205-06175-gato.md`](../../wiki/entities/paper-pai-2205-06175-gato.md)
...
- 实体页：[`wiki/entities/paper-pai-2205-06175-gato.md`](../../wiki/entities/paper-pai-2205-06175-gato.md)
