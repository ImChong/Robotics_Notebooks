...
arxiv: "2509.03956"
venue: "arXiv 2025"
summary: "World model implanting for test-time adaptation of embodied agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_03956_world-model-implanting-for-test-time-ada.md
...
**World Model Implanting for Test-time Adaptation of Embodied Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 358/571** 篇，分组 **813 Navigation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | 813 Navigation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.03956> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.03956) 为准。
...
**本条目的站内价值是把「World Model Implanting for Test-time Adaptation of Embodied Agents」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_03956_world-model-implanting-for-test-time-ada.md`](../../sources/papers/sun_awesome_wm_2509_03956_world-model-implanting-for-test-time-ada.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.03956)
