...
updated: 2026-09-25
arxiv: "2606.10363"
code: https://github.com/Agentic-Intelligence-Lab/HiMem-WAM
summary: "To address this, we present HiMem-WAM, a Hierarchical Memory-Gated WAM that integrates motion-centric latent actions, high-level skill latents, and boundary-triggered memory updates. Specifically, we develop a hierarchic"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_10363_himem-wam-hierarchical-memory-gated-worl.md
...
**HiMem-WAM: Hierarchical Memory-Gated World Action Models for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 240/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To address this, we present HiMem-WAM, a Hierarchical Memory-Gated WAM that integrates motion-centric latent actions, high-level skill latents, and boundary-triggered memory updates. Specifically, we develop a hierarchical latent action framework that jointly learns low-level motion and high-level skill latents, pro...
...
| 分组 | VLA |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.10363> |
| 代码/项目 | <https://github.com/Agentic-Intelligence-Lab/HiMem-WAM> |
| 子类 / 象限 | 分层与双系统VLA · 潜动作预训练 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.10363) 为准。
...
**本条目的站内价值是把「HiMem-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_10363_himem-wam-hierarchical-memory-gated-worl.md`](../../sources/papers/rcl_awesome_wam_2606_10363_himem-wam-hierarchical-memory-gated-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.10363)
