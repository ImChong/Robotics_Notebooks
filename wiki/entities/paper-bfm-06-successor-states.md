...
# Learning Successor States and Goal-Dependent Values

**Learning Successor States and Goal-Dependent Values** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 06/41** 篇，归类为 **01 Forward-backward 表征**（2021 · arXiv）。
...
| 出处 | 2021 · arXiv |
| 论文 | <https://arxiv.org/pdf/2101.07123> |
...
**这是 BFM 潜空间路线的数学底座条目：先把「未来状态分布」立成一种可复用的控制表示，之后的行为调用与目标条件检索才有落脚点。**
...
- 原始 source：[bfm_awesome_successor_states_arxiv_2101_07123.md](../../sources/papers/bfm_awesome_successor_states_arxiv_2101_07123.md)

## 参考来源

- [bfm_awesome_successor_states_arxiv_2101_07123.md](../../sources/papers/bfm_awesome_successor_states_arxiv_2101_07123.md) — awesome-bfm 策展摘录
