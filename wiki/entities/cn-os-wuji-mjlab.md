...
**wuji-mjlab** 是 [舞肌科技](https://github.com/wuji-technology) 公开的 **移动操作** 开源项目：基于mjlab训练Wuji Hand的手内物体旋转策略，公开PPO训练和Sim2Real部署入口，用于检查灵巧手接触控制从仿真到真机的完整链路。
...
1. 从官方 GitHub/Gitee 组织检索 `wuji-mjlab` 仓库并核对 README 许可与依赖。
