...
updated: 2026-09-20
arxiv: "1705.10528"
summary: "Canonical algorithmic framework for constrained safe RL."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/pai_awesome_1705_10528_constrained-policy-optimization-achi.md
...
**Constrained Policy Optimization (Achiam et al.)** 收录于 awesome-physical-ai（natnew）**第 312/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Canonical algorithmic framework for constrained safe RL.
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1705.10528> |
| arXiv | 1705.10528 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1705.10528) 为准。
...
**本条目的站内价值是把「Constrained Policy Optimization (Achiam et al.)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1705_10528_constrained-policy-optimization-achi.md`](../../sources/papers/pai_awesome_1705_10528_constrained-policy-optimization-achi.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1705.10528)
