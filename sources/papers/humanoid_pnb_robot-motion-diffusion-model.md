...
- **标题：** Robot Motion Diffusion Model: Motion Generation for Robotic Characters
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Robot_Motion_Diffusion_Model__Motion_Generation_for_Robotic_Characters/Robot_Motion_Diffusion_Model__Motion_Generation_for_Robotic_Characters.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-robot-motion-diffusion-model](../../wiki/entities/paper-notebook-robot-motion-diffusion-model.md).

## 对 wiki 的映射

- [paper-notebook-robot-motion-diffusion-model](../../wiki/entities/paper-notebook-robot-motion-diffusion-model.md)
