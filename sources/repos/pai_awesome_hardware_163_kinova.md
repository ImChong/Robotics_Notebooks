...
- **代码：** 未在清单中标注
- **清单摘要：** Lightweight assistive and research robot arms.
- **沉淀到 wiki：** [`wiki/entities/painode-163-kinova.md`](../../wiki/entities/painode-163-kinova.md)
...
- 实体页：[`wiki/entities/painode-163-kinova.md`](../../wiki/entities/painode-163-kinova.md)
