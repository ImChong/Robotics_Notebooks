...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/HMC__Learning_Heterogeneous_Meta-Control_for_Contact-Rich_Loco-Manipulation/HMC__Learning_Heterogeneous_Meta-Control_for_Contact-Rich_Loco-Manipulation.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-hmc](../../wiki/entities/paper-notebook-hmc.md).

## 对 wiki 的映射

- [paper-notebook-hmc](../../wiki/entities/paper-notebook-hmc.md)
