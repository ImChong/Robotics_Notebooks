...
# project-instinct/instinct_onboard

[project-instinct/instinct_onboard](https://github.com/project-instinct/instinct_onboard) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「工程与实机部署」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

在Ubuntu 22.04与ROS 2 Humble上读取Unitree G1 29自由度状态，用Jetson Orin NX执行ONNX策略并向机器人接口发送控制命令；它是生态中仿真策略落到板载实时循环的部署层。
...
|------|------|
| 主表分组 | 工程与实机部署 |
| 官方入口 | https://github.com/project-instinct/instinct_onboard |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["project-instinct-instinct_onboard"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [instinct_rl](./instinct-rl.md)
- [Sim2Real](../concepts/sim2real.md)
- [HMI 覆盖索引](../queries/hmi-opensource-projects-coverage.md)

## 参考来源

- [project-instinct/instinct_onboard 来源归档](../../sources/repos/instinct-onboard.md)
