...
**LaPA: Latent Action Pretraining from Videos** 收录于 [深蓝具身智能 · 世界模型 15 开源项目专题](https://mp.weixin.qq.com/s/KZT8sI4n7GvHWyM20wN3gg) **第 03/15** 篇，归类为 **01 级联架构**。本页为知识库 **策展摘要**（arXiv:2410.11758）。
