...
status: complete
updated: 2026-09-20
summary: "Robotics: Science and Systems."
related:
...
sources:
  - ../../sources/repos/pai_awesome_conference_062_rss.md
...
**RSS** 收录于 awesome-physical-ai（natnew、aichr）**第 062/384** 条，分组 **Conferences / Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew、aichr |
| 主链接 | <https://roboticsconference.org/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://roboticsconference.org/> |
...
- [`sources/repos/pai_awesome_conference_062_rss.md`](../../sources/repos/pai_awesome_conference_062_rss.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://roboticsconference.org/)
