...
arxiv: "2506.06725"
venue: "arXiv 2025"
summary: "Leverages curiosity-driven theory-making to improve LLMs' world modeling capabilities."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_06725_worldllm-improving-llms-world-modeling-u.md
...
**WorldLLM: Improving LLMs' world modeling using curiosity-driven theory-making** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 068/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Leverages curiosity-driven theory-making to improve LLMs' world modeling capabilities.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.06725> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.06725) 为准。
...
**本条目的站内价值是把「WorldLLM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2506_06725_worldllm-improving-llms-world-modeling-u.md`](../../sources/papers/sun_awesome_wm_2506_06725_worldllm-improving-llms-world-modeling-u.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.06725)
