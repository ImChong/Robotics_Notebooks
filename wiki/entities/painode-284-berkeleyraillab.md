...
status: complete
updated: 2026-09-20
summary: "Robot Autonomy and Interactive Learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_284_berkeley-rail-lab.md
...
**Berkeley RAIL Lab** 收录于 awesome-physical-ai（aichr）**第 284/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Research Labs |
| 来源清单 | aichr |
| 主链接 | <https://rail-berkeley.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://rail-berkeley.github.io/> |
...
- [`sources/repos/pai_awesome_lab_284_berkeley-rail-lab.md`](../../sources/repos/pai_awesome_lab_284_berkeley-rail-lab.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://rail-berkeley.github.io/)
