...
arxiv: "2501.16733"
venue: "arXiv 2025"
code: https://github.com/gaoyinfeng/PIWM
summary: "Predictive individual world model for driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2501_16733_dream-to-drive-with-predictive-individua.md
...
**Dream to Drive with Predictive Individual World Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 410/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Predictive individual world model for driving.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2501.16733> |
| 代码/项目 | <https://github.com/gaoyinfeng/PIWM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.16733) 为准。
...
**本条目的站内价值是把「Dream to Drive with Predictive Individual World Model」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2501_16733_dream-to-drive-with-predictive-individua.md`](../../sources/papers/sun_awesome_wm_2501_16733_dream-to-drive-with-predictive-individua.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.16733)
