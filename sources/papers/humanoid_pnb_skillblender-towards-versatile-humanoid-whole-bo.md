...
- **标题：** SkillBlender: Towards Versatile Humanoid Whole-Body Loco-Manipulation via Skill Blending
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/skillblender-towards-versatile-humanoid-whole-bo/skillblender-towards-versatile-humanoid-whole-bo.md`
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-077-skillblender](../../wiki/entities/paper-loco-manip-161-077-skillblender.md).

## 对 wiki 的映射

- [paper-loco-manip-161-077-skillblender](../../wiki/entities/paper-loco-manip-161-077-skillblender.md)
...
- 论文：<https://arxiv.org/abs/2506.09366>
