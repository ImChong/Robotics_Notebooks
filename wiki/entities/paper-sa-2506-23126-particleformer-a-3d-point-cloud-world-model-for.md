...
**ParticleFormer: A 3D Point Cloud World Model for Multi-Object, Multi-Material Robotic Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 318/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

3D point cloud world model for multi-object, multi-material robotic manipulation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.23126) 为准。
...
**这一页能给你的是「ParticleFormer」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2506_23126_particleformer-a-3d-point-cloud-world-mo.md`](../../sources/papers/sun_awesome_wm_2506_23126_particleformer-a-3d-point-cloud-world-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.23126)
