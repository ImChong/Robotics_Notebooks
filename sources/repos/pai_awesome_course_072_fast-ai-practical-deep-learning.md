...
- **代码：** 未在清单中标注
- **清单摘要：** Applied deep-learning curriculum useful for perception and representation foundations.
- **沉淀到 wiki：** [`wiki/entities/painode-072-fastaipracticaldeeplearning.md`](../../wiki/entities/painode-072-fastaipracticaldeeplearning.md)
...
- 实体页：[`wiki/entities/painode-072-fastaipracticaldeeplearning.md`](../../wiki/entities/painode-072-fastaipracticaldeeplearning.md)
