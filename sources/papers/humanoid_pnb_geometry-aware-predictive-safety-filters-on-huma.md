...
- **标题：** Geometry-Aware Predictive Safety Filters on Humanoids
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/geometry-aware-predictive-safety-filters-on-huma/geometry-aware-predictive-safety-filters-on-huma.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-geometry-aware-predictive-safety-filters-on-huma](../../wiki/entities/paper-notebook-geometry-aware-predictive-safety-filters-on-huma.md).

## 对 wiki 的映射

- [paper-notebook-geometry-aware-predictive-safety-filters-on-huma](../../wiki/entities/paper-notebook-geometry-aware-predictive-safety-filters-on-huma.md)
