...
updated: 2026-09-25
arxiv: "2607.05133"
summary: "We propose UNIVERSE, a unified video-action model built upon a single mask-modulated Diffusion Transformer. To ensure causal validity and efficient deployment, we introduce a Modality-Decoupling Visibility Mask, which sh"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_05133_universe-unified-video-action-models-for.md
...
**UNIVERSE: Unified Video Action Models for Autonomous Driving with Flexible Mask-Modulated Modality Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 500/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We propose UNIVERSE, a unified video-action model built upon a single mask-modulated Diffusion Transformer. To ensure causal validity and efficient deployment, we introduce a Modality-Decoupling Visibility Mask, which shares historical context across modalities while blocking mutual attention between future video an...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.05133> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.05133) 为准。
...
**本条目的站内价值是把「UNIVERSE」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_05133_universe-unified-video-action-models-for.md`](../../sources/papers/rcl_awesome_wam_2607_05133_universe-unified-video-action-models-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.05133)
