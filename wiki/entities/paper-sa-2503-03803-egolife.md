...
**EgoLife** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 223/249** 篇，分组 **Long Video & Episodic Memory Datasets**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
- 本页 **不做** 与具体基线的逐项数值对比；同分组的横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 的 **Long Video & Episodic Memory Datasets** 分组逐条展开。
...
- 可确证的只有清单坐标：分组 **Long Video & Episodic Memory Datasets**，以及 Highlights 点出的问题设定；本页不自行推导新结论。
