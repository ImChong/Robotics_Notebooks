...
sources:
  ...
  - ../../sources/repos/agibot_x1_hardware.md
summary: "智元机器人 开源项目 agibot_x1_hardware（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - agibot
---
...
**agibot_x1_hardware** 是 [智元机器人](https://github.com/AgibotTech) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
| 机构 | 智元机器人 |
| 类别 | 本体模型资产 |
| 官方组织 | https://github.com/AgibotTech、https://github.com/AimRT、https://github.com/OpenDriveLab |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `agibot_x1_hardware` 仓库并核对 README 许可与依赖。
...
- [agibot_x1_hardware 源码归档](../../sources/repos/agibot_x1_hardware.md)（<https://github.com/AgibotTech/agibot_x1_hardware>）

- [国内具身智能开源全景（微信公众号）](../../sources/blogs/wechat_embodied_station_domestic_opensource_panorama_2026-09-06.md)

## 推荐继续阅读

- [智元机器人 官方组织](https://github.com/AgibotTech)
