...
arxiv: "2605.14723"
venue: "arXiv 2026"
summary: "Closed-loop LLM decision making with world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_14723_reason-imagine-act-closed-loop-llm-decis.md
...
**Reason--Imagine--Act: Closed-Loop LLM Decision Making with World Models for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 476/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Closed-loop LLM decision making with world models.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.14723> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.14723) 为准。
...
**本条目的站内价值是把「Reason--Imagine--Act」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2605_14723_reason-imagine-act-closed-loop-llm-decis.md`](../../sources/papers/sun_awesome_wm_2605_14723_reason-imagine-act-closed-loop-llm-decis.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.14723)
