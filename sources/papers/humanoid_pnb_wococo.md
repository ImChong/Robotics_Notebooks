...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/WoCoCo__Learning_Whole-Body_Humanoid_Control_with_Sequential_Contacts/WoCoCo__Learning_Whole-Body_Humanoid_Control_with_Sequential_Contacts.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-wococo](../../wiki/entities/paper-notebook-wococo.md).

## 对 wiki 的映射

- [paper-notebook-wococo](../../wiki/entities/paper-notebook-wococo.md)
