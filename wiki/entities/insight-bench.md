...
summary: "INSIGHT-Bench：1683 训练场景 / 53090 片段 + 210 评测场景 / 1097 片段；覆盖 HM3D/MP3D/InteriorGS/HabitatGS/VLNVerse 与五类指代。"
---

# INSIGHT-Bench

**INSIGHT-Bench**（INSIGHT-Bench：Real2Sim2Real 导航数据引擎评测集）在 [Light Origins · LightNav-0：以规模化 Real2Sim2Real 实现零样本通用导航](https://www.lightorigins.com/blog/lightnav-0) 中被引用。

## 一句话定义

**1683 训练场景 / 53090 片段 + 210 评测场景 / 1097 片段；覆盖 HM3D/MP3D/InteriorGS/HabitatGS/VLNVerse 与五类指代。**
...
- LightNav Real2Sim2Real 引擎的可复现数据子集与评测矩阵入口。
...
**INSIGHT-Bench 是 LightNav / LightParkour 管线中的关键组件——读博客数字前先对齐本页定义与开源边界。**
