...
type: entity
tags: [paper, humanoid, amp, motion-prior, adversarial-imitation, zju]
status: complete
updated: 2026-06-11
venue: curated
...
**Natural Humanoid Robot Locomotion with Generative Motion Prior** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 06/19** 篇，归类为 **02 人形走跑**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_06_natural_humanoid_robot_locomotion_with_generativ.md](../../sources/papers/humanoid_amp_survey_06_natural_humanoid_robot_locomotion_with_generativ.md)
