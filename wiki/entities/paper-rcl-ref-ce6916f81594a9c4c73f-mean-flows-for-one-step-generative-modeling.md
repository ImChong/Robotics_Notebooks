...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_ce6916f81594a9c4c73f_mean-flows-for-one-step-generative-model.md
...
**Mean Flows for One-step Generative Modeling** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 166/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | NeurIPS 2025 |
| 论文 | <https://papers.neurips.cc/paper_files/paper/2025/hash/6d13e085b79d454da5910e4ca82a3d9d-Abstract-Conference.html> |
| 子类 / 象限 | 扩散与流匹配基础 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://papers.neurips.cc/paper_files/paper/2025/hash/6d13e085b79d454da5910e4ca82a3d9d-Abstract-Conference.html) 为准。
...
**本条目的站内价值是把「Mean Flows for One-step Generative Modeling」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_ce6916f81594a9c4c73f_mean-flows-for-one-step-generative-model.md`](../../sources/papers/rcl_awesome_wam_ref_ce6916f81594a9c4c73f_mean-flows-for-one-step-generative-model.md) — 本条目策展摘录
...
- [原文](https://papers.neurips.cc/paper_files/paper/2025/hash/6d13e085b79d454da5910e4ca82a3d9d-Abstract-Conference.html)
