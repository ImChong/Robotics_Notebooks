...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_a6e65f34d4c161a2ba59_pointnet-deep-learning-on-point-sets-for.md
...
**PointNet: Deep Learning on Point Sets for 3D Classification and Segmentation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 083/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | CVPR 2017 |
| 论文 | <https://openaccess.thecvf.com/content_cvpr_2017/html/Qi_PointNet_Deep_Learning_CVPR_2017_paper.html> |
| 子类 / 象限 | Spatial perception & geometry · 视觉编码器与表征 · 三维表示与状态估计 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openaccess.thecvf.com/content_cvpr_2017/html/Qi_PointNet_Deep_Learning_CVPR_2017_paper.html) 为准。
...
**本条目的站内价值是把「PointNet」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_a6e65f34d4c161a2ba59_pointnet-deep-learning-on-point-sets-for.md`](../../sources/papers/rcl_awesome_wam_ref_a6e65f34d4c161a2ba59_pointnet-deep-learning-on-point-sets-for.md) — 本条目策展摘录
...
- [原文](https://openaccess.thecvf.com/content_cvpr_2017/html/Qi_PointNet_Deep_Learning_CVPR_2017_paper.html)
