...
在 [AMP 运动先验专题 #05/19](../methods/motionbricks.md) 的策展叙事中，MotionBricks 被定位为 **比 Kimodo 更靠近机器人的实时身体 API**（smart primitives + G1 全身控制）；技术细节以本页为准，专题索引页仅保留策展摘要。
...
- [AMP 专题 #05 策展索引](../methods/motionbricks.md) — 19 篇专题中的叙事定位（非技术主入口）
