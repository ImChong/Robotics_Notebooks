...
> 来源归档（ingest · awesome-bfm-papers 第 20/41）

- **标题：** MoConVQ: Unified Physics-Based Motion Control via Scalable Discrete Representations
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 离散动作 token 便于规划器/语言模块组织连续轨迹。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **20/41**。
- **公众号导读要点：** 离散动作 token 便于规划器/语言模块组织连续轨迹。
