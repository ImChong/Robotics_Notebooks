...
sources:
  - ../../sources/repos/droid-policy-learning.md
  - ../../sources/repos/humanoid-motion-intelligence.md
---

# DROID Policy Learning

[DROID Policy Learning](https://github.com/droid-dataset/droid_policy_learning) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「世界模型、VLA与Agent」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

在robomimic基础上增加DROID的RLDS数据读取、训练和评测流程，并保留可选真实机器人控制接口；它把大规模异构真实示范转成可训练批次，是复现DROID策略学习的数据层入口。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| DROID | DROID | DROID Policy Learning 相关缩写，详见正文 |
...
|------|------|
| 主表分组 | 世界模型、VLA与Agent |
| 官方入口 | https://github.com/droid-dataset/droid_policy_learning |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["DROID Policy Learning"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [DROID Policy Learning 来源归档](../../sources/repos/droid-policy-learning.md)
