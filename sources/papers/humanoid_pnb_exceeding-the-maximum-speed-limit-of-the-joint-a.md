...
- **标题：** Exceeding the Maximum Speed Limit of the Joint Angle for the Redundant Tendon-driven Structures of Musculoskeletal Humanoids
- **类型：** paper
- **深读状态：** 待撰写（见 [papers/PROGRESS.md](https://github.com/ImChong/Robot_Learning_Paper_Notebooks/blob/main/papers/PROGRESS.md)）
- **计划笔记路径：** `papers/12_Hardware_Design/exceeding-the-maximum-speed-limit-of-the-joint-a/exceeding-the-maximum-speed-limit-of-the-joint-a.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-exceeding-the-maximum-speed-limit-of-the-joint-a](../../wiki/entities/paper-notebook-exceeding-the-maximum-speed-limit-of-the-joint-a.md).

## 对 wiki 的映射

- [paper-notebook-exceeding-the-maximum-speed-limit-of-the-joint-a](../../wiki/entities/paper-notebook-exceeding-the-maximum-speed-limit-of-the-joint-a.md)
