...
> 来源归档（ingest · awesome-bfm-papers 第 36/41）
...
- **入库日期：** 2026-05-26
- **一句话说明：** 视觉-语言指令压成适合全身的 latent；语义到身体接口。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 05 Hierarchical control，编号 **36/41**。
- **公众号导读要点：** 视觉-语言指令压成适合全身的 latent；语义到身体接口。
...
## 对 wiki 的映射
  ...
  - [paper-daji-anticipatory-joint-intent](../../wiki/entities/paper-daji-anticipatory-joint-intent.md)
