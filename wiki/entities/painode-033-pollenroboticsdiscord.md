...
status: complete
updated: 2026-09-20
summary: "Community for Reachy and open-source robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_033_pollen-robotics-discord.md
...
# Pollen Robotics Discord

**Pollen Robotics Discord** 收录于 awesome-physical-ai（natnew）**第 033/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Community for Reachy and open-source robotics.
...
| 分组 | Community |
| 来源清单 | natnew |
| 主链接 | <https://discord.gg/pollen-robotics> |

## 核心原理

Community for Reachy and open-source robotics.

该条目在 Physical AI 清单中的角色是 **community**，分组 **Community**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://discord.gg/pollen-robotics> |
...
- [`sources/repos/pai_awesome_community_033_pollen-robotics-discord.md`](../../sources/repos/pai_awesome_community_033_pollen-robotics-discord.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://discord.gg/pollen-robotics)
