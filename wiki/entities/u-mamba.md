...
status: complete
updated: 2026-08-12
summary: "U-Mamba 在 U-Net 式编解码中嵌入 Mamba 块，增强医学图像分割的长程上下文，对应课程作业相关的医学分割线。"
related:
...
U-Mamba 在 U-Net 式编解码中嵌入 Mamba 块，增强医学图像分割的长程上下文，对应课程作业相关的医学分割线。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| U-Mamba | U-Mamba | U-Net+Mamba 医学分割 |
| SSM | State Space Model | 长程建模 |
| U-Net | U-Net | 编解码骨架 |
| BraTS | BraTS Challenge | 脑肿瘤分割数据 |
| Dice | Dice Score | 医学分割指标 |
...
- [相关论文](https://arxiv.org/abs/2401.04722)
