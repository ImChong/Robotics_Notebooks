...
summary: "Learning contextual world models aids zero-shot generalization."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2403_10967_dreaming-of-many-worlds-learning-context.md
...
**Dreaming of Many Worlds: Learning Contextual World Models Aids Zero-Shot Generalization** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 256/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learning contextual world models aids zero-shot generalization.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2403.10967> |
| 代码/项目 | <https://github.com/sai-prasanna/dreaming_of_many_worlds> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.10967) 为准。
...
**本条目的站内价值是把「Dreaming of Many Worlds」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2403_10967_dreaming-of-many-worlds-learning-context.md`](../../sources/papers/sun_awesome_wm_2403_10967_dreaming-of-many-worlds-learning-context.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.10967)
