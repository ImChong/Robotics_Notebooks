...
- wiki/methods/genmo.md（被 12 个页面引用，无 queries/comparisons 落地）
...
- wiki/methods/motion-retargeting-gmr.md（被 22 个页面引用，无 queries/comparisons 落地）
...
📊 Sources 覆盖率：335/335 (100%) wiki/entity 页有 ingest 来源
