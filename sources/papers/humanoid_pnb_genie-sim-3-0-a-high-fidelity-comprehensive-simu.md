...
- **计划笔记路径：** `papers/06_Manipulation/genie-sim-3-0-a-high-fidelity-comprehensive-simu/genie-sim-3-0-a-high-fidelity-comprehensive-simu.md`
- **分类：** 06_Manipulation
...
- 知识归纳见 wiki 实体页：[paper-notebook-genie-sim-3-0-a-high-fidelity-comprehensive-simu](../../wiki/entities/paper-notebook-genie-sim-3-0-a-high-fidelity-comprehensive-simu.md).

## 对 wiki 的映射

- [paper-notebook-genie-sim-3-0-a-high-fidelity-comprehensive-simu](../../wiki/entities/paper-notebook-genie-sim-3-0-a-high-fidelity-comprehensive-simu.md)
