...
status: complete
updated: 2026-08-10
venue: "IEEE Trans. 2024"
summary: "Enhances sample efficiency and robustness via semantic masked world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_noarxiv_480_sem2-enhance-sample-efficiency-and-robus.md
...
**SEM2: Enhance Sample Efficiency and Robustness of End-to-End Urban Autonomous Driving via Semantic Masked World Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 480/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Enhances sample efficiency and robustness via semantic masked world models.
...
| 出处 | IEEE Trans. 2024 |
| 论文 | <https://ieeexplore.ieee.org/abstract/document/10538211/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/abstract/document/10538211/) 为准。
...
**本条目的站内价值是把「SEM2」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_noarxiv_480_sem2-enhance-sample-efficiency-and-robus.md`](../../sources/papers/sun_awesome_wm_noarxiv_480_sem2-enhance-sample-efficiency-and-robus.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/abstract/document/10538211/)
