...
arxiv: "2511.01718"
venue: "arXiv 2025"
code: https://github.com/OpenHelix-Team/UD-VLA
summary: "Unified diffusion VLA via joint discrete denoising diffusion process."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2511_01718_ud-vla-unified-diffusion-vla-via-joint-d.md
...
**UD-VLA: Unified Diffusion VLA via Joint Discrete Denoising Diffusion Process** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 205/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified diffusion VLA via joint discrete denoising diffusion process.
...
|------|------|
| 编号 | 205/571 |
| 分组 | 62 Joint WAM & Unified VLA-World Models |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2511.01718> |
| 代码/项目 | <https://github.com/OpenHelix-Team/UD-VLA> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.01718) 为准。
...
**本条目的站内价值是把「UD-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2511_01718_ud-vla-unified-diffusion-vla-via-joint-d.md`](../../sources/papers/sun_awesome_wm_2511_01718_ud-vla-unified-diffusion-vla-via-joint-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.01718)
