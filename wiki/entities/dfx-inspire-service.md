...
summary: "Inspire RH56DFX 灵巧手控制器（Serial↔DDS）。"
---

# dfx_inspire_service

**dfx_inspire_service** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **灵巧手 Serial↔DDS 服务** 主线。

## 一句话定义

Inspire RH56DFX 灵巧手控制器（Serial↔DDS）。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/dfx_inspire_service`](https://github.com/unitreerobotics/dfx_inspire_service) |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/dfx_inspire_service.md](../../sources/repos/dfx_inspire_service.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/dfx_inspire_service>
