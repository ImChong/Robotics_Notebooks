...
sources:
  ...
  - ../../sources/repos/jala.md
summary: "智在无界 开源项目 JALA（VLA/操作模型）：VLA/策略接入：模型输出动作块驱动本体执行…"
institutions:
  - agilex-ai
---
...
**JALA** 是 [智在无界](https://github.com/BeingBeyond) 公开的 **VLA/操作模型** 开源项目：VLA/策略接入：模型输出动作块驱动本体执行
...
1. 从官方 GitHub/Gitee 组织检索 `JALA` 仓库并核对 README 许可与依赖。
...
- [JALA 源码归档](../../sources/repos/jala.md)（<https://github.com/BeingBeyond/JALA>）
