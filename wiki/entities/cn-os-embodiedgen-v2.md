...
**EmbodiedGen V2** 是 [地平线](https://github.com/HorizonRobotics) 公开的 **仿真环境** 开源项目：语言、参考图和编辑指令生成带几何、材质、碰撞与可供性标注的仿真资产，再转换到SAPIEN、Isaac和MuJoCo。插件与并行任务入口把场景生成接到策略训练，可检验资产多样性是否带来下游泛化。
...
1. 从官方 GitHub/Gitee 组织检索 `EmbodiedGen V2` 仓库并核对 README 许可与依赖。
