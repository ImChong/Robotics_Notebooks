...
status: complete
updated: 2026-08-12
summary: "城市场景语义/实例分割基准（车载视角）；自动驾驶与户外移动机器人视觉评测常用。"
related:
...
**Cityscapes**：城市场景语义/实例分割基准（车载视角）；自动驾驶与户外移动机器人视觉评测常用。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| Cityscapes | Cityscapes Dataset | 城市街景精细标注集 |
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 车载分割基准的地域/天气覆盖，对应④层「评测集与部署分布重叠」陷阱
...
- [Cityscapes 官方入口](https://www.cityscapes-dataset.com/)
