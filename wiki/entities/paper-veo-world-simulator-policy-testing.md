...
related:
  ...
  - ../overview/embodied-wm-route-evaluation.md
  - ../methods/generative-world-models.md
  - ../concepts/world-action-models.md
sources:
  - ../../sources/blogs/wechat_embodied_ai_lab_wm_six_routes_survey_2026-08-25.md
summary: "Veo World Simulator（具身世界模型六路线专题）：视频基础模型改造为机器人测试场：OOD 与安全红队。"
---

# Veo World Simulator

**Veo World Simulator** 收录于 [具身智能研究室 · 具身世界模型六路线综述](https://mp.weixin.qq.com/s/mmIJRp9g6NqblMCjd9D5GQ) **评估主导型** 段。本页为知识库 **策展编译** 详情节点；量化指标以原文 PDF / 项目页为准。

## 一句话定义

视频基础模型改造为机器人测试场：OOD 与安全红队。
...
- 属于六路线 taxonomy 的 **评估主导型**：预测结果被用于 **外部策略在学习世界中考试，减少真机筛选。**
...
| **文内角色** | 视频基础模型改造为机器人测试场：OOD 与安全红队。 |

## 结论

**Veo World Simulator 在六路线框架下的读法：先看预测输出被谁消费，再看是否改善真实行动——而非只看网络新旧或画面观感。**
...
- [评估主导型 分类 hub](../overview/embodied-wm-route-evaluation.md)
