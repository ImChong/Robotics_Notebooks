...
arxiv: "2412.15109"
venue: "ICLR 2025"
code: https://github.com/InternRobotics/Seer
...
# Predictive Inverse Dynamics Models are Scalable Learners for Robotic Manipula...

**Predictive Inverse Dynamics Models are Scalable Learners for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 454/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | ICLR 2025 |
| 论文 | <https://iclr.cc/virtual/2025/poster/28455> |
| 代码/项目 | <https://github.com/InternRobotics/Seer> |
| 子类 / 象限 | 视觉规划与IDM · Q2 · One Model × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://iclr.cc/virtual/2025/poster/28455) 为准。
...
**本条目的站内价值是把「Predictive Inverse Dynamics Models are Scalable Learners for Robotic Manipula...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2412_15109_predictive-inverse-dynamics-models-are-s.md`](../../sources/papers/rcl_awesome_wam_2412_15109_predictive-inverse-dynamics-models-are-s.md) — 本条目策展摘录
...
- [原文](https://iclr.cc/virtual/2025/poster/28455)
