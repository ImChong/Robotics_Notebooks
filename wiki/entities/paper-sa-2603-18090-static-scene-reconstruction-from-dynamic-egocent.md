...
sources:
  - ../../sources/papers/sun_awesome_ego_2603_18090_static-scene-reconstruction-from-dynamic.md
...
**Static Scene Reconstruction from Dynamic Egocentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 050/249** 篇，分组 **24 Long-form Video Understanding & Structured Reasoning**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Proposes a robust pipeline that adapts static reconstruction backbones to long-form egocentric video with a mask-aware reconstruction mechanism
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.18090) 为准。
...
**本条目的站内价值是把「Static Scene Reconstruction from Dynamic Egocentric Videos」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2603_18090_static-scene-reconstruction-from-dynamic.md`](../../sources/papers/sun_awesome_ego_2603_18090_static-scene-reconstruction-from-dynamic.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.18090)
