...
status: complete
updated: 2026-09-20
summary: "Lecture series covering core deep-RL concepts and implementation practice."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_070_deep-rl-bootcamp.md
...
**Deep RL Bootcamp** 收录于 awesome-physical-ai（natnew）**第 070/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Lecture series covering core deep-RL concepts and implementation practice.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://sites.google.com/view/deep-rl-bootcamp/lectures> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://sites.google.com/view/deep-rl-bootcamp/lectures> |
...
- [`sources/repos/pai_awesome_course_070_deep-rl-bootcamp.md`](../../sources/repos/pai_awesome_course_070_deep-rl-bootcamp.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://sites.google.com/view/deep-rl-bootcamp/lectures)
