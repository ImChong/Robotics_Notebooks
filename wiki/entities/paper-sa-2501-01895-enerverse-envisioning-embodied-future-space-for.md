...
arxiv: "2501.01895"
venue: "arXiv 2025"
summary: "Envisions embodied future space for robotics manipulation."
related:
...
**EnerVerse: Envisioning Embodied Future Space for Robotics Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 292/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Envisions embodied future space for robotics manipulation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2501.01895> |
| 项目页 | <https://sites.google.com/view/enerverse> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.01895) 为准。
...
**这一页能给你的是「EnerVerse」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [原文](https://arxiv.org/abs/2501.01895)
