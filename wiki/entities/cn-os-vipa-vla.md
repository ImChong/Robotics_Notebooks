...
sources:
  ...
  - ../../sources/repos/vipa-vla.md
summary: "智在无界 开源项目 VIPA-VLA（VLA/操作模型）：VLA/策略接入：模型输出动作块驱动本体执行…"
institutions:
  - agilex-ai
---
...
**VIPA-VLA** 是 [智在无界](https://github.com/BeingBeyond) 公开的 **VLA/操作模型** 开源项目：VLA/策略接入：模型输出动作块驱动本体执行
...
1. 从官方 GitHub/Gitee 组织检索 `VIPA-VLA` 仓库并核对 README 许可与依赖。
...
- [VIPA-VLA 源码归档](../../sources/repos/vipa-vla.md)（<https://github.com/BeingBeyond/VIPA-VLA>）
