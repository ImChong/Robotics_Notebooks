...
updated: 2026-09-20
arxiv: "2105.08328"
summary: "Sim-to-real RL controllers for blind bipedal locomotion on Cassie."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2105_08328_cassie-bipedal-locomotion.md
...
# Cassie Bipedal Locomotion

**Cassie Bipedal Locomotion** 收录于 awesome-physical-ai（natnew）**第 189/384** 条，分组 **Locomotion**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real RL controllers for blind bipedal locomotion on Cassie.
...
| 分组 | Locomotion |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2105.08328> |
| arXiv | 2105.08328 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2105.08328) 为准。
...
**本条目的站内价值是把「Cassie Bipedal Locomotion」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2105_08328_cassie-bipedal-locomotion.md`](../../sources/papers/pai_awesome_2105_08328_cassie-bipedal-locomotion.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2105.08328)
