...
**Kairos** 是 [大晓机器人](https://github.com/kairos-agi) 公开的 **世界模型** 开源项目：Kairos以通用视频、人类行为和真机交互数据逐级训练持续世界表征，并在统一模型中预测未来视觉状态与可执行动作；仓库开放推理代码和多组模型权重，并提供RoboTwin与LIBERO评测入口。
...
| 机构 | 大晓机器人 |
| 类别 | 世界模型 |
| 官方组织 | https://github.com/kairos-agi |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `Kairos` 仓库并核对 README 许可与依赖。
...
- [大晓机器人 官方组织](https://github.com/kairos-agi)
