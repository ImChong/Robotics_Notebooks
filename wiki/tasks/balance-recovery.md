...
- [SD-AMP](../entities/paper-unified-walk-run-recovery-sdamp.md)、[Heracles](../entities/paper-heracles-humanoid-diffusion.md)、[HoST](../entities/paper-host-humanoid-standingup.md) — 人形恢复/起身：AMP 统一策略、生成式中间层、纯 RL 多姿态起身
