...
arxiv: "2411.19548"
venue: "arXiv 2024"
summary: "Crafts world models for driving scene reconstruction via online restoration."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2411_19548_recondreamer-crafting-world-models-for-d.md
...
**ReconDreamer: Crafting World Models for Driving Scene Reconstruction via Online Restoration** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 477/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Crafts world models for driving scene reconstruction via online restoration.
...
| 项目页 | <https://recondreamer.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.19548) 为准。
...
**本条目的站内价值是把「ReconDreamer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2411_19548_recondreamer-crafting-world-models-for-d.md`](../../sources/papers/sun_awesome_wm_2411_19548_recondreamer-crafting-world-models-for-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.19548)
