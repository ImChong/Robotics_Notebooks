...
- **代码：** <https://github.com/wz0919/ScaleVLN>

- **子类 / 象限：** 合成数据与数据生成 · 视觉语言导航数据 · 语言标注与再标注 · 不适用
- **Contribution（清单）：** RCL Awesome WAM 清单收录（Datasets）；细节以原文 PDF / 项目页为准。
- **沉淀到 wiki：** [`wiki/entities/paper-rcl-ref-3fa175f81e25ece6b23f-scaling-data-generation-in-vision-and-language-n.md`](../../wiki/entities/paper-rcl-ref-3fa175f81e25ece6b23f-scaling-data-generation-in-vision-and-language-n.md)
