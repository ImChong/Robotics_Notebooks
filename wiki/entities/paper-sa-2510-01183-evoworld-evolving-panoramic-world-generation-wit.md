...
arxiv: "2510.01183"
venue: "arXiv 2025"
code: https://github.com/JiahaoPlus/EvoWorld
summary: "Evolving panoramic world generation with explicit 3D memory."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_01183_evoworld-evolving-panoramic-world-genera.md
...
**EvoWorld: Evolving Panoramic World Generation with Explicit 3D Memory** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 093/571** 篇，分组 **43 3D & 4D World Models General Purpose**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Evolving panoramic world generation with explicit 3D memory.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.01183> |
| 代码/项目 | <https://github.com/JiahaoPlus/EvoWorld> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.01183) 为准。
...
**本条目的站内价值是把「EvoWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_01183_evoworld-evolving-panoramic-world-genera.md`](../../sources/papers/sun_awesome_wm_2510_01183_evoworld-evolving-panoramic-world-genera.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.01183)
