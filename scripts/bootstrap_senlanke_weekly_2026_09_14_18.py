...
REUSE: dict[str, dict[str, str]] = {
    ...
    "2609.20558": {"wiki": "wiki/entities/paper-g1-slope-adaptive-roofing-locomotion.md", "label": "G1 屋面斜坡"},
    ...
    "2609.18207": {"wiki": "wiki/entities/paper-real-time-expo-ft.md", "label": "Real-Time EXPO-FT"},
...
PAPERS: list[dict] = [
    {
        ...
        "related": ["../tasks/humanoid-locomotion.md", "../concepts/whole-body-control.md", "../methods/reinforcement-learning.md"],
        "abbrev": [("WBC", "Whole-Body Control", "全身控制"), ("RL", "Reinforcement Learning", "强化学习"), ("TS", "Teacher–Student", "特权–观测蒸馏")],
    },
    {
        ...
        "related": ["../tasks/teleoperation.md", "../tasks/loco-manipulation.md", "../concepts/whole-body-control.md"],
        "abbrev": [("WBC", "Whole-Body Control", "全身控制"), ("DoF", "Degrees of Freedom", "自由度"), ("HRI", "Human-Robot Interaction", "人机交互")],
    },
    {
        ...
        "related": ["../concepts/humanoid-multi-robot-coordination.md", "../tasks/loco-manipulation.md", "./paper-recal-collision-aware-wbc.md"],
        "abbrev": [("MRS", "Multi-Robot System", "多机器人系统"), ("WBC", "Whole-Body Control", "全身控制"), ("RL", "Reinforcement Learning", "强化学习")],
    },
    {
        ...
        "related": ["../tasks/locomotion.md", "../methods/reinforcement-learning.md", "../concepts/sim2real.md"],
        "abbrev": [("LEAP", "Learning Emergent Active Perception", "本文框架"), ("RL", "Reinforcement Learning", "强化学习"), ("Oracle", "Privileged Oracle", "特权上界策略")],
    },
    {
        ...
        "related": ["../tasks/locomotion.md", "../methods/vla.md", "../concepts/embodied-semantic-cognitive-map.md"],
        "abbrev": [("POSE", "Pose-aware Semantic Exploration", "本文规划器"), ("BEV", "Bird's-Eye View", "鸟瞰地图"), ("VLM", "Vision-Language Model", "视觉语言模型")],
    },
    {
        ...
        "related": ["../tasks/locomotion.md", "../entities/go2-motion-imitation.md", "../methods/reinforcement-learning.md"],
        "abbrev": [("FMHP", "Feedback-Modulated Harmonic Policies", "本文方法"), ("CPG", "Central Pattern Generator", "中枢模式发生器"), ("DoF", "Degrees of Freedom", "自由度")],
    },
    {
        "slug": "smelldiffusion",
        ...
        "abbrev": [("SLAM", "Simultaneous Localization and Mapping", "同步定位与建图"), ("RL", "Reinforcement Learning", "强化学习"), ("BEV", "Bird's-Eye View", "鸟瞰视图")],
    },
    {
        "slug": "glamdring",
        "short": "GLAMDRING",
        ...
        "abbrev": [("CPG", "Central Pattern Generator", "中枢模式发生器"), ("RL", "Reinforcement Learning", "强化学习"), ("Co-design", "Co-design", "形态–控制联合设计")],
    },
    {
        ...
        "related": ["../entities/paper-autonomous-spot-nebula-exploration.md", "../tasks/manipulation.md", "../tasks/locomotion.md"],
        "abbrev": [("DoF", "Degrees of Freedom", "自由度"), ("SLAM", "Simultaneous Localization and Mapping", "同步定位与建图"), ("CV", "Computer Vision", "计算机视觉")],
    },
    {
        "slug": "wave-go",
        "short": "WAVE-Go",
        ...
        "related": ["../methods/generative-world-models.md", "../tasks/locomotion.md", "../concepts/sim2real.md"],
        "abbrev": [("WM", "World Model", "世界模型"), ("LiDAR", "Light Detection and Ranging", "激光雷达"), ("RGB-D", "RGB-Depth", "彩色深度传感")],
    },
    {
        ...
        "related": ["../tasks/loco-manipulation.md", "../methods/reinforcement-learning.md", "../concepts/contact-dynamics.md"],
        "abbrev": [("RL", "Reinforcement Learning", "强化学习"), ("WBC", "Whole-Body Control", "全身控制"), ("EE", "End-Effector", "末端执行器")],
    },
    {
        "slug": "dr-mpc",
        "short": "DR-MPC",
        ...
        "related": ["../methods/model-predictive-control.md", "../tasks/locomotion.md", "../entities/autonomy-stack-go2.md"],
        "abbrev": [("MPC", "Model Predictive Control", "模型预测控制"), ("QP", "Quadratic Program", "二次规划"), ("IPM", "Interior Point Method", "内点法")],
    },
    {
        "slug": "adaptive-mhe",
        "short": "Adaptive-MHE",
        ...
        "related": ["../methods/model-predictive-control.md", "../tasks/loco-manipulation.md", "../methods/reinforcement-learning.md"],
        "abbrev": [("MHE", "Moving Horizon Estimation", "移动时域估计"), ("MPC", "Model Predictive Control", "模型预测控制"), ("SysID", "System Identification", "系统辨识")],
    },
    {
        ...
        "related": ["../concepts/contact-dynamics.md", "../tasks/locomotion.md", "../methods/model-predictive-control.md"],
        "abbrev": [("Wrench", "Wrench Polytope", "力旋多面体"), ("MPC", "Model Predictive Control", "模型预测控制"), ("CoM", "Center of Mass", "质心")],
    },
    {
        ...
        "related": ["../methods/reinforcement-learning.md", "../methods/residual-policy-learning.md", "../tasks/locomotion.md"],
        "abbrev": [("RL", "Reinforcement Learning", "强化学习"), ("MoE", "Mixture of Experts", "专家混合"), ("WBC", "Whole-Body Control", "全身控制")],
    },
    {
        ...
        "related": ["../formalizations/zmp-lip.md", "../tasks/humanoid-locomotion.md", "../tasks/locomotion.md"],
        "abbrev": [("GA", "Genetic Algorithm", "遗传算法"), ("ZMP", "Zero Moment Point", "零力矩点"), ("DoF", "Degrees of Freedom", "自由度")],
    },
    {
        ...
        "related": ["../methods/reinforcement-learning.md", "../tasks/locomotion.md", "../concepts/humanoid-knee-harmonic-drive-limits.md"],
        "abbrev": [("SEA", "Series Elastic Actuator", "串联弹性执行器"), ("RL", "Reinforcement Learning", "强化学习"), ("IT", "Information Theory", "信息论")],
    },
    {
        "slug": "savla",
        "short": "SAVLA",
        ...
        "abbrev": [("VLA", "Vision-Language-Action", "视觉–语言–动作"), ("FM", "Flow Matching", "流匹配"), ("SE(3)", "Special Euclidean Group", "三维刚体变换群")],
    },
    {
        "slug": "swim-vla",
        "short": "SWIM",
        ...
        "related": ["../methods/vla.md", "../tasks/manipulation.md", "../concepts/robot-simulation-three-layers.md"],
        "abbrev": [("VLA", "Vision-Language-Action", "视觉–语言–动作"), ("DoF", "Degrees of Freedom", "自由度"), ("BC", "Behavior Cloning", "行为克隆")],
    },
    {
        "slug": "xpace",
        "short": "XPACE",
        ...
        "related": ["../concepts/world-action-models.md", "../methods/generative-world-models.md", "../entities/isaac-gr00t.md"],
        "abbrev": [("WAM", "World Action Model", "世界–动作模型"), ("VLA", "Vision-Language-Action", "视觉–语言–动作"), ("IL", "Imitation Learning", "模仿学习")],
    },
    {
        ...
        "related": ["../methods/reinforcement-learning.md", "../tasks/manipulation.md", "../methods/model-predictive-control.md"],
        "abbrev": [("MPC", "Model Predictive Control", "模型预测控制"), ("SAC", "Soft Actor-Critic", "软 actor-critic"), ("RL", "Reinforcement Learning", "强化学习")],
    },
    {
        "slug": "graphpoint",
        "short": "GraphPoint",
        ...
        "related": ["../tasks/manipulation.md", "../methods/vla.md", "../concepts/behavior-tree-vla-orchestration.md"],
        "abbrev": [("VLA", "Vision-Language-Action", "视觉–语言–动作"), ("SR", "Success Rate", "成功率"), ("HOI", "Human-Object Interaction", "人–物交互")],
    },
    {
        ...
        "related": ["../tasks/manipulation.md", "../methods/vla.md", "../tasks/loco-manipulation.md"],
        "abbrev": [("LLM", "Large Language Model", "大语言模型"), ("BC", "Behavior Cloning", "行为克隆"), ("EE", "End-Effector", "末端执行器")],
    },
    {
        ...
        "related": ["../tasks/loco-manipulation.md", "../methods/reinforcement-learning.md", "../methods/diffusion-policy.md"],
        "abbrev": [("WBC", "Whole-Body Control", "全身控制"), ("EE", "End-Effector", "末端执行器"), ("RL", "Reinforcement Learning", "强化学习")],
    },
    {
        ...
        "related": ["../concepts/data-flywheel.md", "../methods/imitation-learning.md", "../tasks/manipulation.md"],
        "abbrev": [("VR", "Virtual Reality", "虚拟现实"), ("IL", "Imitation Learning", "模仿学习"), ("BC", "Behavior Cloning", "行为克隆")],
    },
    {
        "slug": "bench2dex",
        "short": "Bench2Dex",
        ...
        "abbrev": [("VLA", "Vision-Language-Action", "视觉–语言–动作"), ("BC", "Behavior Cloning", "行为克隆"), ("DP", "Diffusion Policy", "扩散策略")],
    },
]
