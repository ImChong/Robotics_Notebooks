...
- **代码：** 未在清单中标注
- **清单摘要：** Navigation benchmark focused on sim-to-real transfer and unseen-scene generalization.
- **沉淀到 wiki：** [`wiki/entities/painode-021-robothor.md`](../../wiki/entities/painode-021-robothor.md)
...
- 实体页：[`wiki/entities/painode-021-robothor.md`](../../wiki/entities/painode-021-robothor.md)
