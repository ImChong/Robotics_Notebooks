...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2507_05331_a-careful-examination-of-large-behavior.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# A Careful Examination of Large Behavior Models for Multitask Dexterous Manipu...

**A Careful Examination of Large Behavior Models for Multitask Dexterous Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 223/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | VLA |
| 出处 | Science Robotics |
| 论文 | <https://doi.org/10.1126/scirobotics.aea6201> |
| 子类 / 象限 | 扩散与流匹配VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://doi.org/10.1126/scirobotics.aea6201) 为准。
...
**本条目的站内价值是把「A Careful Examination of Large Behavior Models for Multitask Dexterous Manipu...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2507_05331_a-careful-examination-of-large-behavior.md`](../../sources/papers/rcl_awesome_wam_2507_05331_a-careful-examination-of-large-behavior.md) — 本条目策展摘录
...
- [原文](https://doi.org/10.1126/scirobotics.aea6201)
