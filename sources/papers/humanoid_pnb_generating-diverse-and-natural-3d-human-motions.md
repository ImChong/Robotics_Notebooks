...
- **标题：** Generating Diverse and Natural 3D Human Motions From Text
- **类型：** paper
...
- **计划笔记路径：** `papers/14_Human_Motion/generating-diverse-and-natural-3d-human-motions/generating-diverse-and-natural-3d-human-motions.md`
- **分类：** 14_Human_Motion
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-generating-diverse-and-natural-3d-human-motions](../../wiki/entities/paper-notebook-generating-diverse-and-natural-3d-human-motions.md).

## 对 wiki 的映射

- [paper-notebook-generating-diverse-and-natural-3d-human-motions](../../wiki/entities/paper-notebook-generating-diverse-and-natural-3d-human-motions.md)
