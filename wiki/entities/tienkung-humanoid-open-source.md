...
- **与 ROS 生态衔接**：文档声称覆盖 ROS 软件系统；实际部署请核对发行版与支持矩阵。

## 开源入口（策展摘录）

| 类型 | 链接 |
|------|------|
| 开源门户（转载） | [opensource.x-humanoid-cloud.com](https://opensource.x-humanoid-cloud.com/plugin.php?id=zhanmishu_doc:index) |
