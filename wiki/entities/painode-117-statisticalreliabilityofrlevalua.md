...
status: complete
updated: 2026-09-20
summary: "`rliable` library and methodology for confidence intervals on RL benchmarks."
related:
...
sources:
  - ../../sources/repos/pai_awesome_eval_117_statistical-reliability-of-rl-evalua.md
...
# Statistical Reliability of RL Evaluations

**Statistical Reliability of RL Evaluations** 收录于 awesome-physical-ai（natnew）**第 117/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

`rliable` library and methodology for confidence intervals on RL benchmarks.
...
| 来源清单 | natnew |
| 主链接 | <https://agarwl.github.io/rliable/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://agarwl.github.io/rliable/> |
...
- [`sources/repos/pai_awesome_eval_117_statistical-reliability-of-rl-evalua.md`](../../sources/repos/pai_awesome_eval_117_statistical-reliability-of-rl-evalua.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://agarwl.github.io/rliable/)
