...
- **代码：** 未在清单中标注
- **清单摘要：** Affordable mobile manipulator for home assistance research.
- **沉淀到 wiki：** [`wiki/entities/painode-162-hellorobotstretch.md`](../../wiki/entities/painode-162-hellorobotstretch.md)
...
- 实体页：[`wiki/entities/painode-162-hellorobotstretch.md`](../../wiki/entities/painode-162-hellorobotstretch.md)
