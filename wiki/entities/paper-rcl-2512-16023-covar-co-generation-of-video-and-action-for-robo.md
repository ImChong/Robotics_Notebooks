...
summary: "CoVAR co-generates instruction-conditioned video and robot actions through separate, interacting diffusion transformers. Bridge Attention connects a pretrained video branch to an action branch; a UNet decodes actions, wi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2512_16023_covar-co-generation-of-video-and-action.md
...
**CoVAR: Co-generation of Video and Action for Robotic Manipulation via Multi-Modal Diffusion** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 292/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

CoVAR co-generates instruction-conditioned video and robot actions through separate, interacting diffusion transformers. Bridge Attention connects a pretrained video branch to an action branch; a UNet decodes actions, with an additional refinement model for LIBERO90. Reported simulation and UR5 successes support the...
...
| 分组 | WAMs |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2512.16023> |
| 子类 / 象限 | 联合视频动作建模 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.16023) 为准。
...
**本条目的站内价值是把「CoVAR」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2512_16023_covar-co-generation-of-video-and-action.md`](../../sources/papers/rcl_awesome_wam_2512_16023_covar-co-generation-of-video-and-action.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.16023)
