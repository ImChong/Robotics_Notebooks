...
summary: "Bridges LLMs and causal world models for language agents with causal reasoning."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2410_19923_llmcwm-language-agents-meet-causality-br.md
...
**LLMCWM: Language Agents Meet Causality – Bridging LLMs and Causal World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 061/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Bridges LLMs and causal world models for language agents with causal reasoning.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2410.19923> |
| 代码/项目 | <https://github.com/j0hngou/LLMCWM/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.19923) 为准。
...
**本条目的站内价值是把「LLMCWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2410_19923_llmcwm-language-agents-meet-causality-br.md`](../../sources/papers/sun_awesome_wm_2410_19923_llmcwm-language-agents-meet-causality-br.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2410.19923)
