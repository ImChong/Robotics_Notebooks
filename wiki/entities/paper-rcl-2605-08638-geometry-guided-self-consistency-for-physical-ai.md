...
summary: "State-of-the-art physical AI models generate a chunk of actions per inference through diffusion or flow matching, iteratively refining an initial noise sample into an action trajectory. We introduce KeyStone, an inferenc"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_08638_geometry-guided-self-consistency-for-phy.md
...
**Geometry Guided Self-Consistency for Physical AI** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 235/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

State-of-the-art physical AI models generate a chunk of actions per inference through diffusion or flow matching, iteratively refining an initial noise sample into an action trajectory. We introduce KeyStone, an inference-time self-consistency method for diffusion-based action generation that draws KK candidate acti...
...
| 分组 | VLA |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.08638> |
| 代码/项目 | <https://github.com/dywsjtu/keystone> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.08638) 为准。
...
**本条目的站内价值是把「Geometry Guided Self-Consistency for Physical AI」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_08638_geometry-guided-self-consistency-for-phy.md`](../../sources/papers/rcl_awesome_wam_2605_08638_geometry-guided-self-consistency-for-phy.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.08638)
