---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, course]
status: complete
updated: 2026-09-20
summary: "Advanced RL lecture track from leading research practitioners."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_071_deepmind-x-ucl-rl-lecture-series.md
...
**DeepMind x UCL RL Lecture Series** 收录于 awesome-physical-ai（natnew）**第 071/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Advanced RL lecture track from leading research practitioners.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://www.youtube.com/playlist?list=PLqYmG7hTraZDVH599EItlEWsUOsJbAodm> |

## 核心原理

Advanced RL lecture track from leading research practitioners.

该条目在 Physical AI 清单中的角色是 **course**，分组 **Courses**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.youtube.com/playlist?list=PLqYmG7hTraZDVH599EItlEWsUOsJbAodm> |
...
- [`sources/repos/pai_awesome_course_071_deepmind-x-ucl-rl-lecture-series.md`](../../sources/repos/pai_awesome_course_071_deepmind-x-ucl-rl-lecture-series.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.youtube.com/playlist?list=PLqYmG7hTraZDVH599EItlEWsUOsJbAodm)
