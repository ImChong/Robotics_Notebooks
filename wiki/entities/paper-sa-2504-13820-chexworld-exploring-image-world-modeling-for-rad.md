...
arxiv: "2504.13820"
venue: "arXiv 2025"
code: https://github.com/LeapLabTHU/CheXWorld
summary: "Explores image world modeling for radiograph representation learning."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2504_13820_chexworld-exploring-image-world-modeling.md
...
**CheXWorld: Exploring Image World Modeling for Radiograph Representation Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 518/571** 篇，分组 **84 Scientific Discovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Explores image world modeling for radiograph representation learning.
...
|------|------|
| 编号 | 518/571 |
| 分组 | 84 Scientific Discovery |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2504.13820> |
| 代码/项目 | <https://github.com/LeapLabTHU/CheXWorld> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2504.13820) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 的 **84 Scientific Discovery** 分组逐条展开。
...
**本条目的站内价值是把「CheXWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **84 Scientific Discovery** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_wm_2504_13820_chexworld-exploring-image-world-modeling.md`](../../sources/papers/sun_awesome_wm_2504_13820_chexworld-exploring-image-world-modeling.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2504.13820)
