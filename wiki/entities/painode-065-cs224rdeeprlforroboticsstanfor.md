...
status: complete
updated: 2026-09-20
summary: "Deep reinforcement learning for real-world robots."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_065_cs-224r-deep-rl-for-robotics-stanfor.md
...
# CS 224R — Deep RL for Robotics (Stanford)

**CS 224R — Deep RL for Robotics (Stanford)** 收录于 awesome-physical-ai（natnew、aichr）**第 065/384** 条，分组 **Courses / Courses & Tutorials**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Deep reinforcement learning for real-world robots.
...
|------|------|
| 编号 | 065/384 |
| 分组 | Courses / Courses & Tutorials |
| 来源清单 | natnew、aichr |
| 主链接 | <http://cs224r.stanford.edu/> |

## 核心原理

Deep reinforcement learning for real-world robots.

该条目在 Physical AI 清单中的角色是 **course**，分组 **Courses / Courses & Tutorials**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
- [`sources/repos/pai_awesome_course_065_cs-224r-deep-rl-for-robotics-stanfor.md`](../../sources/repos/pai_awesome_course_065_cs-224r-deep-rl-for-robotics-stanfor.md) — 本条目策展摘录
...
- [原文 / 官方入口](http://cs224r.stanford.edu/)
