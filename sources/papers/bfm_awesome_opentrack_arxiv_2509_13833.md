...
> 来源归档（ingest · awesome-bfm-papers 第 08/41）
...
- **入库日期：** 2026-05-26
- **一句话说明：** 跟踪 + 抗扰一体；被推撞后仍能接住才算可用身体能力。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **08/41**。
- **公众号导读要点：** 跟踪 + 抗扰一体；被推撞后仍能接住才算可用身体能力。
...
## 对 wiki 的映射
  ...
  - [any2track](../../wiki/methods/any2track.md)
