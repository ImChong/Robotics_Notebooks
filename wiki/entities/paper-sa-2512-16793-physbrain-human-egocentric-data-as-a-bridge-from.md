...
arxiv: "2512.16793"
venue: "arXiv 2025"
summary: "Converts first-person human videos into embodied supervision data"
related:
...
**PhysBrain: Human Egocentric Data as a Bridge from Vision Language Models to Physical Intelligence** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 192/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Converts first-person human videos into embodied supervision data
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2512.16793> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.16793) 为准。
...
**本条目的站内价值是把「PhysBrain」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2512_16793_physbrain-human-egocentric-data-as-a-bri.md`](../../sources/papers/sun_awesome_ego_2512_16793_physbrain-human-egocentric-data-as-a-bri.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.16793)
