...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_219f4f2dd6b959414001_cross-embodiment-dexterous-manipulation.md
...
**Cross-Embodiment Dexterous Manipulation through World Model Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 297/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 编号 | 297/564 |
| 分组 | WAMs |
| 出处 | CoRL 2025 Workshop on Learning to Simulate Robot Worlds |
| 论文 | <https://openreview.net/forum?id=1P9LOCLE2G> |
| 子类 / 象限 | 三维多视角建模 · 泛化与动作对齐 · 待核实 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=1P9LOCLE2G) 为准。
...
**本条目的站内价值是把「Cross-Embodiment Dexterous Manipulation through World Model Learning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_219f4f2dd6b959414001_cross-embodiment-dexterous-manipulation.md`](../../sources/papers/rcl_awesome_wam_ref_219f4f2dd6b959414001_cross-embodiment-dexterous-manipulation.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=1P9LOCLE2G)
