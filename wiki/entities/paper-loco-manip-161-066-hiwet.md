...
related:
  ...
  - ../entities/paper-loco-manip-161-041-hiwet.md
sources:
  - ../../sources/papers/loco_manip_161_survey_066_hiwet.md
...
**HiWET** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 066/161** 篇，归类为 **03 视觉感知驱动的人形移动操作**。
...
- HiWET 先从相机图像/多视角观测、本体状态与关节序列、仿真交互数据恢复场景、目标或运动表征，再用PPO/RL 策略训练、VLM 语义规划/路由、分层技能/专家策略生成末端执行器/腕手目标。关键点是把任务拆成可路由的技能或专家策略，再用高层模块在执行中选择和组合。
- 人形 Loco-Manip 161 篇 **#066/161** · 视觉感知驱动的人形移动操作。
...
- 原始 source：[loco_manip_161_survey_066_hiwet.md](../../sources/papers/loco_manip_161_survey_066_hiwet.md)

## 参考来源

- [loco_manip_161_survey_066_hiwet.md](../../sources/papers/loco_manip_161_survey_066_hiwet.md) — 161 篇策展摘录
