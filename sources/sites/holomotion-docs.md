# HoloMotion 文档站（horizonrobotics.github.io/robot_lab/holomotion）

> 来源归档（ingest 配套站点）

- **URL：** <https://horizonrobotics.github.io/robot_lab/holomotion>
- **标题：** HoloMotion / HoloMotion-1 官方文档
...
| 产物 | 状态 |
|------|------|
| 代码 | **已开源** · [HorizonRobotics/HoloMotion](https://github.com/HorizonRobotics/HoloMotion) |
| 文档站 | **已上线**（本页） |
| HF 权重 | **已发布** |
| Docker | **已发布** |
...
- [HoloMotion 实体](../../wiki/entities/holomotion.md)
- [仓库归档](../repos/horizon_robotics_holomotion.md)
- [技术报告摘录](../papers/holomotion_arxiv_2605_15336.md)
