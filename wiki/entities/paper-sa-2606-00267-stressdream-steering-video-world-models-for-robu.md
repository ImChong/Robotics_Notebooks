...
summary: "Steers video world models for robust policy evaluation and improvement."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_00267_stressdream-steering-video-world-models.md
...
**StressDream: Steering Video World Models for Robust Policy Evaluation and Improvement** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 392/571** 篇，分组 **816 Policy Evaluation with World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Steers video world models for robust policy evaluation and improvement.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.00267> |
| 代码/项目 | <https://github.com/CMU-IntentLab/StressDream> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.00267) 为准。
...
**本条目的站内价值是把「StressDream」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_00267_stressdream-steering-video-world-models.md`](../../sources/papers/sun_awesome_wm_2606_00267_stressdream-steering-video-world-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.00267)
