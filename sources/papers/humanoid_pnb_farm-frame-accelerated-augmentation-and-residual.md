...
- **标题：** FARM: Frame-Accelerated Augmentation and Residual Mixture-of-Experts for Physics-Based High-Dynamic Humanoid Control
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/farm-frame-accelerated-augmentation-and-residual/farm-frame-accelerated-augmentation-and-residual.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-farm-frame-accelerated-augmentation-and-residual](../../wiki/entities/paper-notebook-farm-frame-accelerated-augmentation-and-residual.md).

## 对 wiki 的映射

- [paper-notebook-farm-frame-accelerated-augmentation-and-residual](../../wiki/entities/paper-notebook-farm-frame-accelerated-augmentation-and-residual.md)
