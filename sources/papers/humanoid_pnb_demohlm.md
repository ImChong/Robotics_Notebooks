...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/DemoHLM__From_One_Demonstration_to_Generalizable_Humanoid_Loco-Manipulation/DemoHLM__From_One_Demonstration_to_Generalizable_Humanoid_Loco-Manipulation.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-demohlm](../../wiki/entities/paper-notebook-demohlm.md).

## 对 wiki 的映射

- [paper-notebook-demohlm](../../wiki/entities/paper-notebook-demohlm.md)
