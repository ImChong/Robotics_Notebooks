...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Kinematics-Aware_Multi-Policy_Reinforcement_Learning_for_Force-Capable_Humanoid_/Kinematics-Aware_Multi-Policy_Reinforcement_Learning_for_Force-Capable_Humanoid_.md`
