...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2603_18719_ontology-guided-diffusion-for-zero-shot.md
...
**Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 020/063** 篇，分组 **24 Foundation Model-enhanced Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Ontology-guided diffusion for zero-shot visual sim-to-real transfer
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.18719) 为准。
...
**本条目的站内价值是把「Ontology-Guided Diffusion for Zero-Shot Visual Sim2Real Transfer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2603_18719_ontology-guided-diffusion-for-zero-shot.md`](../../sources/papers/sun_awesome_r2s2r_2603_18719_ontology-guided-diffusion-for-zero-shot.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.18719)
