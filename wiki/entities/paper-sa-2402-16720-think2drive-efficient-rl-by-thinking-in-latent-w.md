...
arxiv: "2402.16720"
venue: "arXiv 2024"
summary: "Efficient RL by thinking in latent world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2402_16720_think2drive-efficient-rl-by-thinking-in.md
...
**Think2Drive: Efficient RL by Thinking in Latent World Model for Quasi-Realistic Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 487/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Efficient RL by thinking in latent world models.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2402.16720> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2402.16720) 为准。
...
**本条目的站内价值是把「Think2Drive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2402_16720_think2drive-efficient-rl-by-thinking-in.md`](../../sources/papers/sun_awesome_wm_2402_16720_think2drive-efficient-rl-by-thinking-in.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2402.16720)
