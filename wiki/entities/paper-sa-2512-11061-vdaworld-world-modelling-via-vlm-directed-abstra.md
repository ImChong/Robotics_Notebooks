...
arxiv: "2512.11061"
venue: "arXiv 2025"
summary: "VLMs act as agents to autonomously construct scene representations and select compatible physics simulators (rigid‑body, fluid, etc.), inferring latent dynamics from static scenes."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2512_11061_vdaworld-world-modelling-via-vlm-directe.md
...
**VDAWorld: World Modelling via VLM-Directed Abstraction and Simulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 045/571** 篇，分组 **114 Physics Simulation & Engine Integration**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VLMs act as agents to autonomously construct scene representations and select compatible physics simulators (rigid‑body, fluid, etc.), inferring latent dynamics from static scenes.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2512.11061> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.11061) 为准。
...
**本条目的站内价值是把「VDAWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2512_11061_vdaworld-world-modelling-via-vlm-directe.md`](../../sources/papers/sun_awesome_wm_2512_11061_vdaworld-world-modelling-via-vlm-directe.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.11061)
