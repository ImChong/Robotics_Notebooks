...
**Elite_Robots_CS_SDK** 是 [艾利特机器人](https://github.com/Elite-Robots) 公开的 **SDK/驱动** 开源项目：提供艾利特CS系列机器人C++访问与控制库，为ROS2驱动和自定义应用提供底层接口。
...
1. 从官方 GitHub/Gitee 组织检索 `Elite_Robots_CS_SDK` 仓库并核对 README 许可与依赖。
