...
- **代码：** <https://github.com/thinklab-sjtu/bench2drive>
- **清单摘要：** Closed-loop evaluation protocol for end-to-end driving policies.
- **沉淀到 wiki：** [`wiki/entities/painode-104-bench2drive.md`](../../wiki/entities/painode-104-bench2drive.md)
...
- 实体页：[`wiki/entities/painode-104-bench2drive.md`](../../wiki/entities/painode-104-bench2drive.md)
