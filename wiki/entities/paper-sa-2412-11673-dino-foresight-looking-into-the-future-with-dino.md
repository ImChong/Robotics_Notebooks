...
summary: "Looks into the future with DINO."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2412_11673_dino-foresight-looking-into-the-future-w.md
...
**DINO-Foresight: Looking into the Future with DINO** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 109/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Looks into the future with DINO.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2412.11673> |
| 代码/项目 | <https://github.com/Sta8is/DINO-Foresight> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2412.11673) 为准。
...
**本条目的站内价值是把「DINO-Foresight」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2412_11673_dino-foresight-looking-into-the-future-w.md`](../../sources/papers/sun_awesome_wm_2412_11673_dino-foresight-looking-into-the-future-w.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2412.11673)
