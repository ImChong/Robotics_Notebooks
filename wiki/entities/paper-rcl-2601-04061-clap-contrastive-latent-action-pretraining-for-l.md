...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2601_04061_clap-contrastive-latent-action-pretraini.md
...
**CLAP: Contrastive Latent Action Pretraining for Learning Vision-Language-Action Models from Human Videos** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 230/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | VLA |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2601.04061> |
| 代码/项目 | <https://github.com/LinShan-Bin/OpenCLAP> |
| 子类 / 象限 | 潜动作预训练 · 自回归VLA · 扩散与流匹配VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.04061) 为准。
...
**本条目的站内价值是把「CLAP」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2601_04061_clap-contrastive-latent-action-pretraini.md`](../../sources/papers/rcl_awesome_wam_2601_04061_clap-contrastive-latent-action-pretraini.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.04061)
