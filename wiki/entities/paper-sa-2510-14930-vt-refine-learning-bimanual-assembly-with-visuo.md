...
sources:
  - ../../sources/papers/sun_awesome_touch_2510_14930_vt-refine-learning-bimanual-assembly-wit.md
...
**VT-Refine: Learning Bimanual Assembly with Visuo-Tactile Feedback via Simulation Fine-Tuning** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 035/065** 篇，分组 **53 Diffusion Policies for Tactile Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Combines real-world demonstrations, high-fidelity tactile simulation, and RL for precise bimanual assembly; diffusion policy trained on small demonstrations then refined via large-scale RL in simulated digital twin.
...
| 出处 | CoRL 2025 |
| 论文 | <https://arxiv.org/abs/2510.14930> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.14930) 为准。
...
**本条目的站内价值是把「VT-Refine」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2510_14930_vt-refine-learning-bimanual-assembly-wit.md`](../../sources/papers/sun_awesome_touch_2510_14930_vt-refine-learning-bimanual-assembly-wit.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.14930)
