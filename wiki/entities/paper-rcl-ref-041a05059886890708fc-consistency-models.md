...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_041a05059886890708fc_consistency-models.md
...
**Consistency Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 148/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICML 2023 |
| 论文 | <https://proceedings.mlr.press/v202/song23a.html> |
| 子类 / 象限 | 扩散与流匹配基础 · 训练优化与蒸馏 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.mlr.press/v202/song23a.html) 为准。
...
**本条目的站内价值是把「Consistency Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_041a05059886890708fc_consistency-models.md`](../../sources/papers/rcl_awesome_wam_ref_041a05059886890708fc_consistency-models.md) — 本条目策展摘录
...
- [原文](https://proceedings.mlr.press/v202/song23a.html)
