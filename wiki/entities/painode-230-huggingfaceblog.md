...
status: complete
updated: 2026-09-20
summary: "Updates on LeRobot, Reachy, and open-source robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_230_hugging-face-blog.md
...
**Hugging Face Blog** 收录于 awesome-physical-ai（natnew）**第 230/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Updates on LeRobot, Reachy, and open-source robotics.
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://huggingface.co/blog> |
...
- [`sources/repos/pai_awesome_community_230_hugging-face-blog.md`](../../sources/repos/pai_awesome_community_230_hugging-face-blog.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://huggingface.co/blog)
