...
status: complete
updated: 2026-09-20
summary: "Voluntary framework for managing risks across the AI lifecycle, applicable to robotics."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_138_nist-ai-risk-management-framework.md
...
**NIST AI Risk Management Framework** 收录于 awesome-physical-ai（natnew）**第 138/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Voluntary framework for managing risks across the AI lifecycle, applicable to robotics.
...
| 来源清单 | natnew |
| 主链接 | <https://www.nist.gov/itl/ai-risk-management-framework> |
...
- [`sources/repos/pai_awesome_standard_138_nist-ai-risk-management-framework.md`](../../sources/repos/pai_awesome_standard_138_nist-ai-risk-management-framework.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.nist.gov/itl/ai-risk-management-framework)
