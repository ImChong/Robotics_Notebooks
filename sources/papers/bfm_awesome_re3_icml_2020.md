...
> 来源归档（ingest · awesome-bfm-papers 第 28/41）

- **标题：** State Entropy Maximization with Random Encoders for Efficient Exploration
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 状态熵最大化打开探索；人形需覆盖更多姿态以防 OOD 失败。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 03 Intrinsic reward 预训练，编号 **28/41**。
- **公众号导读要点：** 状态熵最大化打开探索；人形需覆盖更多姿态以防 OOD 失败。
