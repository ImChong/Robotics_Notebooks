...
电磁仿真侧如何生成 TN 曲线，见 [电机电磁仿真软件选型](../comparisons/motor-em-simulation-software.md)；台架侧如何用测功机/对拖扫出实测 TN，见 [电机测功机（Dynamometer）](./motor-dynamometer.md)。
...
- [电机测功机（Dynamometer）](./motor-dynamometer.md) — 台架如何加载并测出 TN/效率
...
- [执行器驱动链选型闭环知识链](../queries/actuator-drive-chain-selection-loop.md) — 力矩–转速曲线是②层弱磁/饱和区偏离线性的物理背景
...
- [Magtrol Manuals](https://www.magtrol.com/manuals/) — 工业测功机与 M-TEST 曲线模式
