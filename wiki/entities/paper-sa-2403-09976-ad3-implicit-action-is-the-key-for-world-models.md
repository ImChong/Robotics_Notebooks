...
arxiv: "2403.09976"
venue: "arXiv 2024"
summary: "Implicit action is the key for world models to distinguish diverse visual distractors."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2403_09976_ad3-implicit-action-is-the-key-for-world.md
...
**AD3: Implicit Action is the Key for World Models to Distinguish the Diverse Visual Distractors** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 239/571** 篇，分组 **72 Continuous Control**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Implicit action is the key for world models to distinguish diverse visual distractors.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2403.09976> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.09976) 为准。
...
**本条目的站内价值是把「AD3」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2403_09976_ad3-implicit-action-is-the-key-for-world.md`](../../sources/papers/sun_awesome_wm_2403_09976_ad3-implicit-action-is-the-key-for-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.09976)
