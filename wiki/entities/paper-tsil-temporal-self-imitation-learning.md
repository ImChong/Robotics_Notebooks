---
type: entity
tags: [paper, reinforcement-learning, imitation-learning, manipulation, ppo, self-imitation, long-horizon, meta-world, isaac-gym, reward-shaping, duke]
status: complete
updated: 2026-07-01
arxiv: "2606.19752"
related:
...
summary: "TSIL（arXiv:2606.19752）：在 PPO 长时域操作 RL 中挖掘快速成功轨迹——配置条件自适应时间目标 D(φ) 重塑观测与成功奖励，并以效率加权自模仿回放巩固高效行为；15 个 Meta-World 任务上提升样本效率、完成时间与训练鲁棒性。"
---
