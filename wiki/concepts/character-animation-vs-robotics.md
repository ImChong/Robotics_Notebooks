...
| 工具生态 | DCC（Maya / [Blender](../entities/blender.md)）、节点图、动画引擎；[Manim](../entities/manim.md) 管数学示意短片 | URDF / MJCF、ROS2、Isaac Lab | [BotLab / MotionCanvas](../entities/botlab-motioncanvas.md) 试图把交互仿真与节点图拼进浏览器；[Manim](../entities/manim.md) 管离线公式/几何讲解 |
