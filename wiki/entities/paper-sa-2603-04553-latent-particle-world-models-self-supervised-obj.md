...
summary: "Scales to real-world multi-object datasets for decision-making."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2603_04553_latent-particle-world-models-self-superv.md
...
**Latent Particle World Models: Self-supervised Object-centric Stochastic Dynamics Modeling** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 129/571** 篇，分组 **45 Object-Centric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Scales to real-world multi-object datasets for decision-making.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.04553) 为准。
...
**本条目的站内价值是把「Latent Particle World Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2603_04553_latent-particle-world-models-self-superv.md`](../../sources/papers/sun_awesome_wm_2603_04553_latent-particle-world-models-self-superv.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.04553)
