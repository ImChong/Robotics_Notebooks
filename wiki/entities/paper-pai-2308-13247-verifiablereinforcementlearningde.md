...
updated: 2026-09-20
arxiv: "2308.13247"
summary: "Survey-style work on formal verification approaches for RL controllers."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/pai_awesome_2308_13247_verifiable-reinforcement-learning-de.md
...
# Verifiable Reinforcement Learning (DeepMind)

**Verifiable Reinforcement Learning (DeepMind)** 收录于 awesome-physical-ai（natnew）**第 326/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Survey-style work on formal verification approaches for RL controllers.
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2308.13247> |
| arXiv | 2308.13247 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2308.13247) 为准。
...
**本条目的站内价值是把「Verifiable Reinforcement Learning (DeepMind)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2308_13247_verifiable-reinforcement-learning-de.md`](../../sources/papers/pai_awesome_2308_13247_verifiable-reinforcement-learning-de.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2308.13247)
