...
**EgoLife** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 223/249** 篇，分组 **Long Video & Episodic Memory Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
|------|------|
| 编号 | 223/249 |
| 分组 | Long Video & Episodic Memory Datasets |
| 出处 | 见清单 / 原文 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.03803) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 的 **Long Video & Episodic Memory Datasets** 分组逐条展开。
...
- 起作用的是策展坐标：列表分组 **Long Video & Episodic Memory Datasets** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
