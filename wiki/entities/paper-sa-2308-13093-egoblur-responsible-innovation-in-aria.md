...
sources:
  - ../../sources/papers/sun_awesome_ego_2308_13093_egoblur-responsible-innovation-in-aria.md
...
**EgoBlur: Responsible Innovation in Aria** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 006/249** 篇，分组 **2102 Anonymization & Data Deidentification**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

The core anonymization system for **Project Aria**, designed to blur **bystander faces and vehicle license plates** at the data acquisition stage. Uses FasterRCNN as the detector and applies Gaussian blur to detected PII regions.
...
| 出处 | Meta Reality Labs 2023 |
| 论文 | <https://arxiv.org/abs/2308.13093> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2308.13093) 为准。
...
**本条目的站内价值是把「EgoBlur」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2308_13093_egoblur-responsible-innovation-in-aria.md`](../../sources/papers/sun_awesome_ego_2308_13093_egoblur-responsible-innovation-in-aria.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2308.13093)
