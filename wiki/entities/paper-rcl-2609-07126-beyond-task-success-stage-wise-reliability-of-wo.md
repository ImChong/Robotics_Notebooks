...
arxiv: "2609.07126"
venue: "2026"
summary: "This diagnostic study follows synthetic sensing disturbances through an existing world-model planner's representation, action-conditioned prediction, candidate ranking, and executed task outcome. Paired OGBench evaluatio"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_07126_beyond-task-success-stage-wise-reliabili.md
...
**Beyond Task Success: Stage-Wise Reliability of World Model Planning under Sensing Degradation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 133/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.07126> |
| 子类 / 象限 | 行为与表征诊断 · 统计评测协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.07126) 为准。
...
- [`sources/papers/rcl_awesome_wam_2609_07126_beyond-task-success-stage-wise-reliabili.md`](../../sources/papers/rcl_awesome_wam_2609_07126_beyond-task-success-stage-wise-reliabili.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.07126)
