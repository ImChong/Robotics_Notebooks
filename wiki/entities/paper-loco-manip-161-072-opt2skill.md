...
**Opt2Skill** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 072/161** 篇，归类为 **03 视觉感知驱动的人形移动操作**。
...
- Opt2Skill 先从相机图像/多视角观测、仿真交互数据、接触力/触觉信号恢复场景、目标或运动表征，再用PPO/RL 策略训练、ACT/行为克隆模仿学习、IK/动作重定向生成关节位置/力矩命令、全身轨迹/动作序列。关键点是把任务拆成可路由的技能或专家策略，再用高层模块在执行中选择和组合。
- 人形 Loco-Manip 161 篇 **#072/161** · 视觉感知驱动的人形移动操作。
...
| 发表日期 | 2025年10月1日 |
| 论文/项目 | https://opt2skill.github.io |
...
- 本页为 161 篇 **#072/161** 清单索引条目，量化 benchmark 与实机指标以 [原文 / 项目页](https://opt2skill.github.io) 为准。
...
- 原始 source：[loco_manip_161_survey_072_opt2skill.md](../../sources/papers/loco_manip_161_survey_072_opt2skill.md)

## 参考来源

- [loco_manip_161_survey_072_opt2skill.md](../../sources/papers/loco_manip_161_survey_072_opt2skill.md) — 161 篇策展摘录
