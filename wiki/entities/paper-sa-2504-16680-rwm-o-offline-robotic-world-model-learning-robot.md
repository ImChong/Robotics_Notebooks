...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2504_16680_rwm-o-offline-robotic-world-model-learni.md
...
**RWM-O: Offline Robotic World Model – Learning Robotic Policies without a Physics Simulator** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 371/571** 篇，分组 **814 Locomotion & Loco-Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learning robotic policies without a physics simulator.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2504.16680> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2504.16680) 为准。
...
**本条目的站内价值是把「RWM-O」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2504_16680_rwm-o-offline-robotic-world-model-learni.md`](../../sources/papers/sun_awesome_wm_2504_16680_rwm-o-offline-robotic-world-model-learni.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2504.16680)
