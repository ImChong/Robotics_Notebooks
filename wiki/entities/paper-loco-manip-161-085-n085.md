...
sources:
  - ../../sources/papers/loco_manip_161_survey_085_n085.md
...
**人形机器人运动与操作** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 085/161** 篇，归类为 **03 视觉感知驱动的人形移动操作**。
...
- 这篇工作先从相机图像/多视角观测、本体状态与关节序列、接触力/触觉信号恢复场景、目标或运动表征，再用ACT/行为克隆模仿学习、扩散策略/流匹配、全身控制器/WBC/MPC生成可执行动作命令。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#085/161** · 视觉感知驱动的人形移动操作。
...
- 清单索引条目不含量化 benchmark 与实机指标，横向对照请回 [分类 hub](../overview/loco-manip-161-category-03-visuomotor.md) 与 [技术地图](../overview/humanoid-loco-manip-161-papers-technology-map.md)。
...
- 原始 source：[loco_manip_161_survey_085_n085.md](../../sources/papers/loco_manip_161_survey_085_n085.md)

## 参考来源

- [loco_manip_161_survey_085_n085.md](../../sources/papers/loco_manip_161_survey_085_n085.md) — 161 篇策展摘录
