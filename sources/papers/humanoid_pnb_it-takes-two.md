...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/It_Takes_Two__Learning_Interactive_Whole-Body_Control_Between_Humanoid_Robots/It_Takes_Two__Learning_Interactive_Whole-Body_Control_Between_Humanoid_Robots.md`
