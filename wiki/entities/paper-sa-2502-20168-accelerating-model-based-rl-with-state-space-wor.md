...
arxiv: "2502.20168"
venue: "arXiv 2025"
summary: "Accelerating MBRL with state-space world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_20168_accelerating-model-based-rl-with-state-s.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Accelerating Model-Based RL with State-Space World Models

**Accelerating Model-Based RL with State-Space World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 360/571** 篇，分组 **814 Locomotion & Loco-Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Accelerating MBRL with state-space world models.
...
|------|------|
| 编号 | 360/571 |
| 分组 | 814 Locomotion & Loco-Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.20168> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.20168) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 的 **814 Locomotion & Loco-Manipulation** 分组逐条展开。
...
**本条目的站内价值是把「Accelerating Model-Based RL with State-Space World Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **814 Locomotion & Loco-Manipulation** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_wm_2502_20168_accelerating-model-based-rl-with-state-s.md`](../../sources/papers/sun_awesome_wm_2502_20168_accelerating-model-based-rl-with-state-s.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.20168)
