...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_05263_latticeworld-a-multimodal-large-language.md
...
**LatticeWorld: A Multimodal Large Language Model-Empowered Framework for Interactive Complex World Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 033/571** 篇，分组 **113 Interactive World Models & Game Engines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Takes text descriptions and visual instructions as multimodal input to create large‑scale 3D interactive worlds with dynamic agents, high‑fidelity physics simulation, and real‑time rendering.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.05263> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.05263) 为准。
...
**本条目的站内价值是把「LatticeWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_05263_latticeworld-a-multimodal-large-language.md`](../../sources/papers/sun_awesome_wm_2509_05263_latticeworld-a-multimodal-large-language.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.05263)
