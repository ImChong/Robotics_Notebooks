...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/From_Language_to_Locomotion__Retargeting-free_Humanoid_Control_via_Motion_Latent/From_Language_to_Locomotion__Retargeting-free_Humanoid_Control_via_Motion_Latent.md`
