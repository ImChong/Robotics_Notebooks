...
status: complete
updated: 2026-09-20
summary: "Open-source underactuated manipulator for dexterous grasping and manipulation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_172_umi-gripper.md
...
**UMI Gripper** 收录于 awesome-physical-ai（natnew）**第 172/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-source underactuated manipulator for dexterous grasping and manipulation.
...
| 来源清单 | natnew |
| 主链接 | <https://umi-gripper.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://umi-gripper.github.io/> |
...
- [`sources/repos/pai_awesome_hardware_172_umi-gripper.md`](../../sources/repos/pai_awesome_hardware_172_umi-gripper.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://umi-gripper.github.io/)
