...
**SafeHumanoid: VLM-RAG-driven Control of Upper Body Impedance for Humanoid Robot** 收录于 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html)（分类：06_Manipulation），深读笔记已完成。本页是 **笔记摘要**：要点编译自深读笔记，细节以笔记原文与论文 PDF 为准。
...
- 落地状态：系统跑在真 Unitree G1 上，但论文未公开代码 / 项目页；本页为深读笔记编译的笔记摘要，量化指标以笔记页与论文 PDF 为准（见 [参考来源](#参考来源)）。
