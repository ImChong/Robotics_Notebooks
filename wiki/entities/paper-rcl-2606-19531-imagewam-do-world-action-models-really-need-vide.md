...
summary: "We propose ImageWAM, a simple WAM framework that repurposes pretrained image editing models for robot action prediction. ImageWAM outperforms standard VLA baselines and matching competitive WAMs without additional policy"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_19531_imagewam-do-world-action-models-really-n.md
...
**ImageWAM: Do World Action Models Really Need Video Generation, or Just Image Editing?** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 388/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/yuyangalin/ImageWAM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.19531) 为准。
...
**本条目的站内价值是把「ImageWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_19531_imagewam-do-world-action-models-really-n.md`](../../sources/papers/rcl_awesome_wam_2606_19531_imagewam-do-world-action-models-really-n.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.19531)
