...
- **标题：** CAD-Driven Co-Design for Flight-Ready Jet-Powered Humanoids
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/cad-driven-co-design-for-flight-ready-jet-powere/cad-driven-co-design-for-flight-ready-jet-powere.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-cad-driven-co-design-for-flight-ready-jet-powere](../../wiki/entities/paper-notebook-cad-driven-co-design-for-flight-ready-jet-powere.md).

## 对 wiki 的映射

- [paper-notebook-cad-driven-co-design-for-flight-ready-jet-powere](../../wiki/entities/paper-notebook-cad-driven-co-design-for-flight-ready-jet-powere.md)
