...
arxiv: "2508.08086"
venue: "arXiv 2025"
summary: "Omnidirectional explorable 3D world generation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2508_08086_matrix-3d-omnidirectional-explorable-3d.md
...
**Matrix-3D: Omnidirectional Explorable 3D World Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 176/571** 篇，分组 **52 Game & Open-World Exploration Application**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.08086> |
| 项目页 | <https://matrix-3d.github.io> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.08086) 为准。
...
**本条目的站内价值是把「Matrix-3D」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2508_08086_matrix-3d-omnidirectional-explorable-3d.md`](../../sources/papers/sun_awesome_wm_2508_08086_matrix-3d-omnidirectional-explorable-3d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2508.08086)
