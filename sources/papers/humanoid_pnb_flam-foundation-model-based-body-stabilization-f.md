...
- **标题：** FLAM: Foundation Model-Based Body Stabilization for Humanoid Locomotion and Manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/14_Human_Motion/flam-foundation-model-based-body-stabilization-f/flam-foundation-model-based-body-stabilization-f.md`
- **分类：** 14_Human_Motion
...
- 知识归纳见 wiki 实体页：[paper-notebook-flam-foundation-model-based-body-stabilization-f](../../wiki/entities/paper-notebook-flam-foundation-model-based-body-stabilization-f.md).

## 对 wiki 的映射

- [paper-notebook-flam-foundation-model-based-body-stabilization-f](../../wiki/entities/paper-notebook-flam-foundation-model-based-body-stabilization-f.md)
