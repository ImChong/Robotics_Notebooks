...
发布会盯自由度、算力、峰值扭矩，很少问机器是否知道自己的质量、质心和腿转动惯量。控制侧「以为迈了 30 cm / 重心在左脚」必须和物理世界一致；错位后上层策略建在流沙上。这与 [物理保真度分层](./physics-fidelity-sim2real-gap.md) 的几何/URDF 层、[接触力旋量闭环](../queries/contact-wrench-closed-loop.md) 的雅可比/惯量映射是同一条因果链。
