...
status: complete
updated: 2026-09-20
summary: "International Conference on Learning Representations."
related:
...
sources:
  - ../../sources/repos/pai_awesome_conference_057_iclr.md
...
**ICLR** 收录于 awesome-physical-ai（natnew）**第 057/384** 条，分组 **Conferences**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
- [`sources/repos/pai_awesome_conference_057_iclr.md`](../../sources/repos/pai_awesome_conference_057_iclr.md) — 本条目策展摘录
