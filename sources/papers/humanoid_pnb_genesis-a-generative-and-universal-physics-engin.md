...
- **计划笔记路径：** `papers/11_Simulation_Benchmark/genesis-a-generative-and-universal-physics-engin/genesis-a-generative-and-universal-physics-engin.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-genesis-a-generative-and-universal-physics-engin](../../wiki/entities/paper-notebook-genesis-a-generative-and-universal-physics-engin.md).

## 对 wiki 的映射

- [paper-notebook-genesis-a-generative-and-universal-physics-engin](../../wiki/entities/paper-notebook-genesis-a-generative-and-universal-physics-engin.md)
