...
sources:
  ...
  - ../../sources/repos/linkerhand-urdf.md
summary: "灵心巧手 开源项目 linkerhand-urdf（本体模型资产）：提供LinkerHand多款灵巧手URDF模型，为仿真、规划和控制器集成提供几何与关节定义。…"
institutions:
  - linkerbot
---
...
**linkerhand-urdf** 是 [灵心巧手](https://github.com/linker-bot) 公开的 **本体模型资产** 开源项目：提供LinkerHand多款灵巧手URDF模型，为仿真、规划和控制器集成提供几何与关节定义。
...
| 机构 | 灵心巧手 |
| 类别 | 本体模型资产 |
| 官方组织 | https://github.com/linker-bot |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `linkerhand-urdf` 仓库并核对 README 许可与依赖。
...
- [linkerhand-urdf 源码归档](../../sources/repos/linkerhand-urdf.md)（<https://github.com/linker-bot/linkerhand-urdf>）

- [国内具身智能开源全景（微信公众号）](../../sources/blogs/wechat_embodied_station_domestic_opensource_panorama_2026-09-06.md)

## 推荐继续阅读

- [灵心巧手 官方组织](https://github.com/linker-bot)
