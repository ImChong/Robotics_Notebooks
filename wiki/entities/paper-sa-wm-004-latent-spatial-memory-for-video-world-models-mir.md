...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_noarxiv_004_latent-spatial-memory-for-video-world-mo.md
...
**Latent Spatial Memory for Video World Models (Mirage)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 004/571** 篇，分组 **101 Memory Mechanisms**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Stores persistent 3D scene content directly as latent tokens, avoiding repeated RGB rendering, and updates caches during generation.
...
| 出处 | arXiv 2026 |
| 论文 | <https://github.com/microsoft/LatentSpatialMemory> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/microsoft/LatentSpatialMemory) 为准。
...
**本条目的站内价值是把「Latent Spatial Memory for Video World Models (Mirage)」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_noarxiv_004_latent-spatial-memory-for-video-world-mo.md`](../../sources/papers/sun_awesome_wm_noarxiv_004_latent-spatial-memory-for-video-world-mo.md) — 本条目策展摘录
...
- [原文](https://github.com/microsoft/LatentSpatialMemory)
