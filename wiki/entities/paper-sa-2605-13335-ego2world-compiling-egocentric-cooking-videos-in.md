...
sources:
  - ../../sources/papers/sun_awesome_ego_2605_13335_ego2world-compiling-egocentric-cooking-v.md
...
**Ego2World: Compiling Egocentric Cooking Videos into Executable Worlds for Belief-State Planning** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 073/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Turns egocentric cooking videos into executable symbolic worlds governed by graph-transition rules. Forces agents to update memory and replan without observing the true world state
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.13335> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.13335) 为准。
...
**本条目的站内价值是把「Ego2World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2605_13335_ego2world-compiling-egocentric-cooking-v.md`](../../sources/papers/sun_awesome_ego_2605_13335_ego2world-compiling-egocentric-cooking-v.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.13335)
