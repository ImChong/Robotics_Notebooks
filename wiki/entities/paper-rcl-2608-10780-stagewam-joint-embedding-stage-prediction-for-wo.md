...
updated: 2026-09-25
arxiv: "2608.10780"
summary: "We introduce StageWAM, which augments a Motus-based World Action Model (WAM) with Stage-JEPA, a goal-conditioned Joint-Embedding Predictive Architecture (JEPA) predictor. Across 50 RoboTwin 2.0 tasks in clean and randomi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_10780_stagewam-joint-embedding-stage-predictio.md
...
**StageWAM: Joint-Embedding Stage Prediction for World-Action Models in Robot Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 485/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 子类 / 象限 | 潜空间预测与JEPA · 联合视频动作建模 · 记忆与长时序 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.10780) 为准。
...
**本条目的站内价值是把「StageWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_10780_stagewam-joint-embedding-stage-predictio.md`](../../sources/papers/rcl_awesome_wam_2608_10780_stagewam-joint-embedding-stage-predictio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.10780)
