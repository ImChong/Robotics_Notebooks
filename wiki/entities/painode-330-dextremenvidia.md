...
status: complete
updated: 2026-09-20
summary: "Sim-to-real dexterous in-hand manipulation on the Allegro hand using massively parallel GPU simulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/repos/pai_awesome_paper_330_dextreme-nvidia.md
...
**DeXtreme (NVIDIA)** 收录于 awesome-physical-ai（natnew）**第 330/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real dexterous in-hand manipulation on the Allegro hand using massively parallel GPU simulation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://dextreme.org/) 为准。
...
**本条目的站内价值是把「DeXtreme (NVIDIA)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/repos/pai_awesome_paper_330_dextreme-nvidia.md`](../../sources/repos/pai_awesome_paper_330_dextreme-nvidia.md) — 本条目策展摘录
