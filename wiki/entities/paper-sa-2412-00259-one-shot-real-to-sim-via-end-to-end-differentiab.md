...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2412_00259_one-shot-real-to-sim-via-end-to-end-diff.md
...
**One-Shot Real-to-Sim via End-to-End Differentiable Simulation and Rendering** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 026/063** 篇，分组 **31 Real2Sim from Video**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 论文 | <https://arxiv.org/abs/2412.00259> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2412.00259) 为准。
...
**本条目的站内价值是把「One-Shot Real-to-Sim via End-to-End Differentiable Simulation and Rendering」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2412_00259_one-shot-real-to-sim-via-end-to-end-diff.md`](../../sources/papers/sun_awesome_r2s2r_2412_00259_one-shot-real-to-sim-via-end-to-end-diff.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2412.00259)
