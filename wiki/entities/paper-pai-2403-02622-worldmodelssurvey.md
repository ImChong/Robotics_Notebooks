...
updated: 2026-09-20
arxiv: "2403.02622"
summary: "Survey on world models for autonomous systems."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2403_02622_world-models-survey.md
...
**World Models Survey** 收录于 awesome-physical-ai（natnew）**第 364/384** 条，分组 **Survey Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Survey on world models for autonomous systems.
...
| 分组 | Survey Papers |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2403.02622> |
| arXiv | 2403.02622 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.02622) 为准。
...
**本条目的站内价值是把「World Models Survey」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2403_02622_world-models-survey.md`](../../sources/papers/pai_awesome_2403_02622_world-models-survey.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2403.02622)
