...
**magiclab_rl_lab** 是 [魔法原子](https://github.com/MagiclabRobotics) 公开的 **运动RL/技能训练** 开源项目：为魔法原子机器人提供基于Isaac Lab的强化学习训练环境与任务配置。
...
1. 从官方 GitHub/Gitee 组织检索 `magiclab_rl_lab` 仓库并核对 README 许可与依赖。
