...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_16569_prose-training-free-egocentric-scene-reg.md
...
**PROSE: Training-Free Egocentric Scene Registration with Vision-Language Models** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 191/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Uses a pretrained VLM as the source of both scene understanding and cross-scan matching for egocentric scene registration, outperforming geometric and learned scene-graph baselines
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.16569> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.16569) 为准。
...
**本条目的站内价值是把「PROSE」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_16569_prose-training-free-egocentric-scene-reg.md`](../../sources/papers/sun_awesome_ego_2606_16569_prose-training-free-egocentric-scene-reg.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.16569)
