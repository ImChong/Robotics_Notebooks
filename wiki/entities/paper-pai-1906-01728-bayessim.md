...
updated: 2026-09-20
arxiv: "1906.01728"
summary: "Bayesian domain randomization approach for data-efficient sim-to-real adaptation."
related:
...
**BayesSim** 收录于 awesome-physical-ai（natnew）**第 328/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Bayesian domain randomization approach for data-efficient sim-to-real adaptation.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1906.01728> |
| arXiv | 1906.01728 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1906.01728) 为准。
...
**本条目的站内价值是把「BayesSim」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1906_01728_bayessim.md`](../../sources/papers/pai_awesome_1906_01728_bayessim.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1906.01728)
