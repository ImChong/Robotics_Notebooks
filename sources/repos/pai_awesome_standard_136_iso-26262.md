...
- **代码：** 未在清单中标注
- **清单摘要：** Functional safety standard for electrical and software systems in road vehicles.
- **沉淀到 wiki：** [`wiki/entities/painode-136-iso26262.md`](../../wiki/entities/painode-136-iso26262.md)
...
- 实体页：[`wiki/entities/painode-136-iso26262.md`](../../wiki/entities/painode-136-iso26262.md)
