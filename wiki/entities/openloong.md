...
- **生态位独特**：与 [Asimov v1](./asimov-v1.md)（1.2 m 级 DIY + 单仓 MuJoCo）、[天工 / X-Humanoid](./x-humanoid.md)（中心制三入口 + IsaacLab/VLA 栈）、商业 **Unitree** 等形成对照——OpenLoong 更贴近 **国家级公版机 + 工业总线 + 开放原子运营** 路线。
