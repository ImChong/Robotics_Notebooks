...
- **标题：** Implicit Kinodynamic Motion Retargeting for Human-to-humanoid Imitation Learning
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Implicit_Kinodynamic_Motion_Retargeting_for_Human-to-humanoid_Imitation_Learning/Implicit_Kinodynamic_Motion_Retargeting_for_Human-to-humanoid_Imitation_Learning.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-implicit-kinodynamic-motion-retargeting-for-huma](../../wiki/entities/paper-notebook-implicit-kinodynamic-motion-retargeting-for-huma.md).

## 对 wiki 的映射

- [paper-notebook-implicit-kinodynamic-motion-retargeting-for-huma](../../wiki/entities/paper-notebook-implicit-kinodynamic-motion-retargeting-for-huma.md)
