...
arxiv: "2409.12192"
venue: "2024"
summary: "DynaMo uses action-free dynamics pretraining to make visual features useful for imitation learning. An encoder, latent inverse model and forward model jointly learn to predict next-frame embeddings; a separate policy the"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2409_12192_dynamo-in-domain-dynamics-pretraining-fo.md
...
| 出处 | 2024 |
| 论文 | <https://arxiv.org/abs/2409.12192> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2409.12192) 为准。
...
**本条目的站内价值是把「DynaMo」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2409_12192_dynamo-in-domain-dynamics-pretraining-fo.md`](../../sources/papers/rcl_awesome_wam_2409_12192_dynamo-in-domain-dynamics-pretraining-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2409.12192)
