...
summary: "小鹏 IRON CN117359667A：单推杆联动多指的轻量化机械手（2024-01-09 公开/公告）；同一伸缩推杆经连接模块联动至少两指，减少辅助抓握手指的驱动件数量与重量。…"
---

# 小鹏 IRON · 单推杆联动多指的轻量化机械手（CN117359667A）

专利 **CN117359667A**（*单推杆联动多指的轻量化机械手*，小鹏机器人 / IRON 相关布局，2024-01-09）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**同一伸缩推杆经连接模块联动至少两指，减少辅助抓握手指的驱动件数量与重量。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN117359667A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn117359667a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN117359667A](https://patents.google.com/patent/CN117359667A/zh)
