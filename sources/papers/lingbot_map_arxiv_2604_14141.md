...
- **项目页：** <https://technology.robbyant.com/lingbot-map>（主站）；<https://robbyant.github.io/lingbot-map/>（用户给定镜像，2026-09-11 核查 404）
- **代码：** <https://github.com/Robbyant/lingbot-map>
- **权重：** <https://huggingface.co/robbyant/lingbot-map>
- **venue：** ECCV 2026 oral（README 标注）
- **版本：** arXiv v3（2026-09-08）；作者列表含 Shangzhan Zhang
- **入库日期：** 2026-05-17；**2026-09-11** 同步 v3 与 HF 直链
...
- **对 wiki 的映射：**
  - [paper-lingbot-map](../../wiki/entities/paper-lingbot-map.md)
