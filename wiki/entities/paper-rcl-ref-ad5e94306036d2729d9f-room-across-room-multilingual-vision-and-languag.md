...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_ad5e94306036d2729d9f_room-across-room-multilingual-vision-and.md
...
**Room-Across-Room: Multilingual Vision-and-Language Navigation with Dense Spatiotemporal Grounding** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 121/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | EMNLP 2020 |
| 论文 | <https://aclanthology.org/2020.emnlp-main.356/> |
| 子类 / 象限 | 视觉语言导航数据 · 多语言与时空标注 · 基准与评测协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://aclanthology.org/2020.emnlp-main.356/) 为准。
...
**本条目的站内价值是把「Room-Across-Room」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_ad5e94306036d2729d9f_room-across-room-multilingual-vision-and.md`](../../sources/papers/rcl_awesome_wam_ref_ad5e94306036d2729d9f_room-across-room-multilingual-vision-and.md) — 本条目策展摘录
...
- [原文](https://aclanthology.org/2020.emnlp-main.356/)
