...
summary: "LightNav-0（arXiv:2608.30935，Light Origins）：dual-channel pointing + RVQ action tokenizer 统一 VLM 空间意图；2K+ 场景 4K+ h 数据；10 个导航仿真 SOTA + 跨本体零样本真机；lightorigins/LightNav-0 与 HF 权重已开源。"
---
