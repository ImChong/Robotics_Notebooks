...
- **标题：** GBC: Generalized Behavior-Cloning Framework for Whole-Body Humanoid Imitation
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/gbc-generalized-behavior-cloning-framework-for-w/gbc-generalized-behavior-cloning-framework-for-w.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2508.09960>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-gbc](../../wiki/entities/paper-notebook-gbc.md).

## 对 wiki 的映射

- [paper-notebook-gbc](../../wiki/entities/paper-notebook-gbc.md)
...
- 论文：<https://arxiv.org/abs/2508.09960>
