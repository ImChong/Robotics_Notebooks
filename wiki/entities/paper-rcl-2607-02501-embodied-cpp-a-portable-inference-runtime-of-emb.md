...
summary: "We present Embodied..cpp, a portable C++ inference runtime for embodied models. Overall, Embodied..cpp achieves 1.05x-2.70x inference speedups and 7\\%-77\\% lower VRAM relative to Python baselines, while maintaining near"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_02501_embodied-cpp-a-portable-inference-runtim.md
...
**Embodied.cpp: A Portable Inference Runtime of Embodied AI Models on Heterogeneous Robots** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 204/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/SEU-PAISys/Embodied.cpp> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.02501) 为准。
...
**本条目的站内价值是把「Embodied.cpp」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_02501_embodied-cpp-a-portable-inference-runtim.md`](../../sources/papers/rcl_awesome_wam_2607_02501_embodied-cpp-a-portable-inference-runtim.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.02501)
