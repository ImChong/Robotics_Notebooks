...
### 💡 高频引用 methods/ 缺 queries/ 或 comparisons/ 落地（信息型，不阻塞 CI）（35 个）
...
- wiki/methods/sonic-motion-tracking.md（被 33 个页面引用，无 queries/comparisons 落地）
...
📊 Sources 覆盖率：348/348 (100%) wiki/entity 页有 ingest 来源
