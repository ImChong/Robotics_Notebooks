...
- **代码：** 未在清单中标注
- **清单摘要：** Stanford HAI, World Labs. Computer vision and spatial intelligence pioneer.
- **沉淀到 wiki：** [`wiki/entities/painode-247-feifeili.md`](../../wiki/entities/painode-247-feifeili.md)
...
- 实体页：[`wiki/entities/painode-247-feifeili.md`](../../wiki/entities/painode-247-feifeili.md)
