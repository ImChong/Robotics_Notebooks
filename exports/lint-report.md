...
## [2026-08-02] lint | health-check | 自动化 wiki 健康检查
...
- wiki/entities/paper-fa-rdp.md（缺 对比）
- wiki/entities/paper-world-action-planner.md（缺 对比）
...
📊 Sources 覆盖率：2016/2042 (99%) wiki/entity 页有 ingest 来源
