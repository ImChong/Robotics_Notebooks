...
status: complete
updated: 2026-09-20
summary: "Open platform for challenge hosting, leaderboard management, and standardized evaluation workflows."
related:
...
sources:
  - ../../sources/repos/pai_awesome_eval_110_evalai.md
...
**EvalAI** 收录于 awesome-physical-ai（natnew）**第 110/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open platform for challenge hosting, leaderboard management, and standardized evaluation workflows.
...
- [`sources/repos/pai_awesome_eval_110_evalai.md`](../../sources/repos/pai_awesome_eval_110_evalai.md) — 本条目策展摘录
