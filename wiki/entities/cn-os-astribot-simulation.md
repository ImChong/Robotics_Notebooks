...
**astribot_simulation** 是 [星尘智能](https://github.com/Astribot-Dev) 公开的 **仿真环境** 开源项目：提供星尘智能机器人相关的仿真开发环境，用于加载模型并验证机器人系统接口。
...
1. 从官方 GitHub/Gitee 组织检索 `astribot_simulation` 仓库并核对 README 许可与依赖。
