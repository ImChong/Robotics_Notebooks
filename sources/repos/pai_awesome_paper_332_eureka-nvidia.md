...
- **代码：** 未在清单中标注
- **清单摘要：** LLM-driven reward design that enables sim-to-real transfer for dexterous skills.
- **沉淀到 wiki：** [`wiki/entities/painode-332-eurekanvidia.md`](../../wiki/entities/painode-332-eurekanvidia.md)
...
- 实体页：[`wiki/entities/painode-332-eurekanvidia.md`](../../wiki/entities/painode-332-eurekanvidia.md)
