...
- **标题：** Learning to Grasp Anything by Playing with Random Toys
- **类型：** paper
...
- **计划笔记路径：** `papers/06_Manipulation/learning-to-grasp-anything-by-playing-with-rando/learning-to-grasp-anything-by-playing-with-rando.md`
- **分类：** 06_Manipulation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-to-grasp-anything-by-playing-with-rando](../../wiki/entities/paper-notebook-learning-to-grasp-anything-by-playing-with-rando.md).

## 对 wiki 的映射

- [paper-notebook-learning-to-grasp-anything-by-playing-with-rando](../../wiki/entities/paper-notebook-learning-to-grasp-anything-by-playing-with-rando.md)
