...
sources:
  - ../../sources/papers/humanoid_pnb_learning-symmetric-and-low-energy-locomotion.md
summary: "Learning Symmetric and Low-energy Locomotion：列入 Paper Notebooks PROGRESS.md 待深读清单；深读笔记完成后补成完整摘要。"
---

# Learning Symmetric and Low-energy Locomotion

**Learning Symmetric and Low-energy Locomotion** 已列入 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html) 的 **PROGRESS.md 待深读** 清单（分类：13_Physics-Based_Animation）。本页 **还没有深读笔记**：只给出这篇论文的分类位置与原文入口，方法细节与数据请直接看原文。

## 一句话定义

Learning Symmetric and Low-energy Locomotion 的人形机器人学习论文条目，当前处于 Paper Notebooks 阅读进度（待深读）阶段。
...
| 计划文件夹 | `papers/13_Physics-Based_Animation/learning-symmetric-and-low-energy-locomotion` |
| arXiv | <https://arxiv.org/abs/1801.08093> |
...
**本页是 13_Physics-Based_Animation 分类下的待读条目，「对称」与「低能耗」这两个关键词还没有被展开成任何结论。**
...
- [humanoid_pnb_learning-symmetric-and-low-energy-locomotion.md](../../sources/papers/humanoid_pnb_learning-symmetric-and-low-energy-locomotion.md)
...
- 论文：<https://arxiv.org/abs/1801.08093>
