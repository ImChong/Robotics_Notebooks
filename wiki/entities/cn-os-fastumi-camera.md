...
**FastUMI_Camera** 是 [鹿明机器人](https://github.com/LumosRobot) 公开的 **数据集/Benchmark** 开源项目：提供FastUMI板载相机工具，承担第一视角视频采集与设备接入。
...
1. 从官方 GitHub/Gitee 组织检索 `FastUMI_Camera` 仓库并核对 README 许可与依赖。
