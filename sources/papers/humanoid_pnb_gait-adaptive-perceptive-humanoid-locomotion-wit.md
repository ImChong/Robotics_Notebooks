...
- **计划笔记路径：** `papers/03_High_Impact_Selection/gait-adaptive-perceptive-humanoid-locomotion-wit/gait-adaptive-perceptive-humanoid-locomotion-wit.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-gait-adaptive-perceptive-humanoid-locomotion-wit](../../wiki/entities/paper-notebook-gait-adaptive-perceptive-humanoid-locomotion-wit.md).

## 对 wiki 的映射

- [paper-notebook-gait-adaptive-perceptive-humanoid-locomotion-wit](../../wiki/entities/paper-notebook-gait-adaptive-perceptive-humanoid-locomotion-wit.md)
