...
- **标题：** Stabilizing Humanoid Robot Trajectory Generation via Physics-Informed Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/stabilizing-humanoid-robot-trajectory-generation/stabilizing-humanoid-robot-trajectory-generation.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-stabilizing-humanoid-robot-trajectory-generation](../../wiki/entities/paper-notebook-stabilizing-humanoid-robot-trajectory-generation.md).

## 对 wiki 的映射

- [paper-notebook-stabilizing-humanoid-robot-trajectory-generation](../../wiki/entities/paper-notebook-stabilizing-humanoid-robot-trajectory-generation.md)
