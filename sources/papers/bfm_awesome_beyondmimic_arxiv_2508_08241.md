...
> 来源归档（ingest · awesome-bfm-papers 第 35/41）
...
- **入库日期：** 2026-05-26
- **一句话说明：** guided diffusion 进入全身控制；生成方案仍需低层执行器兜底。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 05 Hierarchical control，编号 **35/41**。
- **公众号导读要点：** guided diffusion 进入全身控制；生成方案仍需低层执行器兜底。
