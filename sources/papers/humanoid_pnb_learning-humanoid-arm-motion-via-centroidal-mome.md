...
- **标题：** Learning Humanoid Arm Motion via Centroidal Momentum Regularized Multi-Agent Reinforcement Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/learning-humanoid-arm-motion-via-centroidal-mome/learning-humanoid-arm-motion-via-centroidal-mome.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-humanoid-arm-motion-via-centroidal-mome](../../wiki/entities/paper-notebook-learning-humanoid-arm-motion-via-centroidal-mome.md).

## 对 wiki 的映射

- [paper-notebook-learning-humanoid-arm-motion-via-centroidal-mome](../../wiki/entities/paper-notebook-learning-humanoid-arm-motion-via-centroidal-mome.md)
