...
- **ingest 档案：** [sources/papers/optimal_control.md](../../sources/papers/optimal_control.md)、[lqr_ilqr_primary_refs.md](../../sources/papers/lqr_ilqr_primary_refs.md)
...
- [Cartpole 问题](./cartpole.md) — 同一倒立摆对象：LQR / 能量法 vs RL 失败信号
