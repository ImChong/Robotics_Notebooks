...
sources:
  - ../../sources/papers/sun_awesome_touch_2602_14433_univtac-a-unified-simulation-platform-fo.md
...
**UniVTAC: A Unified Simulation Platform for Visuo-Tactile Manipulation Data Generation, Learning, and Benchmarking** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 054/065** 篇，分组 **Tactile Simulation & Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified simulation platform with eight representative visuo-tactile manipulation tasks; UniVTAC Encoder improves average success rates by 17.1%.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.14433> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.14433) 为准。
...
**本条目的站内价值是把「UniVTAC」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2602_14433_univtac-a-unified-simulation-platform-fo.md`](../../sources/papers/sun_awesome_touch_2602_14433_univtac-a-unified-simulation-platform-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.14433)
