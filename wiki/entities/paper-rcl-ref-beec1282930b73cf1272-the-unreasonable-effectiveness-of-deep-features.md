...
updated: 2026-09-25
venue: "CVPR 2018"
summary: "RCL Awesome WAM 清单收录（Evaluation metrics）；细节以原文 PDF / 项目页为准。"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_beec1282930b73cf1272_the-unreasonable-effectiveness-of-deep-f.md
...
**The Unreasonable Effectiveness of Deep Features as a Perceptual Metric** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 145/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

RCL Awesome WAM 清单收录（Evaluation metrics）；细节以原文 PDF / 项目页为准。
...
| 出处 | CVPR 2018 |
| 论文 | <https://openaccess.thecvf.com/content_cvpr_2018/html/Zhang_The_Unreasonable_Effectiveness_CVPR_2018_paper.html> |
| 子类 / 象限 | 图像质量指标 · 评估指标与协议 · 视觉编码器与表征 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openaccess.thecvf.com/content_cvpr_2018/html/Zhang_The_Unreasonable_Effectiveness_CVPR_2018_paper.html) 为准。
...
**本条目的站内价值是把「The Unreasonable Effectiveness of Deep Features as a Perceptual Metric」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_beec1282930b73cf1272_the-unreasonable-effectiveness-of-deep-f.md`](../../sources/papers/rcl_awesome_wam_ref_beec1282930b73cf1272_the-unreasonable-effectiveness-of-deep-f.md) — 本条目策展摘录
...
- [原文](https://openaccess.thecvf.com/content_cvpr_2018/html/Zhang_The_Unreasonable_Effectiveness_CVPR_2018_paper.html)
