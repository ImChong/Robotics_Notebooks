...
- [Being-M0.5](../entities/paper-notebook-being-m0-5-a-real-time-controllable-vision-langu.md) — 待深读
...
- [FRAME](../entities/paper-notebook-frame-floor-aligned-representation-for-avatar-mo.md) — 待深读
...
- [PICO](../entities/paper-notebook-pico-reconstructing-3d-people-in-contact-with-ob.md) — 待深读
- [PRIMAL Physically Reactive and Interactive Motor Model for Avatar Learning](../entities/paper-notebook-primal-physically-reactive-and-interactive-motor.md) — 待深读
- [PhysDiff](../entities/paper-notebook-physdiff-physics-guided-human-motion-diffusion-m.md) — 待深读
- [Predictive Sampling](../entities/paper-notebook-predictive-sampling-real-time-behaviour-synthesi.md) — 待深读
- [Scaling Large Motion Models with Million-Level Human Motions](../entities/paper-notebook-scaling-large-motion-models-with-million-level-h.md) — 待深读
- [SoftMimic](../entities/paper-notebook-softmimic-learning-compliant-whole-body-control.md) — 待深读
- [TEDi](../entities/paper-notebook-tedi-temporally-entangled-diffusion-for-long-ter.md) — 待深读
- [Taming Diffusion Probabilistic Models for Character Control](../entities/paper-notebook-taming-diffusion-probabilistic-models-for-charac.md) — 待深读
