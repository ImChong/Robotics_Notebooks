...
- **主链接：** <https://wayve.ai/>
- **代码：** 未在清单中标注
- **清单摘要：** Embodied AI for end-to-end autonomous driving using world models and VLAs.
- **沉淀到 wiki：** [`wiki/entities/painode-053-wayve.md`](../../wiki/entities/painode-053-wayve.md)
...
- 实体页：[`wiki/entities/painode-053-wayve.md`](../../wiki/entities/painode-053-wayve.md)
