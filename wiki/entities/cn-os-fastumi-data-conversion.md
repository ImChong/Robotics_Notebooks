...
**FastUMI_Data_Conversion** 是 [鹿明机器人](https://github.com/LumosRobot) 公开的 **数据集/Benchmark** 开源项目：把FastUMI采集结果转换成下游训练或分析所需格式，连接原始记录与策略训练数据。
...
1. 从官方 GitHub/Gitee 组织检索 `FastUMI_Data_Conversion` 仓库并核对 README 许可与依赖。
