...
arxiv: "2606.08555"
venue: "2026"
code: https://github.com/HaotianHehaha/FAWAM
summary: "In this paper, we propose FAWAM, a force-aware world action model that incorporates force information at three levels: perception, prediction, and closed-loop execution."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_08555_fawam-force-aware-world-action-models-fo.md
...
**FAWAM: Force-Aware World Action Models for Closed-Loop Contact-Rich Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 347/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this paper, we propose FAWAM, a force-aware world action model that incorporates force information at three levels: perception, prediction, and closed-loop execution.
...
| 代码/项目 | <https://github.com/HaotianHehaha/FAWAM> |
| 子类 / 象限 | 多模态触觉音频 · 联合视频动作建模 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.08555) 为准。
...
**本条目的站内价值是把「FAWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_08555_fawam-force-aware-world-action-models-fo.md`](../../sources/papers/rcl_awesome_wam_2606_08555_fawam-force-aware-world-action-models-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.08555)
