...
summary: "MimicDreamer converts human demonstrations into robot-looking videos paired with retargeted actions, then post-trains a separate π0 policy. The contribution is training-data alignment across viewpoint, embodiment and app"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2509_22199_mimicdreamer-aligning-human-and-robot-de.md
...
**MimicDreamer: Aligning Human and Robot Demonstrations for Scalable VLA Training** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 114/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

MimicDreamer converts human demonstrations into robot-looking videos paired with retargeted actions, then post-trains a separate π0 policy. The contribution is training-data alignment across viewpoint, embodiment and appearance. Physical-task results improve with added synthetic demonstrations, but real-robot superv...
...
| 分组 | Datasets |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2509.22199> |
| 子类 / 象限 | 合成数据与数据生成 · 伪动作标注 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.22199) 为准。
...
**本条目的站内价值是把「MimicDreamer」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2509_22199_mimicdreamer-aligning-human-and-robot-de.md`](../../sources/papers/rcl_awesome_wam_2509_22199_mimicdreamer-aligning-human-and-robot-de.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.22199)
