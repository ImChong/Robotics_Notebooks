...
- 自研旋转关节模组（需求瀑布→传动→五件套→测试）的工程链路见 [自研关节模组开发流程](../concepts/joint-module-self-development-workflow.md)；无框/空心杯/轴向磁通按关节分工见 [关节电机拓扑选型](../queries/humanoid-joint-motor-topology-selection.md)。
