...
- **代码：** 未在清单中标注
- **清单摘要：** Interactive benchmark for embodied dialog and task execution in household environments.
- **沉淀到 wiki：** [`wiki/entities/painode-023-teach.md`](../../wiki/entities/painode-023-teach.md)
...
- 实体页：[`wiki/entities/painode-023-teach.md`](../../wiki/entities/painode-023-teach.md)
