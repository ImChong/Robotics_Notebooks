...
status: complete
updated: 2026-09-20
summary: "Official ROS community discussion forum."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_039_ros-discourse.md
...
**ROS Discourse** 收录于 awesome-physical-ai（natnew、aichr）**第 039/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Official ROS community discussion forum.
...
- [`sources/repos/pai_awesome_community_039_ros-discourse.md`](../../sources/repos/pai_awesome_community_039_ros-discourse.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://discourse.ros.org/)
