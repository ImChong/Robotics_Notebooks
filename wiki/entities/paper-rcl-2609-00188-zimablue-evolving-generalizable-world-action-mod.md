...
updated: 2026-09-25
arxiv: "2609.00188"
summary: "We introduce ZimaBlue, a scalable framework for learning generalizable World Action Models (WAMs) from large-scale video."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_00188_zimablue-evolving-generalizable-world-ac.md
...
**ZimaBlue: Evolving Generalizable World Action Models through Scalable Video Pre-training** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 561/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2609.00188> |
| 项目页 | <https://zimablue-wam.github.io/> |
| 子类 / 象限 | 视觉规划与IDM · 高效推理与实时控制 · 泛化与动作对齐 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.00188) 为准。
...
**本条目的站内价值是把「ZimaBlue」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_00188_zimablue-evolving-generalizable-world-ac.md`](../../sources/papers/rcl_awesome_wam_2609_00188_zimablue-evolving-generalizable-world-ac.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.00188)
