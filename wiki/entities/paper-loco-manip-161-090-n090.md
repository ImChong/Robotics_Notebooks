...
sources:
  - ../../sources/papers/loco_manip_161_survey_090_n090.md
  - ../../sources/blogs/wechat_embodied_ai_lab_humanoid_loco_manip_161_survey.md
  - ../../sources/papers/humanoid_loco_manip_161_catalog.md
---

# 通过带有多模态基础模型的具体行动链推理的人形智能体用于零样本移动操作

**通过带有多模态基础模型的具体行动链推理的人形智能体用于零样本移动操作** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 090/161** 篇，归类为 **03 视觉感知驱动的人形移动操作**。
...
- 这篇工作先从相机图像/多视角观测、本体状态与关节序列、深度/点云/高度图恢复场景、目标或运动表征，再用PPO/RL 策略训练、扩散策略/流匹配、世界模型/视频预测生成低层控制器目标、地形/场景表征。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#090/161** · 视觉感知驱动的人形移动操作。
...
- 评测原始出处：[原文 / 项目页](https://ego-vcp.github.io/)（见上方「核心信息」表「论文/项目」一行）。
...
- 原始 source：[loco_manip_161_survey_090_n090.md](../../sources/papers/loco_manip_161_survey_090_n090.md)

## 参考来源

- [loco_manip_161_survey_090_n090.md](../../sources/papers/loco_manip_161_survey_090_n090.md) — 161 篇策展摘录
