...
summary: "小鹏 IRON CN118123869A：基座内丝杆滑块驱动的紧凑手指（2024-06-04 公开/公告）；基座内电机-丝杆-滑块将直线位移转为指段弯折，定位柱导向改善径向承载与末端稳定性。…"
---

# 小鹏 IRON · 基座内丝杆滑块驱动的紧凑手指（CN118123869A）

专利 **CN118123869A**（*基座内丝杆滑块驱动的紧凑手指*，小鹏机器人 / IRON 相关布局，2024-06-04）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**基座内电机-丝杆-滑块将直线位移转为指段弯折，定位柱导向改善径向承载与末端稳定性。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN118123869A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn118123869a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN118123869A](https://patents.google.com/patent/CN118123869A/zh)
