...
- **代码：** 未在清单中标注
- **清单摘要：** Intergovernmental principles guiding trustworthy AI deployment, including embodied systems.
- **沉淀到 wiki：** [`wiki/entities/painode-140-oecdaiprinciples.md`](../../wiki/entities/painode-140-oecdaiprinciples.md)
...
- 实体页：[`wiki/entities/painode-140-oecdaiprinciples.md`](../../wiki/entities/painode-140-oecdaiprinciples.md)
