...
updated: 2026-09-20
arxiv: "2502.03206"
summary: "Xue et al. General whole-body controller targeting fine-grained humanoid locomotion across gaits and tasks (RSS 2025)."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2502_03206_hugwbc-unified-humanoid-whole-body-c.md
...
**HugWBC: Unified Humanoid Whole-Body Controller** 收录于 awesome-physical-ai（natnew）**第 182/384** 条，分组 **Key Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Xue et al. General whole-body controller targeting fine-grained humanoid locomotion across gaits and tasks (RSS 2025).
...
| 分组 | Key Papers |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2502.03206> |
| arXiv | 2502.03206 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.03206) 为准。
...
**本条目的站内价值是把「HugWBC」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2502_03206_hugwbc-unified-humanoid-whole-body-c.md`](../../sources/papers/pai_awesome_2502_03206_hugwbc-unified-humanoid-whole-body-c.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2502.03206)
