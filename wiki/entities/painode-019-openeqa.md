...
status: complete
updated: 2026-09-20
summary: "Embodied question-answering benchmark over scanned real environments."
related:
...
sources:
  - ../../sources/repos/pai_awesome_benchmark_019_openeqa.md
...
**OpenEQA** 收录于 awesome-physical-ai（natnew）**第 019/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Embodied question-answering benchmark over scanned real environments.
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 在真实扫描场景上做具身问答，是该闭环第 ① 层「具身大脑/MLLM 认知评测」的代表性基准：只测理解不测执行

## 参考来源

- [`sources/repos/pai_awesome_benchmark_019_openeqa.md`](../../sources/repos/pai_awesome_benchmark_019_openeqa.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://open-eqa.github.io/)
