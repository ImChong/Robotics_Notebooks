...
- **计划笔记路径：** `papers/06_Manipulation/activeumi-robotic-manipulation-with-active-perce/activeumi-robotic-manipulation-with-active-perce.md`
- **分类：** 06_Manipulation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-activeumi-robotic-manipulation-with-active-perce](../../wiki/entities/paper-notebook-activeumi-robotic-manipulation-with-active-perce.md).

## 对 wiki 的映射

- [paper-notebook-activeumi-robotic-manipulation-with-active-perce](../../wiki/entities/paper-notebook-activeumi-robotic-manipulation-with-active-perce.md)
