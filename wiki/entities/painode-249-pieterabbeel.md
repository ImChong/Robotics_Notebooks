...
status: complete
updated: 2026-09-20
summary: "Berkeley BAIR, Covariant. Robot learning and RL."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_249_pieter-abbeel.md
...
**Pieter Abbeel** 收录于 awesome-physical-ai（natnew）**第 249/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Berkeley BAIR, Covariant. Robot learning and RL.
...
- [`sources/repos/pai_awesome_person_249_pieter-abbeel.md`](../../sources/repos/pai_awesome_person_249_pieter-abbeel.md) — 本条目策展摘录
