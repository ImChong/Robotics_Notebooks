...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2509_15953_right-side-out-learning-zero-shot-sim-to.md
...
**Right-Side-Out: Learning Zero-Shot Sim-to-Real Garment Reversal** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 012/063** 篇，分组 **22 Zero-Shot Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A zero-shot sim-to-real framework that solves garment reversal by exploiting task structures through task decomposition and high-fidelity simulation, enabling highly dynamic, severely occluded tasks without laborious human demonstrations
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.15953> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.15953) 为准。
...
**本条目的站内价值是把「Right-Side-Out」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2509_15953_right-side-out-learning-zero-shot-sim-to.md`](../../sources/papers/sun_awesome_r2s2r_2509_15953_right-side-out-learning-zero-shot-sim-to.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.15953)
