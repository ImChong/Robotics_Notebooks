...
**RoboMaster: Learning Video Generation for Robotic Manipulation with Collaborative Trajectory Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 329/571** 篇，分组 **812 Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
**本条目的站内价值是把「RoboMaster」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
