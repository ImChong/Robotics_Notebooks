...
status: complete
updated: 2026-09-20
summary: "Real-time intelligent systems."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_291_stanford-riselab.md
...
**Stanford RISELab** 收录于 awesome-physical-ai（aichr）**第 291/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Research Labs |
| 来源清单 | aichr |
| 主链接 | <https://github.com/rise-lab-skku> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/rise-lab-skku> |
...
- [`sources/repos/pai_awesome_lab_291_stanford-riselab.md`](../../sources/repos/pai_awesome_lab_291_stanford-riselab.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/rise-lab-skku)
