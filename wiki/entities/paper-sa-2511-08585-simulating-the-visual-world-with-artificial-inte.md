...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2511_08585_simulating-the-visual-world-with-artific.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Simulating the Visual World with Artificial Intelligence

**Simulating the Visual World with Artificial Intelligence: A Roadmap** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 058/571** 篇，分组 **117 Surveys & Perspectives**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Defines physical world models as complex digital engines that encode comprehensive world knowledge to simulate real‑world dynamics, following intrinsic physical and mathematical laws.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2511.08585> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.08585) 为准。
...
**本条目的站内价值是把「Simulating the Visual World with Artificial Intelligence」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2511_08585_simulating-the-visual-world-with-artific.md`](../../sources/papers/sun_awesome_wm_2511_08585_simulating-the-visual-world-with-artific.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.08585)
