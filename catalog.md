...
- [CHILD](wiki/entities/paper-notebook-child-a-whole-body-humanoid-teleoperation-system.md) — CHILD (Controller for Humanoid Imitation and Live Demonstration): a Whole-Body Humanoid Teleoperat `📅unknown` `[entity_page]`
