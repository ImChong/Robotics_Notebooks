...
updated: 2026-09-25
arxiv: "2606.13674"
summary: "This work presents RepWAM, a representation-centric world action model (WAM) built on representation visual-action tokenizers."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_13674_repwam-world-action-modeling-with-repres.md
...
**RepWAM: World Action Modeling with Representation Visual-Action Tokenizers** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 462/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.13674> |
| 项目页 | <https://wdrink.github.io/RepWAM/> |
| 子类 / 象限 | 潜空间预测与JEPA · 联合视频动作建模 · 泛化与动作对齐 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.13674) 为准。
...
**本条目的站内价值是把「RepWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_13674_repwam-world-action-modeling-with-repres.md`](../../sources/papers/rcl_awesome_wam_2606_13674_repwam-world-action-modeling-with-repres.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.13674)
