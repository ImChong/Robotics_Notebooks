...
arxiv: "2501.14729"
venue: "arXiv 2025"
summary: "Unified self-driving world model for simultaneous 3D scene understanding and generation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2501_14729_hermes-a-unified-self-driving-world-mode.md
...
**HERMES: A Unified Self-Driving World Model for Simultaneous 3D Scene Understanding and Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 443/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified self-driving world model for simultaneous 3D scene understanding and generation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.14729) 为准。
...
**本条目的站内价值是把「HERMES」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2501_14729_hermes-a-unified-self-driving-world-mode.md`](../../sources/papers/sun_awesome_wm_2501_14729_hermes-a-unified-self-driving-world-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.14729)
