...
arxiv: "2602.21633"
venue: "2026"
summary: "SC-VLA adds progress and end-effector-change predictions to a GR00T N1.5-based flow policy, then freezes it and trains a SAC residual controller. Predicted motion supplies a directional reward whose influence decreases w"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2602_21633_self-correcting-vla-online-action-refine.md
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2602.21633> |
| 子类 / 象限 | 潜空间预测与JEPA · 高效推理与实时控制 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.21633) 为准。
...
**本条目的站内价值是把「Self-Correcting VLA」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2602_21633_self-correcting-vla-online-action-refine.md`](../../sources/papers/rcl_awesome_wam_2602_21633_self-correcting-vla-online-action-refine.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.21633)
