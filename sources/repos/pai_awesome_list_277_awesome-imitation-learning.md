...
- **代码：** <https://github.com/kristery/awesome-imitation-learning>
- **清单摘要：** Learning from demonstrations.
- **沉淀到 wiki：** [`wiki/entities/painode-277-awesomeimitationlearning.md`](../../wiki/entities/painode-277-awesomeimitationlearning.md)
...
- 实体页：[`wiki/entities/painode-277-awesomeimitationlearning.md`](../../wiki/entities/painode-277-awesomeimitationlearning.md)
