---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, hardware]
status: complete
updated: 2026-09-20
summary: "Open-source modular robot for legged locomotion research."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_165_open-dynamic-robot-initiative.md
...
**Open Dynamic Robot Initiative** 收录于 awesome-physical-ai（natnew）**第 165/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-source modular robot for legged locomotion research.
...
|------|------|
| 编号 | 165/384 |
| 分组 | Hardware Platforms |
| 来源清单 | natnew |
| 主链接 | <https://open-dynamic-robot-initiative.github.io/> |

## 核心原理

Open-source modular robot for legged locomotion research.

该条目在 Physical AI 清单中的角色是 **hardware**，分组 **Hardware Platforms**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://open-dynamic-robot-initiative.github.io/> |
...
- [`sources/repos/pai_awesome_hardware_165_open-dynamic-robot-initiative.md`](../../sources/repos/pai_awesome_hardware_165_open-dynamic-robot-initiative.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://open-dynamic-robot-initiative.github.io/)
