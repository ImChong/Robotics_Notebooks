...
- **标题：** JAEGER: Dual-Level Humanoid Whole-Body Controller
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/jaeger-dual-level-humanoid-whole-body-controller/jaeger-dual-level-humanoid-whole-body-controller.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2505.06584>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-jaeger](../../wiki/entities/paper-notebook-jaeger.md).

## 对 wiki 的映射

- [paper-notebook-jaeger](../../wiki/entities/paper-notebook-jaeger.md)
...
- 论文：<https://arxiv.org/abs/2505.06584>
