...
updated: 2026-09-20
arxiv: "2205.06175"
summary: "Generalist policy architecture spanning embodied control and non-robotic tasks with tokenized actions. <!-- tags: paper -->"
related:
...
sources:
  - ../../sources/papers/pai_awesome_2205_06175_gato.md
...
**Gato** 收录于 awesome-physical-ai（natnew）**第 297/384** 条，分组 **Robotics Foundation Models**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Generalist policy architecture spanning embodied control and non-robotic tasks with tokenized actions. <!-- tags: paper -->
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2205.06175> |
| arXiv | 2205.06175 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2205.06175) 为准。
...
**本条目的站内价值是把「Gato」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2205_06175_gato.md`](../../sources/papers/pai_awesome_2205_06175_gato.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2205.06175)
