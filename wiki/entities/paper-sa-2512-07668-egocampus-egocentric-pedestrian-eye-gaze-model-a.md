...
sources:
  - ../../sources/papers/sun_awesome_ego_2512_07668_egocampus-egocentric-pedestrian-eye-gaze.md
...
**EgoCampus: Egocentric Pedestrian Eye Gaze Model and Dataset** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 055/249** 篇，分组 **25 Gaze Attention & Intention Prediction**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces EgoCampus dataset spanning 25 unique outdoor paths with recordings from 80+ pedestrians using Project Aria glasses
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2512.07668> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.07668) 为准。
...
**本条目的站内价值是把「EgoCampus」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2512_07668_egocampus-egocentric-pedestrian-eye-gaze.md`](../../sources/papers/sun_awesome_ego_2512_07668_egocampus-egocentric-pedestrian-eye-gaze.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.07668)
