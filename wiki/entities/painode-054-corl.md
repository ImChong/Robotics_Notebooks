...
status: complete
updated: 2026-09-20
summary: "Conference on Robot Learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_conference_054_corl.md
...
**CoRL** 收录于 awesome-physical-ai（natnew、aichr）**第 054/384** 条，分组 **Conferences / Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
- [`sources/repos/pai_awesome_conference_054_corl.md`](../../sources/repos/pai_awesome_conference_054_corl.md) — 本条目策展摘录
