...
> 来源归档（ingest · 人形 AMP 运动先验 19 篇 · 第 19/19）
...
- **入库日期：** 2026-05-26
- **一句话说明：** Embrace Collisions 的问题意识很直接：

## 核心摘录（策展，非全文）

- **在 AMP 四段地图中的位置：** 04 交互与长时程，编号 **19/19**。
- **公众号导读要点：** Embrace Collisions 的问题意识很直接：

## 对 wiki 的映射

  - [project-instinct](../../wiki/entities/project-instinct.md)
