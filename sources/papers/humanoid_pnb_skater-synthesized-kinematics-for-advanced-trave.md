...
- **计划笔记路径：** `papers/05_Locomotion/skater-synthesized-kinematics-for-advanced-trave/skater-synthesized-kinematics-for-advanced-trave.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-skater-synthesized-kinematics-for-advanced-trave](../../wiki/entities/paper-notebook-skater-synthesized-kinematics-for-advanced-trave.md).

## 对 wiki 的映射

- [paper-notebook-skater-synthesized-kinematics-for-advanced-trave](../../wiki/entities/paper-notebook-skater-synthesized-kinematics-for-advanced-trave.md)
