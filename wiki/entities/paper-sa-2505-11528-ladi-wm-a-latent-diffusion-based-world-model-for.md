...
summary: "Latent diffusion-based world model for predictive manipulation."
related:
...
**LaDi-WM: A Latent Diffusion-based World Model for Predictive Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 306/571** 篇，分组 **812 Manipulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Latent diffusion-based world model for predictive manipulation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.11528> |
| 代码/项目 | <https://github.com/GuHuangAI/LaDiWM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.11528) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 结论

**本条目的站内价值是把「LaDi-WM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2505_11528_ladi-wm-a-latent-diffusion-based-world-m.md`](../../sources/papers/sun_awesome_wm_2505_11528_ladi-wm-a-latent-diffusion-based-world-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.11528)
