...
updated: 2026-09-25
arxiv: "2606.22966"
summary: "Many recent vision-language-action (VLA) policies adopt an imagine-then-act design. A world-action model (WAM) first imagines a short future as a latent trajectory z~, on which the action is then conditioned."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_22966_attacking-the-trusted-imagination-oracle.md
...
**Attacking the Trusted Imagination: Oracle-Level Integrity Attacks on Imagine-then-Act World Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 195/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Many recent vision-language-action (VLA) policies adopt an imagine-then-act design. A world-action model (WAM) first imagines a short future as a latent trajectory z~, on which the action is then conditioned.
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.22966> |
| 子类 / 象限 | 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.22966) 为准。
...
**本条目的站内价值是把「Attacking the Trusted Imagination」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_22966_attacking-the-trusted-imagination-oracle.md`](../../sources/papers/rcl_awesome_wam_2606_22966_attacking-the-trusted-imagination-oracle.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.22966)
