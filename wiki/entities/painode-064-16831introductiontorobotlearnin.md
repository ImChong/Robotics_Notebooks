...
status: complete
updated: 2026-09-20
summary: "CMU's foundations of robot learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_064_16-831-introduction-to-robot-learnin.md
...
# 16-831 — Introduction to Robot Learning (CMU)

**16-831 — Introduction to Robot Learning (CMU)** 收录于 awesome-physical-ai（natnew）**第 064/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

CMU's foundations of robot learning.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://16-831-s24.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://16-831-s24.github.io/> |
...
- [`sources/repos/pai_awesome_course_064_16-831-introduction-to-robot-learnin.md`](../../sources/repos/pai_awesome_course_064_16-831-introduction-to-robot-learnin.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://16-831-s24.github.io/)
