...
summary: "Action-conditioned world models let an autonomous vehicle predict future camera scenes from its own planned controls, enabling planning and simulation without real-world rollouts, but at compact, trainable scale the futu"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_12987_diffusion-transformer-world-action-model.md
...
**Diffusion Transformer World-Action Model for AV Scene Prediction** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 011/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Action-conditioned world models let an autonomous vehicle predict future camera scenes from its own planned controls, enabling planning and simulation without real-world rollouts, but at compact, trainable scale the futures are ambiguous and the field's standard distortion metrics actively mislead: they reward a blu...
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.12987> |
| 代码/项目 | <https://github.com/dlcv-team/latent-world-models-av> |
| 子类 / 象限 | 神经世界模拟器 · 自动驾驶 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.12987) 为准。
...
**本条目的站内价值是把「Diffusion Transformer World-Action Model for AV Scene Prediction」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_12987_diffusion-transformer-world-action-model.md`](../../sources/papers/rcl_awesome_wam_2606_12987_diffusion-transformer-world-action-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.12987)
