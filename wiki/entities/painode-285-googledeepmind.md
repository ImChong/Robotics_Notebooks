...
sources:
  - ../../sources/repos/pai_awesome_lab_285_google-deepmind.md
...
**Google DeepMind** 收录于 awesome-physical-ai（aichr）**第 285/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
- [`sources/repos/pai_awesome_lab_285_google-deepmind.md`](../../sources/repos/pai_awesome_lab_285_google-deepmind.md) — 本条目策展摘录
