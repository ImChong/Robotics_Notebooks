...
updated: 2026-05-26
venue: curated
summary: "Deep Whole-body Parkour 不是 AMP 主线论文，但它对理解人形运动系统很重要。"
related:
...
**Deep Whole-body Parkour** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 18/19** 篇，归类为 **04 交互与长时程**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_18_deep_whole_body_parkour.md](../../sources/papers/humanoid_amp_survey_18_deep_whole_body_parkour.md)
