...
sources:
  - ../../sources/papers/sun_awesome_touch_2606_14981_inference-time-policy-steering-via-visio.md
...
**Inference-time Policy Steering via Vision and Touch (ViTaL)** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 025/065** 篇，分组 **51 Imitation Learning with Tactile Feedback**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Visuo-tactile inference-time steering framework formulating multimodal guidance as bi-level optimization; improves overall success by 51% over base policy.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.14981> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.14981) 为准。
...
**本条目的站内价值是把「Inference-time Policy Steering via Vision and Touch (ViTaL)」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2606_14981_inference-time-policy-steering-via-visio.md`](../../sources/papers/sun_awesome_touch_2606_14981_inference-time-policy-steering-via-visio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.14981)
