...
"""
    ...
    algorithms = [
        (
            ...
            [("CL", "Closed Loop", "闭环系统"), ("Pole", "System Pole", "决定响应快慢与阻尼"), ("SISO", "Single Input Single Output", "常见标定对象")],
            ["control", "classical-control", "linear-control", "pole-placement"],
            "通过配置闭环极点位置直接塑造伺服动态响应，用于高精度伺服调校。",
            ["../overview/robot-control-paradigm-classical-linear-feedback.md", "../methods/pid-control.md", "../methods/lqr-ilqr.md"],
        ...
        (
            ...
            [("CTC", "Computed Torque Control", "计算力矩控制"), ("FF", "Feedforward", "模型前馈"), ("PD", "Proportional–Derivative", "常见反馈层")],
            ["control", "model-based", "manipulation", "computed-torque", "dynamics"],
            "机械臂经典非线性控制：模型前馈线性化 + PD 反馈消除残差。",
            ["../overview/robot-control-paradigm-model-based-nonlinear-dynamics.md", "./inverse-dynamics-control.md", "./feedback-linearization-control.md", "../entities/pinocchio.md"],
        ...
        (
            ...
            [("IDC", "Inverse Dynamics Control", "逆动力学控制"), ("RNEA", "Recursive Newton-Euler Algorithm", "O(n) 逆动力学"), ("CTC", "Computed Torque Control", "IDC + 闭环反馈强化")],
            ["control", "model-based", "inverse-dynamics", "manipulation"],
            "以前馈逆动力学为主、弱反馈为辅的轨迹跟踪控制。",
            ["../overview/robot-control-paradigm-model-based-nonlinear-dynamics.md", "./computed-torque-control.md"],
        ...
        (
            ...
            [("FL", "Feedback Linearization", "反馈线性化"), ("DI", "Dynamic Inversion", "动态逆/微分同胚"), ("CTC", "Computed Torque Control", "机器人领域典型实现")],
            ["control", "nonlinear-control", "feedback-linearization", "model-based"],
            "通用非线性控制方法；CTC 可视为机器人动力学上的反馈线性化实例。",
            ["../overview/robot-control-paradigm-model-based-nonlinear-dynamics.md", "./computed-torque-control.md", "../formalizations/control-lyapunov-function.md"],
        ...
        (
            ...
            [("SMC", "Sliding Mode Control", "滑模控制"), ("Reaching", "Reaching Law", "趋近律"), ("Chattering", "Control Chattering", "高频抖振")],
            ["control", "robust-control", "sliding-mode", "disturbance-rejection"],
            "工业常用鲁棒控制：滑模面约束 + 切换控制抵抗扰动与模型误差。",
            ["../overview/robot-control-paradigm-robust-control.md", "./computed-torque-control.md", "./h-infinity-control.md"],
        ...
        (
            ...
            [("H∞", "H-infinity Control", "无穷范数鲁棒控制"), ("Riccati", "Algebraic Riccati Equation", "状态反馈求解"), ("LMI", "Linear Matrix Inequality", "多变量设计工具")],
            ["control", "robust-control", "h-infinity", "optimal-control"],
            "最优鲁棒控制框架，约束最坏扰动下的误差放大倍数。",
            ["../overview/robot-control-paradigm-robust-control.md", "./mu-synthesis-control.md", "../concepts/optimal-control.md"],
        ...
        (
            ...
            [("μ", "Structured Singular Value", "结构化奇异值"), ("DK", "D-K Iteration", "μ 综合迭代"), ("H∞", "H-infinity Control", "上层鲁棒框架")],
        ...
        (
            ...
            [("MRAC", "Model Reference Adaptive Control", "模型参考自适应"), ("Lyapunov", "Lyapunov Stability", "自适应律设计依据"), ("MIT", "MIT Rule", "经典自适应律（历史）")],
            ["control", "adaptive-control", "mrac"],
            "经典自适应控制：参考模型对标 + 参数自适应律。",
            ["../overview/robot-control-paradigm-adaptive-control.md", "./adaptive-computed-torque-control.md", "../formalizations/lyapunov.md"],
        ...
        (
            ...
            [("A-CTC", "Adaptive Computed Torque Control", "自适应 CTC"), ("CTC", "Computed Torque Control", "基础框架"), ("RLS", "Recursive Least Squares", "常用参数更新")],
            ["control", "adaptive-control", "computed-torque", "manipulation"],
            "CTC 与自适应辨识结合，缓解变负载导致的模型失配。",
            ["../overview/robot-control-paradigm-adaptive-control.md", "./computed-torque-control.md", "./recursive-least-squares-control.md"],
        ...
        (
            ...
            [("RLS", "Recursive Least Squares", "递归最小二乘"), ("SI", "System Identification", "系统辨识"), ("PE", "Persistent Excitation", "持续激励条件")],
            ["control", "adaptive-control", "system-identification", "rls"],
            "自适应控制的基础辨识工具，实时更新参数向量。",
            ["../overview/robot-control-paradigm-adaptive-control.md", "../concepts/system-identification.md", "./adaptive-computed-torque-control.md"],
        ...
        (
            ...
            [("Admittance", "Admittance Control", "导纳控制"), ("F/T", "Force/Torque Sensor", "外力测量"), ("Impedance", "Impedance Control", "位置→力对偶关系")],
            ["control", "force-control", "admittance", "compliance", "collaborative-robot"],
            "力输入、运动输出的柔顺控制，适合协作臂与人机交互。",
            ["../concepts/impedance-control.md", "../overview/robot-control-paradigm-hybrid-position-force.md", "./direct-force-feedback-control.md"],
        ...
        (
            ...
            [("Force", "Force Control", "力闭环"), ("F/T", "Force/Torque Sensor", "力测量"), ("PI", "Proportional–Integral", "常用力环调节")],
            ["control", "force-control", "contact-rich", "manipulation"],
            "最简力控：力误差直接驱动控制量，用于恒力按压/打磨。",
            ["../overview/robot-control-paradigm-hybrid-position-force.md", "../concepts/hybrid-force-position-control.md", "./admittance-control.md"],
        ...
        (
            ...
            [("ILC", "Iterative Learning Control", "迭代学习控制"), ("Batch", "Iteration Batch", "单次重复运行"), ("LTI", "Linear Time Invariant", "常见 ILC 核设计假设")],
            ["control", "ilc", "repetitive", "trajectory-tracking", "manufacturing"],
            "重复轨迹任务的批次学习优化，工业流水线常用。",
            ["../overview/robot-control-paradigm-receding-horizon-ilc.md", "./model-predictive-control.md", "./computed-torque-control.md"],
        ...
        (
            ...
            [("NN", "Neural Network", "神经网络"), ("FFN", "Feedforward Network", "全连接补偿"), ("LSTM", "Long Short-Term Memory", "时序残差")],
            ["control", "machine-learning", "neural-network", "residual-learning"],
            "用 NN 拟合摩擦/柔性等建模残差，与传统控制器并联。",
            ["../overview/robot-control-paradigm-ml-driven-control.md", "../concepts/neural-feedback-controller.md", "./computed-torque-control.md"],
        ...
        (
            ...
            [("GP", "Gaussian Process", "高斯过程"), ("PILCO", "Probabilistic Inference for Learning Control", "GP+策略优化代表"), ("UCB", "Upper Confidence Bound", "探索-利用平衡")],
        ...
        (
            ...
            [("FLC", "Fuzzy Logic Control", "模糊逻辑控制"), ("MF", "Membership Function", "隶属度函数"), ("Defuzz", "Defuzzification", "模糊输出转 crisp")],
        ...
        (
            ...
            [("K-means", "K-means Clustering", "常用聚类"), ("Anomaly", "Anomaly Regime", "异常工况簇"), ("Comp", "Compensation Map", "簇对应补偿表")],
            ["control", "unsupervised-learning", "clustering", "fault-compensation"],
            "无标签工况聚类 + 补偿表切换，应对摩擦漂移与磨损。",
            ["../overview/robot-control-paradigm-ml-driven-control.md", "./neural-network-compensation-control.md"],
        ...
        (
            ...
            [("Q-Learning", "Q-Learning", "表格 Q 更新"), ("DQN", "Deep Q-Network", "深度 Q 网络"), ("TD", "Temporal Difference", "时序差分学习")],
            ["reinforcement-learning", "value-based", "dqn", "q-learning", "discrete-control"],
            "离散动作 RL：Q-Learning → DQN → Double/Dueling 变体。",
            ["../overview/robot-control-paradigm-rl-intelligent-control.md", "./reinforcement-learning.md", "./policy-optimization.md", "../formalizations/mdp.md"],
        ...
        (
            ...
            [("HRL", "Hierarchical Reinforcement Learning", "分层强化学习"), ("Option", "Temporal Option", "时间抽象子策略"), ("Manager", "Manager Policy", "上层任务分配")],
            ["reinforcement-learning", "hrl", "hierarchical", "long-horizon"],
            "移动-抓取-放置等长流程任务的层次化 RL。",
            ["../overview/robot-control-paradigm-rl-intelligent-control.md", "./reinforcement-learning.md", "../concepts/curriculum-learning.md"],
