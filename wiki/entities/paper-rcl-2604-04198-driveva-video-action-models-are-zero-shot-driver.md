...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_04198_driveva-video-action-models-are-zero-sho.md
...
**DriveVA: Video Action Models are Zero-Shot Drivers** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 323/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 子类 / 象限 | 自动驾驶 · 联合视频动作建模 · 泛化与动作对齐 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.04198) 为准。
...
**本条目的站内价值是把「DriveVA」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_04198_driveva-video-action-models-are-zero-sho.md`](../../sources/papers/rcl_awesome_wam_2604_04198_driveva-video-action-models-are-zero-sho.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.04198)
