...
**Being-H** 是 [智在无界](https://github.com/BeingBeyond) 公开的 **数据集/Benchmark** 开源项目：从大规模第一视角人类操作视频学习手部动作和任务结构，再通过目标机器人数据适配到灵巧手操作；仓库连接非本体预训练、动作表示和真机后训练。
...
1. 从官方 GitHub/Gitee 组织检索 `Being-H` 仓库并核对 README 许可与依赖。
