...
arxiv: "2605.12334"
venue: "arXiv 2026"
summary: "Completely decouples world model learning from downstream task dependencies."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_12334_reinforcing-vlas-in-task-agnostic-world.md
...
**Reinforcing VLAs in Task-Agnostic World Models (RAW-Dream)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 225/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Completely decouples world model learning from downstream task dependencies.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.12334> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.12334) 为准。
...
**这一页能给你的是「Reinforcing VLAs in Task-Agnostic World Models (RAW-Dream)」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2605_12334_reinforcing-vlas-in-task-agnostic-world.md`](../../sources/papers/sun_awesome_wm_2605_12334_reinforcing-vlas-in-task-agnostic-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.12334)
