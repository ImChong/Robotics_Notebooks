...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_060_lidar-object-detection-and-sensor-fusion.md
  - ../../sources/papers/lc_awesome_sim2real_catalog.md
  - ../../sources/repos/awesome-sim2real.md
---

# LiDAR Object Detection and-Sensor Fusion in Simulation Environments Sensor mo...

**LiDAR Object Detection and-Sensor Fusion in Simulation Environments Sensor modelling towards advancements in Real2Sim-Sim2Real** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 060/139** 篇，分组 **Observation / Sensor Fusion**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://odr.chalmers.se/items/f604fa2f-b3e9-4e78-8e78-486f933fe311) 为准。
...
**本条目的站内价值是把「LiDAR Object Detection and-Sensor Fusion in Simulation Environments Sensor mo...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_060_lidar-object-detection-and-sensor-fusion.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_060_lidar-object-detection-and-sensor-fusion.md) — 本条目策展摘录
...
- [原文](https://odr.chalmers.se/items/f604fa2f-b3e9-4e78-8e78-486f933fe311)
