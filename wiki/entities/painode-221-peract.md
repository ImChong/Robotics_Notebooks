...
status: complete
updated: 2026-09-20
summary: "3D voxel-action transformer for language-conditioned, long-horizon manipulation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_221_peract.md
...
**PerAct** 收录于 awesome-physical-ai（natnew）**第 221/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

3D voxel-action transformer for language-conditioned, long-horizon manipulation.
...
- [`sources/repos/pai_awesome_method_221_peract.md`](../../sources/repos/pai_awesome_method_221_peract.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://peract.github.io/)
