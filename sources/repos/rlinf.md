...
- **沉淀到 wiki：** [STEAM（论文实体）](../../wiki/entities/paper-steam-advantage-modeling.md)、[Harness VLA / RPent](../../wiki/entities/paper-harness-vla.md)、[APXInf](../../wiki/entities/apxinf.md)
