...
**wujihandpy** 是 [舞肌科技](https://github.com/wuji-technology) 公开的 **工程与工具** 开源项目：以C++核心和Python绑定提供Wuji Hand设备发现、状态读取和控制接口，是连接上层算法与真实灵巧手的基础SDK。
...
1. 从官方 GitHub/Gitee 组织检索 `wujihandpy` 仓库并核对 README 许可与依赖。
