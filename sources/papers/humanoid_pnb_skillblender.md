...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/SkillBlender__Towards_Versatile_Humanoid_Whole-Body_Loco-Manipulation_via_Skill_/SkillBlender__Towards_Versatile_Humanoid_Whole-Body_Loco-Manipulation_via_Skill_.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-skillblender](../../wiki/entities/paper-notebook-skillblender.md).

## 对 wiki 的映射

- [paper-notebook-skillblender](../../wiki/entities/paper-notebook-skillblender.md)
