...
**ABot-Manipulation** 是 [阿里巴巴](https://github.com/amap-cvlab) 公开的 **VLA/操作模型** 开源项目：ABot-M0.5联合处理移动与操作任务，让世界表征、动作预测和评测在同一系统中连接；仓库开放推理、预训练模型和评测入口，用于检查移动操作是否真正形成统一动作接口。
...
1. 从官方 GitHub/Gitee 组织检索 `ABot-Manipulation` 仓库并核对 README 许可与依赖。
