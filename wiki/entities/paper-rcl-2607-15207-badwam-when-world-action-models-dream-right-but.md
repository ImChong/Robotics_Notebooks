...
summary: "We introduce BadWAM, a unified framework for modeling and evaluating World-Action Drift Attacks: a new class of WAM-specific adversarial attacks that use small visual perturbations to break the alignment between what a W"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_15207_badwam-when-world-action-models-dream-ri.md
...
**BadWAM: When World-Action Models Dream Right but Act Wrong** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 196/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/LiQiiiii/BadWAM> |
| 子类 / 象限 | 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.15207) 为准。
...
**本条目的站内价值是把「BadWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_15207_badwam-when-world-action-models-dream-ri.md`](../../sources/papers/rcl_awesome_wam_2607_15207_badwam-when-world-action-models-dream-ri.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.15207)
