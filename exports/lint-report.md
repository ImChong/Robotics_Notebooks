...
- play（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/entities/nvidia-physical-ai-datasets.md（缺 重定向就绪度）

### 💡 陈旧声明（含绝对化措辞但同主题有更晚更新页，建议复核；信息型，不阻塞 CI）（0 个）
- 无

### 💡 动力学/仿真/物理概念页缺回链「仿真物理保真度」知识链枢纽（信息型，不阻塞 CI）（1 个）
- wiki/concepts/software-in-the-loop.md
...
- wiki/entities/nvidia-spatial-intelligence-lab.md

📊 Sources 覆盖率：3466/3466 (100%) wiki/entity 页有 ingest 来源
