...
- **代码：** 未在清单中标注
- **清单摘要：** Regulation establishing risk-tiered obligations for AI systems sold or operated in the EU.
- **沉淀到 wiki：** [`wiki/entities/painode-131-euaiact.md`](../../wiki/entities/painode-131-euaiact.md)
...
- 实体页：[`wiki/entities/painode-131-euaiact.md`](../../wiki/entities/painode-131-euaiact.md)
