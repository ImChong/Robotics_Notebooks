...
arxiv: "2302.00111"
venue: "NeurIPS 2023"
summary: "UniPi turns a language instruction and current image into a video plan, refines its timing, then uses a separately trained inverse model to produce robot controls. Simulated manipulation results support compositional and"
related:
...
**Learning Universal Policies via Text-Guided Video Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 413/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

UniPi turns a language instruction and current image into a video plan, refines its timing, then uses a separately trained inverse model to produce robot controls. Simulated manipulation results support compositional and multitask transfer. Internet pretraining improves generated real-scene plans, but its reported s...
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2302.00111) 为准。
...
**本条目的站内价值是把「Learning Universal Policies via Text-Guided Video Generation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2302_00111_learning-universal-policies-via-text-gui.md`](../../sources/papers/rcl_awesome_wam_2302_00111_learning-universal-policies-via-text-gui.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2302.00111)
