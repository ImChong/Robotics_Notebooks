...
summary: "亮源新创 开源项目 LightNav-0（感知/导航）：紧凑通用具身导航模型（Qwen3-VL 基座）：指令跟随、开放词汇物体导航与视觉跟踪，支持跨机器人形态零样本迁移（配套 HuggingFace 权重）…"
institutions:
  - lightsource
---
...
**LightNav-0** 是 [亮源新创](https://github.com/lightorigins) 公开的 **感知/导航** 开源项目：紧凑通用具身导航模型（Qwen3-VL 基座）：指令跟随、开放词汇物体导航与视觉跟踪，支持跨机器人形态零样本迁移（配套 HuggingFace 权重）
...
| 机构 | 亮源新创 |
| 类别 | 感知/导航 |
| 官方组织 | https://github.com/lightorigins |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `LightNav-0` 仓库并核对 README 许可与依赖。
...
- [亮源新创 官方组织](https://github.com/lightorigins)
