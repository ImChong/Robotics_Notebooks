...
status: complete
updated: 2026-09-20
summary: "Research-grade mobile platforms including Husky and Jackal."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_156_clearpath-robotics.md
...
**Clearpath Robotics** 收录于 awesome-physical-ai（natnew）**第 156/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Research-grade mobile platforms including Husky and Jackal.
...
| 来源清单 | natnew |
| 主链接 | <https://clearpathrobotics.com/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://clearpathrobotics.com/> |
...
- [`sources/repos/pai_awesome_hardware_156_clearpath-robotics.md`](../../sources/repos/pai_awesome_hardware_156_clearpath-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://clearpathrobotics.com/)
