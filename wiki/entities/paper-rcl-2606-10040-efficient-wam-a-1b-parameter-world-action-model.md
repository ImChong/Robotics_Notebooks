...
summary: "We introduce Efficient-WAM, a World-Action Model that reduces the cost of future imagination while preserving its control benefit."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_10040_efficient-wam-a-1b-parameter-world-actio.md
...
**Efficient-WAM: A 1B-Parameter World-Action Model with Low-Cost Future Imagination** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 338/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce Efficient-WAM, a World-Action Model that reduces the cost of future imagination while preserving its control benefit.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.10040> |
| 代码/项目 | <https://github.com/jiajun613/Efficient-WAM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.10040) 为准。
...
**本条目的站内价值是把「Efficient-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_10040_efficient-wam-a-1b-parameter-world-actio.md`](../../sources/papers/rcl_awesome_wam_2606_10040_efficient-wam-a-1b-parameter-world-actio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.10040)
