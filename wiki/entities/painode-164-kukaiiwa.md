...
status: complete
updated: 2026-09-20
summary: "Industrial arm designed for human collaboration."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_164_kuka-iiwa.md
...
**Kuka iiwa** 收录于 awesome-physical-ai（natnew）**第 164/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Industrial arm designed for human collaboration.
...
- [`sources/repos/pai_awesome_hardware_164_kuka-iiwa.md`](../../sources/repos/pai_awesome_hardware_164_kuka-iiwa.md) — 本条目策展摘录
