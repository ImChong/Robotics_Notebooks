...
sources:
  - ../../sources/papers/loco_manip_161_survey_140_twist2.md
...
**TWIST2** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 140/161** 篇，归类为 **08 硬件平台、感知配置与部署扩展**。
...
- TWIST2 的实现路径是先把相机图像/多视角观测、人类视频/动捕轨迹、遥操作/外骨骼数据编码成多模态表征，再用ACT/行为克隆模仿学习、VLA 多模态动作模型、全身控制器/WBC/MPC预测可执行动作命令。关键点是保留 VLM 的语义理解，同时增加机器人状态和动作头，避免只停留在语言规划。
- 人形 Loco-Manip 161 篇 **#140/161** · 硬件平台、感知配置与部署扩展。
...
- 评测原始出处：[原文 / 项目页](https://twist-data.github.io)（见上方「核心信息」表「论文/项目」一行）。
...
- 原始 source：[loco_manip_161_survey_140_twist2.md](../../sources/papers/loco_manip_161_survey_140_twist2.md)

## 参考来源

- [loco_manip_161_survey_140_twist2.md](../../sources/papers/loco_manip_161_survey_140_twist2.md) — 161 篇策展摘录
