...
status: complete
updated: 2026-09-20
code: https://github.com/copper-project/copper-rs
summary: "OS for robots in Rust with deterministic replay."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_124_copper-rs.md
...
**copper-rs** 收录于 awesome-physical-ai（aichr）**第 124/384** 条，分组 **Frameworks & Libraries**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

OS for robots in Rust with deterministic replay.
...
|------|------|
| 编号 | 124/384 |
| 分组 | Frameworks & Libraries |
| 来源清单 | aichr |
| 主链接 | <https://github.com/copper-project/copper-rs> |
| 代码/仓库 | <https://github.com/copper-project/copper-rs> |

## 核心原理

OS for robots in Rust with deterministic replay.

该条目在 Physical AI 清单中的角色是 **resource**，分组 **Frameworks & Libraries**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/copper-project/copper-rs> |
| 代码/仓库 | <https://github.com/copper-project/copper-rs> |
...
- [`sources/repos/pai_awesome_resource_124_copper-rs.md`](../../sources/repos/pai_awesome_resource_124_copper-rs.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/copper-project/copper-rs)
