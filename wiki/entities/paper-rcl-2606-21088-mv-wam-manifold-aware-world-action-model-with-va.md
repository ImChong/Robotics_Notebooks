...
arxiv: "2606.21088"
venue: "2026"
summary: "Recent world action models achieve strong in-domain performance, yet their gains do not extend proportionally to out-of-distribution scenarios. To address this, we propose MV-WAM, a novel end-to-end framework that jointl"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_21088_mv-wam-manifold-aware-world-action-model.md
...
**MV-WAM: Manifold-Aware World Action Model with Value Augmentation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 420/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Recent world action models achieve strong in-domain performance, yet their gains do not extend proportionally to out-of-distribution scenarios. To address this, we propose MV-WAM, a novel end-to-end framework that jointly models visual prediction, action generation, and value estimation designed to effectively lever...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2606.21088> |
| 子类 / 象限 | 视觉规划与IDM · 泛化与动作对齐 · 策略后训练与WM-RL · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.21088) 为准。
...
**本条目的站内价值是把「MV-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_21088_mv-wam-manifold-aware-world-action-model.md`](../../sources/papers/rcl_awesome_wam_2606_21088_mv-wam-manifold-aware-world-action-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.21088)
