...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2604_14268_hy-world-2-0-a-multi-modal-world-model-f.md
...
**HY-World 2.0: A Multi-Modal World Model for Reconstructing, Generating, and Simulating 3D Worlds** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 019/571** 篇，分组 **111 General Simulation Platforms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Tencent Hunyuan's multi‑modal world model framework that accepts text, single‑/multi‑view images, and videos as input, and generates 3DGS scenes. It includes WorldLens, a high‑performance 3DGS rendering platform for interactive exploration.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.14268) 为准。
...
**这一页能给你的是「HY-World 2.0」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2604_14268_hy-world-2-0-a-multi-modal-world-model-f.md`](../../sources/papers/sun_awesome_wm_2604_14268_hy-world-2-0-a-multi-modal-world-model-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.14268)
