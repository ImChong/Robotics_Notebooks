...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_d0e3b6e2a926a91ba6c0_a-benchmark-for-the-evaluation-of-rgb-d.md
...
**A benchmark for the evaluation of RGB-D SLAM systems** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 094/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | IROS 2012 |
| 论文 | <https://portal.fis.tum.de/en/publications/a-benchmark-for-the-evaluation-of-rgb-d-slam-systems/> |
| 项目页 | <https://cvg.cit.tum.de/data/datasets/rgbd-dataset> |
| 子类 / 象限 | 三维场景与RGB-D数据 · 定位与SLAM数据 · 基准与评测协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://portal.fis.tum.de/en/publications/a-benchmark-for-the-evaluation-of-rgb-d-slam-systems/) 为准。
...
**本条目的站内价值是把「A benchmark for the evaluation of RGB-D SLAM systems」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_d0e3b6e2a926a91ba6c0_a-benchmark-for-the-evaluation-of-rgb-d.md`](../../sources/papers/rcl_awesome_wam_ref_d0e3b6e2a926a91ba6c0_a-benchmark-for-the-evaluation-of-rgb-d.md) — 本条目策展摘录
...
- [原文](https://portal.fis.tum.de/en/publications/a-benchmark-for-the-evaluation-of-rgb-d-slam-systems/)
