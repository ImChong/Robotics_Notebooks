...
# GHRC_Evaluation_2026

## 一句话定义

**GHRC_Evaluation_2026** 是 [优必选](https://github.com/UBTECH-Robot) 公开的 **评测** 开源项目：评测基准与工具
...
1. 从官方 GitHub/Gitee 组织检索 `GHRC_Evaluation_2026` 仓库并核对 README 许可与依赖。
