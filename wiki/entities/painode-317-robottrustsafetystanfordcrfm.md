...
status: complete
updated: 2026-09-20
summary: "Foundation-model centre research including robotic safety, evaluation, and failure modes."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_317_robot-trust-safety-stanford-crfm.md
...
# Robot Trust & Safety (Stanford CRFM)

**Robot Trust & Safety (Stanford CRFM)** 收录于 awesome-physical-ai（natnew）**第 317/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Foundation-model centre research including robotic safety, evaluation, and failure modes.
...
- [`sources/repos/pai_awesome_resource_317_robot-trust-safety-stanford-crfm.md`](../../sources/repos/pai_awesome_resource_317_robot-trust-safety-stanford-crfm.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://crfm.stanford.edu/)
