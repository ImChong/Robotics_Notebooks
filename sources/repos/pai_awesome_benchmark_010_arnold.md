...
- **代码：** 未在清单中标注
- **清单摘要：** Language-grounded continuous-task benchmark in physically realistic scenes.
- **沉淀到 wiki：** [`wiki/entities/painode-010-arnold.md`](../../wiki/entities/painode-010-arnold.md)
...
- 实体页：[`wiki/entities/painode-010-arnold.md`](../../wiki/entities/painode-010-arnold.md)
