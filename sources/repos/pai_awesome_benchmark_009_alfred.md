...
- **代码：** 未在清单中标注
- **清单摘要：** Vision-language benchmark for household instruction following and embodied task completion.
- **沉淀到 wiki：** [`wiki/entities/painode-009-alfred.md`](../../wiki/entities/painode-009-alfred.md)
...
- 实体页：[`wiki/entities/painode-009-alfred.md`](../../wiki/entities/painode-009-alfred.md)
