...
sources:
  - ../../sources/repos/pai_awesome_hardware_152_google-coral.md
...
**Google Coral** 收录于 awesome-physical-ai（aichr）**第 152/384** 条，分组 **Hardware & Actuation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
- [`sources/repos/pai_awesome_hardware_152_google-coral.md`](../../sources/repos/pai_awesome_hardware_152_google-coral.md) — 本条目策展摘录
