...
**Diffusion policy: Visuomotor policy learning via action diffusion** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 155/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | International Journal of Robotics Research 2025 |
| 论文 | <https://journals.sagepub.com/doi/10.1177/02783649241273668> |
| 代码/项目 | <https://github.com/real-stanford/diffusion_policy> |
| 子类 / 象限 | 动作策略基础 · 扩散与流匹配基础 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://journals.sagepub.com/doi/10.1177/02783649241273668) 为准。
...
**本条目的站内价值是把「Diffusion policy」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
