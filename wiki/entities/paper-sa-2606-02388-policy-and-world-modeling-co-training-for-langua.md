...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_02388_policy-and-world-modeling-co-training-fo.md
...
**Policy and World Modeling Co-Training for Language Agents (PaW)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 264/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Adds auxiliary WM supervision to policy during RL without changing inference.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.02388> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.02388) 为准。
...
**本条目的站内价值是把「Policy and World Modeling Co-Training for Language Agents (PaW)」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_02388_policy-and-world-modeling-co-training-fo.md`](../../sources/papers/sun_awesome_wm_2606_02388_policy-and-world-modeling-co-training-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.02388)
