...
status: complete
updated: 2026-09-20
summary: "MIT, Toyota Research Institute. Manipulation and control."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_251_russ-tedrake.md
...
**Russ Tedrake** 收录于 awesome-physical-ai（natnew）**第 251/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

MIT, Toyota Research Institute. Manipulation and control.
...
- [`sources/repos/pai_awesome_person_251_russ-tedrake.md`](../../sources/repos/pai_awesome_person_251_russ-tedrake.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://x.com/russtedrake)
