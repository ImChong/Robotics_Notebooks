...
- **代码：** 未在清单中标注
- **清单摘要：** Open-source underactuated manipulator for dexterous grasping and manipulation.
- **沉淀到 wiki：** [`wiki/entities/painode-172-umigripper.md`](../../wiki/entities/painode-172-umigripper.md)
...
- 实体页：[`wiki/entities/painode-172-umigripper.md`](../../wiki/entities/painode-172-umigripper.md)
