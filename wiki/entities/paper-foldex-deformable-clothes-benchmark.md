...
| 维度 | 归档口径（2026-09-14） |
|------|----------------------|
| **规模** | 2000+ 小时；20+ 任务；10+ 机器人本体 |
| **模态** | **归档未落明细** |
| **许可证** | **未知**（无官方仓库） |
| **重定向就绪度** | 多本体混采，需自行归一化 |

- **模态：** 摘录只给出「物理世界真实采集」与本体数量，未列出具体传感通道——视频 / 深度 / 点云 / 触觉 / 本体状态各有无、分辨率与频率均未知。代码与数据卡发布后须回填，**勿按同类衣物数据集的惯例默认**。
- **许可证：** 没有官方仓库，也就没有 LICENSE 与使用条款；商用与再分发边界均待确认。
