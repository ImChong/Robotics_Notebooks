...
arxiv: "2403.09630"
venue: "arXiv 2024"
summary: "Generalized predictive model for autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2403_09630_genad-generalized-predictive-model-for-a.md
...
**GenAD: Generalized Predictive Model for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 437/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2403.09630> |
| 项目页 | <https://github.com/OpenDriveLab/DriveAGI?tab=readme-ov-file#genad-dataset-opendv-youtube> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.09630) 为准。
...
**本条目的站内价值是把「GenAD」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2403_09630_genad-generalized-predictive-model-for-a.md`](../../sources/papers/sun_awesome_wm_2403_09630_genad-generalized-predictive-model-for-a.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.09630)
