...
arxiv: "2609.03557"
venue: "2026"
summary: "This paper documents the Unreal Engine synthetic-data component used in EchoWM: simulate character motion once, record controls and states, then replay the trajectory for high-quality multi-view rendering. Its contributi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_03557_building-pretraining-data-for-world-mode.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Building Pretraining Data for World Models

**Building Pretraining Data for World Models: An Unreal Engine-Based Pipeline for Action-Conditioned Video Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 101/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

This paper documents the Unreal Engine synthetic-data component used in EchoWM: simulate character motion once, record controls and states, then replay the trajectory for high-quality multi-view rendering. Its contribution is a production system combining scene curation, cache locality and failure recovery. Reported...
...
| 分组 | Datasets |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.03557> |
| 子类 / 象限 | 合成数据与数据生成 · 数据采集接口 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.03557) 为准。
- 横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 的 **Datasets** 分组逐条展开。
...
**本条目的站内价值是把「Building Pretraining Data for World Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Datasets** + Contribution 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/rcl_awesome_wam_2609_03557_building-pretraining-data-for-world-mode.md`](../../sources/papers/rcl_awesome_wam_2609_03557_building-pretraining-data-for-world-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.03557)
