...
arxiv: "2502.11537"
venue: "arXiv 2025"
summary: "Uncovers untapped potential in sample-efficient world model agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_11537_simulus-combining-improvements-in-sample.md
...
**Simulus: Combining Improvements in Sample-Efficient World Model Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 268/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Uncovers untapped potential in sample-efficient world model agents.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.11537> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.11537) 为准。
...
**本条目的站内价值是把「Simulus」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_11537_simulus-combining-improvements-in-sample.md`](../../sources/papers/sun_awesome_wm_2502_11537_simulus-combining-improvements-in-sample.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.11537)
