...
- **代码：** 未在清单中标注
- **清单摘要：** Real-world long-horizon furniture assembly benchmark.
- **沉淀到 wiki：** [`wiki/entities/painode-013-furniturebench.md`](../../wiki/entities/painode-013-furniturebench.md)
...
- 实体页：[`wiki/entities/painode-013-furniturebench.md`](../../wiki/entities/painode-013-furniturebench.md)
