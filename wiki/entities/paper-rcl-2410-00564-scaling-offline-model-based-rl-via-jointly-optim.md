...
arxiv: "2410.00564"
venue: "2024"
summary: "JOWA learns an Atari world model and distributional Q-function through one shared transformer, then searches short imagined futures to choose actions. Its strongest evidence is improved aggregate game return and data-eff"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2410_00564_scaling-offline-model-based-rl-via-joint.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Scaling Offline Model-Based RL via Jointly-Optimized World-Action Model Pretr...

**Scaling Offline Model-Based RL via Jointly-Optimized World-Action Model Pretraining** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 180/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

JOWA learns an Atari world model and distributional Q-function through one shared transformer, then searches short imagined futures to choose actions. Its strongest evidence is improved aggregate game return and data-efficient offline adaptation; neither universal game-wise scaling nor unconditional planning optimal...
...
| 出处 | 2024 |
| 论文 | <https://arxiv.org/abs/2410.00564> |
| 子类 / 象限 | 经典WM与模型式RL |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.00564) 为准。
...
**本条目的站内价值是把「Scaling Offline Model-Based RL via Jointly-Optimized World-Action Model Pretr...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2410_00564_scaling-offline-model-based-rl-via-joint.md`](../../sources/papers/rcl_awesome_wam_2410_00564_scaling-offline-model-based-rl-via-joint.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2410.00564)
