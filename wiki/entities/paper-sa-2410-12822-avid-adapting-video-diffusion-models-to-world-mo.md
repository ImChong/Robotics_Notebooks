...
arxiv: "2410.12822"
venue: "arXiv 2024"
code: https://github.com/microsoft/causica/tree/main/research_experiments/avid
summary: "Adapts video diffusion models to world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2410_12822_avid-adapting-video-diffusion-models-to.md
...
**AVID: Adapting Video Diffusion Models to World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 154/571** 篇，分组 **51 General Interactive Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Adapts video diffusion models to world models.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2410.12822> |
| 代码/项目 | <https://github.com/microsoft/causica/tree/main/research_experiments/avid> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.12822) 为准。
...
**本条目的站内价值是把「AVID」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2410_12822_avid-adapting-video-diffusion-models-to.md`](../../sources/papers/sun_awesome_wm_2410_12822_avid-adapting-video-diffusion-models-to.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2410.12822)
