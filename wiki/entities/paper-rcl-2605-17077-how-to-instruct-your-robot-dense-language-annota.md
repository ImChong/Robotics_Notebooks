...
updated: 2026-09-25
arxiv: "2605.17077"
summary: "We introduce DeMiAn (Dense Multi-aspect Annotation), a two-stage approach that first re-labels demonstration segments with VLM-generated annotations along four complementary aspects: physical motion, scene composition, a"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_17077_how-to-instruct-your-robot-dense-languag.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# How to Instruct Your Robot

**How to Instruct Your Robot: Dense Language Annotations Power Robot Policy Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 110/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce DeMiAn (Dense Multi-aspect Annotation), a two-stage approach that first re-labels demonstration segments with VLM-generated annotations along four complementary aspects: physical motion, scene composition, arm pose, and reasoning.
...
| 分组 | Datasets |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.17077> |
| 项目页 | <https://www.cs.toronto.edu/~davidj/publication/instruct-robot/> |
| 子类 / 象限 | 语言标注与再标注 · 机器人示范与操作数据 · 人类第一视角数据 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.17077) 为准。
...
**本条目的站内价值是把「How to Instruct Your Robot」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_17077_how-to-instruct-your-robot-dense-languag.md`](../../sources/papers/rcl_awesome_wam_2605_17077_how-to-instruct-your-robot-dense-languag.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.17077)
