...
- **标题：** SMAP: Self-supervised Motion Adaptation for Physically Plausible Humanoid Whole-body Control
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/smap-self-supervised-motion-adaptation-for-physi/smap-self-supervised-motion-adaptation-for-physi.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2505.19463>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-smap](../../wiki/entities/paper-notebook-smap.md).

## 对 wiki 的映射

- [paper-notebook-smap](../../wiki/entities/paper-notebook-smap.md)
...
- 论文：<https://arxiv.org/abs/2505.19463>
