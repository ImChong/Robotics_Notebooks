...
- **代码：** 未在清单中标注
- **清单摘要：** Standardized autonomous-driving benchmark emphasizing closed-loop safety and robustness.
- **沉淀到 wiki：** [`wiki/entities/painode-011-carlaleaderboard.md`](../../wiki/entities/painode-011-carlaleaderboard.md)
...
- 实体页：[`wiki/entities/painode-011-carlaleaderboard.md`](../../wiki/entities/painode-011-carlaleaderboard.md)
