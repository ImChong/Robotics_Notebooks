...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_58789fde10c5f80c4c89_real-time-humanoid-motion-generation-thr.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Real-time humanoid motion generation through ZMP manipulation based on invert...

**Real-time humanoid motion generation through ZMP manipulation based on inverted pendulum control** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 176/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICRA 2002 |
| 论文 | <https://ieeexplore.ieee.org/document/1014740> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/1014740) 为准。
...
**本条目的站内价值是把「Real-time humanoid motion generation through ZMP manipulation based on invert...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_58789fde10c5f80c4c89_real-time-humanoid-motion-generation-thr.md`](../../sources/papers/rcl_awesome_wam_ref_58789fde10c5f80c4c89_real-time-humanoid-motion-generation-thr.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/1014740)
