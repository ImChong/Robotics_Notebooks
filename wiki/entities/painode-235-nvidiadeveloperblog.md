...
status: complete
updated: 2026-09-20
summary: "Isaac, Cosmos, and robotics AI updates."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_235_nvidia-developer-blog.md
...
**NVIDIA Developer Blog** 收录于 awesome-physical-ai（natnew）**第 235/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Isaac, Cosmos, and robotics AI updates.
...
| 来源清单 | natnew |
| 主链接 | <https://developer.nvidia.com/blog/category/robotics/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://developer.nvidia.com/blog/category/robotics/> |
...
- [`sources/repos/pai_awesome_community_235_nvidia-developer-blog.md`](../../sources/repos/pai_awesome_community_235_nvidia-developer-blog.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://developer.nvidia.com/blog/category/robotics/)
