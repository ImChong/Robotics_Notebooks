...
status: complete
updated: 2026-09-20
summary: "Control and RL foundations for robotics deployment."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_063_16-745-optimal-control-and-reinforce.md
...
# 16-745 — Optimal Control and Reinforcement Learning (CMU)

**16-745 — Optimal Control and Reinforcement Learning (CMU)** 收录于 awesome-physical-ai（natnew）**第 063/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Control and RL foundations for robotics deployment.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://optimalcontrol.ri.cmu.edu/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://optimalcontrol.ri.cmu.edu/> |
...
- [`sources/repos/pai_awesome_course_063_16-745-optimal-control-and-reinforce.md`](../../sources/repos/pai_awesome_course_063_16-745-optimal-control-and-reinforce.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://optimalcontrol.ri.cmu.edu/)
