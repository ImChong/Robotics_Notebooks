---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, lab]
status: complete
updated: 2026-09-20
summary: "CSAIL robotics group."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_286_mit-distributed-robotics-lab.md
...
**MIT Distributed Robotics Lab** 收录于 awesome-physical-ai（aichr）**第 286/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

CSAIL robotics group.
...
| 分组 | Research Labs |
| 来源清单 | aichr |
| 主链接 | <https://www.csail.mit.edu/research/distributed-robotics-laboratory> |

## 核心原理

CSAIL robotics group.

该条目在 Physical AI 清单中的角色是 **lab**，分组 **Research Labs**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.csail.mit.edu/research/distributed-robotics-laboratory> |
...
- [`sources/repos/pai_awesome_lab_286_mit-distributed-robotics-lab.md`](../../sources/repos/pai_awesome_lab_286_mit-distributed-robotics-lab.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.csail.mit.edu/research/distributed-robotics-laboratory)
