...
- **入库日期：** 2026-09-20
- **arXiv：** （无 / 非 arXiv）
- **主链接：** <https://www.cds.caltech.edu/~murray/mlswiki/>
- **代码：** 未在清单中标注
- **清单摘要：** Murray, Li, Sastry. Free online textbook on manipulation.
- **沉淀到 wiki：** [`wiki/entities/painode-025-amathematicalintroductiontorobot.md`](../../wiki/entities/painode-025-amathematicalintroductiontorobot.md)
...
- 实体页：[`wiki/entities/painode-025-amathematicalintroductiontorobot.md`](../../wiki/entities/painode-025-amathematicalintroductiontorobot.md)
