...
- **标题：** PolygMap: A Perceptive Locomotion Framework for Humanoid Robot Stair Climbing
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/polygmap-a-perceptive-locomotion-framework-for-h/polygmap-a-perceptive-locomotion-framework-for-h.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-polygmap-a-perceptive-locomotion-framework-for-h](../../wiki/entities/paper-notebook-polygmap-a-perceptive-locomotion-framework-for-h.md).

## 对 wiki 的映射

- [paper-notebook-polygmap-a-perceptive-locomotion-framework-for-h](../../wiki/entities/paper-notebook-polygmap-a-perceptive-locomotion-framework-for-h.md)
