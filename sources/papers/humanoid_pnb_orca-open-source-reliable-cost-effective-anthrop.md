...
- **标题：** ORCA: Open-Source, Reliable, Cost-Effective, Anthropomorphic Robotic Hand for Uninterrupted Dexterous Task Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/orca-open-source-reliable-cost-effective-anthrop/orca-open-source-reliable-cost-effective-anthrop.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-orca-open-source-reliable-cost-effective-anthrop](../../wiki/entities/paper-notebook-orca-open-source-reliable-cost-effective-anthrop.md).

## 对 wiki 的映射

- [paper-notebook-orca-open-source-reliable-cost-effective-anthrop](../../wiki/entities/paper-notebook-orca-open-source-reliable-cost-effective-anthrop.md)
