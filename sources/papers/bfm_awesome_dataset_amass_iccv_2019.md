# AMASS（BFM 行为数据 · awesome-bfm-papers 数据集表）
...
- **出处：** 2019 · ICCV
- **规模：** 11265 clips · 40.0 h（列表标注）
- **论文链接：** <https://arxiv.org/abs/1904.03278>
- **代码/入口：** <https://amass.is.tue.mpg.de/>
- **索引来源：** [具身智能研究室 BFM 41 篇编译](../blogs/wechat_embodied_ai_lab_bfm_41_papers_survey.md)
- **入库日期：** 2026-05-26
- **一句话说明：** 动捕大集合；人形重定向与 BFM 训练常见起点。
- **本库已有归档：** [`sources/sites/amass-dataset.md`](../sites/amass-dataset.md)（本文件补 awesome-bfm 数据集表索引位）
...
- 数据集论文/页：<https://arxiv.org/abs/1904.03278>
