...
status: complete
updated: 2026-09-20
summary: "Core RL theory and algorithms with strong academic grounding."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_066_cs-234-reinforcement-learning-stanfo.md
...
**CS 234 — Reinforcement Learning (Stanford)** 收录于 awesome-physical-ai（natnew）**第 066/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Core RL theory and algorithms with strong academic grounding.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://web.stanford.edu/class/cs234/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://web.stanford.edu/class/cs234/> |
...
- [`sources/repos/pai_awesome_course_066_cs-234-reinforcement-learning-stanfo.md`](../../sources/repos/pai_awesome_course_066_cs-234-reinforcement-learning-stanfo.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://web.stanford.edu/class/cs234/)
