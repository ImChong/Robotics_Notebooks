...
sources:
  ...
  - ../../sources/repos/roboorchardhardware.md
summary: "地平线 开源项目 RoboOrchardHardware（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - horizon-robotics
---
...
**RoboOrchardHardware** 是 [地平线](https://github.com/HorizonRobotics) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
- 收录于 [国内具身智能开源全景（76 家 · 424 项）](../overview/china-domestic-embodied-opensource-76-companies-technology-map.md) 的 **第四层** 分组。
...
| 机构 | 地平线 |
| 类别 | 本体模型资产 |
| 官方组织 | https://github.com/HorizonRobotics |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `RoboOrchardHardware` 仓库并核对 README 许可与依赖。
...
- [RoboOrchardHardware 源码归档](../../sources/repos/roboorchardhardware.md)（<https://github.com/HorizonRobotics/RoboOrchardHardware>）

- [国内具身智能开源全景（微信公众号）](../../sources/blogs/wechat_embodied_station_domestic_opensource_panorama_2026-09-06.md)

## 推荐继续阅读

- [地平线 官方组织](https://github.com/HorizonRobotics)
