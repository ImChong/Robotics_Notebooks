...
- **代码：** 未在清单中标注
- **清单摘要：** IEEE-RAS International Conference on Humanoid Robots.
- **沉淀到 wiki：** [`wiki/entities/painode-056-humanoids.md`](../../wiki/entities/painode-056-humanoids.md)
...
- 实体页：[`wiki/entities/painode-056-humanoids.md`](../../wiki/entities/painode-056-humanoids.md)
