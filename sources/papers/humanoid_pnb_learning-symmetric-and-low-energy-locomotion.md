...
- **标题：** Learning Symmetric and Low-energy Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/learning-symmetric-and-low-energy-locomotion/learning-symmetric-and-low-energy-locomotion.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-symmetric-and-low-energy-locomotion](../../wiki/entities/paper-notebook-learning-symmetric-and-low-energy-locomotion.md).

## 对 wiki 的映射

- [paper-notebook-learning-symmetric-and-low-energy-locomotion](../../wiki/entities/paper-notebook-learning-symmetric-and-low-energy-locomotion.md)
