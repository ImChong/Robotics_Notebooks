...
## [2026-06-19] lint | health-check | 自动化 wiki 健康检查
...
- wiki/entities/paper-mujica-wheel-legged-multi-skill.md（缺 评测）
- wiki/entities/paper-swap-parkour.md（缺 对比）
...
📊 Sources 覆盖率：1224/1252 (98%) wiki/entity 页有 ingest 来源
