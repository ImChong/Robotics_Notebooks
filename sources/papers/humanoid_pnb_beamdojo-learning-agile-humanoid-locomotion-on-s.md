...
- **标题：** BeamDojo: Learning Agile Humanoid Locomotion on Sparse Footholds
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/beamdojo-learning-agile-humanoid-locomotion-on-s/beamdojo-learning-agile-humanoid-locomotion-on-s.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-beamdojo-learning-agile-humanoid-locomotion-on-s](../../wiki/entities/paper-notebook-beamdojo-learning-agile-humanoid-locomotion-on-s.md).

## 对 wiki 的映射

- [paper-notebook-beamdojo-learning-agile-humanoid-locomotion-on-s](../../wiki/entities/paper-notebook-beamdojo-learning-agile-humanoid-locomotion-on-s.md)
