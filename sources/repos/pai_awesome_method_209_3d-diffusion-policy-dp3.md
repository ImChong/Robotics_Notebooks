...
- **代码：** 未在清单中标注
- **清单摘要：** Point-cloud-conditioned diffusion policy that improves data efficiency and robustness over image-based variants.
- **沉淀到 wiki：** [`wiki/entities/painode-209-3ddiffusionpolicydp3.md`](../../wiki/entities/painode-209-3ddiffusionpolicydp3.md)
...
- 实体页：[`wiki/entities/painode-209-3ddiffusionpolicydp3.md`](../../wiki/entities/painode-209-3ddiffusionpolicydp3.md)
