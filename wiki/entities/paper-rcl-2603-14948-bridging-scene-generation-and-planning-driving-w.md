...
arxiv: "2603.14948"
venue: "2026"
code: https://github.com/TabGuigui/WorldDrive
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_14948_bridging-scene-generation-and-planning-d.md
...
**Bridging Scene Generation and Planning: Driving with World Model via Unifying Vision and Motion Representation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 287/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2603.14948> |
| 代码/项目 | <https://github.com/TabGuigui/WorldDrive> |
| 子类 / 象限 | 自动驾驶 · 潜空间预测与JEPA · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.14948) 为准。
...
**本条目的站内价值是把「Bridging Scene Generation and Planning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_14948_bridging-scene-generation-and-planning-d.md`](../../sources/papers/rcl_awesome_wam_2603_14948_bridging-scene-generation-and-planning-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.14948)
