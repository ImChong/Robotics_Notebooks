...
**A3-A3U-robot-model** 是 [智元机器人](https://github.com/AgibotTech) 公开的 **本体模型资产** 开源项目：提供A3与A3 Ultra多个版本的URDF、MJCF、网格、RViz配置及部分SRDF，使机器人几何、关节和规划语义能够进入ROS、MuJoCo与MoveIt工具链。
...
1. 从官方 GitHub/Gitee 组织检索 `A3-A3U-robot-model` 仓库并核对 README 许可与依赖。
