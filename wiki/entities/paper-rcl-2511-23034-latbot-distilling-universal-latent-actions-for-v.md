...
arxiv: "2511.23034"
venue: "2025"
summary: "LatBot learns scene and motion latents from language-conditioned robot and human manipulation videos, supervises them through future-image and physical-action decoding, then distills them into a VLA student. An action ex"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2511_23034_latbot-distilling-universal-latent-actio.md
...
**LatBot: Distilling Universal Latent Actions for Vision-Language-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 243/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

LatBot learns scene and motion latents from language-conditioned robot and human manipulation videos, supervises them through future-image and physical-action decoding, then distills them into a VLA student. An action expert converts the student's features into executable commands. The strongest evidence concerns do...
...
| 分组 | VLA |
| 出处 | 2025 |
| 论文 | <https://arxiv.org/abs/2511.23034> |
| 子类 / 象限 | 潜动作预训练 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.23034) 为准。
...
**本条目的站内价值是把「LatBot」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2511_23034_latbot-distilling-universal-latent-actio.md`](../../sources/papers/rcl_awesome_wam_2511_23034_latbot-distilling-universal-latent-actio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.23034)
