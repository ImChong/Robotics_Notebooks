...
status: complete
updated: 2026-09-20
summary: "Compact open-source desktop robot from $299 for AI experimentation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_169_reachy-mini.md
...
**Reachy Mini** 收录于 awesome-physical-ai（natnew）**第 169/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Compact open-source desktop robot from $299 for AI experimentation.
...
| 来源清单 | natnew |
| 主链接 | <https://huggingface.co/blog/reachy-mini> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://huggingface.co/blog/reachy-mini> |
...
- [`sources/repos/pai_awesome_hardware_169_reachy-mini.md`](../../sources/repos/pai_awesome_hardware_169_reachy-mini.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://huggingface.co/blog/reachy-mini)
