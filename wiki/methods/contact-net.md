...
- [Grasp Pose Estimation (抓取位姿估计)](./grasp-pose-estimation.md) — 抓取检测谱系总览；与 Contact-GraspNet 在「接触面预测」思路同源
- [AnyGrasp vs GraspNet：抓取检测家族选型对比](../comparisons/anygrasp-vs-graspnet.md) — GraspNet 家族（含 Contact-GraspNet）与 AnyGrasp SDK 的横向选型坐标
