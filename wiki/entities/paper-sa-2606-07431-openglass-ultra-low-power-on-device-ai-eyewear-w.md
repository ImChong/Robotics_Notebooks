...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_07431_openglass-ultra-low-power-on-device-ai-e.md
...
**OpenGlass: Ultra-Low-Power On-Device AI Eyewear with Event-based Vision** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 225/249** 篇，分组 **Low-Power On-Device Perception**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Fully open-source event camera wearable hardware stack paired with lightweight edge inference algorithms
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.07431> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.07431) 为准。
...
**本条目的站内价值是把「OpenGlass」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_07431_openglass-ultra-low-power-on-device-ai-e.md`](../../sources/papers/sun_awesome_ego_2606_07431_openglass-ultra-low-power-on-device-ai-e.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.07431)
