...
- **代码 / 硬件：** <https://github.com/jessicayin/osmo_tactile_glove>
- **开源核查（2026-07-28）：** **源码与设计文件已公开，许可未明确**；示例数据下载脚本仍标 TODO。
- **入库日期：** 2026-06-07
...
- 知识归纳见 wiki 实体页：[paper-notebook-osmo-open-source-tactile-glove-for-human-to-robo](../../wiki/entities/paper-notebook-osmo-open-source-tactile-glove-for-human-to-robo.md).

## 对 wiki 的映射

- [paper-notebook-osmo-open-source-tactile-glove-for-human-to-robo](../../wiki/entities/paper-notebook-osmo-open-source-tactile-glove-for-human-to-robo.md)
