...
- **标题：** Booster Gym: An End-to-End RL Framework for Humanoid Robot Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/booster-gym-an-end-to-end-rl-framework-for-human/booster-gym-an-end-to-end-rl-framework-for-human.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-booster-gym-an-end-to-end-rl-framework-for-human](../../wiki/entities/paper-notebook-booster-gym-an-end-to-end-rl-framework-for-human.md).

## 对 wiki 的映射

- [paper-notebook-booster-gym-an-end-to-end-rl-framework-for-human](../../wiki/entities/paper-notebook-booster-gym-an-end-to-end-rl-framework-for-human.md)
