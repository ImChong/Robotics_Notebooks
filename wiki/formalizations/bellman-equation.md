...
- [lqr_ilqr_primary_refs.md](../../sources/papers/lqr_ilqr_primary_refs.md) — LQR 与 Riccati / 动态规划对偶（Kalman 1964 等）
...
- [GAE](./gae.md) — 基于 Bellman TD 残差的优势估计方法
- [HJB](./hjb.md) — Bellman 最优方程在连续时间域的 PDE 形式
