...
**Impact of Static Friction on Sim2Real in Robotic Reinforcement Learning** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 016/063** 篇，分组 **23 Domain Randomization & Adaptation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Investigates the underexplored impact of Static friction on the Sim2Real gap, proposing a Static friction-aware domain randomization method to bridge the simulation-to-reality transfer
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.01255> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.01255) 为准。
...
**本条目的站内价值是把「Impact of Static Friction on Sim2Real in Robotic Reinforcement Learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2503_01255_impact-of-static-friction-on-sim2real-in.md`](../../sources/papers/sun_awesome_r2s2r_2503_01255_impact-of-static-friction-on-sim2real-in.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.01255)
