...
**WALL-X** 是 [自变量机器人](https://github.com/X-Square-Robot) 公开的 **VLA/操作模型** 开源项目：语言、视觉和机器人状态经过统一模型生成操作动作，面向多任务与跨本体执行；仓库开放训练或推理入口，构成X Square具身模型主线。
...
1. 从官方 GitHub/Gitee 组织检索 `WALL-X` 仓库并核对 README 许可与依赖。
