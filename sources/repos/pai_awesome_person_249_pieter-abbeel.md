...
- **代码：** 未在清单中标注
- **清单摘要：** Berkeley BAIR, Covariant. Robot learning and RL.
- **沉淀到 wiki：** [`wiki/entities/painode-249-pieterabbeel.md`](../../wiki/entities/painode-249-pieterabbeel.md)
...
- 实体页：[`wiki/entities/painode-249-pieterabbeel.md`](../../wiki/entities/painode-249-pieterabbeel.md)
