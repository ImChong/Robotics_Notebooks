...
**WorldArena: A Unified Benchmark for Evaluating Perception and Functional Utility of Embodied World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 049/571** 篇，分组 **115 Benchmarks for World Model Simulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.08971) 为准。
...
**本条目的站内价值是把「WorldArena」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
