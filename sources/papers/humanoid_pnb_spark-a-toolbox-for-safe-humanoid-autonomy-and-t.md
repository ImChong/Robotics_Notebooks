...
- **标题：** SPARK: A Toolbox for Safe Humanoid Autonomy and Teleoperation
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/spark-a-toolbox-for-safe-humanoid-autonomy-and-t/spark-a-toolbox-for-safe-humanoid-autonomy-and-t.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2502.03132>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-spark](../../wiki/entities/paper-notebook-spark.md).

## 对 wiki 的映射

- [paper-notebook-spark](../../wiki/entities/paper-notebook-spark.md)
...
- 论文：<https://arxiv.org/abs/2502.03132>
