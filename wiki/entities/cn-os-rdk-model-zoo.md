...
**rdk_model_zoo** 是 [地瓜机器人](https://github.com/D-Robotics) 公开的 **SDK/驱动** 开源项目：提供在RDK平台部署的模型示例与转换入口，覆盖机器人感知和边缘推理任务。
...
1. 从官方 GitHub/Gitee 组织检索 `rdk_model_zoo` 仓库并核对 README 许可与依赖。
