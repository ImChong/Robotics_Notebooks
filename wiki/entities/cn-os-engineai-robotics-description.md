...
**engineai_robotics_description** 是 [众擎机器人](https://github.com/engineai-robotics) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `engineai_robotics_description` 仓库并核对 README 许可与依赖。
