...
arxiv: "2503.22020"
venue: "arXiv 2025"
summary: "Visual chain-of-thought reasoning for VLAs."
related:
...
**CoT-VLA: Visual Chain-of-Thought Reasoning for Vision-Language-Action Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 189/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Visual chain-of-thought reasoning for VLAs.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.22020> |
| 项目页 | <https://cot-vla.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.22020) 为准。
...
**本条目的站内价值是把「CoT-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [原文](https://arxiv.org/abs/2503.22020)
