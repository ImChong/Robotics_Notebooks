...
updated: 2026-09-20
arxiv: "2304.13653"
summary: "Haarnoja et al. Deep RL pipeline producing whole-body soccer behaviours on a small humanoid (Science Robotics 2024)."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2304_13653_bipedal-soccer-deepmind-op3.md
...
# Bipedal Soccer (DeepMind OP3)

**Bipedal Soccer (DeepMind OP3)** 收录于 awesome-physical-ai（natnew）**第 187/384** 条，分组 **Locomotion / Key Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Haarnoja et al. Deep RL pipeline producing whole-body soccer behaviours on a small humanoid (Science Robotics 2024).
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2304.13653> |
| arXiv | 2304.13653 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2304.13653) 为准。
...
**本条目的站内价值是把「Bipedal Soccer (DeepMind OP3)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2304_13653_bipedal-soccer-deepmind-op3.md`](../../sources/papers/pai_awesome_2304_13653_bipedal-soccer-deepmind-op3.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2304.13653)
