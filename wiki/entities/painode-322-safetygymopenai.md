...
summary: "Environments for benchmarking constrained and safe-exploration RL."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_322_safety-gym-openai.md
...
**Safety Gym (OpenAI)** 收录于 awesome-physical-ai（natnew）**第 322/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Environments for benchmarking constrained and safe-exploration RL.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/openai/safety-gym> |
| 代码/仓库 | <https://github.com/openai/safety-gym> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/openai/safety-gym> |
| 代码/仓库 | <https://github.com/openai/safety-gym> |
...
- [`sources/repos/pai_awesome_resource_322_safety-gym-openai.md`](../../sources/repos/pai_awesome_resource_322_safety-gym-openai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/openai/safety-gym)
