...
summary: "小鹏 IRON CN120238826A：无线信道动作识别与可中断机器人响应（2025-07-01 公开/公告）；从 CSI 序列映射人体动作，执行中若满足中断条件则切换新动作而非排队等待当前动作结束。…"
---

# 小鹏 IRON · 无线信道动作识别与可中断机器人响应（CN120238826A）

专利 **CN120238826A**（*无线信道动作识别与可中断机器人响应*，小鹏机器人 / IRON 相关布局，2025-07-01）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**从 CSI 序列映射人体动作，执行中若满足中断条件则切换新动作而非排队等待当前动作结束。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN120238826A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn120238826a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN120238826A](https://patents.google.com/patent/CN120238826A/zh)
