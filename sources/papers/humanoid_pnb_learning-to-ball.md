...
- **一手策展：** [`learning_to_ball_arxiv_2509_22442.md`](./learning_to_ball_arxiv_2509_22442.md)
- **入库日期：** 2026-06-07（深读笔记锚点）；**深化 ingest：** 2026-07-28
- **一句话说明：** 把篮球里「运球 / 投篮 / 上篮 / 跑动 / 转身 / 捡球」这些差异极大、各自训好的子技能策略，用一套策略组合框架 + 一个高层「软路由器」拼起来——关键在于处理那些「目标说不清」的过渡段，让物理仿真角色能连贯打出 shoot-off-the-dribble、catch-and-shoot、board-and-bang 这类多阶段长程连招。

## 核心摘录（策展）

- 深读笔记（2026-06-27）已覆盖问题设定、软路由直觉、开源入口与面试问答；**方法细节与定量指标以 arXiv / 项目页 / 仓库为准**。
- 知识归纳见 wiki 实体页：[paper-notebook-learning-to-ball](../../wiki/entities/paper-notebook-learning-to-ball.md)。

## 对 wiki 的映射

- [paper-notebook-learning-to-ball](../../wiki/entities/paper-notebook-learning-to-ball.md)
...
- 一手论文归档：[learning_to_ball_arxiv_2509_22442.md](./learning_to_ball_arxiv_2509_22442.md)
