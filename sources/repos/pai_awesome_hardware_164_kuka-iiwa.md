...
- **代码：** 未在清单中标注
- **清单摘要：** Industrial arm designed for human collaboration.
- **沉淀到 wiki：** [`wiki/entities/painode-164-kukaiiwa.md`](../../wiki/entities/painode-164-kukaiiwa.md)
...
- 实体页：[`wiki/entities/painode-164-kukaiiwa.md`](../../wiki/entities/painode-164-kukaiiwa.md)
