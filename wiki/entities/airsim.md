...
**AirSim**（[microsoft/AirSim](https://github.com/microsoft/AirSim)）是微软开源的 **高保真视觉仿真平台**，基于 **[Unreal Engine 5](./unreal-engine-5.md)** 与 **[Unity Engine](./unity-engine.md)** 分支，面向无人机与地面自动驾驶的 **感知、控制与 Sim2Real** 研究。
