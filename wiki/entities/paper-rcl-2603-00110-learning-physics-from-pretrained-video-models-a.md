...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_00110_learning-physics-from-pretrained-video-m.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Learning Physics from Pretrained Video Models

**Learning Physics from Pretrained Video Models: A Multimodal Continuous and Sequential World Interaction Models for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 411/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | ICMR 2026 |
| 论文 | <https://dl.acm.org/doi/10.1145/3805622.3810752> |
| 子类 / 象限 | 视觉规划与IDM · 高效推理与实时控制 · Q2 · One Model × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://dl.acm.org/doi/10.1145/3805622.3810752) 为准。
...
**本条目的站内价值是把「Learning Physics from Pretrained Video Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_00110_learning-physics-from-pretrained-video-m.md`](../../sources/papers/rcl_awesome_wam_2603_00110_learning-physics-from-pretrained-video-m.md) — 本条目策展摘录
...
- [原文](https://dl.acm.org/doi/10.1145/3805622.3810752)
