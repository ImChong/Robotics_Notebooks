...
arxiv: "2608.21402"
venue: "2026"
summary: "We introduce a carve-and-hold-out evaluation protocol on the LIBERO-Plus camera track that separates a distribution-matched ceiling from genuine interpolation and extrapolation to held-out viewpoints, with a matched pair"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_21402_selective-cross-view-consistency-for-wor.md
...
**Selective Cross-View Consistency for World Action Models: Held-Out Viewpoint Robustness Without Test-Time Camera Information** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 478/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2608.21402> |
| 子类 / 象限 | 联合视频动作建模 · 三维多视角建模 · 泛化与动作对齐 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.21402) 为准。
...
**本条目的站内价值是把「Selective Cross-View Consistency for World Action Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_21402_selective-cross-view-consistency-for-wor.md`](../../sources/papers/rcl_awesome_wam_2608_21402_selective-cross-view-consistency-for-wor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.21402)
