...
- **代码：** 未在清单中标注
- **清单摘要：** Research-grade mobile platforms including Husky and Jackal.
- **沉淀到 wiki：** [`wiki/entities/painode-156-clearpathrobotics.md`](../../wiki/entities/painode-156-clearpathrobotics.md)
...
- 实体页：[`wiki/entities/painode-156-clearpathrobotics.md`](../../wiki/entities/painode-156-clearpathrobotics.md)
