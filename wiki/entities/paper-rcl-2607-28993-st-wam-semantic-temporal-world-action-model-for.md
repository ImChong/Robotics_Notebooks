...
summary: "Rather than correcting the predicted futures, we propose Semantic-Temporal WAM (ST-WAM) to improve action robustness by using DINOv3 as a shared semantic representation for future prediction and history retrieval while r"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_28993_st-wam-semantic-temporal-world-action-mo.md
...
**ST-WAM: Semantic-Temporal World Action Model for Robust Manipulation under Visual Distribution Shifts** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 476/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Rather than correcting the predicted futures, we propose Semantic-Temporal WAM (ST-WAM) to improve action robustness by using DINOv3 as a shared semantic representation for future prediction and history retrieval while retaining fine-grained VAE dynamics. It achieves 98.7% on LIBERO and 92.8% on RoboTwin 2.0; more i...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.28993> |
| 代码/项目 | <https://github.com/Thu-WangMX/ST-WAM-Semantic-Temporal-World-Action-Model> |
| 子类 / 象限 | 潜空间预测与JEPA · 记忆与长时序 · 高效推理与实时控制 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.28993) 为准。
...
**本条目的站内价值是把「ST-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_28993_st-wam-semantic-temporal-world-action-mo.md`](../../sources/papers/rcl_awesome_wam_2607_28993_st-wam-semantic-temporal-world-action-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.28993)
