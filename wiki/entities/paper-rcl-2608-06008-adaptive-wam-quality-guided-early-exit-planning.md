...
updated: 2026-09-25
arxiv: "2608.06008"
summary: "Based on this observation, we introduce Adaptive-WAM, a quality-aware multi-exit planner built on a Wan2.2-5B backbone. On NAVSIM, the adaptive single-trajectory planner achieves 90.8 PDMS; a separate fixed-exit variant"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_06008_adaptive-wam-quality-guided-early-exit-p.md
...
**Adaptive-WAM: Quality-Guided Early-Exit Planning from Intermediate Video-Diffusion Features** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 282/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Based on this observation, we introduce Adaptive-WAM, a quality-aware multi-exit planner built on a Wan2.2-5B backbone. On NAVSIM, the adaptive single-trajectory planner achieves 90.8 PDMS; a separate fixed-exit variant reaches 92.6 PDMS with 64 proposals.
...
| 子类 / 象限 | 自动驾驶 · 高效推理与实时控制 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.06008) 为准。
...
**本条目的站内价值是把「Adaptive-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_06008_adaptive-wam-quality-guided-early-exit-p.md`](../../sources/papers/rcl_awesome_wam_2608_06008_adaptive-wam-quality-guided-early-exit-p.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.06008)
