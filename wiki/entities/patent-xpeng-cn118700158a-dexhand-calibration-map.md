...
summary: "小鹏 IRON CN118700158A：个体标定与分段映射的灵巧手遥操作（2024-09-27 公开/公告）；动捕手套数据经个体标定与分段线性映射生成灵巧手主动关节指令，适配不同操作者手型。…"
---

# 小鹏 IRON · 个体标定与分段映射的灵巧手遥操作（CN118700158A）

专利 **CN118700158A**（*个体标定与分段映射的灵巧手遥操作*，小鹏机器人 / IRON 相关布局，2024-09-27）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**动捕手套数据经个体标定与分段线性映射生成灵巧手主动关节指令，适配不同操作者手型。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN118700158A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn118700158a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN118700158A](https://patents.google.com/patent/CN118700158A/zh)
