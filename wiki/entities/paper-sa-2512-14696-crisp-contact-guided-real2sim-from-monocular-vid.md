...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2512_14696_crisp-contact-guided-real2sim-from-monoc.md
...
**CRISP: Contact-Guided Real2Sim from Monocular Video with Planar Scene Primitives** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 024/063** 篇，分组 **31 Real2Sim from Video**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Recovers simulatable human motion and scene geometry from monocular video. Reduces motion tracking failure rates from 55.2% to 6.9% on human-centric video benchmarks, while delivering 43% faster RL simulation throughput. Achieves over 97% success rate on benchmarks
...
| 出处 | NeurIPS 2025 |
| 论文 | <https://arxiv.org/abs/2512.14696> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.14696) 为准。
...
**本条目的站内价值是把「CRISP」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2512_14696_crisp-contact-guided-real2sim-from-monoc.md`](../../sources/papers/sun_awesome_r2s2r_2512_14696_crisp-contact-guided-real2sim-from-monoc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.14696)
