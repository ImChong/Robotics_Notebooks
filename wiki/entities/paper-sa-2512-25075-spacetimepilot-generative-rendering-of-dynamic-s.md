...
summary: "Generative rendering of dynamic scenes across space and time."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2512_25075_spacetimepilot-generative-rendering-of-d.md
...
**SpaceTimePilot: Generative Rendering of Dynamic Scenes Across Space and Time** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 088/571** 篇，分组 **42 Visual / Video World Models**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2512.25075> |
| 代码/项目 | <https://github.com/ZheningHuang/spacetimepilot> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.25075) 为准。
...
**这一页能给你的是「SpaceTimePilot」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2512_25075_spacetimepilot-generative-rendering-of-d.md`](../../sources/papers/sun_awesome_wm_2512_25075_spacetimepilot-generative-rendering-of-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.25075)
