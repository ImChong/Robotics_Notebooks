...
- **计划笔记路径：** `papers/05_Locomotion/soccerdiffusion-toward-learning-end-to-end-human/soccerdiffusion-toward-learning-end-to-end-human.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-soccerdiffusion-toward-learning-end-to-end-human](../../wiki/entities/paper-notebook-soccerdiffusion-toward-learning-end-to-end-human.md).
