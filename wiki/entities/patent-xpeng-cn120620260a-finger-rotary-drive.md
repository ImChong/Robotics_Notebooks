...
summary: "小鹏 IRON CN120620260A：旋转驱动直接联动手指连接架的灵巧手（2025-09-12 公开/公告）；掌内旋转驱动直接带动连接架与伸缩驱动，无名指/小指可共用旋转驱动以改善辅助抓握协调性。…"
---

# 小鹏 IRON · 旋转驱动直接联动手指连接架的灵巧手（CN120620260A）

专利 **CN120620260A**（*旋转驱动直接联动手指连接架的灵巧手*，小鹏机器人 / IRON 相关布局，2025-09-12）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**掌内旋转驱动直接带动连接架与伸缩驱动，无名指/小指可共用旋转驱动以改善辅助抓握协调性。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN120620260A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn120620260a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN120620260A](https://patents.google.com/patent/CN120620260A/zh)
