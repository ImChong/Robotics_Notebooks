...
- 本页归入 14_Human_Motion（SIGGRAPH Asia 2025，frontmatter 给出开源仓库地址），可经[分类父节点](../overview/paper-notebook-category-14-human-motion.md)与[人形论文笔记总索引](../overview/humanoid-paper-notebooks-index.md)交叉检索。
