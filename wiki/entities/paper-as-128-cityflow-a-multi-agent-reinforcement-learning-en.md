...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_128_cityflow-a-multi-agent-reinforcement-lea.md
...
**CityFlow: A Multi-Agent Reinforcement Learning Environment for Large Scale City Traffic Scenario** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 128/139** 篇，分组 **Transportation Environments**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](http://dx.doi.org/10.1145/3308558.3314139) 为准。
...
**本条目的站内价值是把「CityFlow」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_128_cityflow-a-multi-agent-reinforcement-lea.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_128_cityflow-a-multi-agent-reinforcement-lea.md) — 本条目策展摘录
...
- [原文](http://dx.doi.org/10.1145/3308558.3314139)
