...
- **代码：** <https://github.com/motional/nuplan-devkit>
- **清单摘要：** End-to-end planning evaluation stack with documented metrics and simulation loops.
- **沉淀到 wiki：** [`wiki/entities/painode-112-nuplandevkit.md`](../../wiki/entities/painode-112-nuplandevkit.md)
...
- 实体页：[`wiki/entities/painode-112-nuplandevkit.md`](../../wiki/entities/painode-112-nuplandevkit.md)
