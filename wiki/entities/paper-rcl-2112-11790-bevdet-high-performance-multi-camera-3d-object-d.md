...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2112_11790_bevdet-high-performance-multi-camera-3d.md
...
**BEVDet: High-performance Multi-camera 3D Object Detection in Bird-Eye-View** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 066/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/HuangJunJie2017/BEVDet> |
| 子类 / 象限 | Spatial perception & geometry · 三维表示与状态估计 · 视觉编码器与表征 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2112.11790) 为准。
...
**本条目的站内价值是把「BEVDet」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2112_11790_bevdet-high-performance-multi-camera-3d.md`](../../sources/papers/rcl_awesome_wam_2112_11790_bevdet-high-performance-multi-camera-3d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2112.11790)
