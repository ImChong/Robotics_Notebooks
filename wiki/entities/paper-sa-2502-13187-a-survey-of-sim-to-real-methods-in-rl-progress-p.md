...
**A Survey of Sim-to-Real Methods in RL: Progress, Prospects and Challenges with Foundation Models** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 062/063** 篇，分组 **Surveys & Overvies**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
**这一页能给你的是「A Survey of Sim-to-Real Methods in RL」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
