...
sources:
  - ../../sources/repos/engineai-native-sdk.md
  - ../../sources/repos/humanoid-motion-intelligence.md
---

# EngineAI Native SDK

[EngineAI Native SDK](https://github.com/engineai-robotics/engineai_robotics_native_sdk) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「工程与实机部署」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

配置文件定义FSM、机器人参数和策略资源，Runner把IMU与关节反馈整理成观测，再发送PD关节命令。MuJoCo回放、远程下发、ROS 2监测和紧急回退共同构成模型导出后的部署检查链。
...
|------|------|
| 主表分组 | 工程与实机部署 |
| 官方入口 | https://github.com/engineai-robotics/engineai_robotics_native_sdk |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["EngineAI Native SDK"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [EngineAI Native SDK 来源归档](../../sources/repos/engineai-native-sdk.md)
