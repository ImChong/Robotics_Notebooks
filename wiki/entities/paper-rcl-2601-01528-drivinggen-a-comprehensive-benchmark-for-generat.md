...
arxiv: "2601.01528"
venue: "ICLR 2026"
code: https://github.com/mr-d-self-driving/drivinggen
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2601_01528_drivinggen-a-comprehensive-benchmark-for.md
...
**DrivingGen: A Comprehensive Benchmark for Generative Video World Models in Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 014/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICLR 2026 |
| 论文 | <https://openreview.net/forum?id=OrgL5DsU0f> |
| 代码/项目 | <https://github.com/mr-d-self-driving/drivinggen> |
| 子类 / 象限 | 世界模型评测基准 · 自动驾驶基准 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=OrgL5DsU0f) 为准。
...
**本条目的站内价值是把「DrivingGen」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2601_01528_drivinggen-a-comprehensive-benchmark-for.md`](../../sources/papers/rcl_awesome_wam_2601_01528_drivinggen-a-comprehensive-benchmark-for.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=OrgL5DsU0f)
