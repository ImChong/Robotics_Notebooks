...
arxiv: "2511.19236"
venue: "2025 · arXiv"
summary: "语言–全身动作端到端；中间须有处理平衡/接触的身体通道。"
related:
...
**SENTINEL** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 34/41** 篇，归类为 **05 Hierarchical control**（2025 · arXiv）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_sentinel_arxiv_2511_19236.md](../../sources/papers/bfm_awesome_sentinel_arxiv_2511_19236.md)
