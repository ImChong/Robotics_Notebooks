...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_2062ffd7f6397312bd01_deep-reinforcement-learning-from-human-p.md
...
**Deep Reinforcement Learning from Human Preferences** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 153/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | NeurIPS 2017 |
| 论文 | <https://proceedings.neurips.cc/paper/2017/hash/d5e2c0adad503c91f91df240d0cd4e49-Abstract.html> |
| 子类 / 象限 | 训练优化与蒸馏 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.neurips.cc/paper/2017/hash/d5e2c0adad503c91f91df240d0cd4e49-Abstract.html) 为准。
...
**本条目的站内价值是把「Deep Reinforcement Learning from Human Preferences」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_2062ffd7f6397312bd01_deep-reinforcement-learning-from-human-p.md`](../../sources/papers/rcl_awesome_wam_ref_2062ffd7f6397312bd01_deep-reinforcement-learning-from-human-p.md) — 本条目策展摘录
...
- [原文](https://proceedings.neurips.cc/paper/2017/hash/d5e2c0adad503c91f91df240d0cd4e49-Abstract.html)
