...
status: draft
updated: 2026-07-30
summary: "GenMimic：把生成视频重建成四维人体动作，重定向后以三维关键点条件训练物理跟踪策略，并用对称性和分部奖励改善全身动作；最终产物是可执行跟踪器，视频生成只是参考入口，代码仍待发布。"
related:
...
[GenMimic](https://genmimic.github.io/) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「动作跟踪与全身控制」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

把生成视频重建成四维人体动作，重定向后以三维关键点条件训练物理跟踪策略，并用对称性和分部奖励改善全身动作；最终产物是可执行跟踪器，视频生成只是参考入口，代码仍待发布。
...
- [GenMimic 来源归档](../../sources/sites/genmimic.md)
