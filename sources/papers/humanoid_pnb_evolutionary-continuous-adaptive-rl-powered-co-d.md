...
- **标题：** Evolutionary Continuous Adaptive RL-Powered Co-Design for Humanoid Chin-Up Performance
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/evolutionary-continuous-adaptive-rl-powered-co-d/evolutionary-continuous-adaptive-rl-powered-co-d.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-evolutionary-continuous-adaptive-rl-powered-co-d](../../wiki/entities/paper-notebook-evolutionary-continuous-adaptive-rl-powered-co-d.md).

## 对 wiki 的映射

- [paper-notebook-evolutionary-continuous-adaptive-rl-powered-co-d](../../wiki/entities/paper-notebook-evolutionary-continuous-adaptive-rl-powered-co-d.md)
