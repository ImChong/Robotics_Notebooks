...
arxiv: "2507.05240"
venue: "2025"
code: https://github.com/InternRobotics/StreamVLN
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2507_05240_streamvln-streaming-vision-and-language.md
...
**StreamVLN: Streaming Vision-and-Language Navigation via SlowFast Context Modeling** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 255/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/InternRobotics/StreamVLN> |
| 子类 / 象限 | 自回归VLA · 记忆与长时序VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.05240) 为准。
...
**本条目的站内价值是把「StreamVLN」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2507_05240_streamvln-streaming-vision-and-language.md`](../../sources/papers/rcl_awesome_wam_2507_05240_streamvln-streaming-vision-and-language.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.05240)
