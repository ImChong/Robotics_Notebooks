...
## [2026-08-05] lint | health-check | 自动化 wiki 健康检查
...
- Qwen3-VL（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
📊 Sources 覆盖率：2071/2071 (100%) wiki/entity 页有 ingest 来源
