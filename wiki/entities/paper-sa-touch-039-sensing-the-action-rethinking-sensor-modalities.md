...
sources:
  - ../../sources/papers/sun_awesome_touch_noarxiv_039_sensing-the-action-rethinking-sensor-mod.md
...
**Sensing the Action: Rethinking Sensor Modalities and Multi-Modal Fusion in Vision–Language–Action Models for Robotic Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 039/065** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Systematic taxonomy of major sensor modalities including RGB, depth, tactile sensing, force/torque, proprioception and IMU; reinterprets VLA within a sensor–fusion–action pipeline.
...
| 出处 | Sensors 2026 |
| 论文 | <https://doi.org/10.3390/s26113541> |
| 项目页 | <https://doi.org/10.3390/s26113541> |
...
- [`sources/papers/sun_awesome_touch_noarxiv_039_sensing-the-action-rethinking-sensor-mod.md`](../../sources/papers/sun_awesome_touch_noarxiv_039_sensing-the-action-rethinking-sensor-mod.md) — 本条目策展摘录
...
- [原文](https://doi.org/10.3390/s26113541)
