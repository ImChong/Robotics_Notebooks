...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1908_03568_behaviour-suite-for-reinforcement-learni.md
...
**Behaviour Suite for Reinforcement Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 003/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICLR 2020 |
| 论文 | <https://iclr.cc/virtual/2020/poster/1492> |
| 代码/项目 | <https://github.com/deepmind/bsuite> |
| 子类 / 象限 | 强化学习基准 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://iclr.cc/virtual/2020/poster/1492) 为准。
...
**本条目的站内价值是把「Behaviour Suite for Reinforcement Learning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1908_03568_behaviour-suite-for-reinforcement-learni.md`](../../sources/papers/rcl_awesome_wam_1908_03568_behaviour-suite-for-reinforcement-learni.md) — 本条目策展摘录
...
- [原文](https://iclr.cc/virtual/2020/poster/1492)
