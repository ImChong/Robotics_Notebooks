...
- 本页为 161 篇 **#078/161** 清单索引条目，量化 benchmark 与实机指标以 [原文 / 项目页](https://icradooropen.github.io/icradooropen/) 为准。
...
- 同题深读/既有实体：[paper-loco-manip-161-078-stageact](../entities/paper-loco-manip-161-078-stageact.md)
