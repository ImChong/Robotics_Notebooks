...
- **代码：** 未在清单中标注
- **清单摘要：** MIT, Toyota Research Institute. Manipulation and control.
- **沉淀到 wiki：** [`wiki/entities/painode-251-russtedrake.md`](../../wiki/entities/painode-251-russtedrake.md)
...
- 实体页：[`wiki/entities/painode-251-russtedrake.md`](../../wiki/entities/painode-251-russtedrake.md)
