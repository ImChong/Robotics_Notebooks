...
**Open-Robot-Descriptions** 是 [玄雅科技](https://github.com/Synria-Robotics) 公开的 **本体模型资产** 开源项目：开源机器人模型描述文件集合
...
1. 从官方 GitHub/Gitee 组织检索 `Open-Robot-Descriptions` 仓库并核对 README 许可与依赖。
