...
- **标题：** Emergent Active Perception and Dexterity of Simulated Humanoids from Visual Reinforcement Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/emergent-active-perception-and-dexterity-of-simu/emergent-active-perception-and-dexterity-of-simu.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-emergent-active-perception-and-dexterity-of-simu](../../wiki/entities/paper-notebook-emergent-active-perception-and-dexterity-of-simu.md).

## 对 wiki 的映射

- [paper-notebook-emergent-active-perception-and-dexterity-of-simu](../../wiki/entities/paper-notebook-emergent-active-perception-and-dexterity-of-simu.md)
