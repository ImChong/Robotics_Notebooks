---
type: entity
tags: [paper, humanoid, hardware, open-source, berkeley, reinforcement-learning, qdd, humanoid-paper-notebooks]
status: complete
updated: 2026-07-16
arxiv: "2504.17249"
related:
...
- [人形论文笔记总索引](../overview/humanoid-paper-notebooks-index.md)
...
- [humanoid_pnb_berkeley-humanoid-lite-an-open-source-accessible.md](../../sources/papers/humanoid_pnb_berkeley-humanoid-lite-an-open-source-accessible.md) — Paper Notebooks 待深读档案
