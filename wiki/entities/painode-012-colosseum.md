...
status: complete
updated: 2026-09-20
summary: "Generalisation benchmark perturbing 14 axes of variation for manipulation."
related:
...
**Colosseum** 收录于 awesome-physical-ai（natnew）**第 012/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Generalisation benchmark perturbing 14 axes of variation for manipulation.
...
| 分组 | Benchmarks |
| 来源清单 | natnew |
| 主链接 | <https://robot-colosseum.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://robot-colosseum.github.io/> |
...
- [`sources/repos/pai_awesome_benchmark_012_colosseum.md`](../../sources/repos/pai_awesome_benchmark_012_colosseum.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robot-colosseum.github.io/)
