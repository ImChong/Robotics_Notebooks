---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, method]
status: complete
updated: 2026-09-20
summary: "Russ Tedrake's reference text covering perception, planning, and control for manipulation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_219_mit-6-4210-robotic-manipulation.md
...
**MIT 6.4210 — Robotic Manipulation** 收录于 awesome-physical-ai（natnew）**第 219/384** 条，分组 **Manipulation / Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Russ Tedrake's reference text covering perception, planning, and control for manipulation.
...
|------|------|
| 编号 | 219/384 |
| 分组 | Manipulation / Courses |
| 来源清单 | natnew |
| 主链接 | <https://manipulation.csail.mit.edu/> |

## 核心原理

Russ Tedrake's reference text covering perception, planning, and control for manipulation.

该条目在 Physical AI 清单中的角色是 **method**，分组 **Manipulation / Courses**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://manipulation.csail.mit.edu/> |
...
- [`sources/repos/pai_awesome_method_219_mit-6-4210-robotic-manipulation.md`](../../sources/repos/pai_awesome_method_219_mit-6-4210-robotic-manipulation.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://manipulation.csail.mit.edu/)
