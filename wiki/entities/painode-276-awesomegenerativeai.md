...
status: complete
updated: 2026-09-20
code: https://github.com/steven2358/awesome-generative-ai
summary: "Broader generative AI resources."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_276_awesome-generative-ai.md
...
**Awesome Generative AI** 收录于 awesome-physical-ai（natnew）**第 276/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Broader generative AI resources.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/steven2358/awesome-generative-ai> |
| 代码/仓库 | <https://github.com/steven2358/awesome-generative-ai> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/steven2358/awesome-generative-ai> |
| 代码/仓库 | <https://github.com/steven2358/awesome-generative-ai> |
...
- [`sources/repos/pai_awesome_list_276_awesome-generative-ai.md`](../../sources/repos/pai_awesome_list_276_awesome-generative-ai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/steven2358/awesome-generative-ai)
