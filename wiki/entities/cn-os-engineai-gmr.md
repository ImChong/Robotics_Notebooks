...
**EngineAI GMR** 是 [众擎机器人](https://github.com/engineai-robotics) 公开的 **动作重定向** 开源项目：动作重定向：人体/MoCap 动作映射为目标本体训练参考
...
1. 从官方 GitHub/Gitee 组织检索 `EngineAI GMR` 仓库并核对 README 许可与依赖。
