...
sources:
  - ../../sources/papers/loco_manip_161_survey_098_langwbc.md
...
**LangWBC** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 098/161** 篇，归类为 **04 生成式运动、语言控制与轨迹规划**。
...
- LangWBC 先从语言指令、本体状态与关节序列、仿真交互数据恢复场景、目标或运动表征，再用教师-学生知识迁移、PPO/RL 策略训练、扩散策略/流匹配生成全身轨迹/动作序列、低层控制器目标。关键点是用特权信息训练教师策略，再把能力蒸馏到只能使用部署观测的学生策略。
- 人形 Loco-Manip 161 篇 **#098/161** · 生成式运动、语言控制与轨迹规划。
...
- 评测原始出处：[原文 / 项目页](https://LangWBC.github.io)（见上方「核心信息」表「论文/项目」一行）。
...
- 原始 source：[loco_manip_161_survey_098_langwbc.md](../../sources/papers/loco_manip_161_survey_098_langwbc.md)

## 参考来源

- [loco_manip_161_survey_098_langwbc.md](../../sources/papers/loco_manip_161_survey_098_langwbc.md) — 161 篇策展摘录
...
- 同题深读/既有实体：[paper-bfm-37-langwbc](../entities/paper-bfm-37-langwbc.md)
