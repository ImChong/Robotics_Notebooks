...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_23135_roboscape-physics-informed-embodied-worl.md
...
**RoboScape: Physics-informed Embodied World Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 044/571** 篇，分组 **114 Physics Simulation & Engine Integration**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A unified physics‑informed world model that jointly learns RGB video generation, temporal depth prediction, and adaptive keypoint tracking within a single framework.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.23135> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.23135) 为准。
...
**本条目的站内价值是把「RoboScape」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2506_23135_roboscape-physics-informed-embodied-worl.md`](../../sources/papers/sun_awesome_wm_2506_23135_roboscape-physics-informed-embodied-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.23135)
