...
arxiv: "2603.06445"
venue: "arXiv 2026"
summary: "First large-scale dataset for emulative simulation of mental exploration."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2603_06445_what-if-emulative-simulation-with-world.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# What if? Emulative Simulation with World Models for Situated Reasoning (Wande...

**What if? Emulative Simulation with World Models for Situated Reasoning (WanderDream)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 185/571** 篇，分组 **52 Game & Open-World Exploration Application**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First large-scale dataset for emulative simulation of mental exploration.
...
|------|------|
| 编号 | 185/571 |
| 分组 | 52 Game & Open-World Exploration Application |
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2603.06445> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.06445) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 的 **52 Game & Open-World Exploration Application** 分组逐条展开。
...
**本条目的站内价值是把「What if? Emulative Simulation with World Models for Situated Reasoning (Wande...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **52 Game & Open-World Exploration Application** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_wm_2603_06445_what-if-emulative-simulation-with-world.md`](../../sources/papers/sun_awesome_wm_2603_06445_what-if-emulative-simulation-with-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.06445)
