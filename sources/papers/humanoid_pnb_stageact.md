...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/StageACT__Stage-Conditioned_Imitation_for_Robust_Humanoid_Door_Opening/StageACT__Stage-Conditioned_Imitation_for_Robust_Humanoid_Door_Opening.md`
