...
summary: "BAAI's Emu3, demonstrating next-token prediction unifies multimodal tasks."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2409_18869_emu3-next-token-prediction-is-all-you-ne.md
...
**Emu3: Next-Token Prediction is All You Need** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 147/571** 篇，分组 **47 General Foundation World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

BAAI's Emu3, demonstrating next-token prediction unifies multimodal tasks.
...
| 代码/项目 | <https://github.com/baaivision/Emu3> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2409.18869) 为准。
...
**本条目的站内价值是把「Emu3」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2409_18869_emu3-next-token-prediction-is-all-you-ne.md`](../../sources/papers/sun_awesome_wm_2409_18869_emu3-next-token-prediction-is-all-you-ne.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2409.18869)
