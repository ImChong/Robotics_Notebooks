...
- L1（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
- Python（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/entities/paper-cross-view-action-consistency-vla.md（缺 对比）
- wiki/entities/paper-depth-wise-probing-driving-vla.md（缺 对比）
- wiki/entities/paper-hermite-curves-vla-trajectory-priors.md（缺 对比）
- wiki/entities/paper-hymes-hybrid-memory-manipulation.md（缺 对比）
- wiki/entities/paper-jepa-wam.md（缺 对比）
...
- wiki/entities/paper-wa-specdec.md（缺 对比）
- wiki/entities/paper-wam-diff2.md（缺 对比）
- wiki/entities/paper-wnm-3d-vln.md（缺 对比）
...
- wiki/entities/paper-humanclaw.md（含绝对化措辞「SOTA」，updated=2026-09-18；同主题更新页 wiki/entities/ken-goldberg-agentic-robotics-goosebumps.md updated=2026-09-19）
- wiki/entities/paper-lawam.md（含绝对化措辞「SOTA」，updated=2026-09-18；同主题更新页 wiki/entities/ken-goldberg-agentic-robotics-goosebumps.md updated=2026-09-19）
...
📊 Sources 覆盖率：4293/4293 (100%) wiki/entity 页有 ingest 来源
