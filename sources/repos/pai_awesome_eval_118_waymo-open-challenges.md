...
- **代码：** 未在清单中标注
- **清单摘要：** Public challenge suite with fixed protocols for forecasting and planning evaluation.
- **沉淀到 wiki：** [`wiki/entities/painode-118-waymoopenchallenges.md`](../../wiki/entities/painode-118-waymoopenchallenges.md)
...
- 实体页：[`wiki/entities/painode-118-waymoopenchallenges.md`](../../wiki/entities/painode-118-waymoopenchallenges.md)
