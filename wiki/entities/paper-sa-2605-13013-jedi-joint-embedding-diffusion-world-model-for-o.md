...
arxiv: "2605.13013"
venue: "arXiv 2026"
summary: "Joint embedding diffusion world model for online MBRL."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_13013_jedi-joint-embedding-diffusion-world-mod.md
...
**JEDI: Joint Embedding Diffusion World Model for Online Model-Based Reinforcement Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 245/571** 篇，分组 **72 Continuous Control**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Joint embedding diffusion world model for online MBRL.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.13013> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.13013) 为准。
...
**本条目的站内价值是把「JEDI」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2605_13013_jedi-joint-embedding-diffusion-world-mod.md`](../../sources/papers/sun_awesome_wm_2605_13013_jedi-joint-embedding-diffusion-world-mod.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.13013)
