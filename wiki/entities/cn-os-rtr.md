...
**RTR** 是 [它石智航](https://github.com/tars-robotics) 公开的 **VLA/操作模型** 开源项目：在连续潜空间学习高频动作块，并以Reuse-then-Refine处理异步推理时新旧动作块的边界，使接触操作保持连续执行。
...
1. 从官方 GitHub/Gitee 组织检索 `RTR` 仓库并核对 README 许可与依赖。
