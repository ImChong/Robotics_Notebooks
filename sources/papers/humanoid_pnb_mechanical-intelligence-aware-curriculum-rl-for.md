...
- **标题：** Mechanical Intelligence-Aware Curriculum RL for Humanoids with Parallel Actuation
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/mechanical-intelligence-aware-curriculum-rl-for/mechanical-intelligence-aware-curriculum-rl-for.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-mechanical-intelligence-aware-curriculum-rl-for](../../wiki/entities/paper-notebook-mechanical-intelligence-aware-curriculum-rl-for.md).

## 对 wiki 的映射

- [paper-notebook-mechanical-intelligence-aware-curriculum-rl-for](../../wiki/entities/paper-notebook-mechanical-intelligence-aware-curriculum-rl-for.md)
