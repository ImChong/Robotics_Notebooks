...
sources:
  - ../../sources/papers/lc_awesome_sim2real_2409_18382_1.md
...
**1** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 078/139** 篇，分组 **Reward / LLM-Based Reward Design**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- [`sources/papers/lc_awesome_sim2real_2409_18382_1.md`](../../sources/papers/lc_awesome_sim2real_2409_18382_1.md) — 本条目策展摘录
