...
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/04_Loco-Manipulation_and_WBC/ZeroWBC__Learning_Natural_Visuomotor_Humanoid_Control_from_Egocentric_Video/ZeroWBC__Learning_Natural_Visuomotor_Humanoid_Control_from_Egocentric_Video.html>
...
- 知识归纳见 wiki 实体页：[paper-notebook-zerowbc](../../wiki/entities/paper-notebook-zerowbc.md).

## 对 wiki 的映射

- [paper-notebook-zerowbc](../../wiki/entities/paper-notebook-zerowbc.md)
