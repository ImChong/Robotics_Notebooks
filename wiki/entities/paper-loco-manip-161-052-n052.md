...
sources:
  - ../../sources/papers/loco_manip_161_survey_052_n052.md
...
**价值网络结构很重要** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 052/161** 篇，归类为 **02 上半身中心控制与移动操作接口**。
...
- 这篇工作把相机图像/多视角观测、本体状态与关节序列、仿真交互数据转成可跟踪的身体目标，并通过PPO/RL 策略训练、扩散策略/流匹配训练或组合全身策略，最终输出全身轨迹/动作序列、低层控制器目标。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#052/161** · 上半身中心控制与移动操作接口。
...
- 本页为 161 篇清单索引条目，且「论文/项目」一栏标注（见原文）；双 vs 统一 critic 的具体对照数值必须回到原文 PDF。
...
- 原始 source：[loco_manip_161_survey_052_n052.md](../../sources/papers/loco_manip_161_survey_052_n052.md)

## 参考来源

- [loco_manip_161_survey_052_n052.md](../../sources/papers/loco_manip_161_survey_052_n052.md) — 161 篇策展摘录
