...
- **标题：** MaskedManipulator: Versatile Whole-Body Control for Loco-Manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/maskedmanipulator-versatile-whole-body-control-f/maskedmanipulator-versatile-whole-body-control-f.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-maskedmanipulator-versatile-whole-body-control-f](../../wiki/entities/paper-notebook-maskedmanipulator-versatile-whole-body-control-f.md).

## 对 wiki 的映射

- [paper-notebook-maskedmanipulator-versatile-whole-body-control-f](../../wiki/entities/paper-notebook-maskedmanipulator-versatile-whole-body-control-f.md)
