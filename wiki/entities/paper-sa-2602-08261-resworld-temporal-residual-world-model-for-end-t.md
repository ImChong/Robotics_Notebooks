...
arxiv: "2602.08261"
venue: "arXiv 2026"
summary: "Temporal residual world model for end-to-end autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_08261_resworld-temporal-residual-world-model-f.md
...
**ResWorld: Temporal Residual World Model for End-to-End Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 479/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.08261> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.08261) 为准。
...
**本条目的站内价值是把「ResWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2602_08261_resworld-temporal-residual-world-model-f.md`](../../sources/papers/sun_awesome_wm_2602_08261_resworld-temporal-residual-world-model-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.08261)
