...
**EgoBridge: Domain Adaptation for Generalizable Imitation from Egocentric Human Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 078/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Optimal transport alignment between human visual-action distributions, improving imitation success rate by 44% over standard baselines
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.19626) 为准。
...
**本条目的站内价值是把「EgoBridge」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
