...
- **标题：** Learning to Walk in Costume: Adversarial Motion Priors for Aesthetically Constrained Humanoids
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/learning-to-walk-in-costume-adversarial-motion-p/learning-to-walk-in-costume-adversarial-motion-p.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-to-walk-in-costume-adversarial-motion-p](../../wiki/entities/paper-notebook-learning-to-walk-in-costume-adversarial-motion-p.md).

## 对 wiki 的映射

- [paper-notebook-learning-to-walk-in-costume-adversarial-motion-p](../../wiki/entities/paper-notebook-learning-to-walk-in-costume-adversarial-motion-p.md)
