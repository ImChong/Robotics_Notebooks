...
updated: 2026-08-10
venue: "CVPR 2025"
summary: "A project to develop an egocentric life assistant that accompanies and enhances personal efficiency through AI-powered wearable glasses"
related:
...
**EgoLife: Towards Egocentric Life Assistant** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 138/249** 篇，分组 **293 Procedural Question Answering**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A project to develop an egocentric life assistant that accompanies and enhances personal efficiency through AI-powered wearable glasses
...
- 评测口径与具体数值以 [原文 / 项目页](https://openaccess.thecvf.com/content/CVPR2025/html/EgoLife_Towards_Egocentric_Life_Assistant_CVPR_2025_paper.html) 为准。
...
**本条目的站内价值是把「EgoLife」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
