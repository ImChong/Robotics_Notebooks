...
- **标题：** DreamControl: Human-Inspired Whole-Body Humanoid Control for Scene Interaction via Guided Diffusion
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/dreamcontrol-human-inspired-whole-body-humanoid/dreamcontrol-human-inspired-whole-body-humanoid.md`
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-093-dreamcontrol](../../wiki/entities/paper-loco-manip-161-093-dreamcontrol.md).

## 对 wiki 的映射

- [paper-loco-manip-161-093-dreamcontrol](../../wiki/entities/paper-loco-manip-161-093-dreamcontrol.md)
...
- 论文：<https://arxiv.org/abs/2509.14353>
