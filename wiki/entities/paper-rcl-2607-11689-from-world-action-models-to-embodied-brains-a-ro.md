...
updated: 2026-09-25
arxiv: "2607.11689"
summary: "Building on this analysis, we propose a co-evolution roadmap for physical intelligence centered on the \\emph{embodied brain}, a long-term model target for integrating multimodal context, comparing candidate interventions"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_11689_from-world-action-models-to-embodied-bra.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# From World Action Models to Embodied Brains

**From World Action Models to Embodied Brains: A Roadmap for Open-World Physical Intelligence** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 207/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.11689> |
| 子类 / 象限 | 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.11689) 为准。
...
**本条目的站内价值是把「From World Action Models to Embodied Brains」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_11689_from-world-action-models-to-embodied-bra.md`](../../sources/papers/rcl_awesome_wam_2607_11689_from-world-action-models-to-embodied-bra.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.11689)
