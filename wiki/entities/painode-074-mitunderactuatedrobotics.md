...
status: complete
updated: 2026-09-20
summary: "Open textbook/course on dynamics, planning, and control for underactuated systems."
related:
...
**MIT Underactuated Robotics** 收录于 awesome-physical-ai（natnew）**第 074/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open textbook/course on dynamics, planning, and control for underactuated systems.
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://underactuated.mit.edu/> |
...
- [`sources/repos/pai_awesome_course_074_mit-underactuated-robotics.md`](../../sources/repos/pai_awesome_course_074_mit-underactuated-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://underactuated.mit.edu/)
