...
- **标题：** It Takes Two: Learning Interactive Whole-Body Control Between Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/it-takes-two-learning-interactive-whole-body-con/it-takes-two-learning-interactive-whole-body-con.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2510.10206>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-it-takes-two](../../wiki/entities/paper-notebook-it-takes-two.md).

## 对 wiki 的映射

- [paper-notebook-it-takes-two](../../wiki/entities/paper-notebook-it-takes-two.md)
...
- 论文：<https://arxiv.org/abs/2510.10206>
