...
sources:
  ...
  - ../../sources/repos/rlpf.md
summary: "智在无界 开源项目 RLPF（全身动作跟踪/技能训练）：全身动作跟踪策略（带仿真/真机验证）…"
institutions:
  - agilex-ai
---
...
**RLPF** 是 [智在无界](https://github.com/BeingBeyond) 公开的 **全身动作跟踪/技能训练** 开源项目：全身动作跟踪策略（带仿真/真机验证）
...
1. 从官方 GitHub/Gitee 组织检索 `RLPF` 仓库并核对 README 许可与依赖。
...
- [RLPF 源码归档](../../sources/repos/rlpf.md)（<https://github.com/BeingBeyond/RLPF>）
