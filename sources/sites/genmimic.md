...
- **入库日期：** 2026-07-30
- **一句话说明：** 把生成视频重建成四维人体动作，重定向后以三维关键点条件训练物理跟踪策略，并用对称性和分部奖励改善全身动作；最终产物是可执行跟踪器，视频生成只是参考入口，代码仍待发布。
...
- **沉淀到 wiki：** 是 → [`wiki/entities/genmimic.md`](../../wiki/entities/genmimic.md)
...
- [GenMimic](../../wiki/entities/genmimic.md)
