...
如果你已经在工作中接触过机器人控制，根据你能回答出的问题，可以直接跳到对应 L：

| 你能回答 | 可以直接跳到 |
|---------|------------|
| "我会写 NumPy 矩阵运算，但只懂欧拉角，搞不清 SE(3)" | [L1 机器人学骨架](#l1-机器人学骨架) |
| "我能用 Pinocchio 算 FK / Jacobian，但不知道 RNEA、CRBA、ABA 的区别" | [L2 动力学与刚体建模](#l2-动力学与刚体建模) |
| "我能写固定基机器人的逆动力学，但浮动基 / 接触约束没碰过" | [L4 人形运动控制主干](#l4-人形运动控制主干) |
| "我熟 LQR / MPC，但 LIP / Centroidal / WBC 没系统学过" | [L4.1 LIP / ZMP](#l41-lip--zmp) |
| "我能调通 IsaacLab 的 PPO 训练，但不知道怎么和传统控制结合" | [L5.2 RL 在人形运动控制里的应用](#l52-rl-在人形运动控制里的应用) |
| "我能跑通仿真 RL 策略，但 sim2real 部署没做过" | [L6 综合实战](#l6-综合实战) |
| "我做过运动控制项目，想看清当下机器人 AI 全景" | [L7 出口](#l7-出口从运动控制看整个机器人技术栈) |
