...
arxiv: "2609.10540"
venue: "2026"
summary: "Programmable World Model makes a rule-executing engine authoritative for world facts and uses a conditioned video model to render them. State-augmented 3D oriented bounding boxes connect these components without requirin"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_10540_programmable-world-model.md
...
**Programmable World Model** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 044/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Programmable World Model makes a rule-executing engine authoritative for world facts and uses a conditioned video model to render them. State-augmented 3D oriented bounding boxes connect these components without requiring detailed animated assets. On CombatStateBench, the system reports 94% visible-alive-count accur...
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.10540> |
| 子类 / 象限 | 神经世界模拟器 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.10540) 为准。
...
**本条目的站内价值是把「Programmable World Model」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_10540_programmable-world-model.md`](../../sources/papers/rcl_awesome_wam_2609_10540_programmable-world-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.10540)
