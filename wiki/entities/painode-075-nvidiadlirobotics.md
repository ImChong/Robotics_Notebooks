...
status: complete
updated: 2026-09-20
summary: "Self-paced courses on Isaac Sim, ROS, and robot learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_075_nvidia-dli-robotics.md
...
**NVIDIA DLI Robotics** 收录于 awesome-physical-ai（natnew）**第 075/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Self-paced courses on Isaac Sim, ROS, and robot learning.
...
| 分组 | Courses |
| 来源清单 | natnew |
| 主链接 | <https://www.nvidia.com/en-us/training/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.nvidia.com/en-us/training/> |
...
- [`sources/repos/pai_awesome_course_075_nvidia-dli-robotics.md`](../../sources/repos/pai_awesome_course_075_nvidia-dli-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.nvidia.com/en-us/training/)
