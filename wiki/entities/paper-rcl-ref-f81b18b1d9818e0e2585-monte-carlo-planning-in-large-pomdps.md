...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_f81b18b1d9818e0e2585_monte-carlo-planning-in-large-pomdps.md
...
**Monte-Carlo Planning in Large POMDPs** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 169/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | NeurIPS 2010 |
| 论文 | <https://proceedings.neurips.cc/paper/2010/hash/edfbe1afcf9246bb0d40eb4d8027d90f-Abstract.html> |
| 子类 / 象限 | 理论与规划 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.neurips.cc/paper/2010/hash/edfbe1afcf9246bb0d40eb4d8027d90f-Abstract.html) 为准。
...
**本条目的站内价值是把「Monte-Carlo Planning in Large POMDPs」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_f81b18b1d9818e0e2585_monte-carlo-planning-in-large-pomdps.md`](../../sources/papers/rcl_awesome_wam_ref_f81b18b1d9818e0e2585_monte-carlo-planning-in-large-pomdps.md) — 本条目策展摘录
...
- [原文](https://proceedings.neurips.cc/paper/2010/hash/edfbe1afcf9246bb0d40eb4d8027d90f-Abstract.html)
