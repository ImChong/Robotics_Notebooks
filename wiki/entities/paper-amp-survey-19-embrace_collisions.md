...
type: entity
tags: [paper, humanoid, amp, motion-prior, adversarial-imitation, tsinghua, shanghai-pil]
status: complete
updated: 2026-06-11
venue: curated
summary: "Embrace Collisions 的问题意识很直接："
related:
...
**Embrace Collisions** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 19/19** 篇，归类为 **04 交互与长时程**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_19_embrace_collisions_humanoid_shadowing_for_deploy.md](../../sources/papers/humanoid_amp_survey_19_embrace_collisions_humanoid_shadowing_for_deploy.md)
