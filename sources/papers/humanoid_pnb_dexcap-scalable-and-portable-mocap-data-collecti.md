...
- **计划笔记路径：** `papers/06_Manipulation/dexcap-scalable-and-portable-mocap-data-collecti/dexcap-scalable-and-portable-mocap-data-collecti.md`
- **分类：** 06_Manipulation
...
- 知识归纳见 wiki 实体页：[paper-notebook-dexcap-scalable-and-portable-mocap-data-collecti](../../wiki/entities/paper-notebook-dexcap-scalable-and-portable-mocap-data-collecti.md).
