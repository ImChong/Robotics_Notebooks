...
updated: 2026-09-20
arxiv: "1612.07828"
summary: "Sim-to-real visual adaptation method for narrowing sensor-domain gaps."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/pai_awesome_1612_07828_simgan.md
...
**SimGAN** 收录于 awesome-physical-ai（natnew）**第 339/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real visual adaptation method for narrowing sensor-domain gaps.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1612.07828> |
| arXiv | 1612.07828 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1612.07828) 为准。
...
**本条目的站内价值是把「SimGAN」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1612_07828_simgan.md`](../../sources/papers/pai_awesome_1612_07828_simgan.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1612.07828)
