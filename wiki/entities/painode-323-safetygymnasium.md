...
summary: "Modern safe-RL benchmark suite extending Safety Gym with richer constraints and tasks."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_323_safety-gymnasium.md
...
**Safety-Gymnasium** 收录于 awesome-physical-ai（natnew）**第 323/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Modern safe-RL benchmark suite extending Safety Gym with richer constraints and tasks.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/PKU-Alignment/safety-gymnasium> |
| 代码/仓库 | <https://github.com/pku-alignment/safety-gymnasium> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/PKU-Alignment/safety-gymnasium> |
| 代码/仓库 | <https://github.com/pku-alignment/safety-gymnasium> |
...
- [`sources/repos/pai_awesome_resource_323_safety-gymnasium.md`](../../sources/repos/pai_awesome_resource_323_safety-gymnasium.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/PKU-Alignment/safety-gymnasium)
