...
status: complete
updated: 2026-09-20
summary: "Foundation world model that generates interactive, controllable 3D environments. <!-- tags: paper, framework -->"
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_paper_374_genie-2-deepmind.md
...
**Genie 2 (DeepMind)** 收录于 awesome-physical-ai（natnew）**第 374/384** 条，分组 **World Models**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Foundation world model that generates interactive, controllable 3D environments. <!-- tags: paper, framework -->
...
| 分组 | World Models |
| 来源清单 | natnew |
| 主链接 | <https://deepmind.google/discover/blog/genie-2-a-large-scale-foundation-world-model/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://deepmind.google/discover/blog/genie-2-a-large-scale-foundation-world-model/) 为准。
...
**本条目的站内价值是把「Genie 2 (DeepMind)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **World Models**，来源 natnew。
...
- [`sources/repos/pai_awesome_paper_374_genie-2-deepmind.md`](../../sources/repos/pai_awesome_paper_374_genie-2-deepmind.md) — 本条目策展摘录
