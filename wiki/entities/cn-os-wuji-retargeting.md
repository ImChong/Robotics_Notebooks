...
**wuji-retargeting** 是 [舞肌科技](https://github.com/wuji-technology) 公开的 **动作重定向** 开源项目：把Vision Pro获得的人手追踪结果映射为Wuji Hand可执行关节目标，为遥操作和示范采集提供人手到机器人手的映射入口。
...
1. 从官方 GitHub/Gitee 组织检索 `wuji-retargeting` 仓库并核对 README 许可与依赖。
