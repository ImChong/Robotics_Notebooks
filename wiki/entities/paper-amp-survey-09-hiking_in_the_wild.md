...
updated: 2026-05-26
venue: curated
summary: "Hiking in the Wild 不是典型 AMP 论文，但它应该放在这条线里。"
related:
...
**Hiking in the Wild** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 09/19** 篇，归类为 **02 人形走跑**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_09_hiking_in_the_wild_a_scalable_perceptive_parkour.md](../../sources/papers/humanoid_amp_survey_09_hiking_in_the_wild_a_scalable_perceptive_parkour.md)
