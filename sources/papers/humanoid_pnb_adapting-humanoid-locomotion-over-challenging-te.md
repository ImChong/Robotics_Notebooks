...
- **标题：** Adapting Humanoid Locomotion over Challenging Terrain via Two-Phase Training
- **类型：** paper
...
- **计划笔记路径：** `papers/03_High_Impact_Selection/adapting-humanoid-locomotion-over-challenging-te/adapting-humanoid-locomotion-over-challenging-te.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-adapting-humanoid-locomotion-over-challenging-te](../../wiki/entities/paper-notebook-adapting-humanoid-locomotion-over-challenging-te.md).

## 对 wiki 的映射

- [paper-notebook-adapting-humanoid-locomotion-over-challenging-te](../../wiki/entities/paper-notebook-adapting-humanoid-locomotion-over-challenging-te.md)
