...
arxiv: "2605.20811"
venue: "arXiv 2025"
summary: "Joint-embedding predictive architecture for one-shot cross-embodiment imitation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_20811_demo-jepa-joint-embedding-predictive-arc.md
...
**Demo-JEPA: Joint-Embedding Predictive Architecture for One-shot Cross-Embodiment Imitation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 281/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Joint-embedding predictive architecture for one-shot cross-embodiment imitation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2605.20811> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.20811) 为准。
...
**这一页能给你的是「Demo-JEPA」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2605_20811_demo-jepa-joint-embedding-predictive-arc.md`](../../sources/papers/sun_awesome_wm_2605_20811_demo-jepa-joint-embedding-predictive-arc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.20811)
