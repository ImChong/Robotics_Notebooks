...
status: complete
updated: 2026-08-12
summary: "ChangeMamba 将 Mamba 用于遥感/视频变化检测，建模双时相长程依赖以突出变化区域。"
related:
...
ChangeMamba 将 Mamba 用于遥感/视频变化检测，建模双时相长程依赖以突出变化区域。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| CD | Change Detection | 变化检测任务 |
| ChangeMamba | ChangeMamba | 变化检测 Mamba |
| Bi-temporal | Bi-temporal inputs | 双时相输入 |
| SSM | State Space Model | 时序/空间状态建模 |
| F1 | F1 Score | 变化检测常用指标 |
...
- [相关论文](https://arxiv.org/abs/2404.03493)
