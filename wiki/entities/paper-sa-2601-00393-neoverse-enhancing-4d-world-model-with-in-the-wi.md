...
arxiv: "2601.00393"
venue: "arXiv 2026"
summary: "Enhances 4D world models using in-the-wild monocular videos."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2601_00393_neoverse-enhancing-4d-world-model-with-i.md
...
**NeoVerse: Enhancing 4D World Model with in-the-wild Monocular Videos** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 082/571** 篇，分组 **42 Visual / Video World Models**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Enhances 4D world models using in-the-wild monocular videos.
...
| 项目页 | <https://neoverse-4d.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.00393) 为准。
...
**这一页能给你的是「NeoVerse」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2601_00393_neoverse-enhancing-4d-world-model-with-i.md`](../../sources/papers/sun_awesome_wm_2601_00393_neoverse-enhancing-4d-world-model-with-i.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.00393)
