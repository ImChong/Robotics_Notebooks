...
summary: "In this work, we propose LiLa-WAM, a lightweight world-action model that reasons about the future in a compact latent space and can be trained end-to-end on a single 24GB GPU."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_03701_lila-wam-lightweight-latent-reasoning-wo.md
...
**LiLa-WAM: Lightweight Latent Reasoning World-Action Model for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 418/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.03701> |
| 代码/项目 | <https://github.com/teee000/LiLa-WAM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.03701) 为准。
...
**本条目的站内价值是把「LiLa-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_03701_lila-wam-lightweight-latent-reasoning-wo.md`](../../sources/papers/rcl_awesome_wam_2608_03701_lila-wam-lightweight-latent-reasoning-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.03701)
