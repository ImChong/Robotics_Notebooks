...
updated: 2026-08-10
venue: "NeurIPS 2025"
summary: "Generalizable HOI world model with two-stage VLM prior inference + DiT flow matching trajectory generation"
related:
...
**MEgoHand: Multimodal Egocentric Hand-Object Interaction Motion Generation** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 113/249** 篇，分组 **28 Egocentric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Generalizable HOI world model with two-stage VLM prior inference + DiT flow matching trajectory generation
