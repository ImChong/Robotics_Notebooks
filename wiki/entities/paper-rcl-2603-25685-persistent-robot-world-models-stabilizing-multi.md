...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_25685_persistent-robot-world-models-stabilizin.md
...
**Persistent Robot World Models: Stabilizing Multi-Step Rollouts via Reinforcement Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 043/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2603.25685> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.25685) 为准。
...
**本条目的站内价值是把「Persistent Robot World Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_25685_persistent-robot-world-models-stabilizin.md`](../../sources/papers/rcl_awesome_wam_2603_25685_persistent-robot-world-models-stabilizin.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.25685)
