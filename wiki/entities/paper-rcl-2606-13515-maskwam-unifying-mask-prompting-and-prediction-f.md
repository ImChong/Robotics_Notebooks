...
updated: 2026-09-25
arxiv: "2606.13515"
summary: "To overcome these limitations, we introduce MaskWAM, an object-centric world-action model. Evaluations on LIBERO, RoboTwin, and real-world tasks demonstrate that MaskWAM significantly outperforms baselines in both langua"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_13515_maskwam-unifying-mask-prompting-and-pred.md
...
**MaskWAM: Unifying Mask Prompting and Prediction for World-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 424/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To overcome these limitations, we introduce MaskWAM, an object-centric world-action model. Evaluations on LIBERO, RoboTwin, and real-world tasks demonstrate that MaskWAM significantly outperforms baselines in both language-clear and language-ambiguous tasks.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.13515> |
| 项目页 | <https://hanyangyu1021.github.io/maskwam.github.io/> |
| 子类 / 象限 | 视觉规划与IDM · 泛化与动作对齐 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.13515) 为准。
...
**本条目的站内价值是把「MaskWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_13515_maskwam-unifying-mask-prompting-and-pred.md`](../../sources/papers/rcl_awesome_wam_2606_13515_maskwam-unifying-mask-prompting-and-pred.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.13515)
