...
summary: "Open-world MPC with interactive digital twins."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_13761_prompting-with-the-future-open-world-mpc.md
...
**Prompting with the Future: Open-World MPC with Interactive Digital Twins** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 325/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Open-world MPC with interactive digital twins.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.13761> |
| 代码/项目 | <https://github.com/TritiumR/Prompting-with-the-Future> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.13761) 为准。
...
**这一页能给你的是「Prompting with the Future」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2506_13761_prompting-with-the-future-open-world-mpc.md`](../../sources/papers/sun_awesome_wm_2506_13761_prompting-with-the-future-open-world-mpc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.13761)
