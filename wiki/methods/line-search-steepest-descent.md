...
2. 若 $p$ 非下降方向，增大 $\lambda$（[Levenberg-Marquardt](./levenberg-marquardt.md)）
3. 线搜索确定 $\alpha$，更新 $x$

详见 [Newton's Method](./newtons-method.md)。
...
- [Newton's Method](./newtons-method.md) · [Levenberg-Marquardt](./levenberg-marquardt.md)
