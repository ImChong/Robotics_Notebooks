...
sources:
  - ../../sources/papers/lc_awesome_sim2real_2104_08441_action-advising-with-advice-imitation-in.md
...
**Action advising with advice imitation in deep reinforcement learning** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 021/139** 篇，分组 **Action / Action Uncertainty**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2104.08441> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2104.08441) 为准。
...
**本条目的站内价值是把「Action advising with advice imitation in deep reinforcement learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_2104_08441_action-advising-with-advice-imitation-in.md`](../../sources/papers/lc_awesome_sim2real_2104_08441_action-advising-with-advice-imitation-in.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2104.08441)
