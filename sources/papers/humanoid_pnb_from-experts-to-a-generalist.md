...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/From_Experts_to_a_Generalist__Toward_General_Whole-Body_Control_for_Humanoid_Rob/From_Experts_to_a_Generalist__Toward_General_Whole-Body_Control_for_Humanoid_Rob.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-from-experts-to-a-generalist](../../wiki/entities/paper-notebook-from-experts-to-a-generalist.md).

## 对 wiki 的映射

- [paper-notebook-from-experts-to-a-generalist](../../wiki/entities/paper-notebook-from-experts-to-a-generalist.md)
