...
arxiv: "2605.00078"
venue: "2026"
summary: "Being-H0.7 trains a robot policy to anticipate useful future information inside latent queries. A future-aware training branch aligns its hidden states with a deployable branch that sees only current context, avoiding vi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_00078_being-h0-7-a-latent-world-action-model-f.md
...
**Being-H0.7: A Latent World-Action Model from Egocentric Videos** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 284/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Being-H0.7 trains a robot policy to anticipate useful future information inside latent queries. A future-aware training branch aligns its hidden states with a deployable branch that sees only current context, avoiding visual rollout during control. Strong benchmark and real-robot results support the complete system,...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2605.00078> |
| 子类 / 象限 | 潜空间预测与JEPA |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.00078) 为准。
...
**本条目的站内价值是把「Being-H0.7」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_00078_being-h0-7-a-latent-world-action-model-f.md`](../../sources/papers/rcl_awesome_wam_2605_00078_being-h0-7-a-latent-world-action-model-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.00078)
