...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_16395_orbisim-world-models-as-differentiable-p.md
...
**OrbiSim: World Models as Differentiable Physics Engines for Embodied Intelligence** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 027/571** 篇，分组 **112 Differentiable Physics Engines & Neural Simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Redefines world models as fully differentiable physics engines with a decoupled neural architecture (OrbiSim‑Dynamics and OrbiSim‑Vision), supporting end‑to‑end differentiable contact modelling, gradient‑based policy optimisation, and physical reasoning under sparse rewards.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.16395> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.16395) 为准。
...
**本条目的站内价值是把「OrbiSim」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2605_16395_orbisim-world-models-as-differentiable-p.md`](../../sources/papers/sun_awesome_wm_2605_16395_orbisim-world-models-as-differentiable-p.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.16395)
