...
status: complete
updated: 2026-09-20
summary: "Embodied AI for end-to-end autonomous driving using world models and VLAs."
related:
...
sources:
  - ../../sources/repos/pai_awesome_company_053_wayve.md
...
**Wayve** 收录于 awesome-physical-ai（natnew）**第 053/384** 条，分组 **Companies**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Embodied AI for end-to-end autonomous driving using world models and VLAs.
...
- [`sources/repos/pai_awesome_company_053_wayve.md`](../../sources/repos/pai_awesome_company_053_wayve.md) — 本条目策展摘录
