...
updated: 2026-09-20
arxiv: "1709.06560"
summary: "Foundational paper on statistical pitfalls and reproducibility in RL evaluation."
related:
...
sources:
  - ../../sources/papers/pai_awesome_1709_06560_deep-rl-that-matters.md
...
**Deep RL That Matters** 收录于 awesome-physical-ai（natnew）**第 107/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Foundational paper on statistical pitfalls and reproducibility in RL evaluation.
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1709.06560> |
| arXiv | 1709.06560 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1709.06560) 为准。
...
**本条目的站内价值是把「Deep RL That Matters」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1709_06560_deep-rl-that-matters.md`](../../sources/papers/pai_awesome_1709_06560_deep-rl-that-matters.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1709.06560)
