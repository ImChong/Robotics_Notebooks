...
**Alicia-D-VLM-Grasp** 是 [玄雅科技](https://github.com/Synria-Robotics) 公开的 **VLA/操作模型** 开源项目：Alicia-D 视觉语言模型抓取示例
...
1. 从官方 GitHub/Gitee 组织检索 `Alicia-D-VLM-Grasp` 仓库并核对 README 许可与依赖。
