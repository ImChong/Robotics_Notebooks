...
summary: "星海图 开源项目 GalaxeaVLA（VLA/操作模型）：语言、视觉和机器人状态经过VLA生成移动底盘与双臂动作，用于在星海图本体上执行多步骤移动操作任务；仓库提供模型、数据或部署入口。…"
institutions:
  - galaxea
---
...
**GalaxeaVLA** 是 [星海图](https://github.com/OpenGalaxea) 公开的 **VLA/操作模型** 开源项目：语言、视觉和机器人状态经过VLA生成移动底盘与双臂动作，用于在星海图本体上执行多步骤移动操作任务；仓库提供模型、数据或部署入口。
...
1. 从官方 GitHub/Gitee 组织检索 `GalaxeaVLA` 仓库并核对 README 许可与依赖。
