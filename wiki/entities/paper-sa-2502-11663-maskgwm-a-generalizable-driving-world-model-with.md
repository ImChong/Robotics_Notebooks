...
arxiv: "2502.11663"
venue: "arXiv 2025"
summary: "Generalizable driving world model with video mask reconstruction."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_11663_maskgwm-a-generalizable-driving-world-mo.md
...
**MaskGWM: A Generalizable Driving World Model with Video Mask Reconstruction** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 458/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Generalizable driving world model with video mask reconstruction.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.11663> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.11663) 为准。
...
**本条目的站内价值是把「MaskGWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_11663_maskgwm-a-generalizable-driving-world-mo.md`](../../sources/papers/sun_awesome_wm_2502_11663_maskgwm-a-generalizable-driving-world-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.11663)
