...
- **代码：** <https://github.com/gt-ripl/awesome-llm-robotics>
- **清单摘要：** LLM/VLM applications in robotics.
- **沉淀到 wiki：** [`wiki/entities/painode-278-awesomellmrobotics.md`](../../wiki/entities/painode-278-awesomellmrobotics.md)
...
- 实体页：[`wiki/entities/painode-278-awesomellmrobotics.md`](../../wiki/entities/painode-278-awesomellmrobotics.md)
