...
- **标题：** Bimanual Dexterity for Complex Tasks
- **类型：** paper
...
- **计划笔记路径：** `papers/06_Manipulation/bimanual-dexterity-for-complex-tasks/bimanual-dexterity-for-complex-tasks.md`
- **分类：** 06_Manipulation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-bimanual-dexterity-for-complex-tasks](../../wiki/entities/paper-notebook-bimanual-dexterity-for-complex-tasks.md).

## 对 wiki 的映射

- [paper-notebook-bimanual-dexterity-for-complex-tasks](../../wiki/entities/paper-notebook-bimanual-dexterity-for-complex-tasks.md)
