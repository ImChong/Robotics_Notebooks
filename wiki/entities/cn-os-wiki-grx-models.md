...
**Wiki-GRx-Models** 是 [傅利叶智能](https://github.com/FFTAI) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `Wiki-GRx-Models` 仓库并核对 README 许可与依赖。
