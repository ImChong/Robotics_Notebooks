...
- **标题：** Composite Motion Learning with Task Control
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/composite-motion-learning-with-task-control/composite-motion-learning-with-task-control.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-composite-motion-learning-with-task-control](../../wiki/entities/paper-notebook-composite-motion-learning-with-task-control.md).

## 对 wiki 的映射

- [paper-notebook-composite-motion-learning-with-task-control](../../wiki/entities/paper-notebook-composite-motion-learning-with-task-control.md)
