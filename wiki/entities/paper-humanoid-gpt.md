...
**Humanoid-GPT** 是清华、Galbot、北航、上交、北大与期智等团队的 **人形全身在线 motion tracking** 工作（arXiv:2606.03985，项目页标注 **CVPR 2026**）：在 **约 20 亿帧** Unitree G1 重定向运动上，用 **Harmonic Motion Embedding (HME)** 组织数据多样性，先训 **~300 个簇级 PPO expert**，再以 **因果 Transformer + DAgger** 蒸馏为 **单一通才 tracker**，在仿真与真机上同时追求 **高动态敏捷** 与 **训练外零样本泛化**。
...
- **代码成熟度**：官方仓库以论文发布为锚点，训练/权重/部署细节以 [GitHub](https://github.com/GalaxyGeneralRobotics/Humanoid-GPT) 实际更新为准。
