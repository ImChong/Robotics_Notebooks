...
arxiv: "2606.17906"
venue: "arXiv 2026"
summary: "First RL in World-Action paradigm jointly optimizing world and action models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_17906_wam-rl-world-action-model-reinforcement.md
...
**WAM-RL: World-Action Model Reinforcement Learning with Reconstruction Rewards and Online Video SFT** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 229/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

First RL in World-Action paradigm jointly optimizing world and action models.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.17906> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.17906) 为准。
...
**这一页能给你的是「WAM-RL」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2606_17906_wam-rl-world-action-model-reinforcement.md`](../../sources/papers/sun_awesome_wm_2606_17906_wam-rl-world-action-model-reinforcement.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.17906)
