...
**umi-dex** 是 [灵心巧手](https://github.com/linker-bot) 公开的 **数据集/Benchmark** 开源项目：面向灵巧手操作采集高质量示范数据，连接人类操作输入、灵巧手状态与训练数据转换。
...
1. 从官方 GitHub/Gitee 组织检索 `umi-dex` 仓库并核对 README 许可与依赖。
