...
arxiv: "2503.20425"
venue: "arXiv 2025"
summary: "Neuro-symbolic world models for socially-aware robot navigation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_20425_perspective-shifted-neuro-symbolic-world.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Perspective-Shifted Neuro-Symbolic World Models

**Perspective-Shifted Neuro-Symbolic World Models: A Framework for Socially-Aware Robot Navigation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 355/571** 篇，分组 **813 Navigation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Neuro-symbolic world models for socially-aware robot navigation.
...
| 分组 | 813 Navigation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.20425> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.20425) 为准。
...
**本条目的站内价值是把「Perspective-Shifted Neuro-Symbolic World Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_20425_perspective-shifted-neuro-symbolic-world.md`](../../sources/papers/sun_awesome_wm_2503_20425_perspective-shifted-neuro-symbolic-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.20425)
