...
## [2026-09-03] lint | health-check | 自动化 wiki 健康检查
...
- LCM（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
- wiki/entities/paper-demomimic.md（缺 对比）
...
- wiki/entities/paper-openvla.md（含绝对化措辞「SOTA」，updated=2026-09-02；同主题更新页 wiki/entities/paper-act.md updated=2026-09-03）
...
- wiki/entities/paper-physics-consistent-hrc-benchmark.md
- wiki/entities/paper-tapvid-mv.md
...
📊 Sources 覆盖率：3408/3408 (100%) wiki/entity 页有 ingest 来源
