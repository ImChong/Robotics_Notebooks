...
- **标题：** EgoDemoGen: Novel Egocentric Demonstration Generation Enables Viewpoint-Robust Manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/06_Manipulation/egodemogen-novel-egocentric-demonstration-genera/egodemogen-novel-egocentric-demonstration-genera.md`
- **分类：** 06_Manipulation
