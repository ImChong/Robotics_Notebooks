...
**MoDE-VLA: Mixture-of-Dexterous-Experts VLA** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 005/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
**这一页能给你的是「MoDE-VLA」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
