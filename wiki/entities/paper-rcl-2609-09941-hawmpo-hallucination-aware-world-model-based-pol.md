...
arxiv: "2609.09941"
venue: "2026"
summary: "HaWMPO post-trains OpenVLA-OFT inside a frozen video world model. A separate hallucination detector discounts rewards assigned to unreliable imagined action chunks before GRPO updates the policy. Table 1 reports 63.7% av"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_09941_hawmpo-hallucination-aware-world-model-b.md
...
**HaWMPO: Hallucination-Aware World Model-based Policy Optimization for Generalist Robot Policy** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 380/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

HaWMPO post-trains OpenVLA-OFT inside a frozen video world model. A separate hallucination detector discounts rewards assigned to unreliable imagined action chunks before GRPO updates the policy. Table 1 reports 63.7% average LIBERO success, but gains vary by suite and the penalty-selection description is inconsiste...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.09941> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.09941) 为准。
...
**本条目的站内价值是把「HaWMPO」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_09941_hawmpo-hallucination-aware-world-model-b.md`](../../sources/papers/rcl_awesome_wam_2609_09941_hawmpo-hallucination-aware-world-model-b.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.09941)
