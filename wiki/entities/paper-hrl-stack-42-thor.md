...
**Thor 把「强接触下的大力输出」归因于躯干姿态而不是力传感：用 FAT2 奖励把受力方向与躯干倾斜绑定，再靠上身/腰/下身分体共享观测的 RL 架构，把局部补偿改写成全身反作用力协调。**

- 真正起作用的是 **力–躯干倾斜耦合**：躯干倾斜联动重心与地面支撑，后拉峰值 **167.7 N**、前拉 **145.5 N**，较最佳 baseline 提升 **68.9% / 74.7%**。
- 适用边界是持续大力交互（拉车、开防火门、拖货架、推轮椅、擦白板），不覆盖灵巧手与高精度接触。
- 核心取舍是 **无外部力 sensing、无精细力控**：靠姿态换大力输出，代价是接触冲击不可控，167 N 级作用力在服务场景需严格人机隔离与急停。
- 代码标注 Coming Soon，FAT2 奖励与三分体策略细节目前无法复现。
- 与 [CHIP](./paper-hrl-stack-36-chip.md)、[GentleHumanoid](./paper-gentlehumanoid.md) 的柔顺侧相对，Thor 与 [FALCON](./paper-loco-manip-161-109-falcon.md) 同属强发力侧，但分工不同：后者是下肢抗扰 + 上肢力交互的双 agent，Thor 是上身/腰/下身三分体共享全身观测。

## 与其他工作对比

Thor 在「为什么重要」里把自己与柔顺方向的 GentleHumanoid、CHIP 对照（后者偏安全和可调柔顺，Thor 偏强发力），关联页面又把它与同样面向强力交互的 FALCON 并列。下表为定性对照，不含跨论文可比的统一指标。

| 维度 | Thor | FALCON | CHIP | GentleHumanoid |
|------|------|--------|------|----------------|
| 落点 | 强接触下 human-level 全身大力反应 | force-adaptive loco-manip 强力交互 | 连续可调末端柔顺 | 上半身接触柔顺、限力 |
| 核心机制 | FAT2 力自适应躯干倾斜 + 上身/腰/下身分体共享观测 | 双 agent RL：下肢抗扰 + 上肢力交互 + 3D force curriculum | hindsight perturbation 重构跟踪目标 | 肩-肘-腕虚拟阻抗参考动力学 |
| 躯干/全身角色 | 躯干倾斜联动重心与地面支撑，全身发力 | 下肢稳定支撑上肢力输出 | 主要作用于末端执行器 | 主要作用于上半身链条 |
| 力控形式 | 无外部力 sensing，靠姿态与反作用力协调 | 隐式力补偿 | compliance command（Hooke's law） | 虚拟阻抗 + 安全力阈值 |
| 平台/证据 | Unitree G1，后拉 167.7 N、前拉 145.5 N | 拉车、开门、重物搬运 | GR00T N1.5 擦白板/搬箱演示 | Unitree G1 拥抱/搀扶/软物体 |
| 谱系定位 | 强发力侧代表 | 强发力侧，双 agent 分工 | 柔顺侧，安全可调 | 柔顺侧，安全优先 |
