...
- **标题：** HuBE: Cross-Embodiment Human-like Behavior Execution for Humanoid Robots
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/hube-cross-embodiment-human-like-behavior-execut/hube-cross-embodiment-human-like-behavior-execut.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2508.19002>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-hube](../../wiki/entities/paper-notebook-hube.md).

## 对 wiki 的映射

- [paper-notebook-hube](../../wiki/entities/paper-notebook-hube.md)
...
- 论文：<https://arxiv.org/abs/2508.19002>
