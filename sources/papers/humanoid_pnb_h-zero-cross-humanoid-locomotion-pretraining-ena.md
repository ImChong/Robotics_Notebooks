...
- **计划笔记路径：** `papers/05_Locomotion/h-zero-cross-humanoid-locomotion-pretraining-ena/h-zero-cross-humanoid-locomotion-pretraining-ena.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-h-zero-cross-humanoid-locomotion-pretraining-ena](../../wiki/entities/paper-notebook-h-zero-cross-humanoid-locomotion-pretraining-ena.md).

## 对 wiki 的映射

- [paper-notebook-h-zero-cross-humanoid-locomotion-pretraining-ena](../../wiki/entities/paper-notebook-h-zero-cross-humanoid-locomotion-pretraining-ena.md)
