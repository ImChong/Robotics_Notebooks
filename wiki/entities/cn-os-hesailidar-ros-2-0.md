...
**HesaiLidar_ROS_2.0** 是 [禾赛科技](https://github.com/HesaiTechnology) 公开的 **工程与工具** 开源项目：把禾赛激光雷达接入ROS与ROS2，发布点云和设备状态供机器人系统使用。
...
1. 从官方 GitHub/Gitee 组织检索 `HesaiLidar_ROS_2.0` 仓库并核对 README 许可与依赖。
