...
- **主链接：** <https://eval.ai/>
- **代码：** 未在清单中标注
- **清单摘要：** Open platform for challenge hosting, leaderboard management, and standardized evaluation workflows.
- **沉淀到 wiki：** [`wiki/entities/painode-110-evalai.md`](../../wiki/entities/painode-110-evalai.md)
...
- 实体页：[`wiki/entities/painode-110-evalai.md`](../../wiki/entities/painode-110-evalai.md)
