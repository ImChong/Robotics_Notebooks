...
> 来源归档（ingest · awesome-bfm-papers 第 25/41）
...
- **入库日期：** 2026-05-26
- **一句话说明：** 可复用技能嵌入；与 AMP 分布约束不同，强调技能空间。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **25/41**。
- **公众号导读要点：** 可复用技能嵌入；与 AMP 分布约束不同，强调技能空间。
