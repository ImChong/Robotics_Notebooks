...
arxiv: "2307.12698"
venue: "arXiv 2023"
summary: "Learns motion and content features via joint-embedding."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2307_12698_mc-jepa-motion-and-content-features-via.md
...
**MC-JEPA: Motion and Content Features via Joint-Embedding** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 119/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns motion and content features via joint-embedding.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2307.12698> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2307.12698) 为准。
...
**本条目的站内价值是把「MC-JEPA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2307_12698_mc-jepa-motion-and-content-features-via.md`](../../sources/papers/sun_awesome_wm_2307_12698_mc-jepa-motion-and-content-features-via.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2307.12698)
