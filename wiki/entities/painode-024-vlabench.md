...
status: complete
updated: 2026-09-20
summary: "Language-conditioned manipulation benchmark for VLAs."
related:
...
sources:
  - ../../sources/repos/pai_awesome_benchmark_024_vlabench.md
...
**VLABench** 收录于 awesome-physical-ai（aichr）**第 024/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Language-conditioned manipulation benchmark for VLAs.
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 面向 VLA 的语言条件操作评测，属该闭环第 ③ 层「策略任务成功率评测」的 VLA 侧入口

## 参考来源

- [`sources/repos/pai_awesome_benchmark_024_vlabench.md`](../../sources/repos/pai_awesome_benchmark_024_vlabench.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://vlabench.github.io/)
