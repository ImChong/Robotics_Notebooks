...
status: complete
updated: 2026-09-20
code: https://github.com/carla-simulator/scenario_runner
summary: "Scenario-based closed-loop evaluation harness for safety-critical driving behaviors."
related:
...
sources:
  - ../../sources/repos/pai_awesome_eval_105_carla-scenariorunner.md
...
**CARLA ScenarioRunner** 收录于 awesome-physical-ai（natnew）**第 105/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Scenario-based closed-loop evaluation harness for safety-critical driving behaviors.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/carla-simulator/scenario_runner> |
| 代码/仓库 | <https://github.com/carla-simulator/scenario_runner> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/carla-simulator/scenario_runner> |
| 代码/仓库 | <https://github.com/carla-simulator/scenario_runner> |
...
- [`sources/repos/pai_awesome_eval_105_carla-scenariorunner.md`](../../sources/repos/pai_awesome_eval_105_carla-scenariorunner.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/carla-simulator/scenario_runner)
