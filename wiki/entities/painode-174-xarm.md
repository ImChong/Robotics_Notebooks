...
status: complete
updated: 2026-09-20
summary: "Affordable 6/7-DOF robot arms for research and development."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_174_xarm.md
...
**xArm** 收录于 awesome-physical-ai（natnew）**第 174/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Affordable 6/7-DOF robot arms for research and development.
...
- [`sources/repos/pai_awesome_hardware_174_xarm.md`](../../sources/repos/pai_awesome_hardware_174_xarm.md) — 本条目策展摘录
