...
## 关联页面
- [Query：接触力旋量闭环知识链](../queries/contact-wrench-closed-loop.md) — 本页是四层闭环里的 **② 力旋量表示层**（把接触统一成 6D 力旋量并映回关节）
- [Contact-Force-Loop Bandwidth（力控闭环带宽）](./contact-force-loop-bandwidth.md) — 阻抗/导纳带宽差异的量化边界
