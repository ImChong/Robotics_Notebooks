...
arxiv: "2604.11135"
venue: "2026"
summary: "AIM jointly generates future RGB observations, spatial contact maps and continuous robot actions. A masked mixture-of-transformers architecture makes the predicted maps the action head's only route to future information."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_11135_aim-intent-aware-unified-world-action-mo.md
...
**AIM: Intent-Aware Unified world action Modeling with Spatial Value Maps** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 277/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

AIM jointly generates future RGB observations, spatial contact maps and continuous robot actions. A masked mixture-of-transformers architecture makes the predicted maps the action head's only route to future information. Supervised learning uses simulator-derived contact labels; post-training freezes world/value pre...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2604.11135> |
| 子类 / 象限 | 联合视频动作建模 · 策略后训练与WM-RL |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.11135) 为准。
...
**本条目的站内价值是把「AIM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_11135_aim-intent-aware-unified-world-action-mo.md`](../../sources/papers/rcl_awesome_wam_2604_11135_aim-intent-aware-unified-world-action-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.11135)
