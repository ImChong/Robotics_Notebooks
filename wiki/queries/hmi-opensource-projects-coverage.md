...
输入是上游主表项目名与官方链接；机制是「快照深读 + 增量不镜像」；输出是可点开的本库详情，或回到 586 项原文 / 按公司拆页目录。工程层条目数不是方法贡献。
...
| 规模 | 说明 |
|------|------|
| 上游主表（2026-09-10） | **586** 项（工程与实机部署一层就有 286 项） |
| 本页深读快照 | **166** 项（2026-07-30 全覆盖；均可点开本库详情） |
| 本次不镜像的增量 | 约 420 项 — 多为公司 SDK/数据工具/部署中间件；按公司查官方仓改走上游 [具身智能公司的开源项目](https://github.com/RealXiaoze/humanoid-motion-intelligence/tree/main/%E5%85%B7%E8%BA%AB%E6%99%BA%E8%83%BD%E5%85%AC%E5%8F%B8%E7%9A%84%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE) |
| 分组 | 快照表仍按当时主表：数据与重定向、Locomotion、全身跟踪、LocoManip、VLA/世界模型、工程部署 |

## 工程实践

| 场景 | 做法 |
|------|------|
| 快照表里已有的名字 | 左链看官方仓，右链读本库机制页 |
| 主表新增、本页没有的名字 | 打开上游 586 项主表；公司官方仓走「按公司拆页」目录，不要在本库平行造页 |
| 工程层 SDK / 数据工具 | 先读主表「定位」再核对许可证与真机入口；条目数不等于方法贡献 |
...
- **主表会更新，本页是快照式导读。** 2026-07 的 166 项仍可当「目录 → 正文」入口；上游现为 586 项，新增或改名条目以 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 原文为准，本库 **不整表镜像**。
- **工程层条目暴涨不等于方法暴涨。** 286 个工程/部署项目里大量是 SDK、仿真资产、数据格式转换和真机接口；选型时先看「定位」再跳官方 README。
- **按公司查官方仓**走上游新目录 [具身智能公司的开源项目](https://github.com/RealXiaoze/humanoid-motion-intelligence/tree/main/%E5%85%B7%E8%BA%AB%E6%99%BA%E8%83%BD%E5%85%AC%E5%8F%B8%E7%9A%84%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE)，国内 424 项全景仍见 [424 项覆盖索引](./china-domestic-opensource-424-coverage.md)。
