...
- **标题：** EMP: Executable Motion Prior for Humanoid Robot Standing Upper-body Motion Imitation
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/emp-executable-motion-prior-for-humanoid-robot-s/emp-executable-motion-prior-for-humanoid-robot-s.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2507.15649>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-emp](../../wiki/entities/paper-notebook-emp.md).

## 对 wiki 的映射

- [paper-notebook-emp](../../wiki/entities/paper-notebook-emp.md)
...
- 论文：<https://arxiv.org/abs/2507.15649>
