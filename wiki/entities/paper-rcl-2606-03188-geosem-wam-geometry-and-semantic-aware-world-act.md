...
updated: 2026-09-25
arxiv: "2606.03188"
summary: "To address this, we propose a structured world modeling framework that enhances latent representations through geometric and semantic supervision. Alongside future RGB prediction, our model introduces two auxiliary predi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_03188_geosem-wam-geometry-and-semantic-aware-w.md
...
**GeoSem-WAM: Geometry- and Semantic-Aware World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 370/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To address this, we propose a structured world modeling framework that enhances latent representations through geometric and semantic supervision. Alongside future RGB prediction, our model introduces two auxiliary prediction branches for future geometry and semantic representations, enabling it to jointly capture s...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.03188> |
| 子类 / 象限 | 三维多视角建模 · 高效推理与实时控制 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.03188) 为准。
...
**本条目的站内价值是把「GeoSem-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_03188_geosem-wam-geometry-and-semantic-aware-w.md`](../../sources/papers/rcl_awesome_wam_2606_03188_geosem-wam-geometry-and-semantic-aware-w.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.03188)
