...
- **标题：** Learning Bipedal Locomotion on Gear-Driven Humanoid Robot Using Foot-Mounted IMUs
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/learning-bipedal-locomotion-on-gear-driven-human/learning-bipedal-locomotion-on-gear-driven-human.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-bipedal-locomotion-on-gear-driven-human](../../wiki/entities/paper-notebook-learning-bipedal-locomotion-on-gear-driven-human.md).

## 对 wiki 的映射

- [paper-notebook-learning-bipedal-locomotion-on-gear-driven-human](../../wiki/entities/paper-notebook-learning-bipedal-locomotion-on-gear-driven-human.md)
