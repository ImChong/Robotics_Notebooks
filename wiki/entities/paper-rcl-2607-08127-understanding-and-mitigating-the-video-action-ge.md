...
updated: 2026-09-25
arxiv: "2607.08127"
summary: "To explain this behavior, we introduce the Temporal Ratio (TR), an attention-based measure of how strongly the action head relies on future latent rollouts relative to the anchored current frame. Finally, based on these"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_08127_understanding-and-mitigating-the-video-a.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Understanding and Mitigating the Video-Action Generalization Gap via Temporal...

**Understanding and Mitigating the Video-Action Generalization Gap via Temporal Ratio** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 502/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To explain this behavior, we introduce the Temporal Ratio (TR), an attention-based measure of how strongly the action head relies on future latent rollouts relative to the anchored current frame. Finally, based on these findings, we propose an inference-time adaptive guidance method, which exploits this intrinsic fe...
...
| 项目页 | <https://umishra.me/temporal-ratio/> |
| 子类 / 象限 | 视觉规划与IDM · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.08127) 为准。
...
**本条目的站内价值是把「Understanding and Mitigating the Video-Action Generalization Gap via Temporal...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_08127_understanding-and-mitigating-the-video-a.md`](../../sources/papers/rcl_awesome_wam_2607_08127_understanding-and-mitigating-the-video-a.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.08127)
