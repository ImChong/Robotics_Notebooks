...
**mecheye_python_samples** 是 [梅卡曼德](https://github.com/MechMindRobotics) 公开的 **数据采集/工具** 开源项目：提供Mech-Eye API的Python示例，覆盖相机连接、图像和点云采集以及常见参数设置。
...
1. 从官方 GitHub/Gitee 组织检索 `mecheye_python_samples` 仓库并核对 README 许可与依赖。
