...
> 来源归档（ingest · 人形 RL 身体系统栈 42 篇 · 第 20/42）
...
- **项目/论文链接：** <https://github.com/myismyname/SRL4Humanoid>
...
- **入库日期：** 2026-05-26
- **一句话说明：** PvP 的全称是 Proprioceptive-Privileged Contrastive Representations。它关注的是 whole-body control 中的样本效率和部分可观测问题。

## 核心摘录（策展，非全文）

- **在身体系统栈中的位置：** 02 参考跟踪 · 通用控制，编号 **20/42**。
- **公众号导读要点：** PvP 的全称是 Proprioceptive-Privileged Contrastive Representations。它关注的是 whole-body control 中的样本效率和部分可观测问题。
