...
status: complete
updated: 2026-09-20
summary: "Widely adopted behavior-tree runtime for deterministic task orchestration."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_256_behaviortree-cpp.md
...
**BehaviorTree.CPP** 收录于 awesome-physical-ai（natnew）**第 256/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Widely adopted behavior-tree runtime for deterministic task orchestration.
...
| 来源清单 | natnew |
| 主链接 | <https://www.behaviortree.dev/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.behaviortree.dev/> |
...
- [`sources/repos/pai_awesome_resource_256_behaviortree-cpp.md`](../../sources/repos/pai_awesome_resource_256_behaviortree-cpp.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.behaviortree.dev/)
