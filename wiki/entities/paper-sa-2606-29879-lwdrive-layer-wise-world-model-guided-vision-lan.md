...
arxiv: "2606.29879"
venue: "arXiv 2026"
summary: "Layer-wise world-model-guided VLM planning, achieving 92.0 on the NAVSIM benchmark."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_29879_lwdrive-layer-wise-world-model-guided-vi.md
...
**LWDrive: Layer-Wise World-Model-Guided Vision-Language Model Planning for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 451/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Layer-wise world-model-guided VLM planning, achieving 92.0 on the NAVSIM benchmark.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.29879> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.29879) 为准。
...
**本条目的站内价值是把「LWDrive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_29879_lwdrive-layer-wise-world-model-guided-vi.md`](../../sources/papers/sun_awesome_wm_2606_29879_lwdrive-layer-wise-world-model-guided-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.29879)
