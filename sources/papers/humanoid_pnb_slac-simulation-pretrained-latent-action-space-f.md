...
- **标题：** SLAC: Simulation-Pretrained Latent Action Space for Whole-Body Real-World Reinforcement Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/slac-simulation-pretrained-latent-action-space-f/slac-simulation-pretrained-latent-action-space-f.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2506.04147>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-slac](../../wiki/entities/paper-notebook-slac.md).

## 对 wiki 的映射

- [paper-notebook-slac](../../wiki/entities/paper-notebook-slac.md)
...
- 论文：<https://arxiv.org/abs/2506.04147>
