...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1812_01717_towards-accurate-generative-models-of-vi.md
...
**Towards Accurate Generative Models of Video: A New Metric & Challenges** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 146/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2018 |
| 论文 | <https://arxiv.org/abs/1812.01717> |
| 子类 / 象限 | 视频质量指标 · 评估指标与协议 · 基准与模拟器 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1812.01717) 为准。
...
**本条目的站内价值是把「Towards Accurate Generative Models of Video」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1812_01717_towards-accurate-generative-models-of-vi.md`](../../sources/papers/rcl_awesome_wam_1812_01717_towards-accurate-generative-models-of-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/1812.01717)
