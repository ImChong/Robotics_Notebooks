...
status: complete
updated: 2026-09-20
summary: "General, low-cost, and intuitive teleoperation framework."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_161_gello.md
...
**Gello** 收录于 awesome-physical-ai（natnew）**第 161/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew |
| 主链接 | <https://wuphilipp.github.io/gello/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://wuphilipp.github.io/gello/> |
...
- [`sources/repos/pai_awesome_hardware_161_gello.md`](../../sources/repos/pai_awesome_hardware_161_gello.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://wuphilipp.github.io/gello/)
