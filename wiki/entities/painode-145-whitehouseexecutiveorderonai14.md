---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, standard]
status: complete
updated: 2026-09-20
summary: "US federal directive on safe and trustworthy AI development relevant to robotics deployers."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_145_white-house-executive-order-on-ai-14.md
...
# White House Executive Order on AI (14110)

**White House Executive Order on AI (14110)** 收录于 awesome-physical-ai（natnew）**第 145/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

US federal directive on safe and trustworthy AI development relevant to robotics deployers.
...
|------|------|
| 编号 | 145/384 |
| 分组 | Governance & Policy |
| 来源清单 | natnew |
| 主链接 | <https://www.federalregister.gov/documents/2023/11/01/2023-24283/safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence> |

## 核心原理

US federal directive on safe and trustworthy AI development relevant to robotics deployers.

该条目在 Physical AI 清单中的角色是 **standard**，分组 **Governance & Policy**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.federalregister.gov/documents/2023/11/01/2023-24283/safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence> |
...
- [`sources/repos/pai_awesome_standard_145_white-house-executive-order-on-ai-14.md`](../../sources/repos/pai_awesome_standard_145_white-house-executive-order-on-ai-14.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.federalregister.gov/documents/2023/11/01/2023-24283/safe-secure-and-trustworthy-development-and-use-of-artificial-intelligence)
