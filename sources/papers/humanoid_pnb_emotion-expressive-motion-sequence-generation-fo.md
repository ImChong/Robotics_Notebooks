...
- **标题：** EMOTION: Expressive Motion Sequence Generation for Humanoid Robots with In-Context Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/emotion-expressive-motion-sequence-generation-fo/emotion-expressive-motion-sequence-generation-fo.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2410.23234>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-094-emotion](../../wiki/entities/paper-loco-manip-161-094-emotion.md).

## 对 wiki 的映射

- [paper-loco-manip-161-094-emotion](../../wiki/entities/paper-loco-manip-161-094-emotion.md)
...
- 论文：<https://arxiv.org/abs/2410.23234>
