...
status: complete
updated: 2026-09-20
summary: "Language-grounded continuous-task benchmark in physically realistic scenes."
related:
...
**ARNOLD** 收录于 awesome-physical-ai（natnew）**第 010/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Language-grounded continuous-task benchmark in physically realistic scenes.
...
| 分组 | Benchmarks |
| 来源清单 | natnew |
| 主链接 | <https://arnold-benchmark.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://arnold-benchmark.github.io/> |
...
- [`sources/repos/pai_awesome_benchmark_010_arnold.md`](../../sources/repos/pai_awesome_benchmark_010_arnold.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arnold-benchmark.github.io/)
