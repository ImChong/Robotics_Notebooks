...
4. **与 UE 仿真栈的邻接关系**：[AirSim](./airsim.md) 等基于 UE 的机器人视觉仿真可与 MetaHuman 场景共存，但 MetaHuman 本身 **不以刚体控制环或 RL 环境 API** 为设计中心。
...
- [Unreal Engine 文档：MetaHuman](https://dev.epicgames.com/documentation/en-us/metahuman) — 官方工作流与插件索引
