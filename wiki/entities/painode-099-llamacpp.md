...
summary: "Quantized LLM inference."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_099_llama-cpp.md
...
**llama.cpp** 收录于 awesome-physical-ai（aichr）**第 099/384** 条，分组 **Edge AI & Inference**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://github.com/ggerganov/llama.cpp> |
| 代码/仓库 | <https://github.com/ggerganov/llama.cpp> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/ggerganov/llama.cpp> |
| 代码/仓库 | <https://github.com/ggerganov/llama.cpp> |
...
- [`sources/repos/pai_awesome_resource_099_llama-cpp.md`](../../sources/repos/pai_awesome_resource_099_llama-cpp.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/ggerganov/llama.cpp)
