...
arxiv: "2406.08691"
venue: "arXiv 2024"
code: https://waabi.ai/research/uno
summary: "Unsupervised occupancy fields for perception and forecasting."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2406_08691_uno-unsupervised-occupancy-fields-for-pe.md
...
**UnO: Unsupervised Occupancy Fields for Perception and Forecasting** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 489/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2406.08691> |
| 代码/项目 | <https://waabi.ai/research/uno> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.08691) 为准。
...
**本条目的站内价值是把「UnO」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2406_08691_uno-unsupervised-occupancy-fields-for-pe.md`](../../sources/papers/sun_awesome_wm_2406_08691_uno-unsupervised-occupancy-fields-for-pe.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.08691)
