...
- **沉淀到 wiki：** 是 → [`wiki/entities/brainco-hand-service.md`](../../wiki/entities/brainco-hand-service.md)
...
- 实体页：[`wiki/entities/brainco-hand-service.md`](../../wiki/entities/brainco-hand-service.md)
