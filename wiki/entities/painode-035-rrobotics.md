...
status: complete
updated: 2026-09-20
summary: "community for robotics discussion."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_035_r-robotics.md
...
**r/robotics** 收录于 awesome-physical-ai（natnew、aichr）**第 035/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

community for robotics discussion.
...
| 分组 | Community |
| 来源清单 | natnew、aichr |
| 主链接 | <https://www.reddit.com/r/robotics/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.reddit.com/r/robotics/> |
...
- [`sources/repos/pai_awesome_community_035_r-robotics.md`](../../sources/repos/pai_awesome_community_035_r-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.reddit.com/r/robotics/)
