...
arxiv: "2603.22281"
venue: "arXiv 2026"
summary: "VLM-guided JEPA-style framework with dual temporal pathways."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2603_22281_thinkjepa-empowering-latent-world-models.md
...
**ThinkJEPA: Empowering Latent World Models with Large Vision-Language Reasoning Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 120/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VLM-guided JEPA-style framework with dual temporal pathways.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.22281) 为准。
...
**本条目的站内价值是把「ThinkJEPA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2603_22281_thinkjepa-empowering-latent-world-models.md`](../../sources/papers/sun_awesome_wm_2603_22281_thinkjepa-empowering-latent-world-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.22281)
