# KIT-ML（BFM 行为数据 · awesome-bfm-papers 数据集表）
...
- **出处：** 2016 · arXiv
- **规模：** 3911 clips · 11.2 h（列表标注）
- **论文链接：** <https://arxiv.org/abs/1607.03827>
- **代码/入口：** <https://motion-annotation.humanoids.kit.edu/dataset/>
...
- 数据集论文/页：<https://arxiv.org/abs/1607.03827>
