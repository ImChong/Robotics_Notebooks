...
- **代码：** 未在清单中标注
- **清单摘要：** SFU. Social robotics and emotional AI.
- **沉淀到 wiki：** [`wiki/entities/painode-242-angelicalim.md`](../../wiki/entities/painode-242-angelicalim.md)
...
- 实体页：[`wiki/entities/painode-242-angelicalim.md`](../../wiki/entities/painode-242-angelicalim.md)
