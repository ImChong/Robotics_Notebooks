...
status: complete
updated: 2026-09-20
summary: "Regulation establishing risk-tiered obligations for AI systems sold or operated in the EU."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_131_eu-ai-act.md
...
**EU AI Act** 收录于 awesome-physical-ai（natnew）**第 131/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Regulation establishing risk-tiered obligations for AI systems sold or operated in the EU.
...
| 来源清单 | natnew |
| 主链接 | <https://artificialintelligenceact.eu/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://artificialintelligenceact.eu/> |
...
- [`sources/repos/pai_awesome_standard_131_eu-ai-act.md`](../../sources/repos/pai_awesome_standard_131_eu-ai-act.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://artificialintelligenceact.eu/)
