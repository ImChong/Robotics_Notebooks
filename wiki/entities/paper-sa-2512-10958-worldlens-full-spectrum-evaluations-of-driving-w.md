...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2512_10958_worldlens-full-spectrum-evaluations-of-d.md
...
**WorldLens: Full-Spectrum Evaluations of Driving World Models in Real World** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 497/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Full-spectrum evaluations of driving world models in the real world.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.10958) 为准。
...
**本条目的站内价值是把「WorldLens」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2512_10958_worldlens-full-spectrum-evaluations-of-d.md`](../../sources/papers/sun_awesome_wm_2512_10958_worldlens-full-spectrum-evaluations-of-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.10958)
