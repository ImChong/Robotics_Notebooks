...
- **代码：** 未在清单中标注
- **清单摘要：** Foundation-model-driven AI for robotic picking and warehouse manipulation.
- **沉淀到 wiki：** [`wiki/entities/painode-044-covariant.md`](../../wiki/entities/painode-044-covariant.md)
...
- 实体页：[`wiki/entities/painode-044-covariant.md`](../../wiki/entities/painode-044-covariant.md)
