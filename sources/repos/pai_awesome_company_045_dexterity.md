...
- **代码：** 未在清单中标注
- **清单摘要：** AI robotics company deploying high-throughput manipulation systems for logistics.
- **沉淀到 wiki：** [`wiki/entities/painode-045-dexterity.md`](../../wiki/entities/painode-045-dexterity.md)
...
- 实体页：[`wiki/entities/painode-045-dexterity.md`](../../wiki/entities/painode-045-dexterity.md)
