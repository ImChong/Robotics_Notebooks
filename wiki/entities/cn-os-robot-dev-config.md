...
**robot_dev_config** 是 [地瓜机器人](https://github.com/D-Robotics) 公开的 **工程与工具** 开源项目：作为TogetheROS.Bot开发入口组织机器人中间件、依赖和设备配置。
...
| 机构 | 地瓜机器人 |
| 类别 | 工程与工具 |
| 官方组织 | https://github.com/D-Robotics |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `robot_dev_config` 仓库并核对 README 许可与依赖。
...
- [地瓜机器人 官方组织](https://github.com/D-Robotics)
