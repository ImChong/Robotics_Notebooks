...
- **代码：** 未在清单中标注
- **清单摘要：** 3D voxel-action transformer for language-conditioned, long-horizon manipulation.
- **沉淀到 wiki：** [`wiki/entities/painode-221-peract.md`](../../wiki/entities/painode-221-peract.md)
...
- 实体页：[`wiki/entities/painode-221-peract.md`](../../wiki/entities/painode-221-peract.md)
