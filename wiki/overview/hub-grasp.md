...
**抓取知识链** 关注机器人如何通过感知与规划，在接触丰富的环境中稳定地 **抓取、持握并操纵物体**，是人形 loco-manip 与桌面操作的核心子栈。
...
- **[触觉](./hub-tactile.md)**：抓取稳定常依赖力/触觉反馈。
- **[WBC](./hub-wbc.md)**：全身协调下手臂与躯干的分工。
- **[VLA](./hub-vla.md)**：语言条件下的抓取与放置。
