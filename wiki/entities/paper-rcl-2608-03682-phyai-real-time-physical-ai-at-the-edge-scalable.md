...
summary: "To unify them, we build PhyAI, a Physical AI inference engine with a single runtime that keeps architecture-specific conditioning, solver, cache, and output logic in model adapters while sharing graph execution, kernels,"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_03682_phyai-real-time-physical-ai-at-the-edge.md
...
**PhyAI: Real-Time Physical AI at the Edge, Scalable Rollouts in the Cloud** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 212/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To unify them, we build PhyAI, a Physical AI inference engine with a single runtime that keeps architecture-specific conditioning, solver, cache, and output logic in model adapters while sharing graph execution, kernels, memory management, and parallel services. PhyAI achieves 1.40x-4.65x speedups over the official...
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2608.03682> |
| 代码/项目 | <https://github.com/mingti-org/phyai> |
| 子类 / 象限 | 综述与技术资源 · 训练优化与蒸馏 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.03682) 为准。
...
**本条目的站内价值是把「PhyAI」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_03682_phyai-real-time-physical-ai-at-the-edge.md`](../../sources/papers/rcl_awesome_wam_2608_03682_phyai-real-time-physical-ai-at-the-edge.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.03682)
