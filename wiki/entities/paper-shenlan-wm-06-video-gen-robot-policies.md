...
**Video Generators are Robot Policies** 收录于 [深蓝具身智能 · 世界模型 15 开源项目专题](https://mp.weixin.qq.com/s/KZT8sI4n7GvHWyM20wN3gg) **第 06/15** 篇，归类为 **01 级联架构**。本页为知识库 **策展摘要**（arXiv:2508.00795）。
...
- 属于 [世界模型 15 项目技术地图](../overview/world-models-15-open-source-technology-map.md) 中 **01 级联架构** 路线的代表开源基线之一。
- 与 [机器人世界模型训练闭环 taxonomy](../overview/robot-world-models-training-loop-taxonomy.md) 对照：关注预测是否 **进入策略学习/评估闭环**，而非仅开环视频逼真。
