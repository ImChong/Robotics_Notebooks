...
sources:
  - ../../sources/papers/humanoid_pnb_deep-reinforcement-learning-for-bipedal-locomoti.md
summary: "Deep Reinforcement Learning for Bipedal Locomotion：列入 Paper Notebooks PROGRESS.md 待深读清单；深读笔记完成后补成完整摘要。"
---

# Deep Reinforcement Learning for Bipedal Locomotion

**Deep Reinforcement Learning for Bipedal Locomotion: A Brief Survey** 已列入 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html) 的 **PROGRESS.md 待深读** 清单（分类：05_Locomotion）。本页 **还没有深读笔记**：只给出这篇论文的分类位置与原文入口，方法细节与数据请直接看原文。

## 一句话定义

Deep Reinforcement Learning for Bipedal Locomotion 的人形机器人学习论文条目，当前处于 Paper Notebooks 阅读进度（待深读）阶段。
...
| 计划文件夹 | `papers/05_Locomotion/deep-reinforcement-learning-for-bipedal-locomoti` |
| arXiv | <https://arxiv.org/abs/2404.17070> |
...
- [humanoid_pnb_deep-reinforcement-learning-for-bipedal-locomoti.md](../../sources/papers/humanoid_pnb_deep-reinforcement-learning-for-bipedal-locomoti.md)
...
- 论文：<https://arxiv.org/abs/2404.17070>
