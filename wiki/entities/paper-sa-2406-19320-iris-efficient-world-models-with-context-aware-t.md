...
summary: "Efficient world models with context-aware tokenization."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2406_19320_iris-efficient-world-models-with-context.md
...
**Δ-IRIS: Efficient World Models with Context-Aware Tokenization** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 250/571** 篇，分组 **72 Continuous Control**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2406.19320> |
| 代码/项目 | <https://github.com/vmicheli/delta-iris> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.19320) 为准。
...
**本条目的站内价值是把「Δ-IRIS」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2406_19320_iris-efficient-world-models-with-context.md`](../../sources/papers/sun_awesome_wm_2406_19320_iris-efficient-world-models-with-context.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.19320)
