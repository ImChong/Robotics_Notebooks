...
summary: "Unitree Dex1-1 灵巧手 Serial↔DDS 服务。"
---

# dex1_1_service

**dex1_1_service** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **灵巧手 Serial↔DDS 服务** 主线。

## 一句话定义

Unitree Dex1-1 灵巧手 Serial↔DDS 服务。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/dex1_1_service`](https://github.com/unitreerobotics/dex1_1_service) |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/dex1_1_service.md](../../sources/repos/dex1_1_service.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/dex1_1_service>
