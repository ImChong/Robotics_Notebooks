...
summary: "We propose DynamicWAM, a compact WAM for dynamic object manipulation with dual-path motion conditioning. On DOMINO, DynamicWAM achieves a 38.2% success rate and a 53.2 manipulation score, outperforming all evaluated base"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_00793_dynamicwam-dual-path-motion-conditioning.md
...
**DynamicWAM: Dual-Path Motion Conditioning for World-Action Models in Dynamic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 334/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.00793> |
| 代码/项目 | <https://github.com/Autumn1337/DynamicWAM> |
| 子类 / 象限 | 高效推理与实时控制 · 联合视频动作建模 · 泛化与动作对齐 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.00793) 为准。
...
**本条目的站内价值是把「DynamicWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_00793_dynamicwam-dual-path-motion-conditioning.md`](../../sources/papers/rcl_awesome_wam_2608_00793_dynamicwam-dual-path-motion-conditioning.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.00793)
