...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_18135_world-in-world-world-models-in-a-closed.md
...
**World-in-World: World Models in a Closed-Loop World** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 048/571** 篇，分组 **115 Benchmarks for World Model Simulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

The first open platform for benchmarking world models in a closed‑loop world, mirroring real agent‑environment interactions, with unified online planning strategies and standardised action APIs.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.18135> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.18135) 为准。
...
**本条目的站内价值是把「World-in-World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_18135_world-in-world-world-models-in-a-closed.md`](../../sources/papers/sun_awesome_wm_2510_18135_world-in-world-world-models-in-a-closed.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.18135)
