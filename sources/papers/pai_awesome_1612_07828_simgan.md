...
- **代码：** 未在清单中标注
- **清单摘要：** Sim-to-real visual adaptation method for narrowing sensor-domain gaps.
- **沉淀到 wiki：** [`wiki/entities/paper-pai-1612-07828-simgan.md`](../../wiki/entities/paper-pai-1612-07828-simgan.md)
...
- 实体页：[`wiki/entities/paper-pai-1612-07828-simgan.md`](../../wiki/entities/paper-pai-1612-07828-simgan.md)
