...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_ea14fce8991bbd0da18e_a-review-of-learning-based-dynamics-mode.md
...
**A review of learning-based dynamics models for robotic manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 194/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | Science Robotics 10(106), 2025 |
| 论文 | <https://doi.org/10.1126/scirobotics.adt1497> |
| 项目页 | <https://www.hichristensen.com/publication/scirob-25-survey/> |
| 子类 / 象限 | 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://doi.org/10.1126/scirobotics.adt1497) 为准。
...
**本条目的站内价值是把「A review of learning-based dynamics models for robotic manipulation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_ea14fce8991bbd0da18e_a-review-of-learning-based-dynamics-mode.md`](../../sources/papers/rcl_awesome_wam_ref_ea14fce8991bbd0da18e_a-review-of-learning-based-dynamics-mode.md) — 本条目策展摘录
...
- [原文](https://doi.org/10.1126/scirobotics.adt1497)
