...
**WMPO: World Model-based Policy Optimization for Vision-Language-Action Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 231/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
**本条目的站内价值是把「WMPO」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
