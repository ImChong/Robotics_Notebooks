...
- **计划笔记路径：** `papers/06_Manipulation/rgmp-recurrent-geometric-prior-multimodal-policy/rgmp-recurrent-geometric-prior-multimodal-policy.md`
- **分类：** 06_Manipulation
...
- 知识归纳见 wiki 实体页：[paper-notebook-rgmp-recurrent-geometric-prior-multimodal-policy](../../wiki/entities/paper-notebook-rgmp-recurrent-geometric-prior-multimodal-policy.md).

## 对 wiki 的映射

- [paper-notebook-rgmp-recurrent-geometric-prior-multimodal-policy](../../wiki/entities/paper-notebook-rgmp-recurrent-geometric-prior-multimodal-policy.md)
