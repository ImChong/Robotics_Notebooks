...
[Project Instinct InstinctLab](https://github.com/project-instinct/instinctlab) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「工程与实机部署」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

作为Project Instinct的Isaac Lab环境层，它把任务注册、实验目录和ONNX导出连接到instinct_rl训练器及instinct_onboard部署链路，可沿同一实验记录追踪策略从仿真训练到本体执行。
...
|------|------|
| 主表分组 | 工程与实机部署 |
| 官方入口 | https://github.com/project-instinct/instinctlab |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["Project Instinct InstinctLab"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [Project Instinct InstinctLab 来源归档](../../sources/repos/instinctlab.md)
