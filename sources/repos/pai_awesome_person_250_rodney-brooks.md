...
- **代码：** 未在清单中标注
- **清单摘要：** iRobot co-founder, Robust.AI. Robotics pioneer and blogger.
- **沉淀到 wiki：** [`wiki/entities/painode-250-rodneybrooks.md`](../../wiki/entities/painode-250-rodneybrooks.md)
...
- 实体页：[`wiki/entities/painode-250-rodneybrooks.md`](../../wiki/entities/painode-250-rodneybrooks.md)
