...
**SimArt** 是 [字节跳动机器人团队](https://github.com/ByteDance-Seed) 公开的 **仿真环境** 开源项目：使用多模态模型把整体网格分解为可用于仿真的关节资产，服务机器人场景与交互资产构建。
...
1. 从官方 GitHub/Gitee 组织检索 `SimArt` 仓库并核对 README 许可与依赖。
