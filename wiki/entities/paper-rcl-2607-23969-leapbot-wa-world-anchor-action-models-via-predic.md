...
updated: 2026-09-25
arxiv: "2607.23969"
summary: "In this paper, we propose LeapBot-WA, which establishes a novel Predictive-Latent paradigm for WAMs by operationalizing the Joint-Embedding Predictive Architecture (JEPA) as a World-Anchor. To bridge the modality gap bet"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_23969_leapbot-wa-world-anchor-action-models-vi.md
...
**LeapBot-WA: World-Anchor Action Models via Predictive Latent Alignments** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 405/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this paper, we propose LeapBot-WA, which establishes a novel Predictive-Latent paradigm for WAMs by operationalizing the Joint-Embedding Predictive Architecture (JEPA) as a World-Anchor. To bridge the modality gap between non-Gaussian predictive features and diffusion priors, we introduce the Isotropic Semantic A...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.23969> |
| 子类 / 象限 | 潜空间预测与JEPA · 高效推理与实时控制 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.23969) 为准。
...
**本条目的站内价值是把「LeapBot-WA」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_23969_leapbot-wa-world-anchor-action-models-vi.md`](../../sources/papers/rcl_awesome_wam_2607_23969_leapbot-wa-world-anchor-action-models-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.23969)
