...
arxiv: "2404.15109"
venue: "arXiv 2024"
summary: "Learns independent mechanisms for modular world models via compete and compose."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2404_15109_comet-compete-and-compose-learning-indep.md
...
**COMET: Compete and Compose – Learning Independent Mechanisms for Modular World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 125/571** 篇，分组 **45 Object-Centric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns independent mechanisms for modular world models via compete and compose.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2404.15109> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2404.15109) 为准。
...
**本条目的站内价值是把「COMET」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2404_15109_comet-compete-and-compose-learning-indep.md`](../../sources/papers/sun_awesome_wm_2404_15109_comet-compete-and-compose-learning-indep.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2404.15109)
