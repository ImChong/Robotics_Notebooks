...
- 知识归纳见 wiki 实体页：[paper-notebook-human-humanoid-robots-cross-embodiment-behavior](../../wiki/entities/paper-notebook-human-humanoid-robots-cross-embodiment-behavior.md).

## 对 wiki 的映射

- [paper-notebook-human-humanoid-robots-cross-embodiment-behavior](../../wiki/entities/paper-notebook-human-humanoid-robots-cross-embodiment-behavior.md)
