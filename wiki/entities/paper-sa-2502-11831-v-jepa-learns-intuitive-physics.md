...
summary: "V-JEPA learns intuitive physics."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_11831_v-jepa-learns-intuitive-physics.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# V-JEPA Learns Intuitive Physics

**V-JEPA Learns Intuitive Physics** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 123/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.11831> |
| 代码/项目 | <https://github.com/facebookresearch/jepa-intuitive-physics> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.11831) 为准。
...
**本条目的站内价值是把「V-JEPA Learns Intuitive Physics」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_11831_v-jepa-learns-intuitive-physics.md`](../../sources/papers/sun_awesome_wm_2502_11831_v-jepa-learns-intuitive-physics.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.11831)
