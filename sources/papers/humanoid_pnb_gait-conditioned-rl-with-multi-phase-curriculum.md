...
- **标题：** Gait-Conditioned RL with Multi-Phase Curriculum for Humanoid Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/03_High_Impact_Selection/gait-conditioned-rl-with-multi-phase-curriculum/gait-conditioned-rl-with-multi-phase-curriculum.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-gait-conditioned-rl-with-multi-phase-curriculum](../../wiki/entities/paper-notebook-gait-conditioned-rl-with-multi-phase-curriculum.md).

## 对 wiki 的映射

- [paper-notebook-gait-conditioned-rl-with-multi-phase-curriculum](../../wiki/entities/paper-notebook-gait-conditioned-rl-with-multi-phase-curriculum.md)
