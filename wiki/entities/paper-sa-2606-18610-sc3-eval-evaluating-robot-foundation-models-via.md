...
arxiv: "2606.18610"
venue: "arXiv 2026"
summary: "Evaluates robot foundation models via self-consistent video generation."
related:
...
**SC3-Eval: Evaluating Robot Foundation Models via Self-Consistent Video Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 391/571** 篇，分组 **816 Policy Evaluation with World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Evaluates robot foundation models via self-consistent video generation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.18610) 为准。
...
**本条目的站内价值是把「SC3-Eval」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_18610_sc3-eval-evaluating-robot-foundation-mod.md`](../../sources/papers/sun_awesome_wm_2606_18610_sc3-eval-evaluating-robot-foundation-mod.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.18610)
