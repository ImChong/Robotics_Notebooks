...
- **代码：** 未在清单中标注
- **清单摘要：** Bayesian domain randomization approach for data-efficient sim-to-real adaptation.
- **沉淀到 wiki：** [`wiki/entities/paper-pai-1906-01728-bayessim.md`](../../wiki/entities/paper-pai-1906-01728-bayessim.md)
...
- 实体页：[`wiki/entities/paper-pai-1906-01728-bayessim.md`](../../wiki/entities/paper-pai-1906-01728-bayessim.md)
