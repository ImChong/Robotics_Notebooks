...
- **代码：** 未在清单中标注
- **清单摘要：** Widely adopted behavior-tree runtime for deterministic task orchestration.
- **沉淀到 wiki：** [`wiki/entities/painode-256-behaviortreecpp.md`](../../wiki/entities/painode-256-behaviortreecpp.md)
...
- 实体页：[`wiki/entities/painode-256-behaviortreecpp.md`](../../wiki/entities/painode-256-behaviortreecpp.md)
