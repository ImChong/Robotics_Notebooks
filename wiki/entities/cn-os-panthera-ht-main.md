...
sources:
  ...
  - ../../sources/repos/panthera-ht_main.md
summary: "高擎机电 开源项目 Panthera-HT_Main（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - hightorque
---
...
**Panthera-HT_Main** 是 [高擎机电](https://github.com/HighTorque-Robotics) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `Panthera-HT_Main` 仓库并核对 README 许可与依赖。
...
- [Panthera-HT_Main 源码归档](../../sources/repos/panthera-ht_main.md)（<https://github.com/HighTorque-Robotics/Panthera-HT_Main>）
