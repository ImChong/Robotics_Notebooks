...
sources:
  - ../../sources/papers/sun_awesome_ego_2510_08961_egonight-towards-egocentric-vision-under.md
...
**EgoNight: Towards Egocentric Vision Understanding at Night with a Challenging Benchmark** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 139/249** 篇，分组 **293 Procedural Question Answering**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

The first comprehensive benchmark for nighttime egocentric vision with VQA as the core task
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.08961> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.08961) 为准。
...
**本条目的站内价值是把「EgoNight」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2510_08961_egonight-towards-egocentric-vision-under.md`](../../sources/papers/sun_awesome_ego_2510_08961_egonight-towards-egocentric-vision-under.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.08961)
