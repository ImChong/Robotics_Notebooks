...
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Robot_Learning_Paper_Notebooks/papers/06_Manipulation/RGMP-S__Generalizable_Geometric_Prior_and_Recurrent_Spiking_Feature_Learning_for_Humanoid_Manipulation/RGMP-S__Generalizable_Geometric_Prior_and_Recurrent_Spiking_Feature_Learning_for_Humanoid_Manipulation.html>
- **分类：** 06_Manipulation
...
- 知识归纳见 wiki 实体页：[paper-notebook-rgmp-s](../../wiki/entities/paper-notebook-rgmp-s.md).

## 对 wiki 的映射

- [paper-notebook-rgmp-s](../../wiki/entities/paper-notebook-rgmp-s.md)
