...
summary: "We propose Light-WAM, a lightweight World Action Model for efficient robot manipulation. Experiments demonstrate that Light-WAM maintains strong performance on LIBERO and achieves usable multi-task performance on RoboTwi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_08242_light-wam-efficient-world-action-models.md
...
**Light-WAM: Efficient World Action Models with State-Fusion Action Decoding** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 419/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We propose Light-WAM, a lightweight World Action Model for efficient robot manipulation. Experiments demonstrate that Light-WAM maintains strong performance on LIBERO and achieves usable multi-task performance on RoboTwin 2.0, while using only 0.44B trainable parameters.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.08242> |
| 代码/项目 | <https://github.com/L1ziang/Light-WAM> |
| 子类 / 象限 | 高效推理与实时控制 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.08242) 为准。
...
**本条目的站内价值是把「Light-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_08242_light-wam-efficient-world-action-models.md`](../../sources/papers/rcl_awesome_wam_2606_08242_light-wam-efficient-world-action-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.08242)
