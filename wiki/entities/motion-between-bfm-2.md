---
type: entity
tags: [whole-body-tracking, humanoid, rl, hmi-opensource-table, project]
status: draft
updated: 2026-07-30
summary: "Motion-Between BFM-2：当前全身动力学、接触状态与高层目标构型共同条件化二阶段Motion-Between模型，输出连续的状态间过渡。它为VLA提供身体层执行接口，公开证据尚不足以判断控制频率和跨本体范围。"
related:
...
# Motion-Between BFM-2

[Motion-Between BFM-2](https://www.agibot.com.cn/article/315/detail/161.html) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「动作跟踪与全身控制」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

当前全身动力学、接触状态与高层目标构型共同条件化二阶段Motion-Between模型，输出连续的状态间过渡。它为VLA提供身体层执行接口，公开证据尚不足以判断控制频率和跨本体范围。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| BFM | BFM | Motion-Between BFM-2 相关缩写，详见正文 |
...
|------|------|
| 主表分组 | 动作跟踪与全身控制 |
| 官方入口 | https://www.agibot.com.cn/article/315/detail/161.html |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["Motion-Between BFM-2"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [Motion-Between BFM-2 来源归档](../../sources/sites/motion-between-bfm-2.md)
