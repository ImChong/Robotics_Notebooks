...
sources:
  - ../../sources/papers/sun_awesome_ego_2506_07886_egom2p-egocentric-multimodal-multitask-p.md
...
**EgoM2P: Egocentric Multimodal Multitask Pretraining** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 234/249** 篇，分组 **Pre-trained Foundation Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A unified design supporting multitasking across diverse egocentric perception and synthesis tasks, including gaze prediction, egocentric camera tracking, and monocular depth estimation, and also serves as a generative model for conditional egocentric video synthesis
...
| 出处 | ICCV 2025 |
| 论文 | <https://arxiv.org/abs/2506.07886> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.07886) 为准。
...
**本条目的站内价值是把「EgoM2P」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2506_07886_egom2p-egocentric-multimodal-multitask-p.md`](../../sources/papers/sun_awesome_ego_2506_07886_egom2p-egocentric-multimodal-multitask-p.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.07886)
