...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2106_11810_nuplan-a-closed-loop-ml-based-planning-b.md
...
**NuPlan: A closed-loop ML-based planning benchmark for autonomous vehicles** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 040/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2021 |
| 论文 | <https://arxiv.org/abs/2106.11810> |
| 项目页 | <https://motional.com/news/nuplan-closed-loop-ml-based-planning-benchmark-autonomous-vehicles> |
| 子类 / 象限 | 自动驾驶基准 · 驾驶仿真 · 驾驶数据 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2106.11810) 为准。
...
**本条目的站内价值是把「NuPlan」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2106_11810_nuplan-a-closed-loop-ml-based-planning-b.md`](../../sources/papers/rcl_awesome_wam_2106_11810_nuplan-a-closed-loop-ml-based-planning-b.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2106.11810)
