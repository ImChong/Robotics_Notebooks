...
- **标题：** Is imitation learning the route to humanoid robots?
- **类型：** paper
...
- **计划笔记路径：** `papers/06_Manipulation/is-imitation-learning-the-route-to-humanoid-robo/is-imitation-learning-the-route-to-humanoid-robo.md`
- **分类：** 06_Manipulation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-is-imitation-learning-the-route-to-humanoid-robo](../../wiki/entities/paper-notebook-is-imitation-learning-the-route-to-humanoid-robo.md).

## 对 wiki 的映射

- [paper-notebook-is-imitation-learning-the-route-to-humanoid-robo](../../wiki/entities/paper-notebook-is-imitation-learning-the-route-to-humanoid-robo.md)
