...
updated: 2026-09-25
arxiv: "2608.14655"
summary: "To rectify this, we propose Modality Subspace Activation (MSA), a training-free inference-time framework that uses Singular Value Decomposition (SVD) to estimate modal activation strengths."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_14655_diagnosing-and-mitigating-perception-dec.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Diagnosing and Mitigating Perception-Decision Misalignment in Omni-LLMs via M...

**Diagnosing and Mitigating Perception-Decision Misalignment in Omni-LLMs via Modality Subspace Activation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 191/564** 篇，分组 **Major category not recorded**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
|------|------|
| 编号 | 191/564 |
| 分组 | Major category not recorded |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.14655> |
| 子类 / 象限 | 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.14655) 为准。
- 横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 的 **Major category not recorded** 分组逐条展开。
...
**本条目的站内价值是把「Diagnosing and Mitigating Perception-Decision Misalignment in Omni-LLMs via M...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Major category not recorded** + Contribution 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/rcl_awesome_wam_2608_14655_diagnosing-and-mitigating-perception-dec.md`](../../sources/papers/rcl_awesome_wam_2608_14655_diagnosing-and-mitigating-perception-dec.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.14655)
