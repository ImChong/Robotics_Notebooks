...
code: https://github.com/cvlab-kaist/Geometric-Action-Model
summary: "We propose the Geometric Action Model (GAM), a language-conditioned manipulation policy that directly repurposes a pretrained geometric foundation model (GFM) as a shared substrate for perception, temporal prediction, an"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_17046_geometric-action-model-for-robot-policy.md
...
**Geometric Action Model for Robot Policy Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 373/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 编号 | 373/564 |
| 分组 | WAMs |
| 出处 | ECCV 2026 Workshop: 3D in the Era of World Models (non-archival) |
| 论文 | <https://arxiv.org/abs/2606.17046> |
| 代码/项目 | <https://github.com/cvlab-kaist/Geometric-Action-Model> |
| 子类 / 象限 | 三维多视角建模 · 视觉规划与IDM · Q2 · One Model × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.17046) 为准。
...
**本条目的站内价值是把「Geometric Action Model for Robot Policy Learning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_17046_geometric-action-model-for-robot-policy.md`](../../sources/papers/rcl_awesome_wam_2606_17046_geometric-action-model-for-robot-policy.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.17046)
