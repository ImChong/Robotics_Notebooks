...
arxiv: "2503.17973"
venue: "arXiv 2025"
code: https://github.com/Jianghanxiao/PhysTwin
summary: "Physics-informed reconstruction and simulation of deformable objects from videos."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_17973_phystwin-physics-informed-reconstruction.md
...
**PhysTwin: Physics-Informed Reconstruction and Simulation of Deformable Objects from Videos** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 320/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.17973> |
| 代码/项目 | <https://github.com/Jianghanxiao/PhysTwin> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.17973) 为准。
...
**这一页能给你的是「PhysTwin」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2503_17973_phystwin-physics-informed-reconstruction.md`](../../sources/papers/sun_awesome_wm_2503_17973_phystwin-physics-informed-reconstruction.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.17973)
