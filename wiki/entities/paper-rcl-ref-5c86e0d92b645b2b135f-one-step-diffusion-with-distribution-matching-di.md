...
updated: 2026-09-25
venue: "CVPR 2024"
summary: "RCL Awesome WAM 清单收录（Foundational work）；细节以原文 PDF / 项目页为准。"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_5c86e0d92b645b2b135f_one-step-diffusion-with-distribution-mat.md
...
**One-step Diffusion with Distribution Matching Distillation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 171/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

RCL Awesome WAM 清单收录（Foundational work）；细节以原文 PDF / 项目页为准。
...
|------|------|
| 编号 | 171/564 |
| 分组 | Foundational work |
| 出处 | CVPR 2024 |
| 论文 | <https://openaccess.thecvf.com/content/CVPR2024/html/Yin_One-step_Diffusion_with_Distribution_Matching_Distillation_CVPR_2024_paper.html> |
| 项目页 | <https://tianweiy.github.io/dmd/> |
| 子类 / 象限 | 训练优化与蒸馏 · 扩散与流匹配基础 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openaccess.thecvf.com/content/CVPR2024/html/Yin_One-step_Diffusion_with_Distribution_Matching_Distillation_CVPR_2024_paper.html) 为准。
- 横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/rcl-awesome-wam-technology-map.md) 的 **Foundational work** 分组逐条展开。
...
**本条目的站内价值是把「One-step Diffusion with Distribution Matching Distillation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Foundational work** + Contribution 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/rcl_awesome_wam_ref_5c86e0d92b645b2b135f_one-step-diffusion-with-distribution-mat.md`](../../sources/papers/rcl_awesome_wam_ref_5c86e0d92b645b2b135f_one-step-diffusion-with-distribution-mat.md) — 本条目策展摘录
...
- [原文](https://openaccess.thecvf.com/content/CVPR2024/html/Yin_One-step_Diffusion_with_Distribution_Matching_Distillation_CVPR_2024_paper.html)
