...
updated: 2026-08-10
venue: "ICLR 2026"
summary: "First benchmark quantifying embodied cognition via egocentric interaction world modeling, revealing VLMs perform better on inverse tasks than forward prediction"
related:
...
**ENACT: Evaluating Embodied Cognition with World Modeling of Egocentric Interaction** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 104/249** 篇，分组 **28 Egocentric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First benchmark quantifying embodied cognition via egocentric interaction world modeling, revealing VLMs perform better on inverse tasks than forward prediction
