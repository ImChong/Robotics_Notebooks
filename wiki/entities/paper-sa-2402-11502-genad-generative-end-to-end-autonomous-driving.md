...
summary: "Generative end-to-end autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2402_11502_genad-generative-end-to-end-autonomous-d.md
...
**GenAD: Generative End-to-End Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 438/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2402.11502> |
| 代码/项目 | <https://github.com/wzzheng/GenAD> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2402.11502) 为准。
...
- [`sources/papers/sun_awesome_wm_2402_11502_genad-generative-end-to-end-autonomous-d.md`](../../sources/papers/sun_awesome_wm_2402_11502_genad-generative-end-to-end-autonomous-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2402.11502)
