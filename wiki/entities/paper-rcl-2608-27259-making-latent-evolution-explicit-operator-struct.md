...
updated: 2026-09-25
arxiv: "2608.27259"
summary: "We introduce the Latent Evolution Operator Network (LEON), which models latent evolution in a learned observable space through context-modulated operator-based propagation and additive forcing."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_27259_making-latent-evolution-explicit-operato.md
...
**Making Latent Evolution Explicit: Operator-Structured Transitions for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 422/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce the Latent Evolution Operator Network (LEON), which models latent evolution in a learned observable space through context-modulated operator-based propagation and additive forcing.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.27259> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.27259) 为准。
...
**本条目的站内价值是把「Making Latent Evolution Explicit」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_27259_making-latent-evolution-explicit-operato.md`](../../sources/papers/rcl_awesome_wam_2608_27259_making-latent-evolution-explicit-operato.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.27259)
