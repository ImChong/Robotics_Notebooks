...
> 来源归档（ingest · awesome-bfm-papers 第 29/41）

- **标题：** Exploration by Random Network Distillation
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 内在奖励探索经典；身体预训练常需自发现新状态。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 03 Intrinsic reward 预训练，编号 **29/41**。
- **公众号导读要点：** 内在奖励探索经典；身体预训练常需自发现新状态。
