...
- **代码：** <https://github.com/openai/safety-gym>
- **清单摘要：** Environments for benchmarking constrained and safe-exploration RL.
- **沉淀到 wiki：** [`wiki/entities/painode-322-safetygymopenai.md`](../../wiki/entities/painode-322-safetygymopenai.md)
...
- 实体页：[`wiki/entities/painode-322-safetygymopenai.md`](../../wiki/entities/painode-322-safetygymopenai.md)
