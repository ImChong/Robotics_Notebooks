...
sources:
  - ../../sources/papers/sun_awesome_touch_2508_01361_vlh-vision-language-haptics-foundation-m.md
...
**VLH: Vision-Language-Haptics Foundation Model** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 019/065** 篇，分组 **22 Tactile-Enhanced VLA with Foundation Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unifies perception, language, and tactile feedback in aerial robotics and VR; processes visual inputs and language instructions via fine-tuned OpenVLA backbone; achieves 56.7% success for target acquisition and 100% accuracy in texture discrimination.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.01361> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.01361) 为准。
...
**本条目的站内价值是把「VLH」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2508_01361_vlh-vision-language-haptics-foundation-m.md`](../../sources/papers/sun_awesome_touch_2508_01361_vlh-vision-language-haptics-foundation-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2508.01361)
