...
type: entity
tags: [paper, humanoid, amp, motion-prior, adversarial-imitation, nvidia]
status: complete
updated: 2026-06-11
venue: curated
summary: "Kimodo 不是机器人控制论文，但它应该放在这里。"
related:
...
**Kimodo** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 04/19** 篇，归类为 **01 分布约束与先验组件化**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_04_kimodo_scaling_controllable_human_motion_generat.md](../../sources/papers/humanoid_amp_survey_04_kimodo_scaling_controllable_human_motion_generat.md)
