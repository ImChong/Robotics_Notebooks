...
PAGE_INSTITUTION_OVERRIDES: dict[str, list[str]] = {
    ...
    "wiki/entities/act-aloha.md": ["stanford"],
    "wiki/entities/almi-open.md": ["linux-foundation"],
    "wiki/entities/beyondmimic-reproduction.md": ["linux-foundation"],
    "wiki/entities/calvin-benchmark.md": ["linux-foundation"],
    "wiki/entities/cleanrl.md": ["linux-foundation"],
    "wiki/entities/coppeliasim.md": ["linux-foundation"],
    "wiki/entities/droid-policy-learning.md": ["berkeley"],
    "wiki/entities/engineai-native-sdk.md": ["engineai"],
    "wiki/entities/engineai-rl-lab.md": ["engineai"],
    "wiki/entities/foxglove-studio.md": ["linux-foundation"],
    "wiki/entities/gazebo-sim.md": ["open-robotics"],
    "wiki/entities/holoagent.md": ["horizon-robotics"],
    "wiki/entities/humanoid-bench.md": ["berkeley"],
    "wiki/entities/hydra-config.md": ["meta"],
    "wiki/entities/instinct-onboard.md": ["tsinghua", "shanghai-pil", "unitree"],
    "wiki/entities/instinct-rl.md": ["tsinghua", "shanghai-pil"],
    "wiki/entities/instinctlab.md": ["tsinghua", "shanghai-pil"],
    "wiki/entities/internrobotics.md": ["shanghai-ai-lab"],
    "wiki/entities/isaac-gym-envs.md": ["nvidia"],
    "wiki/entities/legged-lab-dwaq.md": ["unitree"],
    "wiki/entities/libero-benchmark.md": ["linux-foundation"],
    "wiki/entities/loco-mujoco.md": ["linux-foundation"],
    "wiki/entities/mc-rtc.md": ["inria"],
    "wiki/entities/mcap-log-format.md": ["linux-foundation"],
    "wiki/entities/mimicgen.md": ["nvidia"],
    "wiki/entities/mink-ik.md": ["linux-foundation"],
    "wiki/entities/mlflow.md": ["linux-foundation"],
    "wiki/entities/mos9-open-source-humanoid.md": ["linux-foundation"],
    "wiki/entities/mujoco-menagerie.md": ["google-deepmind"],
    "wiki/entities/ocs2.md": ["eth"],
    "wiki/entities/omnigibson.md": ["stanford"],
    "wiki/entities/openpi.md": ["physical-intelligence"],
    "wiki/entities/osqp.md": ["linux-foundation"],
    "wiki/entities/pink-ik.md": ["inria"],
    "wiki/entities/prime-system-id.md": ["linux-foundation"],
    "wiki/entities/proxsuite.md": ["inria"],
    "wiki/entities/pulse-physics.md": ["linux-foundation"],
    "wiki/entities/raisim.md": ["linux-foundation"],
    "wiki/entities/rerun-io.md": ["linux-foundation"],
    "wiki/entities/rl-games.md": ["linux-foundation"],
    "wiki/entities/rlbench.md": ["linux-foundation"],
    "wiki/entities/robomimic.md": ["stanford"],
    "wiki/entities/roboparty-train.md": ["roboparty"],
    "wiki/entities/robosuite.md": ["stanford"],
    "wiki/entities/robot-descriptions-py.md": ["linux-foundation"],
    "wiki/entities/ros2-control.md": ["open-robotics"],
    "wiki/entities/simtoolreal.md": ["linux-foundation"],
    "wiki/entities/skrl.md": ["linux-foundation"],
    "wiki/entities/stable-baselines3.md": ["linux-foundation"],
    "wiki/entities/trackerlab.md": ["linux-foundation"],
    "wiki/entities/webots.md": ["linux-foundation"],
    "wiki/entities/wham-world-human-motion.md": ["linux-foundation"],
    "wiki/entities/worldarena.md": ["tsinghua"],
