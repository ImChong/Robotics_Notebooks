...
sources:
  - ../../sources/papers/sun_awesome_touch_2603_23481_vtam-video-tactile-action-models-for-com.md
...
**VTAM: Video-Tactile-Action Models for Complex Physical Interaction Beyond VLAs** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 058/065** 篇，分组 **Tactile World Action Models WAM**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Visuo-tactile world action model integrating high-resolution tactile sensing with visual observations within predictive video backbone for robust contact-rich manipulation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.23481) 为准。
...
**本条目的站内价值是把「VTAM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2603_23481_vtam-video-tactile-action-models-for-com.md`](../../sources/papers/sun_awesome_touch_2603_23481_vtam-video-tactile-action-models-for-com.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.23481)
