...
- **计划笔记路径：** `papers/07_Teleoperation/child-controller-for-humanoid-imitation-and-live/child-controller-for-humanoid-imitation-and-live.md`
- **分类：** 07_Teleoperation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-child-controller-for-humanoid-imitation-and-live](../../wiki/entities/paper-notebook-child-controller-for-humanoid-imitation-and-live.md).

## 对 wiki 的映射

- [paper-notebook-child-controller-for-humanoid-imitation-and-live](../../wiki/entities/paper-notebook-child-controller-for-humanoid-imitation-and-live.md)
