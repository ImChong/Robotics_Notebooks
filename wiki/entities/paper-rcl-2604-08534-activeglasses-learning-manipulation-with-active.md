...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_08534_activeglasses-learning-manipulation-with.md
...
**ActiveGlasses: Learning Manipulation with Active Vision from Ego-centric Human Demonstration** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 095/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2604.08534> |
| 子类 / 象限 | 数据集与数据采集 · 人类第一视角数据 · 数据采集接口 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.08534) 为准。
...
**本条目的站内价值是把「ActiveGlasses」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_08534_activeglasses-learning-manipulation-with.md`](../../sources/papers/rcl_awesome_wam_2604_08534_activeglasses-learning-manipulation-with.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.08534)
