...
status: complete
updated: 2026-09-20
summary: "Science Robotics result combining proprioceptive and exteroceptive teachers for robust real-world transfer."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/repos/pai_awesome_paper_335_learning-robust-perceptive-locomotio.md
...
# Learning Robust Perceptive Locomotion (Miki et al.)

**Learning Robust Perceptive Locomotion (Miki et al.)** 收录于 awesome-physical-ai（natnew）**第 335/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Science Robotics result combining proprioceptive and exteroceptive teachers for robust real-world transfer.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://leggedrobotics.github.io/rl-perceptiveloco/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://leggedrobotics.github.io/rl-perceptiveloco/) 为准。
...
**本条目的站内价值是把「Learning Robust Perceptive Locomotion (Miki et al.)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Sim-to-Real**，来源 natnew。
...
- [`sources/repos/pai_awesome_paper_335_learning-robust-perceptive-locomotio.md`](../../sources/repos/pai_awesome_paper_335_learning-robust-perceptive-locomotio.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://leggedrobotics.github.io/rl-perceptiveloco/)
