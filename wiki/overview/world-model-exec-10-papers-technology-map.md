...
> **本页定位**：为 [具身智能小站 · 10 篇盘点](https://mp.weixin.qq.com/s/NJ6M3CnsmDrtu9baRo8lgQ)（2026-08-19）提供 **按四类问题组织的阅读坐标**；不复述每篇方法细节。姊妹近期盘点见 [接触–预测–适应（2026-08-18）](./contact-predict-adapt-10-papers-technology-map.md)、[世界模型与长期记忆（2026-08-21）](./world-model-memory-8-papers-technology-map.md)、[9 篇 WAM/控制（2026-08-17）](../../sources/blogs/wechat_embodied_station_9_papers_2026-08-17.md)。
...
- 站内 **4 篇已有 complete 详情节点**（HumanoidVLN、SMPC2RL、G0.5、Hand Visibility），本专辑 **新建 6 个独立 `paper-*` 页 + 一张横切面**；**同一 arXiv 不重复造页**。
