...
- **标题：** AMOR: Adaptive Character Control through Multi-Objective Reinforcement Learning
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/amor-adaptive-character-control-through-multi-ob/amor-adaptive-character-control-through-multi-ob.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-amor-adaptive-character-control-through-multi-ob](../../wiki/entities/paper-notebook-amor-adaptive-character-control-through-multi-ob.md).

## 对 wiki 的映射

- [paper-notebook-amor-adaptive-character-control-through-multi-ob](../../wiki/entities/paper-notebook-amor-adaptive-character-control-through-multi-ob.md)
