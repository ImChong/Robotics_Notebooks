...
summary: "Xiaomi's unified embodied synthesis with a world foundation model."
related:
...
**Xiaomi-Robotics-U0: Unified Embodied Synthesis with World Foundation Model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 273/571** 篇，分组 **811 Foundation Embodied World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Xiaomi's unified embodied synthesis with a world foundation model.
...
| 代码/项目 | <https://github.com/XiaomiRobotics/Xiaomi-Robotics-U0> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.11643) 为准。
...
**本条目的站内价值是把「Xiaomi-Robotics-U0」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [原文](https://arxiv.org/abs/2607.11643)
