...
arxiv: "2602.00440"
venue: "arXiv 2026"
summary: "Training-free adaptive inference for autoregressive world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_00440_disk-dynamic-inference-skipping-for-worl.md
...
**DISK: Dynamic Inference SKipping for World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 014/571** 篇，分组 **103 Efficient & Real-Time Inference**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Training-free adaptive inference for autoregressive world models.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.00440> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.00440) 为准。
...
**本条目的站内价值是把「DISK」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2602_00440_disk-dynamic-inference-skipping-for-worl.md`](../../sources/papers/sun_awesome_wm_2602_00440_disk-dynamic-inference-skipping-for-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.00440)
