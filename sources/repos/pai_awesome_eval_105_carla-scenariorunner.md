...
- **代码：** <https://github.com/carla-simulator/scenario_runner>
- **清单摘要：** Scenario-based closed-loop evaluation harness for safety-critical driving behaviors.
- **沉淀到 wiki：** [`wiki/entities/painode-105-carlascenariorunner.md`](../../wiki/entities/painode-105-carlascenariorunner.md)
...
- 实体页：[`wiki/entities/painode-105-carlascenariorunner.md`](../../wiki/entities/painode-105-carlascenariorunner.md)
