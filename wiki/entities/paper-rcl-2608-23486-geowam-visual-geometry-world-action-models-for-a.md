...
updated: 2026-09-25
arxiv: "2608.23486"
summary: "Building on this insight, we introduce \\textbf{GeoWAM}, a visual geometry world action model for autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_23486_geowam-visual-geometry-world-action-mode.md
...
**GeoWAM: Visual Geometry World Action Models for Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 371/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Building on this insight, we introduce \textbf{GeoWAM}, a visual geometry world action model for autonomous driving.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.23486> |
| 项目页 | <https://yiren-lu.com/project_pages/geowam/> |
| 子类 / 象限 | 三维多视角建模 · 自动驾驶 · 视觉规划与IDM · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.23486) 为准。
...
**本条目的站内价值是把「GeoWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_23486_geowam-visual-geometry-world-action-mode.md`](../../sources/papers/rcl_awesome_wam_2608_23486_geowam-visual-geometry-world-action-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.23486)
