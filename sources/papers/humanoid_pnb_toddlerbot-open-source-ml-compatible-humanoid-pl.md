...
- **标题：** ToddlerBot: Open-Source ML-Compatible Humanoid Platform for Loco-Manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/toddlerbot-open-source-ml-compatible-humanoid-pl/toddlerbot-open-source-ml-compatible-humanoid-pl.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-toddlerbot-open-source-ml-compatible-humanoid-pl](../../wiki/entities/paper-notebook-toddlerbot-open-source-ml-compatible-humanoid-pl.md).

## 对 wiki 的映射

- [paper-notebook-toddlerbot-open-source-ml-compatible-humanoid-pl](../../wiki/entities/paper-notebook-toddlerbot-open-source-ml-compatible-humanoid-pl.md)
