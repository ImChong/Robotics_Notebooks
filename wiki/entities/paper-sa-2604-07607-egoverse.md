...
**EgoVerse** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 202/249** 篇，分组 **Embodied VLA Evaluation Benchmarks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.07607) 为准。
...
**本条目的站内价值是把「EgoVerse」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [原文](https://arxiv.org/abs/2604.07607)
