...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/hitter-a-humanoid-table-tennis-robot-via-hierarc/hitter-a-humanoid-table-tennis-robot-via-hierarc.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2508.21043>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-loco-manip-161-111-hitter](../../wiki/entities/paper-loco-manip-161-111-hitter.md).

## 对 wiki 的映射

- [paper-loco-manip-161-111-hitter](../../wiki/entities/paper-loco-manip-161-111-hitter.md)
