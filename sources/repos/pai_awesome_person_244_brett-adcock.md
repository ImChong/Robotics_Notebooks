...
- **代码：** 未在清单中标注
- **清单摘要：** Figure CEO. Humanoid robotics at scale.
- **沉淀到 wiki：** [`wiki/entities/painode-244-brettadcock.md`](../../wiki/entities/painode-244-brettadcock.md)
...
- 实体页：[`wiki/entities/painode-244-brettadcock.md`](../../wiki/entities/painode-244-brettadcock.md)
