...
updated: 2026-09-25
arxiv: "2608.26200"
summary: "We introduce GameWAM, to our knowledge the first WAM for native closed-loop gameplay and GUI control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_26200_gamewam-a-world-action-model-for-video-g.md
...
**GameWAM: A World Action Model for Video Games** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 365/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce GameWAM, to our knowledge the first WAM for native closed-loop gameplay and GUI control.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.26200> |
| 项目页 | <https://yunncheng.github.io/GameWAM/> |
| 子类 / 象限 | 联合视频动作建模 · 记忆与长时序 · Q3 · Dual-system × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.26200) 为准。
...
**本条目的站内价值是把「GameWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_26200_gamewam-a-world-action-model-for-video-g.md`](../../sources/papers/rcl_awesome_wam_2608_26200_gamewam-a-world-action-model-for-video-g.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.26200)
