...
- **标题：** HumanoidVerse: A Versatile Humanoid for Vision-Language Guided Multi-Object Rearrangement
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/humanoidverse-a-versatile-humanoid-for-vision-la/humanoidverse-a-versatile-humanoid-for-vision-la.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2508.16943>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-humanoidverse](../../wiki/entities/paper-notebook-humanoidverse.md).

## 对 wiki 的映射

- [paper-notebook-humanoidverse](../../wiki/entities/paper-notebook-humanoidverse.md)
...
- 论文：<https://arxiv.org/abs/2508.16943>
