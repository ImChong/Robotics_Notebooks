...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2512_17853_anytask-an-automated-task-and-data-gener.md
...
**AnyTask: An Automated Task and Data Generation Framework for Advancing Sim-to-Real Policy Learning** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 054/063** 篇，分组 **Benchmarks Simulators & Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces three AnyTask agents for generating expert demonstrations, trains behavior cloning policies on generated data, validates them in simulation, and deploys them directly on real robot hardware
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2512.17853> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.17853) 为准。
...
**本条目的站内价值是把「AnyTask」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2512_17853_anytask-an-automated-task-and-data-gener.md`](../../sources/papers/sun_awesome_r2s2r_2512_17853_anytask-an-automated-task-and-data-gener.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.17853)
