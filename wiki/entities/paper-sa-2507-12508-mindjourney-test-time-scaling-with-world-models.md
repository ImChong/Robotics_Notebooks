...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2507_12508_mindjourney-test-time-scaling-with-world.md
...
**MindJourney: Test-Time Scaling with World Models for Spatial Reasoning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 350/571** 篇，分组 **813 Navigation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | 813 Navigation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2507.12508> |
| 项目页 | <https://umass-embodied-agi.github.io/MindJourney> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.12508) 为准。
...
**本条目的站内价值是把「MindJourney」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2507_12508_mindjourney-test-time-scaling-with-world.md`](../../sources/papers/sun_awesome_wm_2507_12508_mindjourney-test-time-scaling-with-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.12508)
