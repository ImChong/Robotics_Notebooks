...
- **标题：** Embodied Chain of Action Reasoning with Multi-Modal Foundation Model for Humanoid Loco-manipulation
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/[website],Embodied_Chain_of_Action_Reasoning_with_Multi-Modal_Foundation_Model_f/[website],Embodied_Chain_of_Action_Reasoning_with_Multi-Modal_Foundation_Model_f.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-website-embodied-chain-of-action-reasoning-with](../../wiki/entities/paper-notebook-website-embodied-chain-of-action-reasoning-with.md).

## 对 wiki 的映射

- [paper-notebook-website-embodied-chain-of-action-reasoning-with](../../wiki/entities/paper-notebook-website-embodied-chain-of-action-reasoning-with.md)
