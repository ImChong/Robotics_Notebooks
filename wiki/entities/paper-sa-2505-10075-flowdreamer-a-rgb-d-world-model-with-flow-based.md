...
arxiv: "2505.10075"
venue: "arXiv 2025"
code: https://github.com/sharinka0715/FlowDreamer/
summary: "RGB-D world model with flow-based motion representations for robot manipulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2505_10075_flowdreamer-a-rgb-d-world-model-with-flo.md
...
**FlowDreamer: A RGB-D World Model with Flow-based Motion Representations for Robot Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 297/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

RGB-D world model with flow-based motion representations for robot manipulation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.10075> |
| 代码/项目 | <https://github.com/sharinka0715/FlowDreamer/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.10075) 为准。
...
**这一页能给你的是「FlowDreamer」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2505_10075_flowdreamer-a-rgb-d-world-model-with-flo.md`](../../sources/papers/sun_awesome_wm_2505_10075_flowdreamer-a-rgb-d-world-model-with-flo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.10075)
