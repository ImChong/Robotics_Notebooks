...
**GigaWorld-Policy** 是 [极佳视界](https://github.com/open-gigaai) 公开的 **VLA/操作模型** 开源项目：以动作和环境变化的联合表征训练机器人策略，使世界模型不仅生成未来画面，也为动作选择提供表征；适合研究GigaWorld世界生成能力怎样转成可执行控制信号。
...
| 机构 | 极佳视界 |
| 类别 | VLA/操作模型 |
| 官方组织 | https://github.com/open-gigaai |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `GigaWorld-Policy` 仓库并核对 README 许可与依赖。
...
- [极佳视界 官方组织](https://github.com/open-gigaai)
