...
sources:
  - ../../sources/repos/engineai-rl-lab.md
  - ../../sources/repos/humanoid-motion-intelligence.md
  - ../../sources/repos/engineai_rl_lab.md
---

# engineai_rl_lab

[engineai_rl_lab](https://github.com/engineai-robotics/engineai_rl_lab) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「动作跟踪与全身控制」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

单段参考轨迹进入Isaac Lab的PPO跟踪任务，PM01与T800配置特权Critic、失败片段采样和全身奖励。T800额外随机化执行延迟，导出的MNN策略可接配套SDK，但仓库没有VAE与扩散阶段。
...
|------|------|
| 主表分组 | 动作跟踪与全身控制 |
| 官方入口 | https://github.com/engineai-robotics/engineai_rl_lab |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["engineai_rl_lab"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [engineai_rl_lab 源码归档](../../sources/repos/engineai_rl_lab.md)（<https://github.com/engineai-robotics/engineai_rl_lab>）

- [engineai_rl_lab 来源归档](../../sources/repos/engineai-rl-lab.md)
