...
updated: 2026-09-25
arxiv: "2605.06222"
summary: "In this work, we formulate adaptive WAM execution as a future-reality verification problem: the robot should execute longer when the WAM-predicted future remains reliable, and replan earlier when reality deviates from im"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_06222_when-to-trust-imagination-adaptive-actio.md
...
**When to Trust Imagination: Adaptive Action Execution for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 541/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this work, we formulate adaptive WAM execution as a future-reality verification problem: the robot should execute longer when the WAM-predicted future remains reliable, and replan earlier when reality deviates from imagination. To this end, we propose Future Forward Dynamics Causal Attention (FFDC), a lightweight...
...
| 子类 / 象限 | 记忆与长时序 · 高效推理与实时控制 · 策略后训练与WM-RL · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.06222) 为准。
...
**本条目的站内价值是把「When to Trust Imagination」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_06222_when-to-trust-imagination-adaptive-actio.md`](../../sources/papers/rcl_awesome_wam_2605_06222_when-to-trust-imagination-adaptive-actio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.06222)
