...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2501_11260_a-survey-of-world-models-for-autonomous.md
...
**A Survey of World Models for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 533/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Comprehensive survey of world models for autonomous driving, covering methods from video generation to 4D occupancy forecasting.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2501.11260> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.11260) 为准。
...
**本条目的站内价值是把「A Survey of World Models for Autonomous Driving」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2501_11260_a-survey-of-world-models-for-autonomous.md`](../../sources/papers/sun_awesome_wm_2501_11260_a-survey-of-world-models-for-autonomous.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.11260)
