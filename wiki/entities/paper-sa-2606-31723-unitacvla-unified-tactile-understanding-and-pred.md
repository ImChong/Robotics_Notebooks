...
sources:
  - ../../sources/papers/sun_awesome_touch_2606_31723_unitacvla-unified-tactile-understanding.md
...
**UniTacVLA: Unified Tactile Understanding and Prediction in Vision Language Action Models** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 013/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified tactile learning framework modeling tactile signals as dynamic interaction cues for both contact understanding and prediction; introduces tactile-action mixed controller.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.31723) 为准。
...
**本条目的站内价值是把「UniTacVLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2606_31723_unitacvla-unified-tactile-understanding.md`](../../sources/papers/sun_awesome_touch_2606_31723_unitacvla-unified-tactile-understanding.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.31723)
