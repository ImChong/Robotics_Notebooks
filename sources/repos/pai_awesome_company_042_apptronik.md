...
- **代码：** 未在清单中标注
- **清单摘要：** Humanoid robotics company building Apollo for industrial applications.
- **沉淀到 wiki：** [`wiki/entities/painode-042-apptronik.md`](../../wiki/entities/painode-042-apptronik.md)
...
- 实体页：[`wiki/entities/painode-042-apptronik.md`](../../wiki/entities/painode-042-apptronik.md)
