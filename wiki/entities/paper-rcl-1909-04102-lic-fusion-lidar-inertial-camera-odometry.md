...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1909_04102_lic-fusion-lidar-inertial-camera-odometr.md
...
**LIC-Fusion: LiDAR-Inertial-Camera Odometry** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 209/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | IROS 2019 |
| 论文 | <https://ieeexplore.ieee.org/document/8967746/> |
| 子类 / 象限 | 三维表示与状态估计 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/8967746/) 为准。
...
**本条目的站内价值是把「LIC-Fusion」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1909_04102_lic-fusion-lidar-inertial-camera-odometr.md`](../../sources/papers/rcl_awesome_wam_1909_04102_lic-fusion-lidar-inertial-camera-odometr.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/8967746/)
