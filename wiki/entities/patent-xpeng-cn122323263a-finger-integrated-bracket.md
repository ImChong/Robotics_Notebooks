...
summary: "小鹏 IRON CN122323263A：三支架一体成型的手指双向驱动关节（2026-07-03 公开/公告）；连接/减速器/安装支架一体成型，抓取与侧摆分别采用蜗轮蜗杆，降低多零件装配累积误差。…"
---

# 小鹏 IRON · 三支架一体成型的手指双向驱动关节（CN122323263A）

专利 **CN122323263A**（*三支架一体成型的手指双向驱动关节*，小鹏机器人 / IRON 相关布局，2026-07-03）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**连接/减速器/安装支架一体成型，抓取与侧摆分别采用蜗轮蜗杆，降低多零件装配累积误差。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN122323263A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn122323263a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN122323263A](https://patents.google.com/patent/CN122323263A/zh)
