...
sources:
  - ../../sources/papers/sun_awesome_touch_2511_11456_simtac-a-physics-based-simulator-for-vis.md
...
**SimTac: A Physics-Based Simulator for Vision-Based Tactile Sensing with Biomorphic Structures** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 049/065** 篇，分组 **Tactile Simulation & Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Particle-based deformation modeling, light-field rendering for photorealistic tactile image generation, and neural network for predicting mechanical responses.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2511.11456> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.11456) 为准。
...
**本条目的站内价值是把「SimTac」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2511_11456_simtac-a-physics-based-simulator-for-vis.md`](../../sources/papers/sun_awesome_touch_2511_11456_simtac-a-physics-based-simulator-for-vis.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.11456)
