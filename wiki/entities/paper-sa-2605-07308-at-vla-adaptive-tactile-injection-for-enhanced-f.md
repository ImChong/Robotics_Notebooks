...
sources:
  - ../../sources/papers/sun_awesome_touch_2605_07308_at-vla-adaptive-tactile-injection-for-en.md
...
**AT-VLA: Adaptive Tactile Injection for Enhanced Feedback Reaction in Vision-Language-Action Models** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 001/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Adaptive tactile injection strategy for enhanced feedback reaction in VLA models; dynamically determines timing and locations for tactile injection.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.07308) 为准。
...
**本条目的站内价值是把「AT-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2605_07308_at-vla-adaptive-tactile-injection-for-en.md`](../../sources/papers/sun_awesome_touch_2605_07308_at-vla-adaptive-tactile-injection-for-en.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.07308)
