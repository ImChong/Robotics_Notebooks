...
**noetix_n2_gym** 是 [松延动力](https://github.com/Noetix-Robotics) 公开的 **运动RL/技能训练** 开源项目：为N2人形机器人提供Isaac Gym训练环境、动作加载、AMP和Sim2Sim工具。
...
1. 从官方 GitHub/Gitee 组织检索 `noetix_n2_gym` 仓库并核对 README 许可与依赖。
