...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/trajbooster-boosting-humanoid-whole-body-manipul/trajbooster-boosting-humanoid-whole-body-manipul.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2509.11839>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-trajbooster](../../wiki/entities/paper-notebook-trajbooster.md).

## 对 wiki 的映射

- [paper-notebook-trajbooster](../../wiki/entities/paper-notebook-trajbooster.md)
...
- 论文：<https://arxiv.org/abs/2509.11839>
