...
sources:
  - ../../sources/papers/sun_awesome_ego_2406_11816_videollm-online-online-video-large-langu.md
...
**VideoLLM-online: Online Video Large Language Model for Streaming Video** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 151/249** 篇，分组 **294 Real-time Streaming & Proactive Interaction**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Online video LLM framework designed for streaming egocentric video input
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.11816) 为准。
...
**本条目的站内价值是把「VideoLLM-online」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2406_11816_videollm-online-online-video-large-langu.md`](../../sources/papers/sun_awesome_ego_2406_11816_videollm-online-online-video-large-langu.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.11816)
