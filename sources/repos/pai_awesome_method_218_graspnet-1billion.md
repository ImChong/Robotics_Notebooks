...
- **代码：** 未在清单中标注
- **清单摘要：** Large-scale benchmark and dataset for robust 6-DoF grasp planning.
- **沉淀到 wiki：** [`wiki/entities/painode-218-graspnet1billion.md`](../../wiki/entities/painode-218-graspnet1billion.md)
...
- 实体页：[`wiki/entities/painode-218-graspnet1billion.md`](../../wiki/entities/painode-218-graspnet1billion.md)
