...
status: complete
updated: 2026-05-26
summary: "TeamHOI 做的是多 humanoid 协作搬运。"
related:
...
**TeamHOI** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 17/19** 篇，归类为 **04 交互与长时程**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_17_teamhoi_learning_a_unified_policy_for_cooperativ.md](../../sources/papers/humanoid_amp_survey_17_teamhoi_learning_a_unified_policy_for_cooperativ.md)
