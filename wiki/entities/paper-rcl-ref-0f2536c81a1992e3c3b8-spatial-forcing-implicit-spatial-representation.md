...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_0f2536c81a1992e3c3b8_spatial-forcing-implicit-spatial-represe.md
...
**Spatial Forcing: Implicit Spatial Representation Alignment for Vision-Language-Action Model** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 254/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | VLA |
| 出处 | ICLR 2026 |
| 论文 | <https://openreview.net/forum?id=euMVC1DO4k> |
| 子类 / 象限 | VLA后训练与数据增强 · 空间感知增强VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=euMVC1DO4k) 为准。
...
**本条目的站内价值是把「Spatial Forcing」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_0f2536c81a1992e3c3b8_spatial-forcing-implicit-spatial-represe.md`](../../sources/papers/rcl_awesome_wam_ref_0f2536c81a1992e3c3b8_spatial-forcing-implicit-spatial-represe.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=euMVC1DO4k)
