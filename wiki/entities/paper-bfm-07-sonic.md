...
arxiv: "2511.07820"
venue: "2025 · arXiv"
summary: "supersizing motion tracking；运控基座被上层调用前底层动作覆盖面必须足够宽。"
related:
...
**Sonic** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 07/41** 篇，归类为 **02 Goal-conditioned 学习**（2025 · arXiv）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_sonic_arxiv_2511_07820.md](../../sources/papers/bfm_awesome_sonic_arxiv_2511_07820.md)
