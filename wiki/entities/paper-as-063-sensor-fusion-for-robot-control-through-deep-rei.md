...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_063_sensor-fusion-for-robot-control-through.md
...
**Sensor fusion for robot control through deep reinforcement learning** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 063/139** 篇，分组 **Observation / Sensor Fusion**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 论文 | <https://ieeexplore.ieee.org/document/8206048> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/8206048) 为准。
...
**本条目的站内价值是把「Sensor fusion for robot control through deep reinforcement learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_063_sensor-fusion-for-robot-control-through.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_063_sensor-fusion-for-robot-control-through.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/8206048)
