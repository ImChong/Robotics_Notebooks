...
**Ego-Pi** 收录于 [具身智能研究室 · Loco-Manip 8 篇周报](https://mp.weixin.qq.com/s/Ez87ljBYmCyIpLKjMjEyaQ) **第 01/8** 篇，归类为 **01 第一视角数据**。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 人类 ego 与机器人数据共微调 Pi0.5：语义与动作分工，避免硬拷贝人类轨迹。
