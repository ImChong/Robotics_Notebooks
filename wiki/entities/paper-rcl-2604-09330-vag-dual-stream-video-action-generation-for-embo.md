...
arxiv: "2604.09330"
venue: "2026"
summary: "VAG synthesizes robot videos and action sequences from an initial image and instruction. A video diffusion transformer supplies pooled clean-latent predictions to an action U-Net during synchronized denoising. The eviden"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_09330_vag-dual-stream-video-action-generation.md
...
**VAG: Dual-Stream Video-Action Generation for Embodied Data Synthesis** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 512/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VAG synthesizes robot videos and action sequences from an initial image and instruction. A video diffusion transformer supplies pooled clean-latent predictions to an action U-Net during synchronized denoising. The evidence supports improved action prediction and simulation replay, plus a small real-robot policy-pret...
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.09330) 为准。
...
**本条目的站内价值是把「VAG」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_09330_vag-dual-stream-video-action-generation.md`](../../sources/papers/rcl_awesome_wam_2604_09330_vag-dual-stream-video-action-generation.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.09330)
