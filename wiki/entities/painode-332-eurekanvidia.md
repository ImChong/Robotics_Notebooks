...
status: complete
updated: 2026-09-20
summary: "LLM-driven reward design that enables sim-to-real transfer for dexterous skills."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/repos/pai_awesome_paper_332_eureka-nvidia.md
...
**Eureka (NVIDIA)** 收录于 awesome-physical-ai（natnew）**第 332/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

LLM-driven reward design that enables sim-to-real transfer for dexterous skills.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://eureka-research.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://eureka-research.github.io/) 为准。
...
**本条目的站内价值是把「Eureka (NVIDIA)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/repos/pai_awesome_paper_332_eureka-nvidia.md`](../../sources/repos/pai_awesome_paper_332_eureka-nvidia.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://eureka-research.github.io/)
