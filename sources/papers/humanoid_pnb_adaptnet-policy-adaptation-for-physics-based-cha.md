...
- **标题：** AdaptNet: Policy Adaptation for Physics-Based Character Control
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/adaptnet-policy-adaptation-for-physics-based-cha/adaptnet-policy-adaptation-for-physics-based-cha.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-adaptnet-policy-adaptation-for-physics-based-cha](../../wiki/entities/paper-notebook-adaptnet-policy-adaptation-for-physics-based-cha.md).

## 对 wiki 的映射

- [paper-notebook-adaptnet-policy-adaptation-for-physics-based-cha](../../wiki/entities/paper-notebook-adaptnet-policy-adaptation-for-physics-based-cha.md)
