...
**RynnVLA-002: A Unified Vision-Language-Action and World Model** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 470/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.17502) 为准。
...
**本条目的站内价值是把「RynnVLA-002」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2511_17502_rynnvla-002-a-unified-vision-language-ac.md`](../../sources/papers/rcl_awesome_wam_2511_17502_rynnvla-002-a-unified-vision-language-ac.md) — 本条目策展摘录
