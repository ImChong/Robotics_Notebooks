...
arxiv: "2602.17259"
venue: "arXiv 2026"
summary: "Infuses world modeling into generalist policies via multiple future representation alignment."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_17259_frappe-infusing-world-modeling-into-gene.md
...
**FRAPPE: Infusing World Modeling into Generalist Policies via Multiple Future Representation Alignment** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 294/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Infuses world modeling into generalist policies via multiple future representation alignment.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.17259) 为准。
...
**这一页能给你的是「FRAPPE」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2602_17259_frappe-infusing-world-modeling-into-gene.md`](../../sources/papers/sun_awesome_wm_2602_17259_frappe-infusing-world-modeling-into-gene.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.17259)
