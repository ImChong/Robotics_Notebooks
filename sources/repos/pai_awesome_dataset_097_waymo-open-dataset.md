...
- **代码：** 未在清单中标注
- **清单摘要：** Large-scale real-world driving dataset used for perception, motion forecasting, and closed-loop autonomy studies.
- **沉淀到 wiki：** [`wiki/entities/painode-097-waymoopendataset.md`](../../wiki/entities/painode-097-waymoopendataset.md)
...
- 实体页：[`wiki/entities/painode-097-waymoopendataset.md`](../../wiki/entities/painode-097-waymoopendataset.md)
