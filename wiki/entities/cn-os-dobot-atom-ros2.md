...
**dobot_atom_ros2** 是 [越疆科技](https://github.com/embodied-dobot) 公开的 **工程与工具** 开源项目：为ATOM机器人提供ROS2接口，使状态、传感器与执行器进入上层控制和开发工具链。
...
1. 从官方 GitHub/Gitee 组织检索 `dobot_atom_ros2` 仓库并核对 README 许可与依赖。
