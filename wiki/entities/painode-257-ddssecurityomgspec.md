...
status: complete
updated: 2026-09-20
summary: "Reference standard for authenticated, encrypted robot data buses (used by ROS 2)."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_257_dds-security-omg-spec.md
...
# DDS Security (OMG Spec)

**DDS Security (OMG Spec)** 收录于 awesome-physical-ai（natnew）**第 257/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Reference standard for authenticated, encrypted robot data buses (used by ROS 2).
...
|------|------|
| 编号 | 257/384 |
| 分组 | Production Patterns / Reference Architectures |
| 来源清单 | natnew |
| 主链接 | <https://www.omg.org/spec/DDS-SECURITY/> |

## 核心原理

Reference standard for authenticated, encrypted robot data buses (used by ROS 2).

该条目在 Physical AI 清单中的角色是 **resource**，分组 **Production Patterns / Reference Architectures**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.omg.org/spec/DDS-SECURITY/> |
...
- [`sources/repos/pai_awesome_resource_257_dds-security-omg-spec.md`](../../sources/repos/pai_awesome_resource_257_dds-security-omg-spec.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.omg.org/spec/DDS-SECURITY/)
