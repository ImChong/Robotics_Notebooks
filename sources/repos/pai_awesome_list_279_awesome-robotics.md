...
- **代码：** <https://github.com/kiloreux/awesome-robotics>
- **清单摘要：** General robotics resources.
- **沉淀到 wiki：** [`wiki/entities/painode-279-awesomerobotics.md`](../../wiki/entities/painode-279-awesomerobotics.md)
...
- 实体页：[`wiki/entities/painode-279-awesomerobotics.md`](../../wiki/entities/painode-279-awesomerobotics.md)
