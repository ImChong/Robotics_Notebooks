...
**engineai_ros2_workspace** 是 [众擎机器人](https://github.com/engineai-robotics) 公开的 **SDK/驱动** 开源项目：官方 SDK：真机控制与状态读取的统一接入层
...
1. 从官方 GitHub/Gitee 组织检索 `engineai_ros2_workspace` 仓库并核对 README 许可与依赖。
