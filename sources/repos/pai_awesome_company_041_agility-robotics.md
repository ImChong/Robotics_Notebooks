...
- **代码：** 未在清单中标注
- **清单摘要：** Maker of Digit, a bipedal logistics robot deployed in commercial warehouses.
- **沉淀到 wiki：** [`wiki/entities/painode-041-agilityrobotics.md`](../../wiki/entities/painode-041-agilityrobotics.md)
...
- 实体页：[`wiki/entities/painode-041-agilityrobotics.md`](../../wiki/entities/painode-041-agilityrobotics.md)
