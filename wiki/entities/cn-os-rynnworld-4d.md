...
summary: "阿里巴巴 开源项目 RynnWorld-4D（世界模型）：模型联合表达三维空间结构和时间演化，用于预测机器人动作后的场景变化与对象运动；适合作为空间理解、世界生成和规划之间的研究入口。…"
institutions:
  - alibaba
---
...
**RynnWorld-4D** 是 [阿里巴巴](https://github.com/amap-cvlab) 公开的 **世界模型** 开源项目：模型联合表达三维空间结构和时间演化，用于预测机器人动作后的场景变化与对象运动；适合作为空间理解、世界生成和规划之间的研究入口。
...
1. 从官方 GitHub/Gitee 组织检索 `RynnWorld-4D` 仓库并核对 README 许可与依赖。
