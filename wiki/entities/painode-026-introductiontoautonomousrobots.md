...
status: complete
updated: 2026-09-20
summary: "Correll et al. Open-source robotics textbook."
related:
...
sources:
  - ../../sources/repos/pai_awesome_book_026_introduction-to-autonomous-robots.md
...
**Introduction to Autonomous Robots** 收录于 awesome-physical-ai（natnew）**第 026/384** 条，分组 **Books**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Correll et al. Open-source robotics textbook.
...
| 分组 | Books |
| 来源清单 | natnew |
| 主链接 | <https://introduction-to-autonomous-robots.github.io/> |

## 核心原理

Correll et al. Open-source robotics textbook.

该条目在 Physical AI 清单中的角色是 **book**，分组 **Books**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://introduction-to-autonomous-robots.github.io/> |
...
- [`sources/repos/pai_awesome_book_026_introduction-to-autonomous-robots.md`](../../sources/repos/pai_awesome_book_026_introduction-to-autonomous-robots.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://introduction-to-autonomous-robots.github.io/)
