...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2308_04079_3d-gaussian-splatting-for-real-time-radi.md
...
**3D Gaussian Splatting for Real-Time Radiance Field Rendering** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 064/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ACM Transactions on Graphics 42(4), 2023 |
| 论文 | <https://doi.org/10.1145/3592433> |
| 子类 / 象限 | Spatial perception & geometry · 三维表示与状态估计 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://doi.org/10.1145/3592433) 为准。
...
**本条目的站内价值是把「3D Gaussian Splatting for Real-Time Radiance Field Rendering」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2308_04079_3d-gaussian-splatting-for-real-time-radi.md`](../../sources/papers/rcl_awesome_wam_2308_04079_3d-gaussian-splatting-for-real-time-radi.md) — 本条目策展摘录
...
- [原文](https://doi.org/10.1145/3592433)
