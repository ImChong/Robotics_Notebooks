...
status: complete
updated: 2026-09-20
code: https://github.com/labclaw/awesome-physical-ai-for-science
summary: "AI in scientific discovery."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_081_physical-ai-for-science.md
...
**Physical AI for Science** 收录于 awesome-physical-ai（aichr）**第 081/384** 条，分组 **Courses & Tutorials**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
|------|------|
| 编号 | 081/384 |
| 分组 | Courses & Tutorials |
| 来源清单 | aichr |
| 主链接 | <https://github.com/labclaw/awesome-physical-ai-for-science> |
| 代码/仓库 | <https://github.com/labclaw/awesome-physical-ai-for-science> |

## 核心原理

AI in scientific discovery.

该条目在 Physical AI 清单中的角色是 **course**，分组 **Courses & Tutorials**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/labclaw/awesome-physical-ai-for-science> |
| 代码/仓库 | <https://github.com/labclaw/awesome-physical-ai-for-science> |
...
- [`sources/repos/pai_awesome_course_081_physical-ai-for-science.md`](../../sources/repos/pai_awesome_course_081_physical-ai-for-science.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/labclaw/awesome-physical-ai-for-science)
