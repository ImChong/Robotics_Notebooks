...
- **代码：** 未在清单中标注
- **清单摘要：** V-JEPA, research updates from Yann LeCun's team.
- **沉淀到 wiki：** [`wiki/entities/painode-234-metaaiblog.md`](../../wiki/entities/painode-234-metaaiblog.md)
...
- 实体页：[`wiki/entities/painode-234-metaaiblog.md`](../../wiki/entities/painode-234-metaaiblog.md)
