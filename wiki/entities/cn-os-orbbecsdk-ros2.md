...
**OrbbecSDK_ROS2** 是 [奥比中光](https://github.com/orbbec) 公开的 **SDK/驱动** 开源项目：把奥比中光相机接入ROS2，发布图像、深度和相机参数供感知与机器人应用使用。
...
1. 从官方 GitHub/Gitee 组织检索 `OrbbecSDK_ROS2` 仓库并核对 README 许可与依赖。
