...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2601_20540_advancing-open-source-world-models-lingb.md
...
**Advancing Open-source World Models (LingBot-World)** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 071/571** 篇，分组 **42 Visual / Video World Models**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Open-sourced world simulator stemming from video generation with high fidelity and robust dynamics.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.20540) 为准。
...
**这一页能给你的是「Advancing Open-source World Models (LingBot-World)」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2601_20540_advancing-open-source-world-models-lingb.md`](../../sources/papers/sun_awesome_wm_2601_20540_advancing-open-source-world-models-lingb.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.20540)
