...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2607_02205_actuator-reality-shaping-for-zero-shot-s.md
...
**Actuator Reality Shaping for Zero-Shot Sim-to-Real Robot Learning** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 007/063** 篇，分组 **22 Zero-Shot Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Shapes the closed-loop behavior of physical actuators to match idealized second-order reference dynamics used in simulation. Offers an alternative to making simulators more realistic by shaping reality to match simulation
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.02205) 为准。
...
**本条目的站内价值是把「Actuator Reality Shaping for Zero-Shot Sim-to-Real Robot Learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2607_02205_actuator-reality-shaping-for-zero-shot-s.md`](../../sources/papers/sun_awesome_r2s2r_2607_02205_actuator-reality-shaping-for-zero-shot-s.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.02205)
