...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2502_17894_fetchbot-learning-generalizable-object-f.md
...
**FetchBot: Learning Generalizable Object Fetching in Cluttered Scenes via Zero-Shot Sim2Real** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 010/063** 篇，分组 **22 Zero-Shot Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces FetchBot, a sim-to-real framework for object fetching in cluttered scenes. Curates a large-scale synthetic dataset featuring 1M diverse scenes and 500k representative demonstrations
...
| 出处 | Proceedings of MLR 2025 |
| 论文 | <https://arxiv.org/abs/2502.17894> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.17894) 为准。
...
**本条目的站内价值是把「FetchBot」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2502_17894_fetchbot-learning-generalizable-object-f.md`](../../sources/papers/sun_awesome_r2s2r_2502_17894_fetchbot-learning-generalizable-object-f.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.17894)
