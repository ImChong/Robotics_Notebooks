...
status: complete
updated: 2026-09-20
code: https://github.com/jslee02/awesome-robotics-libraries
summary: "Robotics software libraries."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_281_awesome-robotics-libraries.md
...
**Awesome Robotics Libraries** 收录于 awesome-physical-ai（natnew）**第 281/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/jslee02/awesome-robotics-libraries> |
| 代码/仓库 | <https://github.com/jslee02/awesome-robotics-libraries> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/jslee02/awesome-robotics-libraries> |
| 代码/仓库 | <https://github.com/jslee02/awesome-robotics-libraries> |
...
- [`sources/repos/pai_awesome_list_281_awesome-robotics-libraries.md`](../../sources/repos/pai_awesome_list_281_awesome-robotics-libraries.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/jslee02/awesome-robotics-libraries)
