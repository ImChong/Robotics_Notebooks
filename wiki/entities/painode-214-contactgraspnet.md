...
summary: "Grasp pose generation directly from partial point clouds."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_214_contact-graspnet.md
...
**Contact-GraspNet** 收录于 awesome-physical-ai（natnew）**第 214/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Grasp pose generation directly from partial point clouds.
...
| 分组 | Manipulation |
| 来源清单 | natnew |
| 主链接 | <https://github.com/NVlabs/contact_graspnet> |
| 代码/仓库 | <https://github.com/nvlabs/contact_graspnet> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/NVlabs/contact_graspnet> |
| 代码/仓库 | <https://github.com/nvlabs/contact_graspnet> |
...
- [`sources/repos/pai_awesome_method_214_contact-graspnet.md`](../../sources/repos/pai_awesome_method_214_contact-graspnet.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/NVlabs/contact_graspnet)
