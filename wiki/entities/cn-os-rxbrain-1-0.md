...
**RxBrain-1.0** 是 [腾讯机器人实验室](https://github.com/Tencent-Hunyuan) 公开的 **具身Agent/规划** 开源项目：视觉与语言输入形成场景理解和任务计划，再向下层操作或导航策略发出目标；项目用于区分高层认知、策略动作与低层控制三种职责。
...
1. 从官方 GitHub/Gitee 组织检索 `RxBrain-1.0` 仓库并核对 README 许可与依赖。
