...
- **代码：** 未在清单中标注
- **清单摘要：** Open-source framework for multi-robot, multi-vendor fleet orchestration.
- **沉淀到 wiki：** [`wiki/entities/painode-266-openrmf.md`](../../wiki/entities/painode-266-openrmf.md)
...
- 实体页：[`wiki/entities/painode-266-openrmf.md`](../../wiki/entities/painode-266-openrmf.md)
