...
status: complete
updated: 2026-09-20
summary: "Datasets and models for analytic and learned robust grasping."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_215_dex-net.md
...
**Dex-Net** 收录于 awesome-physical-ai（natnew）**第 215/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Datasets and models for analytic and learned robust grasping.
...
| 分组 | Manipulation |
| 来源清单 | natnew |
| 主链接 | <https://berkeleyautomation.github.io/dex-net/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://berkeleyautomation.github.io/dex-net/> |
...
- [`sources/repos/pai_awesome_method_215_dex-net.md`](../../sources/repos/pai_awesome_method_215_dex-net.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://berkeleyautomation.github.io/dex-net/)
