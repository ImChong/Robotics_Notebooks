...
updated: 2026-09-25
arxiv: "2605.28544"
code: https://github.com/chenshi3/DriveWAM
summary: "We present DriveWAM, a driving world-action model that adapts a pretrained video diffusion transformer into an autoregressive video-action policy. To incorporate high-level scene understanding, we introduce scene-evolvin"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_28544_drivewam-video-generative-priors-enable.md
...
**DriveWAM: Video Generative Priors Enable Scalable World-Action Modeling for Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 325/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present DriveWAM, a driving world-action model that adapts a pretrained video diffusion transformer into an autoregressive video-action policy. To incorporate high-level scene understanding, we introduce scene-evolving driving guidance, where a frozen VLM produces chunk-specific semantic intent to guide video-act...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.28544> |
| 代码/项目 | <https://github.com/chenshi3/DriveWAM> |
| 子类 / 象限 | 自动驾驶 · 视觉规划与IDM · 记忆与长时序 · Q2 · One Model × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.28544) 为准。
...
**本条目的站内价值是把「DriveWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_28544_drivewam-video-generative-priors-enable.md`](../../sources/papers/rcl_awesome_wam_2605_28544_drivewam-video-generative-priors-enable.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.28544)
