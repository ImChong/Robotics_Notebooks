...
- **标题：** Real-Time Polygonal Semantic Mapping for Humanoid Robot Stair Climbing
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/real-time-polygonal-semantic-mapping-for-humanoi/real-time-polygonal-semantic-mapping-for-humanoi.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-real-time-polygonal-semantic-mapping-for-humanoi](../../wiki/entities/paper-notebook-real-time-polygonal-semantic-mapping-for-humanoi.md).

## 对 wiki 的映射

- [paper-notebook-real-time-polygonal-semantic-mapping-for-humanoi](../../wiki/entities/paper-notebook-real-time-polygonal-semantic-mapping-for-humanoi.md)
