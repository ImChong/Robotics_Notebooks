...
status: complete
updated: 2026-09-20
summary: "Recipe for scaling robot dexterity via large-scale imitation learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_211_aloha-unleashed.md
...
**ALOHA Unleashed** 收录于 awesome-physical-ai（natnew）**第 211/384** 条，分组 **Manipulation / Key Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Recipe for scaling robot dexterity via large-scale imitation learning.
...
|------|------|
| 编号 | 211/384 |
| 分组 | Manipulation / Key Papers |
| 来源清单 | natnew |
| 主链接 | <https://aloha-unleashed.github.io/> |

## 核心原理

Recipe for scaling robot dexterity via large-scale imitation learning.

该条目在 Physical AI 清单中的角色是 **method**，分组 **Manipulation / Key Papers**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://aloha-unleashed.github.io/> |
...
- [`sources/repos/pai_awesome_method_211_aloha-unleashed.md`](../../sources/repos/pai_awesome_method_211_aloha-unleashed.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://aloha-unleashed.github.io/)
