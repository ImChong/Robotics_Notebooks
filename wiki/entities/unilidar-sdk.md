...
summary: "Unitree L1 LiDAR 官方 SDK。"
---

# unilidar_sdk

**unilidar_sdk** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **LiDAR 感知** 主线。

## 一句话定义

Unitree L1 LiDAR 官方 SDK。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/unilidar_sdk`](https://github.com/unitreerobotics/unilidar_sdk) |
| 组织分类 | LiDAR 感知 |
| 星标（2026-07-24） | ~140 |
| 最近推送 | 2024-02-18 |
| 主要语言 | C |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/unilidar_sdk.md](../../sources/repos/unilidar_sdk.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/unilidar_sdk>
