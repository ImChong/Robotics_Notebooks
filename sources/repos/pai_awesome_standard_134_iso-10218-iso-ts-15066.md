...
- **代码：** 未在清单中标注
- **清单摘要：** Industrial robot and collaborative-robot safety standards underpinning workplace deployment.
- **沉淀到 wiki：** [`wiki/entities/painode-134-iso10218isots15066.md`](../../wiki/entities/painode-134-iso10218isots15066.md)
...
- 实体页：[`wiki/entities/painode-134-iso10218isots15066.md`](../../wiki/entities/painode-134-iso10218isots15066.md)
