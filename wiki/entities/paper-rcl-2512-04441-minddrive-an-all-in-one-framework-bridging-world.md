...
arxiv: "2512.04441"
venue: "2025"
summary: "MindDrive couples action-conditioned BEV scene prediction with anchor refinement and a VLM trajectory scorer. Its main contribution is the connection between future-aware candidate generation and selection. NAVSIM scores"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2512_04441_minddrive-an-all-in-one-framework-bridgi.md
...
**MindDrive: An All-in-One Framework Bridging World Models and Vision-Language Model for End-to-End Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 428/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2025 |
| 论文 | <https://arxiv.org/abs/2512.04441> |
| 子类 / 象限 | 自动驾驶 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.04441) 为准。
...
**本条目的站内价值是把「MindDrive」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2512_04441_minddrive-an-all-in-one-framework-bridgi.md`](../../sources/papers/rcl_awesome_wam_2512_04441_minddrive-an-all-in-one-framework-bridgi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.04441)
