...
status: complete
updated: 2026-09-20
code: https://github.com/natnew/awesome-agentic-ai-security
summary: "Security research, threat models, defenses, and governance for agentic AI systems."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_271_awesome-agentic-ai-security.md
...
**Awesome Agentic AI Security** 收录于 awesome-physical-ai（natnew）**第 271/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Security research, threat models, defenses, and governance for agentic AI systems.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/natnew/Awesome-Agentic-AI-Security> |
| 代码/仓库 | <https://github.com/natnew/awesome-agentic-ai-security> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/natnew/Awesome-Agentic-AI-Security> |
| 代码/仓库 | <https://github.com/natnew/awesome-agentic-ai-security> |
...
- [`sources/repos/pai_awesome_list_271_awesome-agentic-ai-security.md`](../../sources/repos/pai_awesome_list_271_awesome-agentic-ai-security.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/natnew/Awesome-Agentic-AI-Security)
