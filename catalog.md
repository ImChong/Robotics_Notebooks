...
- [MIT Mini Cheetah（学习栈与开源边界）](wiki/entities/mit-mini-cheetah.md) — MIT Mini Cheetah**（Sangbae Kim 实验室；执行器由 **Ben Katz** 主导）是约 **9 kg**、模块化 **QDD** 四足平台：官方以 **论文 + `C `📅unknown` `[entity_page]`
