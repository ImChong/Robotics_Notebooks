...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_0276752be34087981228_image-quality-assessment-from-error-visi.md
...
**Image Quality Assessment: From Error Visibility to Structural Similarity** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 139/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | IEEE Transactions on Image Processing 13(4), 2004 |
| 论文 | <https://ieeexplore.ieee.org/document/1284395/> |
| 项目页 | <https://ece.uwaterloo.ca/~z70wang/research/ssim/> |
| 子类 / 象限 | 图像质量指标 · 评估指标与协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/1284395/) 为准。
...
**本条目的站内价值是把「Image Quality Assessment」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_0276752be34087981228_image-quality-assessment-from-error-visi.md`](../../sources/papers/rcl_awesome_wam_ref_0276752be34087981228_image-quality-assessment-from-error-visi.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/1284395/)
