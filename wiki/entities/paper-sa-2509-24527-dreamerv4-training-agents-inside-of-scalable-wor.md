...
arxiv: "2509.24527"
venue: "arXiv 2025"
summary: "Trains agents inside of scalable world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_24527_dreamerv4-training-agents-inside-of-scal.md
...
**DreamerV4: Training Agents Inside of Scalable World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 236/571** 篇，分组 **71 Classic Series**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Trains agents inside of scalable world models.
...
| 项目页 | <https://danijar.com/project/dreamer4/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.24527) 为准。
...
**本条目的站内价值是把「DreamerV4」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_24527_dreamerv4-training-agents-inside-of-scal.md`](../../sources/papers/sun_awesome_wm_2509_24527_dreamerv4-training-agents-inside-of-scal.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.24527)
