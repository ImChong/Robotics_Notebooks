...
status: complete
updated: 2026-09-20
summary: "Modern robot learning, covering imitation and reinforcement learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_069_cs-336-robot-learning-stanford.md
...
# CS 336 — Robot Learning (Stanford)

**CS 336 — Robot Learning (Stanford)** 收录于 awesome-physical-ai（natnew）**第 069/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Modern robot learning, covering imitation and reinforcement learning.
...
- [`sources/repos/pai_awesome_course_069_cs-336-robot-learning-stanford.md`](../../sources/repos/pai_awesome_course_069_cs-336-robot-learning-stanford.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://cs336.stanford.edu/)
