...
- **标题：** HuB: Learning Extreme Humanoid Balance
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/hub-learning-extreme-humanoid-balance/hub-learning-extreme-humanoid-balance.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-hub](../../wiki/entities/paper-notebook-hub.md).

## 对 wiki 的映射

- [paper-notebook-hub](../../wiki/entities/paper-notebook-hub.md)
...
- 论文：<https://arxiv.org/abs/2505.07294>
