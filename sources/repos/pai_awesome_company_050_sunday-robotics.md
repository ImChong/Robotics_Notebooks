...
- **代码：** 未在清单中标注
- **清单摘要：** Building generalist robots and foundation models for physical intelligence.
- **沉淀到 wiki：** [`wiki/entities/painode-050-sundayrobotics.md`](../../wiki/entities/painode-050-sundayrobotics.md)
...
- 实体页：[`wiki/entities/painode-050-sundayrobotics.md`](../../wiki/entities/painode-050-sundayrobotics.md)
