...
summary: "Builds a multiplayer video world model in Minecraft."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_22208_solaris-building-a-multiplayer-video-wor.md
...
**Solaris: Building a Multiplayer Video World Model in Minecraft** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 183/571** 篇，分组 **52 Game & Open-World Exploration Application**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Builds a multiplayer video world model in Minecraft.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.22208> |
| 代码/项目 | <https://github.com/solaris-wm/solaris> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.22208) 为准。
...
**本条目的站内价值是把「Solaris」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2602_22208_solaris-building-a-multiplayer-video-wor.md`](../../sources/papers/sun_awesome_wm_2602_22208_solaris-building-a-multiplayer-video-wor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.22208)
