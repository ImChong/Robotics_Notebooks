---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, company]
status: complete
updated: 2026-09-20
summary: "Maker of Digit, a bipedal logistics robot deployed in commercial warehouses."
related:
...
**Agility Robotics** 收录于 awesome-physical-ai（natnew）**第 041/384** 条，分组 **Companies / Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Maker of Digit, a bipedal logistics robot deployed in commercial warehouses.
...
|------|------|
| 编号 | 041/384 |
| 分组 | Companies / Hardware Platforms |
| 来源清单 | natnew |
| 主链接 | <https://agilityrobotics.com/> |

## 核心原理

Maker of Digit, a bipedal logistics robot deployed in commercial warehouses.

该条目在 Physical AI 清单中的角色是 **company**，分组 **Companies / Hardware Platforms**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://agilityrobotics.com/> |
...
- [`sources/repos/pai_awesome_company_041_agility-robotics.md`](../../sources/repos/pai_awesome_company_041_agility-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://agilityrobotics.com/)
