...
- **标题：** SimGenHOI: Physically Realistic Whole-Body Humanoid-Object Interaction via Generative Modeling and RL
- **类型：** paper
- **深读状态：** 待撰写（见 [papers/PROGRESS.md](https://github.com/ImChong/Robot_Learning_Paper_Notebooks/blob/main/papers/PROGRESS.md)）
- **计划笔记路径：** `papers/13_Physics-Based_Animation/simgenhoi-physically-realistic-whole-body-humano/simgenhoi-physically-realistic-whole-body-humano.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-simgenhoi-physically-realistic-whole-body-humano](../../wiki/entities/paper-notebook-simgenhoi-physically-realistic-whole-body-humano.md).

## 对 wiki 的映射

- [paper-notebook-simgenhoi-physically-realistic-whole-body-humano](../../wiki/entities/paper-notebook-simgenhoi-physically-realistic-whole-body-humano.md)
