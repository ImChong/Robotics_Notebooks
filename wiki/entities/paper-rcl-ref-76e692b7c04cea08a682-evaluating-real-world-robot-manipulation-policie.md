...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_76e692b7c04cea08a682_evaluating-real-world-robot-manipulation.md
...
**Evaluating Real-World Robot Manipulation Policies in Simulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 019/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | CoRL 2024（论文集出版于2025年） |
| 论文 | <https://proceedings.mlr.press/v270/li25c.html> |
| 子类 / 象限 | 机器人操作基准 · 物理仿真 · 仿真到真实评测 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.mlr.press/v270/li25c.html) 为准。
...
**本条目的站内价值是把「Evaluating Real-World Robot Manipulation Policies in Simulation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_76e692b7c04cea08a682_evaluating-real-world-robot-manipulation.md`](../../sources/papers/rcl_awesome_wam_ref_76e692b7c04cea08a682_evaluating-real-world-robot-manipulation.md) — 本条目策展摘录
...
- [原文](https://proceedings.mlr.press/v270/li25c.html)
