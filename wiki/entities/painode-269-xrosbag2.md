...
status: complete
updated: 2026-09-20
code: https://github.com/ros2/rosbag2
summary: "Standard ROS 2 recording and replay pipeline for debugging and incident analysis."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_269_rosbag2.md
...
**rosbag2** 收录于 awesome-physical-ai（natnew）**第 269/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Standard ROS 2 recording and replay pipeline for debugging and incident analysis.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/ros2/rosbag2> |
| 代码/仓库 | <https://github.com/ros2/rosbag2> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/ros2/rosbag2> |
| 代码/仓库 | <https://github.com/ros2/rosbag2> |
...
- [`sources/repos/pai_awesome_resource_269_rosbag2.md`](../../sources/repos/pai_awesome_resource_269_rosbag2.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/ros2/rosbag2)
