...
- **入库日期：** 2026-07-10
- **补链日期：** 2026-07-31（官方仓 / 项目页正式 ingest）
...
- 官方仓库 / 项目页归档：[`spi-active` repo](../repos/spi-active.md)、[`spi-active` site](../sites/spi-active.md)、[arXiv 摘录](./spi_active_arxiv_2505_14266.md)。
