...
- **标题：** TACT: Humanoid Whole-body Contact Manipulation through Deep Imitation Learning with Tactile Modality
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/tact-humanoid-whole-body-contact-manipulation-th/tact-humanoid-whole-body-contact-manipulation-th.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2506.15146>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-tact](../../wiki/entities/paper-notebook-tact.md).

## 对 wiki 的映射

- [paper-notebook-tact](../../wiki/entities/paper-notebook-tact.md)
...
- 论文：<https://arxiv.org/abs/2506.15146>
