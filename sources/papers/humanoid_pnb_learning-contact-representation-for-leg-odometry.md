...
- **标题：** Learning Contact Representation for Leg Odometry
- **类型：** paper
- **深读状态：** 待撰写（见 [papers/PROGRESS.md](https://github.com/ImChong/Robot_Learning_Paper_Notebooks/blob/main/papers/PROGRESS.md)）
- **计划笔记路径：** `papers/09_State_Estimation/Learning_Contact_Representation_for_Leg_Odometry/Learning_Contact_Representation_for_Leg_Odometry.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-contact-representation-for-leg-odometry](../../wiki/entities/paper-notebook-learning-contact-representation-for-leg-odometry.md).

## 对 wiki 的映射

- [paper-notebook-learning-contact-representation-for-leg-odometry](../../wiki/entities/paper-notebook-learning-contact-representation-for-leg-odometry.md)
