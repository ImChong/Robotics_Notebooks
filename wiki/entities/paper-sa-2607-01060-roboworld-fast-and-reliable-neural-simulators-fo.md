...
arxiv: "2607.01060"
venue: "arXiv 2026"
summary: "An automated evaluation pipeline combining fast autoregressive video world models with task‑progress‑aware VLM scoring."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2607_01060_roboworld-fast-and-reliable-neural-simul.md
...
**RoboWorld: Fast and Reliable Neural Simulators for Generalist Robot Policy Evaluation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 046/571** 篇，分组 **115 Benchmarks for World Model Simulation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

An automated evaluation pipeline combining fast autoregressive video world models with task‑progress‑aware VLM scoring.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2607.01060> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.01060) 为准。
...
**本条目的站内价值是把「RoboWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2607_01060_roboworld-fast-and-reliable-neural-simul.md`](../../sources/papers/sun_awesome_wm_2607_01060_roboworld-fast-and-reliable-neural-simul.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.01060)
