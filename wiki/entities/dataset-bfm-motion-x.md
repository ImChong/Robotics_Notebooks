...
status: complete
updated: 2026-05-26
summary: "文本–动作–大规模人体运动连接。"
related:
  - ../concepts/behavior-foundation-model.md
  - ../overview/bfm-41-papers-technology-map.md
sources:
  - ../../sources/papers/bfm_awesome_dataset_motion_x_neurips_2023.md
...
**Motion-X** 列入 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) 数据集表（2023 · NeurIPS）。本页为 **清单索引** 说明；规模与许可以官方页面为准。
...
- [bfm_awesome_dataset_motion_x_neurips_2023.md](../../sources/papers/bfm_awesome_dataset_motion_x_neurips_2023.md)
- [bfm_awesome_41_catalog.md](../../sources/papers/bfm_awesome_41_catalog.md#数据集10)
- 数据集页：<https://proceedings.neurips.cc/paper_files/paper/2023/file/4f8e27f6036c1d8b4a66b5b3a947dd7b-Paper-Datasets_and_Benchmarks.pdf>
