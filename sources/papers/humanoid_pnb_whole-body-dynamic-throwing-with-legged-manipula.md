...
- **标题：** Whole-Body Dynamic Throwing with Legged Manipulators
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Whole-Body_Dynamic_Throwing_with_Legged_Manipulators/Whole-Body_Dynamic_Throwing_with_Legged_Manipulators.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-whole-body-dynamic-throwing-with-legged-manipula](../../wiki/entities/paper-notebook-whole-body-dynamic-throwing-with-legged-manipula.md).

## 对 wiki 的映射

- [paper-notebook-whole-body-dynamic-throwing-with-legged-manipula](../../wiki/entities/paper-notebook-whole-body-dynamic-throwing-with-legged-manipula.md)
