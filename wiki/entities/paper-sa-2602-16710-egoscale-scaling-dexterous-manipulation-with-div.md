...
sources:
  - ../../sources/papers/sun_awesome_ego_2602_16710_egoscale-scaling-dexterous-manipulation.md
...
**EgoScale: Scaling Dexterous Manipulation with Diverse Egocentric Human Data** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 083/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Trains a VLA model on over 20,854 hours of action-labeled egocentric human video, uncovering a log-linear scaling law between human data scale and validation loss
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.16710) 为准。
...
**本条目的站内价值是把「EgoScale」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2602_16710_egoscale-scaling-dexterous-manipulation.md`](../../sources/papers/sun_awesome_ego_2602_16710_egoscale-scaling-dexterous-manipulation.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.16710)
