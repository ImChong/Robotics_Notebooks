...
updated: 2026-09-25
arxiv: "2606.23623"
summary: "To solve this problem, we propose \\textbf{dVLA-RL}, shifting the learning objective from the marginal action probability to the joint probability of the sampled generation path. Leveraging this intrinsic fexibility, we i"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_23623_dvla-rl-reinforcement-learning-over-deno.md
...
**dVLA-RL: Reinforcement Learning over Denoising Trajectories for Discrete Diffusion Vision-Language-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 264/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To solve this problem, we propose \textbf{dVLA-RL}, shifting the learning objective from the marginal action probability to the joint probability of the sampled generation path. Leveraging this intrinsic fexibility, we introduce a unified step scheduling approach for complex multi-task learning, tailoring denoising...
...
| 分组 | VLA |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.23623> |
| 子类 / 象限 | 扩散与流匹配VLA · VLA后训练与数据增强 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.23623) 为准。
...
**本条目的站内价值是把「dVLA-RL」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_23623_dvla-rl-reinforcement-learning-over-deno.md`](../../sources/papers/rcl_awesome_wam_2606_23623_dvla-rl-reinforcement-learning-over-deno.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.23623)
