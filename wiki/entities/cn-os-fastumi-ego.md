...
**FastUMI_Ego** 是 [鹿明机器人](https://github.com/LumosRobot) 公开的 **数据集/Benchmark** 开源项目：提供FastUMI第一视角数据采集入口，记录人类操作过程以服务机器人模仿学习数据构建。
...
1. 从官方 GitHub/Gitee 组织检索 `FastUMI_Ego` 仓库并核对 README 许可与依赖。
