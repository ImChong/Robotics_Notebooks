...
- **代码：** 未在清单中标注
- **清单摘要：** Sim-to-real dexterous in-hand manipulation on the Allegro hand using massively parallel GPU simulation.
- **沉淀到 wiki：** [`wiki/entities/painode-330-dextremenvidia.md`](../../wiki/entities/painode-330-dextremenvidia.md)
...
- 实体页：[`wiki/entities/painode-330-dextremenvidia.md`](../../wiki/entities/painode-330-dextremenvidia.md)
