...
summary: "小鹏 IRON CN119058853A：十字轴与直线执行器耦合的髋关节（2024-12-03 公开/公告）；回转安装架+十字轴与双髋执行器/连杆组，同步或异向伸缩驱动两向髋部运动，球铰留偏转余量。…"
---

# 小鹏 IRON · 十字轴与直线执行器耦合的髋关节（CN119058853A）

专利 **CN119058853A**（*十字轴与直线执行器耦合的髋关节*，小鹏机器人 / IRON 相关布局，2024-12-03）公开 **腿足·腰·动力** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**回转安装架+十字轴与双髋执行器/连杆组，同步或异向伸缩驱动两向髋部运动，球铰留偏转余量。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN119058853A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn119058853a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN119058853A](https://patents.google.com/patent/CN119058853A/zh)
