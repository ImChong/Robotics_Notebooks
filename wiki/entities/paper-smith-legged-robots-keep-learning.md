...
- **本页为索引级节点**（FreeDof 44 篇梳理 [36/44]）：正文固化文内角色与机制要点，**未转存原文实验表**。
- **回原文须核对的证据**：本页要点是「仿真预训练 + 安全约束下的真机 policy fine-tuning」，对应证据是真机 fine-tune 的样本量、安全干预次数与性能提升曲线三者一起看。
...
| **横比口径** | 真机样本效率数字与机型、场地与安全约束强绑定；不报干预次数的样本效率不可比。 |
