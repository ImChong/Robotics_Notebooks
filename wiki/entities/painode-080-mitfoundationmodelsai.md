...
sources:
  - ../../sources/repos/pai_awesome_course_080_mit-foundation-models-ai.md
...
# MIT Foundation Models & AI

**MIT Foundation Models & AI** 收录于 awesome-physical-ai（aichr）**第 080/384** 条，分组 **Courses & Tutorials**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://ocw.mit.edu/courses/6-s087-foundation-models-and-generative-ai-january-iap-2024/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://ocw.mit.edu/courses/6-s087-foundation-models-and-generative-ai-january-iap-2024/> |
...
- [`sources/repos/pai_awesome_course_080_mit-foundation-models-ai.md`](../../sources/repos/pai_awesome_course_080_mit-foundation-models-ai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://ocw.mit.edu/courses/6-s087-foundation-models-and-generative-ai-january-iap-2024/)
