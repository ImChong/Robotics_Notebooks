...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/SLAC__Simulation-Pretrained_Latent_Action_Space_for_Whole-Body_Real-World_Reinfo/SLAC__Simulation-Pretrained_Latent_Action_Space_for_Whole-Body_Real-World_Reinfo.md`
