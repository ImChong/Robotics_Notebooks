...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2503_00370_scalable-real2sim-physics-aware-asset-ge.md
...
**Scalable Real2Sim: Physics-Aware Asset Generation Via Robotic Pick-and-Place Setups** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 034/063** 篇，分组 **32 Real2Sim for Manipulation & Interaction**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Simulating object dynamics from real-world perception shows great promise for digital twins and robotic manipulation but demands labor-intensive measurements
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.00370> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.00370) 为准。
...
**本条目的站内价值是把「Scalable Real2Sim」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2503_00370_scalable-real2sim-physics-aware-asset-ge.md`](../../sources/papers/sun_awesome_r2s2r_2503_00370_scalable-real2sim-physics-aware-asset-ge.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.00370)
