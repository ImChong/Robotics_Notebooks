...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1907_05446_general-evaluation-for-instruction-condi.md
...
**General Evaluation for Instruction Conditioned Navigation using Dynamic Time Warping** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 138/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2019 |
| 论文 | <https://arxiv.org/abs/1907.05446> |
| 子类 / 象限 | 导航评估指标 · 评估指标与协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1907.05446) 为准。
...
**本条目的站内价值是把「General Evaluation for Instruction Conditioned Navigation using Dynamic Time ...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1907_05446_general-evaluation-for-instruction-condi.md`](../../sources/papers/rcl_awesome_wam_1907_05446_general-evaluation-for-instruction-condi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/1907.05446)
