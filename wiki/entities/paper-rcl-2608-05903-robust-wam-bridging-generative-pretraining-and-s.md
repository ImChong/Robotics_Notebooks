...
summary: "To overcome this dilemma, we propose Robust-WAM, a general post-training method for video-generation-based WAMs that preserves the VAE-based generative path and adds a lightweight semantic foresight alignment objective o"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_05903_robust-wam-bridging-generative-pretraini.md
...
**Robust-WAM: Bridging Generative Pretraining and Semantic Foresight in World-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 469/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To overcome this dilemma, we propose Robust-WAM, a general post-training method for video-generation-based WAMs that preserves the VAE-based generative path and adds a lightweight semantic foresight alignment objective on the action stream.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.05903> |
| 代码/项目 | <https://github.com/Haodong-Yan/Robust-WAM-release> |
| 子类 / 象限 | 潜空间预测与JEPA · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.05903) 为准。
...
**本条目的站内价值是把「Robust-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_05903_robust-wam-bridging-generative-pretraini.md`](../../sources/papers/rcl_awesome_wam_2608_05903_robust-wam-bridging-generative-pretraini.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.05903)
