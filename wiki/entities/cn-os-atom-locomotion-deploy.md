...
**atom-locomotion-deploy** 是 [越疆科技](https://github.com/embodied-dobot) 公开的 **仿真环境** 开源项目：把ATOM运动策略接入仿真或真机运行时，处理机器人状态、策略推理与控制命令输出。
...
1. 从官方 GitHub/Gitee 组织检索 `atom-locomotion-deploy` 仓库并核对 README 许可与依赖。
