...
sources:
  - ../../sources/papers/sun_awesome_ego_2505_24287_egoexor.md
...
**EgoExOR** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 244/249** 篇，分组 **Specialized Domain Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
|------|------|
| 编号 | 244/249 |
| 分组 | Specialized Domain Datasets |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2505.24287> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.24287) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 的 **Specialized Domain Datasets** 分组逐条展开。
...
**本条目的站内价值是把「EgoExOR」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Specialized Domain Datasets** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_ego_2505_24287_egoexor.md`](../../sources/papers/sun_awesome_ego_2505_24287_egoexor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.24287)
