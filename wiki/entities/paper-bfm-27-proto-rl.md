...
**Reinforcement Learning with Prototypical Representations** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 27/41** 篇，归类为 **03 Intrinsic reward 预训练**（2021 · ICML）。
