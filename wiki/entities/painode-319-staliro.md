...
status: complete
updated: 2026-09-20
summary: "Temporal-logic falsification framework for stress-testing control-system requirements."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_319_s-taliro.md
...
**S-TaLiRo** 收录于 awesome-physical-ai（natnew）**第 319/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Temporal-logic falsification framework for stress-testing control-system requirements.
...
| 来源清单 | natnew |
| 主链接 | <https://sites.google.com/a/asu.edu/s-taliro/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://sites.google.com/a/asu.edu/s-taliro/> |
...
- [`sources/repos/pai_awesome_resource_319_s-taliro.md`](../../sources/repos/pai_awesome_resource_319_s-taliro.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://sites.google.com/a/asu.edu/s-taliro/)
