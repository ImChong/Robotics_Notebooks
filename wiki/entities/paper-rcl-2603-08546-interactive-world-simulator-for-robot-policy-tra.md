...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_08546_interactive-world-simulator-for-robot-po.md
...
**Interactive World Simulator for Robot Policy Training and Evaluation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 028/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2603.08546> |
| 项目页 | <https://yixuanwang.me/interactive_world_sim> |
| 子类 / 象限 | 神经世界模拟器 · 评估指标与协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.08546) 为准。
...
**本条目的站内价值是把「Interactive World Simulator for Robot Policy Training and Evaluation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_08546_interactive-world-simulator-for-robot-po.md`](../../sources/papers/rcl_awesome_wam_2603_08546_interactive-world-simulator-for-robot-po.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.08546)
