...
status: complete
updated: 2026-09-20
summary: "Keypoint-based pick-and-place architecture for data-efficient tabletop manipulation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_225_transporter-networks.md
...
**Transporter Networks** 收录于 awesome-physical-ai（natnew）**第 225/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Keypoint-based pick-and-place architecture for data-efficient tabletop manipulation.
...
| 分组 | Manipulation |
| 来源清单 | natnew |
| 主链接 | <https://transporternets.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://transporternets.github.io/> |
...
- [`sources/repos/pai_awesome_method_225_transporter-networks.md`](../../sources/repos/pai_awesome_method_225_transporter-networks.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://transporternets.github.io/)
