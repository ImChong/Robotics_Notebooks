...
status: complete
updated: 2026-09-20
summary: "Socially intelligent robots."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_287_mit-media-lab-personal-robots.md
...
**MIT Media Lab Personal Robots** 收录于 awesome-physical-ai（aichr）**第 287/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Research Labs |
| 来源清单 | aichr |
| 主链接 | <https://robots.media.mit.edu/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://robots.media.mit.edu/> |
...
- [`sources/repos/pai_awesome_lab_287_mit-media-lab-personal-robots.md`](../../sources/repos/pai_awesome_lab_287_mit-media-lab-personal-robots.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robots.media.mit.edu/)
