...
**Chain-of-Action** 是 [字节跳动机器人团队](https://github.com/ByteDance-Seed) 公开的 **VLA/操作模型** 开源项目：面向机器人操作的轨迹自回归建模（动作链推理）
...
1. 从官方 GitHub/Gitee 组织检索 `Chain-of-Action` 仓库并核对 README 许可与依赖。
