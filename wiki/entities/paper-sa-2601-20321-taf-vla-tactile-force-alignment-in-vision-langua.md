...
sources:
  - ../../sources/papers/sun_awesome_touch_2601_20321_taf-vla-tactile-force-alignment-in-visio.md
...
**TaF-VLA: Tactile-Force Alignment in Vision-Language-Action Models for Force-aware Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 008/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Explicitly grounds high-dimensional tactile observations in physical interaction forces.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2601.20321> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.20321) 为准。
...
**本条目的站内价值是把「TaF-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2601_20321_taf-vla-tactile-force-alignment-in-visio.md`](../../sources/papers/sun_awesome_touch_2601_20321_taf-vla-tactile-force-alignment-in-visio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.20321)
