...
status: complete
updated: 2026-09-20
code: https://github.com/mit-biomimetics/fld
summary: "Periodic motion latent representation for learning agile, natural-looking legged locomotion (ICLR 2024)."
related:
...
sources:
  - ../../sources/repos/pai_awesome_paper_192_fld-fourier-latent-dynamics-mit-biom.md
...
# FLD — Fourier Latent Dynamics (MIT Biomimetics)

**FLD — Fourier Latent Dynamics (MIT Biomimetics)** 收录于 awesome-physical-ai（natnew）**第 192/384** 条，分组 **Locomotion**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Periodic motion latent representation for learning agile, natural-looking legged locomotion (ICLR 2024).
...
| 分组 | Locomotion |
| 来源清单 | natnew |
| 主链接 | <https://github.com/mit-biomimetics/fld> |
| 代码/仓库 | <https://github.com/mit-biomimetics/fld> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/mit-biomimetics/fld) 为准。
...
**本条目的站内价值是把「FLD — Fourier Latent Dynamics (MIT Biomimetics)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Locomotion**，来源 natnew。
...
- [`sources/repos/pai_awesome_paper_192_fld-fourier-latent-dynamics-mit-biom.md`](../../sources/repos/pai_awesome_paper_192_fld-fourier-latent-dynamics-mit-biom.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/mit-biomimetics/fld)
