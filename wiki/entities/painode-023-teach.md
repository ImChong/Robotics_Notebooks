...
status: complete
updated: 2026-09-20
summary: "Interactive benchmark for embodied dialog and task execution in household environments."
related:
...
**TEACh** 收录于 awesome-physical-ai（natnew）**第 023/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Interactive benchmark for embodied dialog and task execution in household environments.
...
| 分组 | Benchmarks |
| 来源清单 | natnew |
| 主链接 | <https://teach.cs.washington.edu/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://teach.cs.washington.edu/> |
...
- [`sources/repos/pai_awesome_benchmark_023_teach.md`](../../sources/repos/pai_awesome_benchmark_023_teach.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://teach.cs.washington.edu/)
