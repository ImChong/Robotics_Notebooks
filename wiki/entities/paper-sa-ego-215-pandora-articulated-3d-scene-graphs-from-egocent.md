...
sources:
  - ../../sources/papers/sun_awesome_ego_noarxiv_215_pandora-articulated-3d-scene-graphs-from.md
...
**Pandora: Articulated 3D Scene Graphs from Egocentric Vision** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 215/249** 篇，分组 **Human Pose & Mesh Recovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Leverages egocentric data captured as a human naturally explores a scene wearing Project Aria glasses to recover models of articulated object parts. Demonstrates that articulated 3D scene graphs enhance a robot's ability to perform mobile manipulation tasks
...
| 出处 | BMVC 2025 |
| 论文 | <https://bmvc2025.bmva.org/proceedings/548/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://bmvc2025.bmva.org/proceedings/548/) 为准。
...
**本条目的站内价值是把「Pandora」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_215_pandora-articulated-3d-scene-graphs-from.md`](../../sources/papers/sun_awesome_ego_noarxiv_215_pandora-articulated-3d-scene-graphs-from.md) — 本条目策展摘录
...
- [原文](https://bmvc2025.bmva.org/proceedings/548/)
