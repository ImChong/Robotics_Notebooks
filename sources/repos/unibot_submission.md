...
- **标题：** unibot_submission
- **类型：** repo
- **来源：** unitreerobotics（Unitree 官方 GitHub 组织）
- **链接：** https://github.com/unitreerobotics/unibot_submission
- **星标（截至 2026-07-24）：** ~6
- **最近推送：** 2026-07-10
- **主要语言：** Python
- **分类：** 赛事 / Challenge
- **入库日期：** 2026-07-24
- **一句话说明：** UniBot Challenge 赛事资源仓。
...
- **已开源**：公开 GitHub 仓库（unitreerobotics/unibot_submission）。
