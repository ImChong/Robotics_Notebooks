...
### 官方网站（wuji.tech，2026-06-25 可访问）

- **中文站**：<https://www.wuji.tech/zh/>
- **英文站**：<https://www.wuji.tech/en/>
- **首页产品叙事（归纳）**：
  - **Wuji Hand**：强调 **20 个主动自由度**、仿人手结构与自然动作；
  - **智能数据手套**：面向机器人遥操作与人机交互，宣称 **526 个触点**、**120 FPS** 实时触觉与姿态采集。
- **站内导航**还指向 **文档中心**（`docs.wuji.tech`）、条款与声明、招聘（加入我们）、联系我们等入口；产品规格仍以文档中心与随货文件为准。

### 其他域名 / ICP 线索

- 公开检索中另见备案域名 **`wujihand.com`**（与「灵巧手」拼音语义一致）；**2026-05-12** 抓取时曾返回 **503**，本资料不依赖其正文，仅作后续 curator 核验入口：  
...
- 舞肌科技官方网站（中文）：<https://www.wuji.tech/zh/>
- 舞肌科技官方网站（英文）：<https://www.wuji.tech/en/>
