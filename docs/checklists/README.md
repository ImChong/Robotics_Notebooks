...
- [技术栈项目执行清单 v30](tech-stack-next-phase-checklist-v30.md) — 当前技术栈、自动化、专题建设与 UX 推进看板。
...
这些文件记录从 v1 到 v29 的阶段性目标和已完成事项，主要用于追溯决策，不作为当前待办入口。历史版本统一存放在 [`archive/`](archive/) 子目录。
