...
status: complete
updated: 2026-09-20
summary: "IEEE International Conference on Robotics and Automation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_conference_059_icra.md
...
**ICRA** 收录于 awesome-physical-ai（natnew、aichr）**第 059/384** 条，分组 **Conferences / Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
|------|------|
| 编号 | 059/384 |
| 分组 | Conferences / Community |
| 来源清单 | natnew、aichr |
| 主链接 | <https://www.ieee-ras.org/conferences-workshops/fully-sponsored/icra> |

## 核心原理

IEEE International Conference on Robotics and Automation.

该条目在 Physical AI 清单中的角色是 **conference**，分组 **Conferences / Community**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.ieee-ras.org/conferences-workshops/fully-sponsored/icra> |
...
- [`sources/repos/pai_awesome_conference_059_icra.md`](../../sources/repos/pai_awesome_conference_059_icra.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.ieee-ras.org/conferences-workshops/fully-sponsored/icra)
