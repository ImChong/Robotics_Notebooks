...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2602_16675_learning-to-unfold-cloth-scaling-up-worl.md
...
**Learning to unfold cloth: Scaling up world models to deformable object manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 417/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2602.16675> |
| 子类 / 象限 | 策略后训练与WM-RL · 经典WM与模型式RL · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.16675) 为准。
...
**本条目的站内价值是把「Learning to unfold cloth」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2602_16675_learning-to-unfold-cloth-scaling-up-worl.md`](../../sources/papers/rcl_awesome_wam_2602_16675_learning-to-unfold-cloth-scaling-up-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.16675)
