...
- **代码：** <https://github.com/AgibotTech/Genie-Envisioner>
- **项目页：** <https://genie-envisioner.github.io/>
- **Highlights（清单）：** Unified world foundation platform for robotic manipulation.
...
- 实体页：[`wiki/entities/paper-sa-2508-05635-genie-envisioner-a-unified-world-foundation-plat.md`](../../wiki/entities/paper-sa-2508-05635-genie-envisioner-a-unified-world-foundation-plat.md)
