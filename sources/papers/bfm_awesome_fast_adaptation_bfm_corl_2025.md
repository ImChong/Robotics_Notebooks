...
> 来源归档（ingest · awesome-bfm-papers 第 33/41）

- **标题：** Fast Adaptation With Behavioral Foundation Models
- **类型：** paper
- **BFM 分类：** 04 Adaptation（[awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers)）
- **出处：** 2025 · CoRL
...
- **入库日期：** 2026-05-26
- **一句话说明：** 适配速度决定 BFM 工程价值：新任务样本与开发成本。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 04 Adaptation，编号 **33/41**。
- **公众号导读要点：** 适配速度决定 BFM 工程价值：新任务样本与开发成本。
