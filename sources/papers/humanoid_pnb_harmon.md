...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Harmon__Whole-Body_Motion_Generation_of_Humanoid_Robots_from_Language_Descriptio/Harmon__Whole-Body_Motion_Generation_of_Humanoid_Robots_from_Language_Descriptio.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-harmon](../../wiki/entities/paper-notebook-harmon.md).

## 对 wiki 的映射

- [paper-notebook-harmon](../../wiki/entities/paper-notebook-harmon.md)
