...
updated: 2026-09-20
arxiv: "2102.03479"
summary: "Guidance on experimental design choices that materially affect reported results."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2102_03479_empirical-design-in-reinforcement-le.md
...
**Empirical Design in Reinforcement Learning** 收录于 awesome-physical-ai（natnew）**第 108/384** 条，分组 **Evaluation Methodology**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Guidance on experimental design choices that materially affect reported results.
...
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2102.03479> |
| arXiv | 2102.03479 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2102.03479) 为准。
...
**本条目的站内价值是把「Empirical Design in Reinforcement Learning」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2102_03479_empirical-design-in-reinforcement-le.md`](../../sources/papers/pai_awesome_2102_03479_empirical-design-in-reinforcement-le.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2102.03479)
