...
arxiv: "2503.13587"
venue: "arXiv 2025"
summary: "Unified driving world model for future generation and perception."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_13587_unifuture-a-unified-driving-world-model.md
...
**UniFuture: A Unified Driving World Model for Future Generation and Perception** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 490/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified driving world model for future generation and perception.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.13587> |
| 项目页 | <https://github.com/dk-liang/UniFuture> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.13587) 为准。
...
**本条目的站内价值是把「UniFuture」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_13587_unifuture-a-unified-driving-world-model.md`](../../sources/papers/sun_awesome_wm_2503_13587_unifuture-a-unified-driving-world-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.13587)
