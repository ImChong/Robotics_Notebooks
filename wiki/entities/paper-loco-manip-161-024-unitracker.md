...
**UniTracker** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 024/161** 篇，归类为 **01 运控基座与通用全身跟踪**。
...
- UniTracker 把相机图像/多视角观测、本体状态与关节序列、仿真交互数据转成可跟踪的身体目标，并通过教师-学生知识迁移、PPO/RL 策略训练、扩散策略/流匹配训练或组合全身策略，最终输出全身轨迹/动作序列、低层控制器目标。关键点是用特权信息训练教师策略，再把能力蒸馏到只能使用部署观测的学生策略。
- 人形 Loco-Manip 161 篇 **#024/161** · 运控基座与通用全身跟踪。
...
| 发表日期 | 2025年9月18日 |
| 论文/项目 | https://yinkangning0124.github.io/Humanoid-UniTracker/ |
...
- 本页为 161 篇清单索引条目，未搬运量化 benchmark；跟踪精度与动作覆盖范围以 [原文 / 项目页](https://yinkangning0124.github.io/Humanoid-UniTracker/) 为准。
...
- 原始 source：[loco_manip_161_survey_024_unitracker.md](../../sources/papers/loco_manip_161_survey_024_unitracker.md)
