...
- **标题：** Integrated linkage-driven dexterous anthropomorphic robotic hand
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/integrated-linkage-driven-dexterous-anthropomorp/integrated-linkage-driven-dexterous-anthropomorp.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-integrated-linkage-driven-dexterous-anthropomorp](../../wiki/entities/paper-notebook-integrated-linkage-driven-dexterous-anthropomorp.md).

## 对 wiki 的映射

- [paper-notebook-integrated-linkage-driven-dexterous-anthropomorp](../../wiki/entities/paper-notebook-integrated-linkage-driven-dexterous-anthropomorp.md)
