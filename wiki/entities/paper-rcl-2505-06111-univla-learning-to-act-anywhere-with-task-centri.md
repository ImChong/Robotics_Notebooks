...
summary: "UniVLA learns a discrete action vocabulary from language-annotated videos, teaches a vision-language policy to predict that vocabulary, and adapts a visual-conditioned head to physical controls. Its distinguishing idea i"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2505_06111_univla-learning-to-act-anywhere-with-tas.md
...
**UniVLA: Learning to Act Anywhere with Task-centric Latent Actions** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 257/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 编号 | 257/564 |
| 分组 | VLA |
| 出处 | RSS 2025 (arXiv author comments) |
| 论文 | <https://arxiv.org/abs/2505.06111> |
| 子类 / 象限 | 潜动作预训练 · 自回归VLA |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.06111) 为准。
...
**本条目的站内价值是把「UniVLA」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2505_06111_univla-learning-to-act-anywhere-with-tas.md`](../../sources/papers/rcl_awesome_wam_2505_06111_univla-learning-to-act-anywhere-with-tas.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.06111)
