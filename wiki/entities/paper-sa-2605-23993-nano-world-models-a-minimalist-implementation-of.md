...
arxiv: "2605.23993"
venue: "arXiv 2026"
summary: "A minimalist implementation of future video prediction that supports exporting generated videos to downstream 3D pipelines."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_23993_nano-world-models-a-minimalist-implement.md
...
**Nano World Models: A Minimalist Implementation of Future Video Prediction** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 022/571** 篇，分组 **111 General Simulation Platforms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

A minimalist implementation of future video prediction that supports exporting generated videos to downstream 3D pipelines.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.23993> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.23993) 为准。
...
**这一页能给你的是「Nano World Models」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2605_23993_nano-world-models-a-minimalist-implement.md`](../../sources/papers/sun_awesome_wm_2605_23993_nano-world-models-a-minimalist-implement.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.23993)
