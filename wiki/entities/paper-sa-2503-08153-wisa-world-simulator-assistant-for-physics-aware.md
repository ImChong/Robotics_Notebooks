...
summary: "World simulator assistant for physics-aware text-to-video generation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_08153_wisa-world-simulator-assistant-for-physi.md
...
**WISA: World Simulator Assistant for Physics-Aware Text-to-Video Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 168/571** 篇，分组 **51 General Interactive Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.08153> |
| 代码/项目 | <https://github.com/360CVGroup/WISA> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.08153) 为准。
...
**本条目的站内价值是把「WISA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_08153_wisa-world-simulator-assistant-for-physi.md`](../../sources/papers/sun_awesome_wm_2503_08153_wisa-world-simulator-assistant-for-physi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.08153)
