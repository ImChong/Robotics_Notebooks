# [EgoPoser: Robust Real-Time Egocentric Pose Estimation from Sparse and Intermittent Observations Everywhere](https://arxiv.org/pdf/2308.06493)

> 来源归档（ingest · Humanoid Paper Notebooks progress 待深读）

- **标题：** [EgoPoser: Robust Real-Time Egocentric Pose Estimation from Sparse and Intermittent Observations Everywhere](https://arxiv.org/pdf/2308.06493)
- **类型：** paper
...
- **计划笔记路径：** `papers/07_Teleoperation/egoposer-robust-real-time-egocentric-pose-estima/egoposer-robust-real-time-egocentric-pose-estima.md`
- **分类：** 07_Teleoperation
- **入库日期：** 2026-06-11
