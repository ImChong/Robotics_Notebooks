...
**SimToolReal: An Object-Centric Policy for Zero-Shot Dexterous Tool Manipulation** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 013/063** 篇，分组 **22 Zero-Shot Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Proposes an object-centric policy for zero-shot dexterous tool manipulation. Generalizes across a diverse set of everyday tools, achieving strong zero-shot performance
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.16863) 为准。
...
**本条目的站内价值是把「SimToolReal」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
