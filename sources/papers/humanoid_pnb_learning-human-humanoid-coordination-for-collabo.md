...
- **标题：** Learning Human-Humanoid Coordination for Collaborative Object Carrying
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Learning_Human-Humanoid_Coordination_for_Collaborative_Object_Carrying/Learning_Human-Humanoid_Coordination_for_Collaborative_Object_Carrying.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-learning-human-humanoid-coordination-for-collabo](../../wiki/entities/paper-notebook-learning-human-humanoid-coordination-for-collabo.md).

## 对 wiki 的映射

- [paper-notebook-learning-human-humanoid-coordination-for-collabo](../../wiki/entities/paper-notebook-learning-human-humanoid-coordination-for-collabo.md)
