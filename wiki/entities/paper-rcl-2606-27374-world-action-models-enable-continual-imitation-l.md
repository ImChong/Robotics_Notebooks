...
arxiv: "2606.27374"
venue: "2026"
code: https://github.com/ManishGovind/REGEN
summary: "We build on this generative capability to propose Recurrent Generative Replay (REGEN), a continual imitation learning framework that synthesizes pseudo-replay trajectories, enabling a robot policy to rehearse previously"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_27374_world-action-models-enable-continual-imi.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# World Action Models Enable Continual Imitation Learning with Recurrent Genera...

**World Action Models Enable Continual Imitation Learning with Recurrent Generative Replays** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 543/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2606.27374> |
| 代码/项目 | <https://github.com/ManishGovind/REGEN> |
| 子类 / 象限 | 联合视频动作建模 · 记忆与长时序 · 泛化与动作对齐 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.27374) 为准。
...
**本条目的站内价值是把「World Action Models Enable Continual Imitation Learning with Recurrent Genera...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_27374_world-action-models-enable-continual-imi.md`](../../sources/papers/rcl_awesome_wam_2606_27374_world-action-models-enable-continual-imi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.27374)
