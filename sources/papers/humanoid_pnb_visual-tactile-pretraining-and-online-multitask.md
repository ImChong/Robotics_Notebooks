...
- **计划笔记路径：** `papers/06_Manipulation/visual-tactile-pretraining-and-online-multitask/visual-tactile-pretraining-and-online-multitask.md`
- **分类：** 06_Manipulation
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-visual-tactile-pretraining-and-online-multitask](../../wiki/entities/paper-notebook-visual-tactile-pretraining-and-online-multitask.md).

## 对 wiki 的映射

- [paper-notebook-visual-tactile-pretraining-and-online-multitask](../../wiki/entities/paper-notebook-visual-tactile-pretraining-and-online-multitask.md)
