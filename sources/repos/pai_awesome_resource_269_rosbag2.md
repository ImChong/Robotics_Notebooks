...
- **代码：** <https://github.com/ros2/rosbag2>
- **清单摘要：** Standard ROS 2 recording and replay pipeline for debugging and incident analysis.
- **沉淀到 wiki：** [`wiki/entities/painode-269-xrosbag2.md`](../../wiki/entities/painode-269-xrosbag2.md)
...
- 实体页：[`wiki/entities/painode-269-xrosbag2.md`](../../wiki/entities/painode-269-xrosbag2.md)
