...
updated: 2026-09-25
arxiv: "2608.01397"
summary: "We propose SG-WAM, a self-guided framework that learns geometry-aware action-conditioned dynamics directly in the policy-derived representation space. Built on a 0.9B model without large-scale embodied pretraining, SG-WA"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_01397_sg-wam-self-guided-world-modeling-in-geo.md
...
**SG-WAM: Self-Guided World Modeling in Geometry-Aware Policy Space** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 474/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.01397> |
| 项目页 | <https://sg-wam.github.io/> |
| 子类 / 象限 | 潜空间预测与JEPA · 三维多视角建模 · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.01397) 为准。
...
**本条目的站内价值是把「SG-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_01397_sg-wam-self-guided-world-modeling-in-geo.md`](../../sources/papers/rcl_awesome_wam_2608_01397_sg-wam-self-guided-world-modeling-in-geo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.01397)
