...
- **计划笔记路径：** `papers/05_Locomotion/architecture-is-all-you-need-diversity-enabled-s/architecture-is-all-you-need-diversity-enabled-s.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-architecture-is-all-you-need-diversity-enabled-s](../../wiki/entities/paper-notebook-architecture-is-all-you-need-diversity-enabled-s.md).

## 对 wiki 的映射

- [paper-notebook-architecture-is-all-you-need-diversity-enabled-s](../../wiki/entities/paper-notebook-architecture-is-all-you-need-diversity-enabled-s.md)
