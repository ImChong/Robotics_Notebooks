...
> 来源归档（ingest · awesome-bfm-papers 第 22/41）

- **标题：** PHC: Perpetual Humanoid Control for Real-Time Simulated Avatars
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 长期稳定 avatar 控制；身体行为连续性是 BFM 前置积累。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **22/41**。
- **公众号导读要点：** 长期稳定 avatar 控制；身体行为连续性是 BFM 前置积累。
...
## 对 wiki 的映射
  ...
  - [zhengyi-luo](../../wiki/entities/zhengyi-luo.md)
