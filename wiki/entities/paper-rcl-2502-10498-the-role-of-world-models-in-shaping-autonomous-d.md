...
arxiv: "2502.10498"
venue: "2025"
code: https://github.com/LMD0311/Awesome-World-Model
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2502_10498_the-role-of-world-models-in-shaping-auto.md
...
**The Role of World Models in Shaping Autonomous Driving: A Comprehensive Survey** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 215/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/LMD0311/Awesome-World-Model> |
| 子类 / 象限 | 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.10498) 为准。
...
**本条目的站内价值是把「The Role of World Models in Shaping Autonomous Driving」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2502_10498_the-role-of-world-models-in-shaping-auto.md`](../../sources/papers/rcl_awesome_wam_2502_10498_the-role-of-world-models-in-shaping-auto.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.10498)
