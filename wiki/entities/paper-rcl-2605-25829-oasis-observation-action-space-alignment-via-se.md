...
updated: 2026-09-25
arxiv: "2605.25829"
summary: "We propose OASIS, a visuomotor policy that aligns the intermediate representation with the action space via SE(3)SE(3) end-effector trajectory prediction. Across simulation and real-world experiments, OASIS outperforms V"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_25829_oasis-observation-action-space-alignment.md
...
**OASIS: Observation-Action Space Alignment via SE(3) Trajectory Prediction for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 245/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | VLA |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.25829> |
| 项目页 | <https://npuhandsome.github.io/OASIS_web/> |
| 子类 / 象限 | 未来表征辅助VLA · 扩散与流匹配VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.25829) 为准。
...
**本条目的站内价值是把「OASIS」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_25829_oasis-observation-action-space-alignment.md`](../../sources/papers/rcl_awesome_wam_2605_25829_oasis-observation-action-space-alignment.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.25829)
