...
arxiv: "2305.15260"
venue: "arXiv 2023"
summary: "Collaborative world models for offline visual RL."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2305_15260_coworld-making-offline-rl-online-collabo.md
...
**CoWorld: Making Offline RL Online: Collaborative World Models for Offline Visual RL** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 253/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Collaborative world models for offline visual RL.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2305.15260> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2305.15260) 为准。
...
**本条目的站内价值是把「CoWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2305_15260_coworld-making-offline-rl-online-collabo.md`](../../sources/papers/sun_awesome_wm_2305_15260_coworld-making-offline-rl-online-collabo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2305.15260)
