...
**wuji-hand-teleop** 是 [舞肌科技](https://github.com/wuji-technology) 公开的 **遥操作与数据采集** 开源项目：通过ROS2接入多种人体输入设备并实时控制Wuji Hand和机器人手臂，为示范采集和操作闭环提供统一入口。
...
1. 从官方 GitHub/Gitee 组织检索 `wuji-hand-teleop` 仓库并核对 README 许可与依赖。
