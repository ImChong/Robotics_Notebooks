...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/ResMimic__From_General_Motion_Tracking_to_Humanoid_Whole-body_Loco-Manipulation_/ResMimic__From_General_Motion_Tracking_to_Humanoid_Whole-body_Loco-Manipulation_.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-resmimic](../../wiki/entities/paper-notebook-resmimic.md).

## 对 wiki 的映射

- [paper-notebook-resmimic](../../wiki/entities/paper-notebook-resmimic.md)
