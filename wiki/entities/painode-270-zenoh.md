...
status: complete
updated: 2026-09-20
summary: "Data-centric middleware for distributed robotics over constrained and heterogeneous networks."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_270_zenoh.md
...
**Zenoh** 收录于 awesome-physical-ai（natnew）**第 270/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Data-centric middleware for distributed robotics over constrained and heterogeneous networks.
...
- [`sources/repos/pai_awesome_resource_270_zenoh.md`](../../sources/repos/pai_awesome_resource_270_zenoh.md) — 本条目策展摘录
