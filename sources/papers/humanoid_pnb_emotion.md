...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/EMOTION__Expressive_Motion_Sequence_Generation_for_Humanoid_Robots_with_In-Conte/EMOTION__Expressive_Motion_Sequence_Generation_for_Humanoid_Robots_with_In-Conte.md`
