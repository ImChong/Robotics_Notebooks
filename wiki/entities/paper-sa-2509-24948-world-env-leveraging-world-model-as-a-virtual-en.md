...
arxiv: "2509.24948"
venue: "arXiv 2025"
summary: "Leveraging world models as virtual environments for VLA post-training."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_24948_world-env-leveraging-world-model-as-a-vi.md
...
**World-Env: Leveraging World Model as a Virtual Environment for VLA Post-Training** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 232/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Leveraging world models as virtual environments for VLA post-training.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.24948> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.24948) 为准。
...
**这一页能给你的是「World-Env」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2509_24948_world-env-leveraging-world-model-as-a-vi.md`](../../sources/papers/sun_awesome_wm_2509_24948_world-env-leveraging-world-model-as-a-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.24948)
