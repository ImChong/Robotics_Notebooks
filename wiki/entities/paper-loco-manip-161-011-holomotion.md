...
sources:
  - ../../sources/papers/loco_manip_161_survey_011_holomotion.md
...
**HoloMotion** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 011/161** 篇，归类为 **01 运控基座与通用全身跟踪**。
...
- HoloMotion 把人类视频/动捕轨迹转成可跟踪的身体目标，并通过异构动捕与合成平衡数据、扩散策略/流匹配、MM-DiT/Transformer 动作头训练或组合全身策略，最终输出全身轨迹/动作序列、低层控制器目标。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#011/161** · 运控基座与通用全身跟踪。
...
| 机构 | Horizon Robotics |
| 发表日期 | 2026年5月19日 |
| 论文/项目 | https://horizonrobotics.github.io/robot\_lab/holomotion |
...
- 评测原始出处：[原文 / 项目页](https://horizonrobotics.github.io/robot\_lab/holomotion)（见上方「核心信息」表「论文/项目」一行）。
...
- 原始 source：[loco_manip_161_survey_011_holomotion.md](../../sources/papers/loco_manip_161_survey_011_holomotion.md)

## 参考来源

- [loco_manip_161_survey_011_holomotion.md](../../sources/papers/loco_manip_161_survey_011_holomotion.md) — 161 篇策展摘录
...
- 同题深读/既有实体：[holomotion](../entities/holomotion.md)
