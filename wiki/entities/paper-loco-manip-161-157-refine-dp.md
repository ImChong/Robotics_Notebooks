...
**REFINE-DP** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 157/161** 篇，归类为 **09 人形 VLA、世界模型与通用操作**。
...
- REFINE-DP 的实现路径是先把语言指令、相机图像/多视角观测、本体状态与关节序列编码成多模态表征，再用PPO/RL 策略训练、ACT/行为克隆模仿学习、扩散策略/流匹配预测关节位置/力矩命令、低层控制器目标。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#157/161** · 人形 VLA、世界模型与通用操作。
...
| 发表日期 | 2026年3月17日 |
| 论文/项目 | https://refine-dp.github.io/REFINE-DP/ |
...
- 原始 source：[loco_manip_161_survey_157_refine-dp.md](../../sources/papers/loco_manip_161_survey_157_refine-dp.md)

## 参考来源

- [loco_manip_161_survey_157_refine-dp.md](../../sources/papers/loco_manip_161_survey_157_refine-dp.md) — 161 篇策展摘录
...
- 同题深读/既有实体：[paper-htd-refine-monocular-hmr](../entities/paper-htd-refine-monocular-hmr.md)
