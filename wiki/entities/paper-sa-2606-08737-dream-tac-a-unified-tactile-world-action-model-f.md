...
sources:
  - ../../sources/papers/sun_awesome_touch_2606_08737_dream-tac-a-unified-tactile-world-action.md
...
**Dream-Tac: A Unified Tactile World Action Model for Contact-Rich Robot Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 055/065** 篇，分组 **Tactile World Action Models WAM**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified Tactile-World Action Model jointly modeling actions, future visual observations, and tactile dynamics; contact-gated visuotactile fusion and contact-aware attention bias; improves action accuracy by 31.7%.
...
|------|------|
| 编号 | 055/065 |
| 分组 | Tactile World Action Models WAM |
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.08737> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.08737) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-touch-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-touch-technology-map.md) 的 **Tactile World Action Models WAM** 分组逐条展开。
...
**本条目的站内价值是把「Dream-Tac」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Tactile World Action Models WAM** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_touch_2606_08737_dream-tac-a-unified-tactile-world-action.md`](../../sources/papers/sun_awesome_touch_2606_08737_dream-tac-a-unified-tactile-world-action.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.08737)
