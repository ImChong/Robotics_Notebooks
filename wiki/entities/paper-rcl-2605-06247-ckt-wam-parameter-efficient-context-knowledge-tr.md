...
updated: 2026-09-25
arxiv: "2605.06247"
code: https://github.com/YuhuaJiang2002/CKT-WAM
summary: "We propose \\textbf{CKT-WAM}, a parameter-efficient \\textbf{C}ontext \\textbf{K}nowledge \\textbf{T}ransfer framework that transfers teacher WAM's knowledge into a student WAM through a compact context in the text embedding"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_06247_ckt-wam-parameter-efficient-context-know.md
...
**CKT-WAM: Parameter-Efficient Context Knowledge Transfer Between World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 289/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We propose \textbf{CKT-WAM}, a parameter-efficient \textbf{C}ontext \textbf{K}nowledge \textbf{T}ransfer framework that transfers teacher WAM's knowledge into a student WAM through a compact context in the text embedding space, rather than output imitation or dense hidden-state matching. Experiments show that CKT-WA...
...
| 代码/项目 | <https://github.com/YuhuaJiang2002/CKT-WAM> |
| 子类 / 象限 | 高效推理与实时控制 · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.06247) 为准。
...
**本条目的站内价值是把「CKT-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_06247_ckt-wam-parameter-efficient-context-know.md`](../../sources/papers/rcl_awesome_wam_2605_06247_ckt-wam-parameter-efficient-context-know.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.06247)
