...
- **计划笔记路径：** `papers/05_Locomotion/omni-perception-omnidirectional-collision-avoida/omni-perception-omnidirectional-collision-avoida.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-omni-perception-omnidirectional-collision-avoida](../../wiki/entities/paper-notebook-omni-perception-omnidirectional-collision-avoida.md).

## 对 wiki 的映射

- [paper-notebook-omni-perception-omnidirectional-collision-avoida](../../wiki/entities/paper-notebook-omni-perception-omnidirectional-collision-avoida.md)
