...
- **代码：** 未在清单中标注
- **清单摘要：** Promptable transformer for multimodal robot manipulation via in-context generalization. <!-- tags: paper -->
- **沉淀到 wiki：** [`wiki/entities/paper-pai-2210-03094-vima.md`](../../wiki/entities/paper-pai-2210-03094-vima.md)
...
- 实体页：[`wiki/entities/paper-pai-2210-03094-vima.md`](../../wiki/entities/paper-pai-2210-03094-vima.md)
