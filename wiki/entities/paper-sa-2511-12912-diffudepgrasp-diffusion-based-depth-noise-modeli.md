...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2511_12912_diffudepgrasp-diffusion-based-depth-nois.md
...
**DiffuDepGrasp: Diffusion-based Depth Noise Modeling Empowers Sim2Real Robotic Grasping** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 008/063** 篇，分组 **22 Zero-Shot Sim2Real**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A deploy-efficient sim2real framework enabling zero-shot transfer through simulation-exclusive policy training, achieving a 95.7% average success rate on 12-object grasping with zero-shot transfer and strong generalization to unseen objects
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2511.12912> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.12912) 为准。
...
**本条目的站内价值是把「DiffuDepGrasp」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2511_12912_diffudepgrasp-diffusion-based-depth-nois.md`](../../sources/papers/sun_awesome_r2s2r_2511_12912_diffudepgrasp-diffusion-based-depth-nois.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.12912)
