...
arxiv: "2507.12898"
venue: "arXiv 2025"
summary: "Embodied video diffusion model for generalist manipulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2507_12898_vidar-embodied-video-diffusion-model-for.md
...
**Vidar: Embodied Video Diffusion Model for Generalist Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 338/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Embodied video diffusion model for generalist manipulation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2507.12898> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.12898) 为准。
...
- [`sources/papers/sun_awesome_wm_2507_12898_vidar-embodied-video-diffusion-model-for.md`](../../sources/papers/sun_awesome_wm_2507_12898_vidar-embodied-video-diffusion-model-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.12898)
