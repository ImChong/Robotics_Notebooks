...
status: complete
updated: 2026-09-20
summary: "Machine learning discussions."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_034_r-machinelearning.md
...
**r/MachineLearning** 收录于 awesome-physical-ai（aichr）**第 034/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Community |
| 来源清单 | aichr |
| 主链接 | <https://reddit.com/r/MachineLearning> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://reddit.com/r/MachineLearning> |
...
- [`sources/repos/pai_awesome_community_034_r-machinelearning.md`](../../sources/repos/pai_awesome_community_034_r-machinelearning.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://reddit.com/r/MachineLearning)
