...
updated: 2026-09-25
arxiv: "2606.15631"
code: https://github.com/jeongeun980906/ReCAP-Cosmos-Policy
summary: "On PushT, we study how retrieval provides a reusable high-level motion prior for cross-embodiment generalization to unseen goal angles, while on RoboTwin 2.0 our method outperforms cross-embodiment baselines on unseen ta"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_15631_retrieve-don-t-retrain-extending-vision.md
...
**Retrieve, Don't Retrain: Extending Vision Language Action Models to New Tasks at Test Time** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 464/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/jeongeun980906/ReCAP-Cosmos-Policy> |
| 子类 / 象限 | 联合视频动作建模 · 泛化与动作对齐 · 记忆与长时序 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.15631) 为准。
...
**本条目的站内价值是把「Retrieve, Don't Retrain」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_15631_retrieve-don-t-retrain-extending-vision.md`](../../sources/papers/rcl_awesome_wam_2606_15631_retrieve-don-t-retrain-extending-vision.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.15631)
