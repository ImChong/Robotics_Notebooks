...
- **与当前主线并存**：官方较新的 RL 训练与 ONNX 部署多围绕 **mjlab / unitree_sdk2**（另有 Isaac Gym / Isaac Lab 官方仓，见 [Unitree 组织软件生态](./unitree.md)）；本栈属于 **ROS1 遗产主线**，选型时不可与 **unitree_ros2**（DDS 直通）或 MuJoCo 管线混为一谈。
