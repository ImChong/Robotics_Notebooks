...
status: complete
updated: 2026-09-20
summary: "ROS 2 navigation stack with behaviour trees, planners, and recovery patterns."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_264_nav2.md
...
**Nav2** 收录于 awesome-physical-ai（natnew）**第 264/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

ROS 2 navigation stack with behaviour trees, planners, and recovery patterns.
...
- [`sources/repos/pai_awesome_resource_264_nav2.md`](../../sources/repos/pai_awesome_resource_264_nav2.md) — 本条目策展摘录
