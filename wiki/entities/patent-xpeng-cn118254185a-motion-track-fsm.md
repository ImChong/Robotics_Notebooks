...
summary: "小鹏 IRON CN118254185A：动作跟踪异常的等待、恢复与停止切换（2024-06-28 公开/公告）；监测动作信号帧间隔与接收频率，异常时等待保姿、恢复后续跟或转入失败停止状态。…"
---

# 小鹏 IRON · 动作跟踪异常的等待、恢复与停止切换（CN118254185A）

专利 **CN118254185A**（*动作跟踪异常的等待、恢复与停止切换*，小鹏机器人 / IRON 相关布局，2024-06-28）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**监测动作信号帧间隔与接收频率，异常时等待保姿、恢复后续跟或转入失败停止状态。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN118254185A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn118254185a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN118254185A](https://patents.google.com/patent/CN118254185A/zh)
