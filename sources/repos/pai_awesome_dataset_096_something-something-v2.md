...
- **代码：** 未在清单中标注
- **清单摘要：** Action recognition dataset frequently used to pretrain manipulation perception.
- **沉淀到 wiki：** [`wiki/entities/painode-096-somethingsomethingv2.md`](../../wiki/entities/painode-096-somethingsomethingv2.md)
...
- 实体页：[`wiki/entities/painode-096-somethingsomethingv2.md`](../../wiki/entities/painode-096-somethingsomethingv2.md)
