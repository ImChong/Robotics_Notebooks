...
updated: 2026-09-25
arxiv: "2608.00547"
summary: "To make this interface independently studyable, we introduce Oracle Visuo-Tactile Foresight (OVTF), a controlled framework that supplies paired RGB and tactile futures from successful trajectories verified in simulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_00547_disentangling-visuo-tactile-foresight-or.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Disentangling Visuo-Tactile Foresight

**Disentangling Visuo-Tactile Foresight: Oracle-Guided Interface Discovery for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 308/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To make this interface independently studyable, we introduce Oracle Visuo-Tactile Foresight (OVTF), a controlled framework that supplies paired RGB and tactile futures from successful trajectories verified in simulation. Within OVTF, we propose Asymmetric Phase-Local Future Memory (AFM), in which visual memory reads...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.00547> |
| 子类 / 象限 | 评估指标与协议 · 动作策略基础 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.00547) 为准。
...
**本条目的站内价值是把「Disentangling Visuo-Tactile Foresight」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_00547_disentangling-visuo-tactile-foresight-or.md`](../../sources/papers/rcl_awesome_wam_2608_00547_disentangling-visuo-tactile-foresight-or.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.00547)
