...
sources:
  - ../../sources/papers/sun_awesome_ego_2601_16378_cognitively-inspired-tokens-overcome-ego.md
...
**Cognitively-Inspired Tokens Overcome Egocentric Bias in Multimodal Models** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 174/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Multimodal language models perform well on semantic vision-language tasks but fail at spatial reasoning that requires adopting another agent's visual perspective, reflecting a persistent egocentric bias
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2601.16378> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.16378) 为准。
...
**本条目的站内价值是把「Cognitively-Inspired Tokens Overcome Egocentric Bias in Multimodal Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2601_16378_cognitively-inspired-tokens-overcome-ego.md`](../../sources/papers/sun_awesome_ego_2601_16378_cognitively-inspired-tokens-overcome-ego.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.16378)
