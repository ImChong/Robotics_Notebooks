...
updated: 2026-09-25
arxiv: "2607.28405"
summary: "We present QuantWAMs, a PTQ framework that aligns quantization decisions with the calibration context defined by model structure, rollout distribution, and task objective."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_28405_quantwams-calibrating-at-the-right-granu.md
...
**QuantWAMs: Calibrating at the Right Granularity for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 457/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.28405> |
| 项目页 | <https://quantwams.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.28405) 为准。
...
**本条目的站内价值是把「QuantWAMs」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_28405_quantwams-calibrating-at-the-right-granu.md`](../../sources/papers/rcl_awesome_wam_2607_28405_quantwams-calibrating-at-the-right-granu.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.28405)
