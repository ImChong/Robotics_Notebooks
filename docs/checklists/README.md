...
- [前端体验优化清单 v1](frontend-optimization-v1.md) — GitHub Pages 首页与交互体验优化计划（**已完成**，2026-08-04 全部条目打勾；后续前端专项另起 v2）。
...
这些文件记录从 v1 到 v30 的阶段性目标和已完成事项，主要用于追溯决策，不作为当前待办入口。历史版本统一存放在 [`archive/`](archive/) 子目录。
...
- [v29](archive/tech-stack-next-phase-checklist-v29.md)
- [v30](archive/tech-stack-next-phase-checklist-v30.md)
