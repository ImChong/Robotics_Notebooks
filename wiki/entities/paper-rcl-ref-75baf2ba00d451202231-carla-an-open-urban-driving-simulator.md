...
**CARLA: An Open Urban Driving Simulator** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 007/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | CoRL 2017 |
| 论文 | <https://proceedings.mlr.press/v78/dosovitskiy17a.html> |
| 代码/项目 | <https://github.com/carla-simulator/carla> |
| 子类 / 象限 | 物理仿真 · 自动驾驶基准 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.mlr.press/v78/dosovitskiy17a.html) 为准。
...
**本条目的站内价值是把「CARLA」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [原文](https://proceedings.mlr.press/v78/dosovitskiy17a.html)
