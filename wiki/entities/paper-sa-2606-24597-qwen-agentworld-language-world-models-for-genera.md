...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_24597_qwen-agentworld-language-world-models-fo.md
...
**Qwen-AgentWorld: Language World Models for General Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 065/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First native language world models (35B-A3B and 397B-A17B) simulating agentic environments across 7 domains via long CoT reasoning, trained on >10M interaction trajectories.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.24597) 为准。
...
**本条目的站内价值是把「Qwen-AgentWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_24597_qwen-agentworld-language-world-models-fo.md`](../../sources/papers/sun_awesome_wm_2606_24597_qwen-agentworld-language-world-models-fo.md) — 本条目策展摘录
