...
summary: "Real-time and streaming interactive world model with long-horizon memory."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2604_08995_matrix-game-3-0-real-time-and-streaming.md
...
**Matrix-Game 3.0: Real-Time and Streaming Interactive World Model with Long-Horizon Memory** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 178/571** 篇，分组 **52 Game & Open-World Exploration Application**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/SkyworkAI/Matrix-Game/tree/main/Matrix-Game-3> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.08995) 为准。
...
**本条目的站内价值是把「Matrix-Game 3.0」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2604_08995_matrix-game-3-0-real-time-and-streaming.md`](../../sources/papers/sun_awesome_wm_2604_08995_matrix-game-3-0-real-time-and-streaming.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.08995)
