...
updated: 2026-09-20
arxiv: "2207.07802"
summary: "Sim-to-real locomotion approach focused on high-speed deployment-ready policies."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2207_07802_rapid-locomotion-via-rl.md
...
# Rapid Locomotion via RL

**Rapid Locomotion via RL** 收录于 awesome-physical-ai（natnew）**第 202/384** 条，分组 **Locomotion**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real locomotion approach focused on high-speed deployment-ready policies.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2207.07802) 为准。
...
**本条目的站内价值是把「Rapid Locomotion via RL」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2207_07802_rapid-locomotion-via-rl.md`](../../sources/papers/pai_awesome_2207_07802_rapid-locomotion-via-rl.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2207.07802)
