...
COMMUNITY_NAME_OVERRIDES: dict[str, str] = {
    ...
    "wiki/concepts/ros2-basics.md": "机器人操作系统 2 基础（ROS 2）",
    ...
    "wiki/overview/humanoid-amp-motion-prior-survey.md": "人形 AMP 运动先验（Humanoid AMP Motion Prior）",
    ...
    "wiki/overview/paper-notebook-category-04-loco-manipulation-and-wbc.md": "论文深读 · 运动操作与全身控制（Loco-Manipulation and WBC）",
    ...
    "wiki/overview/paper-notebook-category-10-sim-to-real.md": "论文深读 · 仿真到现实（Sim-to-Real）",
