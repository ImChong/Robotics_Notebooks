...
summary: "小鹏 IRON CN118544341A：动作识别的双重滤波与轨迹队列缓冲（2024-08-27 公开/公告）；低通+速度/位置饱和滤波后组织轨迹队列，并可历史拟合预测修正后续动作位置。…"
---

# 小鹏 IRON · 动作识别的双重滤波与轨迹队列缓冲（CN118544341A）

专利 **CN118544341A**（*动作识别的双重滤波与轨迹队列缓冲*，小鹏机器人 / IRON 相关布局，2024-08-27）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**低通+速度/位置饱和滤波后组织轨迹队列，并可历史拟合预测修正后续动作位置。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN118544341A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn118544341a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN118544341A](https://patents.google.com/patent/CN118544341A/zh)
