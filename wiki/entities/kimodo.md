...
- [sources/repos/kimodo-cpp.md](../../sources/repos/kimodo-cpp.md) — LocalAI C++/GGML 移植与 GGUF 权重边界
...
- [机器人论文阅读笔记：Kimodo](https://imchong.github.io/Robot_Learning_Paper_Notebooks/papers/14_Human_Motion/Kimodo__Scaling_Controllable_Human_Motion_Generation/Kimodo__Scaling_Controllable_Human_Motion_Generation.html)
...
- [kimodo.cpp](https://github.com/localai-org/kimodo.cpp) — LocalAI C++/GGML 本地推理移植
