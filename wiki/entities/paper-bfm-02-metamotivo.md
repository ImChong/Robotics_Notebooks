...
**Zero-shot Whole-body Humanoid Control via Behavioral Foundation Models** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 02/41** 篇，归类为 **01 Forward-backward 表征**（2025 · ICLR）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
