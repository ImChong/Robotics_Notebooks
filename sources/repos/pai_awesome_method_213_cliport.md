...
- **代码：** 未在清单中标注
- **清单摘要：** Language-conditioned manipulation with CLIP-based perception and transport-based action heads.
- **沉淀到 wiki：** [`wiki/entities/painode-213-cliport.md`](../../wiki/entities/painode-213-cliport.md)
...
- 实体页：[`wiki/entities/painode-213-cliport.md`](../../wiki/entities/painode-213-cliport.md)
