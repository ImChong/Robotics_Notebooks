...
**UrbanVLA** 是 [银河通用](https://github.com/GalaxyGeneralRobotics) 公开的 **VLA/操作模型** 开源项目：将第一视角视觉、语言指令与机器人状态映射为移动决策，使机器人在室外或半开放城市环境中完成目标导向导航。
...
1. 从官方 GitHub/Gitee 组织检索 `UrbanVLA` 仓库并核对 README 许可与依赖。
