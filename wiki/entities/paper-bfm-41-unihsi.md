...
**Unified Human-Scene Interaction via Prompted Chain-of-Contacts** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 41/41** 篇，归类为 **05 Hierarchical control**（2023 · ICLR）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
