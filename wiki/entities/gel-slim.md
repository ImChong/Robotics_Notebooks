...
- [VTAP Gripper](./paper-vtap-gripper.md) — 掌上光学视触（LED 开关）+ 指尖压阻阵列的夹爪对照
...
- [sources/papers/vtap_gripper_arxiv_2607_15448.md](../../sources/papers/vtap_gripper_arxiv_2607_15448.md) — 掌级视触切换对照
