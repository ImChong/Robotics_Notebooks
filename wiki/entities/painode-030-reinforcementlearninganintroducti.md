...
status: complete
updated: 2026-09-20
summary: "Sutton & Barto. The classic RL textbook, freely available online."
related:
...
**Reinforcement Learning: An Introduction** 收录于 awesome-physical-ai（natnew）**第 030/384** 条，分组 **Books**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sutton & Barto. The classic RL textbook, freely available online.
...
| 分组 | Books |
| 来源清单 | natnew |
| 主链接 | <http://incompleteideas.net/book/the-book.html> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <http://incompleteideas.net/book/the-book.html> |
...
- [原文 / 官方入口](http://incompleteideas.net/book/the-book.html)
