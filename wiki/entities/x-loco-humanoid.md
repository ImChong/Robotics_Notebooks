...
status: draft
updated: 2026-07-30
summary: "X-Loco：为多类地形训练不同特权专家，再根据当前场景自适应选取教师并协同蒸馏成单个视觉速度跟踪策略；最终能力是无参考动作的G1感知行走，项目页已有实机证据但未开放代码。"
related:
...
sources:
  - ../../sources/sites/x-loco-humanoid.md
  - ../../sources/repos/humanoid-motion-intelligence.md
---

# X-Loco

[X-Loco](https://x-loco-humanoid.github.io/) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「Locomotion与运动先验」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

为多类地形训练不同特权专家，再根据当前场景自适应选取教师并协同蒸馏成单个视觉速度跟踪策略；最终能力是无参考动作的G1感知行走，项目页已有实机证据但未开放代码。
...
| 官方入口 | https://x-loco-humanoid.github.io/ |
...
- [X-Loco 来源归档](../../sources/sites/x-loco-humanoid.md)
