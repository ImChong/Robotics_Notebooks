...
- **标题：** From Motion to Behavior: Hierarchical Modeling of Humanoid Generative Behavior Control
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/From_Motion_to_Behavior__Hierarchical_Modeling_of_Humanoid_Generative_Behavior_C/From_Motion_to_Behavior__Hierarchical_Modeling_of_Humanoid_Generative_Behavior_C.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-from-motion-to-behavior](../../wiki/entities/paper-notebook-from-motion-to-behavior.md).

## 对 wiki 的映射

- [paper-notebook-from-motion-to-behavior](../../wiki/entities/paper-notebook-from-motion-to-behavior.md)
