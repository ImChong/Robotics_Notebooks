...
updated: 2026-09-20
arxiv: "1812.07252"
summary: "Bridging the reality gap with progressively more realistic intermediate simulators."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/pai_awesome_1812_07252_sim-to-real-via-sim-to-sim-koos-et-a.md
...
# Sim-to-Real via Sim-to-Sim (Koos et al. line)

**Sim-to-Real via Sim-to-Sim (Koos et al. line)** 收录于 awesome-physical-ai（natnew）**第 338/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Bridging the reality gap with progressively more realistic intermediate simulators.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1812.07252> |
| arXiv | 1812.07252 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1812.07252) 为准。
...
**本条目的站内价值是把「Sim-to-Real via Sim-to-Sim (Koos et al. line)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1812_07252_sim-to-real-via-sim-to-sim-koos-et-a.md`](../../sources/papers/pai_awesome_1812_07252_sim-to-real-via-sim-to-sim-koos-et-a.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1812.07252)
