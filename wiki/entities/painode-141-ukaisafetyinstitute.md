...
status: complete
updated: 2026-09-20
summary: "Government body publishing evaluations and guidance on frontier AI risks."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_141_uk-ai-safety-institute.md
...
**UK AI Safety Institute** 收录于 awesome-physical-ai（natnew）**第 141/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Government body publishing evaluations and guidance on frontier AI risks.
...
- [`sources/repos/pai_awesome_standard_141_uk-ai-safety-institute.md`](../../sources/repos/pai_awesome_standard_141_uk-ai-safety-institute.md) — 本条目策展摘录
