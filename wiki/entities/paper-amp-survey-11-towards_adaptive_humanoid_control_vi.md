...
**Towards Adaptive Humanoid Control via Multi-Behavior Distillation and Reinforced Fine-Tuning** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 11/19** 篇，归类为 **03 多技能与自适应**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_11_towards_adaptive_humanoid_control_via_multi_beha.md](../../sources/papers/humanoid_amp_survey_11_towards_adaptive_humanoid_control_via_multi_beha.md)
