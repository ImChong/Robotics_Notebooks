...
- **沉淀到 wiki：** [`wiki/entities/paper-as-097-mujoco-a-physics-engine-for-model-based-control.md`](../../wiki/entities/paper-as-097-mujoco-a-physics-engine-for-model-based-control.md)
...
- 实体页：[`wiki/entities/paper-as-097-mujoco-a-physics-engine-for-model-based-control.md`](../../wiki/entities/paper-as-097-mujoco-a-physics-engine-for-model-based-control.md)
