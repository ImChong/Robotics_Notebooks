...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2602_13977_wovr-world-models-as-reliable-simulators.md
...
**WoVR: World Models as Reliable Simulators for Post-Training VLA Policies with RL** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 542/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 项目页 | <https://wovr-corl.github.io> |
| 子类 / 象限 | 策略后训练与WM-RL · 记忆与长时序 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.13977) 为准。
...
**本条目的站内价值是把「WoVR」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2602_13977_wovr-world-models-as-reliable-simulators.md`](../../sources/papers/rcl_awesome_wam_2602_13977_wovr-world-models-as-reliable-simulators.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.13977)
