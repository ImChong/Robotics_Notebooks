...
status: complete
updated: 2026-09-20
summary: "Language-conditioned manipulation with CLIP-based perception and transport-based action heads."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_213_cliport.md
...
**CLIPort** 收录于 awesome-physical-ai（natnew）**第 213/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Language-conditioned manipulation with CLIP-based perception and transport-based action heads.
...
- [`sources/repos/pai_awesome_method_213_cliport.md`](../../sources/repos/pai_awesome_method_213_cliport.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://cliport.github.io/)
