...
status: complete
updated: 2026-09-20
summary: "Corke. MATLAB/Python-based introduction to robotics fundamentals."
related:
...
sources:
  - ../../sources/repos/pai_awesome_book_031_robotics-vision-and-control.md
...
**Robotics, Vision and Control** 收录于 awesome-physical-ai（natnew）**第 031/384** 条，分组 **Books**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Corke. MATLAB/Python-based introduction to robotics fundamentals.
...
- [`sources/repos/pai_awesome_book_031_robotics-vision-and-control.md`](../../sources/repos/pai_awesome_book_031_robotics-vision-and-control.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://petercorke.com/rvc/)
