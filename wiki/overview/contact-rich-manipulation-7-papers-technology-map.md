...
- **7 篇各有一页**，可逐篇点开核对接触建模与实验设置。
- 把 7 篇放在一页里横向对照，省去逐篇翻找。
...
| # | 论文 | 开源（入库日） | 详情 |
|---|------|---------------|------|
| 01 | Facet-0 | **部分开源** HF `ManuFacet-1K`；GitHub 仍 Code coming soon（2026-09-11） | [paper-facet-0](../entities/paper-facet-0.md) |
