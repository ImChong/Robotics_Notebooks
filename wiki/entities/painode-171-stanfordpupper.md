...
status: complete
updated: 2026-09-20
summary: "Open-source quadruped robot kit."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_171_stanford-pupper.md
...
**Stanford Pupper** 收录于 awesome-physical-ai（natnew）**第 171/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-source quadruped robot kit.
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://stanfordstudentrobotics.org/pupper> |
...
- [`sources/repos/pai_awesome_hardware_171_stanford-pupper.md`](../../sources/repos/pai_awesome_hardware_171_stanford-pupper.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://stanfordstudentrobotics.org/pupper)
