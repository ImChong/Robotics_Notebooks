...
sources:
  - ../../sources/papers/sun_awesome_ego_2404_01688_prego-online-mistake-detection-in-proced.md
...
**PREGO: Online Mistake Detection in PRocedural EGOcentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 122/249** 篇，分组 **291 Procedural Error Detection**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Online real-time mistake detection framework tailored for egocentric procedural videos
...
| 出处 | CVPR 2024 |
| 论文 | <https://arxiv.org/abs/2404.01688> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2404.01688) 为准。
...
**本条目的站内价值是把「PREGO」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2404_01688_prego-online-mistake-detection-in-proced.md`](../../sources/papers/sun_awesome_ego_2404_01688_prego-online-mistake-detection-in-proced.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2404.01688)
