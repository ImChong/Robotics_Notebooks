...
status: complete
updated: 2026-09-20
summary: "Austin Lyons. Semiconductors, AI, and robotics strategy. Excellent 'Robots That See' series on computer vision for robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_228_chipstrat.md
...
**Chipstrat** 收录于 awesome-physical-ai（natnew）**第 228/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Austin Lyons. Semiconductors, AI, and robotics strategy. Excellent "Robots That See" series on computer vision for robotics.
...
- [`sources/repos/pai_awesome_community_228_chipstrat.md`](../../sources/repos/pai_awesome_community_228_chipstrat.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.chipstrat.com/)
