...
updated: 2026-09-25
arxiv: "2606.04907"
summary: "To address these limitations, we propose WAM-Nav, a Latent World-Action Model for embodied visual navigation that jointly learns action generation and latent visual foresight, enabling more robust and foresighted navigat"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_04907_wam-nav-asymmetric-latent-world-action-m.md
...
**WAM-Nav: Asymmetric Latent World-Action Modeling for Unified Visual Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 532/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To address these limitations, we propose WAM-Nav, a Latent World-Action Model for embodied visual navigation that jointly learns action generation and latent visual foresight, enabling more robust and foresighted navigation decisions without compromising inference efficiency. To further encourage smooth and consiste...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.04907> |
| 子类 / 象限 | 导航 · 潜空间预测与JEPA · 联合视频动作建模 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.04907) 为准。
...
**本条目的站内价值是把「WAM-Nav」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_04907_wam-nav-asymmetric-latent-world-action-m.md`](../../sources/papers/rcl_awesome_wam_2606_04907_wam-nav-asymmetric-latent-world-action-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.04907)
