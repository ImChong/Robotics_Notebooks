...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_01164_towards-interactive-video-world-modeling.md
...
**Towards Interactive Video World Modeling: Frontiers, Challenges, Benchmarks, and Future Trends** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 540/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Systematically reviews recent research trends, technical developments, evaluation benchmarks, and future directions in interactive world modeling.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.01164> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.01164) 为准。
...
**本条目的站内价值是把「Towards Interactive Video World Modeling」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_01164_towards-interactive-video-world-modeling.md`](../../sources/papers/sun_awesome_wm_2606_01164_towards-interactive-video-world-modeling.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.01164)
