...
> 来源归档（ingest · awesome-bfm-papers 第 21/41）

- **标题：** CASE: Learning Conditional Adversarial Skill Embeddings for Physics-Based Characters
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 条件技能嵌入；与「按 prompt 调身体」同思路。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **21/41**。
- **公众号导读要点：** 条件技能嵌入；与「按 prompt 调身体」同思路。
