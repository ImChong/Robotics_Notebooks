...
status: complete
updated: 2026-09-20
summary: "Standards on ethical and value-based design for autonomous and intelligent systems."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_133_ieee-7000-series.md
...
**IEEE 7000 Series** 收录于 awesome-physical-ai（natnew）**第 133/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Standards on ethical and value-based design for autonomous and intelligent systems.
...
| 来源清单 | natnew |
| 主链接 | <https://standards.ieee.org/initiatives/autonomous-intelligence-systems/standards/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://standards.ieee.org/initiatives/autonomous-intelligence-systems/standards/> |
...
- [`sources/repos/pai_awesome_standard_133_ieee-7000-series.md`](../../sources/repos/pai_awesome_standard_133_ieee-7000-series.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://standards.ieee.org/initiatives/autonomous-intelligence-systems/standards/)
