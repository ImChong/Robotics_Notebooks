...
status: complete
updated: 2026-09-20
summary: "Developing general-purpose humanoid robots for structured workplace environments."
related:
...
sources:
  - ../../sources/repos/pai_awesome_company_048_sanctuary-ai.md
...
**Sanctuary AI** 收录于 awesome-physical-ai（natnew）**第 048/384** 条，分组 **Companies**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Developing general-purpose humanoid robots for structured workplace environments.
...
| 分组 | Companies |
| 来源清单 | natnew |
| 主链接 | <https://www.sanctuary.ai/> |

## 核心原理

Developing general-purpose humanoid robots for structured workplace environments.

该条目在 Physical AI 清单中的角色是 **company**，分组 **Companies**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
- [`sources/repos/pai_awesome_company_048_sanctuary-ai.md`](../../sources/repos/pai_awesome_company_048_sanctuary-ai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.sanctuary.ai/)
