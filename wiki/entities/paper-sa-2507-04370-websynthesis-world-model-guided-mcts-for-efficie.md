...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2507_04370_websynthesis-world-model-guided-mcts-for.md
...
**WebSynthesis: World-Model-Guided MCTS for Efficient WebUI-Trajectory Synthesis** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 516/571** 篇，分组 **83 GUI / Computer-Use Agents**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2507.04370> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.04370) 为准。
...
**本条目的站内价值是把「WebSynthesis」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2507_04370_websynthesis-world-model-guided-mcts-for.md`](../../sources/papers/sun_awesome_wm_2507_04370_websynthesis-world-model-guided-mcts-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.04370)
