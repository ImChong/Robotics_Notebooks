---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, list]
status: complete
updated: 2026-09-20
code: https://github.com/zita-ch/bipedal-robot-learning-collection
summary: "Curated bipedal/humanoid robot-learning papers with a sim-to-real focus."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_283_bipedal-robot-learning-collection.md
...
**Bipedal Robot Learning Collection** 收录于 awesome-physical-ai（natnew）**第 283/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Curated bipedal/humanoid robot-learning papers with a sim-to-real focus.
...
|------|------|
| 编号 | 283/384 |
| 分组 | Related Awesome Lists |
| 来源清单 | natnew |
| 主链接 | <https://github.com/zita-ch/bipedal-robot-learning-collection> |
| 代码/仓库 | <https://github.com/zita-ch/bipedal-robot-learning-collection> |

## 核心原理

Curated bipedal/humanoid robot-learning papers with a sim-to-real focus.

该条目在 Physical AI 清单中的角色是 **list**，分组 **Related Awesome Lists**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/zita-ch/bipedal-robot-learning-collection> |
| 代码/仓库 | <https://github.com/zita-ch/bipedal-robot-learning-collection> |
...
- [`sources/repos/pai_awesome_list_283_bipedal-robot-learning-collection.md`](../../sources/repos/pai_awesome_list_283_bipedal-robot-learning-collection.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/zita-ch/bipedal-robot-learning-collection)
