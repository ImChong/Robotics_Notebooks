...
updated: 2026-09-25
arxiv: "2606.03868"
summary: "We propose Donk, a unified video-action denoising model for dexterous hands."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_03868_unified-video-action-joint-denoising-for.md
...
**Unified Video-Action Joint Denoising for Dexterous Action and Data Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 508/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We propose Donk, a unified video-action denoising model for dexterous hands.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.03868> |
| 子类 / 象限 | 联合视频动作建模 · 灵巧操作 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.03868) 为准。
...
**本条目的站内价值是把「Unified Video-Action Joint Denoising for Dexterous Action and Data Generation」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_03868_unified-video-action-joint-denoising-for.md`](../../sources/papers/rcl_awesome_wam_2606_03868_unified-video-action-joint-denoising-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.03868)
