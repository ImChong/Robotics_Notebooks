...
sources:
  - ../../sources/papers/sun_awesome_ego_2605_19559_egocot-bench-benchmarking-grounded-and-v.md
...
**EgoCoT-Bench: Benchmarking Grounded and Verifiable Operation-Centric Chain of Thought Reasoning for MLLMs** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 137/249** 篇，分组 **293 Procedural Question Answering**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A fine-grained egocentric benchmark comprising 3,172 verifiable QA pairs over 351 egocentric videos across 12 sub-task groups
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.19559> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.19559) 为准。
...
**本条目的站内价值是把「EgoCoT-Bench」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2605_19559_egocot-bench-benchmarking-grounded-and-v.md`](../../sources/papers/sun_awesome_ego_2605_19559_egocot-bench-benchmarking-grounded-and-v.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.19559)
