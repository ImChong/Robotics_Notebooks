...
status: complete
updated: 2026-09-20
summary: "Navigation benchmark focused on sim-to-real transfer and unseen-scene generalization."
related:
...
sources:
  - ../../sources/repos/pai_awesome_benchmark_021_robothor.md
...
**RoboTHOR** 收录于 awesome-physical-ai（natnew）**第 021/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Navigation benchmark focused on sim-to-real transfer and unseen-scene generalization.
...
| 分组 | Benchmarks |
| 来源清单 | natnew |
| 主链接 | <https://ai2thor.allenai.org/robothor/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://ai2thor.allenai.org/robothor/> |
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 导航基准显式对齐 sim 与真机同构场景，正是该闭环第 ④ 层「sim↔real 评测 gap 校准」要的那种对照装置

## 参考来源

- [`sources/repos/pai_awesome_benchmark_021_robothor.md`](../../sources/repos/pai_awesome_benchmark_021_robothor.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://ai2thor.allenai.org/robothor/)
