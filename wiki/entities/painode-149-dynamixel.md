...
sources:
  - ../../sources/repos/pai_awesome_hardware_149_dynamixel.md
...
**Dynamixel** 收录于 awesome-physical-ai（aichr）**第 149/384** 条，分组 **Hardware & Actuation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://robotis.us/dynamixel/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://robotis.us/dynamixel/> |
...
- [`sources/repos/pai_awesome_hardware_149_dynamixel.md`](../../sources/repos/pai_awesome_hardware_149_dynamixel.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robotis.us/dynamixel/)
