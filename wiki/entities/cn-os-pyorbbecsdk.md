...
**pyorbbecsdk** 是 [奥比中光](https://github.com/orbbec) 公开的 **SDK/驱动** 开源项目：提供OrbbecSDK的Python绑定，便于快速构建深度感知、采集和标定工具。
...
1. 从官方 GitHub/Gitee 组织检索 `pyorbbecsdk` 仓库并核对 README 许可与依赖。
