...
- **代码：** 未在清单中标注
- **清单摘要：** Mobile manipulator for service robotics.
- **沉淀到 wiki：** [`wiki/entities/painode-167-palroboticstiago.md`](../../wiki/entities/painode-167-palroboticstiago.md)
...
- 实体页：[`wiki/entities/painode-167-palroboticstiago.md`](../../wiki/entities/painode-167-palroboticstiago.md)
