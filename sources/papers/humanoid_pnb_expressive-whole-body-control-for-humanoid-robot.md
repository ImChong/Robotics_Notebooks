...
- **计划笔记路径：** `papers/03_High_Impact_Selection/expressive-whole-body-control-for-humanoid-robot/expressive-whole-body-control-for-humanoid-robot.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-expressive-whole-body-control-for-humanoid-robot](../../wiki/entities/paper-notebook-expressive-whole-body-control-for-humanoid-robot.md).

## 对 wiki 的映射

- [paper-notebook-expressive-whole-body-control-for-humanoid-robot](../../wiki/entities/paper-notebook-expressive-whole-body-control-for-humanoid-robot.md)
