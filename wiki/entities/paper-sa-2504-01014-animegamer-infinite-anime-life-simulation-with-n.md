...
arxiv: "2504.01014"
venue: "arXiv 2025"
summary: "Infinite anime life simulation with next game state prediction."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2504_01014_animegamer-infinite-anime-life-simulatio.md
...
**AnimeGamer: Infinite Anime Life Simulation with Next Game State Prediction** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 170/571** 篇，分组 **52 Game & Open-World Exploration Application**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Infinite anime life simulation with next game state prediction.
...
| 项目页 | <https://howe125.github.io/AnimeGamer.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2504.01014) 为准。
...
**本条目的站内价值是把「AnimeGamer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2504_01014_animegamer-infinite-anime-life-simulatio.md`](../../sources/papers/sun_awesome_wm_2504_01014_animegamer-infinite-anime-life-simulatio.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2504.01014)
