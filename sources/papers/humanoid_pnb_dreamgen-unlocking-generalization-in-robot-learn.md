...
- **标题：** DreamGen: Unlocking Generalization in Robot Learning through Neural Trajectories
- **类型：** paper
...
- **计划笔记路径：** `papers/06_Manipulation/dreamgen-unlocking-generalization-in-robot-learn/dreamgen-unlocking-generalization-in-robot-learn.md`
- **分类：** 06_Manipulation
