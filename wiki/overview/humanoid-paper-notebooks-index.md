...
summary: "Humanoid Paper Notebooks 137+ 篇深读笔记在本库的分类父节点与 wiki 子节点总索引（共 665 篇）。"
---
...
- [Foundational RL（基础强化学习）](./paper-notebook-category-01-foundational-rl.md) — `01_Foundational_RL`，28 篇
- [Motion Retargeting（运动重定向）](./paper-notebook-category-02-motion-retargeting.md) — `02_Motion_Retargeting`，4 篇
- [High Impact Selection（高影响力精选）](./paper-notebook-category-03-high-impact-selection.md) — `03_High_Impact_Selection`，37 篇
- [Loco-Manipulation and WBC（运动操作与全身控制）](./paper-notebook-category-04-loco-manipulation-and-wbc.md) — `04_Loco-Manipulation_and_WBC`，262 篇
- [Locomotion（行走运动）](./paper-notebook-category-05-locomotion.md) — `05_Locomotion`，82 篇
- [Manipulation（灵巧操作）](./paper-notebook-category-06-manipulation.md) — `06_Manipulation`，57 篇
- [Teleoperation（遥操作）](./paper-notebook-category-07-teleoperation.md) — `07_Teleoperation`，24 篇
- [Navigation（导航）](./paper-notebook-category-08-navigation.md) — `08_Navigation`，18 篇
- [State Estimation（状态估计）](./paper-notebook-category-09-state-estimation.md) — `09_State_Estimation`，12 篇
- [Sim-to-Real（仿真到现实）](./paper-notebook-category-10-sim-to-real.md) — `10_Sim-to-Real`，11 篇
- [Simulation Benchmark（仿真与基准）](./paper-notebook-category-11-simulation-benchmark.md) — `11_Simulation_Benchmark`，20 篇
- [Hardware Design（硬件设计）](./paper-notebook-category-12-hardware-design.md) — `12_Hardware_Design`，39 篇
- [Physics-Based Animation（物理动画）](./paper-notebook-category-13-physics-based-animation.md) — `13_Physics-Based_Animation`，31 篇
