...
**SENSEI: Semantic Exploration Guided by Foundation Models to Learn Versatile World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 267/571** 篇，分组 **73 Offline & Generalization**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
**这一页能给你的是「SENSEI」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
