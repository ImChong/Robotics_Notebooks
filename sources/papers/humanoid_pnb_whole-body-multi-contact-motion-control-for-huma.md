...
- **标题：** Whole-body Multi-contact Motion Control for Humanoid Robots Based on Distributed Tactile Sensors
- **类型：** paper
...
- **计划笔记路径：** `papers/14_Human_Motion/whole-body-multi-contact-motion-control-for-huma/whole-body-multi-contact-motion-control-for-huma.md`
- **分类：** 14_Human_Motion
...
- 知识归纳见 wiki 实体页：[paper-notebook-whole-body-multi-contact-motion-control-for-huma](../../wiki/entities/paper-notebook-whole-body-multi-contact-motion-control-for-huma.md).

## 对 wiki 的映射

- [paper-notebook-whole-body-multi-contact-motion-control-for-huma](../../wiki/entities/paper-notebook-whole-body-multi-contact-motion-control-for-huma.md)
