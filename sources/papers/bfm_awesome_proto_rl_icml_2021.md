...
> 来源归档（ingest · awesome-bfm-papers 第 27/41）

- **标题：** Reinforcement Learning with Prototypical Representations
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 原型表示组织行为空间，便于上层组合与选择技能。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 03 Intrinsic reward 预训练，编号 **27/41**。
- **公众号导读要点：** 原型表示组织行为空间，便于上层组合与选择技能。
