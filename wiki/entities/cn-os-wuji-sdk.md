...
**wuji-sdk** 是 [舞肌科技](https://github.com/wuji-technology) 公开的 **SDK/驱动** 开源项目：提供Wuji设备发现、实时数据流和记录接口，可连接数据手套与灵巧手采集链路并为遥操作或离线数据处理提供底层输入。
...
1. 从官方 GitHub/Gitee 组织检索 `wuji-sdk` 仓库并核对 README 许可与依赖。
