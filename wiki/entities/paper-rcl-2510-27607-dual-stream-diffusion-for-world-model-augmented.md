...
arxiv: "2510.27607"
venue: "ICML 2026"
summary: "DUST augments a frozen vision-language backbone with jointly denoised actions and future visual embeddings. Separate streams exchange information through attention; independent noise levels and unequal sampling budgets a"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2510_27607_dual-stream-diffusion-for-world-model-au.md
...
**Dual-Stream Diffusion for World-Model Augmented Vision-Language-Action Model** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 330/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

DUST augments a frozen vision-language backbone with jointly denoised actions and future visual embeddings. Separate streams exchange information through attention; independent noise levels and unequal sampling budgets accommodate their different dynamics. Controlled comparisons support improved manipulation, but do...
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.27607) 为准。
...
**本条目的站内价值是把「Dual-Stream Diffusion for World-Model Augmented Vision-Language-Action Model」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2510_27607_dual-stream-diffusion-for-world-model-au.md`](../../sources/papers/rcl_awesome_wam_2510_27607_dual-stream-diffusion-for-world-model-au.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.27607)
