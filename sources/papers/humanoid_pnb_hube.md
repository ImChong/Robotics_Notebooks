...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/HuBE__Cross-Embodiment_Human-like_Behavior_Execution_for_Humanoid_Robots/HuBE__Cross-Embodiment_Human-like_Behavior_Execution_for_Humanoid_Robots.md`
