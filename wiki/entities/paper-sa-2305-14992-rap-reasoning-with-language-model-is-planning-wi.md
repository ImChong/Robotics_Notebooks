...
arxiv: "2305.14992"
venue: "arXiv 2023"
summary: "Formalizes LLM reasoning as planning with a world model."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2305_14992_rap-reasoning-with-language-model-is-pla.md
...
**RAP: Reasoning with language model is planning with world model** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 066/571** 篇，分组 **41 Language-Based World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Formalizes LLM reasoning as planning with a world model.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2305.14992> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2305.14992) 为准。
...
**本条目的站内价值是把「RAP」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2305_14992_rap-reasoning-with-language-model-is-pla.md`](../../sources/papers/sun_awesome_wm_2305_14992_rap-reasoning-with-language-model-is-pla.md) — 本条目策展摘录
