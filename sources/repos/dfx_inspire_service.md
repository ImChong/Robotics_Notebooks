...
- **标题：** dfx_inspire_service
- **类型：** repo
- **来源：** unitreerobotics（Unitree 官方 GitHub 组织）
- **链接：** https://github.com/unitreerobotics/dfx_inspire_service
- **星标（截至 2026-07-24）：** ~49
- **最近推送：** 2025-09-11
- **主要语言：** C++
- **分类：** 灵巧手 Serial↔DDS 服务
- **入库日期：** 2026-07-24
- **一句话说明：** Inspire RH56DFX 灵巧手控制器（Serial↔DDS）。
...
- **已开源**：公开 GitHub 仓库（unitreerobotics/dfx_inspire_service）。
