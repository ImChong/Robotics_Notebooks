...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_17359_position-interactive-generative-video-as.md
...
**Position: Interactive Generative Video as Next-Generation Game Engine** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 038/571** 篇，分组 **113 Interactive World Models & Game Engines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Proposes interactive generative video (IGV) as the foundation of generative game engines (GGE), supporting unlimited novel content generation.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.17359> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.17359) 为准。
...
- [`sources/papers/sun_awesome_wm_2503_17359_position-interactive-generative-video-as.md`](../../sources/papers/sun_awesome_wm_2503_17359_position-interactive-generative-video-as.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.17359)
