...
summary: "Foundation model for depth estimation."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_003_depth-anything.md
...
**Depth Anything** 收录于 awesome-physical-ai（aichr）**第 003/384** 条，分组 **3D Computer Vision**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://github.com/LiheYoung/Depth-Anything> |
| 代码/仓库 | <https://github.com/liheyoung/depth-anything> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/LiheYoung/Depth-Anything> |
| 代码/仓库 | <https://github.com/liheyoung/depth-anything> |
...
- [`sources/repos/pai_awesome_resource_003_depth-anything.md`](../../sources/repos/pai_awesome_resource_003_depth-anything.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/LiheYoung/Depth-Anything)
