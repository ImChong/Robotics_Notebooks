...
| [log-format.md](log-format.md) | `log.md` 叙事条目格式（站点活动以 git 为准） |
...
| [paper-notebook-index.json](paper-notebook-index.json) | Robot Learning Paper Notebooks 137 篇笔记 URL 索引（由脚本同步） |
