...
sources:
  - ../../sources/papers/sun_awesome_ego_2603_13741_ego-1k-a-large-scale-multiview-video-dat.md
...
**Ego-1K: A Large-Scale Multiview Video Dataset for Egocentric Vision** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 237/249** 篇，分组 **Scene Reconstruction & Egocentric SLAM**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Nearly 1,000 multi-view egocentric clips captured by 12 synchronized cameras surrounding a 4-camera VR headset rig
...
| 出处 | CVPR 2026 |
| 论文 | <https://arxiv.org/abs/2603.13741> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.13741) 为准。
...
**本条目的站内价值是把「Ego-1K」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2603_13741_ego-1k-a-large-scale-multiview-video-dat.md`](../../sources/papers/sun_awesome_ego_2603_13741_ego-1k-a-large-scale-multiview-video-dat.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.13741)
