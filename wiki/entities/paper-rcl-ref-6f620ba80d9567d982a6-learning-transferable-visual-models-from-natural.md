...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_6f620ba80d9567d982a6_learning-transferable-visual-models-from.md
...
**Learning Transferable Visual Models From Natural Language Supervision** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 078/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICML 2021 |
| 论文 | <https://proceedings.mlr.press/v139/radford21a.html> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.mlr.press/v139/radford21a.html) 为准。
...
**本条目的站内价值是把「Learning Transferable Visual Models From Natural Language Supervision」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_6f620ba80d9567d982a6_learning-transferable-visual-models-from.md`](../../sources/papers/rcl_awesome_wam_ref_6f620ba80d9567d982a6_learning-transferable-visual-models-from.md) — 本条目策展摘录
