...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Unveiling_the_Impact_of_Data_and_Model_Scaling_on_High-Level_Control_for_Humanoi/Unveiling_the_Impact_of_Data_and_Model_Scaling_on_High-Level_Control_for_Humanoi.md`
