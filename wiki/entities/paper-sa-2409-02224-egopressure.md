...
sources:
  - ../../sources/papers/sun_awesome_ego_2409_02224_egopressure.md
...
**EgoPressure** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 230/249** 篇，分组 **Object & HOI Sub-collections**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2409.02224> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2409.02224) 为准。
...
**本条目的站内价值是把「EgoPressure」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2409_02224_egopressure.md`](../../sources/papers/sun_awesome_ego_2409_02224_egopressure.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2409.02224)
