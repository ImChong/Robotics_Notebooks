...
sources:
  - ../../sources/papers/sun_awesome_ego_2603_23190_gaze-regularized-vlms-for-ego-centric-be.md
...
**Gaze-Regularized VLMs for Ego-Centric Behavior Understanding** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 060/249** 篇，分组 **25 Gaze Attention & Intention Prediction**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Embeds eye-tracking signals into the VLM training pipeline, gaze regularization forces models to prioritize fixated regions, improving semantic metrics by nearly 13%
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2603.23190> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.23190) 为准。
...
**本条目的站内价值是把「Gaze-Regularized VLMs for Ego-Centric Behavior Understanding」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2603_23190_gaze-regularized-vlms-for-ego-centric-be.md`](../../sources/papers/sun_awesome_ego_2603_23190_gaze-regularized-vlms-for-ego-centric-be.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.23190)
