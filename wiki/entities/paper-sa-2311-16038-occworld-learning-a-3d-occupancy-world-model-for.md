...
summary: "Learns a 3D occupancy world model."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2311_16038_occworld-learning-a-3d-occupancy-world-m.md
...
**OccWorld: Learning a 3D Occupancy World Model for Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 466/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns a 3D occupancy world model.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2311.16038> |
| 代码/项目 | <https://github.com/wzzheng/OccWorld> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2311.16038) 为准。
...
**本条目的站内价值是把「OccWorld」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2311_16038_occworld-learning-a-3d-occupancy-world-m.md`](../../sources/papers/sun_awesome_wm_2311_16038_occworld-learning-a-3d-occupancy-world-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2311.16038)
