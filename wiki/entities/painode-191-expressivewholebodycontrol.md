...
status: complete
updated: 2026-09-20
summary: "Whole-body controller producing expressive, human-like motion on a real humanoid (RSS 2024)."
related:
...
sources:
  - ../../sources/repos/pai_awesome_paper_191_expressive-whole-body-control.md
...
**Expressive Whole-Body Control** 收录于 awesome-physical-ai（natnew）**第 191/384** 条，分组 **Locomotion**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Whole-body controller producing expressive, human-like motion on a real humanoid (RSS 2024).
...
| 分组 | Locomotion |
| 来源清单 | natnew |
| 主链接 | <https://expressive-humanoid.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://expressive-humanoid.github.io/) 为准。
...
**本条目的站内价值是把「Expressive Whole-Body Control」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/repos/pai_awesome_paper_191_expressive-whole-body-control.md`](../../sources/repos/pai_awesome_paper_191_expressive-whole-body-control.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://expressive-humanoid.github.io/)
