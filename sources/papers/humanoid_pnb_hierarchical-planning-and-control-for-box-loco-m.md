...
- **标题：** Hierarchical Planning and Control for Box Loco-Manipulation
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/hierarchical-planning-and-control-for-box-loco-m/hierarchical-planning-and-control-for-box-loco-m.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-hierarchical-planning-and-control-for-box-loco-m](../../wiki/entities/paper-notebook-hierarchical-planning-and-control-for-box-loco-m.md).

## 对 wiki 的映射

- [paper-notebook-hierarchical-planning-and-control-for-box-loco-m](../../wiki/entities/paper-notebook-hierarchical-planning-and-control-for-box-loco-m.md)
