...
updated: 2026-09-20
arxiv: "2602.20659"
summary: "Belief-centric architecture for task tracking."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2602_20659_recursive-belief-vla.md
...
# Recursive Belief VLA

**Recursive Belief VLA** 收录于 awesome-physical-ai（aichr）**第 123/384** 条，分组 **Foundation Models (VLA)**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Belief-centric architecture for task tracking.
...
|------|------|
| 编号 | 123/384 |
| 分组 | Foundation Models (VLA) |
| 来源清单 | aichr |
| 主链接 | <https://arxiv.org/abs/2602.20659> |
| arXiv | 2602.20659 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.20659) 为准。
...
**本条目的站内价值是把「Recursive Belief VLA」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Foundation Models (VLA)**，来源 aichr。
...
- [`sources/papers/pai_awesome_2602_20659_recursive-belief-vla.md`](../../sources/papers/pai_awesome_2602_20659_recursive-belief-vla.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2602.20659)
