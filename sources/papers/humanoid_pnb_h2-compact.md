...
- **标题：** H2-COMPACT: Human-Humanoid Co-Manipulation via Adaptive Contact Trajectory Policies
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/H2-COMPACT__Human-Humanoid_Co-Manipulation_via_Adaptive_Contact_Trajectory_Polic/H2-COMPACT__Human-Humanoid_Co-Manipulation_via_Adaptive_Contact_Trajectory_Polic.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-h2-compact](../../wiki/entities/paper-notebook-h2-compact.md).

## 对 wiki 的映射

- [paper-notebook-h2-compact](../../wiki/entities/paper-notebook-h2-compact.md)
