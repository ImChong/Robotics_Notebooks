...
- **代码：** 未在清单中标注
- **清单摘要：** PyTorch co-founder, Meta. Open-source AI.
- **沉淀到 wiki：** [`wiki/entities/painode-253-soumithchintala.md`](../../wiki/entities/painode-253-soumithchintala.md)
...
- 实体页：[`wiki/entities/painode-253-soumithchintala.md`](../../wiki/entities/painode-253-soumithchintala.md)
