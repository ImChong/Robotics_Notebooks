...
sources:
  - ../../sources/papers/sun_awesome_touch_2602_06001_visuo-tactile-world-models-vt-wm.md
...
**Visuo-Tactile World Models (VT-WM)** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 065/065** 篇，分组 **Visuo-Tactile World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First multi-task visuo-tactile world model capturing physics of contact through touch reasoning; 33% better object permanence, 29% better compliance with laws of motion; zero-shot real-robot experiments achieve up to 35% higher success.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.06001> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.06001) 为准。
...
**本条目的站内价值是把「Visuo-Tactile World Models (VT-WM)」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2602_06001_visuo-tactile-world-models-vt-wm.md`](../../sources/papers/sun_awesome_touch_2602_06001_visuo-tactile-world-models-vt-wm.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.06001)
