...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/signbot-learning-human-to-humanoid-sign-language/signbot-learning-human-to-humanoid-sign-language.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2505.24266>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-signbot](../../wiki/entities/paper-notebook-signbot.md).

## 对 wiki 的映射

- [paper-notebook-signbot](../../wiki/entities/paper-notebook-signbot.md)
...
- 论文：<https://arxiv.org/abs/2505.24266>
