...
sources:
  - ../../sources/papers/sun_awesome_ego_2607_02921_r3d-quantitative-3d-spatial-reasoning-fo.md
...
**R3D: Quantitative 3D Spatial Reasoning for Egocentric Wearables** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 216/249** 篇，分组 **Human Pose & Mesh Recovery**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces R3D-Bench with 3,033 quantitative spatial reasoning questions across 15 types built on Aria Digital Twin. Proposes R3D model-agnostic spatial tool-calling framework achieving 73.5% mean relative accuracy
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2607.02921> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.02921) 为准。
...
**本条目的站内价值是把「R3D」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2607_02921_r3d-quantitative-3d-spatial-reasoning-fo.md`](../../sources/papers/sun_awesome_ego_2607_02921_r3d-quantitative-3d-spatial-reasoning-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.02921)
