...
# fast-livo2-deep-robotics

## 一句话定义

**fast-livo2-deep-robotics** 是 [云深处科技](https://github.com/DeepRoboticsLab) 公开的 **工程与工具** 开源项目：感知/定位/建图模块：为导航与控制提供环境状态
...
1. 从官方 GitHub/Gitee 组织检索 `fast-livo2-deep-robotics` 仓库并核对 README 许可与依赖。
