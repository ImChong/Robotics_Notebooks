...
status: complete
updated: 2026-05-26
summary: "跟踪 + 抗扰一体；被推撞后仍能接住才算可用身体能力。"
related:
...
**Track Any Motions under Any Disturbances** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 08/41** 篇，归类为 **02 Goal-conditioned 学习**（2025 · arXiv）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_opentrack_arxiv_2509_13833.md](../../sources/papers/bfm_awesome_opentrack_arxiv_2509_13833.md)
