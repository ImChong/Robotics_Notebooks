...
sources:
  - ../../sources/papers/sun_awesome_ego_2602_15892_egocentric-bias-in-vision-language-model.md
...
**Egocentric Bias in Vision-Language Models** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 186/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Introduces FlipSet, a diagnostic benchmark for Level-2 visual perspective taking in VLMs. Evaluating 103 VLMs reveals systematic egocentric bias: the vast majority perform below chance
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.15892> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.15892) 为准。
...
**本条目的站内价值是把「Egocentric Bias in Vision-Language Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2602_15892_egocentric-bias-in-vision-language-model.md`](../../sources/papers/sun_awesome_ego_2602_15892_egocentric-bias-in-vision-language-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.15892)
