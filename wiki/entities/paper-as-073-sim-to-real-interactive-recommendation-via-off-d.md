...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_073_sim-to-real-interactive-recommendation-v.md
...
**Sim-to-Real Interactive Recommendation via Off-Dynamics Reinforcement Learning** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 073/139** 篇，分组 **Recommender System Benchmarks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

LongchaoDa AwesomeSim2Real 收录；分组 Recommender System Benchmarks。 本页为策展索引级节点，细节以原文为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://offline-rl-neurips.github.io/2021/pdf/50.pdf) 为准。
- 横向对照请回到 [技术地图](../overview/lc-awesome-sim2real-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/lc-awesome-sim2real-technology-map.md) 的 **Recommender System Benchmarks** 分组逐条展开。
...
**本条目的站内价值是把「Sim-to-Real Interactive Recommendation via Off-Dynamics Reinforcement Learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

- 可确证的是策展坐标：列表分组 **Recommender System Benchmarks**，而不是本页自行推导的新算法结论。
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_073_sim-to-real-interactive-recommendation-v.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_073_sim-to-real-interactive-recommendation-v.md) — 本条目策展摘录
...
- [原文](https://offline-rl-neurips.github.io/2021/pdf/50.pdf)
