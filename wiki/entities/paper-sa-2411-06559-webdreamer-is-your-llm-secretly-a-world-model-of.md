...
summary: "Model-based planning for web agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2411_06559_webdreamer-is-your-llm-secretly-a-world.md
...
**WebDreamer: Is Your LLM Secretly a World Model of the Internet? Model-Based Planning for Web Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 514/571** 篇，分组 **83 GUI / Computer-Use Agents**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2411.06559> |
| 代码/项目 | <https://github.com/OSU-NLP-Group/WebDreamer> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.06559) 为准。
...
**本条目的站内价值是把「WebDreamer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2411_06559_webdreamer-is-your-llm-secretly-a-world.md`](../../sources/papers/sun_awesome_wm_2411_06559_webdreamer-is-your-llm-secretly-a-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.06559)
