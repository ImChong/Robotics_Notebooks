...
status: complete
updated: 2026-09-20
summary: "Open-source framework for multi-robot, multi-vendor fleet orchestration."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_266_open-rmf.md
...
**Open-RMF** 收录于 awesome-physical-ai（natnew）**第 266/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-source framework for multi-robot, multi-vendor fleet orchestration.
...
- [`sources/repos/pai_awesome_resource_266_open-rmf.md`](../../sources/repos/pai_awesome_resource_266_open-rmf.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.open-rmf.org/)
