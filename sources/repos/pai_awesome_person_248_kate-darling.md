...
- **代码：** 未在清单中标注
- **清单摘要：** MIT Media Lab, BD AI Institute. Robotics ethics and human-robot interaction.
- **沉淀到 wiki：** [`wiki/entities/painode-248-katedarling.md`](../../wiki/entities/painode-248-katedarling.md)
...
- 实体页：[`wiki/entities/painode-248-katedarling.md`](../../wiki/entities/painode-248-katedarling.md)
