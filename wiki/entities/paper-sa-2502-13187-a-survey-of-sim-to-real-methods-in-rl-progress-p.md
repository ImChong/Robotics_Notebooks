...
**A Survey of Sim-to-Real Methods in RL: Progress, Prospects and Challenges with Foundation Models** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 062/063** 篇，分组 **Surveys & Overvies**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

The first taxonomy that formally frames sim-to-real techniques from key elements of the Markov Decision Process (State, Action, Transition, and Reward). Covers comprehensive literature from classic to advanced methods including sim-to-real techniques empowered by foundation models. Summarizes the formal evaluation p...
...
| 分组 | Surveys & Overvies |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.13187> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.13187) 为准。
...
**本条目的站内价值是把「A Survey of Sim-to-Real Methods in RL」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2502_13187_a-survey-of-sim-to-real-methods-in-rl-pr.md`](../../sources/papers/sun_awesome_r2s2r_2502_13187_a-survey-of-sim-to-real-methods-in-rl-pr.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.13187)
