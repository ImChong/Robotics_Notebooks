...
summary: "Masked world models for visual control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2206_14244_mwm-masked-world-models-for-visual-contr.md
...
**MWM: Masked World Models for Visual Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 349/571** 篇，分组 **813 Navigation**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | 813 Navigation |
| 出处 | arXiv 2022 |
| 论文 | <https://arxiv.org/abs/2206.14244> |
| 代码/项目 | <https://github.com/younggyoseo/MWM> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2206.14244) 为准。
...
**本条目的站内价值是把「MWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2206_14244_mwm-masked-world-models-for-visual-contr.md`](../../sources/papers/sun_awesome_wm_2206_14244_mwm-masked-world-models-for-visual-contr.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2206.14244)
