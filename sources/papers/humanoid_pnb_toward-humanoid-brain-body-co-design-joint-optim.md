...
- **计划笔记路径：** `papers/12_Hardware_Design/toward-humanoid-brain-body-co-design-joint-optim/toward-humanoid-brain-body-co-design-joint-optim.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-toward-humanoid-brain-body-co-design-joint-optim](../../wiki/entities/paper-notebook-toward-humanoid-brain-body-co-design-joint-optim.md).

## 对 wiki 的映射

- [paper-notebook-toward-humanoid-brain-body-co-design-joint-optim](../../wiki/entities/paper-notebook-toward-humanoid-brain-body-co-design-joint-optim.md)
