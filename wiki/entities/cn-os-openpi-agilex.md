...
**openpi-agilex** 是 [松灵机器人](https://github.com/agilexrobotics) 公开的 **VLA/操作模型** 开源项目：VLA/策略接入：模型输出动作块驱动本体执行
...
1. 从官方 GitHub/Gitee 组织检索 `openpi-agilex` 仓库并核对 README 许可与依赖。
