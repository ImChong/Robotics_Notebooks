...
status: complete
updated: 2026-09-20
summary: "Egocentric video corpus useful for action understanding and embodied perception pretraining."
related:
...
sources:
  - ../../sources/repos/pai_awesome_dataset_089_epic-kitchens-100.md
...
**EPIC-KITCHENS-100** 收录于 awesome-physical-ai（natnew）**第 089/384** 条，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Egocentric video corpus useful for action understanding and embodied perception pretraining.
...
| 分组 | Datasets |
| 来源清单 | natnew |
| 主链接 | <https://epic-kitchens.github.io/2021> |
...
- [`sources/repos/pai_awesome_dataset_089_epic-kitchens-100.md`](../../sources/repos/pai_awesome_dataset_089_epic-kitchens-100.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://epic-kitchens.github.io/2021)
