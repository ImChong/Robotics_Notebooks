...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2412_13772_an-efficient-occupancy-world-model-via-d.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# An Efficient Occupancy World Model via Decoupled Dynamic Flow and Image-assis...

**An Efficient Occupancy World Model via Decoupled Dynamic Flow and Image-assisted Training** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 398/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Efficient occupancy world model via decoupled dynamic flow and image-assisted training.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2412.13772> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2412.13772) 为准。
...
**本条目的站内价值是把「An Efficient Occupancy World Model via Decoupled Dynamic Flow and Image-assis...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2412_13772_an-efficient-occupancy-world-model-via-d.md`](../../sources/papers/sun_awesome_wm_2412_13772_an-efficient-occupancy-world-model-via-d.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2412.13772)
