...
summary: "Dynamic Gaussian splatting for multi-task robotic manipulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2403_08321_manigaussian-dynamic-gaussian-splatting.md
...
**ManiGaussian: Dynamic Gaussian Splatting for Multi-task Robotic Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 309/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2403.08321> |
| 代码/项目 | <https://github.com/GuanxingLu/ManiGaussian> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.08321) 为准。
...
- [`sources/papers/sun_awesome_wm_2403_08321_manigaussian-dynamic-gaussian-splatting.md`](../../sources/papers/sun_awesome_wm_2403_08321_manigaussian-dynamic-gaussian-splatting.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.08321)
