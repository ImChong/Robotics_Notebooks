...
status: complete
updated: 2026-05-26
summary: "OmniRetarget 的题目里有一个词很关键：**interaction-preserving**。"
related:
...
**OmniRetarget** 收录于 [具身智能研究室 · 42 篇 humanoid RL 运动控制长文](https://mp.weixin.qq.com/s/hz9JXtJeUPRfUGzfD-pZuA) **第 03/42** 篇，归类为 **01 数据 · 重定向 · 遥操作**。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
| 出处 | curated |
| 链接 | <https://omniretarget.github.io> |

## 与其他页面的关系

- 总框架：[humanoid-rl-motion-control-body-system-stack.md](../overview/humanoid-rl-motion-control-body-system-stack.md)
- AMP 姊妹篇：[humanoid-amp-motion-prior-survey.md](../overview/humanoid-amp-motion-prior-survey.md)
- 原始 source：[humanoid_rl_stack_03_omniretarget_interaction_preserving_data_generat.md](../../sources/papers/humanoid_rl_stack_03_omniretarget_interaction_preserving_data_generat.md)
