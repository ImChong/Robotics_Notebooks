...
- **标题：** RL with Data Bootstrapping for Dynamic Subgoal Pursuit in Humanoid Robot Navigation
- **类型：** paper
...
- **计划笔记路径：** `papers/08_Navigation/rl-with-data-bootstrapping-for-dynamic-subgoal-p/rl-with-data-bootstrapping-for-dynamic-subgoal-p.md`
- **分类：** 08_Navigation
