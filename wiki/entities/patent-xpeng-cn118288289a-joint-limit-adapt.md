...
summary: "小鹏 IRON CN118288289A：面向关节限位的动作轨迹适配（2024-07-05 公开/公告）；外部动作队列经电机限位与多目标优化适配为可执行轨迹，权衡位姿精度与越界风险。…"
---

# 小鹏 IRON · 面向关节限位的动作轨迹适配（CN118288289A）

专利 **CN118288289A**（*面向关节限位的动作轨迹适配*，小鹏机器人 / IRON 相关布局，2024-07-05）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**外部动作队列经电机限位与多目标优化适配为可执行轨迹，权衡位姿精度与越界风险。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN118288289A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn118288289a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN118288289A](https://patents.google.com/patent/CN118288289A/zh)
