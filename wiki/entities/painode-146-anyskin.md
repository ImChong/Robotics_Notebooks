---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, hardware, paper]
status: complete
updated: 2026-09-20
arxiv: "2401.17695"
summary: "Plug-and-play robotic skin."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2401_17695_anyskin.md
...
**AnySkin** 收录于 awesome-physical-ai（aichr）**第 146/384** 条，分组 **Hardware & Actuation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Plug-and-play robotic skin.
...
| 来源清单 | aichr |
| 主链接 | <https://arxiv.org/abs/2401.17695> |
| arXiv | 2401.17695 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2401.17695) 为准。
...
**本条目的站内价值是把「AnySkin」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Hardware & Actuation**，来源 aichr。
...
- [`sources/papers/pai_awesome_2401_17695_anyskin.md`](../../sources/papers/pai_awesome_2401_17695_anyskin.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2401.17695)
