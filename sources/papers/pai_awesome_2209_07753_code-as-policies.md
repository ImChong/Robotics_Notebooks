...
- **代码：** 未在清单中标注
- **清单摘要：** Program-synthesis approach that compiles language instructions into executable robot policies. <!-- tags: paper -->
- **沉淀到 wiki：** [`wiki/entities/paper-pai-2209-07753-codeaspolicies.md`](../../wiki/entities/paper-pai-2209-07753-codeaspolicies.md)
...
- 实体页：[`wiki/entities/paper-pai-2209-07753-codeaspolicies.md`](../../wiki/entities/paper-pai-2209-07753-codeaspolicies.md)
