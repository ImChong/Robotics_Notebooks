...
status: complete
updated: 2026-09-18
code: https://github.com/TATP-233/DISCOVERSE
...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_086_1.md
...
**1** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 086/139** 篇，分组 **Robotics Benchmarks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://air-discoverse.github.io/> |
| 代码/项目 | <https://github.com/TATP-233/DISCOVERSE> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://air-discoverse.github.io/) 为准。
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_086_1.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_086_1.md) — 本条目策展摘录
...
- [原文](https://air-discoverse.github.io/)
