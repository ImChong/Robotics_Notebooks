...
summary: "小鹏 IRON CN120755870A：语音与语义共同驱动的扩散式手势生成（2025-10-10 公开/公告）；梅尔频谱与语义特征条件扩散模型生成与语音同步的手势序列，替代固定预录动作库。…"
---

# 小鹏 IRON · 语音与语义共同驱动的扩散式手势生成（CN120755870A）

专利 **CN120755870A**（*语音与语义共同驱动的扩散式手势生成*，小鹏机器人 / IRON 相关布局，2025-10-10）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**梅尔频谱与语义特征条件扩散模型生成与语音同步的手势序列，替代固定预录动作库。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN120755870A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn120755870a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN120755870A](https://patents.google.com/patent/CN120755870A/zh)
