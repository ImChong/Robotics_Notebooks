...
sources:
  - ../../sources/papers/sun_awesome_touch_2509_10063_twintac-a-wide-range-highly-sensitive-ta.md
...
**TwinTac: A Wide-Range, Highly Sensitive Tactile Sensor with Real-to-Sim Digital Twin Sensor Model** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 045/065** 篇，分组 **Tactile Sensors & Hardware**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Hardware sensor designed for high sensitivity and wide measurement range; digital twin model for simulation.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.10063> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.10063) 为准。
...
**本条目的站内价值是把「TwinTac」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2509_10063_twintac-a-wide-range-highly-sensitive-ta.md`](../../sources/papers/sun_awesome_touch_2509_10063_twintac-a-wide-range-highly-sensitive-ta.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.10063)
