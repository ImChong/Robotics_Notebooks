...
arxiv: "2507.19468"
venue: "arXiv 2025"
summary: "Uses DINO features as a foundation for video world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2507_19468_dino-world-back-to-the-features-dino-as.md
...
**DINO-World: Back to the Features – DINO as a Foundation for Video World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 111/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Uses DINO features as a foundation for video world models.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2507.19468> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.19468) 为准。
...
**本条目的站内价值是把「DINO-World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2507_19468_dino-world-back-to-the-features-dino-as.md`](../../sources/papers/sun_awesome_wm_2507_19468_dino-world-back-to-the-features-dino-as.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.19468)
