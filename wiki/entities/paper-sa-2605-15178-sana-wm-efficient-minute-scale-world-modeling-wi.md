...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_15178_sana-wm-efficient-minute-scale-world-mod.md
...
**SANA-WM: Efficient Minute-Scale World Modeling with Hybrid Linear Diffusion Transformer** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 151/571** 篇，分组 **47 General Foundation World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.15178) 为准。
...
**本条目的站内价值是把「SANA-WM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2605_15178_sana-wm-efficient-minute-scale-world-mod.md`](../../sources/papers/sun_awesome_wm_2605_15178_sana-wm-efficient-minute-scale-world-mod.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.15178)
