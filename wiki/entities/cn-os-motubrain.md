...
**MotuBrain** 是 [生数科技](https://github.com/thu-ml) 公开的 **世界模型** 开源项目：MotuBrain把视频、动作和语言统一建模，并面向多本体适配、长程任务和实时闭环；公开仓库主要承载技术报告、图示和发布材料，适合了解系统定位。
...
| 机构 | 生数科技 |
| 类别 | 世界模型 |
| 官方组织 | https://github.com/thu-ml、https://github.com/shengshu-ai |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `MotuBrain` 仓库并核对 README 许可与依赖。
...
- [生数科技 官方组织](https://github.com/thu-ml)
