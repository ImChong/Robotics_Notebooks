...
- wiki/entities/paper-fierce.md（缺 对比）
- wiki/entities/paper-fpsa-r2s2r.md（缺 评测 / 对比）
- wiki/entities/paper-groot-drifting-action-head.md（缺 评测 / 对比）
- wiki/entities/paper-intermash.md（缺 评测 / 对比）
...
📊 Sources 覆盖率：4071/4071 (100%) wiki/entity 页有 ingest 来源
