...
**DeepMind Control Suite** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 010/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/google-deepmind/dm_control> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1801.00690) 为准。
...
**本条目的站内价值是把「DeepMind Control Suite」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [原文](https://arxiv.org/abs/1801.00690)
