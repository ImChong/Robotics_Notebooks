...
updated: 2026-09-20
arxiv: "2306.03908"
summary: "Segment Anything in 3D scenes."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2306_03908_sam-3d.md
...
**SAM 3D** 收录于 awesome-physical-ai（aichr）**第 008/384** 条，分组 **3D Computer Vision**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://arxiv.org/abs/2306.03908> |
| arXiv | 2306.03908 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2306.03908) 为准。
...
**本条目的站内价值是把「SAM 3D」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **3D Computer Vision**，来源 aichr。
...
- [`sources/papers/pai_awesome_2306_03908_sam-3d.md`](../../sources/papers/pai_awesome_2306_03908_sam-3d.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2306.03908)
