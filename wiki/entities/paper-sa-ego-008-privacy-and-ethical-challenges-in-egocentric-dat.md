...
sources:
  - ../../sources/papers/sun_awesome_ego_noarxiv_008_privacy-and-ethical-challenges-in-egocen.md
...
**Privacy and Ethical Challenges in Egocentric Data Collection** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 008/249** 篇，分组 **2104 Ethics Policy & Social Impact**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Reports on India becoming a hotspot for egocentric AI data collection and the resulting privacy concerns. Points out that egocentric recordings may **inadvertently capture faces, private conversations, sensitive workflows, or bystanders who have not consented**, raising ethical issues around **surveillance, consent,...
...
|------|------|
| 编号 | 008/249 |
| 分组 | 2104 Ethics Policy & Social Impact |
| 出处 | The Indian Express / Moneycontrol 2026 |
| 论文 | <https://indianexpress.com/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://indianexpress.com/) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-ego-technology-map.md) 的 **2104 Ethics Policy & Social Impact** 分组逐条展开。
...
**本条目的站内价值是把「Privacy and Ethical Challenges in Egocentric Data Collection」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **2104 Ethics Policy & Social Impact** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_ego_noarxiv_008_privacy-and-ethical-challenges-in-egocen.md`](../../sources/papers/sun_awesome_ego_noarxiv_008_privacy-and-ethical-challenges-in-egocen.md) — 本条目策展摘录
