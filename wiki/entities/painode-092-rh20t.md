...
status: complete
updated: 2026-09-20
summary: "Robot manipulation dataset with paired human demonstrations for one-shot learning research."
related:
...
sources:
  - ../../sources/repos/pai_awesome_dataset_092_rh20t.md
...
**RH20T** 收录于 awesome-physical-ai（natnew）**第 092/384** 条，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Robot manipulation dataset with paired human demonstrations for one-shot learning research.
...
- [`sources/repos/pai_awesome_dataset_092_rh20t.md`](../../sources/repos/pai_awesome_dataset_092_rh20t.md) — 本条目策展摘录
