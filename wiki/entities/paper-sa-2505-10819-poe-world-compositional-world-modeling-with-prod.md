...
arxiv: "2505.10819"
venue: "arXiv 2025"
summary: "Compositional world modeling with products of programmatic experts."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2505_10819_poe-world-compositional-world-modeling-w.md
...
**PoE-World: Compositional World Modeling with Products of Programmatic Experts** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 139/571** 篇，分组 **46 Symbolic & Neuro-Symbolic World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.10819> |
| 项目页 | <https://topwasu.github.io/poe-world> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.10819) 为准。
...
**本条目的站内价值是把「PoE-World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2505_10819_poe-world-compositional-world-modeling-w.md`](../../sources/papers/sun_awesome_wm_2505_10819_poe-world-compositional-world-modeling-w.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.10819)
