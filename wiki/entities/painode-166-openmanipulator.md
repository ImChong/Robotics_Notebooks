...
status: complete
updated: 2026-09-20
summary: "Affordable open-source robot arm from Robotis."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_166_open-manipulator.md
...
**Open Manipulator** 收录于 awesome-physical-ai（natnew）**第 166/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Affordable open-source robot arm from Robotis.
...
| 来源清单 | natnew |
| 主链接 | <https://emanual.robotis.com/docs/en/platform/openmanipulator_x/overview/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://emanual.robotis.com/docs/en/platform/openmanipulator_x/overview/> |
...
- [`sources/repos/pai_awesome_hardware_166_open-manipulator.md`](../../sources/repos/pai_awesome_hardware_166_open-manipulator.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://emanual.robotis.com/docs/en/platform/openmanipulator_x/overview/)
