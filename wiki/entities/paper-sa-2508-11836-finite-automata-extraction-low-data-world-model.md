...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2508_11836_finite-automata-extraction-low-data-worl.md
...
**Finite Automata Extraction: Low-data World Model Learning as Programs from Gameplay Video** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 133/571** 篇，分组 **46 Symbolic & Neuro-Symbolic World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Low-data world model learning as programs from gameplay video.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.11836> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.11836) 为准。
...
**本条目的站内价值是把「Finite Automata Extraction」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2508_11836_finite-automata-extraction-low-data-worl.md`](../../sources/papers/sun_awesome_wm_2508_11836_finite-automata-extraction-low-data-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2508.11836)
