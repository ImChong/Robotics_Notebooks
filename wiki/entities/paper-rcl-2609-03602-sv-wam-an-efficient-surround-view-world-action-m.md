...
arxiv: "2609.03602"
venue: "2026"
summary: "SV-WAM trains one shared transformer to denoise driving actions and future surround-view video, but blocks action attention to future-video tokens. Deployment retains six-camera history while generating only trajectories"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_03602_sv-wam-an-efficient-surround-view-world.md
...
**SV-WAM: An Efficient Surround-View World-Action Model for End-to-End Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 477/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

SV-WAM trains one shared transformer to denoise driving actions and future surround-view video, but blocks action attention to future-video tokens. Deployment retains six-camera history while generating only trajectories. A differentiable vehicle-footprint loss improves road compliance. The strongest reported result...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.03602> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.03602) 为准。
...
**本条目的站内价值是把「SV-WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_03602_sv-wam-an-efficient-surround-view-world.md`](../../sources/papers/rcl_awesome_wam_2609_03602_sv-wam-an-efficient-surround-view-world.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.03602)
