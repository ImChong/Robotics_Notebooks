...
arxiv: "2506.00320"
venue: "arXiv 2025"
summary: "Synergizes reasoning, acting, and world model simulation in AI agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_00320_dyna-think-synergizing-reasoning-acting.md
...
**Dyna-Think: Synergizing Reasoning, Acting, and World Model Simulation in AI Agents** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 501/571** 篇，分组 **83 GUI / Computer-Use Agents**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Synergizes reasoning, acting, and world model simulation in AI agents.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.00320> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.00320) 为准。
...
**本条目的站内价值是把「Dyna-Think」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2506_00320_dyna-think-synergizing-reasoning-acting.md`](../../sources/papers/sun_awesome_wm_2506_00320_dyna-think-synergizing-reasoning-acting.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.00320)
