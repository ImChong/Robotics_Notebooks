...
- **标题：** ByteWrist: A Parallel Robotic Wrist Enabling Flexible and Anthropomorphic Motion for Confined Spaces
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/bytewrist-a-parallel-robotic-wrist-enabling-flex/bytewrist-a-parallel-robotic-wrist-enabling-flex.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-bytewrist-a-parallel-robotic-wrist-enabling-flex](../../wiki/entities/paper-notebook-bytewrist-a-parallel-robotic-wrist-enabling-flex.md).

## 对 wiki 的映射

- [paper-notebook-bytewrist-a-parallel-robotic-wrist-enabling-flex](../../wiki/entities/paper-notebook-bytewrist-a-parallel-robotic-wrist-enabling-flex.md)
