...
summary: "3D geometry-informed driving world model with precise action control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2505_22421_geodrive-3d-geometry-informed-driving-wo.md
...
**GeoDrive: 3D Geometry-Informed Driving World Model with Precise Action Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 439/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

3D geometry-informed driving world model with precise action control.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.22421> |
| 代码/项目 | <https://github.com/antonioo-c/GeoDrive> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.22421) 为准。
...
**本条目的站内价值是把「GeoDrive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2505_22421_geodrive-3d-geometry-informed-driving-wo.md`](../../sources/papers/sun_awesome_wm_2505_22421_geodrive-3d-geometry-informed-driving-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.22421)
