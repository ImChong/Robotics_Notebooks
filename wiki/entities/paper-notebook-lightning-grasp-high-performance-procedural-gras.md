...
**Lightning Grasp: High Performance Procedural Grasp Synthesis with Contact Fields** 收录于 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html)（分类：06_Manipulation），深读笔记已完成。本页是 **笔记摘要**：要点编译自深读笔记，细节以笔记原文与论文 PDF 为准。
...
- 工程落地友好：代码开源，可作为抓取模块嫁接进更大的灵巧操作（含人形双手）系统。
