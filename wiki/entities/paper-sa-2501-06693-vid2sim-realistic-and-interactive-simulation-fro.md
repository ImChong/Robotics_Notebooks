...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2501_06693_vid2sim-realistic-and-interactive-simula.md
...
**Vid2Sim: Realistic and Interactive Simulation from Video for Urban Navigation** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 029/063** 篇，分组 **31 Real2Sim from Video**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A novel framework that bridges the sim2real gap through a scalable real2sim pipeline for neural 3D scene reconstruction and simulation. Given a monocular video, generates photo-realistic and physically interactable 3D simulation environments
...
| 出处 | CVPR 2025 |
| 论文 | <https://arxiv.org/abs/2501.06693> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.06693) 为准。
...
**本条目的站内价值是把「Vid2Sim」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2501_06693_vid2sim-realistic-and-interactive-simula.md`](../../sources/papers/sun_awesome_r2s2r_2501_06693_vid2sim-realistic-and-interactive-simula.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.06693)
