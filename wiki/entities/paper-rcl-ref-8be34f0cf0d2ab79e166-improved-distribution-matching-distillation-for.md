...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_8be34f0cf0d2ab79e166_improved-distribution-matching-distillat.md
...
**Improved Distribution Matching Distillation for Fast Image Synthesis** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 160/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | NeurIPS 2024 |
| 论文 | <https://proceedings.neurips.cc/paper_files/paper/2024/hash/54dcf25318f9de5a7a01f0a4125c541e-Abstract-Conference.html> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.neurips.cc/paper_files/paper/2024/hash/54dcf25318f9de5a7a01f0a4125c541e-Abstract-Conference.html) 为准。
...
**本条目的站内价值是把「Improved Distribution Matching Distillation for Fast Image Synthesis」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_8be34f0cf0d2ab79e166_improved-distribution-matching-distillat.md`](../../sources/papers/rcl_awesome_wam_ref_8be34f0cf0d2ab79e166_improved-distribution-matching-distillat.md) — 本条目策展摘录
...
- [原文](https://proceedings.neurips.cc/paper_files/paper/2024/hash/54dcf25318f9de5a7a01f0a4125c541e-Abstract-Conference.html)
