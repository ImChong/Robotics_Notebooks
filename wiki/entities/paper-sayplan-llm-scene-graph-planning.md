...
summary: "SayPlan（具身世界模型六路线专题）：从大型场景图检索任务子图并用符号约束检查计划。"
---

# SayPlan

**SayPlan** 收录于 [具身智能研究室 · 具身世界模型六路线综述](https://mp.weixin.qq.com/s/mmIJRp9g6NqblMCjd9D5GQ) **上下文主导型** 段。本页为知识库 **策展编译** 详情节点；量化指标以原文 PDF / 项目页为准。

## 一句话定义

从大型场景图检索任务子图并用符号约束检查计划。
...
|----|------|
| **路线** | 上下文主导型 |
| **出处** | [arXiv:2307.01871](https://arxiv.org/abs/2307.01871) |
| **文内角色** | 从大型场景图检索任务子图并用符号约束检查计划。 |

## 结论

**SayPlan 在六路线框架下的读法：先看预测输出被谁消费，再看是否改善真实行动——而非只看网络新旧或画面观感。**
...
- [arXiv:2307.01871](https://arxiv.org/abs/2307.01871)
