---
type: entity
tags: [repo, china-embodied-opensource, open-source, project, ti5robot]
status: draft
updated: 2026-09-06
related:
...
**ros2_sdk** 是 [星动纪元](https://github.com/roboterax) 公开的 **SDK/驱动** 开源项目：官方 SDK：真机控制与状态读取的统一接入层
...
1. 从官方 GitHub/Gitee 组织检索 `ros2_sdk` 仓库并核对 README 许可与依赖。
