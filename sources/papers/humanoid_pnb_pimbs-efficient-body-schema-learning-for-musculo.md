...
- 知识归纳见 wiki 实体页：[paper-notebook-pimbs-efficient-body-schema-learning-for-musculo](../../wiki/entities/paper-notebook-pimbs-efficient-body-schema-learning-for-musculo.md).

## 对 wiki 的映射

- [paper-notebook-pimbs-efficient-body-schema-learning-for-musculo](../../wiki/entities/paper-notebook-pimbs-efficient-body-schema-learning-for-musculo.md)
