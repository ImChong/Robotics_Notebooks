...
status: complete
updated: 2026-09-20
code: https://github.com/gt-ripl/awesome-llm-robotics
summary: "LLM/VLM applications in robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_278_awesome-llm-robotics.md
...
**Awesome LLM Robotics** 收录于 awesome-physical-ai（natnew）**第 278/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/GT-RIPL/Awesome-LLM-Robotics> |
| 代码/仓库 | <https://github.com/gt-ripl/awesome-llm-robotics> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/GT-RIPL/Awesome-LLM-Robotics> |
| 代码/仓库 | <https://github.com/gt-ripl/awesome-llm-robotics> |
...
- [`sources/repos/pai_awesome_list_278_awesome-llm-robotics.md`](../../sources/repos/pai_awesome_list_278_awesome-llm-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/GT-RIPL/Awesome-LLM-Robotics)
