...
arxiv: "2504.16693"
venue: "arXiv 2025"
summary: "Employs differentiable physics simulation to end‑to‑end identify 3D rigid‑body dynamics systems from a small number of visual interaction trajectories."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2504_16693_pin-wm-learning-physics-informed-world-m.md
...
**PIN-WM: Learning Physics-Informed World Models for Non-Prehensile Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 028/571** 篇，分组 **112 Differentiable Physics Engines & Neural Simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Employs differentiable physics simulation to end‑to‑end identify 3D rigid‑body dynamics systems from a small number of visual interaction trajectories.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2504.16693> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2504.16693) 为准。
...
**本条目的站内价值是把「PIN-WM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2504_16693_pin-wm-learning-physics-informed-world-m.md`](../../sources/papers/sun_awesome_wm_2504_16693_pin-wm-learning-physics-informed-world-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2504.16693)
