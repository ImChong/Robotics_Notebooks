...
## [2026-07-05] lint | health-check | 自动化 wiki 健康检查
...
- wiki/entities/paper-autonomous-spot-nebula-exploration.md（缺 方法 / 评测 / 对比）
- wiki/entities/paper-spot-rl-distributional-sim2real.md（缺 方法 / 评测 / 对比）
...
📊 Sources 覆盖率：1547/1577 (98%) wiki/entity 页有 ingest 来源
