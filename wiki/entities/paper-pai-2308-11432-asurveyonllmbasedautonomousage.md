...
updated: 2026-09-20
arxiv: "2308.11432"
summary: "Comprehensive survey on LLM-based agents."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2308_11432_a-survey-on-llm-based-autonomous-age.md
...
**A Survey on LLM-based Autonomous Agents** 收录于 awesome-physical-ai（natnew）**第 360/384** 条，分组 **Survey Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Comprehensive survey on LLM-based agents.
...
| 分组 | Survey Papers |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2308.11432> |
| arXiv | 2308.11432 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2308.11432) 为准。
...
**本条目的站内价值是把「A Survey on LLM-based Autonomous Agents」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Survey Papers**，来源 natnew。
...
- [`sources/papers/pai_awesome_2308_11432_a-survey-on-llm-based-autonomous-age.md`](../../sources/papers/pai_awesome_2308_11432_a-survey-on-llm-based-autonomous-age.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2308.11432)
