...
**Hand-4DGS: Feed-Forward 3D Gaussian Splatting for 4D Hand Reconstruction from Egocentric Videos** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 023/249** 篇，分组 **22 Hand-Object Interaction & Fine-grained Activity**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Dynamic 3D hand reconstruction from egocentric videos essential for AR/VR and AI glasses, addressing fast head motion, rapid hand dynamics, severe occlusions, and single-view ambiguity
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.19156) 为准。
...
**本条目的站内价值是把「Hand-4DGS」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_19156_hand-4dgs-feed-forward-3d-gaussian-splat.md`](../../sources/papers/sun_awesome_ego_2606_19156_hand-4dgs-feed-forward-3d-gaussian-splat.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.19156)
