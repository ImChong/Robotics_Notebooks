...
arxiv: "2604.06168"
venue: "2026"
code: https://github.com/UMass-Embodied-AGI/ActionImages
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_06168_action-images-end-to-end-policy-learning.md
...
**Action Images: End-to-End Policy Learning via Multiview Video Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 281/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2604.06168> |
| 代码/项目 | <https://github.com/UMass-Embodied-AGI/ActionImages> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.06168) 为准。
...
**本条目的站内价值是把「Action Images」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_06168_action-images-end-to-end-policy-learning.md`](../../sources/papers/rcl_awesome_wam_2604_06168_action-images-end-to-end-policy-learning.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.06168)
