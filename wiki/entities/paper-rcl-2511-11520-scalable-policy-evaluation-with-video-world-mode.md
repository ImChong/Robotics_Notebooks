...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2511_11520_scalable-policy-evaluation-with-video-wo.md
...
**Scalable Policy Evaluation with Video World Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 054/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2025 |
| 论文 | <https://arxiv.org/abs/2511.11520> |
| 子类 / 象限 | 神经策略评测环境 · 机器人操作基准 · 仿真到真实评测 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.11520) 为准。
...
**本条目的站内价值是把「Scalable Policy Evaluation with Video World Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2511_11520_scalable-policy-evaluation-with-video-wo.md`](../../sources/papers/rcl_awesome_wam_2511_11520_scalable-policy-evaluation-with-video-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2511.11520)
