...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_5c37def65669693c1520_leveraging-procedural-generation-to-benc.md
...
**Leveraging Procedural Generation to Benchmark Reinforcement Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 032/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICML 2020 |
| 论文 | <https://proceedings.mlr.press/v119/cobbe20a.html> |
| 子类 / 象限 | 强化学习基准 · 泛化评测 · 物理仿真 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.mlr.press/v119/cobbe20a.html) 为准。
...
**本条目的站内价值是把「Leveraging Procedural Generation to Benchmark Reinforcement Learning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_5c37def65669693c1520_leveraging-procedural-generation-to-benc.md`](../../sources/papers/rcl_awesome_wam_ref_5c37def65669693c1520_leveraging-procedural-generation-to-benc.md) — 本条目策展摘录
...
- [原文](https://proceedings.mlr.press/v119/cobbe20a.html)
