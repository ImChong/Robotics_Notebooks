...
- **代码：** 未在清单中标注
- **清单摘要：** Multimodal bimanual mobile manipulation dataset with 310K+ trajectories.
- **沉淀到 wiki：** [`wiki/entities/painode-094-robomind.md`](../../wiki/entities/painode-094-robomind.md)
...
- 实体页：[`wiki/entities/painode-094-robomind.md`](../../wiki/entities/painode-094-robomind.md)
