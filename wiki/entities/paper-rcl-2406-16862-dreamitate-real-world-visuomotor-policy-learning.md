...
summary: "Dreamitate learns task-specific video generation from human tool demonstrations, then extracts tool poses from synthesized stereo videos for robot execution. It outperforms the tested Diffusion Policy baseline on four ph"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2406_16862_dreamitate-real-world-visuomotor-policy.md
...
**Dreamitate: Real-World Visuomotor Policy Learning via Video Generation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 318/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2406.16862> |
| 子类 / 象限 | 视觉规划与IDM · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.16862) 为准。
...
**本条目的站内价值是把「Dreamitate」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2406_16862_dreamitate-real-world-visuomotor-policy.md`](../../sources/papers/rcl_awesome_wam_2406_16862_dreamitate-real-world-visuomotor-policy.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.16862)
