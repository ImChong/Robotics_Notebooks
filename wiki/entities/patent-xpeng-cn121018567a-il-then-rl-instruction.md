...
summary: "小鹏 IRON CN121018567A：先模仿参考动作再学习指令的控制策略（2025-11-28 公开/公告）；IL 吸收重定向参考动作后再 RL 学习多维度指令集，降低复杂全身动作从零探索难度。…"
---

# 小鹏 IRON · 先模仿参考动作再学习指令的控制策略（CN121018567A）

专利 **CN121018567A**（*先模仿参考动作再学习指令的控制策略*，小鹏机器人 / IRON 相关布局，2025-11-28）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**IL 吸收重定向参考动作后再 RL 学习多维度指令集，降低复杂全身动作从零探索难度。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN121018567A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn121018567a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN121018567A](https://patents.google.com/patent/CN121018567A/zh)
