...
summary: "星动纪元 开源项目 xbot_sdk_api（SDK/驱动）：官方 SDK：真机控制与状态读取的统一接入层…"
institutions:
  - roboterax
---
...
**xbot_sdk_api** 是 [星动纪元](https://github.com/roboterax) 公开的 **SDK/驱动** 开源项目：官方 SDK：真机控制与状态读取的统一接入层
...
1. 从官方 GitHub/Gitee 组织检索 `xbot_sdk_api` 仓库并核对 README 许可与依赖。
...
- [xbot_sdk_api 源码归档](../../sources/repos/xbot_sdk_api.md)（<https://github.com/roboterax/xbot_sdk_api>）
