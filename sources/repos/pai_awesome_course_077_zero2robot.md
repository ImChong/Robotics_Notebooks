...
- **代码：** 未在清单中标注
- **清单摘要：** Free, from-scratch course on embodied AI that builds MuJoCo-based agents from a basic simulation loop to training a vision-language-action policy.
- **沉淀到 wiki：** [`wiki/entities/painode-077-zero2robot.md`](../../wiki/entities/painode-077-zero2robot.md)
...
- 实体页：[`wiki/entities/painode-077-zero2robot.md`](../../wiki/entities/painode-077-zero2robot.md)
