...
summary: "ROS 2 直接消费 Unitree DDS 消息的官方包（Go2/B2/H1 等），推荐 Humble。"
---

# unitree_ros2

**unitree_ros2** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **ROS 集成** 主线。

## 一句话定义

ROS 2 直接消费 Unitree DDS 消息的官方包（Go2/B2/H1 等），推荐 Humble。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/unitree_ros2`](https://github.com/unitreerobotics/unitree_ros2) |
| 组织分类 | ROS 集成 |
| 星标（2026-07-24） | ~773 |
| 最近推送 | 2026-07-02 |
| 主要语言 | C++ |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/unitree_ros2.md](../../sources/repos/unitree_ros2.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/unitree_ros2>
