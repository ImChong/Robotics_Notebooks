...
**OpenDM** 是 [原力灵机](https://github.com/dexmal) 公开的 **VLA/操作模型** 开源项目：DM0.5根据语言、图像和机器人状态生成动作序列，面向开放指令、长时任务、动态干扰和多本体控制；OpenDM开放基础及任务权重、训练和推理脚本、数据注册示例，以及LIBERO、RoboTwin和SO101后训练流程。
...
| 机构 | 原力灵机 |
| 类别 | VLA/操作模型 |
| 官方组织 | https://github.com/dexmal |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `OpenDM` 仓库并核对 README 许可与依赖。
...
- [原力灵机 官方组织](https://github.com/dexmal)
