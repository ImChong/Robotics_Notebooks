...
**A3_Ultra_usd** 是 [智元机器人](https://github.com/AgibotTech) 公开的 **本体模型资产** 开源项目：仿真级USD按Isaac Sim Asset Structure 3.0组织A3 Ultra的层级、视觉与碰撞网格、质量惯量、关节限制和驱动参数，并通过Physics Variant切换通用USD、PhysX和MuJoCo物理配置。
...
1. 从官方 GitHub/Gitee 组织检索 `A3_Ultra_usd` 仓库并核对 README 许可与依赖。
