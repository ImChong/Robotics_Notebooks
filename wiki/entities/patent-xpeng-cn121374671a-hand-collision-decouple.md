...
summary: "小鹏 IRON CN121374671A：碰撞时切断动力传递的机械手解耦机构（2026-01-23 公开/公告）；关节间传动组件在沿抓握/反向撞击时可分离齿面或利用周向空行程解耦，减少冲击传至电机并可弹性复位。…"
---

# 小鹏 IRON · 碰撞时切断动力传递的机械手解耦机构（CN121374671A）

专利 **CN121374671A**（*碰撞时切断动力传递的机械手解耦机构*，小鹏机器人 / IRON 相关布局，2026-01-23）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**关节间传动组件在沿抓握/反向撞击时可分离齿面或利用周向空行程解耦，减少冲击传至电机并可弹性复位。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN121374671A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn121374671a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN121374671A](https://patents.google.com/patent/CN121374671A/zh)
