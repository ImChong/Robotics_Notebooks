...
updated: 2026-09-25
arxiv: "2608.03244"
summary: "We present UniNav, a unified world-action model that generates future visual observations and continuous waypoint trajectories through a single diffusion process. Based on this unified framework, we introduce two variant"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_03244_uninav-a-unified-world-action-diffusion.md
...
**UniNav: A Unified World-Action Diffusion Model for Visual Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 505/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present UniNav, a unified world-action model that generates future visual observations and continuous waypoint trajectories through a single diffusion process. Based on this unified framework, we introduce two variants: UniNav-Full jointly predicts interpretable future observations and their corresponding traject...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.03244> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.03244) 为准。
...
**本条目的站内价值是把「UniNav」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_03244_uninav-a-unified-world-action-diffusion.md`](../../sources/papers/rcl_awesome_wam_2608_03244_uninav-a-unified-world-action-diffusion.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.03244)
