...
updated: 2026-09-25
arxiv: "2606.01095"
summary: "We introduce a model-agnostic diagnostic framework that compares WAMs and VLAs through two complementary lenses: behavioral rollout analysis and sparse-autoencoder-based feature analysis."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_01095_beyond-task-success-behavioral-and-repre.md
...
**Beyond Task Success: Behavioral and Representational Diagnostics for WAM and VLA** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 132/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We introduce a model-agnostic diagnostic framework that compares WAMs and VLAs through two complementary lenses: behavioral rollout analysis and sparse-autoencoder-based feature analysis.
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.01095> |
| 子类 / 象限 | 行为与表征诊断 · 评估指标与协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.01095) 为准。
...
**本条目的站内价值是把「Beyond Task Success」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_01095_beyond-task-success-behavioral-and-repre.md`](../../sources/papers/rcl_awesome_wam_2606_01095_beyond-task-success-behavioral-and-repre.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.01095)
