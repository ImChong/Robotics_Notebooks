...
**RynnBrain** 是 [阿里巴巴](https://github.com/amap-cvlab) 公开的 **具身Agent/规划** 开源项目：视觉和语言输入先形成场景与任务表示，再输出任务步骤或技能调用，为下层VLA、导航和操作策略提供高层目标；仓库用于理解Rynn体系中大脑层与动作层的接口。
...
1. 从官方 GitHub/Gitee 组织检索 `RynnBrain` 仓库并核对 README 许可与依赖。
