...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2509_06798_synthdrive-scalable-real2sim2real-sensor.md
...
**SynthDrive: Scalable Real2Sim2Real Sensor Simulation Pipeline for High-Fidelity Asset Generation and Driving Data Synthesis** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 049/063** 篇，分组 **42 Simulation Frameworks & Pipelines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A scalable real2sim2real system that leverages 3D generation to automate asset mining, generation, and rare-case data synthesis
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.06798> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.06798) 为准。
...
**本条目的站内价值是把「SynthDrive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2509_06798_synthdrive-scalable-real2sim2real-sensor.md`](../../sources/papers/sun_awesome_r2s2r_2509_06798_synthdrive-scalable-real2sim2real-sensor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.06798)
