...
- 本页为 161 篇清单索引条目，未搬运原文量化 benchmark 与实机指标；数值以 [原文 / 项目页](https://humanoid-ai.github.io) 为准。
...
- 同品牌人类侧数据基础设施：[HumanPlus-1000](./humanplus-1000-dataset.md) — 1000h 同步 ego + SMPL-H/MANO/SLAM（预览已 HF 开源）
