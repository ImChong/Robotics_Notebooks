...
updated: 2026-09-25
arxiv: "2605.10942"
summary: "Motivated by these findings, we propose HarmoWAM, an end-to-end WAM that fully leverages a world model to unify predictive and reactive control, enabling both generalizable transit and precise manipulation. Notably, Harm"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_10942_harmowam-harmonizing-generalizable-and-p.md
...
**HarmoWAM: Harmonizing Generalizable and Precise Manipulation via Adaptive World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 381/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Motivated by these findings, we propose HarmoWAM, an end-to-end WAM that fully leverages a world model to unify predictive and reactive control, enabling both generalizable transit and precise manipulation. Notably, HarmoWAM achieves strong zero-shot generalization across these scenarios, significantly outperforming...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.10942> |
| 项目页 | <https://elbb-yu.github.io/HarmoWAM/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.10942) 为准。
...
**本条目的站内价值是把「HarmoWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_10942_harmowam-harmonizing-generalizable-and-p.md`](../../sources/papers/rcl_awesome_wam_2605_10942_harmowam-harmonizing-generalizable-and-p.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.10942)
