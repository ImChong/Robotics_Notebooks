...
arxiv: "2311.01017"
venue: "arXiv 2023"
summary: "Learns unsupervised world models for autonomous driving via discrete diffusion."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2311_01017_copilot4d-learning-unsupervised-world-mo.md
...
**Copilot4D: Learning Unsupervised World Models for Autonomous Driving via Discrete Diffusion** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 405/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns unsupervised world models for autonomous driving via discrete diffusion.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2311.01017> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2311.01017) 为准。
...
**本条目的站内价值是把「Copilot4D」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2311_01017_copilot4d-learning-unsupervised-world-mo.md`](../../sources/papers/sun_awesome_wm_2311_01017_copilot4d-learning-unsupervised-world-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2311.01017)
