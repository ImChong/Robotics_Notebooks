...
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/04_Loco-Manipulation_and_WBC/PDF-HR__Pose_Distance_Fields_for_Humanoid_Robots/PDF-HR__Pose_Distance_Fields_for_Humanoid_Robots.html>
...
- 知识归纳见 wiki 实体页：[paper-notebook-pdf-hr](../../wiki/entities/paper-notebook-pdf-hr.md).

## 对 wiki 的映射

- [paper-notebook-pdf-hr](../../wiki/entities/paper-notebook-pdf-hr.md)
