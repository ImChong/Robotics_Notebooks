...
status: complete
updated: 2026-09-20
summary: "Mobile manipulator for service robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_167_pal-robotics-tiago.md
...
**PAL Robotics TIAGo** 收录于 awesome-physical-ai（natnew）**第 167/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Mobile manipulator for service robotics.
...
- [`sources/repos/pai_awesome_hardware_167_pal-robotics-tiago.md`](../../sources/repos/pai_awesome_hardware_167_pal-robotics-tiago.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://pal-robotics.com/)
