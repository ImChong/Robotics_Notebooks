...
arxiv: "2602.07131"
venue: "arXiv 2026"
summary: "Models GUI dynamics by generating renderable code rather than pixels."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2602_07131_code2world-a-gui-world-model-via-rendera.md
...
**Code2World: A GUI World Model via Renderable Code Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 499/571** 篇，分组 **83 GUI / Computer-Use Agents**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Models GUI dynamics by generating renderable code rather than pixels.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2602.07131> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2602.07131) 为准。
...
**本条目的站内价值是把「Code2World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2602_07131_code2world-a-gui-world-model-via-rendera.md`](../../sources/papers/sun_awesome_wm_2602_07131_code2world-a-gui-world-model-via-rendera.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2602.07131)
