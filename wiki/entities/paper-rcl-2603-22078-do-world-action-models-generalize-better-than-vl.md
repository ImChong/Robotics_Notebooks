...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_22078_do-world-action-models-generalize-better.md
...
**Do World Action Models Generalize Better than VLAs? A Robustness Study** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 012/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/Robot-Robustness/RoboTwin2.0-Plus> |
| 子类 / 象限 | 机器人操作基准 · 鲁棒性与泛化评测 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.22078) 为准。
...
**本条目的站内价值是把「Do World Action Models Generalize Better than VLAs? A Robustness Study」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_22078_do-world-action-models-generalize-better.md`](../../sources/papers/rcl_awesome_wam_2603_22078_do-world-action-models-generalize-better.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.22078)
