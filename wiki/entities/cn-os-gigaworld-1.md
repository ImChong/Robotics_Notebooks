...
**GigaWorld-1** 是 [极佳视界](https://github.com/open-gigaai) 公开的 **世界模型** 开源项目：GigaWorld-1继续研究机器人动作条件下的未来环境生成、交互一致性和世界模型评测，为具身数据生成与策略训练提供可控环境变化。
...
1. 从官方 GitHub/Gitee 组织检索 `GigaWorld-1` 仓库并核对 README 许可与依赖。
