...
summary: "Task harmonization inside world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2310_00344_harmonydream-task-harmonization-inside-w.md
...
**HarmonyDream: Task Harmonization Inside World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 243/571** 篇，分组 **72 Continuous Control**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2310.00344> |
| 代码/项目 | <https://github.com/thuml/HarmonyDream> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2310.00344) 为准。
...
**本条目的站内价值是把「HarmonyDream」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2310_00344_harmonydream-task-harmonization-inside-w.md`](../../sources/papers/sun_awesome_wm_2310_00344_harmonydream-task-harmonization-inside-w.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2310.00344)
