...
status: complete
updated: 2026-09-20
summary: "Robot Operating System community."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_036_r-ros.md
...
**r/ROS** 收录于 awesome-physical-ai（aichr）**第 036/384** 条，分组 **Community**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Robot Operating System community.
...
- [`sources/repos/pai_awesome_community_036_r-ros.md`](../../sources/repos/pai_awesome_community_036_r-ros.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://reddit.com/r/ROS)
