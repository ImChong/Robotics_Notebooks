...
arxiv: "2606.12783"
venue: "arXiv 2026"
summary: "Presents a coherent framework unifying diverse world modeling approaches through shared predictive structure; connects world modeling techniques to physical AI applications such as robotics and autonomous driving."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_12783_a-tutorial-on-world-models-and-physical.md
...
**A Tutorial on World Models and Physical AI** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 534/571** 篇，分组 **Surveys & Overviews**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Presents a coherent framework unifying diverse world modeling approaches through shared predictive structure; connects world modeling techniques to physical AI applications such as robotics and autonomous driving.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.12783> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.12783) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 的 **Surveys & Overviews** 分组逐条展开。
...
**本条目的站内价值是把「A Tutorial on World Models and Physical AI」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_12783_a-tutorial-on-world-models-and-physical.md`](../../sources/papers/sun_awesome_wm_2606_12783_a-tutorial-on-world-models-and-physical.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.12783)
