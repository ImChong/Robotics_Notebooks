...
updated: 2026-09-25
arxiv: "2608.01221"
summary: "We present EndoWAM, which is, to our knowledge, the first WAM for generalizable robotic endoscopic navigation. EndoWAM consistently outperforms all baselines and alternative grounding strategies, while demonstrating stro"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_01221_endowam-a-grounded-world-action-model-fo.md
...
**EndoWAM: A Grounded World-Action Model for Generalizable Endoscopic Navigation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 341/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present EndoWAM, which is, to our knowledge, the first WAM for generalizable robotic endoscopic navigation. EndoWAM consistently outperforms all baselines and alternative grounding strategies, while demonstrating strong zero-shot generalization to unseen viewpoints, environments, and targets.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.01221> |
| 子类 / 象限 | 导航 · 视觉规划与IDM · 高效推理与实时控制 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.01221) 为准。
...
**本条目的站内价值是把「EndoWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_01221_endowam-a-grounded-world-action-model-fo.md`](../../sources/papers/rcl_awesome_wam_2608_01221_endowam-a-grounded-world-action-model-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.01221)
