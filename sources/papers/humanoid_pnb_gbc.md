...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/GBC__Generalized_Behavior-Cloning_Framework_for_Whole-Body_Humanoid_Imitation/GBC__Generalized_Behavior-Cloning_Framework_for_Whole-Body_Humanoid_Imitation.md`
