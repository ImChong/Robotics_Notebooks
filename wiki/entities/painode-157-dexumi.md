...
status: complete
updated: 2026-09-20
summary: "Dexterous manipulation platform and dataset for multi-fingered robotic hands."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_157_dex-umi.md
...
**Dex-UMI** 收录于 awesome-physical-ai（natnew）**第 157/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Dexterous manipulation platform and dataset for multi-fingered robotic hands.
...
- [`sources/repos/pai_awesome_hardware_157_dex-umi.md`](../../sources/repos/pai_awesome_hardware_157_dex-umi.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://dex-umi.github.io/)
