...
- **代码：** 未在清单中标注
- **清单摘要：** Generalisation benchmark perturbing 14 axes of variation for manipulation.
- **沉淀到 wiki：** [`wiki/entities/painode-012-colosseum.md`](../../wiki/entities/painode-012-colosseum.md)
...
- 实体页：[`wiki/entities/painode-012-colosseum.md`](../../wiki/entities/painode-012-colosseum.md)
