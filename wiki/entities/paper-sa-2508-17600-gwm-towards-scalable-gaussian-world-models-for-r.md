...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2508_17600_gwm-towards-scalable-gaussian-world-mode.md
...
**GWM: Towards Scalable Gaussian World Models for Robotic Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 025/571** 篇，分组 **112 Differentiable Physics Engines & Neural Simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A 3D Gaussian Splatting‑based world model that enhances visual representation learning and serves as a robust neural simulator for model‑based reinforcement learning.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.17600> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.17600) 为准。
...
**本条目的站内价值是把「GWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2508_17600_gwm-towards-scalable-gaussian-world-mode.md`](../../sources/papers/sun_awesome_wm_2508_17600_gwm-towards-scalable-gaussian-world-mode.md) — 本条目策展摘录
