...
**ENACT: Evaluating Embodied Cognition with World Modeling of Egocentric Interaction** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 033/249** 篇，分组 **24 Long-form Video Understanding & Structured Reasoning**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A benchmark for evaluating embodied cognition through egocentric interaction world modeling, revealing that VLMs perform better on inverse tasks than forward prediction
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=Patx6MRipw) 为准。
...
**本条目的站内价值是把「ENACT」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_033_enact-evaluating-embodied-cognition-with.md`](../../sources/papers/sun_awesome_ego_noarxiv_033_enact-evaluating-embodied-cognition-with.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=Patx6MRipw)
