...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2607_03461_worldbagel-uncovering-the-power-of-unifi.md
...
**WorldBagel: Uncovering the Power of Unified Multimodal Models for Vision-Language-Action-World Modeling** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 215/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified VLAW framework outperforming task-specific alternatives.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2607.03461> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.03461) 为准。
...
**本条目的站内价值是把「WorldBagel」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2607_03461_worldbagel-uncovering-the-power-of-unifi.md`](../../sources/papers/sun_awesome_wm_2607_03461_worldbagel-uncovering-the-power-of-unifi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.03461)
