...
updated: 2026-09-25
arxiv: "2605.13548"
code: https://github.com/DaojiePENG/AttenA-Plus
summary: "To rectify this, we introduce AttenA+, an architecture-agnostic framework that prioritizes kinematically critical segments via velocity-driven action attention. Extensive experiments demonstrate that AttenA+ significantl"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_13548_attena-rectifying-action-inequality-in-r.md
...
**AttenA+: Rectifying Action Inequality in Robotic Foundation Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 226/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To rectify this, we introduce AttenA+, an architecture-agnostic framework that prioritizes kinematically critical segments via velocity-driven action attention. Extensive experiments demonstrate that AttenA+ significantly elevates the ceilings of current state-of-the-art models.
...
| 代码/项目 | <https://github.com/DaojiePENG/AttenA-Plus> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.13548) 为准。
...
**本条目的站内价值是把「AttenA+」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_13548_attena-rectifying-action-inequality-in-r.md`](../../sources/papers/rcl_awesome_wam_2605_13548_attena-rectifying-action-inequality-in-r.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.13548)
