...
**Probabilistic Robotics** 收录于 awesome-physical-ai（natnew）**第 029/384** 条，分组 **Books**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Thrun, Burgard, Fox. Essential text on probabilistic methods for robotics.
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://mitpress.mit.edu/9780262201629/> |
...
- [`sources/repos/pai_awesome_book_029_probabilistic-robotics.md`](../../sources/repos/pai_awesome_book_029_probabilistic-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://mitpress.mit.edu/9780262201629/)
