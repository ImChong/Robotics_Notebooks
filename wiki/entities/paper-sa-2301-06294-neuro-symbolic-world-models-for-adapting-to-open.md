...
arxiv: "2301.06294"
venue: "arXiv 2023"
summary: "Neuro-symbolic world models for adapting to open world novelty."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2301_06294_neuro-symbolic-world-models-for-adapting.md
...
**Neuro-Symbolic World Models for Adapting to Open World Novelty** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 136/571** 篇，分组 **46 Symbolic & Neuro-Symbolic World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2301.06294> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2301.06294) 为准。
...
**本条目的站内价值是把「Neuro-Symbolic World Models for Adapting to Open World Novelty」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2301_06294_neuro-symbolic-world-models-for-adapting.md`](../../sources/papers/sun_awesome_wm_2301_06294_neuro-symbolic-world-models-for-adapting.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2301.06294)
