---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, conference]
status: complete
updated: 2026-09-20
summary: "IEEE-RAS International Conference on Humanoid Robots."
related:
...
sources:
  - ../../sources/repos/pai_awesome_conference_056_humanoids.md
...
**Humanoids** 收录于 awesome-physical-ai（natnew）**第 056/384** 条，分组 **Conferences**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Conferences |
| 来源清单 | natnew |
| 主链接 | <https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/humanoids> |

## 核心原理

IEEE-RAS International Conference on Humanoid Robots.

该条目在 Physical AI 清单中的角色是 **conference**，分组 **Conferences**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/humanoids> |
...
- [`sources/repos/pai_awesome_conference_056_humanoids.md`](../../sources/repos/pai_awesome_conference_056_humanoids.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.ieee-ras.org/conferences-workshops/financially-co-sponsored/humanoids)
