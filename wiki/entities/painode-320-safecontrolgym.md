...
summary: "Benchmark suite for safe learning-based control with constraints and disturbances."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_320_safe-control-gym.md
...
**Safe Control Gym** 收录于 awesome-physical-ai（natnew）**第 320/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Benchmark suite for safe learning-based control with constraints and disturbances.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/utiasDSL/safe-control-gym> |
| 代码/仓库 | <https://github.com/utiasdsl/safe-control-gym> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/utiasDSL/safe-control-gym> |
| 代码/仓库 | <https://github.com/utiasdsl/safe-control-gym> |
...
- [`sources/repos/pai_awesome_resource_320_safe-control-gym.md`](../../sources/repos/pai_awesome_resource_320_safe-control-gym.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/utiasDSL/safe-control-gym)
