...
summary: "LLM-enhanced world models for diverse driving video generation."
related:
...
**DriveDreamer-2: LLM-Enhanced World Models for Diverse Driving Video Generation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 417/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://drivedreamer2.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.06845) 为准。
...
**本条目的站内价值是把「DriveDreamer-2」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2403_06845_drivedreamer-2-llm-enhanced-world-models.md`](../../sources/papers/sun_awesome_wm_2403_06845_drivedreamer-2-llm-enhanced-world-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.06845)
