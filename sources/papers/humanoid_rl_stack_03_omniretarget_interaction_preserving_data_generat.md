...
> 来源归档（ingest · 人形 RL 身体系统栈 42 篇 · 第 03/42）
...
- **入库日期：** 2026-05-26
- **一句话说明：** OmniRetarget 的题目里有一个词很关键：**interaction-preserving**。

## 核心摘录（策展，非全文）

- **在身体系统栈中的位置：** 01 数据 · 重定向 · 遥操作，编号 **03/42**。
- **公众号导读要点：** OmniRetarget 的题目里有一个词很关键：**interaction-preserving**。
