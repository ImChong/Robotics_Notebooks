...
summary: "Unified understanding and prediction model for embodied agents."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2501_18867_up-vla-a-unified-understanding-and-predi.md
...
**UP-VLA: A Unified Understanding and Prediction Model for Embodied Agent** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 206/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Unified understanding and prediction model for embodied agents.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2501.18867> |
| 代码/项目 | <https://github.com/CladernyJorn/UP-VLA> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.18867) 为准。
...
**本条目的站内价值是把「UP-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2501_18867_up-vla-a-unified-understanding-and-predi.md`](../../sources/papers/sun_awesome_wm_2501_18867_up-vla-a-unified-understanding-and-predi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.18867)
