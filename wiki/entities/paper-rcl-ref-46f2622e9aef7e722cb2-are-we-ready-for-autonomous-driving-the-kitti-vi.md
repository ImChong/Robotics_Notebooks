...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_46f2622e9aef7e722cb2_are-we-ready-for-autonomous-driving-the.md
...
**Are we ready for autonomous driving? The KITTI vision benchmark suite** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 097/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | CVPR 2012 |
| 论文 | <https://ieeexplore.ieee.org/document/6248074> |
| 项目页 | <https://www.cvlibs.net/datasets/kitti> |
| 子类 / 象限 | 自动驾驶感知数据 · 定位与SLAM数据 · 基准与评测协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://ieeexplore.ieee.org/document/6248074) 为准。
...
**本条目的站内价值是把「Are we ready for autonomous driving? The KITTI vision benchmark suite」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_46f2622e9aef7e722cb2_are-we-ready-for-autonomous-driving-the.md`](../../sources/papers/rcl_awesome_wam_ref_46f2622e9aef7e722cb2_are-we-ready-for-autonomous-driving-the.md) — 本条目策展摘录
...
- [原文](https://ieeexplore.ieee.org/document/6248074)
