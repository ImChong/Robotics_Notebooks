...
status: complete
updated: 2026-09-20
summary: "Vision and Learning Lab."
related:
...
sources:
  - ../../sources/repos/pai_awesome_lab_292_stanford-vl.md
...
**Stanford VL** 收录于 awesome-physical-ai（aichr）**第 292/384** 条，分组 **Research Labs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 分组 | Research Labs |
| 来源清单 | aichr |
| 主链接 | <https://github.com/StanfordVL> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/StanfordVL> |
...
- [`sources/repos/pai_awesome_lab_292_stanford-vl.md`](../../sources/repos/pai_awesome_lab_292_stanford-vl.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/StanfordVL)
