...
arxiv: "2403.00504"
venue: "arXiv 2024"
summary: "Learns and leverages world models in visual representation learning."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2403_00504_iwm-learning-and-leveraging-world-models.md
...
**IWM: Learning and Leveraging World Models in Visual Representation Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 116/571** 篇，分组 **44 Latent Space World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns and leverages world models in visual representation learning.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2403.00504> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2403.00504) 为准。
...
**本条目的站内价值是把「IWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2403_00504_iwm-learning-and-leveraging-world-models.md`](../../sources/papers/sun_awesome_wm_2403_00504_iwm-learning-and-leveraging-world-models.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2403.00504)
