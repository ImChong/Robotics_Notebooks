...
arxiv: "2502.09297"
venue: "arXiv 2025"
summary: "Investigates when neural networks learn world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2502_09297_when-do-neural-networks-learn-world-mode.md
...
**When Do Neural Networks Learn World Models?** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 567/571** 篇，分组 **Theory Interpretability & Positions**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Investigates when neural networks learn world models.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2502.09297> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.09297) 为准。
...
**本条目的站内价值是把「When Do Neural Networks Learn World Models?」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2502_09297_when-do-neural-networks-learn-world-mode.md`](../../sources/papers/sun_awesome_wm_2502_09297_when-do-neural-networks-learn-world-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.09297)
