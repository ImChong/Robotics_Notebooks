...
summary: "Gen2Act turns a language instruction and an initial scene image into a generated human demonstration, then uses that video to condition a separate closed-loop robot policy. A pretrained VideoPoet supplies the demonstrati"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2409_16283_gen2act-human-video-generation-in-novel.md
...
**Gen2Act: Human Video Generation in Novel Scenarios enables Generalizable Robot Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 367/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Gen2Act turns a language instruction and an initial scene image into a generated human demonstration, then uses that video to condition a separate closed-loop robot policy. A pretrained VideoPoet supplies the demonstration without robot-specific fine-tuning. Auxiliary point-track prediction teaches policy representa...
...
| 分组 | WAMs |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2409.16283> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2409.16283) 为准。
...
**本条目的站内价值是把「Gen2Act」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2409_16283_gen2act-human-video-generation-in-novel.md`](../../sources/papers/rcl_awesome_wam_2409_16283_gen2act-human-video-generation-in-novel.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2409.16283)
