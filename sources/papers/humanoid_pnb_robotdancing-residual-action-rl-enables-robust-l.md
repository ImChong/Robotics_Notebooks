...
- **标题：** RobotDancing: Residual-Action RL Enables Robust Long-Horizon Humanoid Motion Tracking
- **类型：** paper
...
- **计划笔记路径：** `papers/13_Physics-Based_Animation/robotdancing-residual-action-rl-enables-robust-l/robotdancing-residual-action-rl-enables-robust-l.md`
