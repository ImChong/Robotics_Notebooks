...
summary: "小鹏 IRON CN117863190B：融合视觉高度与落足触觉的地形轨迹规划（2024-07-19 公开/公告）；视觉高度栅格与落足触觉高度图融合为承托地形高度图，用于足端轨迹规划并随新观测更新权重。…"
---

# 小鹏 IRON · 融合视觉高度与落足触觉的地形轨迹规划（CN117863190B）

专利 **CN117863190B**（*融合视觉高度与落足触觉的地形轨迹规划*，小鹏机器人 / IRON 相关布局，2024-07-19）公开 **双足步态控制** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**视觉高度栅格与落足触觉高度图融合为承托地形高度图，用于足端轨迹规划并随新观测更新权重。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN117863190B/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn117863190b)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN117863190B](https://patents.google.com/patent/CN117863190B/zh)
