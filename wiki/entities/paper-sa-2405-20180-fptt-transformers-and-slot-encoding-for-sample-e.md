...
arxiv: "2405.20180"
venue: "arXiv 2024"
code: https://github.com/torchipeppo/transformers-and-slot-encoding-for-wm
summary: "Transformers and slot encoding for sample-efficient physical world modeling."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2405_20180_fptt-transformers-and-slot-encoding-for.md
...
**FPTT: Transformers and Slot Encoding for Sample Efficient Physical World Modelling** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 128/571** 篇，分组 **45 Object-Centric World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2405.20180> |
| 代码/项目 | <https://github.com/torchipeppo/transformers-and-slot-encoding-for-wm> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2405.20180) 为准。
...
**本条目的站内价值是把「FPTT」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2405_20180_fptt-transformers-and-slot-encoding-for.md`](../../sources/papers/sun_awesome_wm_2405_20180_fptt-transformers-and-slot-encoding-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2405.20180)
