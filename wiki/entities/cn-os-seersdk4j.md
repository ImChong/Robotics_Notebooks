...
**SeerSdk4j** 是 [仙工智能](https://github.com/seer-robotics) 公开的 **SDK/驱动** 开源项目：为仙工智能移动机器人控制器提供Java TCP客户端与请求示例，便于业务系统读取状态和调用控制接口。
...
1. 从官方 GitHub/Gitee 组织检索 `SeerSdk4j` 仓库并核对 README 许可与依赖。
