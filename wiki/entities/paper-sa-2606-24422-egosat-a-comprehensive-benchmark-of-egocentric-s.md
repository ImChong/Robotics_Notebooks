...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_24422_egosat-a-comprehensive-benchmark-of-egoc.md
...
**EgoSAT: A Comprehensive Benchmark of Egocentric Streaming Interaction Understanding** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 182/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

The first comprehensive benchmark for egocentric video reasoning in streaming settings, designed to evaluate VLMs on streaming interaction understanding. Contains 1,997 unique videos spanning 165 hours and ~4,800 QA pairs
...
| 出处 | ECCV 2026 |
| 论文 | <https://arxiv.org/abs/2606.24422> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.24422) 为准。
...
**本条目的站内价值是把「EgoSAT」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_24422_egosat-a-comprehensive-benchmark-of-egoc.md`](../../sources/papers/sun_awesome_ego_2606_24422_egosat-a-comprehensive-benchmark-of-egoc.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.24422)
