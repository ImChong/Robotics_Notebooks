...
- **标题：** Design and Control of a Bipedal Robotic Character
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/design-and-control-of-a-bipedal-robotic-characte/design-and-control-of-a-bipedal-robotic-characte.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-design-and-control-of-a-bipedal-robotic-characte](../../wiki/entities/paper-notebook-design-and-control-of-a-bipedal-robotic-characte.md).

## 对 wiki 的映射

- [paper-notebook-design-and-control-of-a-bipedal-robotic-characte](../../wiki/entities/paper-notebook-design-and-control-of-a-bipedal-robotic-characte.md)
