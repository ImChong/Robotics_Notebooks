...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1910_04867_a-large-scale-study-of-representation-le.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# A Large-scale Study of Representation Learning with the Visual Task Adaptatio...

**A Large-scale Study of Representation Learning with the Visual Task Adaptation Benchmark** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 001/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 2019 |
| 论文 | <https://arxiv.org/abs/1910.04867> |
| 子类 / 象限 | 视觉表征迁移基准 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1910.04867) 为准。
...
**本条目的站内价值是把「A Large-scale Study of Representation Learning with the Visual Task Adaptatio...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1910_04867_a-large-scale-study-of-representation-le.md`](../../sources/papers/rcl_awesome_wam_1910_04867_a-large-scale-study-of-representation-le.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/1910.04867)
