...
- **代码：** 未在清单中标注
- **清单摘要：** Probabilistic scenario-description language for specifying and generating stress-test scenes for autonomy.
- **沉淀到 wiki：** [`wiki/entities/painode-324-scenic.md`](../../wiki/entities/painode-324-scenic.md)
...
- 实体页：[`wiki/entities/painode-324-scenic.md`](../../wiki/entities/painode-324-scenic.md)
