...
summary: "小鹏 IRON CN121879147A：从高程表征迁移到深度视觉的运动策略（2026-04-17 公开/公告）；仿真以高程图训练编码器，再迁移至配对深度图，RL 策略部署时仅用真实深度视觉输出关节控制。…"
---

# 小鹏 IRON · 从高程表征迁移到深度视觉的运动策略（CN121879147A）

专利 **CN121879147A**（*从高程表征迁移到深度视觉的运动策略*，小鹏机器人 / IRON 相关布局，2026-04-17）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**仿真以高程图训练编码器，再迁移至配对深度图，RL 策略部署时仅用真实深度视觉输出关节控制。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN121879147A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn121879147a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN121879147A](https://patents.google.com/patent/CN121879147A/zh)
