...
- 知识归纳见 wiki 实体页：[paper-notebook-icub3-avatar-system-enabling-remote-fully-immers](../../wiki/entities/paper-notebook-icub3-avatar-system-enabling-remote-fully-immers.md).

## 对 wiki 的映射

- [paper-notebook-icub3-avatar-system-enabling-remote-fully-immers](../../wiki/entities/paper-notebook-icub3-avatar-system-enabling-remote-fully-immers.md)
