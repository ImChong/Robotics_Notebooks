...
- **代码：** 未在清单中标注
- **清单摘要：** Developing general-purpose humanoid robots for structured workplace environments.
- **沉淀到 wiki：** [`wiki/entities/painode-048-sanctuaryai.md`](../../wiki/entities/painode-048-sanctuaryai.md)
...
- 实体页：[`wiki/entities/painode-048-sanctuaryai.md`](../../wiki/entities/painode-048-sanctuaryai.md)
