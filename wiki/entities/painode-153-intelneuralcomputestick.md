...
sources:
  - ../../sources/repos/pai_awesome_hardware_153_intel-neural-compute-stick.md
...
**Intel Neural Compute Stick** 收录于 awesome-physical-ai（aichr）**第 153/384** 条，分组 **Hardware & Actuation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
|------|------|
| 编号 | 153/384 |
| 分组 | Hardware & Actuation |
| 来源清单 | aichr |
| 主链接 | <https://www.intel.com/content/www/us/en/developer/tools/neural-compute-stick.html> |

## 核心原理

NPU for edge.

该条目在 Physical AI 清单中的角色是 **hardware**，分组 **Hardware & Actuation**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.intel.com/content/www/us/en/developer/tools/neural-compute-stick.html> |
...
- [`sources/repos/pai_awesome_hardware_153_intel-neural-compute-stick.md`](../../sources/repos/pai_awesome_hardware_153_intel-neural-compute-stick.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.intel.com/content/www/us/en/developer/tools/neural-compute-stick.html)
