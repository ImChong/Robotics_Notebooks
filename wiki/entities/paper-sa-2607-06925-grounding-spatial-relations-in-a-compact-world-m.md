...
arxiv: "2607.06925"
venue: "arXiv 2026"
summary: "Identifies 'instruction leakage' problem in goal-conditioned world models and proposes a fix."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2607_06925_grounding-spatial-relations-in-a-compact.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Grounding Spatial Relations in a Compact World Model

**Grounding Spatial Relations in a Compact World Model: Instruction Leakage and a Goal-Free Dynamics Fix** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 553/571** 篇，分组 **Theory Interpretability & Positions**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Identifies "instruction leakage" problem in goal-conditioned world models and proposes a fix.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2607.06925> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.06925) 为准。
...
**本条目的站内价值是把「Grounding Spatial Relations in a Compact World Model」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2607_06925_grounding-spatial-relations-in-a-compact.md`](../../sources/papers/sun_awesome_wm_2607_06925_grounding-spatial-relations-in-a-compact.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.06925)
