...
**astribot_descriptions** 是 [星尘智能](https://github.com/Astribot-Dev) 公开的 **本体模型资产** 开源项目：提供星尘智能机器人在仿真和ROS工具链中使用的描述文件与模型资产。
...
| 机构 | 星尘智能 |
| 类别 | 本体模型资产 |
| 官方组织 | https://github.com/Astribot-Dev |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `astribot_descriptions` 仓库并核对 README 许可与依赖。
...
- [星尘智能 官方组织](https://github.com/Astribot-Dev)
