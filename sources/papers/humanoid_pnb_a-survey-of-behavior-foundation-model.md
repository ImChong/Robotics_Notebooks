...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/A_Survey_of_Behavior_Foundation_Model__Next-Generation_Whole-Body_Control_System/A_Survey_of_Behavior_Foundation_Model__Next-Generation_Whole-Body_Control_System.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-a-survey-of-behavior-foundation-model](../../wiki/entities/paper-notebook-a-survey-of-behavior-foundation-model.md).

## 对 wiki 的映射

- [paper-notebook-a-survey-of-behavior-foundation-model](../../wiki/entities/paper-notebook-a-survey-of-behavior-foundation-model.md)
