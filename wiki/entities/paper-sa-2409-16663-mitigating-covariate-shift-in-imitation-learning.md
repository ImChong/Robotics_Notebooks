...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2409_16663_mitigating-covariate-shift-in-imitation.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Mitigating Covariate Shift in Imitation Learning for AVs Using Latent Space G...

**Mitigating Covariate Shift in Imitation Learning for AVs Using Latent Space Generative World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 460/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Mitigates covariate shift in imitation learning for AVs using latent space generative world models.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2409.16663> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2409.16663) 为准。
...
**本条目的站内价值是把「Mitigating Covariate Shift in Imitation Learning for AVs Using Latent Space G...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2409_16663_mitigating-covariate-shift-in-imitation.md`](../../sources/papers/sun_awesome_wm_2409_16663_mitigating-covariate-shift-in-imitation.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2409.16663)
