...
- **标题：** Hierarchical Intention-Aware Expressive Motion Generation for Humanoid Robots
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Hierarchical_Intention-Aware_Expressive_Motion_Generation_for_Humanoid_Robots/Hierarchical_Intention-Aware_Expressive_Motion_Generation_for_Humanoid_Robots.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-hierarchical-intention-aware-expressive-motion-g](../../wiki/entities/paper-notebook-hierarchical-intention-aware-expressive-motion-g.md).

## 对 wiki 的映射

- [paper-notebook-hierarchical-intention-aware-expressive-motion-g](../../wiki/entities/paper-notebook-hierarchical-intention-aware-expressive-motion-g.md)
