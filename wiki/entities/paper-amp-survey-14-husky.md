...
type: entity
tags: [paper, humanoid, amp, motion-prior, adversarial-imitation, teleai, shanghaitech, sjtu, hku, ustc]
status: complete
updated: 2026-06-11
venue: curated
summary: "HUSKY 里，AMP 被用于学习 human-like pushing motion。"
related:
...
**HUSKY** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 14/19** 篇，归类为 **04 交互与长时程**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_14_husky_humanoid_skateboarding_system_via_physics.md](../../sources/papers/humanoid_amp_survey_14_husky_humanoid_skateboarding_system_via_physics.md)
