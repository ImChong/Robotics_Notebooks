...
- **索引级说明：** 具体数值以 [论文摘录](../../sources/papers/3d_ic_icml_2026.md) 与官方仓库 README 为准；本页为溯源索引，细节待深读补充。
...
- 工程状态需保守对待：本页为索引级，具体数值以论文摘录与官方 README 为准，[代码仓库](https://github.com/kekeZ66/3D-IC) 在 ingest 时为新建仓，勿假设可直接复现。
