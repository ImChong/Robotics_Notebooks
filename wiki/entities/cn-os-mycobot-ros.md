...
**mycobot_ros** 是 [大象机器人](https://github.com/elephantrobotics) 公开的 **仿真环境** 开源项目：为myCobot系列提供ROS模型、驱动、MoveIt配置和Gazebo仿真，可用于真机控制与上层规划验证。
...
1. 从官方 GitHub/Gitee 组织检索 `mycobot_ros` 仓库并核对 README 许可与依赖。
