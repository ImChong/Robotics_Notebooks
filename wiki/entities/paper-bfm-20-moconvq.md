...
type: entity
tags: [paper, bfm, behavior-foundation-model, awesome-bfm-papers, pku]
status: complete
updated: 2026-06-25
arxiv: "2310.10198"
venue: "2023 · TOG"
summary: "离散动作 token 便于规划器/语言模块组织连续轨迹。"
related:
...
**MoConVQ** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 20/41** 篇，归类为 **02 Goal-conditioned 学习**（2023 · TOG）。
...
- 离散动作 token 便于规划器/语言模块组织连续轨迹。
- 在 [BFM 41 篇技术地图](../overview/bfm-41-papers-technology-map.md) 中属于 **02 Goal-conditioned 学习**（#20/41）。
...
| 出处 | 2023 · TOG |
| 论文 | <https://arxiv.org/pdf/2310.10198> |
...
- 本页为 **#20/41 清单索引策展编译**（2023 · TOG），量化 benchmark 与消融以原文 PDF 为准。
...
- 原始 source：[bfm_awesome_moconvq_tog_2023.md](../../sources/papers/bfm_awesome_moconvq_tog_2023.md)

## 参考来源

- [bfm_awesome_moconvq_tog_2023.md](../../sources/papers/bfm_awesome_moconvq_tog_2023.md) — awesome-bfm 策展摘录
