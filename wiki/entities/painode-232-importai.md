...
status: complete
updated: 2026-09-20
summary: "Jack Clark. Weekly analysis of AI breakthroughs, policy, and implications for robotics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_232_import-ai.md
...
**Import AI** 收录于 awesome-physical-ai（natnew）**第 232/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Jack Clark. Weekly analysis of AI breakthroughs, policy, and implications for robotics.
...
| 来源清单 | natnew |
| 主链接 | <https://importai.substack.com/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://importai.substack.com/> |
...
- [`sources/repos/pai_awesome_community_232_import-ai.md`](../../sources/repos/pai_awesome_community_232_import-ai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://importai.substack.com/)
