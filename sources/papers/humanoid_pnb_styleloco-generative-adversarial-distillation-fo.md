...
- **标题：** StyleLoco: Generative Adversarial Distillation for Natural Humanoid Robot Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/styleloco-generative-adversarial-distillation-fo/styleloco-generative-adversarial-distillation-fo.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-styleloco-generative-adversarial-distillation-fo](../../wiki/entities/paper-notebook-styleloco-generative-adversarial-distillation-fo.md).

## 对 wiki 的映射

- [paper-notebook-styleloco-generative-adversarial-distillation-fo](../../wiki/entities/paper-notebook-styleloco-generative-adversarial-distillation-fo.md)
