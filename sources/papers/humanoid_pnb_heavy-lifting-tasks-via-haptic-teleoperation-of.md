...
- **计划笔记路径：** `papers/07_Teleoperation/heavy-lifting-tasks-via-haptic-teleoperation-of/heavy-lifting-tasks-via-haptic-teleoperation-of.md`
- **分类：** 07_Teleoperation
...
- 知识归纳见 wiki 实体页：[paper-notebook-heavy-lifting-tasks-via-haptic-teleoperation-of](../../wiki/entities/paper-notebook-heavy-lifting-tasks-via-haptic-teleoperation-of.md).

## 对 wiki 的映射

- [paper-notebook-heavy-lifting-tasks-via-haptic-teleoperation-of](../../wiki/entities/paper-notebook-heavy-lifting-tasks-via-haptic-teleoperation-of.md)
