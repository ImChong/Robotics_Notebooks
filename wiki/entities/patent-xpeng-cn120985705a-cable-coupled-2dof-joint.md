...
summary: "小鹏 IRON CN120985705A：柔性线传动的双轴解耦关节（2025-11-21 公开/公告）；解耦轮与解耦轴经柔性线缆连接，分解组合两轴运动，降低齿轮磨损、背隙与冲击刚性。…"
---

# 小鹏 IRON · 柔性线传动的双轴解耦关节（CN120985705A）

专利 **CN120985705A**（*柔性线传动的双轴解耦关节*，小鹏机器人 / IRON 相关布局，2025-11-21）公开 **灵巧手·关节** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**解耦轮与解耦轴经柔性线缆连接，分解组合两轴运动，降低齿轮磨损、背隙与冲击刚性。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN120985705A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn120985705a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN120985705A](https://patents.google.com/patent/CN120985705A/zh)
