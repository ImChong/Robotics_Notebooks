...
- **标题：** Task and Motion Planning for Humanoid Loco-manipulation
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Task_and_Motion_Planning_for_Humanoid_Loco-manipulation/Task_and_Motion_Planning_for_Humanoid_Loco-manipulation.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-task-and-motion-planning-for-humanoid-loco-manip](../../wiki/entities/paper-notebook-task-and-motion-planning-for-humanoid-loco-manip.md).

## 对 wiki 的映射

- [paper-notebook-task-and-motion-planning-for-humanoid-loco-manip](../../wiki/entities/paper-notebook-task-and-motion-planning-for-humanoid-loco-manip.md)
