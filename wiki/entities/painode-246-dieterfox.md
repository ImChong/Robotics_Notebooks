...
status: complete
updated: 2026-09-20
summary: "NVIDIA, UW. Perception and robot learning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_246_dieter-fox.md
...
**Dieter Fox** 收录于 awesome-physical-ai（natnew）**第 246/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

NVIDIA, UW. Perception and robot learning.
...
- [`sources/repos/pai_awesome_person_246_dieter-fox.md`](../../sources/repos/pai_awesome_person_246_dieter-fox.md) — 本条目策展摘录
