...
status: complete
updated: 2026-09-20
summary: "Humanoid for logistics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_293_agility-robotics-digit.md
...
**Agility Robotics - Digit** 收录于 awesome-physical-ai（aichr）**第 293/384** 条，分组 **Robot Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Humanoid for logistics.
...
| 分组 | Robot Platforms |
| 来源清单 | aichr |
| 主链接 | <https://github.com/AgilityRobotics> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/AgilityRobotics> |
...
- [`sources/repos/pai_awesome_hardware_293_agility-robotics-digit.md`](../../sources/repos/pai_awesome_hardware_293_agility-robotics-digit.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/AgilityRobotics)
