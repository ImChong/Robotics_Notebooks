...
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/seeq_arxiv_2609_22085.md
  - ../../sources/sites/seeq.md
  - ../../sources/blogs/wechat_embodied_station_contact_rich_sim_10_papers_2026-09-21.md
summary: "SeeQ（arXiv:2609.22085）：Q 函数先预测当前子任务再估短时域 TD 价值，对 π₀.₅ base policy 做 best-of-N 排序；四真机双臂任务 24 次试验均有提升。"
---

# SeeQ（arXiv:2609.22085）

**SeeQ**（*SeeQ: Training Generalist Value Functions for Long-Horizon Robotic Manipulation*，[arXiv:2609.22085](https://arxiv.org/abs/2609.22085)）来自 [具身智能小站 10 篇盘点](../../sources/blogs/wechat_embodied_station_contact_rich_sim_10_papers_2026-09-21.md)（策展档位：**扫读**）。

## 一句话定义

**Q 函数先预测当前子任务再估短时域 TD 价值，对 π₀.₅ base policy 做 best-of-N 排序；四真机双臂任务 24 次试验均有提升。**
...
- **卡内基梅隆大学（CMU）**；开源结论：**待发布**（步骤 2.5，2026-09-21）。
- 稀疏任务级奖励下直接学 Q 需长时域信用分配；SeeQ 把价值学习拆到活跃子任务。
...
| **开源** | **待发布** |
| **策展摘要** | Q 函数先预测当前子任务再估短时域 TD 价值，对 π₀.₅ base policy 做 best-of-N 排序；四真机双臂任务 24 次试验均有提升。 |
...
**SeeQ 代表「扫读」档位的 value-function 方向样本——部署前以开源状态与评测协议为准绳。**
...
- [seeq_arxiv_2609_22085.md](../../sources/papers/seeq_arxiv_2609_22085.md)
...
- [arXiv PDF](https://arxiv.org/pdf/2609.22085)
