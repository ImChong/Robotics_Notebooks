...
sources:
  - ../../sources/papers/sun_awesome_ego_2501_00358_embodied-videoagent-persistent-memory-fr.md
...
**Embodied VideoAgent: Persistent Memory from Egocentric Videos and Embodied Sensors Enables Dynamic Scene Understanding** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 087/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

An LLM-based agent that constructs scene memory from both egocentric video and embodied sensory inputs (depth and pose sensing). Achieves gains of 6.5% on Ego4D-VQ3D, 2.6% on OpenEQA, and 15.3% on EnvQA
...
| 出处 | ICCV 2025 |
| 论文 | <https://arxiv.org/abs/2501.00358> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.00358) 为准。
...
**本条目的站内价值是把「Embodied VideoAgent」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2501_00358_embodied-videoagent-persistent-memory-fr.md`](../../sources/papers/sun_awesome_ego_2501_00358_embodied-videoagent-persistent-memory-fr.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.00358)
