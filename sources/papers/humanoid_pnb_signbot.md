...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/SignBot__Learning_Human-to-Humanoid_Sign_Language_Interaction/SignBot__Learning_Human-to-Humanoid_Sign_Language_Interaction.md`
