...
**Lightwheel-YCB** 是 [光轮智能](https://github.com/LightwheelAI) 公开的 **仿真环境** 开源项目：提供刚体、关节体和柔性物体的仿真就绪YCB资产，并同时提供MJCF与USD格式。
...
1. 从官方 GitHub/Gitee 组织检索 `Lightwheel-YCB` 仓库并核对 README 许可与依赖。
