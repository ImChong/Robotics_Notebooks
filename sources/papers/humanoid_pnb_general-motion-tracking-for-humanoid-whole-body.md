...
- **标题：** General Motion Tracking for Humanoid Whole-Body Control
- **类型：** paper
- **深读状态：** 待撰写（见 [progress.json](https://github.com/ImChong/Humanoid_Robot_Learning_Paper_Notebooks/blob/main/progress.json)）
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/General_Motion_Tracking_for_Humanoid_Whole-Body_Control/General_Motion_Tracking_for_Humanoid_Whole-Body_Control.md`
...
- 知识归纳见正式实体：[paper-gmt](../../wiki/entities/paper-gmt.md)；计划占位：[paper-notebook-general-motion-tracking-for-humanoid-whole-body](../../wiki/entities/paper-notebook-general-motion-tracking-for-humanoid-whole-body.md)。
