...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2604_08544_sim1-physics-aligned-simulator-as-zero-s.md
...
**Sim1: Physics-Aligned Simulator as Zero-Shot Data Scaler in Deformable Worlds** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 047/063** 篇，分组 **42 Simulation Frameworks & Pipelines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A physics-aligned real-to-sim-to-real data engine that grounds simulation in the physical world, validating physics-aligned simulation as scalable supervision for deformable manipulation
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.08544) 为准。
...
**本条目的站内价值是把「Sim1」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2604_08544_sim1-physics-aligned-simulator-as-zero-s.md`](../../sources/papers/sun_awesome_r2s2r_2604_08544_sim1-physics-aligned-simulator-as-zero-s.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.08544)
