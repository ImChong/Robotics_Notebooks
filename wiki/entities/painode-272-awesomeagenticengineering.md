...
status: complete
updated: 2026-09-20
code: https://github.com/natnew/awesome-agentic-engineering
summary: "Agentic AI architectures, frameworks, memory, evaluation, and safety."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_272_awesome-agentic-engineering.md
...
**Awesome Agentic Engineering** 收录于 awesome-physical-ai（natnew）**第 272/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Agentic AI architectures, frameworks, memory, evaluation, and safety.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/natnew/Awesome-Agentic-Engineering> |
| 代码/仓库 | <https://github.com/natnew/awesome-agentic-engineering> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/natnew/Awesome-Agentic-Engineering> |
| 代码/仓库 | <https://github.com/natnew/awesome-agentic-engineering> |
...
- [`sources/repos/pai_awesome_list_272_awesome-agentic-engineering.md`](../../sources/repos/pai_awesome_list_272_awesome-agentic-engineering.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/natnew/Awesome-Agentic-Engineering)
