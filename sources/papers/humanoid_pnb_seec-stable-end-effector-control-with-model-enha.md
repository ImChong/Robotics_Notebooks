...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/seec-stable-end-effector-control-with-model-enha/seec-stable-end-effector-control-with-model-enha.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2509.21231>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-seec](../../wiki/entities/paper-notebook-seec.md).

## 对 wiki 的映射

- [paper-notebook-seec](../../wiki/entities/paper-notebook-seec.md)
...
- 论文：<https://arxiv.org/abs/2509.21231>
