...
## [2026-08-11] lint | health-check | 自动化 wiki 健康检查
...
- wiki/methods/teacher-student-dagger-training.md（被 4 个页面引用，无 queries/comparisons 落地）
