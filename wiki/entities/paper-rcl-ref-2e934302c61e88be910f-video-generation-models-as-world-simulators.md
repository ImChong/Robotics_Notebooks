...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_2e934302c61e88be910f_video-generation-models-as-world-simulat.md
...
**Video generation models as world simulators** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 091/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 论文 | <https://openai.com/index/video-generation-models-as-world-simulators/> |
| 子类 / 象限 | Video & world prediction backbones · 视频生成Backbone · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openai.com/index/video-generation-models-as-world-simulators/) 为准。
...
**本条目的站内价值是把「Video generation models as world simulators」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_2e934302c61e88be910f_video-generation-models-as-world-simulat.md`](../../sources/papers/rcl_awesome_wam_ref_2e934302c61e88be910f_video-generation-models-as-world-simulat.md) — 本条目策展摘录
