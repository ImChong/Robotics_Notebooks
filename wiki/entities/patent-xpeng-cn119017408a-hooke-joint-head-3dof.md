...
summary: "小鹏 IRON CN119017408A：虎克铰与双驱动头部三轴机构（2024-11-26 公开/公告）；虎克铰连接动平台，三组两两垂直转轴；双驱动同步/异步产生俯仰与侧倾，另组带轮实现水平转向。…"
---

# 小鹏 IRON · 虎克铰与双驱动头部三轴机构（CN119017408A）

专利 **CN119017408A**（*虎克铰与双驱动头部三轴机构*，小鹏机器人 / IRON 相关布局，2024-11-26）公开 **本体·头颈·机械臂** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**虎克铰连接动平台，三组两两垂直转轴；双驱动同步/异步产生俯仰与侧倾，另组带轮实现水平转向。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN119017408A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn119017408a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN119017408A](https://patents.google.com/patent/CN119017408A/zh)
