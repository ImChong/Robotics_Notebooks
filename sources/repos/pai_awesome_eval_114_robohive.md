...
- **代码：** <https://github.com/vikashplus/robohive>
- **清单摘要：** Benchmarking suite with standardized tasks and scoring across manipulation and locomotion.
- **沉淀到 wiki：** [`wiki/entities/painode-114-robohive.md`](../../wiki/entities/painode-114-robohive.md)
...
- 实体页：[`wiki/entities/painode-114-robohive.md`](../../wiki/entities/painode-114-robohive.md)
