...
status: complete
updated: 2026-09-20
code: https://github.com/berkeleylearnverify/verifai
summary: "Falsification and formal-analysis toolkit for autonomy and cyber-physical systems."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_325_verifai.md
...
**VerifAI** 收录于 awesome-physical-ai（natnew）**第 325/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Falsification and formal-analysis toolkit for autonomy and cyber-physical systems.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/BerkeleyLearnVerify/VerifAI> |
| 代码/仓库 | <https://github.com/berkeleylearnverify/verifai> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/BerkeleyLearnVerify/VerifAI> |
| 代码/仓库 | <https://github.com/berkeleylearnverify/verifai> |
...
- [`sources/repos/pai_awesome_resource_325_verifai.md`](../../sources/repos/pai_awesome_resource_325_verifai.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/BerkeleyLearnVerify/VerifAI)
