...
arxiv: "2509.23958"
venue: "arXiv 2025"
summary: "Uses inverse rewards for world model post-training."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_23958_rlir-reinforcement-learning-with-inverse.md
...
**RLIR: Reinforcement Learning with Inverse Rewards for World Model Post-training** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 011/571** 篇，分组 **102 Post-Training & Test-Time Scaling**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Uses inverse rewards for world model post-training.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.23958> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.23958) 为准。
...
**本条目的站内价值是把「RLIR」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_23958_rlir-reinforcement-learning-with-inverse.md`](../../sources/papers/sun_awesome_wm_2509_23958_rlir-reinforcement-learning-with-inverse.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.23958)
