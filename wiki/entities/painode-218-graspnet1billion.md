...
status: complete
updated: 2026-09-20
summary: "Large-scale benchmark and dataset for robust 6-DoF grasp planning."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_218_graspnet-1billion.md
...
**GraspNet-1Billion** 收录于 awesome-physical-ai（natnew）**第 218/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Large-scale benchmark and dataset for robust 6-DoF grasp planning.
...
- [`sources/repos/pai_awesome_method_218_graspnet-1billion.md`](../../sources/repos/pai_awesome_method_218_graspnet-1billion.md) — 本条目策展摘录
