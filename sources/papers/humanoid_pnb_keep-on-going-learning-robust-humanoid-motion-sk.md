...
- **标题：** Keep on Going: Learning Robust Humanoid Motion Skills via Selective Adversarial Training
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/keep-on-going-learning-robust-humanoid-motion-sk/keep-on-going-learning-robust-humanoid-motion-sk.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2507.08303>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-keep-on-going](../../wiki/entities/paper-notebook-keep-on-going.md).

## 对 wiki 的映射

- [paper-notebook-keep-on-going](../../wiki/entities/paper-notebook-keep-on-going.md)
...
- 论文：<https://arxiv.org/abs/2507.08303>
