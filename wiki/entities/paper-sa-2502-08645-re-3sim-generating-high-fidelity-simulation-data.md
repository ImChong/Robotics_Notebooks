...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2502_08645_re-3sim-generating-high-fidelity-simulat.md
...
**Re^3Sim: Generating High-Fidelity Simulation Data via 3D-Photorealistic Real-to-Sim for Robotic Manipulation** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 027/063** 篇，分组 **31 Real2Sim from Video**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A 3D-photorealistic real-to-sim system addressing geometric and visual sim-to-real gaps, employing advanced 3D reconstruction and neural rendering techniques to faithfully recreate real-world scenarios
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.08645) 为准。
...
**本条目的站内价值是把「Re^3Sim」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2502_08645_re-3sim-generating-high-fidelity-simulat.md`](../../sources/papers/sun_awesome_r2s2r_2502_08645_re-3sim-generating-high-fidelity-simulat.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.08645)
