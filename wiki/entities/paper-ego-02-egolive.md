...
**EgoLive** 收录于 [具身智能研究室 · Ego 9 篇专题](https://mp.weixin.qq.com/s/4JQ1xa-cJ7J1ep_e4txNnA) **第 02/9** 篇，归类为 **01 数据采集**。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。

## 为什么重要

- 大规模真实家政/零售等任务导向 Ego 数据，把「人类视频」推向机器人任务数据。
- 在 [Ego 9 篇技术地图](../overview/ego-9-papers-technology-map.md) 的四类问题坐标中，属于 **[01 数据采集](../overview/ego-category-01-data-collection.md)**。
