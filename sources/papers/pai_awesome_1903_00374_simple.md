...
- **代码：** 未在清单中标注
- **清单摘要：** Model-based RL baseline showing strong sample efficiency from learned video prediction.
- **沉淀到 wiki：** [`wiki/entities/paper-pai-1903-00374-simple.md`](../../wiki/entities/paper-pai-1903-00374-simple.md)
...
- 实体页：[`wiki/entities/paper-pai-1903-00374-simple.md`](../../wiki/entities/paper-pai-1903-00374-simple.md)
