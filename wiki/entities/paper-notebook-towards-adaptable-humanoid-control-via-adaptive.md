...
| arXiv | [2510.14454](https://arxiv.org/abs/2510.14454) — canonical 节点在主实体页，本页 frontmatter 不重复 `arxiv` 键 |
| Venue | ICRA 2026 Oral |
| 代码 | [InternRobotics/AdaMimic](https://github.com/InternRobotics/AdaMimic) |
| 本页角色 | 题名级重复索引（兼容旧链接与图谱入边） |

## 方法与实验评测

- 本页 **不维护** 方法栈与实验数据：AdaMimic 的核心原理、源码时序、量化结果与消融一律以主实体页为准。
- 方法：[paper-adamimic「核心原理」](./paper-adamimic.md#核心原理)
- 评测：[paper-adamimic「实验与评测」](./paper-adamimic.md#实验与评测)
- 横向对比：[paper-adamimic「与其他工作对比」](./paper-adamimic.md#与其他工作对比)
