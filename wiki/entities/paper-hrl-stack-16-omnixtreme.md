...
**OmniXtreme 指认的是一条取舍曲线而不是一个模块：动作库越大、动作越极端，通用性与跟踪精度之间的冲突就越明显。**
...
- 对照：[Extreme-RGMT](./paper-extreme-rgmt.md) — 同台评测 XtremeMotion / AMASS Challenging；强调参考质量变化下的鲁棒性
...
- [机器人论文阅读笔记：OmniXtreme](https://imchong.github.io/Robot_Learning_Paper_Notebooks/papers/04_Loco-Manipulation_and_WBC/OmniXtreme_Breaking_the_Generality_Barrier_in_High-Dynamic_Humanoid_Control/OmniXtreme_Breaking_the_Generality_Barrier_in_High-Dynamic_Humanoid_Control.html)
