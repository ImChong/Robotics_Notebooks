...
arxiv: "2505.20795"
venue: "ICRA 2026"
summary: "A human demonstration video conditions a frozen video model whose features guide a separate diffusion policy for an Xhand robot. Human hand motions are reconstructed and retargeted into the policy's action space, allowin"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2505_20795_learning-generalizable-robot-policy-with.md
...
**Learning Generalizable Robot Policy with Human Demonstration Video as a Prompt** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 210/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A human demonstration video conditions a frozen video model whose features guide a separate diffusion policy for an Xhand robot. Human hand motions are reconstructed and retargeted into the policy's action space, allowing human demonstrations to supervise action learning. The reported transfer concerns objects and s...
...
| 出处 | ICRA 2026 |
| 论文 | <https://arxiv.org/abs/2505.20795> |
| 子类 / 象限 | Visuomotor policy methods · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.20795) 为准。
...
**本条目的站内价值是把「Learning Generalizable Robot Policy with Human Demonstration Video as a Prompt」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2505_20795_learning-generalizable-robot-policy-with.md`](../../sources/papers/rcl_awesome_wam_2505_20795_learning-generalizable-robot-policy-with.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.20795)
