...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2411_11839_robogsim-a-real2sim2real-robotic-gaussia.md
...
**RoboGSim: A Real2Sim2Real Robotic Gaussian Splatting Simulator** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 058/063** 篇，分组 **Benchmarks Simulators & Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A Real2Sim2Real robotic Gaussian Splatting simulator for synthesizing simulated data with novel views, objects, trajectories, and scenes
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2411.11839> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.11839) 为准。
...
**本条目的站内价值是把「RoboGSim」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2411_11839_robogsim-a-real2sim2real-robotic-gaussia.md`](../../sources/papers/sun_awesome_r2s2r_2411_11839_robogsim-a-real2sim2real-robotic-gaussia.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.11839)
