...
sources:
  - ../../sources/papers/humanoid_pnb_adaptnet-policy-adaptation-for-physics-based-cha.md
summary: "AdaptNet：列入 Paper Notebooks PROGRESS.md 待深读清单；深读笔记完成后补成完整摘要。"
---

# AdaptNet

**AdaptNet: Policy Adaptation for Physics-Based Character Control** 已列入 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html) 的 **PROGRESS.md 待深读** 清单（分类：13_Physics-Based_Animation）。本页 **还没有深读笔记**：只给出这篇论文的分类位置与原文入口，方法细节与数据请直接看原文。

## 一句话定义

AdaptNet 的人形机器人学习论文条目，当前处于 Paper Notebooks 阅读进度（待深读）阶段。
...
| 计划文件夹 | `papers/13_Physics-Based_Animation/adaptnet-policy-adaptation-for-physics-based-cha` |
...
**本页是 AdaptNet 的待读条目节点：它当前承载的是归档信息（13_Physics-Based_Animation、待深读），而不是对该方法的任何技术判断。**
...
- [humanoid_pnb_adaptnet-policy-adaptation-for-physics-based-cha.md](../../sources/papers/humanoid_pnb_adaptnet-policy-adaptation-for-physics-based-cha.md)
