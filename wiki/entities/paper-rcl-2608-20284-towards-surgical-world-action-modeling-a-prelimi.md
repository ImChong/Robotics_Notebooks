...
updated: 2026-09-25
arxiv: "2608.20284"
summary: "To bridge this gap, we present a preliminary joint visual-trajectory world-action model that simultaneously forecasts future visual states and instrument trajectories from historical surgical observations. The chunked st"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_20284_towards-surgical-world-action-modeling-a.md
...
**Towards Surgical World-Action Modeling: A Preliminary Joint Visual-Trajectory Forecasting for Surgical Motion Planning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 498/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

To bridge this gap, we present a preliminary joint visual-trajectory world-action model that simultaneously forecasts future visual states and instrument trajectories from historical surgical observations. The chunked strategy consistently outperforms direct one-shot prediction across all evaluated horizons, improvi...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.20284> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.20284) 为准。
...
**本条目的站内价值是把「Towards Surgical World-Action Modeling」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_20284_towards-surgical-world-action-modeling-a.md`](../../sources/papers/rcl_awesome_wam_2608_20284_towards-surgical-world-action-modeling-a.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.20284)
