...
arxiv: "2510.06492"
venue: "arXiv 2025"
summary: "Evaluates latent world models on partially observable safety constraints."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2510_06492_partially-observable-safety-how-well-do.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Partially Observable Safety

**Partially Observable Safety: How Well Do Latent World Models Understand Partially Observable Safety Constraints?** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 558/571** 篇，分组 **Theory Interpretability & Positions**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Evaluates latent world models on partially observable safety constraints.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.06492> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.06492) 为准。
...
**本条目的站内价值是把「Partially Observable Safety」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2510_06492_partially-observable-safety-how-well-do.md`](../../sources/papers/sun_awesome_wm_2510_06492_partially-observable-safety-how-well-do.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.06492)
