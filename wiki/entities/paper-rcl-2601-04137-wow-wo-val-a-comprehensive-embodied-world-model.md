...
arxiv: "2601.04137"
venue: "2026"
summary: "WoW-World-Eval tests whether instruction-conditioned robot videos are visually convincing, task-correct, physically plausible and usable for action extraction. Its 609-sample benchmark combines automated metrics, human j"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2601_04137_wow-wo-val-a-comprehensive-embodied-worl.md
...
**Wow, wo, val! A Comprehensive Embodied World Model Evaluation Turing Test** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 062/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

WoW-World-Eval tests whether instruction-conditioned robot videos are visually convincing, task-correct, physically plausible and usable for action extraction. Its 609-sample benchmark combines automated metrics, human judgments and a separate GC-IDM robot-execution test. Hailuo leads the reported aggregate video sc...
...
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2601.04137> |
| 子类 / 象限 | 世界模型评测基准 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2601.04137) 为准。
...
**本条目的站内价值是把「Wow, wo, val! A Comprehensive Embodied World Model Evaluation Turing Test」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2601_04137_wow-wo-val-a-comprehensive-embodied-worl.md`](../../sources/papers/rcl_awesome_wam_2601_04137_wow-wo-val-a-comprehensive-embodied-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2601.04137)
