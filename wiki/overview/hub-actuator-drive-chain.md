...
| ② 驱动固件 FOC | 电流环带宽/编码器分辨率/标定 | SimpleFOC、FOC 电流环 | [SimpleFOC](../entities/simplefoc.md)、[磁场定向控制](../concepts/field-oriented-control.md)、[LunaDrive GaN 高压驱动](../entities/paper-lunadrive.md) |
