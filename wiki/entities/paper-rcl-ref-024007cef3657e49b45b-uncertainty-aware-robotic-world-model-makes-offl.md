...
code: https://github.com/leggedrobotics/robotic_world_model
summary: "RCL Awesome WAM 清单收录（WAMs）；细节以原文 PDF / 项目页为准。"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_024007cef3657e49b45b_uncertainty-aware-robotic-world-model-ma.md
  - ../../sources/papers/rcl_awesome_wam_catalog.md
  - ../../sources/repos/awesome-world-action-models-rcl.md
---

# Uncertainty-Aware Robotic World Model Makes Offline Model-Based Reinforcement...

**Uncertainty-Aware Robotic World Model Makes Offline Model-Based Reinforcement Learning Work on Real Robots** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 501/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

RCL Awesome WAM 清单收录（WAMs）；细节以原文 PDF / 项目页为准。
...
| 编号 | 501/564 |
| 分组 | WAMs |
| 出处 | ICLR 2026 Workshop on World Models |
| 论文 | <https://openreview.net/pdf/4c7bf7d1b35f9e402b680031bb65e7738103a9bb.pdf> |
| 代码/项目 | <https://github.com/leggedrobotics/robotic_world_model> |
| 子类 / 象限 | 策略后训练与WM-RL · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/pdf/4c7bf7d1b35f9e402b680031bb65e7738103a9bb.pdf) 为准。
...
**本条目的站内价值是把「Uncertainty-Aware Robotic World Model Makes Offline Model-Based Reinforcement...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_024007cef3657e49b45b_uncertainty-aware-robotic-world-model-ma.md`](../../sources/papers/rcl_awesome_wam_ref_024007cef3657e49b45b_uncertainty-aware-robotic-world-model-ma.md) — 本条目策展摘录
...
- [原文](https://openreview.net/pdf/4c7bf7d1b35f9e402b680031bb65e7738103a9bb.pdf)
