...
updated: 2026-09-25
arxiv: "2607.14943"
code: https://github.com/trustworthyrobotics/steering_robustness_WAMs
summary: "World Action Models (WAMs) enable semantically- and physically-informed control but are brittle under distribution shift. In this work, we use mechanistic interpretability to study how robustness-relevant perturbations a"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_14943_steering-robustness-into-world-action-mo.md
...
**Steering Robustness into World Action Models via Mechanistic Interpretability and Optimal Control** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 486/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

World Action Models (WAMs) enable semantically- and physically-informed control but are brittle under distribution shift. In this work, we use mechanistic interpretability to study how robustness-relevant perturbations are represented in WAM activation space.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2607.14943> |
| 代码/项目 | <https://github.com/trustworthyrobotics/steering_robustness_WAMs> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.14943) 为准。
...
**本条目的站内价值是把「Steering Robustness into World Action Models via Mechanistic Interpretability...」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_14943_steering-robustness-into-world-action-mo.md`](../../sources/papers/rcl_awesome_wam_2607_14943_steering-robustness-into-world-action-mo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.14943)
