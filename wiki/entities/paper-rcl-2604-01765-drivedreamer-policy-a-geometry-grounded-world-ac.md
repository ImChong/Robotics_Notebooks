...
arxiv: "2604.01765"
venue: "2026"
summary: "DriveDreamer-Policy trains a shared multimodal backbone with depth, video and trajectory generators. Ordered query embeddings transfer geometry and future-scene context into planning without requiring rendered depth or v"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_01765_drivedreamer-policy-a-geometry-grounded.md
...
**DriveDreamer-Policy: A Geometry-Grounded World-Action Model for Unified Generation and Planning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 320/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

DriveDreamer-Policy trains a shared multimodal backbone with depth, video and trajectory generators. Ordered query embeddings transfer geometry and future-scene context into planning without requiring rendered depth or video at inference. Navsim scores and controlled modality ablations support useful joint supervisi...
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.01765) 为准。
...
**本条目的站内价值是把「DriveDreamer-Policy」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_01765_drivedreamer-policy-a-geometry-grounded.md`](../../sources/papers/rcl_awesome_wam_2604_01765_drivedreamer-policy-a-geometry-grounded.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.01765)
