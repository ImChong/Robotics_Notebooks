...
**NaVILA: Legged Robot Vision-Language-Action Model for Navigation** 收录于 [Humanoid Robot Learning Paper Notebooks](https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/index.html)（分类：08_Navigation）。本页为 **索引级实体**，链向深读笔记与原始论文；详细机制待从笔记消化后补充。
...
- [humanoid_pnb_navila-legged-robot-vision-language-action-model.md](../../sources/papers/humanoid_pnb_navila-legged-robot-vision-language-action-model.md)
- 深读笔记：<https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/08_Navigation/NaVILA_Legged_Robot_Vision-Language-Action_Model_for_Navigation/NaVILA_Legged_Robot_Vision-Language-Action_Model_for_Navigation.html>
- 论文：<https://arxiv.org/abs/2412.04453>

## 推荐继续阅读

- [机器人论文阅读笔记：NaVILA](https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/08_Navigation/NaVILA_Legged_Robot_Vision-Language-Action_Model_for_Navigation/NaVILA_Legged_Robot_Vision-Language-Action_Model_for_Navigation.html)
