...
arxiv: "2311.01450"
venue: "arXiv 2023"
summary: "Improves MBRL via reward smoothing."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2311_01450_dreamsmooth-improving-model-based-reinfo.md
...
**DreamSmooth: Improving Model-based Reinforcement Learning via Reward Smoothing** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 241/571** 篇，分组 **72 Continuous Control**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Improves MBRL via reward smoothing.
...
| 出处 | arXiv 2023 |
| 论文 | <https://arxiv.org/abs/2311.01450> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2311.01450) 为准。
...
**本条目的站内价值是把「DreamSmooth」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2311_01450_dreamsmooth-improving-model-based-reinfo.md`](../../sources/papers/sun_awesome_wm_2311_01450_dreamsmooth-improving-model-based-reinfo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2311.01450)
