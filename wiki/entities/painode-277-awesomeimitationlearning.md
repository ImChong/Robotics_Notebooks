...
status: complete
updated: 2026-09-20
code: https://github.com/kristery/awesome-imitation-learning
summary: "Learning from demonstrations."
related:
...
sources:
  - ../../sources/repos/pai_awesome_list_277_awesome-imitation-learning.md
...
**Awesome Imitation Learning** 收录于 awesome-physical-ai（natnew）**第 277/384** 条，分组 **Related Awesome Lists**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/kristery/Awesome-Imitation-Learning> |
| 代码/仓库 | <https://github.com/kristery/awesome-imitation-learning> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/kristery/Awesome-Imitation-Learning> |
| 代码/仓库 | <https://github.com/kristery/awesome-imitation-learning> |
...
- [`sources/repos/pai_awesome_list_277_awesome-imitation-learning.md`](../../sources/repos/pai_awesome_list_277_awesome-imitation-learning.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/kristery/Awesome-Imitation-Learning)
