...
**noetix_sdk_bumi** 是 [松延动力](https://github.com/Noetix-Robotics) 公开的 **SDK/驱动** 开源项目：通过DDS提供Bumi机器人的高层与低层控制示例，支持上层应用和本体联调。
...
1. 从官方 GitHub/Gitee 组织检索 `noetix_sdk_bumi` 仓库并核对 README 许可与依赖。
