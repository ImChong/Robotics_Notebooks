...
related:
  ...
  - ../entities/paper-loco-manip-161-135-amo.md
sources:
  - ../../sources/papers/loco_manip_161_survey_032_amo.md
...
**AMO** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 032/161** 篇，归类为 **02 上半身中心控制与移动操作接口**。
...
- AMO 把本体状态与关节序列、仿真交互数据、接触力/触觉信号转成可跟踪的身体目标，并通过PPO/RL 策略训练、ACT/行为克隆模仿学习、全身控制器/WBC/MPC训练或组合全身策略，最终输出全身轨迹/动作序列、低层控制器目标。关键点是把示范轨迹压成可监督的动作预测问题，再通过动作 chunk 或闭环执行降低时序抖动。
- 人形 Loco-Manip 161 篇 **#032/161** · 上半身中心控制与移动操作接口。
...
| 机构 | UC San Diego |
| 发表日期 | 2025年5月6日 |
| 论文/项目 | https://amo-humanoid.github.io/ |
...
- 原始 source：[loco_manip_161_survey_032_amo.md](../../sources/papers/loco_manip_161_survey_032_amo.md)

## 参考来源

- [loco_manip_161_survey_032_amo.md](../../sources/papers/loco_manip_161_survey_032_amo.md) — 161 篇策展摘录
