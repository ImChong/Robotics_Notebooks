...
updated: 2026-09-25
arxiv: "2608.28995"
summary: "In this paper, we present Hydra, a discrete World Action Model that closes this gap by moving the planner, both the sampler and the evaluator, inside the model. Evaluated on two physical robotic platforms, Hydra outperfo"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_28995_hydra-a-navigation-world-action-model-wi.md
...
**Hydra: A Navigation World Action Model with Discrete Latent Planning and Continuous Flow-Matching Execution** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 386/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this paper, we present Hydra, a discrete World Action Model that closes this gap by moving the planner, both the sampler and the evaluator, inside the model. Evaluated on two physical robotic platforms, Hydra outperforms state-of-the-art world models in goal-directed planning, while matching or exceeding the clos...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.28995> |
| 项目页 | <https://robotixx.github.io/hydra> |
| 子类 / 象限 | 导航 · 潜空间预测与JEPA · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.28995) 为准。
...
**本条目的站内价值是把「Hydra」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_28995_hydra-a-navigation-world-action-model-wi.md`](../../sources/papers/rcl_awesome_wam_2608_28995_hydra-a-navigation-world-action-model-wi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.28995)
