...
arxiv: "2503.00653"
venue: "arXiv 2025"
summary: "Discrete codebook world models for continuous control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_00653_dcwm-discrete-codebook-world-models-for.md
...
**DCWM: Discrete Codebook World Models for Continuous Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 254/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.00653> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.00653) 为准。
...
**本条目的站内价值是把「DCWM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_00653_dcwm-discrete-codebook-world-models-for.md`](../../sources/papers/sun_awesome_wm_2503_00653_dcwm-discrete-codebook-world-models-for.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.00653)
