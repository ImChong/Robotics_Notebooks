...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2510_10637_robosimgs-high-fidelity-simulated-data-g.md
...
**RoboSimGS: High-Fidelity Simulated Data Generation for Real-World Zero-Shot Robotic Manipulation Learning with Gaussian Splatting** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 039/063** 篇，分组 **41 Gaussian Splatting-based Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A Real2Sim2Real framework that uses 3D Gaussian Splatting and mesh primitives to create scalable, high-fidelity, and physically interactive simulation environments, enabling successful zero-shot sim-to-real transfer
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2510.10637> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2510.10637) 为准。
...
**本条目的站内价值是把「RoboSimGS」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2510_10637_robosimgs-high-fidelity-simulated-data-g.md`](../../sources/papers/sun_awesome_r2s2r_2510_10637_robosimgs-high-fidelity-simulated-data-g.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2510.10637)
