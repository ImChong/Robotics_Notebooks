...
sources:
  - ../../sources/papers/lc_awesome_sim2real_noarxiv_131_highway-env-an-environment-for-autonomou.md
...
**Highway-Env: An Environment for Autonomous Driving Decision-Making** 收录于 [AwesomeSim2Real](https://github.com/LongchaoDa/AwesomeSim2Real) **第 131/139** 篇，分组 **Transportation Environments**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://github.com/eleurent/highway-env> |
| 代码/项目 | <https://github.com/eleurent/highway-env> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/eleurent/highway-env) 为准。
...
**本条目的站内价值是把「Highway-Env」从外部 Awesome 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/lc_awesome_sim2real_noarxiv_131_highway-env-an-environment-for-autonomou.md`](../../sources/papers/lc_awesome_sim2real_noarxiv_131_highway-env-an-environment-for-autonomou.md) — 本条目策展摘录
...
- [原文](https://github.com/eleurent/highway-env)
