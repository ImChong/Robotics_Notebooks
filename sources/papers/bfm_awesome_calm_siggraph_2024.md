...
> 来源归档（ingest · awesome-bfm-papers 第 19/41）

- **标题：** CALM: Conditional Adversarial Latent Models for Directable Virtual Characters
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 可指挥 latent skill；BFM 前史：技能空间先于大基座。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 02 Goal-conditioned 学习，编号 **19/41**。
- **公众号导读要点：** 可指挥 latent skill；BFM 前史：技能空间先于大基座。
