...
status: complete
updated: 2026-09-20
summary: "Silicon Valley Robotics. Robot ecosystem and startups."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_240_andra-keay.md
...
**Andra Keay** 收录于 awesome-physical-ai（natnew）**第 240/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Silicon Valley Robotics. Robot ecosystem and startups.
...
- [`sources/repos/pai_awesome_person_240_andra-keay.md`](../../sources/repos/pai_awesome_person_240_andra-keay.md) — 本条目策展摘录
