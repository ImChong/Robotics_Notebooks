...
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/pai_awesome_1903_00374_simple.md
...
**SimPLe** 收录于 awesome-physical-ai（natnew）**第 380/384** 条，分组 **World Models**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Model-based RL baseline showing strong sample efficiency from learned video prediction.
...
| 分组 | World Models |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1903.00374> |
| arXiv | 1903.00374 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1903.00374) 为准。
...
**本条目的站内价值是把「SimPLe」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1903_00374_simple.md`](../../sources/papers/pai_awesome_1903_00374_simple.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1903.00374)
