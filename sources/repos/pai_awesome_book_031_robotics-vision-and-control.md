...
- **代码：** 未在清单中标注
- **清单摘要：** Corke. MATLAB/Python-based introduction to robotics fundamentals.
- **沉淀到 wiki：** [`wiki/entities/painode-031-roboticsvisionandcontrol.md`](../../wiki/entities/painode-031-roboticsvisionandcontrol.md)
...
- 实体页：[`wiki/entities/painode-031-roboticsvisionandcontrol.md`](../../wiki/entities/painode-031-roboticsvisionandcontrol.md)
