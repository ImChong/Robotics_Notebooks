...
arxiv: "2501.09781"
venue: "2025"
summary: "VideoWorld predicts compact multi-step dynamics codes alongside video frames, then converts predictions into task operations. On rendered 9×9 Go and simulated robot tasks, this representation substantially improves over"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2501_09781_videoworld-exploring-knowledge-learning.md
...
**VideoWorld: Exploring Knowledge Learning from Unlabeled Videos** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 528/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VideoWorld predicts compact multi-step dynamics codes alongside video frames, then converts predictions into task operations. On rendered 9×9 Go and simulated robot tasks, this representation substantially improves over video-only prediction. Expert-curated training data, language conditioning and a separately super...
...
| 分组 | WAMs |
| 出处 | 2025 |
| 论文 | <https://arxiv.org/abs/2501.09781> |
| 子类 / 象限 | 视觉规划与IDM · 潜空间预测与JEPA · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2501.09781) 为准。
...
**本条目的站内价值是把「VideoWorld」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2501_09781_videoworld-exploring-knowledge-learning.md`](../../sources/papers/rcl_awesome_wam_2501_09781_videoworld-exploring-knowledge-learning.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2501.09781)
