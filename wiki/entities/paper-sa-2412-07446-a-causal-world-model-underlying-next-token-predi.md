...
arxiv: "2412.07446"
venue: "arXiv 2024"
summary: "Explores the causal world model underlying next-token prediction in GPT."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2412_07446_a-causal-world-model-underlying-next-tok.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# A Causal World Model Underlying Next Token Prediction

**A Causal World Model Underlying Next Token Prediction: Exploring GPT in a Controlled Environment** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 548/571** 篇，分组 **Theory Interpretability & Positions**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Explores the causal world model underlying next-token prediction in GPT.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2412.07446> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2412.07446) 为准。
...
**本条目的站内价值是把「A Causal World Model Underlying Next Token Prediction」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2412_07446_a-causal-world-model-underlying-next-tok.md`](../../sources/papers/sun_awesome_wm_2412_07446_a-causal-world-model-underlying-next-tok.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2412.07446)
