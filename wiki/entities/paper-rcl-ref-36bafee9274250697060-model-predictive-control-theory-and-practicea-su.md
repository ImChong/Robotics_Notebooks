...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_36bafee9274250697060_model-predictive-control-theory-and-prac.md
...
**Model predictive control: Theory and practice—A survey** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 167/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | Automatica |
| 论文 | <https://www.sciencedirect.com/science/article/abs/pii/0005109889900022> |
| 子类 / 象限 | 理论与规划 · 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.sciencedirect.com/science/article/abs/pii/0005109889900022) 为准。
...
**本条目的站内价值是把「Model predictive control」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_36bafee9274250697060_model-predictive-control-theory-and-prac.md`](../../sources/papers/rcl_awesome_wam_ref_36bafee9274250697060_model-predictive-control-theory-and-prac.md) — 本条目策展摘录
...
- [原文](https://www.sciencedirect.com/science/article/abs/pii/0005109889900022)
