...
**Latent-WAM: Latent World Action Modeling for End-to-End Autonomous Driving** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 452/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Latent world action modeling for trajectory planning via spatial-aware and dynamic-aware latent representations.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.24581) 为准。
...
**本条目的站内价值是把「Latent-WAM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2603_24581_latent-wam-latent-world-action-modeling.md`](../../sources/papers/sun_awesome_wm_2603_24581_latent-wam-latent-world-action-modeling.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.24581)
