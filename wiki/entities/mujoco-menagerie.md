...
[MuJoCo Menagerie](https://github.com/google-deepmind/mujoco_menagerie) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「工程与实机部署」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

仓库为常见机器人维护可直接运行的MJCF资产，网格、执行器、传感器、默认姿态和关键参数已经过人工整理。算法对照复用同一资产，可减少模型适配差异对实验结论的干扰。
...
|------|------|
| 主表分组 | 工程与实机部署 |
| 官方入口 | https://github.com/google-deepmind/mujoco_menagerie |
...
```mermaid
flowchart LR
  A["上游数据 / 观测 / 配置"] --> B["MuJoCo Menagerie"]
  B --> C["下游策略 / 部署 / 评测"]
```
...
- [MuJoCo Menagerie 来源归档](../../sources/repos/mujoco-menagerie.md)
