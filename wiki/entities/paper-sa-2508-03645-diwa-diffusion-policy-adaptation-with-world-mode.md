...
arxiv: "2508.03645"
venue: "arXiv 2025"
code: https://diwa.cs.uni-freiburg.de
summary: "Diffusion policy adaptation with world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2508_03645_diwa-diffusion-policy-adaptation-with-wo.md
...
**DiWA: Diffusion Policy Adaptation with World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 191/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.03645> |
| 代码/项目 | <https://diwa.cs.uni-freiburg.de> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.03645) 为准。
...
**本条目的站内价值是把「DiWA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2508_03645_diwa-diffusion-policy-adaptation-with-wo.md`](../../sources/papers/sun_awesome_wm_2508_03645_diwa-diffusion-policy-adaptation-with-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2508.03645)
