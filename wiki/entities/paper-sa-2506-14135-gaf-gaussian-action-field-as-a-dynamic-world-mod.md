...
arxiv: "2506.14135"
venue: "arXiv 2025"
summary: "Gaussian action field as a dynamic world model for robotic manipulation."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2506_14135_gaf-gaussian-action-field-as-a-dynamic-w.md
...
**GAF: Gaussian Action Field as a Dynamic World Model for Robotic Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 298/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Gaussian action field as a dynamic world model for robotic manipulation.
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2506.14135> |
| 项目页 | <http://chaiying1.github.io/GAF.github.io/project_page/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2506.14135) 为准。
...
**这一页能给你的是「GAF」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2506_14135_gaf-gaussian-action-field-as-a-dynamic-w.md`](../../sources/papers/sun_awesome_wm_2506_14135_gaf-gaussian-action-field-as-a-dynamic-w.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2506.14135)
