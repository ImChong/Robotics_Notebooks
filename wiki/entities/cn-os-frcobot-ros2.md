...
**frcobot_ros2** 是 [法奥意威](https://github.com/FAIR-INNOVATION) 公开的 **工程与工具** 开源项目：为法奥意威协作机器人提供ROS2驱动、机器人描述、控制与MoveIt集成入口。
...
1. 从官方 GitHub/Gitee 组织检索 `frcobot_ros2` 仓库并核对 README 许可与依赖。
