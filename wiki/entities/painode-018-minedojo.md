...
status: complete
updated: 2026-09-20
summary: "Open-ended embodied-agent benchmark for long-horizon decision making in complex 3D worlds."
related:
...
**MineDojo** 收录于 awesome-physical-ai（natnew）**第 018/384** 条，分组 **Benchmarks**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-ended embodied-agent benchmark for long-horizon decision making in complex 3D worlds.
...
- [`sources/repos/pai_awesome_benchmark_018_minedojo.md`](../../sources/repos/pai_awesome_benchmark_018_minedojo.md) — 本条目策展摘录
