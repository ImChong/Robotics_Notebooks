...
- **标题：** Mobi-π: Mobilizing Your Robot Learning Policy
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/mobi-mobilizing-your-robot-learning-policy/mobi-mobilizing-your-robot-learning-policy.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2505.23692>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-mobi](../../wiki/entities/paper-notebook-mobi.md).

## 对 wiki 的映射

- [paper-notebook-mobi](../../wiki/entities/paper-notebook-mobi.md)
...
- 论文：<https://arxiv.org/abs/2505.23692>
