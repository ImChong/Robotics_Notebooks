...
- **代码：** <https://github.com/zchoi/awesome-embodied-robotics-and-agent>
- **清单摘要：** Embodied AI with VLMs and LLMs.
- **沉淀到 wiki：** [`wiki/entities/painode-275-awesomeembodiedagent.md`](../../wiki/entities/painode-275-awesomeembodiedagent.md)
...
- 实体页：[`wiki/entities/painode-275-awesomeembodiedagent.md`](../../wiki/entities/painode-275-awesomeembodiedagent.md)
