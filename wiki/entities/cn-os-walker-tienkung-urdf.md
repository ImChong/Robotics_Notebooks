...
sources:
  ...
  - ../../sources/repos/walker_tienkung_urdf.md
summary: "优必选 开源项目 Walker_TienKung_URDF（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - ubtech
---

# Walker_TienKung_URDF

## 一句话定义

**Walker_TienKung_URDF** 是 [优必选](https://github.com/UBTECH-Robot) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `Walker_TienKung_URDF` 仓库并核对 README 许可与依赖。
...
- [Walker_TienKung_URDF 源码归档](../../sources/repos/walker_tienkung_urdf.md)（<https://github.com/UBTECH-Robot/Walker_TienKung_URDF>）
