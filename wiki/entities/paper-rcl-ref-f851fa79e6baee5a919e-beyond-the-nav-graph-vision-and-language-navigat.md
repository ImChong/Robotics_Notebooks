...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_f851fa79e6baee5a919e_beyond-the-nav-graph-vision-and-language.md
...
**Beyond the Nav-Graph: Vision-and-Language Navigation in Continuous Environments** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 005/564** 篇，分组 **Benchmarks & simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ECCV 2020 |
| 论文 | <https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/6018_ECCV_2020_paper.php> |
| 子类 / 象限 | 导航基准 · 物理仿真 · 评测协议与诊断 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/6018_ECCV_2020_paper.php) 为准。
...
**本条目的站内价值是把「Beyond the Nav-Graph」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_f851fa79e6baee5a919e_beyond-the-nav-graph-vision-and-language.md`](../../sources/papers/rcl_awesome_wam_ref_f851fa79e6baee5a919e_beyond-the-nav-graph-vision-and-language.md) — 本条目策展摘录
...
- [原文](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/6018_ECCV_2020_paper.php)
