...
status: complete
updated: 2026-09-20
code: https://github.com/lee-jaewon/2025-arxiv-paper-list-gaussian-splatting
...
sources:
  - ../../sources/repos/pai_awesome_resource_001_2025-gs-paper-list.md
...
**2025 GS Paper List** 收录于 awesome-physical-ai（aichr）**第 001/384** 条，分组 **3D Computer Vision**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://github.com/Lee-JaeWon/2025-Arxiv-Paper-List-Gaussian-Splatting> |
| 代码/仓库 | <https://github.com/lee-jaewon/2025-arxiv-paper-list-gaussian-splatting> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/Lee-JaeWon/2025-Arxiv-Paper-List-Gaussian-Splatting> |
| 代码/仓库 | <https://github.com/lee-jaewon/2025-arxiv-paper-list-gaussian-splatting> |
...
- [`sources/repos/pai_awesome_resource_001_2025-gs-paper-list.md`](../../sources/repos/pai_awesome_resource_001_2025-gs-paper-list.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/Lee-JaeWon/2025-Arxiv-Paper-List-Gaussian-Splatting)
