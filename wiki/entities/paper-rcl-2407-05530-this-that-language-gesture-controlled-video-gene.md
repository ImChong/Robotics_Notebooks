...
arxiv: "2407.05530"
venue: "2024"
summary: "This&That turns an initial image, language and pointing coordinates into a generated video plan, then uses a separate DiVA behavior-cloning controller to follow it with live feedback. Gestures improve intent disambiguati"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2407_05530_this-that-language-gesture-controlled-vi.md
...
**This&That: Language-Gesture Controlled Video Generation for Robot Planning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 494/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

This&That turns an initial image, language and pointing coordinates into a generated video plan, then uses a separate DiVA behavior-cloning controller to follow it with live feedback. Gestures improve intent disambiguation in Bridge video generation and simulated block manipulation; real-robot execution remains unte...
...
| 分组 | WAMs |
| 出处 | 2024 |
| 论文 | <https://arxiv.org/abs/2407.05530> |
| 子类 / 象限 | 视觉规划与IDM · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2407.05530) 为准。
...
**本条目的站内价值是把「This&That」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2407_05530_this-that-language-gesture-controlled-vi.md`](../../sources/papers/rcl_awesome_wam_2407_05530_this-that-language-gesture-controlled-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2407.05530)
