...
arxiv: "2603.14851"
venue: "ICML 2026"
code: https://github.com/OscarHuangWind/AutoMoT
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_14851_automot-a-unified-vision-language-action.md
...
**AutoMoT: A Unified Vision-Language-Action Model with Asynchronous Mixture-of-Transformers for End-to-End Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 227/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | VLA |
| 出处 | ICML 2026 |
| 论文 | <https://icml.cc/virtual/2026/poster/64489> |
| 代码/项目 | <https://github.com/OscarHuangWind/AutoMoT> |
| 子类 / 象限 | 分层与双系统VLA · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://icml.cc/virtual/2026/poster/64489) 为准。
...
**本条目的站内价值是把「AutoMoT」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_14851_automot-a-unified-vision-language-action.md`](../../sources/papers/rcl_awesome_wam_2603_14851_automot-a-unified-vision-language-action.md) — 本条目策展摘录
...
- [原文](https://icml.cc/virtual/2026/poster/64489)
