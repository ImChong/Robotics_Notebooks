...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2406_10788_physically-embodied-gaussian-splatting-a.md
...
**Physically Embodied Gaussian Splatting: A Realtime Correctable World Model for Robotics** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 029/571** 篇，分组 **112 Differentiable Physics Engines & Neural Simulators**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A dual Gaussian‑Particle representation that models the physical world while supporting future state prediction and online observation correction.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2406.10788> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2406.10788) 为准。
...
**本条目的站内价值是把「Physically Embodied Gaussian Splatting」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2406_10788_physically-embodied-gaussian-splatting-a.md`](../../sources/papers/sun_awesome_wm_2406_10788_physically-embodied-gaussian-splatting-a.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2406.10788)
