...
summary: "We introduce FutureNav, a VLM-based unified world-action modeling framework for vision-and-language navigation. Extensive experiments show that, with only a 4B-scale backbone, FutureNav achieves state-of-the-art performa"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_30367_futurenav-unified-world-action-modeling.md
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.30367> |
| 代码/项目 | <https://github.com/linglingxiansen/FutureNav> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.30367) 为准。
...
**本条目的站内价值是把「FutureNav」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_30367_futurenav-unified-world-action-modeling.md`](../../sources/papers/rcl_awesome_wam_2606_30367_futurenav-unified-world-action-modeling.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.30367)
