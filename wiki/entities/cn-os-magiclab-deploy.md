...
**magiclab_deploy** 是 [魔法原子](https://github.com/MagiclabRobotics) 公开的 **运动RL/技能训练** 开源项目：提供魔法原子运动策略的运行与部署入口，将策略输出接到机器人控制接口。
...
1. 从官方 GitHub/Gitee 组织检索 `magiclab_deploy` 仓库并核对 README 许可与依赖。
