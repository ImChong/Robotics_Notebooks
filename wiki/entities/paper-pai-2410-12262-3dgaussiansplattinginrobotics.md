...
updated: 2026-09-20
arxiv: "2410.12262"
summary: "Survey on gaussian splatting applications in robotics."
related:
...
sources:
  - ../../sources/papers/pai_awesome_2410_12262_3d-gaussian-splatting-in-robotics.md
...
**3D Gaussian Splatting in Robotics** 收录于 awesome-physical-ai（natnew）**第 359/384** 条，分组 **Survey Papers**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Survey on gaussian splatting applications in robotics.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.12262) 为准。
...
**本条目的站内价值是把「3D Gaussian Splatting in Robotics」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_2410_12262_3d-gaussian-splatting-in-robotics.md`](../../sources/papers/pai_awesome_2410_12262_3d-gaussian-splatting-in-robotics.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2410.12262)
