...
**MEgoHand: Multimodal Egocentric Hand-Object Interaction Motion Generation** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 026/249** 篇，分组 **22 Hand-Object Interaction & Fine-grained Activity**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Proposes a two-layer architecture framework, using VLM to infer motion priors at the high level, and generating fine-grained trajectories based on DiT flow matching at the low level
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.neurips.cc/paper_files/paper/2025/hash/469c396a192043e3d70c04bdb3e5a532-Abstract-Conference.html) 为准。
...
**本条目的站内价值是把「MEgoHand」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_noarxiv_026_megohand-multimodal-egocentric-hand-obje.md`](../../sources/papers/sun_awesome_ego_noarxiv_026_megohand-multimodal-egocentric-hand-obje.md) — 本条目策展摘录
...
- [原文](https://proceedings.neurips.cc/paper_files/paper/2025/hash/469c396a192043e3d70c04bdb3e5a532-Abstract-Conference.html)
