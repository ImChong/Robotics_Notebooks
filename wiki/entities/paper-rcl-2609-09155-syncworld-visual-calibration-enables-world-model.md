...
arxiv: "2609.09155"
venue: "2026"
summary: "SyncWorld interprets robot commands through a short visual calibration context, then predicts proposed actions’ consequences with a video diffusion model. Calibration-conditioned training and distillation also support hi"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_09155_syncworld-visual-calibration-enables-wor.md
...
**SyncWorld: Visual Calibration Enables World Models as Zero-Shot Simulators** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 488/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

SyncWorld interprets robot commands through a short visual calibration context, then predicts proposed actions’ consequences with a video diffusion model. Calibration-conditioned training and distillation also support history-only prediction. It improves held-out video metrics and selected LIBERO policy outcomes, bu...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.09155> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.09155) 为准。
...
**本条目的站内价值是把「SyncWorld」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_09155_syncworld-visual-calibration-enables-wor.md`](../../sources/papers/rcl_awesome_wam_2609_09155_syncworld-visual-calibration-enables-wor.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.09155)
