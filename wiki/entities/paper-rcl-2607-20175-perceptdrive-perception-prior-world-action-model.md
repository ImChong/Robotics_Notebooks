...
updated: 2026-09-25
arxiv: "2607.20175"
summary: "Experiments show that PerceptDrive achieves state-of-the-art performance with 90.4 PDMS on NAVSIM v1 and 90.2 EPDMS on NAVSIM v2, outperforming existing methods."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2607_20175_perceptdrive-perception-prior-world-acti.md
...
**PerceptDrive: Perception Prior World-Action Modeling with Adaptive Expert Routing for End-to-End Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 449/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 子类 / 象限 | 自动驾驶 · 潜空间预测与JEPA · 视觉规划与IDM · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.20175) 为准。
...
**本条目的站内价值是把「PerceptDrive」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2607_20175_perceptdrive-perception-prior-world-acti.md`](../../sources/papers/rcl_awesome_wam_2607_20175_perceptdrive-perception-prior-world-acti.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2607.20175)
