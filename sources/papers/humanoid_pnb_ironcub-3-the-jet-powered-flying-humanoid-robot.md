...
- **标题：** iRonCub 3: The Jet-Powered Flying Humanoid Robot
- **类型：** paper
...
- **计划笔记路径：** `papers/12_Hardware_Design/ironcub-3-the-jet-powered-flying-humanoid-robot/ironcub-3-the-jet-powered-flying-humanoid-robot.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-ironcub-3-the-jet-powered-flying-humanoid-robot](../../wiki/entities/paper-notebook-ironcub-3-the-jet-powered-flying-humanoid-robot.md).

## 对 wiki 的映射

- [paper-notebook-ironcub-3-the-jet-powered-flying-humanoid-robot](../../wiki/entities/paper-notebook-ironcub-3-the-jet-powered-flying-humanoid-robot.md)
