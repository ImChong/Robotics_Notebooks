...
summary: "面向 Go1 的 ROS 2 真机控制示例包（代际偏旧，选型时对照 unitree_ros2 / SDK2）。"
---

# unitree_ros2_to_real

**unitree_ros2_to_real** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **ROS 集成** 主线。

## 一句话定义

面向 Go1 的 ROS 2 真机控制示例包（代际偏旧，选型时对照 unitree_ros2 / SDK2）。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/unitree_ros2_to_real`](https://github.com/unitreerobotics/unitree_ros2_to_real) |
| 组织分类 | ROS 集成 |
| 星标（2026-07-24） | ~84 |
| 最近推送 | 2023-01-13 |
| 主要语言 | C++ |
...
- unitreeleggedsdk: v3.5.1

- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/unitree_ros2_to_real.md](../../sources/repos/unitree_ros2_to_real.md)。
...
- [unitree_ros_to_real](./unitree-ros-to-real.md)
...
- 上游仓库：<https://github.com/unitreerobotics/unitree_ros2_to_real>
