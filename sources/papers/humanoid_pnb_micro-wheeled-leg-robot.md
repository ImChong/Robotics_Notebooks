...
- **计划笔记路径：** `papers/12_Hardware_Design/micro-wheeled-leg-robot/micro-wheeled-leg-robot.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-micro-wheeled-leg-robot](../../wiki/entities/paper-notebook-micro-wheeled-leg-robot.md).

## 对 wiki 的映射

- [paper-notebook-micro-wheeled-leg-robot](../../wiki/entities/paper-notebook-micro-wheeled-leg-robot.md)
