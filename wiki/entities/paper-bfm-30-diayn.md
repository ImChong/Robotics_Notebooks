...
summary: "无外部奖励学多样技能；「先学技能再服务任务」的早期思路。"
related:
...
**DIAYN 是「先学技能、再服务任务」这条思路的早期原型：没有外部奖励也能长出一组彼此可区分的技能。**
...
- [bfm_awesome_diayn_iclr_2018.md](../../sources/papers/bfm_awesome_diayn_iclr_2018.md) — awesome-bfm 策展摘录
