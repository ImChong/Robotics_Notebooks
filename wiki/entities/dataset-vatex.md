...
status: complete
updated: 2026-08-12
summary: "大规模多语言视频–文本数据集，用于视频描述与跨语言检索，服务多模态时序对齐研究。"
related:
...
**VaTeX**：大规模多语言视频–文本数据集，用于视频描述与跨语言检索，服务多模态时序对齐研究。

## 英文缩写速查

| 缩写 | 英文全称 | 简要说明 |
|------|----------|----------|
| VaTeX | Video and Text dataset | 多语言视频描述/检索集 |
...
| 维度 | 速查 |
|------|------|
| 规模 | 约 41k 视频片段量级，中英等多语描述。
| 模态 | 视频 + 多语句文本。
| 许可证 | 以官方发布条款为准。
| 适配形态 | 视频 VLM；具身侧作时序语言对齐参考。
| 重定向就绪度 | 不适用；视频–文本对可直接训练。
...
- [具身大模型评测基准选型闭环知识链](../queries/embodied-eval-benchmark-selection-loop.md) — 视频–文本时序对齐评测，对应①认知层的 AV 时序对齐维度
...
- [VaTeX 官方入口](https://eric-xw.github.io/vatex-website/)
