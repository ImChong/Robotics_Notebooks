...
arxiv: "2609.03681"
venue: "2026"
summary: "WISE post-trains a VLA action head by selectively imagining alternative behaviors at visually identified interaction states. A separate frozen world model predicts bounded futures; a frozen evaluator ranks them; updates"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2609_03681_wise-world-model-guided-imagination-sche.md
...
**WISE: World-model-guided Imagination Scheduling for Efficient Post-training of Vision-Language-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 537/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

WISE post-trains a VLA action head by selectively imagining alternative behaviors at visually identified interaction states. A separate frozen world model predicts bounded futures; a frozen evaluator ranks them; updates supervise only the first action chunk from a real context. The strongest controlled evidence is t...
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2609.03681> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2609.03681) 为准。
...
**本条目的站内价值是把「WISE」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2609_03681_wise-world-model-guided-imagination-sche.md`](../../sources/papers/rcl_awesome_wam_2609_03681_wise-world-model-guided-imagination-sche.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2609.03681)
