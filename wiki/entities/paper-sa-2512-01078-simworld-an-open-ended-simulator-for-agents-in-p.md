...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2512_01078_simworld-an-open-ended-simulator-for-age.md
...
**SimWorld: An Open-ended Simulator for Agents in Physical Environments** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 023/571** 篇，分组 **111 General Simulation Platforms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

A simulator built on Unreal Engine 5, designed for developing and evaluating LLM/VLM agents in rich real‑world scenarios, providing realistic and open‑ended world simulation.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.01078) 为准。
...
**这一页能给你的是「SimWorld」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2512_01078_simworld-an-open-ended-simulator-for-age.md`](../../sources/papers/sun_awesome_wm_2512_01078_simworld-an-open-ended-simulator-for-age.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.01078)
