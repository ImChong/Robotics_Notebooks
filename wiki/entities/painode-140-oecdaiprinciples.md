...
status: complete
updated: 2026-09-20
summary: "Intergovernmental principles guiding trustworthy AI deployment, including embodied systems."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_140_oecd-ai-principles.md
...
**OECD AI Principles** 收录于 awesome-physical-ai（natnew）**第 140/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Intergovernmental principles guiding trustworthy AI deployment, including embodied systems.
...
| 来源清单 | natnew |
| 主链接 | <https://oecd.ai/en/ai-principles> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://oecd.ai/en/ai-principles> |
...
- [`sources/repos/pai_awesome_standard_140_oecd-ai-principles.md`](../../sources/repos/pai_awesome_standard_140_oecd-ai-principles.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://oecd.ai/en/ai-principles)
