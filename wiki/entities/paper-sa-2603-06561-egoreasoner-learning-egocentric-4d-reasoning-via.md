...
sources:
  - ../../sources/papers/sun_awesome_ego_2603_06561_egoreasoner-learning-egocentric-4d-reaso.md
...
**EgoReasoner: Learning Egocentric 4D Reasoning via Task-Adaptive Structured Thinking** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 181/249** 篇，分组 **Advanced Reasoning & Cutting-edge Advances**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A two-stage framework for egocentric 4D reasoning tasks featuring task-adaptive thinking templates and reward functions that improve performance on complex spatial and temporal reasoning challenges
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2603.06561> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.06561) 为准。
...
**本条目的站内价值是把「EgoReasoner」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2603_06561_egoreasoner-learning-egocentric-4d-reaso.md`](../../sources/papers/sun_awesome_ego_2603_06561_egoreasoner-learning-egocentric-4d-reaso.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.06561)
