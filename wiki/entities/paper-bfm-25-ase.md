...
summary: "可复用技能嵌入；与 AMP 分布约束不同，强调技能空间。"
related:
...
**ASE** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 25/41** 篇，归类为 **02 Goal-conditioned 学习**（2022 · TOG）。

## 一句话定义

可复用技能嵌入；与 AMP 分布约束不同，强调技能空间。
...
- 可复用技能嵌入；与 AMP 分布约束不同，强调技能空间。
- 在 [BFM 41 篇技术地图](../overview/bfm-41-papers-technology-map.md) 中属于 **02 Goal-conditioned 学习**（#25/41）。
...
- 原始 source：[bfm_awesome_ase_arxiv_2205_01906.md](../../sources/papers/bfm_awesome_ase_arxiv_2205_01906.md)

## 参考来源

- [bfm_awesome_ase_arxiv_2205_01906.md](../../sources/papers/bfm_awesome_ase_arxiv_2205_01906.md) — awesome-bfm 策展摘录
