...
summary: "小鹏 IRON CN120941401A：上肢动作与下肢行走的分区混合控制（2025-11-14 公开/公告）；下肢/腰部力矩与上肢参考位置分路生成，蒙版合并全身指令，训练时可引入上肢替代动作扰动。…"
---

# 小鹏 IRON · 上肢动作与下肢行走的分区混合控制（CN120941401A）

专利 **CN120941401A**（*上肢动作与下肢行走的分区混合控制*，小鹏机器人 / IRON 相关布局，2025-11-14）公开 **全身控制·具身智能** 方向的结构或控制方案 — 编译自 [54 项专利盘点](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)（AI工业 / 微信公众号，2026-09-24）。

## 一句话定义

**下肢/腰部力矩与上肢参考位置分路生成，蒙版合并全身指令，训练时可引入上肢替代动作扰动。**
...
- **局限：** 公众号整理为 **摘要级** 解读，力矩/带宽/控制频率等 **未在 ingest 中量化**；细节以 [Google Patents](https://patents.google.com/patent/CN120941401A/zh) 原文为准。
...
- [小鹏 IRON 54 项专利索引（CN）](../../sources/patents/xpeng_iron_patents_cn.md#cn120941401a)
- [微信公众号盘点归档](../../sources/blogs/wechat_xpeng_iron_54_patents_2026-09-24.md)

## 推荐继续阅读

- Google Patents：[CN120941401A](https://patents.google.com/patent/CN120941401A/zh)
