...
sources:
  - ../../sources/papers/interiorgs_lightnav_2026.md
  - ../../sources/blogs/lightorigins_lightnav_0_2026-09-01.md
summary: "InteriorGS：INSIGHT-Bench 训练 16.1% 来自 InteriorGS；可导入官方 3D bbox 或 Molmo2 开放词汇标注。"
---

# InteriorGS

**InteriorGS**（InteriorGS：室内高斯泼溅场景（LightNav 数据引擎来源））在 [Light Origins · LightNav-0：以规模化 Real2Sim2Real 实现零样本通用导航](https://www.lightorigins.com/blog/lightnav-0) 中被引用。

## 一句话定义

**INSIGHT-Bench 训练 16.1% 来自 InteriorGS；可导入官方 3D bbox 或 Molmo2 开放词汇标注。**
...
**InteriorGS 是 LightNav / LightParkour 管线中的关键组件——读博客数字前先对齐本页定义与开源边界。**
...
- [interiorgs_lightnav_2026.md](../../sources/papers/interiorgs_lightnav_2026.md)
