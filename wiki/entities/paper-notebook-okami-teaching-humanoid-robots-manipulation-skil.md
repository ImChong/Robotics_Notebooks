...
**OKAMI: Teaching Humanoid Robots Manipulation Skills through Single Video Imitation** 收录于 [Robot Learning Paper Notebooks](https://imchong.github.io/Robot_Learning_Paper_Notebooks/index.html)（分类：06_Manipulation），深读笔记已完成。本页是 **笔记摘要**：要点编译自深读笔记，细节以笔记原文与论文 PDF 为准。
...
- 本页未列失败模式，但方法显式依赖单段 RGB-D 视频的质量与开放世界模型能否认出任务相关物体，这两处也是最直接的能力边界。
