...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2512_19390_twinaligner-visual-dynamic-alignment-emp.md
...
**TwinAligner: Visual-Dynamic Alignment Empowers Physics-aware Real2Sim2Real for Robotic Manipulation** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 050/063** 篇，分组 **42 Simulation Frameworks & Pipelines**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

A novel Real2Sim2Real system that addresses both visual and dynamic gaps in robot learning by providing scalable data collection and establishing a trustworthy iterative cycle, accelerating algorithm development
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2512.19390> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.19390) 为准。
...
**本条目的站内价值是把「TwinAligner」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_r2s2r_2512_19390_twinaligner-visual-dynamic-alignment-emp.md`](../../sources/papers/sun_awesome_r2s2r_2512_19390_twinaligner-visual-dynamic-alignment-emp.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.19390)
