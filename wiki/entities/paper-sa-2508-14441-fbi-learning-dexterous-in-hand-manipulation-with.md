...
sources:
  - ../../sources/papers/sun_awesome_touch_2508_14441_fbi-learning-dexterous-in-hand-manipulat.md
...
**FBI: Learning Dexterous In-hand Manipulation with Dynamic Visuotactile Shortcut Policy** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 021/065** 篇，分组 **51 Imitation Learning with Tactile Feedback**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Flow Before Imitation (FBI) framework dynamically fuses tactile interactions with visual observations through motion dynamics; transformer-based interaction module with one-step diffusion policy for real-time execution.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2508.14441> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2508.14441) 为准。
...
**本条目的站内价值是把「FBI」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2508_14441_fbi-learning-dexterous-in-hand-manipulat.md`](../../sources/papers/sun_awesome_touch_2508_14441_fbi-learning-dexterous-in-hand-manipulat.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2508.14441)
