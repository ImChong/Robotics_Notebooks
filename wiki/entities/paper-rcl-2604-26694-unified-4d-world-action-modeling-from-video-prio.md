...
arxiv: "2604.26694"
venue: "2026"
summary: "X-WAM adapts a pretrained video diffusion transformer to predict robot actions, future states and multi-view RGB-D observations together. A one-way depth branch adds geometric supervision, while asynchronous denoising re"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2604_26694_unified-4d-world-action-modeling-from-vi.md
...
**Unified 4D World Action Modeling from Video Priors with Asynchronous Denoising** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 506/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

X-WAM adapts a pretrained video diffusion transformer to predict robot actions, future states and multi-view RGB-D observations together. A one-way depth branch adds geometric supervision, while asynchronous denoising releases actions before completing video generation. The paper reports strong simulated manipulatio...
...
| 子类 / 象限 | 联合视频动作建模 · 三维多视角建模 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.26694) 为准。
...
**本条目的站内价值是把「Unified 4D World Action Modeling from Video Priors with Asynchronous Denoising」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2604_26694_unified-4d-world-action-modeling-from-vi.md`](../../sources/papers/rcl_awesome_wam_2604_26694_unified-4d-world-action-modeling-from-vi.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.26694)
