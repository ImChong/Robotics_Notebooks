...
- **计划笔记路径：** `papers/05_Locomotion/symphony-a-heuristic-normalized-calibrated-advan/symphony-a-heuristic-normalized-calibrated-advan.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-symphony-a-heuristic-normalized-calibrated-advan](../../wiki/entities/paper-notebook-symphony-a-heuristic-normalized-calibrated-advan.md).

## 对 wiki 的映射

- [paper-notebook-symphony-a-heuristic-normalized-calibrated-advan](../../wiki/entities/paper-notebook-symphony-a-heuristic-normalized-calibrated-advan.md)
