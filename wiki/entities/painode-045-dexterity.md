...
status: complete
updated: 2026-09-20
summary: "AI robotics company deploying high-throughput manipulation systems for logistics."
related:
...
sources:
  - ../../sources/repos/pai_awesome_company_045_dexterity.md
...
**Dexterity** 收录于 awesome-physical-ai（natnew）**第 045/384** 条，分组 **Companies**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

AI robotics company deploying high-throughput manipulation systems for logistics.
...
- [`sources/repos/pai_awesome_company_045_dexterity.md`](../../sources/repos/pai_awesome_company_045_dexterity.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.dexterity.ai/)
