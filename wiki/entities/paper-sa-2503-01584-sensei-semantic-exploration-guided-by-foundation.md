...
arxiv: "2503.01584"
venue: "arXiv 2025"
summary: "Semantic exploration guided by foundation models to learn versatile world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_01584_sensei-semantic-exploration-guided-by-fo.md
...
**SENSEI: Semantic Exploration Guided by Foundation Models to Learn Versatile World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 267/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Semantic exploration guided by foundation models to learn versatile world models.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.01584) 为准。
...
**本条目的站内价值是把「SENSEI」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_01584_sensei-semantic-exploration-guided-by-fo.md`](../../sources/papers/sun_awesome_wm_2503_01584_sensei-semantic-exploration-guided-by-fo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.01584)
