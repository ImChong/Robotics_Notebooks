...
**ROS2Ti5DualArmManipulation** 是 [钛虎机器人](https://github.com/ti5robot) 公开的 **SDK/驱动** 开源项目：人形双臂操作 ROS2 控制接口
...
1. 从官方 GitHub/Gitee 组织检索 `ROS2Ti5DualArmManipulation` 仓库并核对 README 许可与依赖。
