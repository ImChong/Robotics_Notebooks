...
**pymycobot** 是 [大象机器人](https://github.com/elephantrobotics) 公开的 **工程与工具** 开源项目：提供大象机器人多类机械臂和双臂产品的统一Python API，用于连接、状态读取、关节与末端控制及外设集成。
...
1. 从官方 GitHub/Gitee 组织检索 `pymycobot` 仓库并核对 README 许可与依赖。
