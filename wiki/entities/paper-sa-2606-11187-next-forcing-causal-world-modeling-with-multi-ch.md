...
arxiv: "2606.11187"
venue: "arXiv 2026"
summary: "Multi-chunk prediction framework enabling faster training, higher accuracy, and accelerated inference."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_11187_next-forcing-causal-world-modeling-with.md
...
**Next Forcing: Causal World Modeling with Multi-Chunk Prediction** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 083/571** 篇，分组 **42 Visual / Video World Models**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Multi-chunk prediction framework enabling faster training, higher accuracy, and accelerated inference.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.11187> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.11187) 为准。
...
**这一页能给你的是「Next Forcing」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2606_11187_next-forcing-causal-world-modeling-with.md`](../../sources/papers/sun_awesome_wm_2606_11187_next-forcing-causal-world-modeling-with.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.11187)
