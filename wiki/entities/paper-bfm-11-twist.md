...
summary: "遥操作同时是 BFM 数据生产方式：稳定全身轨迹沉淀为训练语料。"
related:
...
**TWIST** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 11/41** 篇，归类为 **02 Goal-conditioned 学习**（2025 · CoRL）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_twist_corl_2025.md](../../sources/papers/bfm_awesome_twist_corl_2025.md)
