...
summary: "Dream2Flow converts generated human-interaction videos into 3D object trajectories, then uses domain-specific optimization or reinforcement learning to make a robot realize them. Its central benefit is an object-level in"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2512_24766_dream2flow-bridging-video-generation-and.md
...
**Dream2Flow: Bridging Video Generation and Open-World Manipulation with 3D Object Flow** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 311/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Dream2Flow converts generated human-interaction videos into 3D object trajectories, then uses domain-specific optimization or reinforcement learning to make a robot realize them. Its central benefit is an object-level interface across embodiments; its reliability still depends on video geometry, tracking, contact as...
...
| 分组 | WAMs |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2512.24766> |
| 子类 / 象限 | 视觉规划与IDM · 三维多视角建模 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.24766) 为准。
...
**本条目的站内价值是把「Dream2Flow」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2512_24766_dream2flow-bridging-video-generation-and.md`](../../sources/papers/rcl_awesome_wam_2512_24766_dream2flow-bridging-video-generation-and.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.24766)
