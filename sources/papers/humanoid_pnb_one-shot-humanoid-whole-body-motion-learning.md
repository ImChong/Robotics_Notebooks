...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/One-shot_Humanoid_Whole-body_Motion_Learning/One-shot_Humanoid_Whole-body_Motion_Learning.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-one-shot-humanoid-whole-body-motion-learning](../../wiki/entities/paper-notebook-one-shot-humanoid-whole-body-motion-learning.md).

## 对 wiki 的映射

- [paper-notebook-one-shot-humanoid-whole-body-motion-learning](../../wiki/entities/paper-notebook-one-shot-humanoid-whole-body-motion-learning.md)
