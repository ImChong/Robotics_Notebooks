...
arxiv: "2604.26182"
venue: "arXiv 2026"
summary: "Lifting methods for embodied world models in planning and control."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2604_26182_lifting-embodied-world-models-for-planni.md
...
**Lifting Embodied World Models for Planning and Control** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 556/571** 篇，分组 **Theory Interpretability & Positions**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Lifting methods for embodied world models in planning and control.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2604.26182> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.26182) 为准。
...
**本条目的站内价值是把「Lifting Embodied World Models for Planning and Control」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2604_26182_lifting-embodied-world-models-for-planni.md`](../../sources/papers/sun_awesome_wm_2604_26182_lifting-embodied-world-models-for-planni.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.26182)
