...
summary: "We present SimWAM, a simple yet effective WAM that leverages future-video prediction as a training-time supervision signal. Our SimWAM achieves 91.5 PDMS on NAVSIM, surpasses state-of-the-art WAM-based planners with subs"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_07468_simwam-a-simple-world-action-model-for-e.md
...
**SimWAM: A Simple World Action Model for End-to-End Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 481/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present SimWAM, a simple yet effective WAM that leverages future-video prediction as a training-time supervision signal. Our SimWAM achieves 91.5 PDMS on NAVSIM, surpasses state-of-the-art WAM-based planners with substantially lower latency, and transfers zero-shot to nuScenes.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.07468> |
| 代码/项目 | <https://github.com/H-EmbodVis/SimWAM> |
| 子类 / 象限 | 自动驾驶 · 高效推理与实时控制 · 策略后训练与WM-RL · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.07468) 为准。
...
**本条目的站内价值是把「SimWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_07468_simwam-a-simple-world-action-model-for-e.md`](../../sources/papers/rcl_awesome_wam_2608_07468_simwam-a-simple-world-action-model-for-e.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.07468)
