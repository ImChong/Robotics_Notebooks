...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2505_19017_worldeval-world-model-as-real-world-robo.md
...
**WorldEval: World Model as Real-World Robot Policies Evaluator** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 393/571** 篇，分组 **816 Policy Evaluation with World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

World model as real-world robot policy evaluator.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.19017) 为准。
...
**本条目的站内价值是把「WorldEval」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2505_19017_worldeval-world-model-as-real-world-robo.md`](../../sources/papers/sun_awesome_wm_2505_19017_worldeval-world-model-as-real-world-robo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.19017)
