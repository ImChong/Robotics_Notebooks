...
- 边界：本条目为清单索引条目，硬件 BOM、成本与实机指标以 <https://toddlerbot.github.io> 为准。
...
- 同类桌面 ML 平台（双形态手/人形）：[Handroid](./handroid.md)
...
- 同题深读/既有实体：[paper-loco-manip-161-141-toddlerbot](../entities/paper-loco-manip-161-141-toddlerbot.md)
