...
- **标题：** Antagonistic Bowden-Cable Actuation of a Lightweight Robotic Hand
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Humanoid_Robot_Learning_Paper_Notebooks/papers/12_Hardware_Design/Antagonistic_Bowden-Cable_Actuation_of_a_Lightweight_Robotic_Hand/Antagonistic_Bowden-Cable_Actuation_of_a_Lightweight_Robotic_Hand.html>
...
- 知识归纳见 wiki 实体页：[paper-notebook-antagonistic-bowden-cable-actuation-of-a-lightwe](../../wiki/entities/paper-notebook-antagonistic-bowden-cable-actuation-of-a-lightwe.md).

## 对 wiki 的映射

- [paper-notebook-antagonistic-bowden-cable-actuation-of-a-lightwe](../../wiki/entities/paper-notebook-antagonistic-bowden-cable-actuation-of-a-lightwe.md)
