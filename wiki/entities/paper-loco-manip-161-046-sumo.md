...
related:
  ...
  - ../methods/sumo.md
sources:
  - ../../sources/papers/loco_manip_161_survey_046_sumo.md
...
**Sumo** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 046/161** 篇，归类为 **02 上半身中心控制与移动操作接口**。
...
- Sumo 把本体状态与关节序列、仿真交互数据转成可跟踪的身体目标，并通过扩散策略/流匹配、全身控制器/WBC/MPC、分层技能/专家策略训练或组合全身策略，最终输出全身轨迹/动作序列、低层控制器目标。关键点是把动作生成看成条件生成问题，用扩散或流匹配在多模态动作分布里采样可执行轨迹。
- 人形 Loco-Manip 161 篇 **#046/161** · 上半身中心控制与移动操作接口。
...
- 评测原始出处：[原文 / 项目页](https://sumo.rai-inst.com/)（见上方「核心信息」表「论文/项目」一行）。
...
- 原始 source：[loco_manip_161_survey_046_sumo.md](../../sources/papers/loco_manip_161_survey_046_sumo.md)

## 参考来源

- [loco_manip_161_survey_046_sumo.md](../../sources/papers/loco_manip_161_survey_046_sumo.md) — 161 篇策展摘录
...
- 同题深读/既有实体：[sumo](../methods/sumo.md)
