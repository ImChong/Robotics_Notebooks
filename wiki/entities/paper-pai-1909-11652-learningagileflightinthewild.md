...
updated: 2026-09-20
arxiv: "1909.11652"
summary: "Sim-to-real pipeline for high-speed quadrotor control under real-world disturbances."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/pai_awesome_1909_11652_learning-agile-flight-in-the-wild.md
...
**Learning Agile Flight in the Wild** 收录于 awesome-physical-ai（natnew）**第 333/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real pipeline for high-speed quadrotor control under real-world disturbances.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/1909.11652> |
| arXiv | 1909.11652 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/1909.11652) 为准。
...
**本条目的站内价值是把「Learning Agile Flight in the Wild」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/papers/pai_awesome_1909_11652_learning-agile-flight-in-the-wild.md`](../../sources/papers/pai_awesome_1909_11652_learning-agile-flight-in-the-wild.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/1909.11652)
