...
- **代码：** 未在清单中标注
- **清单摘要：** ACM/IEEE International Conference on Human-Robot Interaction.
- **沉淀到 wiki：** [`wiki/entities/painode-055-hri.md`](../../wiki/entities/painode-055-hri.md)
...
- 实体页：[`wiki/entities/painode-055-hri.md`](../../wiki/entities/painode-055-hri.md)
