...
**ABot-3DWorld** 是 [阿里巴巴](https://github.com/amap-cvlab) 公开的 **世界模型** 开源项目：文本/图像/多视图/视频生成可探索 3D 世界（高德 ABot 系列）
...
1. 从官方 GitHub/Gitee 组织检索 `ABot-3DWorld` 仓库并核对 README 许可与依赖。
