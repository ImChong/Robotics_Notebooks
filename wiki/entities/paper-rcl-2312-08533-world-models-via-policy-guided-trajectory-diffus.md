...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2312_08533_world-models-via-policy-guided-trajector.md
...
**World Models via Policy-Guided Trajectory Diffusion** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 188/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | TMLR 2024 |
| 论文 | <https://openreview.net/forum?id=9CcgO0LhKG> |
| 子类 / 象限 | 经典WM与模型式RL · 扩散与流匹配基础 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=9CcgO0LhKG) 为准。
...
**本条目的站内价值是把「World Models via Policy-Guided Trajectory Diffusion」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2312_08533_world-models-via-policy-guided-trajector.md`](../../sources/papers/rcl_awesome_wam_2312_08533_world-models-via-policy-guided-trajector.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=9CcgO0LhKG)
