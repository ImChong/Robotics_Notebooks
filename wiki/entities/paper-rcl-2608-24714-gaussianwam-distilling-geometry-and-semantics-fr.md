...
updated: 2026-09-25
arxiv: "2608.24714"
summary: "We propose \\textbf{GaussianWAM}, a training-time representation-enhancement framework that organizes geometric and semantic supervision through a 3D Gaussian field."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_24714_gaussianwam-distilling-geometry-and-sema.md
...
**GaussianWAM: Distilling Geometry and Semantics from 3D Gaussian Fields into World-Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 366/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 项目页 | <https://tuojingai.github.io/GaussianWAM-project-page/> |
| 子类 / 象限 | 三维多视角建模 · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.24714) 为准。
...
**本条目的站内价值是把「GaussianWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_24714_gaussianwam-distilling-geometry-and-sema.md`](../../sources/papers/rcl_awesome_wam_2608_24714_gaussianwam-distilling-geometry-and-sema.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.24714)
