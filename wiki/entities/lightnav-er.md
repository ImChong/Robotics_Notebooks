...
sources:
  - ../../sources/papers/lightnav_er_lightorigins_2026.md
  - ../../sources/blogs/lightorigins_lightnav_0_2026-09-01.md
summary: "LightNav-ER：LightNav-0 第一阶段 ER 中期训练产物；8 项具身推理基准平均 67.4（4 第一 / 4 第二），为 SFT 提供空间先验。"
---

# LightNav-ER

**LightNav-ER**（LightNav-ER：具身推理中期训练模型）在 [Light Origins · LightNav-0：以规模化 Real2Sim2Real 实现零样本通用导航](https://www.lightorigins.com/blog/lightnav-0) 中被引用。

## 一句话定义

**LightNav-0 第一阶段 ER 中期训练产物；8 项具身推理基准平均 67.4（4 第一 / 4 第二），为 SFT 提供空间先验。**
...
- 对齐段「先理解空间再学行动」的可操作锚点；MolmoER / Gemini Robotics-ER 同路线对照。
...
|----|------|
| **类型** | product |
| **出处** | Light Origins Tech Blog 2026-09-01 |
| **开源** | **未单独发布** |
...
**LightNav-ER 是 LightNav / LightParkour 管线中的关键组件——读博客数字前先对齐本页定义与开源边界。**
...
- [lightnav_er_lightorigins_2026.md](../../sources/papers/lightnav_er_lightorigins_2026.md)
