...
status: complete
updated: 2026-09-20
summary: "Functional safety standard for electrical and software systems in road vehicles."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_standard_136_iso-26262.md
...
**ISO 26262** 收录于 awesome-physical-ai（natnew）**第 136/384** 条，分组 **Governance & Policy**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Functional safety standard for electrical and software systems in road vehicles.
...
| 来源清单 | natnew |
| 主链接 | <https://www.iso.org/standard/43464.html> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.iso.org/standard/43464.html> |
...
- [`sources/repos/pai_awesome_standard_136_iso-26262.md`](../../sources/repos/pai_awesome_standard_136_iso-26262.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.iso.org/standard/43464.html)
