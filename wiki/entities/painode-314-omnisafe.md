...
summary: "Open-source safe-RL training framework with strong baseline implementations."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/repos/pai_awesome_resource_314_omnisafe.md
...
**OmniSafe** 收录于 awesome-physical-ai（natnew）**第 314/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Open-source safe-RL training framework with strong baseline implementations.
...
| 来源清单 | natnew |
| 主链接 | <https://github.com/PKU-Alignment/omnisafe> |
| 代码/仓库 | <https://github.com/pku-alignment/omnisafe> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/PKU-Alignment/omnisafe> |
| 代码/仓库 | <https://github.com/pku-alignment/omnisafe> |
...
- [`sources/repos/pai_awesome_resource_314_omnisafe.md`](../../sources/repos/pai_awesome_resource_314_omnisafe.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/PKU-Alignment/omnisafe)
