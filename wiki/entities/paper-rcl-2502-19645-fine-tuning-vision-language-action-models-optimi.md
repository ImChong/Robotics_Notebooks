...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2502_19645_fine-tuning-vision-language-action-model.md
...
**Fine-Tuning Vision-Language-Action Models: Optimizing Speed and Success** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 233/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 代码/项目 | <https://github.com/moojink/openvla-oft> |
| 子类 / 象限 | VLA后训练与数据增强 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2502.19645) 为准。
...
**本条目的站内价值是把「Fine-Tuning Vision-Language-Action Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2502_19645_fine-tuning-vision-language-action-model.md`](../../sources/papers/rcl_awesome_wam_2502_19645_fine-tuning-vision-language-action-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2502.19645)
