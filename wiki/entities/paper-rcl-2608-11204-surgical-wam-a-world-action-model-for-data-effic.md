...
updated: 2026-09-25
arxiv: "2608.11204"
summary: "To answer it, we introduce the Surgical World-Action Model (Surgical WAM), a unified generative model built on Cosmos Policy that jointly predicts future endoscopic observations and executable surgical robot action chunk"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_11204_surgical-wam-a-world-action-model-for-da.md
...
**Surgical WAM: A World-Action Model for Data-Efficient Surgical Robot Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 487/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.11204> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.11204) 为准。
...
**本条目的站内价值是把「Surgical WAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_11204_surgical-wam-a-world-action-model-for-da.md`](../../sources/papers/rcl_awesome_wam_2608_11204_surgical-wam-a-world-action-model-for-da.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.11204)
