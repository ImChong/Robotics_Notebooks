...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/SPIDER__Scalable_Physics-Informed_DExterous_Retargeting/SPIDER__Scalable_Physics-Informed_DExterous_Retargeting.md`
...
- 知识归纳见 wiki 实体页：[spider-physics-informed-dexterous-retargeting](../../wiki/methods/spider-physics-informed-dexterous-retargeting.md).

## 对 wiki 的映射

- [spider-physics-informed-dexterous-retargeting](../../wiki/methods/spider-physics-informed-dexterous-retargeting.md)
