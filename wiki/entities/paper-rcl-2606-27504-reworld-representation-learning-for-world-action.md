...
summary: "We present ReWorld, the first representation learning framework specifically designed for autonomous-driving WAMs."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2606_27504_reworld-representation-learning-for-worl.md
...
**ReWorld: Representation Learning for World Action Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 461/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present ReWorld, the first representation learning framework specifically designed for autonomous-driving WAMs.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2606.27504> |
| 代码/项目 | <https://github.com/xiaomi-research/ReWorld> |
| 子类 / 象限 | 自动驾驶 · 视觉规划与IDM · 泛化与动作对齐 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.27504) 为准。
...
**本条目的站内价值是把「ReWorld」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2606_27504_reworld-representation-learning-for-worl.md`](../../sources/papers/rcl_awesome_wam_2606_27504_reworld-representation-learning-for-worl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.27504)
