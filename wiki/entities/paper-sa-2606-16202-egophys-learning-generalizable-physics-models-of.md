...
sources:
  - ../../sources/papers/sun_awesome_ego_2606_16202_egophys-learning-generalizable-physics-m.md
...
**EgoPhys: Learning Generalizable Physics Models of Deformable Objects from Egocentric Video** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 080/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Constructs deformable physical digital twins from egocentric RGB-only video using generalizable priors, enabling prediction of dense spring stiffness fields for unseen objects
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2606.16202> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.16202) 为准。
...
**本条目的站内价值是把「EgoPhys」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2606_16202_egophys-learning-generalizable-physics-m.md`](../../sources/papers/sun_awesome_ego_2606_16202_egophys-learning-generalizable-physics-m.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.16202)
