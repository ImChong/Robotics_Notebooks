...
**Active Pretraining with Successor Features** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 26/41** 篇，归类为 **03 Intrinsic reward 预训练**（2021 · ICML）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
