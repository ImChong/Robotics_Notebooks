...
related:
  ...
  - ./unitree-sdk2.md
sources:
  - ../../sources/repos/digital_servo.md
...
**digital_servo** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **工具与调试** 主线。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/digital_servo`](https://github.com/unitreerobotics/digital_servo) |
| 组织分类 | 工具与调试 |
| 星标（2026-07-24） | ~1 |
| 最近推送 | 2026-07-22 |
| 主要语言 | C |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/digital_servo.md](../../sources/repos/digital_servo.md)。
...
- [sources/repos/digital_servo.md](../../sources/repos/digital_servo.md)
- [sources/repos/unitree.md](../../sources/repos/unitree.md) — 组织级仓库地图
- 上游仓库：<https://github.com/unitreerobotics/digital_servo>
