...
summary: "Video2Act turns observed video into conditioning for a separate robot action policy. Sobel filtering emphasizes spatial structure in video-model features, while temporal Fourier filtering emphasizes motion. A slow video"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2512_03044_video2act-a-dual-system-video-diffusion.md
...
**Video2Act: A Dual-System Video Diffusion Policy with Robotic Spatio-Motional Modeling** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 259/564** 篇，分组 **VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Video2Act turns observed video into conditioning for a separate robot action policy. Sobel filtering emphasizes spatial structure in video-model features, while temporal Fourier filtering emphasizes motion. A slow video network refreshes these representations for a faster diffusion action head. The strongest evidenc...
...
| 分组 | VLA |
| 出处 | arXiv preprint |
| 论文 | <https://arxiv.org/abs/2512.03044> |
| 子类 / 象限 | 分层与双系统VLA · 扩散与流匹配VLA |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2512.03044) 为准。
...
**本条目的站内价值是把「Video2Act」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2512_03044_video2act-a-dual-system-video-diffusion.md`](../../sources/papers/rcl_awesome_wam_2512_03044_video2act-a-dual-system-video-diffusion.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2512.03044)
