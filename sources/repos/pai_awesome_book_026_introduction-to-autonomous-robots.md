...
- **代码：** 未在清单中标注
- **清单摘要：** Correll et al. Open-source robotics textbook.
- **沉淀到 wiki：** [`wiki/entities/painode-026-introductiontoautonomousrobots.md`](../../wiki/entities/painode-026-introductiontoautonomousrobots.md)
...
- 实体页：[`wiki/entities/painode-026-introductiontoautonomousrobots.md`](../../wiki/entities/painode-026-introductiontoautonomousrobots.md)
