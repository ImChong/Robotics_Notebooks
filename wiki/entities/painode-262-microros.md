...
status: complete
updated: 2026-09-20
summary: "ROS 2 client stack for microcontrollers and embedded real-time robot components."
related:
...
sources:
  - ../../sources/repos/pai_awesome_resource_262_micro-ros.md
...
**micro-ROS** 收录于 awesome-physical-ai（natnew）**第 262/384** 条，分组 **Production Patterns / Reference Architectures**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

ROS 2 client stack for microcontrollers and embedded real-time robot components.
...
- [`sources/repos/pai_awesome_resource_262_micro-ros.md`](../../sources/repos/pai_awesome_resource_262_micro-ros.md) — 本条目策展摘录
