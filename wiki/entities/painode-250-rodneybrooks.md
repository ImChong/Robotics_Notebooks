...
status: complete
updated: 2026-09-20
summary: "iRobot co-founder, Robust.AI. Robotics pioneer and blogger."
related:
...
sources:
  - ../../sources/repos/pai_awesome_person_250_rodney-brooks.md
...
**Rodney Brooks** 收录于 awesome-physical-ai（natnew）**第 250/384** 条，分组 **People to Follow**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

iRobot co-founder, Robust.AI. Robotics pioneer and blogger.
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://x.com/rodneyabrooks> |
...
- [`sources/repos/pai_awesome_person_250_rodney-brooks.md`](../../sources/repos/pai_awesome_person_250_rodney-brooks.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://x.com/rodneyabrooks)
