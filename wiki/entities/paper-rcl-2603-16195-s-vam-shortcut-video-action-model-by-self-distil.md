...
arxiv: "2603.16195"
venue: "2026"
code: https://github.com/Haodong-Yan/S-VAM
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2603_16195_s-vam-shortcut-video-action-model-by-sel.md
...
**S-VAM: Shortcut Video-Action Model by Self-Distilling Geometric and Semantic Foresight** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 471/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | WAMs |
| 出处 | 2026 |
| 论文 | <https://arxiv.org/abs/2603.16195> |
| 代码/项目 | <https://github.com/Haodong-Yan/S-VAM> |
| 子类 / 象限 | 视觉规划与IDM · 高效推理与实时控制 · 三维多视角建模 · Q4 · Dual-system × IDM |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.16195) 为准。
...
**本条目的站内价值是把「S-VAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2603_16195_s-vam-shortcut-video-action-model-by-sel.md`](../../sources/papers/rcl_awesome_wam_2603_16195_s-vam-shortcut-video-action-model-by-sel.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.16195)
