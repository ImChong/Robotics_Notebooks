...
arxiv: "2605.11367"
venue: "arXiv 2026"
summary: "Redefines world modeling as embodied belief inference in 3D space."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_11367_3d-belief-embodied-belief-inference-via.md
...
**3D-Belief: Embodied Belief Inference via Generative 3D World Modeling** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 090/571** 篇，分组 **43 3D & 4D World Models General Purpose**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Redefines world modeling as embodied belief inference in 3D space.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.11367> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.11367) 为准。
...
**本条目的站内价值是把「3D-Belief」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2605_11367_3d-belief-embodied-belief-inference-via.md`](../../sources/papers/sun_awesome_wm_2605_11367_3d-belief-embodied-belief-inference-via.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.11367)
