...
- **代码：** 未在清单中标注
- **清单摘要：** ROS 2 client stack for microcontrollers and embedded real-time robot components.
- **沉淀到 wiki：** [`wiki/entities/painode-262-microros.md`](../../wiki/entities/painode-262-microros.md)
...
- 实体页：[`wiki/entities/painode-262-microros.md`](../../wiki/entities/painode-262-microros.md)
