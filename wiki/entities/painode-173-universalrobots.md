...
status: complete
updated: 2026-09-20
summary: "Collaborative robot arms widely used in research and industry."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_173_universal-robots.md
...
**Universal Robots** 收录于 awesome-physical-ai（natnew）**第 173/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Collaborative robot arms widely used in research and industry.
...
| 来源清单 | natnew |
| 主链接 | <https://www.universal-robots.com/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.universal-robots.com/> |
...
- [`sources/repos/pai_awesome_hardware_173_universal-robots.md`](../../sources/repos/pai_awesome_hardware_173_universal-robots.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.universal-robots.com/)
