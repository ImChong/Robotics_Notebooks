...
[openpi](https://github.com/Physical-Intelligence/openpi) 收录于具身智能研究室 [开源项目主表](https://github.com/RealXiaoze/humanoid-motion-intelligence/blob/main/%E8%AE%BA%E6%96%87%E4%B8%8E%E9%A1%B9%E7%9B%AE/%E5%BC%80%E6%BA%90%E9%A1%B9%E7%9B%AE%E4%B8%BB%E8%A1%A8.md) 的「世界模型、VLA与Agent」分组，是本库为该入口建立的独立详情节点。

## 一句话定义

仓库同时维护流匹配式π0、快速自回归π0-FAST和π0.5，并提供检查点、数据配置、微调与推理服务。接入新机器人时最关键的工作是动作归一化、数据字段映射和推理频率对齐。
...
|------|------|
| 主表分组 | 世界模型、VLA与Agent |
| 官方入口 | https://github.com/Physical-Intelligence/openpi |
...
- [π0.7 Policy](../methods/pi07-policy.md)
- [VLA](../methods/vla.md)
...
- [openpi 来源归档](../../sources/repos/openpi.md)
