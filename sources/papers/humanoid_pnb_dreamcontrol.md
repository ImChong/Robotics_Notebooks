...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/DreamControl__Human-Inspired_Whole-Body_Humanoid_Control_for_Scene_Interaction_v/DreamControl__Human-Inspired_Whole-Body_Humanoid_Control_for_Scene_Interaction_v.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-dreamcontrol](../../wiki/entities/paper-notebook-dreamcontrol.md).

## 对 wiki 的映射

- [paper-notebook-dreamcontrol](../../wiki/entities/paper-notebook-dreamcontrol.md)
