---
type: overview
tags: [depth, depth-vla, vision-language-action, foundation, manipulation]
status: complete
updated: 2026-07-31
summary: "VLA 与基础策略纵深汇总：视觉-语言-动作统一建模、OpenVLA/π0/GR00T 等开源谱系，以及 BFM 身体接口与 loco-manip 任务接口；含社区多基准榜入口与驾驶 VLA（S²-VLA）锚点。"
---

# VLA 与基础策略（纵深汇总）

> **图谱纵深视图**：本页是知识图谱「👀 视觉-语言-动作 (VLA)」纵深的统一入口；在 [图谱纵深视图](../../docs/graph.html?depth=vla) 筛选时，本节点为汇总锚点。
...
- **[IL/RL](./depth-learning.md)**：VLA 训练常混合 IL 与 RLHF/微调。
- **[视觉骨干](./depth-vision-backbone.md)**：感知表征质量影响 VLA 上限。
- **[WBT](./depth-wbt.md)**：全身技能与 VLA 任务接口的分层。
...
- 图谱纵深定义：[docs/depth-filters.js](../../docs/depth-filters.js)（`vla` 命中规则）
