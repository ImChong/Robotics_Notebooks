...
arxiv: "2511.12643"
venue: "arXiv 2025"
summary: "Curates PHSD dataset with egocentric data and on-task data directly aligned to target manipulation tasks"
related:
...
**In-N-On: Scaling Egocentric Manipulation with in-the-wild and on-task Data** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 091/249** 篇，分组 **27 Embodied AI & Vision-Language-Action Ego-VLA**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Curates PHSD dataset with egocentric data and on-task data directly aligned to target manipulation tasks
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2511.12643> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2511.12643) 为准。
...
**本条目的站内价值是把「In-N-On」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [原文](https://arxiv.org/abs/2511.12643)
