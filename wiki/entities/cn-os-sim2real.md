---
type: entity
tags: [repo, china-embodied-opensource, open-source, project, qztech]
status: draft
updated: 2026-09-06
related:
...
**sim2real** 是 [高擎机电](https://github.com/HighTorque-Robotics) 公开的 **仿真环境** 开源项目：策略部署运行时：加载训练策略、下发关节命令
...
1. 从官方 GitHub/Gitee 组织检索 `sim2real` 仓库并核对 README 许可与依赖。
