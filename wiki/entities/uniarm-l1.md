...
sources:
  - ../../sources/repos/UniArmL1.md
  - ../../sources/repos/unitree.md
summary: "轻量机械臂遥操作与标准化采数框架，数据可对接 unitree_lerobot。"
---

# UniArmL1

**UniArmL1** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **模仿学习** 主线。

## 一句话定义

轻量机械臂遥操作与标准化采数框架，数据可对接 unitree_lerobot。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/UniArmL1`](https://github.com/unitreerobotics/UniArmL1) |
| 组织分类 | 模仿学习 |
| 星标（2026-07-24） | ~10 |
| 最近推送 | 2026-05-25 |
| 主要语言 | Python |
...
- 🔄 训练对接 — 采集数据可直接用于 unitreelerobot 模仿学习训练

- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/UniArmL1.md](../../sources/repos/UniArmL1.md)。
...
- [sources/repos/UniArmL1.md](../../sources/repos/UniArmL1.md)
- [sources/repos/unitree.md](../../sources/repos/unitree.md) — 组织级仓库地图
- 上游仓库：<https://github.com/unitreerobotics/UniArmL1>
