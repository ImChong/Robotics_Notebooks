...
status: complete
updated: 2026-09-20
summary: "Affordable mobile manipulator for home assistance research."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_162_hello-robot-stretch.md
...
**Hello Robot Stretch** 收录于 awesome-physical-ai（natnew）**第 162/384** 条，分组 **Hardware Platforms**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Affordable mobile manipulator for home assistance research.
...
- [`sources/repos/pai_awesome_hardware_162_hello-robot-stretch.md`](../../sources/repos/pai_awesome_hardware_162_hello-robot-stretch.md) — 本条目策展摘录
