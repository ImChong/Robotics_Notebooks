...
sources:
  - ../../sources/repos/pai_awesome_resource_005_midas.md
...
**MiDaS** 收录于 awesome-physical-ai（aichr）**第 005/384** 条，分组 **3D Computer Vision**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
| 来源清单 | aichr |
| 主链接 | <https://github.com/isl-org/MiDaS> |
| 代码/仓库 | <https://github.com/isl-org/midas> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://github.com/isl-org/MiDaS> |
| 代码/仓库 | <https://github.com/isl-org/midas> |
...
- [`sources/repos/pai_awesome_resource_005_midas.md`](../../sources/repos/pai_awesome_resource_005_midas.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://github.com/isl-org/MiDaS)
