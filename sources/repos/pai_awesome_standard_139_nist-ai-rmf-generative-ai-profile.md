...
- **代码：** 未在清单中标注
- **清单摘要：** Practical profile extending AI RMF controls to generative-model deployments.
- **沉淀到 wiki：** [`wiki/entities/painode-139-nistairmfgenerativeaiprofile.md`](../../wiki/entities/painode-139-nistairmfgenerativeaiprofile.md)
...
- 实体页：[`wiki/entities/painode-139-nistairmfgenerativeaiprofile.md`](../../wiki/entities/painode-139-nistairmfgenerativeaiprofile.md)
