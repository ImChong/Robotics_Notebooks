...
updated: 2026-09-20
arxiv: "2003.01197"
summary: "Methodology for stress-testing autonomous driving policies under adversarial conditions."
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/pai_awesome_2003_01197_realistic-adversarial-driving-wang-e.md
...
# Realistic Adversarial Driving (Wang et al.)

**Realistic Adversarial Driving (Wang et al.)** 收录于 awesome-physical-ai（natnew）**第 315/384** 条，分组 **Safety & Robustness**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Methodology for stress-testing autonomous driving policies under adversarial conditions.
...
|------|------|
| 编号 | 315/384 |
| 分组 | Safety & Robustness |
| 来源清单 | natnew |
| 主链接 | <https://arxiv.org/abs/2003.01197> |
| arXiv | 2003.01197 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2003.01197) 为准。
...
**本条目的站内价值是把「Realistic Adversarial Driving (Wang et al.)」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**

1. **策展坐标** — 分组 **Safety & Robustness**，来源 natnew。
...
- [`sources/papers/pai_awesome_2003_01197_realistic-adversarial-driving-wang-e.md`](../../sources/papers/pai_awesome_2003_01197_realistic-adversarial-driving-wang-e.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://arxiv.org/abs/2003.01197)
