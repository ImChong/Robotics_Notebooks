...
updated: 2026-09-25
arxiv: "2608.02578"
summary: "We present CoWAM, a selective intervention layer that expresses synchronization, role compatibility, and collision convergence as coordination contracts."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_02578_cowam-coordination-contracts-for-selecti.md
...
**CoWAM: Coordination Contracts for Selective Policy Intervention with WAMs** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 293/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

We present CoWAM, a selective intervention layer that expresses synchronization, role compatibility, and collision convergence as coordination contracts.
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.02578> |
| 子类 / 象限 | 策略后训练与WM-RL · 泛化与动作对齐 · 四象限外 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.02578) 为准。
...
**本条目的站内价值是把「CoWAM」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_02578_cowam-coordination-contracts-for-selecti.md`](../../sources/papers/rcl_awesome_wam_2608_02578_cowam-coordination-contracts-for-selecti.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.02578)
