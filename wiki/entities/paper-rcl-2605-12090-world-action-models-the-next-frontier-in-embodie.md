...
summary: "Vision-Language-Action (VLA) models have achieved strong semantic generalization for embodied policy learning, yet they learn reactive observation-to-action mappings without explicitly modeling how the physical world evo"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2605_12090_world-action-models-the-next-frontier-in.md
...
**World Action Models: The Next Frontier in Embodied AI** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 221/564** 篇，分组 **Related resources**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Vision-Language-Action (VLA) models have achieved strong semantic generalization for embodied policy learning, yet they learn reactive observation-to-action mappings without explicitly modeling how the physical world evolves under intervention. A growing body of work addresses this limitation by integrating world mo...
...
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2605.12090> |
| 代码/项目 | <https://github.com/OpenMOSS/Awesome-WAM> |
| 子类 / 象限 | 综述与技术资源 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.12090) 为准。
...
**本条目的站内价值是把「World Action Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2605_12090_world-action-models-the-next-frontier-in.md`](../../sources/papers/rcl_awesome_wam_2605_12090_world-action-models-the-next-frontier-in.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.12090)
