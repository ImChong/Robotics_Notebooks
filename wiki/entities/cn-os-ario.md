...
sources:
  ...
  - ../../sources/repos/ario.md
summary: "松灵机器人 开源项目 ARIO（本体模型资产）：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用…"
institutions:
  - agilex
---
...
**ARIO** 是 [松灵机器人](https://github.com/agilexrobotics) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `ARIO` 仓库并核对 README 许可与依赖。
...
- [ARIO 源码归档](../../sources/repos/ario.md)（<https://github.com/agilexrobotics/ARIO>）
