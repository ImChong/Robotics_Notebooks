...
- **代码：** <https://github.com/pku-alignment/omnisafe>
- **清单摘要：** Open-source safe-RL training framework with strong baseline implementations.
- **沉淀到 wiki：** [`wiki/entities/painode-314-omnisafe.md`](../../wiki/entities/painode-314-omnisafe.md)
...
- 实体页：[`wiki/entities/painode-314-omnisafe.md`](../../wiki/entities/painode-314-omnisafe.md)
