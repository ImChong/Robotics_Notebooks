...
- **标题：** Reduced-Order Model-Guided RL for Demonstration-Free Humanoid Locomotion
- **类型：** paper
...
- **计划笔记路径：** `papers/05_Locomotion/reduced-order-model-guided-rl-for-demonstration/reduced-order-model-guided-rl-for-demonstration.md`
- **分类：** 05_Locomotion
...
- 知识归纳见 wiki 实体页：[paper-notebook-reduced-order-model-guided-rl-for-demonstration](../../wiki/entities/paper-notebook-reduced-order-model-guided-rl-for-demonstration.md).

## 对 wiki 的映射

- [paper-notebook-reduced-order-model-guided-rl-for-demonstration](../../wiki/entities/paper-notebook-reduced-order-model-guided-rl-for-demonstration.md)
