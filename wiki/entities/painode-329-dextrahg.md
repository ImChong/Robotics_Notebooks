...
status: complete
updated: 2026-09-20
summary: "Sim-to-real dexterous arm-hand grasping pipeline using GPU-parallel RL."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/repos/pai_awesome_paper_329_dextrah-g.md
...
**DextrAH-G** 收录于 awesome-physical-ai（natnew）**第 329/384** 条，分组 **Sim-to-Real**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Sim-to-real dexterous arm-hand grasping pipeline using GPU-parallel RL.
...
| 分组 | Sim-to-Real |
| 来源清单 | natnew |
| 主链接 | <https://sites.google.com/view/dextrah-g> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://sites.google.com/view/dextrah-g) 为准。
...
**本条目的站内价值是把「DextrAH-G」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
...
- [`sources/repos/pai_awesome_paper_329_dextrah-g.md`](../../sources/repos/pai_awesome_paper_329_dextrah-g.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://sites.google.com/view/dextrah-g)
