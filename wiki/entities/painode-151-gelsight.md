...
status: complete
updated: 2026-09-20
summary: "Gel-based tactile sensors."
related:
...
sources:
  - ../../sources/repos/pai_awesome_hardware_151_gelsight.md
...
**GelSight** 收录于 awesome-physical-ai（aichr）**第 151/384** 条，分组 **Hardware & Actuation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Gel-based tactile sensors.
...
| 来源清单 | aichr |
| 主链接 | <https://www.gelsight.com/gelsightmini/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://www.gelsight.com/gelsightmini/> |
...
- [`sources/repos/pai_awesome_hardware_151_gelsight.md`](../../sources/repos/pai_awesome_hardware_151_gelsight.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://www.gelsight.com/gelsightmini/)
