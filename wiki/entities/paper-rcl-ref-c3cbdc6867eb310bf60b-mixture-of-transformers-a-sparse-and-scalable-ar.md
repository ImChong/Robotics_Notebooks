...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_c3cbdc6867eb310bf60b_mixture-of-transformers-a-sparse-and-sca.md
...
**Mixture-of-Transformers: A Sparse and Scalable Architecture for Multi-Modal Foundation Models** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 079/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | Transactions on Machine Learning Research |
| 论文 | <https://openreview.net/forum?id=Nu6N69i8SB> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=Nu6N69i8SB) 为准。
...
**本条目的站内价值是把「Mixture-of-Transformers」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_c3cbdc6867eb310bf60b_mixture-of-transformers-a-sparse-and-sca.md`](../../sources/papers/rcl_awesome_wam_ref_c3cbdc6867eb310bf60b_mixture-of-transformers-a-sparse-and-sca.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=Nu6N69i8SB)
