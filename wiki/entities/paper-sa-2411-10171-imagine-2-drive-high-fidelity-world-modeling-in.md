...
arxiv: "2411.10171"
venue: "arXiv 2024"
summary: "High-fidelity world modeling in CARLA for autonomous vehicles."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2411_10171_imagine-2-drive-high-fidelity-world-mode.md
...
**Imagine-2-Drive: High-Fidelity World Modeling in CARLA for Autonomous Vehicles** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 445/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

High-fidelity world modeling in CARLA for autonomous vehicles.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2411.10171> |
| 项目页 | <https://anantagrg.github.io/Imagine-2-Drive.github.io/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.10171) 为准。
...
**本条目的站内价值是把「Imagine-2-Drive」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2411_10171_imagine-2-drive-high-fidelity-world-mode.md`](../../sources/papers/sun_awesome_wm_2411_10171_imagine-2-drive-high-fidelity-world-mode.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.10171)
