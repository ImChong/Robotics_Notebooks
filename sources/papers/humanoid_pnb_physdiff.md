...
- **类型：** paper
- **笔记链接：** <https://imchong.github.io/Robot_Learning_Paper_Notebooks/papers/14_Human_Motion/PhysDiff__Physics-Guided_Human_Motion_Diffusion_Model/PhysDiff__Physics-Guided_Human_Motion_Diffusion_Model.html>
- **分类：** 14_Human_Motion
- **arXiv：** <https://arxiv.org/abs/2212.02500>
- **项目页：** <https://nvlabs.github.io/PhysDiff/>
- **代码：** **未开源**（截至 2026-07-28，项目页未列仓库）
- **入库日期：** 2026-07-10
...
- 深读笔记：<https://imchong.github.io/Robot_Learning_Paper_Notebooks/papers/14_Human_Motion/PhysDiff__Physics-Guided_Human_Motion_Diffusion_Model/PhysDiff__Physics-Guided_Human_Motion_Diffusion_Model.html>
- 论文：<https://arxiv.org/abs/2212.02500>
- 项目页归档：[physdiff-project.md](../sites/physdiff-project.md)
