...
updated: 2026-09-25
arxiv: "2608.22067"
summary: "In this paper, we propose DELE-w0.5, which infers robot actions from predicted future states without relying on video generation. Across 640 real-robot trials on four long-horizon manipulation tasks, our DELE-w0.5 achiev"
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_2608_22067_dele-w0-5-inferring-action-from-future-l.md
...
**DELE-w0.5: Inferring Action from Future Latent State for Robotic Manipulation** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 300/564** 篇，分组 **WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

In this paper, we propose DELE-w0.5, which infers robot actions from predicted future states without relying on video generation. Across 640 real-robot trials on four long-horizon manipulation tasks, our DELE-w0.5 achieves the best performance among all compared policies, attaining 62.5% overall full-task success an...
...
| 分组 | WAMs |
| 出处 | 见清单 / 原文 |
| 论文 | <https://arxiv.org/abs/2608.22067> |
| 项目页 | <https://deepleap-x.com/research/dele-w0.5> |
| 子类 / 象限 | 潜空间预测与JEPA · 联合视频动作建模 · 高效推理与实时控制 · Q1 · One Model × 联合预测 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2608.22067) 为准。
...
**本条目的站内价值是把「DELE-w0.5」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_2608_22067_dele-w0-5-inferring-action-from-future-l.md`](../../sources/papers/rcl_awesome_wam_2608_22067_dele-w0-5-inferring-action-from-future-l.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2608.22067)
