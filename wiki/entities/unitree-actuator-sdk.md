...
summary: "宇树执行器/电机侧 SDK，面向关节级调试与底层驱动实验。"
---

# unitree_actuator_sdk

**unitree_actuator_sdk** 是 [unitreerobotics](https://github.com/unitreerobotics) 组织下的官方仓库，归属 **底层 SDK / 通信** 主线。

## 一句话定义

宇树执行器/电机侧 SDK，面向关节级调试与底层驱动实验。
...
| 字段 | 内容 |
|------|------|
| 仓库 | [`unitreerobotics/unitree_actuator_sdk`](https://github.com/unitreerobotics/unitree_actuator_sdk) |
| 组织分类 | 底层 SDK / 通信 |
| 星标（2026-07-24） | ~132 |
| 最近推送 | 2025-01-15 |
| 主要语言 | C++ |
...
- 组织级导航与五条研发主线见 [Unitree 软件生态](./unitree.md)；原始归档见 [sources/repos/unitree_actuator_sdk.md](../../sources/repos/unitree_actuator_sdk.md)。
...
- 上游仓库：<https://github.com/unitreerobotics/unitree_actuator_sdk>
