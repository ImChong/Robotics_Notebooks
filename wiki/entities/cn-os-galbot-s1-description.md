...
**galbot_s1_description** 是 [银河通用](https://github.com/GalaxyGeneralRobotics) 公开的 **本体模型资产** 开源项目：官方本体模型资产（URDF/MJCF/USD），供仿真、训练与部署引用
...
1. 从官方 GitHub/Gitee 组织检索 `galbot_s1_description` 仓库并核对 README 许可与依赖。
