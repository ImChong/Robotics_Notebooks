...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/Being-0__A_Humanoid_Robotic_Agent_with_Vision-Language_Models_and_Modular_Skills/Being-0__A_Humanoid_Robotic_Agent_with_Vision-Language_Models_and_Modular_Skills.md`
...
- 知识归纳见 wiki 实体页：[paper-notebook-being-0](../../wiki/entities/paper-notebook-being-0.md).

## 对 wiki 的映射

- [paper-notebook-being-0](../../wiki/entities/paper-notebook-being-0.md)
