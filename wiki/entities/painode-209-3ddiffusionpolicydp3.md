...
status: complete
updated: 2026-09-20
summary: "Point-cloud-conditioned diffusion policy that improves data efficiency and robustness over image-based variants."
related:
...
sources:
  - ../../sources/repos/pai_awesome_method_209_3d-diffusion-policy-dp3.md
...
**3D Diffusion Policy (DP3)** 收录于 awesome-physical-ai（natnew）**第 209/384** 条，分组 **Manipulation**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Point-cloud-conditioned diffusion policy that improves data efficiency and robustness over image-based variants.
...
| 分组 | Manipulation |
| 来源清单 | natnew |
| 主链接 | <https://3d-diffusion-policy.github.io/> |

## 核心原理

Point-cloud-conditioned diffusion policy that improves data efficiency and robustness over image-based variants.

该条目在 Physical AI 清单中的角色是 **method**，分组 **Manipulation**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://3d-diffusion-policy.github.io/> |
...
- [`sources/repos/pai_awesome_method_209_3d-diffusion-policy-dp3.md`](../../sources/repos/pai_awesome_method_209_3d-diffusion-policy-dp3.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://3d-diffusion-policy.github.io/)
