...
arxiv: "2509.20328"
venue: "arXiv 2025"
summary: "Veo-3 as zero-shot learners and reasoners."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2509_20328_video-models-are-zero-shot-learners-and.md
...
**Video models are zero-shot learners and reasoners** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 153/571** 篇，分组 **47 General Foundation World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Veo-3 as zero-shot learners and reasoners.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2509.20328> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2509.20328) 为准。
...
**本条目的站内价值是把「Video models are zero-shot learners and reasoners」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2509_20328_video-models-are-zero-shot-learners-and.md`](../../sources/papers/sun_awesome_wm_2509_20328_video-models-are-zero-shot-learners-and.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2509.20328)
