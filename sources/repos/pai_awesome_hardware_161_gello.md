...
- **代码：** 未在清单中标注
- **清单摘要：** General, low-cost, and intuitive teleoperation framework.
- **沉淀到 wiki：** [`wiki/entities/painode-161-gello.md`](../../wiki/entities/painode-161-gello.md)
...
- 实体页：[`wiki/entities/painode-161-gello.md`](../../wiki/entities/painode-161-gello.md)
