...
**LejuLab-Deploy** 是 [乐聚机器人](https://github.com/LejuRobotics) 公开的 **运动RL/技能训练** 开源项目：策略部署运行时：加载训练策略、下发关节命令
...
1. 从官方 GitHub/Gitee 组织检索 `LejuLab-Deploy` 仓库并核对 README 许可与依赖。
