...
arxiv: "2503.21232"
venue: "arXiv 2025"
summary: "Knowledge graphs as world models for semantic material-aware obstacle handling."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_21232_knowledge-graphs-as-world-models-for-sem.md
  - ../../sources/papers/sun_awesome_wm_catalog.md
  - ../../sources/repos/awesome-world-models.md
---

# Knowledge Graphs as World Models for Semantic Material-Aware Obstacle Handlin...

**Knowledge Graphs as World Models for Semantic Material-Aware Obstacle Handling in AVs** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 449/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Knowledge graphs as world models for semantic material-aware obstacle handling.
...
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.21232> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.21232) 为准。
...
**本条目的站内价值是把「Knowledge Graphs as World Models for Semantic Material-Aware Obstacle Handlin...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2503_21232_knowledge-graphs-as-world-models-for-sem.md`](../../sources/papers/sun_awesome_wm_2503_21232_knowledge-graphs-as-world-models-for-sem.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.21232)
