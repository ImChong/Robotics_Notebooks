...
related:
  ...
  - ../methods/vla.md
sources:
  - ../../sources/papers/carf_arxiv_2609_21982.md
  - ../../sources/sites/carf.md
  - ../../sources/blogs/wechat_embodied_station_contact_rich_sim_10_papers_2026-09-21.md
summary: "CARF（arXiv:2609.21982）：progress scorer 区分推进片段与失败关键段，flow matching 对前者吸引、对后者排斥；仿真与真机均优于 success-only/all-data IL。"
---

# CARF（arXiv:2609.21982）

**CARF**（*CARF: Contrastive Attraction-Repulsion of Failure-Guided Flow Matching*，[arXiv:2609.21982](https://arxiv.org/abs/2609.21982)）来自 [具身智能小站 10 篇盘点](../../sources/blogs/wechat_embodied_station_contact_rich_sim_10_papers_2026-09-21.md)（策展档位：**扫读**）。

## 一句话定义

**progress scorer 区分推进片段与失败关键段，flow matching 对前者吸引、对后者排斥；仿真与真机均优于 success-only/all-data IL。**
...
- **加州大学伯克利分校**；开源结论：**待发布**（步骤 2.5，2026-09-21）。
- 失败轨迹含异质片段，粗粒度丢弃或全量模仿都浪费；CARF 显式分离有用与有害段。

## 核心机制

| 项 | 内容 |
|----|------|
| **arXiv** | [2609.21982](https://arxiv.org/abs/2609.21982) |
| **开源** | **待发布** |
| **策展摘要** | progress scorer 区分推进片段与失败关键段，flow matching 对前者吸引、对后者排斥；仿真与真机均优于 success-only/all-data IL。 |
...
**CARF 代表「扫读」档位的 imitation-learning 方向样本——部署前以开源状态与评测协议为准绳。**
...
- [carf_arxiv_2609_21982.md](../../sources/papers/carf_arxiv_2609_21982.md)
...
- [arXiv PDF](https://arxiv.org/pdf/2609.21982)
