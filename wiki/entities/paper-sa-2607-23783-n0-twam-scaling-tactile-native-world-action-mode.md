...
**𝒩₀-TWAM: Scaling Tactile-Native World Action Model for Contact-Rich Manipulation** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 059/065** 篇，分组 **Tactile World Action Models WAM**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

First tactile-native world-action model trained at large scale; predicts both future vision and contact with strong capability on contact-rich tasks.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2607.23783) 为准。
...
**本条目的站内价值是把「𝒩₀-TWAM」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
