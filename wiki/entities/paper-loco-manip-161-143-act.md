...
**在人形操作的ACT模仿学习中，主动立体相机的性能优于多传感器设置** 收录于 [具身智能研究室 · 人形 Loco-Manip 161 篇长文](https://mp.weixin.qq.com/s/pACh9EhsISiyPGdiiR0C3A) **第 143/161** 篇，归类为 **08 硬件平台、感知配置与部署扩展**。
...
- 在人形操作的ACT模仿学习中，主动立体相机的性能优于多传感器设置 把相机图像/多视角观测、本体状态与关节序列、接触力/触觉信号转成可跟踪的身体目标，并通过ACT/行为克隆模仿学习、MM-DiT/Transformer 动作头训练或组合全身策略，最终输出动作 chunk/token。关键点是把示范轨迹压成可监督的动作预测问题，再通过动作 chunk 或闭环执行降低时序抖动。
- 人形 Loco-Manip 161 篇 **#143/161** · 硬件平台、感知配置与部署扩展。
...
| 发表日期 | 2026年3月30日 |
| 论文/项目 | http://github.com/kuehnrobin/ |
...
- 原始 source：[loco_manip_161_survey_143_act.md](../../sources/papers/loco_manip_161_survey_143_act.md)

## 参考来源

- [loco_manip_161_survey_143_act.md](../../sources/papers/loco_manip_161_survey_143_act.md) — 161 篇策展摘录
