...
**uf-gym** 是 [众为创造](https://github.com/xArm-Developer) 公开的 **运动RL/技能训练** 开源项目：在panda-gym基础上加入UFACTORY机器人模型和到达、抓取放置等任务，用于机械臂强化学习的快速仿真实验。
...
1. 从官方 GitHub/Gitee 组织检索 `uf-gym` 仓库并核对 README 许可与依赖。
