...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_8432892bf821930fe230_on-policy-distillation-of-language-model.md
...
**On-Policy Distillation of Language Models: Learning from Self-Generated Mistakes** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 170/564** 篇，分组 **Foundational work**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ICLR 2024 |
| 论文 | <https://proceedings.iclr.cc/paper_files/paper/2024/hash/5be69a584901a26c521c2b51e40a4c20-Abstract-Conference.html> |
| 子类 / 象限 | 训练优化与蒸馏 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.iclr.cc/paper_files/paper/2024/hash/5be69a584901a26c521c2b51e40a4c20-Abstract-Conference.html) 为准。
...
**本条目的站内价值是把「On-Policy Distillation of Language Models」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_8432892bf821930fe230_on-policy-distillation-of-language-model.md`](../../sources/papers/rcl_awesome_wam_ref_8432892bf821930fe230_on-policy-distillation-of-language-model.md) — 本条目策展摘录
...
- [原文](https://proceedings.iclr.cc/paper_files/paper/2024/hash/5be69a584901a26c521c2b51e40a4c20-Abstract-Conference.html)
