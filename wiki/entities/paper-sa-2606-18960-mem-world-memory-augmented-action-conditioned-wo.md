...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2606_18960_mem-world-memory-augmented-action-condit.md
...
**Mem-World: Memory-Augmented Action-Conditioned World Models for Persistent Robot Manipulation** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 005/571** 篇，分组 **101 Memory Mechanisms**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Memory-augmented multi-view action-conditioned world models; proposes W-VMem, a 4D wrist-centric surfel-indexed memory.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2606.18960) 为准。
...
**本条目的站内价值是把「Mem-World」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2606_18960_mem-world-memory-augmented-action-condit.md`](../../sources/papers/sun_awesome_wm_2606_18960_mem-world-memory-augmented-action-condit.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2606.18960)
