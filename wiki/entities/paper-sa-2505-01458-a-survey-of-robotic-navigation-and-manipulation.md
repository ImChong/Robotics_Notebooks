...
sources:
  - ../../sources/papers/sun_awesome_r2s2r_2505_01458_a-survey-of-robotic-navigation-and-manip.md
  - ../../sources/papers/sun_awesome_r2s2r_catalog.md
  - ../../sources/repos/awesome-real2sim2real.md
---

# A Survey of Robotic Navigation and Manipulation with Physics Simulators in th...

**A Survey of Robotic Navigation and Manipulation with Physics Simulators in the Era of Embodied AI** 收录于 [Awesome-Real2Sim2Real](https://github.com/sun254667/Awesome-Real2Sim2Real) **第 061/063** 篇，分组 **Surveys & Overvies**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Examines how physics simulators address the sim-to-real gap by analyzing their properties overlooked in previous surveys. Analyzes features for navigation and manipulation tasks along with hardware requirements. Provides a comprehensive overview of recent advancements in robotic navigation and manipulation in Embodi...
...
| 分组 | Surveys & Overvies |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2505.01458> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2505.01458) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-r2s2r-technology-map.md) 同分组条目。

## 与其他工作对比（索引级）

- 本页 **不做** 与具体基线的逐项数值对比：索引级节点只保留清单坐标，同分组横向对照请回到 [技术地图](../overview/sun-awesome-r2s2r-technology-map.md) 的 **Surveys & Overvies** 分组逐条展开。
...
**本条目的站内价值是把「A Survey of Robotic Navigation and Manipulation with Physics Simulators in th...」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**

- 起作用的是策展坐标：列表分组 **Surveys & Overvies** + Highlights 指出的问题设定，而不是本页自行推导的新算法结论。
...
- [`sources/papers/sun_awesome_r2s2r_2505_01458_a-survey-of-robotic-navigation-and-manip.md`](../../sources/papers/sun_awesome_r2s2r_2505_01458_a-survey-of-robotic-navigation-and-manip.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2505.01458)
