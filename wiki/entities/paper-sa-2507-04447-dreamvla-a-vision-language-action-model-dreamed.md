...
summary: "VLA dreamed with comprehensive world knowledge."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2507_04447_dreamvla-a-vision-language-action-model.md
...
**DreamVLA: A Vision-Language-Action Model Dreamed with Comprehensive World Knowledge** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 192/571** 篇，分组 **62 Joint WAM & Unified VLA-World Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

VLA dreamed with comprehensive world knowledge.
...
| 代码/项目 | <https://github.com/Zhangwenyao1/DreamVLA> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2507.04447) 为准。
- 横向对照请回到 [技术地图](../overview/sun-awesome-wm-technology-map.md) 同分组条目。

## 结论

**本条目的站内价值是把「DreamVLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2507_04447_dreamvla-a-vision-language-action-model.md`](../../sources/papers/sun_awesome_wm_2507_04447_dreamvla-a-vision-language-action-model.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2507.04447)
