...
**xense-mcap-viewer** 是 [千觉机器人](https://github.com/XenseRobotics-AI) 公开的 **工程与工具** 开源项目：触觉数据 MCAP 可视化工具
...
1. 从官方 GitHub/Gitee 组织检索 `xense-mcap-viewer` 仓库并核对 README 许可与依赖。
