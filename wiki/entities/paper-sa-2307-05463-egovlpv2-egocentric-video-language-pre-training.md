...
sources:
  - ../../sources/papers/sun_awesome_ego_2307_05463_egovlpv2-egocentric-video-language-pre-t.md
...
**EgoVLPv2: Egocentric Video-Language Pre-training with Fusion in the Backbone** 收录于 [Awesome Egocentric Vision](https://github.com/sun254667/awesome-egocentric-vision) **第 235/249** 篇，分组 **Pre-trained Foundation Models**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Improved VLP with backbone-level fusion architecture
...
| 出处 | ICCV 2023 |
| 论文 | <https://arxiv.org/abs/2307.05463> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2307.05463) 为准。
...
**本条目的站内价值是把「EgoVLPv2」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_ego_2307_05463_egovlpv2-egocentric-video-language-pre-t.md`](../../sources/papers/sun_awesome_ego_2307_05463_egovlpv2-egocentric-video-language-pre-t.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2307.05463)
