...
arxiv: "2410.14081"
venue: "arXiv 2024"
summary: "Reward-free world models for online imitation learning."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2410_14081_reward-free-world-models-for-online-imit.md
...
**Reward-free World Models for Online Imitation Learning** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 266/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2410.14081> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2410.14081) 为准。
...
**本条目的站内价值是把「Reward-free World Models for Online Imitation Learning」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2410_14081_reward-free-world-models-for-online-imit.md`](../../sources/papers/sun_awesome_wm_2410_14081_reward-free-world-models-for-online-imit.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2410.14081)
