...
arxiv: "2503.12531"
venue: "arXiv 2025"
summary: "Learning predictive models for robotic surgical tasks."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2503_12531_towards-suturing-world-models-learning-p.md
...
**Towards Suturing World Models: Learning Predictive Models for Robotic Surgical Tasks** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 337/571** 篇，分组 **812 Manipulation**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。
...
| 分组 | 812 Manipulation |
| 出处 | arXiv 2025 |
| 论文 | <https://arxiv.org/abs/2503.12531> |
| 项目页 | <https://mkturkcan.github.io/suturingmodels/> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2503.12531) 为准。
...
**这一页能给你的是「Towards Suturing World Models」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2503_12531_towards-suturing-world-models-learning-p.md`](../../sources/papers/sun_awesome_wm_2503_12531_towards-suturing-world-models-learning-p.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2503.12531)
