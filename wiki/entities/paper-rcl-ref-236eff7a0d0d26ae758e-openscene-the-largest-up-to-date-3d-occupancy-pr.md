...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_236eff7a0d0d26ae758e_openscene-the-largest-up-to-date-3d-occu.md
...
**OpenScene: The Largest Up-to-Date 3D Occupancy Prediction Benchmark in Autonomous Driving** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 117/564** 篇，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 分组 | Datasets |
| 出处 | 2023 |
| 论文 | <https://github.com/OpenDriveLab/OpenScene> |
| 代码/项目 | <https://github.com/OpenDriveLab/OpenScene> |
| 子类 / 象限 | 自动驾驶感知数据 · 三维占据与场景流数据 · 基准与评测协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://github.com/OpenDriveLab/OpenScene) 为准。
...
**本条目的站内价值是把「OpenScene」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_236eff7a0d0d26ae758e_openscene-the-largest-up-to-date-3d-occu.md`](../../sources/papers/rcl_awesome_wam_ref_236eff7a0d0d26ae758e_openscene-the-largest-up-to-date-3d-occu.md) — 本条目策展摘录
...
- [原文](https://github.com/OpenDriveLab/OpenScene)
