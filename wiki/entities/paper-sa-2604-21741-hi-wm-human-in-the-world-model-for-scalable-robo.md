...
**Hi-WM: Human-in-the-World-Model for Scalable Robot Post-Training** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 222/571** 篇，分组 **63 World Models for VLA Training & Evaluation Combining Paradigms**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

Post-training framework using learned world model as corrective substrate.
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2604.21741) 为准。
...
**这一页能给你的是「Hi-WM」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2604_21741_hi-wm-human-in-the-world-model-for-scala.md`](../../sources/papers/sun_awesome_wm_2604_21741_hi-wm-human-in-the-world-model-for-scala.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2604.21741)
