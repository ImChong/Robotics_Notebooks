...
- **代码：** <https://github.com/google-research/rlds>
- **清单摘要：** Standardized format and tooling for logged trajectories used across robot-learning datasets.
- **沉淀到 wiki：** [`wiki/entities/painode-093-rlds.md`](../../wiki/entities/painode-093-rlds.md)
...
- 实体页：[`wiki/entities/painode-093-rlds.md`](../../wiki/entities/painode-093-rlds.md)
