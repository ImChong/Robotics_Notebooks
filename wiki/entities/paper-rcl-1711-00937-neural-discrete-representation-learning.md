...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_1711_00937_neural-discrete-representation-learning.md
...
**Neural Discrete Representation Learning** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 080/564** 篇，分组 **Components of WAMs**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | NeurIPS 2017 |
| 论文 | <https://proceedings.neurips.cc/paper/2017/hash/7a98af17e63a0ac09ce2e96d03992fbc-Abstract.html> |
| 子类 / 象限 | Generative modeling & tokenizers · 视觉编码器与表征 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://proceedings.neurips.cc/paper/2017/hash/7a98af17e63a0ac09ce2e96d03992fbc-Abstract.html) 为准。
...
**本条目的站内价值是把「Neural Discrete Representation Learning」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_1711_00937_neural-discrete-representation-learning.md`](../../sources/papers/rcl_awesome_wam_1711_00937_neural-discrete-representation-learning.md) — 本条目策展摘录
...
- [原文](https://proceedings.neurips.cc/paper/2017/hash/7a98af17e63a0ac09ce2e96d03992fbc-Abstract.html)
