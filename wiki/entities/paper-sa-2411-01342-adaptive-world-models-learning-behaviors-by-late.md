...
arxiv: "2411.01342"
venue: "arXiv 2024"
summary: "Learns behaviors by latent imagination under non-stationarity."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2411_01342_adaptive-world-models-learning-behaviors.md
...
**Adaptive World Models: Learning Behaviors by Latent Imagination Under Non-Stationarity** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 251/571** 篇，分组 **73 Offline & Generalization**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Learns behaviors by latent imagination under non-stationarity.
...
| 出处 | arXiv 2024 |
| 论文 | <https://arxiv.org/abs/2411.01342> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2411.01342) 为准。
...
**本条目的站内价值是把「Adaptive World Models」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_2411_01342_adaptive-world-models-learning-behaviors.md`](../../sources/papers/sun_awesome_wm_2411_01342_adaptive-world-models-learning-behaviors.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2411.01342)
