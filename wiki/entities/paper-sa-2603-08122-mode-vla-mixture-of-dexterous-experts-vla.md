...
sources:
  - ../../sources/papers/sun_awesome_touch_2603_08122_mode-vla-mixture-of-dexterous-experts-vl.md
...
**MoDE-VLA: Mixture-of-Dexterous-Experts VLA** 收录于 [Awesome Touch](https://github.com/sun254667/awesome-touch) **第 005/065** 篇，分组 **21 Unified Vision-Tactile-Language-Action Frameworks**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Seamlessly integrates heterogeneous force and tactile modalities into a pretrained VLA backbone.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2603.08122> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2603.08122) 为准。
...
**本条目的站内价值是把「MoDE-VLA」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_touch_2603_08122_mode-vla-mixture-of-dexterous-experts-vl.md`](../../sources/papers/sun_awesome_touch_2603_08122_mode-vla-mixture-of-dexterous-experts-vl.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2603.08122)
