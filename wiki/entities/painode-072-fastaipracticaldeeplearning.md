...
status: complete
updated: 2026-09-20
summary: "Applied deep-learning curriculum useful for perception and representation foundations."
related:
...
sources:
  - ../../sources/repos/pai_awesome_course_072_fast-ai-practical-deep-learning.md
...
**Fast.ai Practical Deep Learning** 收录于 awesome-physical-ai（natnew）**第 072/384** 条，分组 **Courses**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Applied deep-learning curriculum useful for perception and representation foundations.
...
- [`sources/repos/pai_awesome_course_072_fast-ai-practical-deep-learning.md`](../../sources/repos/pai_awesome_course_072_fast-ai-practical-deep-learning.md) — 本条目策展摘录
