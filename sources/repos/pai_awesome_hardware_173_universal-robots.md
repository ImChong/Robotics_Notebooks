...
- **代码：** 未在清单中标注
- **清单摘要：** Collaborative robot arms widely used in research and industry.
- **沉淀到 wiki：** [`wiki/entities/painode-173-universalrobots.md`](../../wiki/entities/painode-173-universalrobots.md)
...
- 实体页：[`wiki/entities/painode-173-universalrobots.md`](../../wiki/entities/painode-173-universalrobots.md)
