...
sources:
  ...
  - ../../sources/repos/videoworld.md
summary: "字节跳动机器人团队 开源项目 VideoWorld（世界模型）：从无标注视频学习潜在动态和行为表示，为从视觉变化中获得动作先验提供上游模型案例。…"
institutions:
  - bytedance
---
...
**VideoWorld** 是 [字节跳动机器人团队](https://github.com/ByteDance-Seed) 公开的 **世界模型** 开源项目：从无标注视频学习潜在动态和行为表示，为从视觉变化中获得动作先验提供上游模型案例。
...
| 机构 | 字节跳动机器人团队 |
| 类别 | 世界模型 |
| 官方组织 | https://github.com/ByteDance-Seed、https://github.com/bytedance |

## 工程实践

1. 从官方 GitHub/Gitee 组织检索 `VideoWorld` 仓库并核对 README 许可与依赖。
...
- [VideoWorld 源码归档](../../sources/repos/videoworld.md)（<https://github.com/ByteDance-Seed/VideoWorld>）

- [国内具身智能开源全景（微信公众号）](../../sources/blogs/wechat_embodied_station_domestic_opensource_panorama_2026-09-06.md)

## 推荐继续阅读

- [字节跳动机器人团队 官方组织](https://github.com/ByteDance-Seed)
