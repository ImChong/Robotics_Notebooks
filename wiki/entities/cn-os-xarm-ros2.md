...
**xarm_ros2** 是 [众为创造](https://github.com/xArm-Developer) 公开的 **仿真环境** 开源项目：为xArm、UFACTORY 850和Lite6提供ROS2模型、硬件接口、MoveIt规划、Gazebo仿真和真机控制示例。
...
1. 从官方 GitHub/Gitee 组织检索 `xarm_ros2` 仓库并核对 README 许可与依赖。
