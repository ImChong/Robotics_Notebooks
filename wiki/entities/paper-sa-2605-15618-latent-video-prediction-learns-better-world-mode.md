...
arxiv: "2605.15618"
venue: "arXiv 2026"
summary: "First systematic study on robustness of latent-predictive video models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_2605_15618_latent-video-prediction-learns-better-wo.md
...
**Latent Video Prediction Learns Better World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 080/571** 篇，分组 **42 Visual / Video World Models**。本页是 **清单索引**：给出它在清单中的位置与原文入口，方法细节和量化结果请看原文。

## 一句话定义

First systematic study on robustness of latent-predictive video models.
...
| 出处 | arXiv 2026 |
| 论文 | <https://arxiv.org/abs/2605.15618> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://arxiv.org/abs/2605.15618) 为准。
...
**这一页能给你的是「Latent Video Prediction Learns Better World Models」在策展清单里的坐标与要点：够你判断要不要去读原文，但不能替代原文。**
...
- [`sources/papers/sun_awesome_wm_2605_15618_latent-video-prediction-learns-better-wo.md`](../../sources/papers/sun_awesome_wm_2605_15618_latent-video-prediction-learns-better-wo.md) — 本条目策展摘录
...
- [原文](https://arxiv.org/abs/2605.15618)
