...
- **代码：** 未在清单中标注
- **清单摘要：** Government body publishing evaluations and guidance on frontier AI risks.
- **沉淀到 wiki：** [`wiki/entities/painode-141-ukaisafetyinstitute.md`](../../wiki/entities/painode-141-ukaisafetyinstitute.md)
...
- 实体页：[`wiki/entities/painode-141-ukaisafetyinstitute.md`](../../wiki/entities/painode-141-ukaisafetyinstitute.md)
