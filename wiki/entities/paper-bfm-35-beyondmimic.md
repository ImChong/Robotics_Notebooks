...
summary: "guided diffusion 进入全身控制；生成方案仍需低层执行器兜底。"
related:
...
**BeyondMimic** 收录于 [awesome-bfm-papers](https://github.com/friedrichyuan/awesome-bfm-papers) **第 35/41** 篇，归类为 **05 Hierarchical control**（2025 · arXiv）。本页为知识库 **策展摘要**；方法细节以论文 PDF 与项目页为准。
...
- 原始 source：[bfm_awesome_beyondmimic_arxiv_2508_08241.md](../../sources/papers/bfm_awesome_beyondmimic_arxiv_2508_08241.md)
