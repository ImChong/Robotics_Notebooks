...
updated: 2026-08-10
venue: "ICLR 2024"
code: https://github.com/PKU-Alignment/SafeDreamer
summary: "Safe RL with world models."
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/sun_awesome_wm_noarxiv_482_safedreamer-safe-reinforcement-learning.md
...
**SafeDreamer: Safe Reinforcement Learning with World Models** 收录于 [Awesome World Models](https://github.com/sun254667/awesome-world-models) **第 482/571** 篇，分组 **82 Autonomous Driving**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。

## 一句话定义

Safe RL with world models.
...
| 出处 | ICLR 2024 |
| 论文 | <https://openreview.net/forum?id=tsE5HLYtYg> |
| 代码/项目 | <https://github.com/PKU-Alignment/SafeDreamer> |
...
- 评测口径与具体数值以 [原文 / 项目页](https://openreview.net/forum?id=tsE5HLYtYg) 为准。
...
**本条目的站内价值是把「SafeDreamer」从外部 Awesome 列表提升为可链接的知识节点，并保留清单 Highlights 作为阅读锚点。**
...
- [`sources/papers/sun_awesome_wm_noarxiv_482_safedreamer-safe-reinforcement-learning.md`](../../sources/papers/sun_awesome_wm_noarxiv_482_safedreamer-safe-reinforcement-learning.md) — 本条目策展摘录
...
- [原文](https://openreview.net/forum?id=tsE5HLYtYg)
