...
## [2026-06-16] lint | health-check | 自动化 wiki 健康检查
...
- SAC（被 6 个页面以加粗/反引号引用，但无独立 concepts/methods/formalizations 页，建议评估新建）
...
📊 Sources 覆盖率：1169/1183 (99%) wiki/entity 页有 ingest 来源
