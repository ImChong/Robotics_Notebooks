...
status: complete
updated: 2026-09-25
venue: "ACL Workshop on Intrinsic and Extrinsic Evaluation Measures for Machine Translat"
...
related:
  ...
  - ../tasks/locomotion.md
sources:
  - ../../sources/papers/rcl_awesome_wam_ref_73844778b2bcfa68b4e9_meteor-an-automatic-metric-for-mt-evalua.md
...
**METEOR: An Automatic Metric for MT Evaluation with Improved Correlation with Human Judgments** 收录于 [Awesome World-Action Models (RCL)](https://github.com/rcl-robotics/Awesome-World-Action-Models) **第 141/564** 篇，分组 **Evaluation metrics**。本页为知识库 **策展索引级** 详情节点；方法细节与量化指标以原文 PDF / 项目页为准。
...
| 出处 | ACL Workshop on Intrinsic and Extrinsic Evaluation Measures for Machine Translation and/or Summarization, 2005 |
| 论文 | <https://aclanthology.org/W05-0909/> |
| 子类 / 象限 | 语言生成指标 · 评估指标与协议 · 不适用 |
...
- 评测口径与具体数值以 [原文 / 项目页](https://aclanthology.org/W05-0909/) 为准。
...
**本条目的站内价值是把「METEOR」从 RCL Awesome WAM 列表提升为可链接的知识节点，并保留清单 Contribution 作为阅读锚点。**
...
- [`sources/papers/rcl_awesome_wam_ref_73844778b2bcfa68b4e9_meteor-an-automatic-metric-for-mt-evalua.md`](../../sources/papers/rcl_awesome_wam_ref_73844778b2bcfa68b4e9_meteor-an-automatic-metric-for-mt-evalua.md) — 本条目策展摘录
...
- [原文](https://aclanthology.org/W05-0909/)
