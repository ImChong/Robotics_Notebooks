...
> 来源归档（ingest · awesome-bfm-papers 第 34/41）

- **标题：** SENTINEL: A Fully End-to-End Language-Action Model for Humanoid Whole Body Control
- **类型：** paper
...
- **入库日期：** 2026-05-26
- **一句话说明：** 语言–全身动作端到端；中间须有处理平衡/接触的身体通道。

## 核心摘录（策展，非全文）

- **在 BFM 技术地图中的位置：** 05 Hierarchical control，编号 **34/41**。
- **公众号导读要点：** 语言–全身动作端到端；中间须有处理平衡/接触的身体通道。
