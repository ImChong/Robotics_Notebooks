...
- 知识归纳见 wiki 实体页：[paper-notebook-aero-hand-open](../../wiki/entities/paper-notebook-aero-hand-open.md).

## 对 wiki 的映射

- [paper-notebook-aero-hand-open](../../wiki/entities/paper-notebook-aero-hand-open.md)
