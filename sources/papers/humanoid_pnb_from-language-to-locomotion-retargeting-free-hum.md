...
- **标题：** From Language to Locomotion: Retargeting-free Humanoid Control via Motion Latent Guidance
- **类型：** paper
...
- **计划笔记路径：** `papers/04_Loco-Manipulation_and_WBC/from-language-to-locomotion-retargeting-free-hum/from-language-to-locomotion-retargeting-free-hum.md`
- **分类：** 04_Loco-Manipulation_and_WBC
- **arXiv：** <https://arxiv.org/abs/2510.14952>
- **入库日期：** 2026-06-11
...
- 知识归纳见 wiki 实体页：[paper-notebook-from-language-to-locomotion](../../wiki/entities/paper-notebook-from-language-to-locomotion.md).

## 对 wiki 的映射

- [paper-notebook-from-language-to-locomotion](../../wiki/entities/paper-notebook-from-language-to-locomotion.md)
...
- 论文：<https://arxiv.org/abs/2510.14952>
