...
status: complete
updated: 2026-09-20
summary: "Multimodal bimanual mobile manipulation dataset with 310K+ trajectories."
related:
...
sources:
  - ../../sources/repos/pai_awesome_dataset_094_robomind.md
...
**RoboMIND** 收录于 awesome-physical-ai（natnew）**第 094/384** 条，分组 **Datasets**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Multimodal bimanual mobile manipulation dataset with 310K+ trajectories.
...
| 分组 | Datasets |
| 来源清单 | natnew |
| 主链接 | <https://x-humanoid-robomind.github.io/> |
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://x-humanoid-robomind.github.io/> |
| 开源核查 | 以项目页 / GitHub 实际链接为准（清单可能滞后） |
| 源码运行时序图 | **不适用**（非论文可运行训练仓，或未核 README 入口） |
| 重定向就绪度 | **需适配**：多模态双臂移动操作真机轨迹，同构机型可直接训练；跨本体（臂长 / 自由度 / 夹爪）使用前须重定向并核对动作空间（索引级判断，以官方文档 / 数据卡为准） |
...
- [`sources/repos/pai_awesome_dataset_094_robomind.md`](../../sources/repos/pai_awesome_dataset_094_robomind.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://x-humanoid-robomind.github.io/)
