...
status: complete
updated: 2026-09-20
summary: "LaValle. Comprehensive coverage of motion planning, free online."
related:
...
sources:
  - ../../sources/repos/pai_awesome_book_028_planning-algorithms.md
...
**Planning Algorithms** 收录于 awesome-physical-ai（natnew）**第 028/384** 条，分组 **Books**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

LaValle. Comprehensive coverage of motion planning, free online.
...
- [`sources/repos/pai_awesome_book_028_planning-algorithms.md`](../../sources/repos/pai_awesome_book_028_planning-algorithms.md) — 本条目策展摘录
...
- [原文 / 官方入口](http://lavalle.pl/planning/)
