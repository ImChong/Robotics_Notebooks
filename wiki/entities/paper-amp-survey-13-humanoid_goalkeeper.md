...
type: entity
tags: [paper, humanoid, amp, motion-prior, adversarial-imitation, shanghai-ai-lab, hku]
status: complete
updated: 2026-06-11
venue: curated
summary: "Humanoid Goalkeeper 里，运动先验用于守门任务中的自然全身反应。"
related:
...
**Humanoid Goalkeeper** 收录于 [具身智能研究室 · AMP 运动先验专题](https://mp.weixin.qq.com/s/YZsm3855iP3TNTTt1aou7w) **第 13/19** 篇，归类为 **04 交互与长时程**。本页为知识库 **策展摘要**。
...
- 原始 source：[humanoid_amp_survey_13_humanoid_goalkeeper_learning_from_position_condi.md](../../sources/papers/humanoid_amp_survey_13_humanoid_goalkeeper_learning_from_position_condi.md)
