---
type: entity
tags: [curated-index, physical-ai, awesome-physical-ai, community]
status: complete
updated: 2026-09-20
summary: "Andra Keay (Silicon Valley Robotics). Robot startups and industry trends from the epicenter of the robot revolution."
related:
...
sources:
  - ../../sources/repos/pai_awesome_community_237_robots-startups.md
...
**Robots & Startups** 收录于 awesome-physical-ai（natnew）**第 237/384** 条，分组 **Newsletters & Blogs**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。

## 一句话定义

Andra Keay (Silicon Valley Robotics). Robot startups and industry trends from the epicenter of the robot revolution.
...
|------|------|
| 编号 | 237/384 |
| 分组 | Newsletters & Blogs |
| 来源清单 | natnew |
| 主链接 | <https://robotsandstartups.substack.com/> |

## 核心原理

Andra Keay (Silicon Valley Robotics). Robot startups and industry trends from the epicenter of the robot revolution.

该条目在 Physical AI 清单中的角色是 **community**，分组 **Newsletters & Blogs**。本页只固化清单给出的问题设定与入口链接，不把外部营销页或课程大纲转存成知识正文。
...
| 字段 | 内容 |
|------|------|
| 官方入口 | <https://robotsandstartups.substack.com/> |
...
- [`sources/repos/pai_awesome_community_237_robots-startups.md`](../../sources/repos/pai_awesome_community_237_robots-startups.md) — 本条目策展摘录
...
- [原文 / 官方入口](https://robotsandstartups.substack.com/)
