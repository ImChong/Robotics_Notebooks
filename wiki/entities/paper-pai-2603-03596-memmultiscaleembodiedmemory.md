...
**MEM — Multi-Scale Embodied Memory** 收录于 awesome-physical-ai（natnew）**第 301/384** 条，分组 **Robotics Foundation Models**。本页为知识库 **策展索引级** 详情节点；细节以官方文档 / 原文为准。
...
**本条目的站内价值是把「MEM — Multi-Scale Embodied Memory」从 awesome-physical-ai 列表提升为可链接的知识节点，并保留清单分组作为阅读锚点。**
